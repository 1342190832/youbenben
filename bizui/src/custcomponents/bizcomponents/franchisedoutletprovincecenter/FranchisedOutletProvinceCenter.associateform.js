...
import styles from './FranchisedOutletProvinceCenter.createform.less'
import {mapBackToImageValues, mapFromImageValues} from '../../axios/tools'
import GlobalComponents from '../../custcomponents';
import FranchisedOutletProvinceCenterBase from './FranchisedOutletProvinceCenter.base'
...
class FranchisedOutletProvinceCenterAssociateForm extends Component {
  state = {
  ...
  render() {
    ...
    const { convertedImagesValues } = this.state
    const {FranchisedOutletProvinceCenterService} = GlobalComponents
 ...
 const {CatalogModalTable} = GlobalComponents;
    ...
    const {fieldLabels} = FranchisedOutletProvinceCenterBase
...
}))(Form.create()(FranchisedOutletProvinceCenterAssociateForm))
