...
const packFormValuesToObject = ( formValuesToPack )=>{
	...
	const data = {name, rfid, uom, maxPackage, expireTime:moment(expireTime).valueOf(), sku, receivingSpace, goodsAllocation, smartPallet, shippingSpace, transportTask, retailStore, bizOrder, retailStoreOrder, packaging}
	return data
}
const unpackObjectToFormValues = ( objectToUnpack )=>{
	...
	const data = {name, rfid, uom, maxPackage, expireTime:moment(expireTime), skuId, receivingSpaceId, goodsAllocationId, smartPalletId, shippingSpaceId, transportTaskId, retailStoreId, bizOrderId, retailStoreOrderId, packagingId}
	return data
}
