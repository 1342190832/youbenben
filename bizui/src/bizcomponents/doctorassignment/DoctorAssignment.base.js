...
const displayColumns = [
  { title: fieldLabels.id, debugtype: 'string', dataIndex: 'id', width: '6', render: (text, record)=>renderTextCell(text,record,'doctorAssignment') , sorter: true },
...
const renderItemOfList=(doctorAssignment, targetComponent, columCount, listName)=>{
  ...
  const userContext = null
  return (
    <Card key={`${listName}-${doctorAssignment.id}`} style={{marginTop:"10px"}}>
