...
class DoctorAssignmentSearchForm extends PureComponent {
  state = {
    // addInputValue: '',
    // modalVisible: false,
    expandForm: false,
...
componentDidMount() {
  ...
  buildStringSearchParameters = (formValues, fieldName) => {
    ...
    return {
      doctorAssignmentList: 1,
      'doctorAssignmentList.searchField': fieldName,
      'doctorAssignmentList.searchVerb': 'startsWith',
      'doctorAssignmentList.searchValue': fieldValue,
    }
  }
  */
  ...
  handleSearch = (e) => {
    ...
    form.validateFields((err, fieldsValue) => {
      ...
      dispatch({
        ...
        doctorAssignmentSearchFormParameters: filterObjectKeys(fieldsValue),
 ...
 <Col md={8} sm={24}>
                  ...
                  <CandidateList 
		                 ...
		                 ownerId={owner.id}
		                 scenarioCode={"search"}
		                 listType={"doctor_assignment"} 
		                 targetType={"doctor"} 
                 
                    requestFunction={DoctorAssignmentService.queryCandidates} useForSearch />
...
export default Form.create()(DoctorAssignmentSearchForm)
