...
class DoctorAssignmentCreateFormBody extends Component {
  state = {
  ...
  render() {
    ...
    const internalRenderTitle = () =>{
      ...
      return (<div>{linkComp}{appLocaleName(userContext,"CreateNew")}{window.trans('doctor_assignment')}</div>)
    }
              ...
              <Col lg={24} md={24} sm={24}>
                <Form.Item label={fieldLabels.doctor} {...formItemLayout}>
                  ...
                  <CandidateList 
                    ...
                    requestFunction={DoctorAssignmentService.queryCandidates}  />
...
}))(Form.create()(DoctorAssignmentCreateFormBody))
