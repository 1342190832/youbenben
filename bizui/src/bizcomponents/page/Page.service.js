...
const addSection = (targetObjectId, parameters) => {
  const url = `${PREFIX}pageManager/addSection/pageId/title/brief/icon/viewGroup/linkToUrl/tokensExpr/`
  const pageId = targetObjectId
  const requestParameters = { ...parameters, pageId, tokensExpr: 'none' }
  return postForm({ url,requestParameters})
}
...
const updateSection = (targetObjectId, parameters) => {
  const url = `${PREFIX}pageManager/updateSectionProperties/pageId/id/title/brief/icon/viewGroup/linkToUrl/tokensExpr/`
  const pageId = targetObjectId
  const requestParameters = { ...parameters, pageId, tokensExpr: 'none' }
  return postForm({ url,requestParameters})
}
