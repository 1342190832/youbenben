...
<Description term="备注" style={{wordBreak: 'break-all'}}>{termination.comment}</Description> 
  ...
  render() {
    ...
    const cardsData = {cardsName:window.trans('termination'),cardsFor: "termination",
    	cardsSource: this.props.termination,returnURL,displayName,
  		subItems: [
{name: 'employeeList', displayName: window.mtrans('employee','termination.employee_list',false) ,viewGroup:'__no_group', type:'employee',count:employeeCount,addFunction: true, role: 'employee', metaInfo: employeeListMetaInfo, renderItem: GlobalComponents.EmployeeBase.renderItemOfList},
