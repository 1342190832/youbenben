...
<Description term="所有人">{memberWishlistProduct.owner==null?appLocaleName(userContext,"NotAssigned"):`${memberWishlistProduct.owner.displayName}(${memberWishlistProduct.owner.id})`}
 <Icon type="swap" onClick={()=>
  showTransferModel(targetComponent,"所有人","memberWishlist",MemberWishlistProductService.requestCandidateOwner,
