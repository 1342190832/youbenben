...
const displayColumns = [
  { title: fieldLabels.id, debugtype: 'string', dataIndex: 'id', width: '6', render: (text, record)=>renderTextCell(text,record,'expenseItem') , sorter: true },
...
const renderItemOfList=(expenseItem, targetComponent, columCount, listName)=>{
  ...
  const userContext = null
  return (
    <Card key={`${listName}-${expenseItem.id}`} style={{marginTop:"10px"}}>
