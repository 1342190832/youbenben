...
const showAssociateDialog = (targetComponent) => {
  ...
  <div>
	...
	data={{expenseItemList:selectedRows}} owner={owner}  
...
class ExpenseItemSearch extends PureComponent {
  state = {
  ...
  render(){
    ...
    const {ExpenseItemTable} = GlobalComponents;
    const {ExpenseItemSearchForm} = GlobalComponents;
    ...
    return (
      <PageHeaderLayout title={renderTitle()}>
        ...
        <Card bordered={false}>
          <div className={styles.tableList}>
            <div className={styles.tableListForm}>
              <ExpenseItemSearchForm {...this.props} />
            </div>
        ...
        {showDeletionDialog(this,ExpenseItemModalTable,"expenseItemIds")}
...
export default Form.create()(ExpenseItemSearch)
