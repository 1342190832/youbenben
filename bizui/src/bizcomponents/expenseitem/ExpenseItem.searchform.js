...
import styles from './ExpenseItem.search.less'
...
class ExpenseItemSearchForm extends PureComponent {
  state = {
    // addInputValue: '',
    // modalVisible: false,
    expandForm: false,
...
componentDidMount() {
  ...
  buildStringSearchParameters = (formValues, fieldName) => {
    ...
    return {
      expenseItemList: 1,
      'expenseItemList.searchField': fieldName,
      'expenseItemList.searchVerb': 'startsWith',
      'expenseItemList.searchValue': fieldValue,
    }
  }
  */
  ...
  handleSearch = (e) => {
    ...
    form.validateFields((err, fieldsValue) => {
      ...
      dispatch({
        ...
        expenseItemSearchFormParameters: filterObjectKeys(fieldsValue),
 ...
 <Col md={8} sm={24}>
                  ...
                  <CandidateList 
                    ...
                    requestFunction={ExpenseItemService.queryCandidates} useForSearch />
...
export default Form.create()(ExpenseItemSearchForm)
