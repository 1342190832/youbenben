...
import ExpenseItemCreateFormBody from './ExpenseItem.createformbody'
...
class ExpenseItemCreateForm extends Component {
  ...
  render() {
    ...
    const internalRenderTitle = () =>{
      ...
      return (<div>{linkComp}{appLocaleName(userContext,"CreateNew")}{window.trans('expense_item')}</div>)
    }

	return (
      <PageHeaderLayout
        title={internalRenderTitle()}
        content={`${appLocaleName(userContext,"CreateNew")}${window.trans('expense_item')}`}
        wrapperClassName={styles.advancedForm}
      >
   			
   		<ExpenseItemCreateFormBody	 {...this.props} handleImageChange={this.handleImageChange}/>
