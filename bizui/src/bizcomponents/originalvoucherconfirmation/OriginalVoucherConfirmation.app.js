 ...
 getNavMenuItems = (targetObject, style, customTheme) => {
  ...
  getOriginalVoucherSearch = () => {
    ...
    return connect(state => ({
      rule: state.rule,
      name: window.mtrans('original_voucher','original_voucher_confirmation.original_voucher_list',false),
  ...
  getRequestTypeStepForm = () => {
    ...
    return connect(state => ({
      ...
      role: "cq",
      currentUpdateIndex: state._originalVoucherConfirmation.currentUpdateIndex,
      owner: { type: '_originalVoucherConfirmation', id: state._originalVoucherConfirmation.id, listName: 'nolist', ref:state._originalVoucherConfirmation, listDisplayName: appLocaleName(userContext,"List") }, // this is for model namespace and
      ...
      {this.state.showSearch&&(
       ...
       <Sider
        ...
        >
         ...
         {this.getNavMenuItems(this.props.originalVoucherConfirmation,"inline","dark")}
