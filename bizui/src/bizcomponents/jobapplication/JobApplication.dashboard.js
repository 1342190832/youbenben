...
<Description term="ID" style={{wordBreak: 'break-all'}}>{jobApplication.id}</Description> 
...
class JobApplicationDashboard extends Component {
 ...
 state = {
  ...
  render() {
    ...
    const cardsData = {cardsName:window.trans('job_application'),cardsFor: "jobApplication",
    	cardsSource: this.props.jobApplication,returnURL,displayName,
  		subItems: [
{name: 'employeeList', displayName: window.mtrans('employee','job_application.employee_list',false) ,viewGroup:'__no_group', type:'employee',count:employeeCount,addFunction: true, role: 'employee', metaInfo: employeeListMetaInfo, renderItem: GlobalComponents.EmployeeBase.renderItemOfList},
