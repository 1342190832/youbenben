 ...
 getNavMenuItems = (targetObject, style, customTheme) => {
  ...
  getEmployeeSearch = () => {
    ...
    return connect(state => ({
      rule: state.rule,
      name: window.mtrans('employee','job_application.employee_list',false),
      role: "employee",
  ...
  getRequestTypeStepForm = () => {
    ...
    return connect(state => ({
      ...
      role: "cq",
      currentUpdateIndex: state._jobApplication.currentUpdateIndex,
      owner: { type: '_jobApplication', id: state._jobApplication.id, listName: 'nolist', ref:state._jobApplication, listDisplayName: appLocaleName(userContext,"List") }, // this is for model namespace and
      ...
      {this.state.showSearch&&(
       ...
       <Sider
        ...
        >
         ...
         {this.getNavMenuItems(this.props.jobApplication,"inline","dark")}
