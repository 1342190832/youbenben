 ...
 getNavMenuItems = (targetObject, style, customTheme) => {
  ...
  getRetailStoreOrderSearch = () => {
    ...
    return connect(state => ({
      rule: state.rule,
      name: window.mtrans('retail_store_order','retail_store_order_approval.retail_store_order_list',false),
  ...
  getRequestTypeStepForm = () => {
    ...
    return connect(state => ({
      ...
      role: "cq",
      currentUpdateIndex: state._retailStoreOrderApproval.currentUpdateIndex,
      owner: { type: '_retailStoreOrderApproval', id: state._retailStoreOrderApproval.id, listName: 'nolist', ref:state._retailStoreOrderApproval, listDisplayName: appLocaleName(userContext,"List") }, // this is for model namespace and
      ...
      {this.state.showSearch&&(
       ...
       <Sider
        ...
        >
         ...
         {this.getNavMenuItems(this.props.retailStoreOrderApproval,"inline","dark")}
