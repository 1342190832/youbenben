...
class DoctorScheduleSearchForm extends PureComponent {
  state = {
    // addInputValue: '',
    // modalVisible: false,
    expandForm: false,
...
componentDidMount() {
  ...
  buildStringSearchParameters = (formValues, fieldName) => {
    ...
    return {
      ...
      'doctorScheduleList.searchField': fieldName,
      'doctorScheduleList.searchVerb': 'startsWith',
      'doctorScheduleList.searchValue': fieldValue,
    }
  }
  */
  ...
  handleSearch = (e) => {
    ...
    form.validateFields((err, fieldsValue) => {
      ...
      dispatch({
        ...
        doctorScheduleSearchFormParameters: filterObjectKeys(fieldsValue),
 ...
 <Col md={8} sm={24}>
               ...
               <CandidateList 
                 ...
                 ownerId={owner.id}
                 scenarioCode={"search"}
                 listType={"doctor_schedule"} 
                 targetType={"period"} 
                 
                 
                 requestFunction={DoctorScheduleService.queryCandidates} useForSearch />
...
export default Form.create()(DoctorScheduleSearchForm)
