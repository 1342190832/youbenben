...
const displayColumns = [
  { title: fieldLabels.id, debugtype: 'string', dataIndex: 'id', width: '6', render: (text, record)=>renderTextCell(text,record,'doctorSchedule') , sorter: true },
...
const renderItemOfList=(doctorSchedule, targetComponent, columCount, listName)=>{
  ...
  const userContext = null
  return (
    <Card key={`${listName}-${doctorSchedule.id}`} style={{marginTop:"10px"}}>
