...
<Description term="打包站商家">{retailStoreOrder.buyer==null?appLocaleName(userContext,"NotAssigned"):`${retailStoreOrder.buyer.displayName}(${retailStoreOrder.buyer.id})`}
 <Icon type="swap" onClick={()=>
  showTransferModel(targetComponent,"打包站商家","retailStore",RetailStoreOrderService.requestCandidateBuyer,
	      RetailStoreOrderService.transferToAnotherBuyer,"anotherBuyerId",retailStoreOrder.buyer?retailStoreOrder.buyer.id:"")} 
  style={{fontSize: 20,color:"red"}} />
</Description>
<Description term="标题" style={{wordBreak: 'break-all'}}>{retailStoreOrder.title}</Description> 
