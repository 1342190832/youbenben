...
import styles from './ExpenseType.search.less'
...
class ExpenseTypeSearchForm extends PureComponent {
  state = {
    // addInputValue: '',
    // modalVisible: false,
    expandForm: false,
...
componentDidMount() {
  ...
  buildStringSearchParameters = (formValues, fieldName) => {
    ...
    return {
      expenseTypeList: 1,
      'expenseTypeList.searchField': fieldName,
      'expenseTypeList.searchVerb': 'startsWith',
      'expenseTypeList.searchValue': fieldValue,
    }
  }
  */
  ...
  handleSearch = (e) => {
    ...
    form.validateFields((err, fieldsValue) => {
      ...
      const {listName} = owner
		...
		pushIfNotNull(paramList,this.buildStringSearchParameters(listName, fieldsValue,'contains', 'helperChars'))
		pushIfNotNull(paramList,this.buildStringSearchParameters(listName, fieldsValue,'contains', 'status'))
      ...
      dispatch({
        ...
        expenseTypeSearchFormParameters: filterObjectKeys(fieldsValue),
    ...
    return (
      <Form onSubmit={this.handleSearch} layout="inline">
        <Row gutter={{ md: 8, lg: 24, xl: 48 }}>
          ...
          <Col md={8} sm={24}>
            <FormItem label={fieldLabels.helperChars}>
 ...
 <Col md={8} sm={24}>
                  ...
                  <CandidateList 
		                 ...
		                 ownerId={owner.id}
		                 scenarioCode={"search"}
		                 listType={"expense_type"} 
		                 targetType={"hospital"} 
                 
                    requestFunction={ExpenseTypeService.queryCandidates} useForSearch />
...
export default Form.create()(ExpenseTypeSearchForm)
