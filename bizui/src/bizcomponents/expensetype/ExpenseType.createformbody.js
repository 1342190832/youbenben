...
class ExpenseTypeCreateFormBody extends Component {
  state = {
  ...
  render() {
    ...
    const internalRenderTitle = () =>{
      ...
      return (<div>{linkComp}{appLocaleName(userContext,"CreateNew")}{window.trans('expense_type')}</div>)
    }
	...
	return (
      <div>
              ...
              <Col lg={24} md={24} sm={24}>
                <Form.Item label={fieldLabels.hospital} {...formItemLayout}>
                  ...
                  <CandidateList 
                    ...
                    requestFunction={ExpenseTypeService.queryCandidates}  />
        ...
        <Card title={fieldLabels.description} className={styles.card} bordered={false}>
          <Form >
          	<Row gutter={16}>
              <Col lg={24} md={24} sm={24}>
                <Form.Item>
...
}))(Form.create()(ExpenseTypeCreateFormBody))
