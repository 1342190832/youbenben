...
const displayColumns = [
  { title: fieldLabels.id, debugtype: 'string', dataIndex: 'id', width: '6', render: (text, record)=>renderTextCell(text,record,'expenseType') , sorter: true },
...
const renderItemOfList=(expenseType, targetComponent, columCount, listName)=>{
  ...
  const userContext = null
  return (
    <Card key={`${listName}-${expenseType.id}`} style={{marginTop:"10px"}}>
