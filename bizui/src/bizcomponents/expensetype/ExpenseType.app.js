 ...
 getNavMenuItems = (targetObject, style, customTheme) => {
	  ...
	  <Menu
       ...
       >
             ...
             <Menu.Item key="dashboard">
               <Link to={`/expenseType/${this.props.expenseType.id}/dashboard`}><Icon type="dashboard" style={{marginRight:"20px"}}/><span>{appLocaleName(userContext,"Dashboard")}</span></Link>
             </Menu.Item>
  ...
  getExpenseItemSearch = () => {
    ...
    return connect(state => ({
      rule: state.rule,
      name: window.mtrans('expense_item','expense_type.expense_item_list',false),
      role: "expenseItem",
      ...
      owner: { type: '_expenseType', id: state._expenseType.id, 
      referenceName: 'expenseType', 
      listName: 'expenseItemList', ref:state._expenseType, 
  ...
  getExpenseItemCreateForm = () => {
    ...
    return connect(state => ({
      ...
      metaInfo: state._expenseType.expenseItemListMetaInfo,
      count: state._expenseType.expenseItemCount,
      returnURL: `/expenseType/${state._expenseType.id}/list`,
      currentPage: state._expenseType.expenseItemCurrentPageNumber,
      searchFormParameters: state._expenseType.expenseItemSearchFormParameters,
      loading: state._expenseType.loading,
      owner: { type: '_expenseType', id: state._expenseType.id, referenceName: 'expenseType', listName: 'expenseItemList', ref:state._expenseType, listDisplayName: appLocaleName(userContext,"List")}, // this is for model namespace and
  ...
  getExpenseItemUpdateForm = () => {
    ...
    return connect(state => ({
      ...
      owner: { type: '_expenseType', id: state._expenseType.id, listName: 'expenseItemList', ref:state._expenseType, listDisplayName: appLocaleName(userContext,"List") }, // this is for model namespace and
  ...
  getDoctorScheduleSearch = () => {
    ...
    return connect(state => ({
      rule: state.rule,
      name: window.mtrans('doctor_schedule','expense_type.doctor_schedule_list',false),
      role: "doctorSchedule",
      ...
      owner: { type: '_expenseType', id: state._expenseType.id, 
      referenceName: 'expenseType', 
      listName: 'doctorScheduleList', ref:state._expenseType, 
      listDisplayName: appLocaleName(userContext,"List") }, // this is for model namespace and
  ...
  getDoctorScheduleCreateForm = () => {
    ...
    return connect(state => ({
      ...
      searchFormParameters: state._expenseType.doctorScheduleSearchFormParameters,
      loading: state._expenseType.loading,
      owner: { type: '_expenseType', id: state._expenseType.id, referenceName: 'expenseType', listName: 'doctorScheduleList', ref:state._expenseType, listDisplayName: appLocaleName(userContext,"List")}, // this is for model namespace and
  ...
  getDoctorScheduleUpdateForm = () => {
    ...
    return connect(state => ({
      ...
      role: "doctorSchedule",
      currentUpdateIndex: state._expenseType.currentUpdateIndex,
      owner: { type: '_expenseType', id: state._expenseType.id, listName: 'doctorScheduleList', ref:state._expenseType, listDisplayName: appLocaleName(userContext,"List") }, // this is for model namespace and
  ...
  getRequestTypeStepForm = () => {
    ...
    return connect(state => ({
      ...
      role: "cq",
      currentUpdateIndex: state._expenseType.currentUpdateIndex,
      owner: { type: '_expenseType', id: state._expenseType.id, listName: 'nolist', ref:state._expenseType, listDisplayName: appLocaleName(userContext,"List") }, // this is for model namespace and
  ...
  buildRouters = () =>{
  	...
  	{path:"/expenseType/:id/list/expenseItemCreateForm", component: this.getExpenseItemCreateForm()},
  	{path:"/expenseType/:id/list/expenseItemUpdateForm", component: this.getExpenseItemUpdateForm()},
   	
  	{path:"/expenseType/:id/list/doctorScheduleList", component: this.getDoctorScheduleSearch()},
  	{path:"/expenseType/:id/list/doctorScheduleCreateForm", component: this.getDoctorScheduleCreateForm()},
  	{path:"/expenseType/:id/list/doctorScheduleUpdateForm", component: this.getDoctorScheduleUpdateForm()},
  ...
  handleOpenChange = (openKeys) => {
   ...
   render() {
    ...
    const {searchLocalData}=GlobalComponents.ExpenseTypeBase
    ...
    const renderMenuSwitch=()=>{
     ...
     <Layout>
      ...
      {this.state.showSearch&&(
        ...
        <div style={{backgroundColor:'black'}}  onClick={()=>hideSearchResult()}  >{searchLocalData(this.props.expenseType,this.state.searchKeyword)}</div>
       ...
       <Sider
        ...
        >
         ...
         {this.getNavMenuItems(this.props.expenseType,"inline","dark")}
