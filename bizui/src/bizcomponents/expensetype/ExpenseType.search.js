...
const showAssociateDialog = (targetComponent) => {
  ...
  <div>
	...
	data={{expenseTypeList:selectedRows}} owner={owner}  
...
class ExpenseTypeSearch extends PureComponent {
  state = {
  ...
  render(){
    ...
    const {ExpenseTypeTable} = GlobalComponents;
    const {ExpenseTypeSearchForm} = GlobalComponents;
    ...
    return (
      <PageHeaderLayout title={renderTitle()}>
        ...
        <Card bordered={false}>
          <div className={styles.tableList}>
            <div className={styles.tableListForm}>
              <ExpenseTypeSearchForm {...this.props} />
            </div>
        ...
        {showDeletionDialog(this,ExpenseTypeModalTable,"expenseTypeIds")}
...
export default Form.create()(ExpenseTypeSearch)
