 ...
 getNavMenuItems = (targetObject, style, customTheme) => {
  ...
  getRequestTypeStepForm = () => {
    ...
    return connect(state => ({
      selectedRows: state._consumerOrderApproval.selectedRows,
      role: "cq",
      currentUpdateIndex: state._consumerOrderApproval.currentUpdateIndex,
      owner: { type: '_consumerOrderApproval', id: state._consumerOrderApproval.id, listName: 'nolist', ref:state._consumerOrderApproval, listDisplayName: appLocaleName(userContext,"List") }, // this is for model namespace and
      ...
      {this.state.showSearch&&(
       ...
       <Sider
        ...
        >
         ...
         {this.getNavMenuItems(this.props.consumerOrderApproval,"inline","dark")}
