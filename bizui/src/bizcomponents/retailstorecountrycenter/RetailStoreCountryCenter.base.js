...
const displayColumns = [
  ...
  { title: fieldLabels.webSite, debugtype: 'string_url', dataIndex: 'webSite', width: '30',render: (text, record)=>renderTextCell(text,record)},
  { title: fieldLabels.address, debugtype: 'string', dataIndex: 'address', width: '18',render: (text, record)=>renderTextCell(text,record)},
  { title: fieldLabels.operatedBy, debugtype: 'string', dataIndex: 'operatedBy', width: '10',render: (text, record)=>renderTextCell(text,record)},
  ...
  { title: fieldLabels.description, debugtype: 'string', dataIndex: 'description', width: '18',render: (text, record)=>renderTextCell(text,record)},
