...
<Description term="培训活动">{employeeCompanyTraining.training==null?appLocaleName(userContext,"NotAssigned"):`${employeeCompanyTraining.training.displayName}(${employeeCompanyTraining.training.id})`}
 <Icon type="swap" onClick={()=>
  showTransferModel(targetComponent,"培训活动","companyTraining",EmployeeCompanyTrainingService.requestCandidateTraining,
