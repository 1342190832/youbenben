...
<Description term="ID" style={{wordBreak: 'break-all'}}>{accountingDocumentCreation.id}</Description> 
...
class AccountingDocumentCreationDashboard extends Component {
 ...
 state = {
  ...
  render() {
    ...
    const cardsData = {cardsName:window.trans('accounting_document_creation'),cardsFor: "accountingDocumentCreation",
    	cardsSource: this.props.accountingDocumentCreation,returnURL,displayName,
  		subItems: [
{name: 'accountingDocumentList', displayName: window.mtrans('accounting_document','accounting_document_creation.accounting_document_list',false) ,viewGroup:'__no_group', type:'accountingDocument',count:accountingDocumentCount,addFunction: true, role: 'accountingDocument', metaInfo: accountingDocumentListMetaInfo, renderItem: GlobalComponents.AccountingDocumentBase.renderItemOfList},
