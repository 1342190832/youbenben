 ...
 getNavMenuItems = (targetObject, style, customTheme) => {
  ...
  getAccountingDocumentSearch = () => {
    ...
    return connect(state => ({
      rule: state.rule,
      name: window.mtrans('accounting_document','accounting_document_auditing.accounting_document_list',false),
  ...
  getRequestTypeStepForm = () => {
    ...
    return connect(state => ({
      ...
      role: "cq",
      currentUpdateIndex: state._accountingDocumentAuditing.currentUpdateIndex,
      owner: { type: '_accountingDocumentAuditing', id: state._accountingDocumentAuditing.id, listName: 'nolist', ref:state._accountingDocumentAuditing, listDisplayName: appLocaleName(userContext,"List") }, // this is for model namespace and
      ...
      {this.state.showSearch&&(
       ...
       <Sider
        ...
        >
         ...
         {this.getNavMenuItems(this.props.accountingDocumentAuditing,"inline","dark")}
