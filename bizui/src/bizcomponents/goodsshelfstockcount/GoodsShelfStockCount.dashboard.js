...
<Description term="标题" style={{wordBreak: 'break-all'}}>{goodsShelfStockCount.title}</Description> 
<Description term="计数时间">{ moment(goodsShelfStockCount.countTime).format('YYYY-MM-DD')}</Description> 
<Description term="总结" style={{wordBreak: 'break-all'}}>{goodsShelfStockCount.summary}</Description> 
