 ...
 getNavMenuItems = (targetObject, style, customTheme) => {
  ...
  getConsumerOrderSearch = () => {
    ...
    return connect(state => ({
      rule: state.rule,
      name: window.mtrans('consumer_order','supply_order_delivery.consumer_order_list',false),
      role: "consumerOrder",
  ...
  getSupplyOrderSearch = () => {
    ...
    return connect(state => ({
      rule: state.rule,
      name: window.mtrans('supply_order','supply_order_delivery.supply_order_list',false),
      role: "supplyOrder",
  ...
  getRequestTypeStepForm = () => {
    ...
    return connect(state => ({
      ...
      role: "cq",
      currentUpdateIndex: state._supplyOrderDelivery.currentUpdateIndex,
      owner: { type: '_supplyOrderDelivery', id: state._supplyOrderDelivery.id, listName: 'nolist', ref:state._supplyOrderDelivery, listDisplayName: appLocaleName(userContext,"List") }, // this is for model namespace and
      ...
      {this.state.showSearch&&(
       ...
       <Sider
        ...
        >
         ...
         {this.getNavMenuItems(this.props.supplyOrderDelivery,"inline","dark")}
