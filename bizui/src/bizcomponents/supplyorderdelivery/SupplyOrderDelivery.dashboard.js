...
<Description term="ID" style={{wordBreak: 'break-all'}}>{supplyOrderDelivery.id}</Description> 
...
class SupplyOrderDeliveryDashboard extends Component {
 ...
 state = {
  ...
  render() {
    ...
    const cardsData = {cardsName:window.trans('supply_order_delivery'),cardsFor: "supplyOrderDelivery",
    	cardsSource: this.props.supplyOrderDelivery,returnURL,displayName,
  		subItems: [
{name: 'consumerOrderList', displayName: window.mtrans('consumer_order','supply_order_delivery.consumer_order_list',false) ,viewGroup:'__no_group', type:'consumerOrder',count:consumerOrderCount,addFunction: true, role: 'consumerOrder', metaInfo: consumerOrderListMetaInfo, renderItem: GlobalComponents.ConsumerOrderBase.renderItemOfList},
{name: 'supplyOrderList', displayName: window.mtrans('supply_order','supply_order_delivery.supply_order_list',false) ,viewGroup:'__no_group', type:'supplyOrder',count:supplyOrderCount,addFunction: true, role: 'supplyOrder', metaInfo: supplyOrderListMetaInfo, renderItem: GlobalComponents.SupplyOrderBase.renderItemOfList},
