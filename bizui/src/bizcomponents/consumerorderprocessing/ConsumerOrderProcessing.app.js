 ...
 getNavMenuItems = (targetObject, style, customTheme) => {
  ...
  getRequestTypeStepForm = () => {
    ...
    return connect(state => ({
      selectedRows: state._consumerOrderProcessing.selectedRows,
      role: "cq",
      currentUpdateIndex: state._consumerOrderProcessing.currentUpdateIndex,
      owner: { type: '_consumerOrderProcessing', id: state._consumerOrderProcessing.id, listName: 'nolist', ref:state._consumerOrderProcessing, listDisplayName: appLocaleName(userContext,"List") }, // this is for model namespace and
      ...
      {this.state.showSearch&&(
       ...
       <Sider
        ...
        >
         ...
         {this.getNavMenuItems(this.props.consumerOrderProcessing,"inline","dark")}
