...
<Description term="ID" style={{wordBreak: 'break-all'}}>{retailStoreOrderConfirmation.id}</Description> 
...
class RetailStoreOrderConfirmationDashboard extends Component {
 ...
 state = {
  ...
  render() {
    ...
    const cardsData = {cardsName:window.trans('retail_store_order_confirmation'),cardsFor: "retailStoreOrderConfirmation",
