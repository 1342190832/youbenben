 ...
 getNavMenuItems = (targetObject, style, customTheme) => {
  ...
  getRetailStoreOrderSearch = () => {
    ...
    return connect(state => ({
      rule: state.rule,
      name: window.mtrans('retail_store_order','retail_store_order_confirmation.retail_store_order_list',false),
  ...
  getRequestTypeStepForm = () => {
    ...
    return connect(state => ({
      ...
      role: "cq",
      currentUpdateIndex: state._retailStoreOrderConfirmation.currentUpdateIndex,
      owner: { type: '_retailStoreOrderConfirmation', id: state._retailStoreOrderConfirmation.id, listName: 'nolist', ref:state._retailStoreOrderConfirmation, listDisplayName: appLocaleName(userContext,"List") }, // this is for model namespace and
      ...
      {this.state.showSearch&&(
       ...
       <Sider
        ...
        >
         ...
         {this.getNavMenuItems(this.props.retailStoreOrderConfirmation,"inline","dark")}
