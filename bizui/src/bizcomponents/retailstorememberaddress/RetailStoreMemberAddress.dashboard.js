...
<Description term="所有人">{retailStoreMemberAddress.owner==null?appLocaleName(userContext,"NotAssigned"):`${retailStoreMemberAddress.owner.displayName}(${retailStoreMemberAddress.owner.id})`}
 <Icon type="swap" onClick={()=>
  showTransferModel(targetComponent,"所有人","retailStoreMember",RetailStoreMemberAddressService.requestCandidateOwner,
