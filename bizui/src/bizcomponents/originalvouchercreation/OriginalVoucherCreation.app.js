 ...
 getNavMenuItems = (targetObject, style, customTheme) => {
  ...
  getOriginalVoucherSearch = () => {
    ...
    return connect(state => ({
      rule: state.rule,
      name: window.mtrans('original_voucher','original_voucher_creation.original_voucher_list',false),
  ...
  getRequestTypeStepForm = () => {
    ...
    return connect(state => ({
      ...
      role: "cq",
      currentUpdateIndex: state._originalVoucherCreation.currentUpdateIndex,
      owner: { type: '_originalVoucherCreation', id: state._originalVoucherCreation.id, listName: 'nolist', ref:state._originalVoucherCreation, listDisplayName: appLocaleName(userContext,"List") }, // this is for model namespace and
      ...
      {this.state.showSearch&&(
       ...
       <Sider
        ...
        >
         ...
         {this.getNavMenuItems(this.props.originalVoucherCreation,"inline","dark")}
