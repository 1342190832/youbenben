 ...
 getNavMenuItems = (targetObject, style, customTheme) => {
  ...
  getRequestTypeStepForm = () => {
    ...
    return connect(state => ({
      ...
      role: "cq",
      currentUpdateIndex: state._department.currentUpdateIndex,
      owner: { type: '_department', id: state._department.id, listName: 'nolist', ref:state._department, listDisplayName: appLocaleName(userContext,"List") }, // this is for model namespace and
