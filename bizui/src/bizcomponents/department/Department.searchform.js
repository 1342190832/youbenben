...
import styles from './Department.search.less'
...
const {fieldLabels} = DepartmentBase
...
class DepartmentSearchForm extends PureComponent {
  state = {
    // addInputValue: '',
    // modalVisible: false,
    expandForm: false,
...
componentDidMount() {
  ...
  buildStringSearchParameters = (formValues, fieldName) => {
    ...
    return {
      departmentList: 1,
      'departmentList.searchField': fieldName,
      'departmentList.searchVerb': 'startsWith',
      'departmentList.searchValue': fieldValue,
    }
  }
  */
  ...
  handleSearch = (e) => {
    ...
    form.validateFields((err, fieldsValue) => {
      ...
      dispatch({
        ...
        departmentSearchFormParameters: filterObjectKeys(fieldsValue),
 ...
 <Col md={8} sm={24}>
                  ...
                  <CandidateList 
                    ...
                    requestFunction={DepartmentService.queryCandidates} useForSearch />
...
export default Form.create()(DepartmentSearchForm)
