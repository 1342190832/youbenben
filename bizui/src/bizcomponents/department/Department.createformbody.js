...
import styles from './Department.createform.less'
...
class DepartmentCreateFormBody extends Component {
  state = {
              ...
              <Col lg={24} md={24} sm={24}>
                <Form.Item label={fieldLabels.hospital} {...formItemLayout}>
                  ...
                  <CandidateList 
                    ...
                    requestFunction={DepartmentService.queryCandidates}  />
...
}))(Form.create()(DepartmentCreateFormBody))
