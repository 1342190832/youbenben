...
const showAssociateDialog = (targetComponent) => {
  ...
  <div>
	...
	data={{departmentList:selectedRows}} owner={owner}  
...
class DepartmentSearch extends PureComponent {
  state = {
  ...
  render(){
    ...
    const {DepartmentTable} = GlobalComponents;
    const {DepartmentSearchForm} = GlobalComponents;
    ...
    return (
      <PageHeaderLayout title={renderTitle()}>
        ...
        <Card bordered={false}>
          <div className={styles.tableList}>
            <div className={styles.tableListForm}>
              <DepartmentSearchForm {...this.props} />
            </div>
        ...
        {showDeletionDialog(this,DepartmentModalTable,"departmentIds")}
