...
const displayColumns = [
  ...
  { title: fieldLabels.address, debugtype: 'string', dataIndex: 'address', width: '8',render: (text, record)=>renderTextCell(text,record)},
  ...
  return (
	...
	<Col span={20}>
      ...
      <DescriptionList  key={employee.id} size="small" col={displayColumnsCount} >
        ...
        <Description term={fieldLabels.termination}>{renderReferenceItem(employee.termination)}</Description>
