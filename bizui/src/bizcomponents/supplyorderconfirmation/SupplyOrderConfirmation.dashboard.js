...
<Description term="ID" style={{wordBreak: 'break-all'}}>{supplyOrderConfirmation.id}</Description> 
...
class SupplyOrderConfirmationDashboard extends Component {
 ...
 state = {
  ...
  render() {
    ...
    const cardsData = {cardsName:window.trans('supply_order_confirmation'),cardsFor: "supplyOrderConfirmation",
    	cardsSource: this.props.supplyOrderConfirmation,returnURL,displayName,
  		subItems: [
{name: 'consumerOrderList', displayName: window.mtrans('consumer_order','supply_order_confirmation.consumer_order_list',false) ,viewGroup:'__no_group', type:'consumerOrder',count:consumerOrderCount,addFunction: true, role: 'consumerOrder', metaInfo: consumerOrderListMetaInfo, renderItem: GlobalComponents.ConsumerOrderBase.renderItemOfList},
{name: 'supplyOrderList', displayName: window.mtrans('supply_order','supply_order_confirmation.supply_order_list',false) ,viewGroup:'__no_group', type:'supplyOrder',count:supplyOrderCount,addFunction: true, role: 'supplyOrder', metaInfo: supplyOrderListMetaInfo, renderItem: GlobalComponents.SupplyOrderBase.renderItemOfList},
