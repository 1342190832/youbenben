 ...
 getNavMenuItems = (targetObject, style, customTheme) => {
  ...
  getConsumerOrderSearch = () => {
    ...
    return connect(state => ({
      rule: state.rule,
      name: window.mtrans('consumer_order','supply_order_confirmation.consumer_order_list',false),
      role: "consumerOrder",
  ...
  getSupplyOrderSearch = () => {
    ...
    return connect(state => ({
      rule: state.rule,
      name: window.mtrans('supply_order','supply_order_confirmation.supply_order_list',false),
      role: "supplyOrder",
  ...
  getRequestTypeStepForm = () => {
    ...
    return connect(state => ({
      ...
      role: "cq",
      currentUpdateIndex: state._supplyOrderConfirmation.currentUpdateIndex,
      owner: { type: '_supplyOrderConfirmation', id: state._supplyOrderConfirmation.id, listName: 'nolist', ref:state._supplyOrderConfirmation, listDisplayName: appLocaleName(userContext,"List") }, // this is for model namespace and
      ...
      {this.state.showSearch&&(
       ...
       <Sider
        ...
        >
         ...
         {this.getNavMenuItems(this.props.supplyOrderConfirmation,"inline","dark")}
