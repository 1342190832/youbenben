...
const showAssociateDialog = (targetComponent) => {
  ...
  <div>
	...
	data={{periodList:selectedRows}} owner={owner}  
...
class PeriodSearch extends PureComponent {
  state = {
  ...
  render(){
    ...
    const {PeriodTable} = GlobalComponents;
    const {PeriodSearchForm} = GlobalComponents;
    ...
    return (
      <PageHeaderLayout title={renderTitle()}>
        ...
        {showDeletionDialog(this,PeriodModalTable,"periodIds")}
...
export default Form.create()(PeriodSearch)
