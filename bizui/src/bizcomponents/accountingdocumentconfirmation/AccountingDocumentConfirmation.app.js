 ...
 getNavMenuItems = (targetObject, style, customTheme) => {
  ...
  getAccountingDocumentSearch = () => {
    ...
    return connect(state => ({
      rule: state.rule,
      name: window.mtrans('accounting_document','accounting_document_confirmation.accounting_document_list',false),
  ...
  getRequestTypeStepForm = () => {
    ...
    return connect(state => ({
      ...
      role: "cq",
      currentUpdateIndex: state._accountingDocumentConfirmation.currentUpdateIndex,
      owner: { type: '_accountingDocumentConfirmation', id: state._accountingDocumentConfirmation.id, listName: 'nolist', ref:state._accountingDocumentConfirmation, listDisplayName: appLocaleName(userContext,"List") }, // this is for model namespace and
      ...
      {this.state.showSearch&&(
       ...
       <Sider
        ...
        >
         ...
         {this.getNavMenuItems(this.props.accountingDocumentConfirmation,"inline","dark")}
