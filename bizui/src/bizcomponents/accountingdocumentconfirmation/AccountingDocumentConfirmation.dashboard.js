...
<Description term="ID" style={{wordBreak: 'break-all'}}>{accountingDocumentConfirmation.id}</Description> 
...
class AccountingDocumentConfirmationDashboard extends Component {
 ...
 state = {
  ...
  render() {
    ...
    const cardsData = {cardsName:window.trans('accounting_document_confirmation'),cardsFor: "accountingDocumentConfirmation",
