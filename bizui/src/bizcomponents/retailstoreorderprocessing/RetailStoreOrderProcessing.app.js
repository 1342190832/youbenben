 ...
 getNavMenuItems = (targetObject, style, customTheme) => {
  ...
  getRetailStoreOrderSearch = () => {
    ...
    return connect(state => ({
      rule: state.rule,
      name: window.mtrans('retail_store_order','retail_store_order_processing.retail_store_order_list',false),
  ...
  getRequestTypeStepForm = () => {
    ...
    return connect(state => ({
      ...
      role: "cq",
      currentUpdateIndex: state._retailStoreOrderProcessing.currentUpdateIndex,
      owner: { type: '_retailStoreOrderProcessing', id: state._retailStoreOrderProcessing.id, listName: 'nolist', ref:state._retailStoreOrderProcessing, listDisplayName: appLocaleName(userContext,"List") }, // this is for model namespace and
      ...
      {this.state.showSearch&&(
       ...
       <Sider
        ...
        >
         ...
         {this.getNavMenuItems(this.props.retailStoreOrderProcessing,"inline","dark")}
