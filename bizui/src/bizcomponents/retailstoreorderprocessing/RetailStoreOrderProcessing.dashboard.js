...
<Description term="ID" style={{wordBreak: 'break-all'}}>{retailStoreOrderProcessing.id}</Description> 
<Description term="谁" style={{wordBreak: 'break-all'}}>{retailStoreOrderProcessing.who}</Description> 
<Description term="处理时间">{ moment(retailStoreOrderProcessing.processTime).format('YYYY-MM-DD')}</Description> 
