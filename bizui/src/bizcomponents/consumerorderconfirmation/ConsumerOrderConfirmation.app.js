 ...
 getNavMenuItems = (targetObject, style, customTheme) => {
  ...
  getRequestTypeStepForm = () => {
    ...
    return connect(state => ({
      selectedRows: state._consumerOrderConfirmation.selectedRows,
      role: "cq",
      currentUpdateIndex: state._consumerOrderConfirmation.currentUpdateIndex,
      owner: { type: '_consumerOrderConfirmation', id: state._consumerOrderConfirmation.id, listName: 'nolist', ref:state._consumerOrderConfirmation, listDisplayName: appLocaleName(userContext,"List") }, // this is for model namespace and
      ...
      {this.state.showSearch&&(
       ...
       <Sider
        ...
        >
         ...
         {this.getNavMenuItems(this.props.consumerOrderConfirmation,"inline","dark")}
