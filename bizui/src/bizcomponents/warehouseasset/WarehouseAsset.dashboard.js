...
<Description term="所有人">{warehouseAsset.owner==null?appLocaleName(userContext,"NotAssigned"):`${warehouseAsset.owner.displayName}(${warehouseAsset.owner.id})`}
 <Icon type="swap" onClick={()=>
  showTransferModel(targetComponent,"所有人","warehouse",WarehouseAssetService.requestCandidateOwner,
