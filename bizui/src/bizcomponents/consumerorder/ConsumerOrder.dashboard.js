...
<Description term="标题" style={{wordBreak: 'break-all'}}>{consumerOrder.title}</Description> 
...
<Description term="门店">{consumerOrder.store==null?appLocaleName(userContext,"NotAssigned"):`${consumerOrder.store.displayName}(${consumerOrder.store.id})`}
 <Icon type="swap" onClick={()=>
  showTransferModel(targetComponent,"门店","retailStore",ConsumerOrderService.requestCandidateStore,
