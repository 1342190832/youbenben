 ...
 getNavMenuItems = (targetObject, style, customTheme) => {
  ...
  getRetailStoreOrderSearch = () => {
    ...
    return connect(state => ({
      rule: state.rule,
      name: window.mtrans('retail_store_order','retail_store_order_shipment.retail_store_order_list',false),
  ...
  getRequestTypeStepForm = () => {
    ...
    return connect(state => ({
      ...
      role: "cq",
      currentUpdateIndex: state._retailStoreOrderShipment.currentUpdateIndex,
      owner: { type: '_retailStoreOrderShipment', id: state._retailStoreOrderShipment.id, listName: 'nolist', ref:state._retailStoreOrderShipment, listDisplayName: appLocaleName(userContext,"List") }, // this is for model namespace and
      ...
      {this.state.showSearch&&(
       ...
       <Sider
        ...
        >
         ...
         {this.getNavMenuItems(this.props.retailStoreOrderShipment,"inline","dark")}
