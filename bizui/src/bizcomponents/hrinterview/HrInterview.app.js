 ...
 getNavMenuItems = (targetObject, style, customTheme) => {
  ...
  getEmployeeSearch = () => {
    ...
    return connect(state => ({
      rule: state.rule,
      name: window.mtrans('employee','hr_interview.employee_list',false),
      role: "employee",
  ...
  getRequestTypeStepForm = () => {
    ...
    return connect(state => ({
      ...
      role: "cq",
      currentUpdateIndex: state._hrInterview.currentUpdateIndex,
      owner: { type: '_hrInterview', id: state._hrInterview.id, listName: 'nolist', ref:state._hrInterview, listDisplayName: appLocaleName(userContext,"List") }, // this is for model namespace and
      ...
      {this.state.showSearch&&(
       ...
       <Sider
        ...
        >
         ...
         {this.getNavMenuItems(this.props.hrInterview,"inline","dark")}
