 ...
 getNavMenuItems = (targetObject, style, customTheme) => {
  ...
  getEmployeeSearch = () => {
    ...
    return connect(state => ({
      rule: state.rule,
      name: window.mtrans('employee','offer_approval.employee_list',false),
      role: "employee",
  ...
  getRequestTypeStepForm = () => {
    ...
    return connect(state => ({
      ...
      role: "cq",
      currentUpdateIndex: state._offerApproval.currentUpdateIndex,
      owner: { type: '_offerApproval', id: state._offerApproval.id, listName: 'nolist', ref:state._offerApproval, listDisplayName: appLocaleName(userContext,"List") }, // this is for model namespace and
      ...
      {this.state.showSearch&&(
       ...
       <Sider
        ...
        >
         ...
         {this.getNavMenuItems(this.props.offerApproval,"inline","dark")}
