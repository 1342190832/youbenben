...
<Description term="ID" style={{wordBreak: 'break-all'}}>{offerApproval.id}</Description> 
...
class OfferApprovalDashboard extends Component {
 ...
 state = {
  ...
  render() {
    ...
    const cardsData = {cardsName:window.trans('offer_approval'),cardsFor: "offerApproval",
    	cardsSource: this.props.offerApproval,returnURL,displayName,
  		subItems: [
{name: 'employeeList', displayName: window.mtrans('employee','offer_approval.employee_list',false) ,viewGroup:'__no_group', type:'employee',count:employeeCount,addFunction: true, role: 'employee', metaInfo: employeeListMetaInfo, renderItem: GlobalComponents.EmployeeBase.renderItemOfList},
