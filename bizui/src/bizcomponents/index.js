...
const ViewMapping = {
  ...
  'com.youbenben.youbenben.retailstorecountrycenter.RetailStoreCountryCenter': {name:'retailStoreCountryCenter'},
  'com.youbenben.youbenben.catalog.Catalog': {name:'catalog'},
  'com.youbenben.youbenben.levelonecategory.LevelOneCategory': {name:'levelOneCategory'},
  'com.youbenben.youbenben.leveltwocategory.LevelTwoCategory': {name:'levelTwoCategory'},
  'com.youbenben.youbenben.levelthreecategory.LevelThreeCategory': {name:'levelThreeCategory'},
  'com.youbenben.youbenben.product.Product': {name:'product'},
  'com.youbenben.youbenben.sku.Sku': {name:'sku'},
  'com.youbenben.youbenben.retailstoreprovincecenter.RetailStoreProvinceCenter': {name:'retailStoreProvinceCenter'},
  'com.youbenben.youbenben.provincecenterdepartment.ProvinceCenterDepartment': {name:'provinceCenterDepartment'},
  'com.youbenben.youbenben.provincecenteremployee.ProvinceCenterEmployee': {name:'provinceCenterEmployee'},
  'com.youbenben.youbenben.retailstorecityservicecenter.RetailStoreCityServiceCenter': {name:'retailStoreCityServiceCenter'},
  'com.youbenben.youbenben.citypartner.CityPartner': {name:'cityPartner'},
  'com.youbenben.youbenben.potentialcustomer.PotentialCustomer': {name:'potentialCustomer'},
  'com.youbenben.youbenben.potentialcustomercontactperson.PotentialCustomerContactPerson': {name:'potentialCustomerContactPerson'},
  'com.youbenben.youbenben.potentialcustomercontact.PotentialCustomerContact': {name:'potentialCustomerContact'},
  'com.youbenben.youbenben.cityevent.CityEvent': {name:'cityEvent'},
  'com.youbenben.youbenben.eventattendance.EventAttendance': {name:'eventAttendance'},
  'com.youbenben.youbenben.retailstore.RetailStore': {name:'retailStore'},
  'com.youbenben.youbenben.retailstorecreation.RetailStoreCreation': {name:'retailStoreCreation'},
  'com.youbenben.youbenben.retailstoreinvestmentinvitation.RetailStoreInvestmentInvitation': {name:'retailStoreInvestmentInvitation'},
  'com.youbenben.youbenben.retailstorefranchising.RetailStoreFranchising': {name:'retailStoreFranchising'},
  'com.youbenben.youbenben.retailstoredecoration.RetailStoreDecoration': {name:'retailStoreDecoration'},
  'com.youbenben.youbenben.retailstoreopening.RetailStoreOpening': {name:'retailStoreOpening'},
  'com.youbenben.youbenben.retailstoreclosing.RetailStoreClosing': {name:'retailStoreClosing'},
  'com.youbenben.youbenben.retailstoremember.RetailStoreMember': {name:'retailStoreMember'},
  'com.youbenben.youbenben.consumerorder.ConsumerOrder': {name:'consumerOrder'},
  'com.youbenben.youbenben.consumerorderconfirmation.ConsumerOrderConfirmation': {name:'consumerOrderConfirmation'},
  'com.youbenben.youbenben.consumerorderapproval.ConsumerOrderApproval': {name:'consumerOrderApproval'},
  'com.youbenben.youbenben.consumerorderprocessing.ConsumerOrderProcessing': {name:'consumerOrderProcessing'},
  'com.youbenben.youbenben.consumerordershipment.ConsumerOrderShipment': {name:'consumerOrderShipment'},
  'com.youbenben.youbenben.consumerorderdelivery.ConsumerOrderDelivery': {name:'consumerOrderDelivery'},
  'com.youbenben.youbenben.consumerorderlineitem.ConsumerOrderLineItem': {name:'consumerOrderLineItem'},
  'com.youbenben.youbenben.consumerordershippinggroup.ConsumerOrderShippingGroup': {name:'consumerOrderShippingGroup'},
  'com.youbenben.youbenben.consumerorderpaymentgroup.ConsumerOrderPaymentGroup': {name:'consumerOrderPaymentGroup'},
  'com.youbenben.youbenben.consumerorderpriceadjustment.ConsumerOrderPriceAdjustment': {name:'consumerOrderPriceAdjustment'},
  'com.youbenben.youbenben.retailstoremembercoupon.RetailStoreMemberCoupon': {name:'retailStoreMemberCoupon'},
  'com.youbenben.youbenben.memberwishlist.MemberWishlist': {name:'memberWishlist'},
  'com.youbenben.youbenben.memberrewardpoint.MemberRewardPoint': {name:'memberRewardPoint'},
  'com.youbenben.youbenben.memberrewardpointredemption.MemberRewardPointRedemption': {name:'memberRewardPointRedemption'},
  'com.youbenben.youbenben.memberwishlistproduct.MemberWishlistProduct': {name:'memberWishlistProduct'},
  'com.youbenben.youbenben.retailstorememberaddress.RetailStoreMemberAddress': {name:'retailStoreMemberAddress'},
  'com.youbenben.youbenben.retailstoremembergiftcard.RetailStoreMemberGiftCard': {name:'retailStoreMemberGiftCard'},
  'com.youbenben.youbenben.retailstoremembergiftcardconsumerecord.RetailStoreMemberGiftCardConsumeRecord': {name:'retailStoreMemberGiftCardConsumeRecord'},
  'com.youbenben.youbenben.goodssupplier.GoodsSupplier': {name:'goodsSupplier'},
  'com.youbenben.youbenben.supplierproduct.SupplierProduct': {name:'supplierProduct'},
  'com.youbenben.youbenben.productsupplyduration.ProductSupplyDuration': {name:'productSupplyDuration'},
  'com.youbenben.youbenben.supplyorder.SupplyOrder': {name:'supplyOrder'},
  'com.youbenben.youbenben.supplyorderconfirmation.SupplyOrderConfirmation': {name:'supplyOrderConfirmation'},
  'com.youbenben.youbenben.supplyorderapproval.SupplyOrderApproval': {name:'supplyOrderApproval'},
  'com.youbenben.youbenben.supplyorderprocessing.SupplyOrderProcessing': {name:'supplyOrderProcessing'},
  'com.youbenben.youbenben.supplyorderpicking.SupplyOrderPicking': {name:'supplyOrderPicking'},
  'com.youbenben.youbenben.supplyordershipment.SupplyOrderShipment': {name:'supplyOrderShipment'},
  'com.youbenben.youbenben.supplyorderdelivery.SupplyOrderDelivery': {name:'supplyOrderDelivery'},
  'com.youbenben.youbenben.supplyorderlineitem.SupplyOrderLineItem': {name:'supplyOrderLineItem'},
  'com.youbenben.youbenben.supplyordershippinggroup.SupplyOrderShippingGroup': {name:'supplyOrderShippingGroup'},
  'com.youbenben.youbenben.supplyorderpaymentgroup.SupplyOrderPaymentGroup': {name:'supplyOrderPaymentGroup'},
  'com.youbenben.youbenben.retailstoreorder.RetailStoreOrder': {name:'retailStoreOrder'},
  'com.youbenben.youbenben.retailstoreorderconfirmation.RetailStoreOrderConfirmation': {name:'retailStoreOrderConfirmation'},
  'com.youbenben.youbenben.retailstoreorderapproval.RetailStoreOrderApproval': {name:'retailStoreOrderApproval'},
  'com.youbenben.youbenben.retailstoreorderprocessing.RetailStoreOrderProcessing': {name:'retailStoreOrderProcessing'},
  'com.youbenben.youbenben.retailstoreorderpicking.RetailStoreOrderPicking': {name:'retailStoreOrderPicking'},
  'com.youbenben.youbenben.retailstoreordershipment.RetailStoreOrderShipment': {name:'retailStoreOrderShipment'},
  'com.youbenben.youbenben.retailstoreorderdelivery.RetailStoreOrderDelivery': {name:'retailStoreOrderDelivery'},
  'com.youbenben.youbenben.retailstoreorderlineitem.RetailStoreOrderLineItem': {name:'retailStoreOrderLineItem'},
  'com.youbenben.youbenben.retailstoreordershippinggroup.RetailStoreOrderShippingGroup': {name:'retailStoreOrderShippingGroup'},
  'com.youbenben.youbenben.retailstoreorderpaymentgroup.RetailStoreOrderPaymentGroup': {name:'retailStoreOrderPaymentGroup'},
  'com.youbenben.youbenben.warehouse.Warehouse': {name:'warehouse'},
  'com.youbenben.youbenben.storagespace.StorageSpace': {name:'storageSpace'},
  'com.youbenben.youbenben.smartpallet.SmartPallet': {name:'smartPallet'},
  'com.youbenben.youbenben.goodsshelf.GoodsShelf': {name:'goodsShelf'},
  'com.youbenben.youbenben.goodsshelfstockcount.GoodsShelfStockCount': {name:'goodsShelfStockCount'},
  'com.youbenben.youbenben.stockcountissuetrack.StockCountIssueTrack': {name:'stockCountIssueTrack'},
  'com.youbenben.youbenben.goodsallocation.GoodsAllocation': {name:'goodsAllocation'},
  'com.youbenben.youbenben.goods.Goods': {name:'goods'},
  'com.youbenben.youbenben.goodspackaging.GoodsPackaging': {name:'goodsPackaging'},
  'com.youbenben.youbenben.goodsmovement.GoodsMovement': {name:'goodsMovement'},
  'com.youbenben.youbenben.supplierspace.SupplierSpace': {name:'supplierSpace'},
  'com.youbenben.youbenben.receivingspace.ReceivingSpace': {name:'receivingSpace'},
  'com.youbenben.youbenben.shippingspace.ShippingSpace': {name:'shippingSpace'},
  'com.youbenben.youbenben.damagespace.DamageSpace': {name:'damageSpace'},
  'com.youbenben.youbenben.warehouseasset.WarehouseAsset': {name:'warehouseAsset'},
  'com.youbenben.youbenben.transportfleet.TransportFleet': {name:'transportFleet'},
  'com.youbenben.youbenben.transporttruck.TransportTruck': {name:'transportTruck'},
  'com.youbenben.youbenben.truckdriver.TruckDriver': {name:'truckDriver'},
  'com.youbenben.youbenben.transporttask.TransportTask': {name:'transportTask'},
  'com.youbenben.youbenben.transporttasktrack.TransportTaskTrack': {name:'transportTaskTrack'},
  'com.youbenben.youbenben.accountset.AccountSet': {name:'accountSet'},
  'com.youbenben.youbenben.accountingsubject.AccountingSubject': {name:'accountingSubject'},
  'com.youbenben.youbenben.accountingperiod.AccountingPeriod': {name:'accountingPeriod'},
  'com.youbenben.youbenben.accountingdocumenttype.AccountingDocumentType': {name:'accountingDocumentType'},
  'com.youbenben.youbenben.accountingdocument.AccountingDocument': {name:'accountingDocument'},
  'com.youbenben.youbenben.accountingdocumentcreation.AccountingDocumentCreation': {name:'accountingDocumentCreation'},
  'com.youbenben.youbenben.accountingdocumentconfirmation.AccountingDocumentConfirmation': {name:'accountingDocumentConfirmation'},
  'com.youbenben.youbenben.accountingdocumentauditing.AccountingDocumentAuditing': {name:'accountingDocumentAuditing'},
  'com.youbenben.youbenben.accountingdocumentposting.AccountingDocumentPosting': {name:'accountingDocumentPosting'},
  'com.youbenben.youbenben.originalvoucher.OriginalVoucher': {name:'originalVoucher'},
  'com.youbenben.youbenben.originalvouchercreation.OriginalVoucherCreation': {name:'originalVoucherCreation'},
  'com.youbenben.youbenben.originalvoucherconfirmation.OriginalVoucherConfirmation': {name:'originalVoucherConfirmation'},
  'com.youbenben.youbenben.originalvoucherauditing.OriginalVoucherAuditing': {name:'originalVoucherAuditing'},
  'com.youbenben.youbenben.accountingdocumentline.AccountingDocumentLine': {name:'accountingDocumentLine'},
  'com.youbenben.youbenben.levelonedepartment.LevelOneDepartment': {name:'levelOneDepartment'},
  'com.youbenben.youbenben.leveltwodepartment.LevelTwoDepartment': {name:'levelTwoDepartment'},
  'com.youbenben.youbenben.levelthreedepartment.LevelThreeDepartment': {name:'levelThreeDepartment'},
  'com.youbenben.youbenben.skilltype.SkillType': {name:'skillType'},
  'com.youbenben.youbenben.responsibilitytype.ResponsibilityType': {name:'responsibilityType'},
  'com.youbenben.youbenben.terminationreason.TerminationReason': {name:'terminationReason'},
  'com.youbenben.youbenben.terminationtype.TerminationType': {name:'terminationType'},
  'com.youbenben.youbenben.occupationtype.OccupationType': {name:'occupationType'},
  'com.youbenben.youbenben.leavetype.LeaveType': {name:'leaveType'},
  'com.youbenben.youbenben.salarygrade.SalaryGrade': {name:'salaryGrade'},
  'com.youbenben.youbenben.interviewtype.InterviewType': {name:'interviewType'},
  'com.youbenben.youbenben.trainingcoursetype.TrainingCourseType': {name:'trainingCourseType'},
  'com.youbenben.youbenben.publicholiday.PublicHoliday': {name:'publicHoliday'},
  'com.youbenben.youbenben.termination.Termination': {name:'termination'},
  'com.youbenben.youbenben.view.View': {name:'view'},
  'com.youbenben.youbenben.employee.Employee': {name:'employee'},
  'com.youbenben.youbenben.jobapplication.JobApplication': {name:'jobApplication'},
  'com.youbenben.youbenben.professioninterview.ProfessionInterview': {name:'professionInterview'},
  'com.youbenben.youbenben.hrinterview.HrInterview': {name:'hrInterview'},
  'com.youbenben.youbenben.offerapproval.OfferApproval': {name:'offerApproval'},
  'com.youbenben.youbenben.offeracceptance.OfferAcceptance': {name:'offerAcceptance'},
  'com.youbenben.youbenben.employeeboarding.EmployeeBoarding': {name:'employeeBoarding'},
  'com.youbenben.youbenben.instructor.Instructor': {name:'instructor'},
  'com.youbenben.youbenben.companytraining.CompanyTraining': {name:'companyTraining'},
  'com.youbenben.youbenben.scoring.Scoring': {name:'scoring'},
  'com.youbenben.youbenben.employeecompanytraining.EmployeeCompanyTraining': {name:'employeeCompanyTraining'},
  'com.youbenben.youbenben.employeeskill.EmployeeSkill': {name:'employeeSkill'},
  'com.youbenben.youbenben.employeeperformance.EmployeePerformance': {name:'employeePerformance'},
  'com.youbenben.youbenben.employeeworkexperience.EmployeeWorkExperience': {name:'employeeWorkExperience'},
  'com.youbenben.youbenben.employeeleave.EmployeeLeave': {name:'employeeLeave'},
  'com.youbenben.youbenben.employeeinterview.EmployeeInterview': {name:'employeeInterview'},
  'com.youbenben.youbenben.employeeattendance.EmployeeAttendance': {name:'employeeAttendance'},
  'com.youbenben.youbenben.employeequalifier.EmployeeQualifier': {name:'employeeQualifier'},
  'com.youbenben.youbenben.employeeeducation.EmployeeEducation': {name:'employeeEducation'},
  'com.youbenben.youbenben.employeeaward.EmployeeAward': {name:'employeeAward'},
  'com.youbenben.youbenben.employeesalarysheet.EmployeeSalarySheet': {name:'employeeSalarySheet'},
  'com.youbenben.youbenben.payingoff.PayingOff': {name:'payingOff'},
  'com.youbenben.youbenben.mobileapp.MobileApp': {name:'mobileApp'},
  'com.youbenben.youbenben.page.Page': {name:'page'},
  'com.youbenben.youbenben.pagetype.PageType': {name:'pageType'},
  'com.youbenben.youbenben.slide.Slide': {name:'slide'},
  'com.youbenben.youbenben.uiaction.UiAction': {name:'uiAction'},
  'com.youbenben.youbenben.section.Section': {name:'section'},
  'com.youbenben.youbenben.userdomain.UserDomain': {name:'userDomain'},
  'com.youbenben.youbenben.userwhitelist.UserWhiteList': {name:'userWhiteList'},
  'com.youbenben.youbenben.secuser.SecUser': {name:'secUser'},
  'com.youbenben.youbenben.userapp.UserApp': {name:'userApp'},
  'com.youbenben.youbenben.quicklink.QuickLink': {name:'quickLink'},
  'com.youbenben.youbenben.listaccess.ListAccess': {name:'listAccess'},
  'com.youbenben.youbenben.loginhistory.LoginHistory': {name:'loginHistory'},
  'com.youbenben.youbenben.candidatecontainer.CandidateContainer': {name:'candidateContainer'},
  'com.youbenben.youbenben.candidateelement.CandidateElement': {name:'candidateElement'},
  'com.youbenben.youbenben.wechatworkappidentify.WechatWorkappIdentify': {name:'wechatWorkappIdentify'},
  'com.youbenben.youbenben.wechatminiappidentify.WechatMiniappIdentify': {name:'wechatMiniappIdentify'},
  'com.youbenben.youbenben.keypairidentify.KeypairIdentify': {name:'keypairIdentify'},
  'com.youbenben.youbenben.publickeytype.PublicKeyType': {name:'publicKeyType'},
  'com.youbenben.youbenben.treenode.TreeNode': {name:'treeNode'},
