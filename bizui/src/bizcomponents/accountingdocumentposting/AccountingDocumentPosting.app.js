 ...
 getNavMenuItems = (targetObject, style, customTheme) => {
  ...
  getAccountingDocumentSearch = () => {
    ...
    return connect(state => ({
      rule: state.rule,
      name: window.mtrans('accounting_document','accounting_document_posting.accounting_document_list',false),
  ...
  getRequestTypeStepForm = () => {
    ...
    return connect(state => ({
      ...
      role: "cq",
      currentUpdateIndex: state._accountingDocumentPosting.currentUpdateIndex,
      owner: { type: '_accountingDocumentPosting', id: state._accountingDocumentPosting.id, listName: 'nolist', ref:state._accountingDocumentPosting, listDisplayName: appLocaleName(userContext,"List") }, // this is for model namespace and
      ...
      {this.state.showSearch&&(
       ...
       <Sider
        ...
        >
         ...
         {this.getNavMenuItems(this.props.accountingDocumentPosting,"inline","dark")}
