 ...
 getNavMenuItems = (targetObject, style, customTheme) => {
  ...
  getRequestTypeStepForm = () => {
    ...
    return connect(state => ({
      selectedRows: state._consumerOrderDelivery.selectedRows,
      role: "cq",
      currentUpdateIndex: state._consumerOrderDelivery.currentUpdateIndex,
      owner: { type: '_consumerOrderDelivery', id: state._consumerOrderDelivery.id, listName: 'nolist', ref:state._consumerOrderDelivery, listDisplayName: appLocaleName(userContext,"List") }, // this is for model namespace and
      ...
      {this.state.showSearch&&(
       ...
       <Sider
        ...
        >
         ...
         {this.getNavMenuItems(this.props.consumerOrderDelivery,"inline","dark")}
