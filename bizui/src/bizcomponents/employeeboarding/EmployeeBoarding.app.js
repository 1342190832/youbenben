 ...
 getNavMenuItems = (targetObject, style, customTheme) => {
  ...
  getEmployeeSearch = () => {
    ...
    return connect(state => ({
      rule: state.rule,
      name: window.mtrans('employee','employee_boarding.employee_list',false),
      role: "employee",
  ...
  getRequestTypeStepForm = () => {
    ...
    return connect(state => ({
      ...
      role: "cq",
      currentUpdateIndex: state._employeeBoarding.currentUpdateIndex,
      owner: { type: '_employeeBoarding', id: state._employeeBoarding.id, listName: 'nolist', ref:state._employeeBoarding, listDisplayName: appLocaleName(userContext,"List") }, // this is for model namespace and
      ...
      {this.state.showSearch&&(
       ...
       <Sider
        ...
        >
         ...
         {this.getNavMenuItems(this.props.employeeBoarding,"inline","dark")}
