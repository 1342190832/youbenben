 ...
 getNavMenuItems = (targetObject, style, customTheme) => {
  ...
  getConsumerOrderSearch = () => {
    ...
    return connect(state => ({
      rule: state.rule,
      name: window.mtrans('consumer_order','supply_order_approval.consumer_order_list',false),
      role: "consumerOrder",
  ...
  getSupplyOrderSearch = () => {
    ...
    return connect(state => ({
      rule: state.rule,
      name: window.mtrans('supply_order','supply_order_approval.supply_order_list',false),
      role: "supplyOrder",
  ...
  getRequestTypeStepForm = () => {
    ...
    return connect(state => ({
      ...
      role: "cq",
      currentUpdateIndex: state._supplyOrderApproval.currentUpdateIndex,
      owner: { type: '_supplyOrderApproval', id: state._supplyOrderApproval.id, listName: 'nolist', ref:state._supplyOrderApproval, listDisplayName: appLocaleName(userContext,"List") }, // this is for model namespace and
      ...
      {this.state.showSearch&&(
       ...
       <Sider
        ...
        >
         ...
         {this.getNavMenuItems(this.props.supplyOrderApproval,"inline","dark")}
