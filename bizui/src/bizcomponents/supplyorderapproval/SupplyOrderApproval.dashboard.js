...
<Description term="ID" style={{wordBreak: 'break-all'}}>{supplyOrderApproval.id}</Description> 
...
class SupplyOrderApprovalDashboard extends Component {
 ...
 state = {
  ...
  render() {
    ...
    const cardsData = {cardsName:window.trans('supply_order_approval'),cardsFor: "supplyOrderApproval",
    	cardsSource: this.props.supplyOrderApproval,returnURL,displayName,
  		subItems: [
{name: 'consumerOrderList', displayName: window.mtrans('consumer_order','supply_order_approval.consumer_order_list',false) ,viewGroup:'__no_group', type:'consumerOrder',count:consumerOrderCount,addFunction: true, role: 'consumerOrder', metaInfo: consumerOrderListMetaInfo, renderItem: GlobalComponents.ConsumerOrderBase.renderItemOfList},
{name: 'supplyOrderList', displayName: window.mtrans('supply_order','supply_order_approval.supply_order_list',false) ,viewGroup:'__no_group', type:'supplyOrder',count:supplyOrderCount,addFunction: true, role: 'supplyOrder', metaInfo: supplyOrderListMetaInfo, renderItem: GlobalComponents.SupplyOrderBase.renderItemOfList},
