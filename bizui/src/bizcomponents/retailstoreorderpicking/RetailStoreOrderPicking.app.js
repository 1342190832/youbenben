 ...
 getNavMenuItems = (targetObject, style, customTheme) => {
  ...
  getRetailStoreOrderSearch = () => {
    ...
    return connect(state => ({
      rule: state.rule,
      name: window.mtrans('retail_store_order','retail_store_order_picking.retail_store_order_list',false),
  ...
  getRequestTypeStepForm = () => {
    ...
    return connect(state => ({
      ...
      role: "cq",
      currentUpdateIndex: state._retailStoreOrderPicking.currentUpdateIndex,
      owner: { type: '_retailStoreOrderPicking', id: state._retailStoreOrderPicking.id, listName: 'nolist', ref:state._retailStoreOrderPicking, listDisplayName: appLocaleName(userContext,"List") }, // this is for model namespace and
      ...
      {this.state.showSearch&&(
       ...
       <Sider
        ...
        >
         ...
         {this.getNavMenuItems(this.props.retailStoreOrderPicking,"inline","dark")}
