 ...
 getNavMenuItems = (targetObject, style, customTheme) => {
  ...
  getSupplyOrderSearch = () => {
    ...
    return connect(state => ({
      rule: state.rule,
      name: window.mtrans('supply_order','supply_order_picking.supply_order_list',false),
      role: "supplyOrder",
  ...
  getRequestTypeStepForm = () => {
    ...
    return connect(state => ({
      ...
      role: "cq",
      currentUpdateIndex: state._supplyOrderPicking.currentUpdateIndex,
      owner: { type: '_supplyOrderPicking', id: state._supplyOrderPicking.id, listName: 'nolist', ref:state._supplyOrderPicking, listDisplayName: appLocaleName(userContext,"List") }, // this is for model namespace and
      ...
      {this.state.showSearch&&(
       ...
       <Sider
        ...
        >
         ...
         {this.getNavMenuItems(this.props.supplyOrderPicking,"inline","dark")}
