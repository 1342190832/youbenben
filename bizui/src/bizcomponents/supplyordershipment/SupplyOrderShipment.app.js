 ...
 getNavMenuItems = (targetObject, style, customTheme) => {
  ...
  getConsumerOrderSearch = () => {
    ...
    return connect(state => ({
      rule: state.rule,
      name: window.mtrans('consumer_order','supply_order_shipment.consumer_order_list',false),
      role: "consumerOrder",
  ...
  getSupplyOrderSearch = () => {
    ...
    return connect(state => ({
      rule: state.rule,
      name: window.mtrans('supply_order','supply_order_shipment.supply_order_list',false),
      role: "supplyOrder",
  ...
  getRequestTypeStepForm = () => {
    ...
    return connect(state => ({
      ...
      role: "cq",
      currentUpdateIndex: state._supplyOrderShipment.currentUpdateIndex,
      owner: { type: '_supplyOrderShipment', id: state._supplyOrderShipment.id, listName: 'nolist', ref:state._supplyOrderShipment, listDisplayName: appLocaleName(userContext,"List") }, // this is for model namespace and
      ...
      {this.state.showSearch&&(
       ...
       <Sider
        ...
        >
         ...
         {this.getNavMenuItems(this.props.supplyOrderShipment,"inline","dark")}
