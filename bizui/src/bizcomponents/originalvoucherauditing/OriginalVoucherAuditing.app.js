 ...
 getNavMenuItems = (targetObject, style, customTheme) => {
  ...
  getOriginalVoucherSearch = () => {
    ...
    return connect(state => ({
      rule: state.rule,
      name: window.mtrans('original_voucher','original_voucher_auditing.original_voucher_list',false),
  ...
  getRequestTypeStepForm = () => {
    ...
    return connect(state => ({
      ...
      role: "cq",
      currentUpdateIndex: state._originalVoucherAuditing.currentUpdateIndex,
      owner: { type: '_originalVoucherAuditing', id: state._originalVoucherAuditing.id, listName: 'nolist', ref:state._originalVoucherAuditing, listDisplayName: appLocaleName(userContext,"List") }, // this is for model namespace and
      ...
      {this.state.showSearch&&(
       ...
       <Sider
        ...
        >
         ...
         {this.getNavMenuItems(this.props.originalVoucherAuditing,"inline","dark")}
