...
const showAssociateDialog = (targetComponent) => {
  ...
  <div>
	...
	data={{doctorList:selectedRows}} owner={owner}  
...
class DoctorSearch extends PureComponent {
  state = {
  ...
  render(){
    ...
    const {DoctorTable} = GlobalComponents;
    const {DoctorSearchForm} = GlobalComponents;
    ...
    return (
      <PageHeaderLayout title={renderTitle()}>
        ...
        {showDeletionDialog(this,DoctorModalTable,"doctorIds")}
