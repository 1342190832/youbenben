...
import styles from './Doctor.createform.less'
...
class DoctorCreateFormBody extends Component {
  state = {
  ...
  render() {
    ...
    const internalRenderTitle = () =>{
      ...
      return (<div>{linkComp}{appLocaleName(userContext,"CreateNew")}{window.trans('doctor')}</div>)
    }
              ...
              <Col lg={24} md={24} sm={24}>
                <Form.Item label={fieldLabels.hospital} {...formItemLayout}>
                  ...
                  <CandidateList 
                    ...
                    requestFunction={DoctorService.queryCandidates}  />
          ...
          <Form >
            <Row gutter={16}>     
              ...
              <Col lg={6} md={12} sm={24}>
                <ImageComponent
                  buttonTitle={fieldLabels.shotImage}
                  handlePreview={this.handlePreview}
                  handleChange={event => this.handleImageChange(event, 'shotImage')}
...
}))(Form.create()(DoctorCreateFormBody))
