...
<Description term="车辆信息" style={{wordBreak: 'break-all'}}>{transportTruck.plateNumber}</Description> 
...
<Description term="所有人">{transportTruck.owner==null?appLocaleName(userContext,"NotAssigned"):`${transportTruck.owner.displayName}(${transportTruck.owner.id})`}
 <Icon type="swap" onClick={()=>
  showTransferModel(targetComponent,"所有人","transportFleet",TransportTruckService.requestCandidateOwner,
