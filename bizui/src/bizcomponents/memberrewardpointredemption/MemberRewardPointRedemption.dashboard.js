...
<Description term="所有人">{memberRewardPointRedemption.owner==null?appLocaleName(userContext,"NotAssigned"):`${memberRewardPointRedemption.owner.displayName}(${memberRewardPointRedemption.owner.id})`}
 <Icon type="swap" onClick={()=>
  showTransferModel(targetComponent,"所有人","retailStoreMember",MemberRewardPointRedemptionService.requestCandidateOwner,
