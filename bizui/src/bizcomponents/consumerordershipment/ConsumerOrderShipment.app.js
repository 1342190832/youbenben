 ...
 getNavMenuItems = (targetObject, style, customTheme) => {
  ...
  getRequestTypeStepForm = () => {
    ...
    return connect(state => ({
      selectedRows: state._consumerOrderShipment.selectedRows,
      role: "cq",
      currentUpdateIndex: state._consumerOrderShipment.currentUpdateIndex,
      owner: { type: '_consumerOrderShipment', id: state._consumerOrderShipment.id, listName: 'nolist', ref:state._consumerOrderShipment, listDisplayName: appLocaleName(userContext,"List") }, // this is for model namespace and
      ...
      {this.state.showSearch&&(
       ...
       <Sider
        ...
        >
         ...
         {this.getNavMenuItems(this.props.consumerOrderShipment,"inline","dark")}
