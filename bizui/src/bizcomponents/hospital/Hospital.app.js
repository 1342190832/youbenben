 ...
 getNavMenuItems = (targetObject, style, customTheme) => {
  ...
  getRequestTypeStepForm = () => {
    ...
    return connect(state => ({
      ...
      role: "cq",
      currentUpdateIndex: state._hospital.currentUpdateIndex,
      owner: { type: '_hospital', id: state._hospital.id, listName: 'nolist', ref:state._hospital, listDisplayName: appLocaleName(userContext,"List") }, // this is for model namespace and
