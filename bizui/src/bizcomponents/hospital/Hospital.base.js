...
const displayColumns = [
  { title: fieldLabels.id, debugtype: 'string', dataIndex: 'id', width: '6', render: (text, record)=>renderTextCell(text,record,'hospital') , sorter: true },
...
const renderItemOfList=(hospital, targetComponent, columCount, listName)=>{
  ...
  const userContext = null
  return (
    <Card key={`${listName}-${hospital.id}`} style={{marginTop:"10px"}}>
