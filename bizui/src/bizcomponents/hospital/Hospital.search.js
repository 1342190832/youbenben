...
class HospitalSearch extends PureComponent {
  state = {
  ...
  render(){
    ...
    const {HospitalTable} = GlobalComponents;
    const {HospitalSearchForm} = GlobalComponents;
    const {HospitalModalTable} = GlobalComponents;
    ...
    return (
      <PageHeaderLayout title={renderTitle()}>
        ...
        {showDeletionDialog(this,HospitalModalTable,"hospitalIds")}
...
export default Form.create()(HospitalSearch)
