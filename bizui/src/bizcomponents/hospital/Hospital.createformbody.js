...
class HospitalCreateFormBody extends Component {
  state = {
  ...
  render() {
    ...
    const internalRenderTitle = () =>{
      ...
      return (<div>{linkComp}{appLocaleName(userContext,"CreateNew")}{window.trans('hospital')}</div>)
    }
...
}))(Form.create()(HospitalCreateFormBody))
