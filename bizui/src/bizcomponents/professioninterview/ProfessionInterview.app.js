 ...
 getNavMenuItems = (targetObject, style, customTheme) => {
  ...
  getEmployeeSearch = () => {
    ...
    return connect(state => ({
      rule: state.rule,
      name: window.mtrans('employee','profession_interview.employee_list',false),
      role: "employee",
  ...
  getRequestTypeStepForm = () => {
    ...
    return connect(state => ({
      ...
      role: "cq",
      currentUpdateIndex: state._professionInterview.currentUpdateIndex,
      owner: { type: '_professionInterview', id: state._professionInterview.id, listName: 'nolist', ref:state._professionInterview, listDisplayName: appLocaleName(userContext,"List") }, // this is for model namespace and
      ...
      {this.state.showSearch&&(
       ...
       <Sider
        ...
        >
         ...
         {this.getNavMenuItems(this.props.professionInterview,"inline","dark")}
