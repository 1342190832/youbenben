...
<Description term="ID" style={{wordBreak: 'break-all'}}>{professionInterview.id}</Description> 
...
class ProfessionInterviewDashboard extends Component {
 ...
 state = {
  ...
  render() {
    ...
    const cardsData = {cardsName:window.trans('profession_interview'),cardsFor: "professionInterview",
    	cardsSource: this.props.professionInterview,returnURL,displayName,
  		subItems: [
{name: 'employeeList', displayName: window.mtrans('employee','profession_interview.employee_list',false) ,viewGroup:'__no_group', type:'employee',count:employeeCount,addFunction: true, role: 'employee', metaInfo: employeeListMetaInfo, renderItem: GlobalComponents.EmployeeBase.renderItemOfList},
