...
<Description term="标题" style={{wordBreak: 'break-all'}}>{stockCountIssueTrack.title}</Description> 
<Description term="计数时间">{ moment(stockCountIssueTrack.countTime).format('YYYY-MM-DD')}</Description> 
<Description term="总结" style={{wordBreak: 'break-all'}}>{stockCountIssueTrack.summary}</Description> 
