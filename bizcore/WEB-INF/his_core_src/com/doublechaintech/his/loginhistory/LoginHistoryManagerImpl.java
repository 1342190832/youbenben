...
public class LoginHistoryManagerImpl extends CustomHisCheckerManager implements LoginHistoryManager, BusinessHandler{
	...
	protected void throwExceptionWithMessage(String value) throws LoginHistoryManagerException{
 	...
 	protected LoginHistory saveLoginHistoryDetail(HisUserContext userContext, LoginHistory loginHistory) throws Exception{	
 	...
 	protected LoginHistory present(HisUserContext userContext, LoginHistory loginHistory, Map<String, Object> tokens) throws Exception {
 	...
 	public LoginHistory loadLoginHistoryDetail(HisUserContext userContext, String loginHistoryId) throws Exception{	
 	...
 	public Object view(HisUserContext userContext, String loginHistoryId) throws Exception{	
 	...
 	protected<T extends BaseEntity> void addActions(HisUserContext userContext, LoginHistory loginHistory, Map<String, Object> tokens){
	...
	}// end method of protected<T extends BaseEntity> void addActions(HisUserContext userContext, LoginHistory loginHistory, Map<String, Object> tokens){
