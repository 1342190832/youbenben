...
public interface SecUserManager extends BaseManager{
	...
	*/
	...
	//public  KeypairIdentifyManager getKeypairIdentifyManager(HisUserContext userContext, String secUserId, String publicKey, String keyTypeId ,String [] tokensExpr)  throws Exception;
	...
	public  SecUser removeKeypairIdentify(HisUserContext userContext, String secUserId, String keypairIdentifyId, int keypairIdentifyVersion,String [] tokensExpr)  throws Exception;
	public  SecUser updateKeypairIdentify(HisUserContext userContext, String secUserId, String keypairIdentifyId, int keypairIdentifyVersion, String property, String newValueExpr,String [] tokensExpr)  throws Exception;
