...
public class SecUserManagerImpl extends CustomHisCheckerManager implements SecUserManager, BusinessHandler{
	...
	protected void throwExceptionWithMessage(String value) throws SecUserManagerException{
 	...
 	protected SecUser saveSecUserDetail(HisUserContext userContext, SecUser secUser) throws Exception{	
 	...
 	protected SecUser present(HisUserContext userContext, SecUser secUser, Map<String, Object> tokens) throws Exception {
 	...
 	public SecUser loadSecUserDetail(HisUserContext userContext, String secUserId) throws Exception{	
 		SecUser secUser = loadSecUser( userContext, secUserId, allTokens());
 		return present(userContext,secUser, allTokens());
		
 	}
 	
 	public Object view(HisUserContext userContext, String secUserId) throws Exception{	
	...
	public SecUser loadSecUserWithMobile(HisUserContext userContext, String mobile, Map<String,Object>tokens) throws Exception{	
 	...
 	protected<T extends BaseEntity> void addActions(HisUserContext userContext, SecUser secUser, Map<String, Object> tokens){
	...
	}// end method of protected<T extends BaseEntity> void addActions(HisUserContext userContext, SecUser secUser, Map<String, Object> tokens){
 ...
 //--------------------------------------------------------------
	...
	protected SecUser breakWithKeypairIdentifyByKeyType(HisUserContext userContext, String secUserId, String keyTypeId,  String [] tokensExpr)
		 throws Exception{
	...
	*/
	...
	protected void checkParamsForAddingKeypairIdentify(HisUserContext userContext, String secUserId, String publicKey, String keyTypeId,String [] tokensExpr) throws Exception{
	...
	public  SecUser addKeypairIdentify(HisUserContext userContext, String secUserId, String publicKey, String keyTypeId, String [] tokensExpr) throws Exception
	{
	...
	protected void checkParamsForUpdatingKeypairIdentifyProperties(HisUserContext userContext, String secUserId,String id,String publicKey,String [] tokensExpr) throws Exception {
	...
	public  SecUser updateKeypairIdentifyProperties(HisUserContext userContext, String secUserId, String id,String publicKey, String [] tokensExpr) throws Exception
	{
	...
	protected KeypairIdentify createKeypairIdentify(HisUserContext userContext, String publicKey, String keyTypeId) throws Exception{
	...
	protected void checkParamsForRemovingKeypairIdentifyList(HisUserContext userContext, String secUserId,
	...
	public  SecUser removeKeypairIdentifyList(HisUserContext userContext, String secUserId,
			String keypairIdentifyIds[],String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForRemovingKeypairIdentify(HisUserContext userContext, String secUserId,
	...
	public  SecUser removeKeypairIdentify(HisUserContext userContext, String secUserId,
		String keypairIdentifyId, int keypairIdentifyVersion,String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForCopyingKeypairIdentify(HisUserContext userContext, String secUserId,
		String keypairIdentifyId, int keypairIdentifyVersion,String [] tokensExpr) throws Exception{
	...
	public  SecUser copyKeypairIdentifyFrom(HisUserContext userContext, String secUserId,
		String keypairIdentifyId, int keypairIdentifyVersion,String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForUpdatingKeypairIdentify(HisUserContext userContext, String secUserId, String keypairIdentifyId, int keypairIdentifyVersion, String property, String newValueExpr,String [] tokensExpr) throws Exception{
	...
	public  SecUser updateKeypairIdentify(HisUserContext userContext, String secUserId, String keypairIdentifyId, int keypairIdentifyVersion, String property, String newValueExpr,String [] tokensExpr)
			throws Exception{
