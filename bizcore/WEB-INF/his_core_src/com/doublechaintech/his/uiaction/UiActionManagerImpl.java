...
import com.doublechaintech.his.page.CandidatePage;
...
public class UiActionManagerImpl extends CustomHisCheckerManager implements UiActionManager, BusinessHandler{
	...
	@Override
	public UiActionDAO daoOf(HisUserContext userContext) {
	...
	protected void throwExceptionWithMessage(String value) throws UiActionManagerException{
 	...
 	protected UiAction saveUiAction(HisUserContext userContext, UiAction uiAction, String [] tokensExpr) throws Exception{	
 	...
 	protected UiAction saveUiActionDetail(HisUserContext userContext, UiAction uiAction) throws Exception{	
 	...
 	public UiAction loadUiAction(HisUserContext userContext, String uiActionId, String [] tokensExpr) throws Exception{				
 	 ...
 	 public UiAction searchUiAction(HisUserContext userContext, String uiActionId, String textToSearch,String [] tokensExpr) throws Exception{				
 	...
 	protected UiAction present(HisUserContext userContext, UiAction uiAction, Map<String, Object> tokens) throws Exception {
 	...
 	public UiAction loadUiActionDetail(HisUserContext userContext, String uiActionId) throws Exception{	
 		UiAction uiAction = loadUiAction( userContext, uiActionId, allTokens());
 		return present(userContext,uiAction, allTokens());
		
 	}
 	
 	public Object view(HisUserContext userContext, String uiActionId) throws Exception{	
 		UiAction uiAction = loadUiAction( userContext, uiActionId, viewTokens());
 		return present(userContext,uiAction, allTokens());
		
 	}
 	protected UiAction saveUiAction(HisUserContext userContext, UiAction uiAction, Map<String,Object>tokens) throws Exception{	
 		return uiActionDaoOf(userContext).save(uiAction, tokens);
 	}
 	protected UiAction loadUiAction(HisUserContext userContext, String uiActionId, Map<String,Object>tokens) throws Exception{	
		checkerOf(userContext).checkIdOfUiAction(uiActionId);
		checkerOf(userContext).throwExceptionIfHasErrors( UiActionManagerException.class);
 	...
 	protected<T extends BaseEntity> void addActions(HisUserContext userContext, UiAction uiAction, Map<String, Object> tokens){
	...
	}// end method of protected<T extends BaseEntity> void addActions(HisUserContext userContext, UiAction uiAction, Map<String, Object> tokens){
	...
	protected void checkParamsForUpdatingUiAction(HisUserContext userContext,String uiActionId, int uiActionVersion, String property, String newValueExpr,String [] tokensExpr)throws Exception
	{
	...
	public UiAction clone(HisUserContext userContext, String fromUiActionId) throws Exception{
	...
	public UiAction internalSaveUiAction(HisUserContext userContext, UiAction uiAction, Map<String,Object> options) throws Exception
	{
	...
	public UiAction updateUiActionProperty(HisUserContext userContext,String uiActionId, int uiActionVersion, String property, String newValueExpr,String [] tokensExpr) throws Exception
	{
		checkParamsForUpdatingUiAction(userContext, uiActionId, uiActionVersion, property, newValueExpr, tokensExpr);
	...
	protected void checkParamsForTransferingAnotherPage(HisUserContext userContext, String uiActionId, String anotherPageId) throws Exception
 	{
	...
	public CandidatePage requestCandidatePage(HisUserContext userContext, String ownerClass, String id, String filterKey, int pageNo) throws Exception {
 ...
 //--------------------------------------------------------------
 	...
 	protected Page loadPage(HisUserContext userContext, String newPageId, Map<String,Object> options) throws Exception
 	{
	...
	public void delete(HisUserContext userContext, String uiActionId, int uiActionVersion) throws Exception {
	...
	public UiAction forgetByAll(HisUserContext userContext, String uiActionId, int uiActionVersion) throws Exception {
		return forgetByAllInternal(userContext, uiActionId, uiActionVersion);
	}
	protected UiAction forgetByAllInternal(HisUserContext userContext,
			String uiActionId, int uiActionVersion) throws Exception{
	...
	// -----------------------------------// list-of-view 处理 \\-----------------------------------
    protected void enhanceForListOfView(HisUserContext userContext,SmartList<UiAction> list) throws Exception {
    	if (list == null || list.isEmpty()){
    		return;
    	}
		List<Page> pageList = HisBaseUtils.collectReferencedObjectWithType(userContext, list, Page.class);
  ...
  // -----------------------------------\\ list-of-view 处理 //-----------------------------------v
	 ...
	 * @throws Exception
	 */
 	public Object wxappview(HisUserContext userContext, String uiActionId) throws Exception{
	  SerializeScope vscope = HisViewScope.getInstance().getUiActionDetailScope().clone();
