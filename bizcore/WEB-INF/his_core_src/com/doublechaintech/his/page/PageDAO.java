...
public interface PageDAO extends BaseDAO{
	...
	public SectionDAO getSectionDAO();
 	...
 	public SmartList<Page> requestCandidatePageForSection(HisUserContext userContext, String ownerClass, String id, String filterKey, int pageNo, int pageSize) throws Exception;
	...
	public SmartList<Section> loadOurSectionList(HisUserContext userContext, List<Page> us, Map<String,Object> options) throws Exception;
