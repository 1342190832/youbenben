...
public interface PageManager extends BaseManager{
	...
	*/
	...
	//public  SectionManager getSectionManager(HisUserContext userContext, String pageId, String title, String brief, String icon, String viewGroup, String linkToUrl ,String [] tokensExpr)  throws Exception;
	...
	public  Page removeSection(HisUserContext userContext, String pageId, String sectionId, int sectionVersion,String [] tokensExpr)  throws Exception;
	public  Page updateSection(HisUserContext userContext, String pageId, String sectionId, int sectionVersion, String property, String newValueExpr,String [] tokensExpr)  throws Exception;
