...
public class PageManagerImpl extends CustomHisCheckerManager implements PageManager, BusinessHandler{
 ...
 //--------------------------------------------------------------
	...
	*/
	...
	protected void checkParamsForAddingSection(HisUserContext userContext, String pageId, String title, String brief, String icon, String viewGroup, String linkToUrl,String [] tokensExpr) throws Exception{
	...
	public  Page addSection(HisUserContext userContext, String pageId, String title, String brief, String icon, String viewGroup, String linkToUrl, String [] tokensExpr) throws Exception
	{
	...
	protected void checkParamsForUpdatingSectionProperties(HisUserContext userContext, String pageId,String id,String title,String brief,String icon,String viewGroup,String linkToUrl,String [] tokensExpr) throws Exception {
	...
	public  Page updateSectionProperties(HisUserContext userContext, String pageId, String id,String title,String brief,String icon,String viewGroup,String linkToUrl, String [] tokensExpr) throws Exception
	{
	...
	protected Section createSection(HisUserContext userContext, String title, String brief, String icon, String viewGroup, String linkToUrl) throws Exception{
	...
	protected void checkParamsForRemovingSectionList(HisUserContext userContext, String pageId,
	...
	public  Page removeSectionList(HisUserContext userContext, String pageId,
			String sectionIds[],String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForRemovingSection(HisUserContext userContext, String pageId,
	...
	public  Page removeSection(HisUserContext userContext, String pageId,
		String sectionId, int sectionVersion,String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForCopyingSection(HisUserContext userContext, String pageId,
		String sectionId, int sectionVersion,String [] tokensExpr) throws Exception{
	...
	public  Page copySectionFrom(HisUserContext userContext, String pageId,
		String sectionId, int sectionVersion,String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForUpdatingSection(HisUserContext userContext, String pageId, String sectionId, int sectionVersion, String property, String newValueExpr,String [] tokensExpr) throws Exception{
	...
	public  Page updateSection(HisUserContext userContext, String pageId, String sectionId, int sectionVersion, String property, String newValueExpr,String [] tokensExpr)
			throws Exception{
  ...
  // -----------------------------------\\ list-of-view 处理 //-----------------------------------v
    ...
    String pageTitle = "页面"+"详情";
		...
		vscope.field("sectionListSection", HisListOfViewScope.getInstance()
