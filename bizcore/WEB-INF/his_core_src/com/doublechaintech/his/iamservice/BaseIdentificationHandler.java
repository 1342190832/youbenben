...
public abstract class BaseIdentificationHandler implements IdentificationHandler{
	...
	protected String getVeriyCodeCacheKey(HisUserContext userContext, String mobile) {
		return String.format("vcode:%s:%s", mobile, "login");
	}

	protected String getWehatSessionKeyCacheKey(HisUserContext userContext, String appId, String openId) {
