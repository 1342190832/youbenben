...
public class TreeNodeManagerImpl extends CustomHisCheckerManager implements TreeNodeManager, BusinessHandler{
	...
	@Override
	public TreeNodeDAO daoOf(HisUserContext userContext) {
	...
	protected void throwExceptionWithMessage(String value) throws TreeNodeManagerException{
 	...
 	protected TreeNode saveTreeNode(HisUserContext userContext, TreeNode treeNode, String [] tokensExpr) throws Exception{	
 	...
 	protected TreeNode saveTreeNodeDetail(HisUserContext userContext, TreeNode treeNode) throws Exception{	
 	...
 	public TreeNode loadTreeNode(HisUserContext userContext, String treeNodeId, String [] tokensExpr) throws Exception{				
 	 ...
 	 public TreeNode searchTreeNode(HisUserContext userContext, String treeNodeId, String textToSearch,String [] tokensExpr) throws Exception{				
 	...
 	protected TreeNode present(HisUserContext userContext, TreeNode treeNode, Map<String, Object> tokens) throws Exception {
 	...
 	public TreeNode loadTreeNodeDetail(HisUserContext userContext, String treeNodeId) throws Exception{	
 		TreeNode treeNode = loadTreeNode( userContext, treeNodeId, allTokens());
 		return present(userContext,treeNode, allTokens());
		
 	}
 	
 	public Object view(HisUserContext userContext, String treeNodeId) throws Exception{	
 		TreeNode treeNode = loadTreeNode( userContext, treeNodeId, viewTokens());
 		return present(userContext,treeNode, allTokens());
		
 	}
 	protected TreeNode saveTreeNode(HisUserContext userContext, TreeNode treeNode, Map<String,Object>tokens) throws Exception{	
 		return treeNodeDaoOf(userContext).save(treeNode, tokens);
 	}
 	protected TreeNode loadTreeNode(HisUserContext userContext, String treeNodeId, Map<String,Object>tokens) throws Exception{	
		checkerOf(userContext).checkIdOfTreeNode(treeNodeId);
		checkerOf(userContext).throwExceptionIfHasErrors( TreeNodeManagerException.class);
 	...
 	protected<T extends BaseEntity> void addActions(HisUserContext userContext, TreeNode treeNode, Map<String, Object> tokens){
	...
	}// end method of protected<T extends BaseEntity> void addActions(HisUserContext userContext, TreeNode treeNode, Map<String, Object> tokens){
	...
	protected void checkParamsForUpdatingTreeNode(HisUserContext userContext,String treeNodeId, int treeNodeVersion, String property, String newValueExpr,String [] tokensExpr)throws Exception
	{
	...
	public TreeNode clone(HisUserContext userContext, String fromTreeNodeId) throws Exception{
	...
	public TreeNode internalSaveTreeNode(HisUserContext userContext, TreeNode treeNode, Map<String,Object> options) throws Exception
	{
	...
	public TreeNode updateTreeNodeProperty(HisUserContext userContext,String treeNodeId, int treeNodeVersion, String property, String newValueExpr,String [] tokensExpr) throws Exception
	{
		checkParamsForUpdatingTreeNode(userContext, treeNodeId, treeNodeVersion, property, newValueExpr, tokensExpr);
...
//--------------------------------------------------------------
	...
	public void delete(HisUserContext userContext, String treeNodeId, int treeNodeVersion) throws Exception {
	...
	public TreeNode forgetByAll(HisUserContext userContext, String treeNodeId, int treeNodeVersion) throws Exception {
		return forgetByAllInternal(userContext, treeNodeId, treeNodeVersion);
	}
	protected TreeNode forgetByAllInternal(HisUserContext userContext,
			String treeNodeId, int treeNodeVersion) throws Exception{
	...
	// -----------------------------------// list-of-view 处理 \\-----------------------------------
    protected void enhanceForListOfView(HisUserContext userContext,SmartList<TreeNode> list) throws Exception {
  ...
  // -----------------------------------\\ list-of-view 处理 //-----------------------------------v
	 ...
	 * @throws Exception
	 */
 	public Object wxappview(HisUserContext userContext, String treeNodeId) throws Exception{
	  SerializeScope vscope = HisViewScope.getInstance().getTreeNodeDetailScope().clone();
