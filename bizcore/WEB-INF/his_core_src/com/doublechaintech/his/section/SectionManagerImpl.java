...
public class SectionManagerImpl extends CustomHisCheckerManager implements SectionManager, BusinessHandler{
	...
	public Section createSection(HisUserContext userContext, String title,String brief,String icon,String viewGroup,String linkToUrl,String pageId) throws Exception
	//public Section createSection(HisUserContext userContext,String title, String brief, String icon, String viewGroup, String linkToUrl, String pageId) throws Exception
	{
	...
	protected void checkParamsForTransferingAnotherPage(HisUserContext userContext, String sectionId, String anotherPageId) throws Exception
 	{
 	...
 	public Section transferToAnotherPage(HisUserContext userContext, String sectionId, String anotherPageId) throws Exception
 	{
