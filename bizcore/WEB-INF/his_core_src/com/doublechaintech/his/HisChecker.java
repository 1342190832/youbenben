...
public class HisChecker extends BaseChecker{
	...
	public HisChecker checkPageIdOfSection(String pageId)
	{		
	...
	public HisChecker checkIdOfKeypairIdentify(String id)
	{		
	...
	public HisChecker checkPublicKeyOfKeypairIdentify(String publicKey)
	{		
	...
	public HisChecker checkKeyTypeIdOfKeypairIdentify(String keyTypeId)
	{		
	...
	public HisChecker checkSecUserIdOfKeypairIdentify(String secUserId)
	{		
	...
	public HisChecker checkVersionOfKeypairIdentify(int version)
	{		
	...
	public HisChecker checkIdOfPublicKeyType(String id)
	{		
	...
	public HisChecker checkNameOfPublicKeyType(String name)
	{		
	...
	public HisChecker checkCodeOfPublicKeyType(String code)
	{		
	...
	public HisChecker checkDomainIdOfPublicKeyType(String domainId)
	{		
	...
	public HisChecker checkVersionOfPublicKeyType(int version)
	{		
