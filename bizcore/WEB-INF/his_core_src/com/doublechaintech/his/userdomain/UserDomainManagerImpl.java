...
//--------------------------------------------------------------
	...
	*/
	...
	protected void checkParamsForAddingPublicKeyType(HisUserContext userContext, String userDomainId, String name, String code,String [] tokensExpr) throws Exception{
	...
	public  UserDomain addPublicKeyType(HisUserContext userContext, String userDomainId, String name, String code, String [] tokensExpr) throws Exception
	{
	...
	protected void checkParamsForUpdatingPublicKeyTypeProperties(HisUserContext userContext, String userDomainId,String id,String name,String code,String [] tokensExpr) throws Exception {
	...
	public  UserDomain updatePublicKeyTypeProperties(HisUserContext userContext, String userDomainId, String id,String name,String code, String [] tokensExpr) throws Exception
	{
	...
	protected PublicKeyType createPublicKeyType(HisUserContext userContext, String name, String code) throws Exception{
	...
	protected void checkParamsForRemovingPublicKeyTypeList(HisUserContext userContext, String userDomainId,
	...
	public  UserDomain removePublicKeyTypeList(HisUserContext userContext, String userDomainId,
			String publicKeyTypeIds[],String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForRemovingPublicKeyType(HisUserContext userContext, String userDomainId,
	...
	public  UserDomain removePublicKeyType(HisUserContext userContext, String userDomainId,
		String publicKeyTypeId, int publicKeyTypeVersion,String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForCopyingPublicKeyType(HisUserContext userContext, String userDomainId,
		String publicKeyTypeId, int publicKeyTypeVersion,String [] tokensExpr) throws Exception{
	...
	public  UserDomain copyPublicKeyTypeFrom(HisUserContext userContext, String userDomainId,
		String publicKeyTypeId, int publicKeyTypeVersion,String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForUpdatingPublicKeyType(HisUserContext userContext, String userDomainId, String publicKeyTypeId, int publicKeyTypeVersion, String property, String newValueExpr,String [] tokensExpr) throws Exception{
	...
	public  UserDomain updatePublicKeyType(HisUserContext userContext, String userDomainId, String publicKeyTypeId, int publicKeyTypeVersion, String property, String newValueExpr,String [] tokensExpr)
			throws Exception{
  ...
  // -----------------------------------\\ list-of-view 处理 //-----------------------------------v
    ...
    String pageTitle = "用户域"+"详情";
		...
		vscope.field("publicKeyTypeListSection", HisListOfViewScope.getInstance()
