...
import com.doublechaintech.his.keypairidentify.KeypairIdentifyDAO;
...
public class PublicKeyTypeJDBCTemplateDAO extends HisBaseDAOImpl implements PublicKeyTypeDAO{
	...
	*/
    ...
    public SmartList<PublicKeyType> requestCandidatePublicKeyTypeForKeypairIdentify(HisUserContext userContext, String ownerClass, String id, String filterKey, int pageNo, int pageSize) throws Exception {
	...
	public SmartList<KeypairIdentify> loadOurKeypairIdentifyList(HisUserContext userContext, List<PublicKeyType> us, Map<String,Object> options) throws Exception{
