...
import com.doublechaintech.his.keypairidentify.KeypairIdentify;

import com.doublechaintech.his.userdomain.CandidateUserDomain;

import com.doublechaintech.his.publickeytype.PublicKeyType;
import com.doublechaintech.his.secuser.SecUser;
...
public class PublicKeyTypeManagerImpl extends CustomHisCheckerManager implements PublicKeyTypeManager, BusinessHandler{
	...
	@Override
	public PublicKeyTypeDAO daoOf(HisUserContext userContext) {
	...
	protected void throwExceptionWithMessage(String value) throws PublicKeyTypeManagerException{
 	...
 	protected PublicKeyType savePublicKeyType(HisUserContext userContext, PublicKeyType publicKeyType, String [] tokensExpr) throws Exception{	
 	...
 	protected PublicKeyType savePublicKeyTypeDetail(HisUserContext userContext, PublicKeyType publicKeyType) throws Exception{	
 	...
 	public PublicKeyType loadPublicKeyType(HisUserContext userContext, String publicKeyTypeId, String [] tokensExpr) throws Exception{				
 	 ...
 	 public PublicKeyType searchPublicKeyType(HisUserContext userContext, String publicKeyTypeId, String textToSearch,String [] tokensExpr) throws Exception{				
 	...
 	protected PublicKeyType present(HisUserContext userContext, PublicKeyType publicKeyType, Map<String, Object> tokens) throws Exception {
 	...
 	public PublicKeyType loadPublicKeyTypeDetail(HisUserContext userContext, String publicKeyTypeId) throws Exception{	
 	...
 	public Object view(HisUserContext userContext, String publicKeyTypeId) throws Exception{	
 		PublicKeyType publicKeyType = loadPublicKeyType( userContext, publicKeyTypeId, viewTokens());
 		return present(userContext,publicKeyType, allTokens());
		
 	}
 	protected PublicKeyType savePublicKeyType(HisUserContext userContext, PublicKeyType publicKeyType, Map<String,Object>tokens) throws Exception{	
 		return publicKeyTypeDaoOf(userContext).save(publicKeyType, tokens);
 	}
 	protected PublicKeyType loadPublicKeyType(HisUserContext userContext, String publicKeyTypeId, Map<String,Object>tokens) throws Exception{	
		checkerOf(userContext).checkIdOfPublicKeyType(publicKeyTypeId);
		checkerOf(userContext).throwExceptionIfHasErrors( PublicKeyTypeManagerException.class);
 	...
 	protected<T extends BaseEntity> void addActions(HisUserContext userContext, PublicKeyType publicKeyType, Map<String, Object> tokens){
	...
	}// end method of protected<T extends BaseEntity> void addActions(HisUserContext userContext, PublicKeyType publicKeyType, Map<String, Object> tokens){
	...
	protected void checkParamsForUpdatingPublicKeyType(HisUserContext userContext,String publicKeyTypeId, int publicKeyTypeVersion, String property, String newValueExpr,String [] tokensExpr)throws Exception
	{
	...
	public PublicKeyType clone(HisUserContext userContext, String fromPublicKeyTypeId) throws Exception{
	...
	public PublicKeyType internalSavePublicKeyType(HisUserContext userContext, PublicKeyType publicKeyType, Map<String,Object> options) throws Exception
	{
	...
	public PublicKeyType updatePublicKeyTypeProperty(HisUserContext userContext,String publicKeyTypeId, int publicKeyTypeVersion, String property, String newValueExpr,String [] tokensExpr) throws Exception
	{
		checkParamsForUpdatingPublicKeyType(userContext, publicKeyTypeId, publicKeyTypeVersion, property, newValueExpr, tokensExpr);
	...
	protected void checkParamsForTransferingAnotherDomain(HisUserContext userContext, String publicKeyTypeId, String anotherDomainId) throws Exception
 	{
 ...
 //--------------------------------------------------------------
	...
	public void delete(HisUserContext userContext, String publicKeyTypeId, int publicKeyTypeVersion) throws Exception {
	...
	public PublicKeyType forgetByAll(HisUserContext userContext, String publicKeyTypeId, int publicKeyTypeVersion) throws Exception {
		return forgetByAllInternal(userContext, publicKeyTypeId, publicKeyTypeVersion);
	}
	protected PublicKeyType forgetByAllInternal(HisUserContext userContext,
			String publicKeyTypeId, int publicKeyTypeVersion) throws Exception{
	...
	protected PublicKeyType breakWithKeypairIdentifyBySecUser(HisUserContext userContext, String publicKeyTypeId, String secUserId,  String [] tokensExpr)
		 throws Exception{
	...
	protected void checkParamsForAddingKeypairIdentify(HisUserContext userContext, String publicKeyTypeId, String publicKey, String secUserId,String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForUpdatingKeypairIdentifyProperties(HisUserContext userContext, String publicKeyTypeId,String id,String publicKey,String [] tokensExpr) throws Exception {
	...
	public  PublicKeyType updateKeypairIdentifyProperties(HisUserContext userContext, String publicKeyTypeId, String id,String publicKey, String [] tokensExpr) throws Exception
	{
	...
	protected KeypairIdentify createKeypairIdentify(HisUserContext userContext, String publicKey, String secUserId) throws Exception{
	...
	protected void checkParamsForRemovingKeypairIdentifyList(HisUserContext userContext, String publicKeyTypeId,
	...
	public  PublicKeyType removeKeypairIdentifyList(HisUserContext userContext, String publicKeyTypeId,
			String keypairIdentifyIds[],String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForRemovingKeypairIdentify(HisUserContext userContext, String publicKeyTypeId,
	...
	public  PublicKeyType removeKeypairIdentify(HisUserContext userContext, String publicKeyTypeId,
		String keypairIdentifyId, int keypairIdentifyVersion,String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForCopyingKeypairIdentify(HisUserContext userContext, String publicKeyTypeId,
		String keypairIdentifyId, int keypairIdentifyVersion,String [] tokensExpr) throws Exception{
	...
	public  PublicKeyType copyKeypairIdentifyFrom(HisUserContext userContext, String publicKeyTypeId,
		String keypairIdentifyId, int keypairIdentifyVersion,String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForUpdatingKeypairIdentify(HisUserContext userContext, String publicKeyTypeId, String keypairIdentifyId, int keypairIdentifyVersion, String property, String newValueExpr,String [] tokensExpr) throws Exception{
	...
	public  PublicKeyType updateKeypairIdentify(HisUserContext userContext, String publicKeyTypeId, String keypairIdentifyId, int keypairIdentifyVersion, String property, String newValueExpr,String [] tokensExpr)
			throws Exception{
	...
	*/
	...
	// -----------------------------------// list-of-view 处理 \\-----------------------------------
    protected void enhanceForListOfView(HisUserContext userContext,SmartList<PublicKeyType> list) throws Exception {
  ...
  // -----------------------------------\\ list-of-view 处理 //-----------------------------------v
	 ...
	 * @throws Exception
	 */
 	public Object wxappview(HisUserContext userContext, String publicKeyTypeId) throws Exception{
	  SerializeScope vscope = HisViewScope.getInstance().getPublicKeyTypeDetailScope().clone();
    ...
    String pageTitle = "公共密钥类型"+"详情";
		...
		vscope.field("keypairIdentifyListSection", HisListOfViewScope.getInstance()
