...
public class MobileAppManagerImpl extends CustomHisCheckerManager implements MobileAppManager, BusinessHandler{

	// Only some of ods have such function
	
	// To test 
	public BlobObject exportExcelFromList(HisUserContext userContext, String id, String listName) throws Exception {
	...
	@Override
	public MobileAppDAO daoOf(HisUserContext userContext) {
	...
	protected void throwExceptionWithMessage(String value) throws MobileAppManagerException{
 	...
 	protected MobileApp saveMobileApp(HisUserContext userContext, MobileApp mobileApp, String [] tokensExpr) throws Exception{	
 	...
 	protected MobileApp saveMobileAppDetail(HisUserContext userContext, MobileApp mobileApp) throws Exception{	
 	...
 	public MobileApp loadMobileApp(HisUserContext userContext, String mobileAppId, String [] tokensExpr) throws Exception{				
 	 ...
 	 public MobileApp searchMobileApp(HisUserContext userContext, String mobileAppId, String textToSearch,String [] tokensExpr) throws Exception{				
 	...
 	protected MobileApp present(HisUserContext userContext, MobileApp mobileApp, Map<String, Object> tokens) throws Exception {
 	...
 	public MobileApp loadMobileAppDetail(HisUserContext userContext, String mobileAppId) throws Exception{	
 		MobileApp mobileApp = loadMobileApp( userContext, mobileAppId, allTokens());
 		return present(userContext,mobileApp, allTokens());
		
 	}
 	
 	public Object view(HisUserContext userContext, String mobileAppId) throws Exception{	
 		MobileApp mobileApp = loadMobileApp( userContext, mobileAppId, viewTokens());
 		return present(userContext,mobileApp, allTokens());
		
 	}
 	protected MobileApp saveMobileApp(HisUserContext userContext, MobileApp mobileApp, Map<String,Object>tokens) throws Exception{	
 		return mobileAppDaoOf(userContext).save(mobileApp, tokens);
 	}
 	protected MobileApp loadMobileApp(HisUserContext userContext, String mobileAppId, Map<String,Object>tokens) throws Exception{	
		checkerOf(userContext).checkIdOfMobileApp(mobileAppId);
		checkerOf(userContext).throwExceptionIfHasErrors( MobileAppManagerException.class);
 	...
 	protected<T extends BaseEntity> void addActions(HisUserContext userContext, MobileApp mobileApp, Map<String, Object> tokens){
	...
	}// end method of protected<T extends BaseEntity> void addActions(HisUserContext userContext, MobileApp mobileApp, Map<String, Object> tokens){
	...
	protected void checkParamsForUpdatingMobileApp(HisUserContext userContext,String mobileAppId, int mobileAppVersion, String property, String newValueExpr,String [] tokensExpr)throws Exception
	{
	...
	public MobileApp clone(HisUserContext userContext, String fromMobileAppId) throws Exception{
	...
	public MobileApp internalSaveMobileApp(HisUserContext userContext, MobileApp mobileApp, Map<String,Object> options) throws Exception
	{
	...
	public MobileApp updateMobileAppProperty(HisUserContext userContext,String mobileAppId, int mobileAppVersion, String property, String newValueExpr,String [] tokensExpr) throws Exception
	{
		checkParamsForUpdatingMobileApp(userContext, mobileAppId, mobileAppVersion, property, newValueExpr, tokensExpr);
...
//--------------------------------------------------------------
	...
	public void delete(HisUserContext userContext, String mobileAppId, int mobileAppVersion) throws Exception {
	...
	public MobileApp forgetByAll(HisUserContext userContext, String mobileAppId, int mobileAppVersion) throws Exception {
		return forgetByAllInternal(userContext, mobileAppId, mobileAppVersion);
	}
	protected MobileApp forgetByAllInternal(HisUserContext userContext,
			String mobileAppId, int mobileAppVersion) throws Exception{
	...
	protected MobileApp breakWithPageByPageType(HisUserContext userContext, String mobileAppId, String pageTypeId,  String [] tokensExpr)
		 throws Exception{
	...
	protected void checkParamsForAddingPage(HisUserContext userContext, String mobileAppId, String pageTitle, String linkToUrl, String pageTypeId,String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForUpdatingPageProperties(HisUserContext userContext, String mobileAppId,String id,String pageTitle,String linkToUrl,String [] tokensExpr) throws Exception {
	...
	public  MobileApp updatePageProperties(HisUserContext userContext, String mobileAppId, String id,String pageTitle,String linkToUrl, String [] tokensExpr) throws Exception
	{
	...
	protected Page createPage(HisUserContext userContext, String pageTitle, String linkToUrl, String pageTypeId) throws Exception{
	...
	protected void checkParamsForRemovingPageList(HisUserContext userContext, String mobileAppId,
	...
	public  MobileApp removePageList(HisUserContext userContext, String mobileAppId,
			String pageIds[],String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForRemovingPage(HisUserContext userContext, String mobileAppId,
	...
	public  MobileApp removePage(HisUserContext userContext, String mobileAppId,
		String pageId, int pageVersion,String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForCopyingPage(HisUserContext userContext, String mobileAppId,
		String pageId, int pageVersion,String [] tokensExpr) throws Exception{
	...
	public  MobileApp copyPageFrom(HisUserContext userContext, String mobileAppId,
		String pageId, int pageVersion,String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForUpdatingPage(HisUserContext userContext, String mobileAppId, String pageId, int pageVersion, String property, String newValueExpr,String [] tokensExpr) throws Exception{
	...
	public  MobileApp updatePage(HisUserContext userContext, String mobileAppId, String pageId, int pageVersion, String property, String newValueExpr,String [] tokensExpr)
			throws Exception{
	...
	*/
	...
	protected void checkParamsForAddingPageType(HisUserContext userContext, String mobileAppId, String name, String code, boolean footerTab,String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForUpdatingPageTypeProperties(HisUserContext userContext, String mobileAppId,String id,String name,String code,boolean footerTab,String [] tokensExpr) throws Exception {
	...
	public  MobileApp updatePageTypeProperties(HisUserContext userContext, String mobileAppId, String id,String name,String code,boolean footerTab, String [] tokensExpr) throws Exception
	{
	...
	protected PageType createPageType(HisUserContext userContext, String name, String code, boolean footerTab) throws Exception{
	...
	protected void checkParamsForRemovingPageTypeList(HisUserContext userContext, String mobileAppId,
	...
	public  MobileApp removePageTypeList(HisUserContext userContext, String mobileAppId,
			String pageTypeIds[],String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForRemovingPageType(HisUserContext userContext, String mobileAppId,
	...
	public  MobileApp removePageType(HisUserContext userContext, String mobileAppId,
		String pageTypeId, int pageTypeVersion,String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForCopyingPageType(HisUserContext userContext, String mobileAppId,
		String pageTypeId, int pageTypeVersion,String [] tokensExpr) throws Exception{
	...
	public  MobileApp copyPageTypeFrom(HisUserContext userContext, String mobileAppId,
		String pageTypeId, int pageTypeVersion,String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForUpdatingPageType(HisUserContext userContext, String mobileAppId, String pageTypeId, int pageTypeVersion, String property, String newValueExpr,String [] tokensExpr) throws Exception{
	...
	public  MobileApp updatePageType(HisUserContext userContext, String mobileAppId, String pageTypeId, int pageTypeVersion, String property, String newValueExpr,String [] tokensExpr)
			throws Exception{
	...
	*/
	...
	public void onAuthenticateUserLogged(HisUserContext userContext, LoginContext loginContext,
		...
		((HisBizUserContextImpl)userContext).setCurrentUserInfo(app);
	}
	// -----------------------------------\\  登录部分处理 //-----------------------------------


	// -----------------------------------// list-of-view 处理 \\-----------------------------------
    protected void enhanceForListOfView(HisUserContext userContext,SmartList<MobileApp> list) throws Exception {
  ...
  // -----------------------------------\\ list-of-view 处理 //-----------------------------------v
	 ...
	 * @throws Exception
	 */
 	public Object wxappview(HisUserContext userContext, String mobileAppId) throws Exception{
	  SerializeScope vscope = HisViewScope.getInstance().getMobileAppDetailScope().clone();
