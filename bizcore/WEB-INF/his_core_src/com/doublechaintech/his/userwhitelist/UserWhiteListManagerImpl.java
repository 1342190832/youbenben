...
public class UserWhiteListManagerImpl extends CustomHisCheckerManager implements UserWhiteListManager, BusinessHandler{
	...
	@Override
	public UserWhiteListDAO daoOf(HisUserContext userContext) {
 ...
 //--------------------------------------------------------------
	...
	// -----------------------------------// list-of-view 处理 \\-----------------------------------
    protected void enhanceForListOfView(HisUserContext userContext,SmartList<UserWhiteList> list) throws Exception {
  ...
  // -----------------------------------\\ list-of-view 处理 //-----------------------------------v
	 ...
	 * @throws Exception
	 */
 	public Object wxappview(HisUserContext userContext, String userWhiteListId) throws Exception{
	  SerializeScope vscope = HisViewScope.getInstance().getUserWhiteListDetailScope().clone();
