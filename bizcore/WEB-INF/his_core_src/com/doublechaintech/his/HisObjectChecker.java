...
public class HisObjectChecker extends HisChecker{
	...
	public HisObjectChecker checkAndFixKeypairIdentify(BaseEntity keypairIdentifyAsBaseEntity){
	...
	public HisObjectChecker checkAndFixPublicKeyType(BaseEntity publicKeyTypeAsBaseEntity){
	...
	public HisObjectChecker checkSectionListOfPage(List<BaseEntity> sectionList){
		AtomicInteger index = new AtomicInteger();
	...
	public HisObjectChecker checkPageOfSection(BaseEntity pageAsBaseEntity){
	...
	public HisObjectChecker checkPublicKeyTypeListOfUserDomain(List<BaseEntity> publicKeyTypeList){
		AtomicInteger index = new AtomicInteger();
	...
	public HisObjectChecker checkKeypairIdentifyListOfSecUser(List<BaseEntity> keypairIdentifyList){
		AtomicInteger index = new AtomicInteger();
	...
	public HisObjectChecker checkKeyTypeOfKeypairIdentify(BaseEntity keyTypeAsBaseEntity){
	...
	public HisObjectChecker checkSecUserOfKeypairIdentify(BaseEntity secUserAsBaseEntity){
	...
	public HisObjectChecker checkKeypairIdentifyListOfPublicKeyType(List<BaseEntity> keypairIdentifyList){
		AtomicInteger index = new AtomicInteger();
		keypairIdentifyList.stream().forEach(keypairIdentify->
			commonObjectElementCheck(keypairIdentify,wrapArrayIndex(index.getAndIncrement()),this::checkAndFixKeypairIdentify));
		return this;
	...
	public HisObjectChecker checkDomainOfPublicKeyType(BaseEntity domainAsBaseEntity){
	...
	public HisObjectChecker assignCreateTimeOfKeypairIdentify(BaseEntity targetEntity){
		if(!isObjectForCreate(targetEntity)){
			return this;
		}
		if(userContext==null){
