...
public class DoctorJDBCTemplateDAO extends HisBaseDAOImpl implements DoctorDAO{
	...
	public void setHospitalDAO(HospitalDAO hospitalDAO){
 		...
 		if(hospitalDAO == null){
 			throw new IllegalStateException("Do not try to set hospitalDAO to null.");
 		}
	 	this.hospitalDAO = hospitalDAO;
 	}
 	public HospitalDAO getHospitalDAO(){
 		if(this.hospitalDAO == null){
 			throw new IllegalStateException("The hospitalDAO is not configured yet, please config it some where.");
 		}
	...
	public void setDoctorAssignmentDAO(DoctorAssignmentDAO doctorAssignmentDAO){
 	
 		if(doctorAssignmentDAO == null){
 			throw new IllegalStateException("Do not try to set doctorAssignmentDAO to null.");
 		}
	 	this.doctorAssignmentDAO = doctorAssignmentDAO;
 	}
	...
	*/
	...
	public SmartList<DoctorAssignment> loadOurDoctorAssignmentList(HisUserContext userContext, List<Doctor> us, Map<String,Object> options) throws Exception{
	...
	public SmartList<DoctorSchedule> loadOurDoctorScheduleList(HisUserContext userContext, List<Doctor> us, Map<String,Object> options) throws Exception{
		if (us == null || us.isEmpty()){
			return new SmartList<>();
		}
		Set<String> ids = us.stream().map(it->it.getId()).collect(Collectors.toSet());
