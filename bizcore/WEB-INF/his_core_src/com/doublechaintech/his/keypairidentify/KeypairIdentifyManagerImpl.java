...
import com.doublechaintech.his.publickeytype.CandidatePublicKeyType;
...
public class KeypairIdentifyManagerImpl extends CustomHisCheckerManager implements KeypairIdentifyManager, BusinessHandler{
	...
	@Override
	public KeypairIdentifyDAO daoOf(HisUserContext userContext) {
	...
	protected void throwExceptionWithMessage(String value) throws KeypairIdentifyManagerException{
 	...
 	protected KeypairIdentify saveKeypairIdentify(HisUserContext userContext, KeypairIdentify keypairIdentify, String [] tokensExpr) throws Exception{	
 	...
 	protected KeypairIdentify saveKeypairIdentifyDetail(HisUserContext userContext, KeypairIdentify keypairIdentify) throws Exception{	
 	...
 	public KeypairIdentify loadKeypairIdentify(HisUserContext userContext, String keypairIdentifyId, String [] tokensExpr) throws Exception{				
 	 ...
 	 public KeypairIdentify searchKeypairIdentify(HisUserContext userContext, String keypairIdentifyId, String textToSearch,String [] tokensExpr) throws Exception{				
 	...
 	protected KeypairIdentify present(HisUserContext userContext, KeypairIdentify keypairIdentify, Map<String, Object> tokens) throws Exception {
 	...
 	public KeypairIdentify loadKeypairIdentifyDetail(HisUserContext userContext, String keypairIdentifyId) throws Exception{	
 	...
 	public Object view(HisUserContext userContext, String keypairIdentifyId) throws Exception{	
 		KeypairIdentify keypairIdentify = loadKeypairIdentify( userContext, keypairIdentifyId, viewTokens());
 		return present(userContext,keypairIdentify, allTokens());
		
 	}
 	protected KeypairIdentify saveKeypairIdentify(HisUserContext userContext, KeypairIdentify keypairIdentify, Map<String,Object>tokens) throws Exception{	
 		return keypairIdentifyDaoOf(userContext).save(keypairIdentify, tokens);
 	}
 	protected KeypairIdentify loadKeypairIdentify(HisUserContext userContext, String keypairIdentifyId, Map<String,Object>tokens) throws Exception{	
		checkerOf(userContext).checkIdOfKeypairIdentify(keypairIdentifyId);
		checkerOf(userContext).throwExceptionIfHasErrors( KeypairIdentifyManagerException.class);
 	...
 	protected<T extends BaseEntity> void addActions(HisUserContext userContext, KeypairIdentify keypairIdentify, Map<String, Object> tokens){
	...
	}// end method of protected<T extends BaseEntity> void addActions(HisUserContext userContext, KeypairIdentify keypairIdentify, Map<String, Object> tokens){
	...
	protected void checkParamsForUpdatingKeypairIdentify(HisUserContext userContext,String keypairIdentifyId, int keypairIdentifyVersion, String property, String newValueExpr,String [] tokensExpr)throws Exception
	{
	...
	public KeypairIdentify clone(HisUserContext userContext, String fromKeypairIdentifyId) throws Exception{
	...
	public KeypairIdentify internalSaveKeypairIdentify(HisUserContext userContext, KeypairIdentify keypairIdentify, Map<String,Object> options) throws Exception
	{
	...
	public KeypairIdentify updateKeypairIdentifyProperty(HisUserContext userContext,String keypairIdentifyId, int keypairIdentifyVersion, String property, String newValueExpr,String [] tokensExpr) throws Exception
	{
		checkParamsForUpdatingKeypairIdentify(userContext, keypairIdentifyId, keypairIdentifyVersion, property, newValueExpr, tokensExpr);
	...
	protected void checkParamsForTransferingAnotherKeyType(HisUserContext userContext, String keypairIdentifyId, String anotherKeyTypeId) throws Exception
 	{
	...
	public CandidatePublicKeyType requestCandidateKeyType(HisUserContext userContext, String ownerClass, String id, String filterKey, int pageNo) throws Exception {
 	...
 	protected void checkParamsForTransferingAnotherSecUser(HisUserContext userContext, String keypairIdentifyId, String anotherSecUserId) throws Exception
 	{
	...
	protected void checkParamsForTransferingAnotherSecUserWithLogin(HisUserContext userContext, String keypairIdentifyId, String anotherLogin) throws Exception
 	{
 	...
 	public KeypairIdentify transferToAnotherSecUserWithLogin(HisUserContext userContext, String keypairIdentifyId, String anotherLogin) throws Exception
 	{
	...
	protected void checkParamsForTransferingAnotherSecUserWithEmail(HisUserContext userContext, String keypairIdentifyId, String anotherEmail) throws Exception
 	{
 	...
 	public KeypairIdentify transferToAnotherSecUserWithEmail(HisUserContext userContext, String keypairIdentifyId, String anotherEmail) throws Exception
 	{
	...
	protected void checkParamsForTransferingAnotherSecUserWithMobile(HisUserContext userContext, String keypairIdentifyId, String anotherMobile) throws Exception
 	{
 	...
 	public KeypairIdentify transferToAnotherSecUserWithMobile(HisUserContext userContext, String keypairIdentifyId, String anotherMobile) throws Exception
 	{
 ...
 //--------------------------------------------------------------
 	...
 	protected PublicKeyType loadPublicKeyType(HisUserContext userContext, String newKeyTypeId, Map<String,Object> options) throws Exception
 	{
	...
	public void delete(HisUserContext userContext, String keypairIdentifyId, int keypairIdentifyVersion) throws Exception {
	...
	public KeypairIdentify forgetByAll(HisUserContext userContext, String keypairIdentifyId, int keypairIdentifyVersion) throws Exception {
		return forgetByAllInternal(userContext, keypairIdentifyId, keypairIdentifyVersion);
	}
	protected KeypairIdentify forgetByAllInternal(HisUserContext userContext,
			String keypairIdentifyId, int keypairIdentifyVersion) throws Exception{
	...
	// -----------------------------------// list-of-view 处理 \\-----------------------------------
    protected void enhanceForListOfView(HisUserContext userContext,SmartList<KeypairIdentify> list) throws Exception {
    	if (list == null || list.isEmpty()){
    		return;
    	}
		List<PublicKeyType> keyTypeList = HisBaseUtils.collectReferencedObjectWithType(userContext, list, PublicKeyType.class);
  ...
  // -----------------------------------\\ list-of-view 处理 //-----------------------------------v
	 ...
	 * @throws Exception
	 */
 	public Object wxappview(HisUserContext userContext, String keypairIdentifyId) throws Exception{
	  SerializeScope vscope = HisViewScope.getInstance().getKeypairIdentifyDetailScope().clone();
