...
public class PageTypeJDBCTemplateDAO extends HisBaseDAOImpl implements PageTypeDAO{
	...
	*/
    ...
    public SmartList<PageType> requestCandidatePageTypeForPage(HisUserContext userContext, String ownerClass, String id, String filterKey, int pageNo, int pageSize) throws Exception {
	...
	public SmartList<Page> loadOurPageList(HisUserContext userContext, List<PageType> us, Map<String,Object> options) throws Exception{
