...
public class DoctorScheduleTokens extends CommonTokens{
	...
	public DoctorScheduleTokens withTokenFromListName(String listName){		
	...
	public DoctorScheduleTokens withPeriod(){		
		addSimpleOptions(PERIOD);
		return this;
	}
	...
	public DoctorScheduleTokens withHospital(){		
