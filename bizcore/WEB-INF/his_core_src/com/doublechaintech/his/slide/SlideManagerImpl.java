...
public class SlideManagerImpl extends CustomHisCheckerManager implements SlideManager, BusinessHandler{
	...
	@Override
	public SlideDAO daoOf(HisUserContext userContext) {
	...
	protected void throwExceptionWithMessage(String value) throws SlideManagerException{
 	...
 	protected Slide saveSlide(HisUserContext userContext, Slide slide, String [] tokensExpr) throws Exception{	
 	...
 	protected Slide saveSlideDetail(HisUserContext userContext, Slide slide) throws Exception{	
 	...
 	public Slide loadSlide(HisUserContext userContext, String slideId, String [] tokensExpr) throws Exception{				
 	 ...
 	 public Slide searchSlide(HisUserContext userContext, String slideId, String textToSearch,String [] tokensExpr) throws Exception{				
 	...
 	protected Slide present(HisUserContext userContext, Slide slide, Map<String, Object> tokens) throws Exception {
 	...
 	public Slide loadSlideDetail(HisUserContext userContext, String slideId) throws Exception{	
 		Slide slide = loadSlide( userContext, slideId, allTokens());
 		return present(userContext,slide, allTokens());
		
 	}
 	
 	public Object view(HisUserContext userContext, String slideId) throws Exception{	
 		Slide slide = loadSlide( userContext, slideId, viewTokens());
 		return present(userContext,slide, allTokens());
		
 	}
 	protected Slide saveSlide(HisUserContext userContext, Slide slide, Map<String,Object>tokens) throws Exception{	
 		return slideDaoOf(userContext).save(slide, tokens);
 	}
 	protected Slide loadSlide(HisUserContext userContext, String slideId, Map<String,Object>tokens) throws Exception{	
		checkerOf(userContext).checkIdOfSlide(slideId);
		checkerOf(userContext).throwExceptionIfHasErrors( SlideManagerException.class);
 	...
 	protected<T extends BaseEntity> void addActions(HisUserContext userContext, Slide slide, Map<String, Object> tokens){
	...
	}// end method of protected<T extends BaseEntity> void addActions(HisUserContext userContext, Slide slide, Map<String, Object> tokens){
	...
	protected void checkParamsForUpdatingSlide(HisUserContext userContext,String slideId, int slideVersion, String property, String newValueExpr,String [] tokensExpr)throws Exception
	{
	...
	public Slide clone(HisUserContext userContext, String fromSlideId) throws Exception{
	...
	public Slide internalSaveSlide(HisUserContext userContext, Slide slide, Map<String,Object> options) throws Exception
	{
	...
	public Slide updateSlideProperty(HisUserContext userContext,String slideId, int slideVersion, String property, String newValueExpr,String [] tokensExpr) throws Exception
	{
		checkParamsForUpdatingSlide(userContext, slideId, slideVersion, property, newValueExpr, tokensExpr);
	...
	protected void checkParamsForTransferingAnotherPage(HisUserContext userContext, String slideId, String anotherPageId) throws Exception
 	{
 ...
 //--------------------------------------------------------------
	...
	public void delete(HisUserContext userContext, String slideId, int slideVersion) throws Exception {
	...
	public Slide forgetByAll(HisUserContext userContext, String slideId, int slideVersion) throws Exception {
		return forgetByAllInternal(userContext, slideId, slideVersion);
	}
	protected Slide forgetByAllInternal(HisUserContext userContext,
			String slideId, int slideVersion) throws Exception{
	...
	// -----------------------------------// list-of-view 处理 \\-----------------------------------
    protected void enhanceForListOfView(HisUserContext userContext,SmartList<Slide> list) throws Exception {
  ...
  // -----------------------------------\\ list-of-view 处理 //-----------------------------------v
	 ...
	 * @throws Exception
	 */
 	public Object wxappview(HisUserContext userContext, String slideId) throws Exception{
	  SerializeScope vscope = HisViewScope.getInstance().getSlideDetailScope().clone();
