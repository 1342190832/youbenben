    ...
    String pageTitle = "医生的任务"+"详情";
		...
		propList.add(
				MapUtil.put("id", "3-doctor")
				    ...
				    .put("displayMode", "{\"brief\":\"update_time\",\"imageUrl\":\"shot_image\",\"name\":\"auto\",\"title\":\"name\",\"imageList\":\"\"}")
				    .into_map()
		);
		...
		propList.add(
				MapUtil.put("id", "4-department")
				    ...
				    .put("displayMode", "{\"brief\":\"update_time\",\"imageUrl\":\"\",\"name\":\"auto\",\"title\":\"name\",\"imageList\":\"\"}")
				    .into_map()
		);
