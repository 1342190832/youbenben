...
public class HisCheckerManager extends BaseManagerImpl {
	...
	public com.doublechaintech.his.keypairidentify.KeypairIdentifyManager keypairIdentifyManagerOf(HisUserContext userContext){
		return userContext.getManagerGroup().getKeypairIdentifyManager();
	}
	public com.doublechaintech.his.keypairidentify.KeypairIdentifyDAO keypairIdentifyDaoOf(HisUserContext userContext){
		return userContext.getDAOGroup().getKeypairIdentifyDAO();
	}
	public com.doublechaintech.his.publickeytype.PublicKeyTypeManager publicKeyTypeManagerOf(HisUserContext userContext){
		return userContext.getManagerGroup().getPublicKeyTypeManager();
	}
	public com.doublechaintech.his.publickeytype.PublicKeyTypeDAO publicKeyTypeDaoOf(HisUserContext userContext){
