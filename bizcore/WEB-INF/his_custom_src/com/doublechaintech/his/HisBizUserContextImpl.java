...
public class HisBizUserContextImpl extends HisUserContextImpl{
	...
	public String getPostMd5Key(HisBizUserContextImpl ctx) {
	...
	public BaseHisFormProcessor getInputFormData() {
		return inputFormData;
	}
	public void setInputFormData(BaseHisFormProcessor inputFormData) {
		this.inputFormData = inputFormData;
	}
	public BaseHisFormProcessor getOutputFormData() {
		return outputFormData;
	}
	public void setOutputFormData(BaseHisFormProcessor outputFormData) {
