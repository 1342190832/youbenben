...
public class LevelThreeCategoryJDBCTemplateDAO extends XingyouBaseDAOImpl implements LevelThreeCategoryDAO{
	...
	*/
    ...
    public SmartList<LevelThreeCategory> requestCandidateLevelThreeCategoryForProduct(XingyouUserContext userContext, String ownerClass, String id, String filterKey, int pageNo, int pageSize) throws Exception {
	...
	public SmartList<Product> loadOurProductList(XingyouUserContext userContext, List<LevelThreeCategory> us, Map<String,Object> options) throws Exception{
