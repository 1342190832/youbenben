...
import com.xingyou.xingyou.leveltwocategory.CandidateLevelTwoCategory;
...
public class LevelThreeCategoryManagerImpl extends CustomXingyouCheckerManager implements LevelThreeCategoryManager, BusinessHandler{
	...
	@Override
	public LevelThreeCategoryDAO daoOf(XingyouUserContext userContext) {
	...
	protected void throwExceptionWithMessage(String value) throws LevelThreeCategoryManagerException{
 	...
 	protected LevelThreeCategory saveLevelThreeCategory(XingyouUserContext userContext, LevelThreeCategory levelThreeCategory, String [] tokensExpr) throws Exception{	
 	...
 	protected LevelThreeCategory saveLevelThreeCategoryDetail(XingyouUserContext userContext, LevelThreeCategory levelThreeCategory) throws Exception{	
 	...
 	public LevelThreeCategory loadLevelThreeCategory(XingyouUserContext userContext, String levelThreeCategoryId, String [] tokensExpr) throws Exception{				
 	 ...
 	 public LevelThreeCategory searchLevelThreeCategory(XingyouUserContext userContext, String levelThreeCategoryId, String textToSearch,String [] tokensExpr) throws Exception{				
 	...
 	protected LevelThreeCategory present(XingyouUserContext userContext, LevelThreeCategory levelThreeCategory, Map<String, Object> tokens) throws Exception {
 	...
 	public LevelThreeCategory loadLevelThreeCategoryDetail(XingyouUserContext userContext, String levelThreeCategoryId) throws Exception{	
 	...
 	public Object view(XingyouUserContext userContext, String levelThreeCategoryId) throws Exception{	
 		LevelThreeCategory levelThreeCategory = loadLevelThreeCategory( userContext, levelThreeCategoryId, viewTokens());
 		return present(userContext,levelThreeCategory, allTokens());
		
 	}
 	protected LevelThreeCategory saveLevelThreeCategory(XingyouUserContext userContext, LevelThreeCategory levelThreeCategory, Map<String,Object>tokens) throws Exception{	
 		return levelThreeCategoryDaoOf(userContext).save(levelThreeCategory, tokens);
 	}
 	protected LevelThreeCategory loadLevelThreeCategory(XingyouUserContext userContext, String levelThreeCategoryId, Map<String,Object>tokens) throws Exception{	
		checkerOf(userContext).checkIdOfLevelThreeCategory(levelThreeCategoryId);
		checkerOf(userContext).throwExceptionIfHasErrors( LevelThreeCategoryManagerException.class);
 	...
 	protected<T extends BaseEntity> void addActions(XingyouUserContext userContext, LevelThreeCategory levelThreeCategory, Map<String, Object> tokens){
	...
	}// end method of protected<T extends BaseEntity> void addActions(XingyouUserContext userContext, LevelThreeCategory levelThreeCategory, Map<String, Object> tokens){
	...
	protected void checkParamsForUpdatingLevelThreeCategory(XingyouUserContext userContext,String levelThreeCategoryId, int levelThreeCategoryVersion, String property, String newValueExpr,String [] tokensExpr)throws Exception
	{
	...
	public LevelThreeCategory clone(XingyouUserContext userContext, String fromLevelThreeCategoryId) throws Exception{
	...
	public LevelThreeCategory internalSaveLevelThreeCategory(XingyouUserContext userContext, LevelThreeCategory levelThreeCategory, Map<String,Object> options) throws Exception
	{
	...
	public LevelThreeCategory updateLevelThreeCategoryProperty(XingyouUserContext userContext,String levelThreeCategoryId, int levelThreeCategoryVersion, String property, String newValueExpr,String [] tokensExpr) throws Exception
	{
		checkParamsForUpdatingLevelThreeCategory(userContext, levelThreeCategoryId, levelThreeCategoryVersion, property, newValueExpr, tokensExpr);
	...
	protected void checkParamsForTransferingAnotherParentCategory(XingyouUserContext userContext, String levelThreeCategoryId, String anotherParentCategoryId) throws Exception
 	{
	...
	public CandidateLevelTwoCategory requestCandidateParentCategory(XingyouUserContext userContext, String ownerClass, String id, String filterKey, int pageNo) throws Exception {
 ...
 //--------------------------------------------------------------
 	...
 	protected LevelTwoCategory loadLevelTwoCategory(XingyouUserContext userContext, String newParentCategoryId, Map<String,Object> options) throws Exception
 	{
	...
	public void delete(XingyouUserContext userContext, String levelThreeCategoryId, int levelThreeCategoryVersion) throws Exception {
	...
	public LevelThreeCategory forgetByAll(XingyouUserContext userContext, String levelThreeCategoryId, int levelThreeCategoryVersion) throws Exception {
		return forgetByAllInternal(userContext, levelThreeCategoryId, levelThreeCategoryVersion);
	}
	protected LevelThreeCategory forgetByAllInternal(XingyouUserContext userContext,
			String levelThreeCategoryId, int levelThreeCategoryVersion) throws Exception{
	...
	protected void checkParamsForAddingProduct(XingyouUserContext userContext, String levelThreeCategoryId, String name, String origin, String remark, String brand, String picture,String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForUpdatingProductProperties(XingyouUserContext userContext, String levelThreeCategoryId,String id,String name,String origin,String remark,String brand,String picture,String [] tokensExpr) throws Exception {
	...
	public  LevelThreeCategory updateProductProperties(XingyouUserContext userContext, String levelThreeCategoryId, String id,String name,String origin,String remark,String brand,String picture, String [] tokensExpr) throws Exception
	{
	...
	protected Product createProduct(XingyouUserContext userContext, String name, String origin, String remark, String brand, String picture) throws Exception{
	...
	protected void checkParamsForRemovingProductList(XingyouUserContext userContext, String levelThreeCategoryId,
	...
	public  LevelThreeCategory removeProductList(XingyouUserContext userContext, String levelThreeCategoryId,
			String productIds[],String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForRemovingProduct(XingyouUserContext userContext, String levelThreeCategoryId,
	...
	public  LevelThreeCategory removeProduct(XingyouUserContext userContext, String levelThreeCategoryId,
		String productId, int productVersion,String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForCopyingProduct(XingyouUserContext userContext, String levelThreeCategoryId,
		String productId, int productVersion,String [] tokensExpr) throws Exception{
	...
	public  LevelThreeCategory copyProductFrom(XingyouUserContext userContext, String levelThreeCategoryId,
		String productId, int productVersion,String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForUpdatingProduct(XingyouUserContext userContext, String levelThreeCategoryId, String productId, int productVersion, String property, String newValueExpr,String [] tokensExpr) throws Exception{
	...
	public  LevelThreeCategory updateProduct(XingyouUserContext userContext, String levelThreeCategoryId, String productId, int productVersion, String property, String newValueExpr,String [] tokensExpr)
			throws Exception{
	...
	*/
	...
	// -----------------------------------// list-of-view 处理 \\-----------------------------------
    protected void enhanceForListOfView(XingyouUserContext userContext,SmartList<LevelThreeCategory> list) throws Exception {
    	if (list == null || list.isEmpty()){
    		return;
    	}
		List<LevelTwoCategory> parentCategoryList = XingyouBaseUtils.collectReferencedObjectWithType(userContext, list, LevelTwoCategory.class);
  ...
  // -----------------------------------\\ list-of-view 处理 //-----------------------------------v
	 ...
	 * @throws Exception
	 */
 	public Object wxappview(XingyouUserContext userContext, String levelThreeCategoryId) throws Exception{
	  SerializeScope vscope = XingyouViewScope.getInstance().getLevelThreeCategoryDetailScope().clone();
    ...
    String pageTitle = "三级分类"+"详情";
		...
		vscope.field("productListSection", XingyouListOfViewScope.getInstance()
