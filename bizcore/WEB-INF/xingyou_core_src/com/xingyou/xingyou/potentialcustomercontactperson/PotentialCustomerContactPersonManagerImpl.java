...
public class PotentialCustomerContactPersonManagerImpl extends CustomXingyouCheckerManager implements PotentialCustomerContactPersonManager, BusinessHandler{
	...
	@Override
	public PotentialCustomerContactPersonDAO daoOf(XingyouUserContext userContext) {
	...
	protected void throwExceptionWithMessage(String value) throws PotentialCustomerContactPersonManagerException{
 	...
 	protected PotentialCustomerContactPerson savePotentialCustomerContactPerson(XingyouUserContext userContext, PotentialCustomerContactPerson potentialCustomerContactPerson, String [] tokensExpr) throws Exception{	
 	...
 	protected PotentialCustomerContactPerson savePotentialCustomerContactPersonDetail(XingyouUserContext userContext, PotentialCustomerContactPerson potentialCustomerContactPerson) throws Exception{	
 	...
 	public PotentialCustomerContactPerson loadPotentialCustomerContactPerson(XingyouUserContext userContext, String potentialCustomerContactPersonId, String [] tokensExpr) throws Exception{				
 	 ...
 	 public PotentialCustomerContactPerson searchPotentialCustomerContactPerson(XingyouUserContext userContext, String potentialCustomerContactPersonId, String textToSearch,String [] tokensExpr) throws Exception{				
 	...
 	protected PotentialCustomerContactPerson present(XingyouUserContext userContext, PotentialCustomerContactPerson potentialCustomerContactPerson, Map<String, Object> tokens) throws Exception {
 	...
 	public PotentialCustomerContactPerson loadPotentialCustomerContactPersonDetail(XingyouUserContext userContext, String potentialCustomerContactPersonId) throws Exception{	
 	...
 	public Object view(XingyouUserContext userContext, String potentialCustomerContactPersonId) throws Exception{	
 	...
 	protected PotentialCustomerContactPerson savePotentialCustomerContactPerson(XingyouUserContext userContext, PotentialCustomerContactPerson potentialCustomerContactPerson, Map<String,Object>tokens) throws Exception{	
 		return potentialCustomerContactPersonDaoOf(userContext).save(potentialCustomerContactPerson, tokens);
 	}
 	protected PotentialCustomerContactPerson loadPotentialCustomerContactPerson(XingyouUserContext userContext, String potentialCustomerContactPersonId, Map<String,Object>tokens) throws Exception{	
		checkerOf(userContext).checkIdOfPotentialCustomerContactPerson(potentialCustomerContactPersonId);
		checkerOf(userContext).throwExceptionIfHasErrors( PotentialCustomerContactPersonManagerException.class);
 	...
 	protected<T extends BaseEntity> void addActions(XingyouUserContext userContext, PotentialCustomerContactPerson potentialCustomerContactPerson, Map<String, Object> tokens){
	...
	}// end method of protected<T extends BaseEntity> void addActions(XingyouUserContext userContext, PotentialCustomerContactPerson potentialCustomerContactPerson, Map<String, Object> tokens){
	...
	protected void checkParamsForUpdatingPotentialCustomerContactPerson(XingyouUserContext userContext,String potentialCustomerContactPersonId, int potentialCustomerContactPersonVersion, String property, String newValueExpr,String [] tokensExpr)throws Exception
	{
	...
	public PotentialCustomerContactPerson clone(XingyouUserContext userContext, String fromPotentialCustomerContactPersonId) throws Exception{
	...
	public PotentialCustomerContactPerson internalSavePotentialCustomerContactPerson(XingyouUserContext userContext, PotentialCustomerContactPerson potentialCustomerContactPerson, Map<String,Object> options) throws Exception
	{
	...
	public PotentialCustomerContactPerson updatePotentialCustomerContactPersonProperty(XingyouUserContext userContext,String potentialCustomerContactPersonId, int potentialCustomerContactPersonVersion, String property, String newValueExpr,String [] tokensExpr) throws Exception
	{
		checkParamsForUpdatingPotentialCustomerContactPerson(userContext, potentialCustomerContactPersonId, potentialCustomerContactPersonVersion, property, newValueExpr, tokensExpr);
	...
	protected void checkParamsForTransferingAnotherPotentialCustomer(XingyouUserContext userContext, String potentialCustomerContactPersonId, String anotherPotentialCustomerId) throws Exception
 	{
 ...
 //--------------------------------------------------------------
	...
	public void delete(XingyouUserContext userContext, String potentialCustomerContactPersonId, int potentialCustomerContactPersonVersion) throws Exception {
	...
	public PotentialCustomerContactPerson forgetByAll(XingyouUserContext userContext, String potentialCustomerContactPersonId, int potentialCustomerContactPersonVersion) throws Exception {
		return forgetByAllInternal(userContext, potentialCustomerContactPersonId, potentialCustomerContactPersonVersion);
	}
	protected PotentialCustomerContactPerson forgetByAllInternal(XingyouUserContext userContext,
			String potentialCustomerContactPersonId, int potentialCustomerContactPersonVersion) throws Exception{
	...
	protected PotentialCustomerContactPerson breakWithPotentialCustomerContactByPotentialCustomer(XingyouUserContext userContext, String potentialCustomerContactPersonId, String potentialCustomerId,  String [] tokensExpr)
		 throws Exception{
	...
	protected PotentialCustomerContactPerson breakWithPotentialCustomerContactByCityPartner(XingyouUserContext userContext, String potentialCustomerContactPersonId, String cityPartnerId,  String [] tokensExpr)
		 throws Exception{
	...
	protected void checkParamsForAddingPotentialCustomerContact(XingyouUserContext userContext, String potentialCustomerContactPersonId, String name, Date contactDate, String contactMethod, String potentialCustomerId, String cityPartnerId, String description,String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForUpdatingPotentialCustomerContactProperties(XingyouUserContext userContext, String potentialCustomerContactPersonId,String id,String name,Date contactDate,String contactMethod,String description,String [] tokensExpr) throws Exception {
	...
	public  PotentialCustomerContactPerson updatePotentialCustomerContactProperties(XingyouUserContext userContext, String potentialCustomerContactPersonId, String id,String name,Date contactDate,String contactMethod,String description, String [] tokensExpr) throws Exception
	{
	...
	protected PotentialCustomerContact createPotentialCustomerContact(XingyouUserContext userContext, String name, Date contactDate, String contactMethod, String potentialCustomerId, String cityPartnerId, String description) throws Exception{
	...
	protected void checkParamsForRemovingPotentialCustomerContactList(XingyouUserContext userContext, String potentialCustomerContactPersonId,
	...
	public  PotentialCustomerContactPerson removePotentialCustomerContactList(XingyouUserContext userContext, String potentialCustomerContactPersonId,
			String potentialCustomerContactIds[],String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForRemovingPotentialCustomerContact(XingyouUserContext userContext, String potentialCustomerContactPersonId,
	...
	public  PotentialCustomerContactPerson removePotentialCustomerContact(XingyouUserContext userContext, String potentialCustomerContactPersonId,
		String potentialCustomerContactId, int potentialCustomerContactVersion,String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForCopyingPotentialCustomerContact(XingyouUserContext userContext, String potentialCustomerContactPersonId,
		String potentialCustomerContactId, int potentialCustomerContactVersion,String [] tokensExpr) throws Exception{
	...
	public  PotentialCustomerContactPerson copyPotentialCustomerContactFrom(XingyouUserContext userContext, String potentialCustomerContactPersonId,
		String potentialCustomerContactId, int potentialCustomerContactVersion,String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForUpdatingPotentialCustomerContact(XingyouUserContext userContext, String potentialCustomerContactPersonId, String potentialCustomerContactId, int potentialCustomerContactVersion, String property, String newValueExpr,String [] tokensExpr) throws Exception{
	...
	public  PotentialCustomerContactPerson updatePotentialCustomerContact(XingyouUserContext userContext, String potentialCustomerContactPersonId, String potentialCustomerContactId, int potentialCustomerContactVersion, String property, String newValueExpr,String [] tokensExpr)
			throws Exception{
	...
	*/
	...
	// -----------------------------------// list-of-view 处理 \\-----------------------------------
    protected void enhanceForListOfView(XingyouUserContext userContext,SmartList<PotentialCustomerContactPerson> list) throws Exception {
  ...
  // -----------------------------------\\ list-of-view 处理 //-----------------------------------v
	 ...
	 * @throws Exception
	 */
 	public Object wxappview(XingyouUserContext userContext, String potentialCustomerContactPersonId) throws Exception{
	  SerializeScope vscope = XingyouViewScope.getInstance().getPotentialCustomerContactPersonDetailScope().clone();
