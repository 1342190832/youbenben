...
public class XingyouBaseUtils {
	...
	public static String getCacheAccessKey(XingyouUserContext ctx) {
	...
	protected static BaseEntity loadCanCacheInLocal(XingyouUserContext userContext, String type, String id) throws Exception {
	...
	public static <T extends BaseEntity> List<T> collectReferencedObjectWithType(XingyouUserContext userContext,
	...
	private static <T extends BaseEntity> void collectReferedObjectIdSet(XingyouUserContext userContext,
	...
	public static int getAppBuildVersion(XingyouUserContext ctx) {
		return getBuildVersion(getRequestAppVersion(ctx));
	}
	protected static boolean startFromVersion(XingyouUserContext ctx, int version) {
     ...
     * "x-app-version" : "9"
	 */
	public static String getRequestAppVersion(XingyouUserContext userContext) {
		return userContext.getRequestHeader("x-app-version");
	}
	public static String getRequestAppDevice(XingyouUserContext userContext) {
		return userContext.getRequestHeader("x-app-device");
	}
	public static String getRequestAppType(XingyouUserContext userContext) {
	...
	public static PageType getPageType(XingyouUserContext userContext, String code) throws Exception {
	...
	public static <T> T loadBaseEntityById(XingyouUserContext ctx, String type, String id) throws Exception {
		return loadBaseEntityById(ctx, type, id, null);
	}
	public static <T> T loadBaseEntityById(XingyouUserContext ctx, String type, String id, Consumer<T> enhancer) throws Exception {
		String key = type+":"+id;
	...
	public static <T extends BaseEntity> void appendLinkToUrl(XingyouUserContext ctx, List<T> list,
			Function<T, String> makeFunc) {
		if (list == null || list.isEmpty()) {
			return;
		}
		list.forEach(it -> {
			it.addItemToValueMap(XingyouBaseConstants.X_LINK_TO_URL, makeFunc.apply(it));
		});
	}

	public static <T extends BaseEntity> void appendLinkToUrl(XingyouUserContext ctx, T obj, String url) {
		if (obj == null) {
			return;
		}
		obj.addItemToValueMap(XingyouBaseConstants.X_LINK_TO_URL, url);
	}

	public static ButtonViewComponent addAction(XingyouUserContext ctx, BaseEntity obj, String title, String code,
			String linkToUrl) {
	...
	public static void setAction(XingyouUserContext ctx, BaseEntity obj, String title, String code, String linkToUrl) {
		ButtonViewComponent actionBtn = new ButtonViewComponent(title, null, code);
		actionBtn.setLinkToUrl(linkToUrl);
