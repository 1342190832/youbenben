...
public class PublicKeyTypeManagerImpl extends CustomXingyouCheckerManager implements PublicKeyTypeManager, BusinessHandler{
	...
	@Override
	public PublicKeyTypeDAO daoOf(XingyouUserContext userContext) {
	...
	protected void throwExceptionWithMessage(String value) throws PublicKeyTypeManagerException{
 	...
 	protected PublicKeyType savePublicKeyType(XingyouUserContext userContext, PublicKeyType publicKeyType, String [] tokensExpr) throws Exception{	
 	...
 	protected PublicKeyType savePublicKeyTypeDetail(XingyouUserContext userContext, PublicKeyType publicKeyType) throws Exception{	
 	...
 	public PublicKeyType loadPublicKeyType(XingyouUserContext userContext, String publicKeyTypeId, String [] tokensExpr) throws Exception{				
 	 ...
 	 public PublicKeyType searchPublicKeyType(XingyouUserContext userContext, String publicKeyTypeId, String textToSearch,String [] tokensExpr) throws Exception{				
 	...
 	protected PublicKeyType present(XingyouUserContext userContext, PublicKeyType publicKeyType, Map<String, Object> tokens) throws Exception {
 	...
 	public PublicKeyType loadPublicKeyTypeDetail(XingyouUserContext userContext, String publicKeyTypeId) throws Exception{	
 	...
 	public Object view(XingyouUserContext userContext, String publicKeyTypeId) throws Exception{	
 		PublicKeyType publicKeyType = loadPublicKeyType( userContext, publicKeyTypeId, viewTokens());
 		return present(userContext,publicKeyType, allTokens());
		
 	}
 	protected PublicKeyType savePublicKeyType(XingyouUserContext userContext, PublicKeyType publicKeyType, Map<String,Object>tokens) throws Exception{	
 		return publicKeyTypeDaoOf(userContext).save(publicKeyType, tokens);
 	}
 	protected PublicKeyType loadPublicKeyType(XingyouUserContext userContext, String publicKeyTypeId, Map<String,Object>tokens) throws Exception{	
		checkerOf(userContext).checkIdOfPublicKeyType(publicKeyTypeId);
		checkerOf(userContext).throwExceptionIfHasErrors( PublicKeyTypeManagerException.class);
 	...
 	protected<T extends BaseEntity> void addActions(XingyouUserContext userContext, PublicKeyType publicKeyType, Map<String, Object> tokens){
	...
	}// end method of protected<T extends BaseEntity> void addActions(XingyouUserContext userContext, PublicKeyType publicKeyType, Map<String, Object> tokens){
	...
	protected void checkParamsForUpdatingPublicKeyType(XingyouUserContext userContext,String publicKeyTypeId, int publicKeyTypeVersion, String property, String newValueExpr,String [] tokensExpr)throws Exception
	{
	...
	public PublicKeyType clone(XingyouUserContext userContext, String fromPublicKeyTypeId) throws Exception{
	...
	public PublicKeyType internalSavePublicKeyType(XingyouUserContext userContext, PublicKeyType publicKeyType, Map<String,Object> options) throws Exception
	{
	...
	public PublicKeyType updatePublicKeyTypeProperty(XingyouUserContext userContext,String publicKeyTypeId, int publicKeyTypeVersion, String property, String newValueExpr,String [] tokensExpr) throws Exception
	{
		checkParamsForUpdatingPublicKeyType(userContext, publicKeyTypeId, publicKeyTypeVersion, property, newValueExpr, tokensExpr);
	...
	protected void checkParamsForTransferingAnotherDomain(XingyouUserContext userContext, String publicKeyTypeId, String anotherDomainId) throws Exception
 	{
 ...
 //--------------------------------------------------------------
	...
	public void delete(XingyouUserContext userContext, String publicKeyTypeId, int publicKeyTypeVersion) throws Exception {
	...
	public PublicKeyType forgetByAll(XingyouUserContext userContext, String publicKeyTypeId, int publicKeyTypeVersion) throws Exception {
		return forgetByAllInternal(userContext, publicKeyTypeId, publicKeyTypeVersion);
	}
	protected PublicKeyType forgetByAllInternal(XingyouUserContext userContext,
			String publicKeyTypeId, int publicKeyTypeVersion) throws Exception{
	...
	protected PublicKeyType breakWithKeypairIdentifyBySecUser(XingyouUserContext userContext, String publicKeyTypeId, String secUserId,  String [] tokensExpr)
		 throws Exception{
	...
	protected void checkParamsForAddingKeypairIdentify(XingyouUserContext userContext, String publicKeyTypeId, String publicKey, String secUserId,String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForUpdatingKeypairIdentifyProperties(XingyouUserContext userContext, String publicKeyTypeId,String id,String publicKey,String [] tokensExpr) throws Exception {
	...
	public  PublicKeyType updateKeypairIdentifyProperties(XingyouUserContext userContext, String publicKeyTypeId, String id,String publicKey, String [] tokensExpr) throws Exception
	{
	...
	protected KeypairIdentify createKeypairIdentify(XingyouUserContext userContext, String publicKey, String secUserId) throws Exception{
	...
	protected void checkParamsForRemovingKeypairIdentifyList(XingyouUserContext userContext, String publicKeyTypeId,
	...
	public  PublicKeyType removeKeypairIdentifyList(XingyouUserContext userContext, String publicKeyTypeId,
			String keypairIdentifyIds[],String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForRemovingKeypairIdentify(XingyouUserContext userContext, String publicKeyTypeId,
	...
	public  PublicKeyType removeKeypairIdentify(XingyouUserContext userContext, String publicKeyTypeId,
		String keypairIdentifyId, int keypairIdentifyVersion,String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForCopyingKeypairIdentify(XingyouUserContext userContext, String publicKeyTypeId,
		String keypairIdentifyId, int keypairIdentifyVersion,String [] tokensExpr) throws Exception{
	...
	public  PublicKeyType copyKeypairIdentifyFrom(XingyouUserContext userContext, String publicKeyTypeId,
		String keypairIdentifyId, int keypairIdentifyVersion,String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForUpdatingKeypairIdentify(XingyouUserContext userContext, String publicKeyTypeId, String keypairIdentifyId, int keypairIdentifyVersion, String property, String newValueExpr,String [] tokensExpr) throws Exception{
	...
	public  PublicKeyType updateKeypairIdentify(XingyouUserContext userContext, String publicKeyTypeId, String keypairIdentifyId, int keypairIdentifyVersion, String property, String newValueExpr,String [] tokensExpr)
			throws Exception{
	...
	*/
	...
	// -----------------------------------// list-of-view 处理 \\-----------------------------------
    protected void enhanceForListOfView(XingyouUserContext userContext,SmartList<PublicKeyType> list) throws Exception {
  ...
  // -----------------------------------\\ list-of-view 处理 //-----------------------------------v
	 ...
	 * @throws Exception
	 */
 	public Object wxappview(XingyouUserContext userContext, String publicKeyTypeId) throws Exception{
	  SerializeScope vscope = XingyouViewScope.getInstance().getPublicKeyTypeDetailScope().clone();
