...
public class LevelOneCategoryJDBCTemplateDAO extends XingyouBaseDAOImpl implements LevelOneCategoryDAO{
	...
	*/
    ...
    public SmartList<LevelOneCategory> requestCandidateLevelOneCategoryForLevelTwoCategory(XingyouUserContext userContext, String ownerClass, String id, String filterKey, int pageNo, int pageSize) throws Exception {
	...
	public SmartList<LevelTwoCategory> loadOurLevelTwoCategoryList(XingyouUserContext userContext, List<LevelOneCategory> us, Map<String,Object> options) throws Exception{
