...
import com.xingyou.xingyou.catalog.CandidateCatalog;
...
public class LevelOneCategoryManagerImpl extends CustomXingyouCheckerManager implements LevelOneCategoryManager, BusinessHandler{
	...
	@Override
	public LevelOneCategoryDAO daoOf(XingyouUserContext userContext) {
	...
	protected void throwExceptionWithMessage(String value) throws LevelOneCategoryManagerException{
 	...
 	protected LevelOneCategory saveLevelOneCategory(XingyouUserContext userContext, LevelOneCategory levelOneCategory, String [] tokensExpr) throws Exception{	
 	...
 	protected LevelOneCategory saveLevelOneCategoryDetail(XingyouUserContext userContext, LevelOneCategory levelOneCategory) throws Exception{	
 	...
 	public LevelOneCategory loadLevelOneCategory(XingyouUserContext userContext, String levelOneCategoryId, String [] tokensExpr) throws Exception{				
 	 ...
 	 public LevelOneCategory searchLevelOneCategory(XingyouUserContext userContext, String levelOneCategoryId, String textToSearch,String [] tokensExpr) throws Exception{				
 	...
 	protected LevelOneCategory present(XingyouUserContext userContext, LevelOneCategory levelOneCategory, Map<String, Object> tokens) throws Exception {
 	...
 	public LevelOneCategory loadLevelOneCategoryDetail(XingyouUserContext userContext, String levelOneCategoryId) throws Exception{	
 	...
 	public Object view(XingyouUserContext userContext, String levelOneCategoryId) throws Exception{	
 		LevelOneCategory levelOneCategory = loadLevelOneCategory( userContext, levelOneCategoryId, viewTokens());
 		return present(userContext,levelOneCategory, allTokens());
		
 	}
 	protected LevelOneCategory saveLevelOneCategory(XingyouUserContext userContext, LevelOneCategory levelOneCategory, Map<String,Object>tokens) throws Exception{	
 		return levelOneCategoryDaoOf(userContext).save(levelOneCategory, tokens);
 	}
 	protected LevelOneCategory loadLevelOneCategory(XingyouUserContext userContext, String levelOneCategoryId, Map<String,Object>tokens) throws Exception{	
		checkerOf(userContext).checkIdOfLevelOneCategory(levelOneCategoryId);
		checkerOf(userContext).throwExceptionIfHasErrors( LevelOneCategoryManagerException.class);
 	...
 	protected<T extends BaseEntity> void addActions(XingyouUserContext userContext, LevelOneCategory levelOneCategory, Map<String, Object> tokens){
	...
	}// end method of protected<T extends BaseEntity> void addActions(XingyouUserContext userContext, LevelOneCategory levelOneCategory, Map<String, Object> tokens){
	...
	protected void checkParamsForUpdatingLevelOneCategory(XingyouUserContext userContext,String levelOneCategoryId, int levelOneCategoryVersion, String property, String newValueExpr,String [] tokensExpr)throws Exception
	{
	...
	public LevelOneCategory clone(XingyouUserContext userContext, String fromLevelOneCategoryId) throws Exception{
	...
	public LevelOneCategory internalSaveLevelOneCategory(XingyouUserContext userContext, LevelOneCategory levelOneCategory, Map<String,Object> options) throws Exception
	{
	...
	public LevelOneCategory updateLevelOneCategoryProperty(XingyouUserContext userContext,String levelOneCategoryId, int levelOneCategoryVersion, String property, String newValueExpr,String [] tokensExpr) throws Exception
	{
		checkParamsForUpdatingLevelOneCategory(userContext, levelOneCategoryId, levelOneCategoryVersion, property, newValueExpr, tokensExpr);
	...
	protected void checkParamsForTransferingAnotherCatalog(XingyouUserContext userContext, String levelOneCategoryId, String anotherCatalogId) throws Exception
 	{
	...
	public CandidateCatalog requestCandidateCatalog(XingyouUserContext userContext, String ownerClass, String id, String filterKey, int pageNo) throws Exception {
 ...
 //--------------------------------------------------------------
 	...
 	protected Catalog loadCatalog(XingyouUserContext userContext, String newCatalogId, Map<String,Object> options) throws Exception
 	{
	...
	public void delete(XingyouUserContext userContext, String levelOneCategoryId, int levelOneCategoryVersion) throws Exception {
	...
	public LevelOneCategory forgetByAll(XingyouUserContext userContext, String levelOneCategoryId, int levelOneCategoryVersion) throws Exception {
		return forgetByAllInternal(userContext, levelOneCategoryId, levelOneCategoryVersion);
	}
	protected LevelOneCategory forgetByAllInternal(XingyouUserContext userContext,
			String levelOneCategoryId, int levelOneCategoryVersion) throws Exception{
	...
	protected void checkParamsForAddingLevelTwoCategory(XingyouUserContext userContext, String levelOneCategoryId, String name,String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForUpdatingLevelTwoCategoryProperties(XingyouUserContext userContext, String levelOneCategoryId,String id,String name,String [] tokensExpr) throws Exception {
	...
	public  LevelOneCategory updateLevelTwoCategoryProperties(XingyouUserContext userContext, String levelOneCategoryId, String id,String name, String [] tokensExpr) throws Exception
	{
	...
	protected LevelTwoCategory createLevelTwoCategory(XingyouUserContext userContext, String name) throws Exception{
	...
	protected void checkParamsForRemovingLevelTwoCategoryList(XingyouUserContext userContext, String levelOneCategoryId,
	...
	public  LevelOneCategory removeLevelTwoCategoryList(XingyouUserContext userContext, String levelOneCategoryId,
			String levelTwoCategoryIds[],String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForRemovingLevelTwoCategory(XingyouUserContext userContext, String levelOneCategoryId,
	...
	public  LevelOneCategory removeLevelTwoCategory(XingyouUserContext userContext, String levelOneCategoryId,
		String levelTwoCategoryId, int levelTwoCategoryVersion,String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForCopyingLevelTwoCategory(XingyouUserContext userContext, String levelOneCategoryId,
		String levelTwoCategoryId, int levelTwoCategoryVersion,String [] tokensExpr) throws Exception{
	...
	public  LevelOneCategory copyLevelTwoCategoryFrom(XingyouUserContext userContext, String levelOneCategoryId,
		String levelTwoCategoryId, int levelTwoCategoryVersion,String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForUpdatingLevelTwoCategory(XingyouUserContext userContext, String levelOneCategoryId, String levelTwoCategoryId, int levelTwoCategoryVersion, String property, String newValueExpr,String [] tokensExpr) throws Exception{
	...
	public  LevelOneCategory updateLevelTwoCategory(XingyouUserContext userContext, String levelOneCategoryId, String levelTwoCategoryId, int levelTwoCategoryVersion, String property, String newValueExpr,String [] tokensExpr)
			throws Exception{
	...
	*/
	...
	// -----------------------------------// list-of-view 处理 \\-----------------------------------
    protected void enhanceForListOfView(XingyouUserContext userContext,SmartList<LevelOneCategory> list) throws Exception {
    	if (list == null || list.isEmpty()){
    		return;
    	}
		List<Catalog> catalogList = XingyouBaseUtils.collectReferencedObjectWithType(userContext, list, Catalog.class);
  ...
  // -----------------------------------\\ list-of-view 处理 //-----------------------------------v
	 ...
	 * @throws Exception
	 */
 	public Object wxappview(XingyouUserContext userContext, String levelOneCategoryId) throws Exception{
	  SerializeScope vscope = XingyouViewScope.getInstance().getLevelOneCategoryDetailScope().clone();
    ...
    String pageTitle = "一级分类"+"详情";
		...
		vscope.field("levelTwoCategoryListSection", XingyouListOfViewScope.getInstance()
