...
public class FranchisedOutletProvinceCenterManagerImpl extends CustomXingyouCheckerManager implements FranchisedOutletProvinceCenterManager, BusinessHandler{
	...
	@Override
	public FranchisedOutletProvinceCenterDAO daoOf(XingyouUserContext userContext) {
	...
	protected void throwExceptionWithMessage(String value) throws FranchisedOutletProvinceCenterManagerException{
 	...
 	protected FranchisedOutletProvinceCenter saveFranchisedOutletProvinceCenter(XingyouUserContext userContext, FranchisedOutletProvinceCenter franchisedOutletProvinceCenter, String [] tokensExpr) throws Exception{	
 	...
 	protected FranchisedOutletProvinceCenter saveFranchisedOutletProvinceCenterDetail(XingyouUserContext userContext, FranchisedOutletProvinceCenter franchisedOutletProvinceCenter) throws Exception{	
 	...
 	public FranchisedOutletProvinceCenter loadFranchisedOutletProvinceCenter(XingyouUserContext userContext, String franchisedOutletProvinceCenterId, String [] tokensExpr) throws Exception{				
 	 ...
 	 public FranchisedOutletProvinceCenter searchFranchisedOutletProvinceCenter(XingyouUserContext userContext, String franchisedOutletProvinceCenterId, String textToSearch,String [] tokensExpr) throws Exception{				
 	...
 	protected FranchisedOutletProvinceCenter present(XingyouUserContext userContext, FranchisedOutletProvinceCenter franchisedOutletProvinceCenter, Map<String, Object> tokens) throws Exception {
 	...
 	public FranchisedOutletProvinceCenter loadFranchisedOutletProvinceCenterDetail(XingyouUserContext userContext, String franchisedOutletProvinceCenterId) throws Exception{	
 	...
 	public Object view(XingyouUserContext userContext, String franchisedOutletProvinceCenterId) throws Exception{	
 	...
 	protected FranchisedOutletProvinceCenter saveFranchisedOutletProvinceCenter(XingyouUserContext userContext, FranchisedOutletProvinceCenter franchisedOutletProvinceCenter, Map<String,Object>tokens) throws Exception{	
 		return franchisedOutletProvinceCenterDaoOf(userContext).save(franchisedOutletProvinceCenter, tokens);
 	}
 	protected FranchisedOutletProvinceCenter loadFranchisedOutletProvinceCenter(XingyouUserContext userContext, String franchisedOutletProvinceCenterId, Map<String,Object>tokens) throws Exception{	
		checkerOf(userContext).checkIdOfFranchisedOutletProvinceCenter(franchisedOutletProvinceCenterId);
		checkerOf(userContext).throwExceptionIfHasErrors( FranchisedOutletProvinceCenterManagerException.class);
 	...
 	protected<T extends BaseEntity> void addActions(XingyouUserContext userContext, FranchisedOutletProvinceCenter franchisedOutletProvinceCenter, Map<String, Object> tokens){
	...
	}// end method of protected<T extends BaseEntity> void addActions(XingyouUserContext userContext, FranchisedOutletProvinceCenter franchisedOutletProvinceCenter, Map<String, Object> tokens){
	...
	protected void checkParamsForUpdatingFranchisedOutletProvinceCenter(XingyouUserContext userContext,String franchisedOutletProvinceCenterId, int franchisedOutletProvinceCenterVersion, String property, String newValueExpr,String [] tokensExpr)throws Exception
	{
	...
	public FranchisedOutletProvinceCenter clone(XingyouUserContext userContext, String fromFranchisedOutletProvinceCenterId) throws Exception{
	...
	public FranchisedOutletProvinceCenter internalSaveFranchisedOutletProvinceCenter(XingyouUserContext userContext, FranchisedOutletProvinceCenter franchisedOutletProvinceCenter, Map<String,Object> options) throws Exception
	{
	...
	public FranchisedOutletProvinceCenter updateFranchisedOutletProvinceCenterProperty(XingyouUserContext userContext,String franchisedOutletProvinceCenterId, int franchisedOutletProvinceCenterVersion, String property, String newValueExpr,String [] tokensExpr) throws Exception
	{
		checkParamsForUpdatingFranchisedOutletProvinceCenter(userContext, franchisedOutletProvinceCenterId, franchisedOutletProvinceCenterVersion, property, newValueExpr, tokensExpr);
...
//--------------------------------------------------------------
	...
	public void delete(XingyouUserContext userContext, String franchisedOutletProvinceCenterId, int franchisedOutletProvinceCenterVersion) throws Exception {
	...
	public FranchisedOutletProvinceCenter forgetByAll(XingyouUserContext userContext, String franchisedOutletProvinceCenterId, int franchisedOutletProvinceCenterVersion) throws Exception {
		return forgetByAllInternal(userContext, franchisedOutletProvinceCenterId, franchisedOutletProvinceCenterVersion);
	}
	protected FranchisedOutletProvinceCenter forgetByAllInternal(XingyouUserContext userContext,
			String franchisedOutletProvinceCenterId, int franchisedOutletProvinceCenterVersion) throws Exception{
	...
	protected void checkParamsForAddingCatalog(XingyouUserContext userContext, String franchisedOutletProvinceCenterId, String name, int subCount, BigDecimal amount,String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForUpdatingCatalogProperties(XingyouUserContext userContext, String franchisedOutletProvinceCenterId,String id,String name,int subCount,BigDecimal amount,String [] tokensExpr) throws Exception {
	...
	public  FranchisedOutletProvinceCenter updateCatalogProperties(XingyouUserContext userContext, String franchisedOutletProvinceCenterId, String id,String name,int subCount,BigDecimal amount, String [] tokensExpr) throws Exception
	{
	...
	protected Catalog createCatalog(XingyouUserContext userContext, String name, int subCount, BigDecimal amount) throws Exception{
	...
	protected void checkParamsForRemovingCatalogList(XingyouUserContext userContext, String franchisedOutletProvinceCenterId,
	...
	public  FranchisedOutletProvinceCenter removeCatalogList(XingyouUserContext userContext, String franchisedOutletProvinceCenterId,
			String catalogIds[],String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForRemovingCatalog(XingyouUserContext userContext, String franchisedOutletProvinceCenterId,
	...
	public  FranchisedOutletProvinceCenter removeCatalog(XingyouUserContext userContext, String franchisedOutletProvinceCenterId,
		String catalogId, int catalogVersion,String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForCopyingCatalog(XingyouUserContext userContext, String franchisedOutletProvinceCenterId,
		String catalogId, int catalogVersion,String [] tokensExpr) throws Exception{
	...
	public  FranchisedOutletProvinceCenter copyCatalogFrom(XingyouUserContext userContext, String franchisedOutletProvinceCenterId,
		String catalogId, int catalogVersion,String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForUpdatingCatalog(XingyouUserContext userContext, String franchisedOutletProvinceCenterId, String catalogId, int catalogVersion, String property, String newValueExpr,String [] tokensExpr) throws Exception{
	...
	public  FranchisedOutletProvinceCenter updateCatalog(XingyouUserContext userContext, String franchisedOutletProvinceCenterId, String catalogId, int catalogVersion, String property, String newValueExpr,String [] tokensExpr)
			throws Exception{
	...
	*/
	...
	// -----------------------------------// list-of-view 处理 \\-----------------------------------
    protected void enhanceForListOfView(XingyouUserContext userContext,SmartList<FranchisedOutletProvinceCenter> list) throws Exception {
  ...
  // -----------------------------------\\ list-of-view 处理 //-----------------------------------v
	 ...
	 * @throws Exception
	 */
 	public Object wxappview(XingyouUserContext userContext, String franchisedOutletProvinceCenterId) throws Exception{
	  SerializeScope vscope = XingyouViewScope.getInstance().getFranchisedOutletProvinceCenterDetailScope().clone();
    ...
    String pageTitle = "加盟店省中心"+"详情";
		...
		vscope.field("catalogListSection", XingyouListOfViewScope.getInstance()
