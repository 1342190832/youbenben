...
public class Catalog extends BaseEntity implements  java.io.Serializable{
	...
	protected		FranchisedOutletProvinceCenter	mOwner              ;
	...
	public void setOwner(FranchisedOutletProvinceCenter owner){
		this.mOwner = owner;;
	}
	public FranchisedOutletProvinceCenter getOwner(){
		return this.mOwner;
	}
	public Catalog updateOwner(FranchisedOutletProvinceCenter owner){
		this.mOwner = owner;;
		this.changed = true;
		return this;
	}
	public void mergeOwner(FranchisedOutletProvinceCenter owner){
	...
	public String toString(){
		...
		if(getOwner() != null ){
 			stringBuilder.append("\towner='FranchisedOutletProvinceCenter("+getOwner().getId()+")';");
 		}
