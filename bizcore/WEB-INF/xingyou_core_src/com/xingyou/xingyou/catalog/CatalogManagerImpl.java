...
import com.xingyou.xingyou.franchisedoutletprovincecenter.CandidateFranchisedOutletProvinceCenter;
...
public class CatalogManagerImpl extends CustomXingyouCheckerManager implements CatalogManager, BusinessHandler{
	...
	@Override
	public CatalogDAO daoOf(XingyouUserContext userContext) {
	...
	protected void throwExceptionWithMessage(String value) throws CatalogManagerException{
 	...
 	protected Catalog saveCatalog(XingyouUserContext userContext, Catalog catalog, String [] tokensExpr) throws Exception{	
 	...
 	protected Catalog saveCatalogDetail(XingyouUserContext userContext, Catalog catalog) throws Exception{	
 	...
 	public Catalog loadCatalog(XingyouUserContext userContext, String catalogId, String [] tokensExpr) throws Exception{				
 	 ...
 	 public Catalog searchCatalog(XingyouUserContext userContext, String catalogId, String textToSearch,String [] tokensExpr) throws Exception{				
 	...
 	protected Catalog present(XingyouUserContext userContext, Catalog catalog, Map<String, Object> tokens) throws Exception {
 	...
 	public Catalog loadCatalogDetail(XingyouUserContext userContext, String catalogId) throws Exception{	
 		Catalog catalog = loadCatalog( userContext, catalogId, allTokens());
 		return present(userContext,catalog, allTokens());
		
 	}
 	
 	public Object view(XingyouUserContext userContext, String catalogId) throws Exception{	
 		Catalog catalog = loadCatalog( userContext, catalogId, viewTokens());
 		return present(userContext,catalog, allTokens());
		
 	}
 	protected Catalog saveCatalog(XingyouUserContext userContext, Catalog catalog, Map<String,Object>tokens) throws Exception{	
 		return catalogDaoOf(userContext).save(catalog, tokens);
 	}
 	protected Catalog loadCatalog(XingyouUserContext userContext, String catalogId, Map<String,Object>tokens) throws Exception{	
		checkerOf(userContext).checkIdOfCatalog(catalogId);
		checkerOf(userContext).throwExceptionIfHasErrors( CatalogManagerException.class);
 	...
 	protected<T extends BaseEntity> void addActions(XingyouUserContext userContext, Catalog catalog, Map<String, Object> tokens){
	...
	}// end method of protected<T extends BaseEntity> void addActions(XingyouUserContext userContext, Catalog catalog, Map<String, Object> tokens){
	...
	protected void checkParamsForUpdatingCatalog(XingyouUserContext userContext,String catalogId, int catalogVersion, String property, String newValueExpr,String [] tokensExpr)throws Exception
	{
	...
	public Catalog clone(XingyouUserContext userContext, String fromCatalogId) throws Exception{
	...
	public Catalog internalSaveCatalog(XingyouUserContext userContext, Catalog catalog, Map<String,Object> options) throws Exception
	{
	...
	public Catalog updateCatalogProperty(XingyouUserContext userContext,String catalogId, int catalogVersion, String property, String newValueExpr,String [] tokensExpr) throws Exception
	{
		checkParamsForUpdatingCatalog(userContext, catalogId, catalogVersion, property, newValueExpr, tokensExpr);
	...
	protected void checkParamsForTransferingAnotherOwner(XingyouUserContext userContext, String catalogId, String anotherOwnerId) throws Exception
 	{
	...
	public CandidateFranchisedOutletProvinceCenter requestCandidateOwner(XingyouUserContext userContext, String ownerClass, String id, String filterKey, int pageNo) throws Exception {
 ...
 //--------------------------------------------------------------
 	...
 	protected FranchisedOutletProvinceCenter loadFranchisedOutletProvinceCenter(XingyouUserContext userContext, String newOwnerId, Map<String,Object> options) throws Exception
 	{
	...
	public void delete(XingyouUserContext userContext, String catalogId, int catalogVersion) throws Exception {
	...
	public Catalog forgetByAll(XingyouUserContext userContext, String catalogId, int catalogVersion) throws Exception {
		return forgetByAllInternal(userContext, catalogId, catalogVersion);
	}
	protected Catalog forgetByAllInternal(XingyouUserContext userContext,
			String catalogId, int catalogVersion) throws Exception{
	...
	protected void checkParamsForAddingLevelOneCategory(XingyouUserContext userContext, String catalogId, String name,String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForUpdatingLevelOneCategoryProperties(XingyouUserContext userContext, String catalogId,String id,String name,String [] tokensExpr) throws Exception {
	...
	public  Catalog updateLevelOneCategoryProperties(XingyouUserContext userContext, String catalogId, String id,String name, String [] tokensExpr) throws Exception
	{
	...
	protected LevelOneCategory createLevelOneCategory(XingyouUserContext userContext, String name) throws Exception{
	...
	protected void checkParamsForRemovingLevelOneCategoryList(XingyouUserContext userContext, String catalogId,
	...
	public  Catalog removeLevelOneCategoryList(XingyouUserContext userContext, String catalogId,
			String levelOneCategoryIds[],String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForRemovingLevelOneCategory(XingyouUserContext userContext, String catalogId,
	...
	public  Catalog removeLevelOneCategory(XingyouUserContext userContext, String catalogId,
		String levelOneCategoryId, int levelOneCategoryVersion,String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForCopyingLevelOneCategory(XingyouUserContext userContext, String catalogId,
		String levelOneCategoryId, int levelOneCategoryVersion,String [] tokensExpr) throws Exception{
	...
	public  Catalog copyLevelOneCategoryFrom(XingyouUserContext userContext, String catalogId,
		String levelOneCategoryId, int levelOneCategoryVersion,String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForUpdatingLevelOneCategory(XingyouUserContext userContext, String catalogId, String levelOneCategoryId, int levelOneCategoryVersion, String property, String newValueExpr,String [] tokensExpr) throws Exception{
	...
	public  Catalog updateLevelOneCategory(XingyouUserContext userContext, String catalogId, String levelOneCategoryId, int levelOneCategoryVersion, String property, String newValueExpr,String [] tokensExpr)
			throws Exception{
	...
	*/
	...
	// -----------------------------------// list-of-view 处理 \\-----------------------------------
    protected void enhanceForListOfView(XingyouUserContext userContext,SmartList<Catalog> list) throws Exception {
    	if (list == null || list.isEmpty()){
    		return;
    	}
		List<FranchisedOutletProvinceCenter> ownerList = XingyouBaseUtils.collectReferencedObjectWithType(userContext, list, FranchisedOutletProvinceCenter.class);
  ...
  // -----------------------------------\\ list-of-view 处理 //-----------------------------------v
	 ...
	 * @throws Exception
	 */
 	public Object wxappview(XingyouUserContext userContext, String catalogId) throws Exception{
	  SerializeScope vscope = XingyouViewScope.getInstance().getCatalogDetailScope().clone();
    ...
    String pageTitle = "目录"+"详情";
		...
		vscope.field("levelOneCategoryListSection", XingyouListOfViewScope.getInstance()
