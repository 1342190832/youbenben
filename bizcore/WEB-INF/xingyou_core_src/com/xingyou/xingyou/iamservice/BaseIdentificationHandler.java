...
public abstract class BaseIdentificationHandler implements IdentificationHandler{
	...
	protected String getVeriyCodeCacheKey(XingyouUserContext userContext, String mobile) {
		return String.format("vcode:%s:%s", mobile, "login");
	}

	protected String getWehatSessionKeyCacheKey(XingyouUserContext userContext, String appId, String openId) {
