...
public class WechatMiniprogramHandler extends BaseIdentificationHandler {
	...
	@Override
	public LoginResult authenticate(XingyouUserContext userContext, LoginContext loginContext) {
	...
	protected boolean authenticateWithCode(XingyouUserContext userContext, String code, LoginResult result) throws Exception{
	...
	@Override
	public void bindWithSecUser(XingyouUserContext userContext, LoginContext loginContext) throws Exception {
	...
	protected SmartList<WechatMiniappIdentify> getIdentifyRecords(XingyouUserContext userContext,
