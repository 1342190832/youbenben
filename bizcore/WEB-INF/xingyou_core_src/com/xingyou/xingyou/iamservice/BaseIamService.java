...
// import com.xingyou.xingyou.XingyouBizUserContextImpl;
import com.xingyou.xingyou.XingyouUserContextImpl;
import com.xingyou.xingyou.UserContext;
...
public abstract class BaseIamService {
	...
	public LoginResult doLogin(XingyouUserContextImpl userContext, LoginContext loginContext, BusinessHandler bizHandler) throws Exception {
	 ...
	 * @throws Exception 
	 */
	protected void onAuthenticateNewUserLogged(XingyouUserContextImpl userContext, LoginContext loginContext,
	 ...
	 * 
	 */
	protected void onAuthenticateUserLogged(XingyouUserContextImpl userContext, LoginContext loginContext,
			LoginResult loginResult, IdentificationHandler idHandler, BusinessHandler bizHandler) throws Exception {
		// 回调业务
	...
	// 为兼容旧版本secUser登录接口
	public void onLoginSecUserInternalSuccess(XingyouUserContextImpl userContext, SecUser user) {
		String tokenKey = userContext.tokenId();
		// 生成 jwtToken
	 ...
	 */
	protected boolean isLoginClientSupportSession(XingyouUserContextImpl userContext, LoginContext loginContext,
	 ...
	 */
	protected void onAuthenticationFailed(XingyouUserContextImpl userContext, LoginContext loginContext, LoginResult loginResult,
	 ...
	 * @return
	 */
	protected IdentificationHandler selectIdentificationHandler(XingyouUserContextImpl userContext, LoginContext loginContext) {
		if (idHandlers == null) {
	...
	protected String getLoginInfoCacheKey(XingyouUserContextImpl userContext) {
		return this.getCacheKey(userContext, "loginInfo");
	}
	protected String getJwtTokenCacheKey(XingyouUserContextImpl userContext) {
		return this.getCacheKey(userContext, "jwtToken");
	}
	
	// 获取token key的优先级为: jwtToken->cookie->session id
	public String getTokenKey(XingyouUserContextImpl userContext) {
	...
	protected void cacheJwtToken(XingyouUserContextImpl userContext, DecodedJWT jwtToken) {
		userContext.putIntoContextLocalStorage(getJwtTokenCacheKey(userContext), jwtToken);
	}
	protected DecodedJWT getCachedJwtToken(XingyouUserContextImpl userContext) {
		return (DecodedJWT) userContext.getFromContextLocalStorage(getJwtTokenCacheKey(userContext));
	}
	
	protected DecodedJWT getJwtTokenFromCookie(XingyouUserContextImpl userContext) {
	...
	protected DecodedJWT getJwtTokenFromHeader(XingyouUserContextImpl userContext) {
	...
	public Map<String, Object> getCachedLoginInfo(XingyouUserContextImpl userContext) {
	...
	protected String getCacheKey(UserContext userContext, String prefix){
		return "xingyou:"+prefix+":"+userContext.tokenId();
	}
	protected String getUserKey(UserContext userContext){
		return "xingyou:user:"+userContext.tokenId();
	}
	protected String getCurrentAppKey(UserContext userContext){
		return getUserKey(userContext)+":currentApp";
	}
	protected void fixUserContextTokenId(XingyouUserContextImpl userContext, String tokenKey) {
		if (!userContext.tokenId().equals(tokenKey)) {
			userContext.setTokenId(tokenKey);
		}
	}
	public SecUser tryToLoadSecUser(XingyouUserContextImpl userContext, Map<String, Object> loginInfo){
		if(loginInfo == null) {
			return null;
		}
	...
	public UserApp tryToLoadUserApp(XingyouUserContextImpl userContext, Map<String, Object> loginInfo){
		if(loginInfo == null) {
			return null;
		}
	 ...
	 * @param loginInfo2 */
	public void onCheckAccessWhenAnonymousFound(XingyouUserContextImpl userContext, Map<String, Object> loginInfo) {
...
//	
//	
//	protected boolean onSecUserNotFoundWhenCheckAccess(XingyouUserContextImpl userContext, Map<String, Object> loginInfo,
//			SecUser secUser, UserApp userApp) {
//		return false;
//	}
//	protected boolean onSecUserFoundWhenCheckAccess(XingyouUserContextImpl userContext, Map<String, Object> loginInfo,
//			SecUser secUser, UserApp userApp) {
//		return true;
//	}
//	protected boolean onSecUserAppFoundWhenCheckAccess(XingyouUserContextImpl userContext, Map<String, Object> loginInfo,
//			SecUser secUser, UserApp userApp) {
//		return true;
//	}
//	protected SecUser tryToLoadSecUser(XingyouUserContextImpl userContext, Map<String, Object> loginInfo){
//		if(loginInfo == null) {
//			return null;
//		}
//		String secUserId = (String) loginInfo.get("secUser");
...
//		}
//	}
//	protected UserApp tryToLoadUserApp(XingyouUserContextImpl userContext, Map<String, Object> loginInfo){
//		if(loginInfo == null) {
//			return null;
//		}
//		
...
//	
//	
//	public Object exampleLoginByAccountPassword(XingyouUserContextImpl userContext, String acct, String password) throws Exception {
//		
//		BusinessHandler bizHandler = new BusinessHandler() {
//			public void onAuthenticationFailed(XingyouUserContextImpl userContext, LoginContext loginContext,
//					LoginResult loginResult, IdentificationHandler idHandler, BusinessHandler bizHandler)
//					throws Exception {
//				onFailExample(userContext, loginContext, loginResult, idHandler, bizHandler);
//			}
//			public void onAuthenticateNewUserLogged(XingyouUserContextImpl userContext, LoginContext loginContext,
//					LoginResult loginResult, IdentificationHandler idHandler, BusinessHandler bizHandler)
//					throws Exception {
//				onNewExample(userContext, loginContext, loginResult, idHandler, bizHandler);
//			}
//			public void onAuthenticateUserLogged(XingyouUserContextImpl userContext, LoginContext loginContext,
//					LoginResult loginResult, IdentificationHandler idHandler, BusinessHandler bizHandler)
//					throws Exception {
...
//	}
//	
//	protected Object onFailExample(XingyouUserContextImpl userContext, LoginContext loginContext, LoginResult loginResult,
//			IdentificationHandler idHandler, BusinessHandler bizHandler) {
//		// TODO Auto-generated method stub
//		return null;
//	}
//	protected Object onNewExample(XingyouUserContextImpl userContext, LoginContext loginContext, LoginResult loginResult,
//			IdentificationHandler idHandler, BusinessHandler bizHandler) {
//		// 新用户来了,我也不知道该干嘛,所以报错
...
//		return null;
//	}
//	protected Object onSuccessExample(XingyouUserContextImpl userContext, LoginContext loginContext, LoginResult loginResult,
//			IdentificationHandler idHandler, BusinessHandler bizHandler) {
//		// 成功了就直接记载第一个userApp
//		SecUser secUser = loginResult.getLoginContext().getLoginTarget().getSecUser();
