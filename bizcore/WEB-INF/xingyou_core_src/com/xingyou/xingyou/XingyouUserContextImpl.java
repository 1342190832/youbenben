...
import com.xingyou.xingyou.secuser.SecUserCustomManagerImpl;
...
public class XingyouUserContextImpl extends UserContextImpl implements XingyouUserContext{
	...
	static final String RESOURCE_PATH="com.xingyou.xingyou.XingyouResources";
	static final String CUSTOM_RESOURCE_PATH="com.xingyou.xingyou.XingyouCustomResources";
    ...
    /*
    public static SecUser getSecUser(XingyouUserContext userContext) {
	...
	public static UserApp getSingleUserAppByObjectName(XingyouUserContext userContext, String objectName)
			throws Exception {
		SecUserCustomManagerImpl secUserManager = (SecUserCustomManagerImpl) userContext.getManagerGroup()
				.getSecUserManager();
		SecUser secUser = secUserManager.getCachedSecUser(userContext);
	...
	*/
	public static SmartList<UserApp> getUserAppByName(XingyouUserContext userContext, SecUser secUser, String objectName) {
	...
	public static UserApp getUserAppByBindedEntity(XingyouUserContext userContext, BaseEntity userAppBindedObject) {
		MultipleAccessKey key = new MultipleAccessKey();
	...
	private XingyouObjectChecker checker;
