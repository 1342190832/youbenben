...
public class PageTypeJDBCTemplateDAO extends XingyouBaseDAOImpl implements PageTypeDAO{
	...
	*/
    ...
    public SmartList<PageType> requestCandidatePageTypeForPage(XingyouUserContext userContext, String ownerClass, String id, String filterKey, int pageNo, int pageSize) throws Exception {
	...
	public SmartList<Page> loadOurPageList(XingyouUserContext userContext, List<PageType> us, Map<String,Object> options) throws Exception{
