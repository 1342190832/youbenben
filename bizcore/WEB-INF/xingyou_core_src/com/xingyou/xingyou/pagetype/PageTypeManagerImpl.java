...
public class PageTypeManagerImpl extends CustomXingyouCheckerManager implements PageTypeManager, BusinessHandler{
	...
	@Override
	public PageTypeDAO daoOf(XingyouUserContext userContext) {
	...
	protected void throwExceptionWithMessage(String value) throws PageTypeManagerException{
 	...
 	protected PageType savePageType(XingyouUserContext userContext, PageType pageType, String [] tokensExpr) throws Exception{	
 	...
 	protected PageType savePageTypeDetail(XingyouUserContext userContext, PageType pageType) throws Exception{	
 	...
 	public PageType loadPageType(XingyouUserContext userContext, String pageTypeId, String [] tokensExpr) throws Exception{				
 	 ...
 	 public PageType searchPageType(XingyouUserContext userContext, String pageTypeId, String textToSearch,String [] tokensExpr) throws Exception{				
 	...
 	protected PageType present(XingyouUserContext userContext, PageType pageType, Map<String, Object> tokens) throws Exception {
 	...
 	public PageType loadPageTypeDetail(XingyouUserContext userContext, String pageTypeId) throws Exception{	
 		PageType pageType = loadPageType( userContext, pageTypeId, allTokens());
 		return present(userContext,pageType, allTokens());
		
 	}
 	
 	public Object view(XingyouUserContext userContext, String pageTypeId) throws Exception{	
 		PageType pageType = loadPageType( userContext, pageTypeId, viewTokens());
 		return present(userContext,pageType, allTokens());
		
 	}
 	protected PageType savePageType(XingyouUserContext userContext, PageType pageType, Map<String,Object>tokens) throws Exception{	
 		return pageTypeDaoOf(userContext).save(pageType, tokens);
 	}
 	protected PageType loadPageType(XingyouUserContext userContext, String pageTypeId, Map<String,Object>tokens) throws Exception{	
		checkerOf(userContext).checkIdOfPageType(pageTypeId);
		checkerOf(userContext).throwExceptionIfHasErrors( PageTypeManagerException.class);
	...
	public PageType loadPageTypeWithCode(XingyouUserContext userContext, String code, Map<String,Object>tokens) throws Exception{	
 	...
 	protected<T extends BaseEntity> void addActions(XingyouUserContext userContext, PageType pageType, Map<String, Object> tokens){
	...
	}// end method of protected<T extends BaseEntity> void addActions(XingyouUserContext userContext, PageType pageType, Map<String, Object> tokens){
	...
	protected void checkParamsForUpdatingPageType(XingyouUserContext userContext,String pageTypeId, int pageTypeVersion, String property, String newValueExpr,String [] tokensExpr)throws Exception
	{
	...
	public PageType clone(XingyouUserContext userContext, String fromPageTypeId) throws Exception{
	...
	public PageType internalSavePageType(XingyouUserContext userContext, PageType pageType, Map<String,Object> options) throws Exception
	{
	...
	public PageType updatePageTypeProperty(XingyouUserContext userContext,String pageTypeId, int pageTypeVersion, String property, String newValueExpr,String [] tokensExpr) throws Exception
	{
		checkParamsForUpdatingPageType(userContext, pageTypeId, pageTypeVersion, property, newValueExpr, tokensExpr);
	...
	protected void checkParamsForTransferingAnotherMobileApp(XingyouUserContext userContext, String pageTypeId, String anotherMobileAppId) throws Exception
 	{
 ...
 //--------------------------------------------------------------
	...
	public void delete(XingyouUserContext userContext, String pageTypeId, int pageTypeVersion) throws Exception {
	...
	public PageType forgetByAll(XingyouUserContext userContext, String pageTypeId, int pageTypeVersion) throws Exception {
		return forgetByAllInternal(userContext, pageTypeId, pageTypeVersion);
	}
	protected PageType forgetByAllInternal(XingyouUserContext userContext,
			String pageTypeId, int pageTypeVersion) throws Exception{
	...
	protected PageType breakWithPageByMobileApp(XingyouUserContext userContext, String pageTypeId, String mobileAppId,  String [] tokensExpr)
		 throws Exception{
	...
	protected void checkParamsForAddingPage(XingyouUserContext userContext, String pageTypeId, String pageTitle, String linkToUrl, String mobileAppId,String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForUpdatingPageProperties(XingyouUserContext userContext, String pageTypeId,String id,String pageTitle,String linkToUrl,String [] tokensExpr) throws Exception {
	...
	public  PageType updatePageProperties(XingyouUserContext userContext, String pageTypeId, String id,String pageTitle,String linkToUrl, String [] tokensExpr) throws Exception
	{
	...
	protected Page createPage(XingyouUserContext userContext, String pageTitle, String linkToUrl, String mobileAppId) throws Exception{
	...
	protected void checkParamsForRemovingPageList(XingyouUserContext userContext, String pageTypeId,
	...
	public  PageType removePageList(XingyouUserContext userContext, String pageTypeId,
			String pageIds[],String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForRemovingPage(XingyouUserContext userContext, String pageTypeId,
	...
	public  PageType removePage(XingyouUserContext userContext, String pageTypeId,
		String pageId, int pageVersion,String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForCopyingPage(XingyouUserContext userContext, String pageTypeId,
		String pageId, int pageVersion,String [] tokensExpr) throws Exception{
	...
	public  PageType copyPageFrom(XingyouUserContext userContext, String pageTypeId,
		String pageId, int pageVersion,String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForUpdatingPage(XingyouUserContext userContext, String pageTypeId, String pageId, int pageVersion, String property, String newValueExpr,String [] tokensExpr) throws Exception{
	...
	public  PageType updatePage(XingyouUserContext userContext, String pageTypeId, String pageId, int pageVersion, String property, String newValueExpr,String [] tokensExpr)
			throws Exception{
	...
	*/
	...
	// -----------------------------------// list-of-view 处理 \\-----------------------------------
    protected void enhanceForListOfView(XingyouUserContext userContext,SmartList<PageType> list) throws Exception {
  ...
  // -----------------------------------\\ list-of-view 处理 //-----------------------------------v
	 ...
	 * @throws Exception
	 */
 	public Object wxappview(XingyouUserContext userContext, String pageTypeId) throws Exception{
	  SerializeScope vscope = XingyouViewScope.getInstance().getPageTypeDetailScope().clone();
