...
public class TreeServiceImpl extends CustomXingyouCheckerManager implements TreeService {

    @Override
    public Node loadTree(XingyouUserContext ctx, String nodeId, String nodeType) throws Exception {
    ...
    @Override
    public Node loadAncestors(XingyouUserContext ctx, String nodeId, String nodeType) throws Exception {
        SmartList<TreeNode> nodes = loadTreeNode(ctx, nodeId, nodeType);
    ...
    public SmartList<TreeNode> loadTreeNode(XingyouUserContext ctx, String nodeId, String nodeType) {
     ...
     * @throws Exception
     */
    private <T extends BaseEntity> Node<T> extractTreeFromRoot(XingyouUserContext ctx, TreeNode pRoot) throws Exception {
    ...
    private <T extends BaseEntity> Node<T> extractAncestors(XingyouUserContext ctx, TreeNode pNode) throws Exception {
    ...
    @Override
    public Node addChild(XingyouUserContext ctx, Node nodeTree, String childId, String childType) throws Exception {
    ...
    public Node ensureRoot(XingyouUserContext ctx) throws Exception {
    ...
    @Override
    public Node deleteChild(XingyouUserContext ctx, Node parent, Node child) throws Exception {
        //do nothing
    ...
    private Node buildInternalTree(XingyouUserContext ctx, final List<TreeNode> pTreeNodes) throws Exception {
