...
public class CandidateContainerJDBCTemplateDAO extends XingyouBaseDAOImpl implements CandidateContainerDAO{
	...
	*/
    ...
    public SmartList<CandidateContainer> requestCandidateCandidateContainerForCandidateElement(XingyouUserContext userContext, String ownerClass, String id, String filterKey, int pageNo, int pageSize) throws Exception {
	...
	public SmartList<CandidateElement> loadOurCandidateElementList(XingyouUserContext userContext, List<CandidateContainer> us, Map<String,Object> options) throws Exception{
