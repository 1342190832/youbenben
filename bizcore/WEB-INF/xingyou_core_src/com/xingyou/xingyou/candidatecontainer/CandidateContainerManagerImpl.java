...
public class CandidateContainerManagerImpl extends CustomXingyouCheckerManager implements CandidateContainerManager, BusinessHandler{
	...
	@Override
	public CandidateContainerDAO daoOf(XingyouUserContext userContext) {
	...
	protected void throwExceptionWithMessage(String value) throws CandidateContainerManagerException{
 	...
 	protected CandidateContainer saveCandidateContainer(XingyouUserContext userContext, CandidateContainer candidateContainer, String [] tokensExpr) throws Exception{	
 	...
 	protected CandidateContainer saveCandidateContainerDetail(XingyouUserContext userContext, CandidateContainer candidateContainer) throws Exception{	
 	...
 	public CandidateContainer loadCandidateContainer(XingyouUserContext userContext, String candidateContainerId, String [] tokensExpr) throws Exception{				
 	 ...
 	 public CandidateContainer searchCandidateContainer(XingyouUserContext userContext, String candidateContainerId, String textToSearch,String [] tokensExpr) throws Exception{				
 	...
 	protected CandidateContainer present(XingyouUserContext userContext, CandidateContainer candidateContainer, Map<String, Object> tokens) throws Exception {
 	...
 	public CandidateContainer loadCandidateContainerDetail(XingyouUserContext userContext, String candidateContainerId) throws Exception{	
 	...
 	public Object view(XingyouUserContext userContext, String candidateContainerId) throws Exception{	
 		CandidateContainer candidateContainer = loadCandidateContainer( userContext, candidateContainerId, viewTokens());
 		return present(userContext,candidateContainer, allTokens());
		
 	}
 	protected CandidateContainer saveCandidateContainer(XingyouUserContext userContext, CandidateContainer candidateContainer, Map<String,Object>tokens) throws Exception{	
 		return candidateContainerDaoOf(userContext).save(candidateContainer, tokens);
 	}
 	protected CandidateContainer loadCandidateContainer(XingyouUserContext userContext, String candidateContainerId, Map<String,Object>tokens) throws Exception{	
		checkerOf(userContext).checkIdOfCandidateContainer(candidateContainerId);
		checkerOf(userContext).throwExceptionIfHasErrors( CandidateContainerManagerException.class);
 	...
 	protected<T extends BaseEntity> void addActions(XingyouUserContext userContext, CandidateContainer candidateContainer, Map<String, Object> tokens){
	...
	}// end method of protected<T extends BaseEntity> void addActions(XingyouUserContext userContext, CandidateContainer candidateContainer, Map<String, Object> tokens){
	...
	protected void checkParamsForUpdatingCandidateContainer(XingyouUserContext userContext,String candidateContainerId, int candidateContainerVersion, String property, String newValueExpr,String [] tokensExpr)throws Exception
	{
	...
	public CandidateContainer clone(XingyouUserContext userContext, String fromCandidateContainerId) throws Exception{
	...
	public CandidateContainer internalSaveCandidateContainer(XingyouUserContext userContext, CandidateContainer candidateContainer, Map<String,Object> options) throws Exception
	{
	...
	public CandidateContainer updateCandidateContainerProperty(XingyouUserContext userContext,String candidateContainerId, int candidateContainerVersion, String property, String newValueExpr,String [] tokensExpr) throws Exception
	{
		checkParamsForUpdatingCandidateContainer(userContext, candidateContainerId, candidateContainerVersion, property, newValueExpr, tokensExpr);
...
//--------------------------------------------------------------
	...
	public void delete(XingyouUserContext userContext, String candidateContainerId, int candidateContainerVersion) throws Exception {
	...
	public CandidateContainer forgetByAll(XingyouUserContext userContext, String candidateContainerId, int candidateContainerVersion) throws Exception {
		return forgetByAllInternal(userContext, candidateContainerId, candidateContainerVersion);
	}
	protected CandidateContainer forgetByAllInternal(XingyouUserContext userContext,
			String candidateContainerId, int candidateContainerVersion) throws Exception{
	...
	protected void checkParamsForAddingCandidateElement(XingyouUserContext userContext, String candidateContainerId, String name, String type, String image,String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForUpdatingCandidateElementProperties(XingyouUserContext userContext, String candidateContainerId,String id,String name,String type,String image,String [] tokensExpr) throws Exception {
	...
	public  CandidateContainer updateCandidateElementProperties(XingyouUserContext userContext, String candidateContainerId, String id,String name,String type,String image, String [] tokensExpr) throws Exception
	{
	...
	protected CandidateElement createCandidateElement(XingyouUserContext userContext, String name, String type, String image) throws Exception{
	...
	protected void checkParamsForRemovingCandidateElementList(XingyouUserContext userContext, String candidateContainerId,
	...
	public  CandidateContainer removeCandidateElementList(XingyouUserContext userContext, String candidateContainerId,
			String candidateElementIds[],String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForRemovingCandidateElement(XingyouUserContext userContext, String candidateContainerId,
	...
	public  CandidateContainer removeCandidateElement(XingyouUserContext userContext, String candidateContainerId,
		String candidateElementId, int candidateElementVersion,String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForCopyingCandidateElement(XingyouUserContext userContext, String candidateContainerId,
		String candidateElementId, int candidateElementVersion,String [] tokensExpr) throws Exception{
	...
	public  CandidateContainer copyCandidateElementFrom(XingyouUserContext userContext, String candidateContainerId,
		String candidateElementId, int candidateElementVersion,String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForUpdatingCandidateElement(XingyouUserContext userContext, String candidateContainerId, String candidateElementId, int candidateElementVersion, String property, String newValueExpr,String [] tokensExpr) throws Exception{
	...
	public  CandidateContainer updateCandidateElement(XingyouUserContext userContext, String candidateContainerId, String candidateElementId, int candidateElementVersion, String property, String newValueExpr,String [] tokensExpr)
			throws Exception{
	...
	*/
	...
	// -----------------------------------// list-of-view 处理 \\-----------------------------------
    protected void enhanceForListOfView(XingyouUserContext userContext,SmartList<CandidateContainer> list) throws Exception {
  ...
  // -----------------------------------\\ list-of-view 处理 //-----------------------------------v
	 ...
	 * @throws Exception
	 */
 	public Object wxappview(XingyouUserContext userContext, String candidateContainerId) throws Exception{
	  SerializeScope vscope = XingyouViewScope.getInstance().getCandidateContainerDetailScope().clone();
    ...
    String pageTitle = "候选人容器"+"详情";
		...
		vscope.field("candidateElementListSection", XingyouListOfViewScope.getInstance()
