...
public class WechatMiniappIdentifyManagerImpl extends CustomXingyouCheckerManager implements WechatMiniappIdentifyManager, BusinessHandler{
	...
	@Override
	public WechatMiniappIdentifyDAO daoOf(XingyouUserContext userContext) {
	...
	protected void throwExceptionWithMessage(String value) throws WechatMiniappIdentifyManagerException{
 	...
 	protected WechatMiniappIdentify saveWechatMiniappIdentify(XingyouUserContext userContext, WechatMiniappIdentify wechatMiniappIdentify, String [] tokensExpr) throws Exception{	
 	...
 	protected WechatMiniappIdentify saveWechatMiniappIdentifyDetail(XingyouUserContext userContext, WechatMiniappIdentify wechatMiniappIdentify) throws Exception{	
 	...
 	public WechatMiniappIdentify loadWechatMiniappIdentify(XingyouUserContext userContext, String wechatMiniappIdentifyId, String [] tokensExpr) throws Exception{				
 	 ...
 	 public WechatMiniappIdentify searchWechatMiniappIdentify(XingyouUserContext userContext, String wechatMiniappIdentifyId, String textToSearch,String [] tokensExpr) throws Exception{				
 	...
 	protected WechatMiniappIdentify present(XingyouUserContext userContext, WechatMiniappIdentify wechatMiniappIdentify, Map<String, Object> tokens) throws Exception {
 	...
 	public WechatMiniappIdentify loadWechatMiniappIdentifyDetail(XingyouUserContext userContext, String wechatMiniappIdentifyId) throws Exception{	
 	...
 	public Object view(XingyouUserContext userContext, String wechatMiniappIdentifyId) throws Exception{	
 		WechatMiniappIdentify wechatMiniappIdentify = loadWechatMiniappIdentify( userContext, wechatMiniappIdentifyId, viewTokens());
 		return present(userContext,wechatMiniappIdentify, allTokens());
		
 	}
 	protected WechatMiniappIdentify saveWechatMiniappIdentify(XingyouUserContext userContext, WechatMiniappIdentify wechatMiniappIdentify, Map<String,Object>tokens) throws Exception{	
 		return wechatMiniappIdentifyDaoOf(userContext).save(wechatMiniappIdentify, tokens);
 	}
 	protected WechatMiniappIdentify loadWechatMiniappIdentify(XingyouUserContext userContext, String wechatMiniappIdentifyId, Map<String,Object>tokens) throws Exception{	
		checkerOf(userContext).checkIdOfWechatMiniappIdentify(wechatMiniappIdentifyId);
		checkerOf(userContext).throwExceptionIfHasErrors( WechatMiniappIdentifyManagerException.class);
 	...
 	protected<T extends BaseEntity> void addActions(XingyouUserContext userContext, WechatMiniappIdentify wechatMiniappIdentify, Map<String, Object> tokens){
	...
	}// end method of protected<T extends BaseEntity> void addActions(XingyouUserContext userContext, WechatMiniappIdentify wechatMiniappIdentify, Map<String, Object> tokens){
	...
	protected void checkParamsForUpdatingWechatMiniappIdentify(XingyouUserContext userContext,String wechatMiniappIdentifyId, int wechatMiniappIdentifyVersion, String property, String newValueExpr,String [] tokensExpr)throws Exception
	{
	...
	public WechatMiniappIdentify clone(XingyouUserContext userContext, String fromWechatMiniappIdentifyId) throws Exception{
	...
	public WechatMiniappIdentify internalSaveWechatMiniappIdentify(XingyouUserContext userContext, WechatMiniappIdentify wechatMiniappIdentify, Map<String,Object> options) throws Exception
	{
	...
	public WechatMiniappIdentify updateWechatMiniappIdentifyProperty(XingyouUserContext userContext,String wechatMiniappIdentifyId, int wechatMiniappIdentifyVersion, String property, String newValueExpr,String [] tokensExpr) throws Exception
	{
		checkParamsForUpdatingWechatMiniappIdentify(userContext, wechatMiniappIdentifyId, wechatMiniappIdentifyVersion, property, newValueExpr, tokensExpr);
	...
	protected void checkParamsForTransferingAnotherSecUser(XingyouUserContext userContext, String wechatMiniappIdentifyId, String anotherSecUserId) throws Exception
 	{
	...
	protected void checkParamsForTransferingAnotherSecUserWithLogin(XingyouUserContext userContext, String wechatMiniappIdentifyId, String anotherLogin) throws Exception
 	{
 	...
 	public WechatMiniappIdentify transferToAnotherSecUserWithLogin(XingyouUserContext userContext, String wechatMiniappIdentifyId, String anotherLogin) throws Exception
 	{
	...
	protected void checkParamsForTransferingAnotherSecUserWithEmail(XingyouUserContext userContext, String wechatMiniappIdentifyId, String anotherEmail) throws Exception
 	{
 	...
 	public WechatMiniappIdentify transferToAnotherSecUserWithEmail(XingyouUserContext userContext, String wechatMiniappIdentifyId, String anotherEmail) throws Exception
 	{
	...
	protected void checkParamsForTransferingAnotherSecUserWithMobile(XingyouUserContext userContext, String wechatMiniappIdentifyId, String anotherMobile) throws Exception
 	{
 	...
 	public WechatMiniappIdentify transferToAnotherSecUserWithMobile(XingyouUserContext userContext, String wechatMiniappIdentifyId, String anotherMobile) throws Exception
 	{
 ...
 //--------------------------------------------------------------
	...
	public void delete(XingyouUserContext userContext, String wechatMiniappIdentifyId, int wechatMiniappIdentifyVersion) throws Exception {
	...
	public WechatMiniappIdentify forgetByAll(XingyouUserContext userContext, String wechatMiniappIdentifyId, int wechatMiniappIdentifyVersion) throws Exception {
		return forgetByAllInternal(userContext, wechatMiniappIdentifyId, wechatMiniappIdentifyVersion);
	}
	protected WechatMiniappIdentify forgetByAllInternal(XingyouUserContext userContext,
			String wechatMiniappIdentifyId, int wechatMiniappIdentifyVersion) throws Exception{
	...
	// -----------------------------------// list-of-view 处理 \\-----------------------------------
    protected void enhanceForListOfView(XingyouUserContext userContext,SmartList<WechatMiniappIdentify> list) throws Exception {
  ...
  // -----------------------------------\\ list-of-view 处理 //-----------------------------------v
	 ...
	 * @throws Exception
	 */
 	public Object wxappview(XingyouUserContext userContext, String wechatMiniappIdentifyId) throws Exception{
	  SerializeScope vscope = XingyouViewScope.getInstance().getWechatMiniappIdentifyDetailScope().clone();
