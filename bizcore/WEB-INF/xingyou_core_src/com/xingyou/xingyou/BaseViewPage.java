...
public abstract class BaseViewPage extends HashMap<String, Object> {
	...
	public void assemblerContent(XingyouUserContext userContext, String requestName) throws Exception {
		setPageTitle("尚未实现");
	}
	public Map<String, Object> doRender(XingyouUserContext userContext) {
	...
	protected CustomSerializer getCustomSerializerByObject(Object object) {
		...
		if (object instanceof BaseXingyouFormProcessor) {
	...
	protected class FormProcessorSerializer implements CustomSerializer {
		@Override
		public Object serialize(SerializeScope serializeScope, Object value, String path) {
			BaseXingyouFormProcessor form = (BaseXingyouFormProcessor) value;
			if (form == null) {
				return null;
			}
