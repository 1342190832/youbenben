...
public class MobileAppManagerImpl extends CustomXingyouCheckerManager implements MobileAppManager, BusinessHandler{
	...
	@Override
	public MobileAppDAO daoOf(XingyouUserContext userContext) {
	...
	protected void throwExceptionWithMessage(String value) throws MobileAppManagerException{
 	...
 	protected MobileApp saveMobileApp(XingyouUserContext userContext, MobileApp mobileApp, String [] tokensExpr) throws Exception{	
 	...
 	protected MobileApp saveMobileAppDetail(XingyouUserContext userContext, MobileApp mobileApp) throws Exception{	
 	...
 	public MobileApp loadMobileApp(XingyouUserContext userContext, String mobileAppId, String [] tokensExpr) throws Exception{				
 	 ...
 	 public MobileApp searchMobileApp(XingyouUserContext userContext, String mobileAppId, String textToSearch,String [] tokensExpr) throws Exception{				
 	...
 	protected MobileApp present(XingyouUserContext userContext, MobileApp mobileApp, Map<String, Object> tokens) throws Exception {
 	...
 	public MobileApp loadMobileAppDetail(XingyouUserContext userContext, String mobileAppId) throws Exception{	
 		MobileApp mobileApp = loadMobileApp( userContext, mobileAppId, allTokens());
 		return present(userContext,mobileApp, allTokens());
		
 	}
 	
 	public Object view(XingyouUserContext userContext, String mobileAppId) throws Exception{	
 		MobileApp mobileApp = loadMobileApp( userContext, mobileAppId, viewTokens());
 		return present(userContext,mobileApp, allTokens());
		
 	}
 	protected MobileApp saveMobileApp(XingyouUserContext userContext, MobileApp mobileApp, Map<String,Object>tokens) throws Exception{	
 		return mobileAppDaoOf(userContext).save(mobileApp, tokens);
 	}
 	protected MobileApp loadMobileApp(XingyouUserContext userContext, String mobileAppId, Map<String,Object>tokens) throws Exception{	
		checkerOf(userContext).checkIdOfMobileApp(mobileAppId);
		checkerOf(userContext).throwExceptionIfHasErrors( MobileAppManagerException.class);
 	...
 	protected<T extends BaseEntity> void addActions(XingyouUserContext userContext, MobileApp mobileApp, Map<String, Object> tokens){
	...
	}// end method of protected<T extends BaseEntity> void addActions(XingyouUserContext userContext, MobileApp mobileApp, Map<String, Object> tokens){
	...
	protected void checkParamsForUpdatingMobileApp(XingyouUserContext userContext,String mobileAppId, int mobileAppVersion, String property, String newValueExpr,String [] tokensExpr)throws Exception
	{
	...
	public MobileApp clone(XingyouUserContext userContext, String fromMobileAppId) throws Exception{
	...
	public MobileApp internalSaveMobileApp(XingyouUserContext userContext, MobileApp mobileApp, Map<String,Object> options) throws Exception
	{
	...
	public MobileApp updateMobileAppProperty(XingyouUserContext userContext,String mobileAppId, int mobileAppVersion, String property, String newValueExpr,String [] tokensExpr) throws Exception
	{
		checkParamsForUpdatingMobileApp(userContext, mobileAppId, mobileAppVersion, property, newValueExpr, tokensExpr);
...
//--------------------------------------------------------------
	...
	public void delete(XingyouUserContext userContext, String mobileAppId, int mobileAppVersion) throws Exception {
	...
	public MobileApp forgetByAll(XingyouUserContext userContext, String mobileAppId, int mobileAppVersion) throws Exception {
		return forgetByAllInternal(userContext, mobileAppId, mobileAppVersion);
	}
	protected MobileApp forgetByAllInternal(XingyouUserContext userContext,
			String mobileAppId, int mobileAppVersion) throws Exception{
	...
	protected MobileApp breakWithPageByPageType(XingyouUserContext userContext, String mobileAppId, String pageTypeId,  String [] tokensExpr)
		 throws Exception{
	...
	protected void checkParamsForAddingPage(XingyouUserContext userContext, String mobileAppId, String pageTitle, String linkToUrl, String pageTypeId,String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForUpdatingPageProperties(XingyouUserContext userContext, String mobileAppId,String id,String pageTitle,String linkToUrl,String [] tokensExpr) throws Exception {
	...
	public  MobileApp updatePageProperties(XingyouUserContext userContext, String mobileAppId, String id,String pageTitle,String linkToUrl, String [] tokensExpr) throws Exception
	{
	...
	protected Page createPage(XingyouUserContext userContext, String pageTitle, String linkToUrl, String pageTypeId) throws Exception{
	...
	protected void checkParamsForRemovingPageList(XingyouUserContext userContext, String mobileAppId,
	...
	public  MobileApp removePageList(XingyouUserContext userContext, String mobileAppId,
			String pageIds[],String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForRemovingPage(XingyouUserContext userContext, String mobileAppId,
	...
	public  MobileApp removePage(XingyouUserContext userContext, String mobileAppId,
		String pageId, int pageVersion,String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForCopyingPage(XingyouUserContext userContext, String mobileAppId,
		String pageId, int pageVersion,String [] tokensExpr) throws Exception{
	...
	public  MobileApp copyPageFrom(XingyouUserContext userContext, String mobileAppId,
		String pageId, int pageVersion,String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForUpdatingPage(XingyouUserContext userContext, String mobileAppId, String pageId, int pageVersion, String property, String newValueExpr,String [] tokensExpr) throws Exception{
	...
	public  MobileApp updatePage(XingyouUserContext userContext, String mobileAppId, String pageId, int pageVersion, String property, String newValueExpr,String [] tokensExpr)
			throws Exception{
	...
	*/
	...
	protected void checkParamsForAddingPageType(XingyouUserContext userContext, String mobileAppId, String name, String code, boolean footerTab,String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForUpdatingPageTypeProperties(XingyouUserContext userContext, String mobileAppId,String id,String name,String code,boolean footerTab,String [] tokensExpr) throws Exception {
	...
	public  MobileApp updatePageTypeProperties(XingyouUserContext userContext, String mobileAppId, String id,String name,String code,boolean footerTab, String [] tokensExpr) throws Exception
	{
	...
	protected PageType createPageType(XingyouUserContext userContext, String name, String code, boolean footerTab) throws Exception{
	...
	protected void checkParamsForRemovingPageTypeList(XingyouUserContext userContext, String mobileAppId,
	...
	public  MobileApp removePageTypeList(XingyouUserContext userContext, String mobileAppId,
			String pageTypeIds[],String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForRemovingPageType(XingyouUserContext userContext, String mobileAppId,
	...
	public  MobileApp removePageType(XingyouUserContext userContext, String mobileAppId,
		String pageTypeId, int pageTypeVersion,String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForCopyingPageType(XingyouUserContext userContext, String mobileAppId,
		String pageTypeId, int pageTypeVersion,String [] tokensExpr) throws Exception{
	...
	public  MobileApp copyPageTypeFrom(XingyouUserContext userContext, String mobileAppId,
		String pageTypeId, int pageTypeVersion,String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForUpdatingPageType(XingyouUserContext userContext, String mobileAppId, String pageTypeId, int pageTypeVersion, String property, String newValueExpr,String [] tokensExpr) throws Exception{
	...
	public  MobileApp updatePageType(XingyouUserContext userContext, String mobileAppId, String pageTypeId, int pageTypeVersion, String property, String newValueExpr,String [] tokensExpr)
			throws Exception{
	...
	*/
	...
	// -----------------------------------// list-of-view 处理 \\-----------------------------------
    protected void enhanceForListOfView(XingyouUserContext userContext,SmartList<MobileApp> list) throws Exception {
  ...
  // -----------------------------------\\ list-of-view 处理 //-----------------------------------v
	 ...
	 * @throws Exception
	 */
 	public Object wxappview(XingyouUserContext userContext, String mobileAppId) throws Exception{
	  SerializeScope vscope = XingyouViewScope.getInstance().getMobileAppDetailScope().clone();
    ...
    String pageTitle = "手机应用程序"+"详情";
		...
		vscope.field("pageListSection", XingyouListOfViewScope.getInstance()
