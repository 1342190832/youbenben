...
public class WechatWorkappIdentifyManagerImpl extends CustomXingyouCheckerManager implements WechatWorkappIdentifyManager, BusinessHandler{
	...
	@Override
	public WechatWorkappIdentifyDAO daoOf(XingyouUserContext userContext) {
	...
	protected void throwExceptionWithMessage(String value) throws WechatWorkappIdentifyManagerException{
 	...
 	protected WechatWorkappIdentify saveWechatWorkappIdentify(XingyouUserContext userContext, WechatWorkappIdentify wechatWorkappIdentify, String [] tokensExpr) throws Exception{	
 	...
 	protected WechatWorkappIdentify saveWechatWorkappIdentifyDetail(XingyouUserContext userContext, WechatWorkappIdentify wechatWorkappIdentify) throws Exception{	
 	...
 	public WechatWorkappIdentify loadWechatWorkappIdentify(XingyouUserContext userContext, String wechatWorkappIdentifyId, String [] tokensExpr) throws Exception{				
 	 ...
 	 public WechatWorkappIdentify searchWechatWorkappIdentify(XingyouUserContext userContext, String wechatWorkappIdentifyId, String textToSearch,String [] tokensExpr) throws Exception{				
 	...
 	protected WechatWorkappIdentify present(XingyouUserContext userContext, WechatWorkappIdentify wechatWorkappIdentify, Map<String, Object> tokens) throws Exception {
 	...
 	public WechatWorkappIdentify loadWechatWorkappIdentifyDetail(XingyouUserContext userContext, String wechatWorkappIdentifyId) throws Exception{	
 	...
 	public Object view(XingyouUserContext userContext, String wechatWorkappIdentifyId) throws Exception{	
 		WechatWorkappIdentify wechatWorkappIdentify = loadWechatWorkappIdentify( userContext, wechatWorkappIdentifyId, viewTokens());
 		return present(userContext,wechatWorkappIdentify, allTokens());
		
 	}
 	protected WechatWorkappIdentify saveWechatWorkappIdentify(XingyouUserContext userContext, WechatWorkappIdentify wechatWorkappIdentify, Map<String,Object>tokens) throws Exception{	
 		return wechatWorkappIdentifyDaoOf(userContext).save(wechatWorkappIdentify, tokens);
 	}
 	protected WechatWorkappIdentify loadWechatWorkappIdentify(XingyouUserContext userContext, String wechatWorkappIdentifyId, Map<String,Object>tokens) throws Exception{	
		checkerOf(userContext).checkIdOfWechatWorkappIdentify(wechatWorkappIdentifyId);
		checkerOf(userContext).throwExceptionIfHasErrors( WechatWorkappIdentifyManagerException.class);
 	...
 	protected<T extends BaseEntity> void addActions(XingyouUserContext userContext, WechatWorkappIdentify wechatWorkappIdentify, Map<String, Object> tokens){
	...
	}// end method of protected<T extends BaseEntity> void addActions(XingyouUserContext userContext, WechatWorkappIdentify wechatWorkappIdentify, Map<String, Object> tokens){
	...
	protected void checkParamsForUpdatingWechatWorkappIdentify(XingyouUserContext userContext,String wechatWorkappIdentifyId, int wechatWorkappIdentifyVersion, String property, String newValueExpr,String [] tokensExpr)throws Exception
	{
	...
	public WechatWorkappIdentify clone(XingyouUserContext userContext, String fromWechatWorkappIdentifyId) throws Exception{
	...
	public WechatWorkappIdentify internalSaveWechatWorkappIdentify(XingyouUserContext userContext, WechatWorkappIdentify wechatWorkappIdentify, Map<String,Object> options) throws Exception
	{
	...
	public WechatWorkappIdentify updateWechatWorkappIdentifyProperty(XingyouUserContext userContext,String wechatWorkappIdentifyId, int wechatWorkappIdentifyVersion, String property, String newValueExpr,String [] tokensExpr) throws Exception
	{
		checkParamsForUpdatingWechatWorkappIdentify(userContext, wechatWorkappIdentifyId, wechatWorkappIdentifyVersion, property, newValueExpr, tokensExpr);
	...
	protected void checkParamsForTransferingAnotherSecUser(XingyouUserContext userContext, String wechatWorkappIdentifyId, String anotherSecUserId) throws Exception
 	{
	...
	protected void checkParamsForTransferingAnotherSecUserWithLogin(XingyouUserContext userContext, String wechatWorkappIdentifyId, String anotherLogin) throws Exception
 	{
 	...
 	public WechatWorkappIdentify transferToAnotherSecUserWithLogin(XingyouUserContext userContext, String wechatWorkappIdentifyId, String anotherLogin) throws Exception
 	{
	...
	protected void checkParamsForTransferingAnotherSecUserWithEmail(XingyouUserContext userContext, String wechatWorkappIdentifyId, String anotherEmail) throws Exception
 	{
 	...
 	public WechatWorkappIdentify transferToAnotherSecUserWithEmail(XingyouUserContext userContext, String wechatWorkappIdentifyId, String anotherEmail) throws Exception
 	{
	...
	protected void checkParamsForTransferingAnotherSecUserWithMobile(XingyouUserContext userContext, String wechatWorkappIdentifyId, String anotherMobile) throws Exception
 	{
 	...
 	public WechatWorkappIdentify transferToAnotherSecUserWithMobile(XingyouUserContext userContext, String wechatWorkappIdentifyId, String anotherMobile) throws Exception
 	{
 ...
 //--------------------------------------------------------------
	...
	public void delete(XingyouUserContext userContext, String wechatWorkappIdentifyId, int wechatWorkappIdentifyVersion) throws Exception {
	...
	public WechatWorkappIdentify forgetByAll(XingyouUserContext userContext, String wechatWorkappIdentifyId, int wechatWorkappIdentifyVersion) throws Exception {
		return forgetByAllInternal(userContext, wechatWorkappIdentifyId, wechatWorkappIdentifyVersion);
	}
	protected WechatWorkappIdentify forgetByAllInternal(XingyouUserContext userContext,
			String wechatWorkappIdentifyId, int wechatWorkappIdentifyVersion) throws Exception{
	...
	// -----------------------------------// list-of-view 处理 \\-----------------------------------
    protected void enhanceForListOfView(XingyouUserContext userContext,SmartList<WechatWorkappIdentify> list) throws Exception {
  ...
  // -----------------------------------\\ list-of-view 处理 //-----------------------------------v
	 ...
	 * @throws Exception
	 */
 	public Object wxappview(XingyouUserContext userContext, String wechatWorkappIdentifyId) throws Exception{
	  SerializeScope vscope = XingyouViewScope.getInstance().getWechatWorkappIdentifyDetailScope().clone();
