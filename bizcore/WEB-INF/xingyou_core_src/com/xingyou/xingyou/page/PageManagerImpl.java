...
import com.xingyou.xingyou.mobileapp.CandidateMobileApp;
import com.xingyou.xingyou.pagetype.CandidatePageType;
...
public class PageManagerImpl extends CustomXingyouCheckerManager implements PageManager, BusinessHandler{
	...
	@Override
	public PageDAO daoOf(XingyouUserContext userContext) {
	...
	protected void throwExceptionWithMessage(String value) throws PageManagerException{
 	...
 	protected Page savePage(XingyouUserContext userContext, Page page, String [] tokensExpr) throws Exception{	
 	...
 	protected Page savePageDetail(XingyouUserContext userContext, Page page) throws Exception{	
 	...
 	public Page loadPage(XingyouUserContext userContext, String pageId, String [] tokensExpr) throws Exception{				
 	 ...
 	 public Page searchPage(XingyouUserContext userContext, String pageId, String textToSearch,String [] tokensExpr) throws Exception{				
 	...
 	protected Page present(XingyouUserContext userContext, Page page, Map<String, Object> tokens) throws Exception {
 	...
 	public Page loadPageDetail(XingyouUserContext userContext, String pageId) throws Exception{	
 		Page page = loadPage( userContext, pageId, allTokens());
 		return present(userContext,page, allTokens());
		
 	}
 	
 	public Object view(XingyouUserContext userContext, String pageId) throws Exception{	
 		Page page = loadPage( userContext, pageId, viewTokens());
 		return present(userContext,page, allTokens());
		
 	}
 	protected Page savePage(XingyouUserContext userContext, Page page, Map<String,Object>tokens) throws Exception{	
 		return pageDaoOf(userContext).save(page, tokens);
 	}
 	protected Page loadPage(XingyouUserContext userContext, String pageId, Map<String,Object>tokens) throws Exception{	
		checkerOf(userContext).checkIdOfPage(pageId);
		checkerOf(userContext).throwExceptionIfHasErrors( PageManagerException.class);
 	...
 	protected<T extends BaseEntity> void addActions(XingyouUserContext userContext, Page page, Map<String, Object> tokens){
	...
	}// end method of protected<T extends BaseEntity> void addActions(XingyouUserContext userContext, Page page, Map<String, Object> tokens){
	...
	protected void checkParamsForUpdatingPage(XingyouUserContext userContext,String pageId, int pageVersion, String property, String newValueExpr,String [] tokensExpr)throws Exception
	{
	...
	public Page clone(XingyouUserContext userContext, String fromPageId) throws Exception{
	...
	public Page internalSavePage(XingyouUserContext userContext, Page page, Map<String,Object> options) throws Exception
	{
	...
	public Page updatePageProperty(XingyouUserContext userContext,String pageId, int pageVersion, String property, String newValueExpr,String [] tokensExpr) throws Exception
	{
		checkParamsForUpdatingPage(userContext, pageId, pageVersion, property, newValueExpr, tokensExpr);
	...
	protected void checkParamsForTransferingAnotherPageType(XingyouUserContext userContext, String pageId, String anotherPageTypeId) throws Exception
 	{
	...
	protected void checkParamsForTransferingAnotherPageTypeWithCode(XingyouUserContext userContext, String pageId, String anotherCode) throws Exception
 	{
 	...
 	public Page transferToAnotherPageTypeWithCode(XingyouUserContext userContext, String pageId, String anotherCode) throws Exception
 	{
	...
	public CandidatePageType requestCandidatePageType(XingyouUserContext userContext, String ownerClass, String id, String filterKey, int pageNo) throws Exception {
 	...
 	protected void checkParamsForTransferingAnotherMobileApp(XingyouUserContext userContext, String pageId, String anotherMobileAppId) throws Exception
 	{
	...
	public CandidateMobileApp requestCandidateMobileApp(XingyouUserContext userContext, String ownerClass, String id, String filterKey, int pageNo) throws Exception {
 ...
 //--------------------------------------------------------------
 	...
 	protected PageType loadPageType(XingyouUserContext userContext, String newPageTypeId, Map<String,Object> options) throws Exception
 	{

 		return pageTypeDaoOf(userContext).load(newPageTypeId, options);
 	}
 	
 	protected PageType loadPageTypeWithCode(XingyouUserContext userContext, String newCode, Map<String,Object> options) throws Exception
 	{
 	...
 	protected MobileApp loadMobileApp(XingyouUserContext userContext, String newMobileAppId, Map<String,Object> options) throws Exception
 	{
	...
	public void delete(XingyouUserContext userContext, String pageId, int pageVersion) throws Exception {
	...
	public Page forgetByAll(XingyouUserContext userContext, String pageId, int pageVersion) throws Exception {
		return forgetByAllInternal(userContext, pageId, pageVersion);
	}
	protected Page forgetByAllInternal(XingyouUserContext userContext,
			String pageId, int pageVersion) throws Exception{
	...
	protected void checkParamsForAddingSlide(XingyouUserContext userContext, String pageId, int displayOrder, String name, String imageUrl, String videoUrl, String linkToUrl,String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForUpdatingSlideProperties(XingyouUserContext userContext, String pageId,String id,int displayOrder,String name,String imageUrl,String videoUrl,String linkToUrl,String [] tokensExpr) throws Exception {
	...
	public  Page updateSlideProperties(XingyouUserContext userContext, String pageId, String id,int displayOrder,String name,String imageUrl,String videoUrl,String linkToUrl, String [] tokensExpr) throws Exception
	{
	...
	protected Slide createSlide(XingyouUserContext userContext, int displayOrder, String name, String imageUrl, String videoUrl, String linkToUrl) throws Exception{
	...
	protected void checkParamsForRemovingSlideList(XingyouUserContext userContext, String pageId,
	...
	public  Page removeSlideList(XingyouUserContext userContext, String pageId,
			String slideIds[],String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForRemovingSlide(XingyouUserContext userContext, String pageId,
	...
	public  Page removeSlide(XingyouUserContext userContext, String pageId,
		String slideId, int slideVersion,String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForCopyingSlide(XingyouUserContext userContext, String pageId,
		String slideId, int slideVersion,String [] tokensExpr) throws Exception{
	...
	public  Page copySlideFrom(XingyouUserContext userContext, String pageId,
		String slideId, int slideVersion,String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForUpdatingSlide(XingyouUserContext userContext, String pageId, String slideId, int slideVersion, String property, String newValueExpr,String [] tokensExpr) throws Exception{
	...
	public  Page updateSlide(XingyouUserContext userContext, String pageId, String slideId, int slideVersion, String property, String newValueExpr,String [] tokensExpr)
			throws Exception{
	...
	*/
	...
	protected void checkParamsForAddingUiAction(XingyouUserContext userContext, String pageId, String code, String icon, String title, String brief, String imageUrl, String linkToUrl, String extraData,String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForUpdatingUiActionProperties(XingyouUserContext userContext, String pageId,String id,String code,String icon,String title,String brief,String imageUrl,String linkToUrl,String extraData,String [] tokensExpr) throws Exception {
	...
	public  Page updateUiActionProperties(XingyouUserContext userContext, String pageId, String id,String code,String icon,String title,String brief,String imageUrl,String linkToUrl,String extraData, String [] tokensExpr) throws Exception
	{
	...
	protected UiAction createUiAction(XingyouUserContext userContext, String code, String icon, String title, String brief, String imageUrl, String linkToUrl, String extraData) throws Exception{
	...
	protected void checkParamsForRemovingUiActionList(XingyouUserContext userContext, String pageId,
	...
	public  Page removeUiActionList(XingyouUserContext userContext, String pageId,
			String uiActionIds[],String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForRemovingUiAction(XingyouUserContext userContext, String pageId,
	...
	public  Page removeUiAction(XingyouUserContext userContext, String pageId,
		String uiActionId, int uiActionVersion,String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForCopyingUiAction(XingyouUserContext userContext, String pageId,
		String uiActionId, int uiActionVersion,String [] tokensExpr) throws Exception{
	...
	public  Page copyUiActionFrom(XingyouUserContext userContext, String pageId,
		String uiActionId, int uiActionVersion,String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForUpdatingUiAction(XingyouUserContext userContext, String pageId, String uiActionId, int uiActionVersion, String property, String newValueExpr,String [] tokensExpr) throws Exception{
	...
	public  Page updateUiAction(XingyouUserContext userContext, String pageId, String uiActionId, int uiActionVersion, String property, String newValueExpr,String [] tokensExpr)
			throws Exception{
	...
	*/
	...
	protected void checkParamsForAddingSection(XingyouUserContext userContext, String pageId, String title, String brief, String icon, String viewGroup, String linkToUrl,String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForUpdatingSectionProperties(XingyouUserContext userContext, String pageId,String id,String title,String brief,String icon,String viewGroup,String linkToUrl,String [] tokensExpr) throws Exception {
	...
	public  Page updateSectionProperties(XingyouUserContext userContext, String pageId, String id,String title,String brief,String icon,String viewGroup,String linkToUrl, String [] tokensExpr) throws Exception
	{
	...
	protected Section createSection(XingyouUserContext userContext, String title, String brief, String icon, String viewGroup, String linkToUrl) throws Exception{
	...
	protected void checkParamsForRemovingSectionList(XingyouUserContext userContext, String pageId,
	...
	public  Page removeSectionList(XingyouUserContext userContext, String pageId,
			String sectionIds[],String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForRemovingSection(XingyouUserContext userContext, String pageId,
	...
	public  Page removeSection(XingyouUserContext userContext, String pageId,
		String sectionId, int sectionVersion,String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForCopyingSection(XingyouUserContext userContext, String pageId,
		String sectionId, int sectionVersion,String [] tokensExpr) throws Exception{
	...
	public  Page copySectionFrom(XingyouUserContext userContext, String pageId,
		String sectionId, int sectionVersion,String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForUpdatingSection(XingyouUserContext userContext, String pageId, String sectionId, int sectionVersion, String property, String newValueExpr,String [] tokensExpr) throws Exception{
	...
	public  Page updateSection(XingyouUserContext userContext, String pageId, String sectionId, int sectionVersion, String property, String newValueExpr,String [] tokensExpr)
			throws Exception{
	...
	*/
	...
	// -----------------------------------// list-of-view 处理 \\-----------------------------------
    protected void enhanceForListOfView(XingyouUserContext userContext,SmartList<Page> list) throws Exception {
    	if (list == null || list.isEmpty()){
    		return;
    	}
		List<PageType> pageTypeList = XingyouBaseUtils.collectReferencedObjectWithType(userContext, list, PageType.class);
		userContext.getDAOGroup().enhanceList(pageTypeList, PageType.class);
		List<MobileApp> mobileAppList = XingyouBaseUtils.collectReferencedObjectWithType(userContext, list, MobileApp.class);
  ...
  // -----------------------------------\\ list-of-view 处理 //-----------------------------------v
	 ...
	 * @throws Exception
	 */
 	public Object wxappview(XingyouUserContext userContext, String pageId) throws Exception{
	  SerializeScope vscope = XingyouViewScope.getInstance().getPageDetailScope().clone();
    ...
    String pageTitle = "页面"+"详情";
		...
		vscope.field("slideListSection", XingyouListOfViewScope.getInstance()
		...
		vscope.field("uiActionListSection", XingyouListOfViewScope.getInstance()
		...
		vscope.field("sectionListSection", XingyouListOfViewScope.getInstance()
