...
public class UiActionTable{
	...
	public static final String []ALL_CLOUMNS = {COLUMN_ID,COLUMN_CODE,COLUMN_ICON,COLUMN_TITLE,COLUMN_BRIEF,COLUMN_IMAGE_URL,COLUMN_LINK_TO_URL,COLUMN_EXTRA_DATA,COLUMN_PAGE,COLUMN_VERSION};
	public static final String []NORMAL_CLOUMNS = {COLUMN_CODE,COLUMN_ICON,COLUMN_TITLE,COLUMN_BRIEF,COLUMN_IMAGE_URL,COLUMN_LINK_TO_URL,COLUMN_EXTRA_DATA,COLUMN_PAGE};
