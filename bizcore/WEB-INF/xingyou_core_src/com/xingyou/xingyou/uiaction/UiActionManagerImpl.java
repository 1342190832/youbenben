...
public class UiActionManagerImpl extends CustomXingyouCheckerManager implements UiActionManager, BusinessHandler{
	...
	@Override
	public UiActionDAO daoOf(XingyouUserContext userContext) {
	...
	protected void throwExceptionWithMessage(String value) throws UiActionManagerException{
 	...
 	protected UiAction saveUiAction(XingyouUserContext userContext, UiAction uiAction, String [] tokensExpr) throws Exception{	
 	...
 	protected UiAction saveUiActionDetail(XingyouUserContext userContext, UiAction uiAction) throws Exception{	
 	...
 	public UiAction loadUiAction(XingyouUserContext userContext, String uiActionId, String [] tokensExpr) throws Exception{				
 	 ...
 	 public UiAction searchUiAction(XingyouUserContext userContext, String uiActionId, String textToSearch,String [] tokensExpr) throws Exception{				
 	...
 	protected UiAction present(XingyouUserContext userContext, UiAction uiAction, Map<String, Object> tokens) throws Exception {
 	...
 	public UiAction loadUiActionDetail(XingyouUserContext userContext, String uiActionId) throws Exception{	
 		UiAction uiAction = loadUiAction( userContext, uiActionId, allTokens());
 		return present(userContext,uiAction, allTokens());
		
 	}
 	
 	public Object view(XingyouUserContext userContext, String uiActionId) throws Exception{	
 		UiAction uiAction = loadUiAction( userContext, uiActionId, viewTokens());
 		return present(userContext,uiAction, allTokens());
		
 	}
 	protected UiAction saveUiAction(XingyouUserContext userContext, UiAction uiAction, Map<String,Object>tokens) throws Exception{	
 		return uiActionDaoOf(userContext).save(uiAction, tokens);
 	}
 	protected UiAction loadUiAction(XingyouUserContext userContext, String uiActionId, Map<String,Object>tokens) throws Exception{	
		checkerOf(userContext).checkIdOfUiAction(uiActionId);
		checkerOf(userContext).throwExceptionIfHasErrors( UiActionManagerException.class);
 	...
 	protected<T extends BaseEntity> void addActions(XingyouUserContext userContext, UiAction uiAction, Map<String, Object> tokens){
	...
	}// end method of protected<T extends BaseEntity> void addActions(XingyouUserContext userContext, UiAction uiAction, Map<String, Object> tokens){
	...
	protected void checkParamsForUpdatingUiAction(XingyouUserContext userContext,String uiActionId, int uiActionVersion, String property, String newValueExpr,String [] tokensExpr)throws Exception
	{
	...
	public UiAction clone(XingyouUserContext userContext, String fromUiActionId) throws Exception{
	...
	public UiAction internalSaveUiAction(XingyouUserContext userContext, UiAction uiAction, Map<String,Object> options) throws Exception
	{
	...
	public UiAction updateUiActionProperty(XingyouUserContext userContext,String uiActionId, int uiActionVersion, String property, String newValueExpr,String [] tokensExpr) throws Exception
	{
		checkParamsForUpdatingUiAction(userContext, uiActionId, uiActionVersion, property, newValueExpr, tokensExpr);
	...
	protected void checkParamsForTransferingAnotherPage(XingyouUserContext userContext, String uiActionId, String anotherPageId) throws Exception
 	{
 ...
 //--------------------------------------------------------------
	...
	public void delete(XingyouUserContext userContext, String uiActionId, int uiActionVersion) throws Exception {
	...
	public UiAction forgetByAll(XingyouUserContext userContext, String uiActionId, int uiActionVersion) throws Exception {
		return forgetByAllInternal(userContext, uiActionId, uiActionVersion);
	}
	protected UiAction forgetByAllInternal(XingyouUserContext userContext,
			String uiActionId, int uiActionVersion) throws Exception{
	...
	// -----------------------------------// list-of-view 处理 \\-----------------------------------
    protected void enhanceForListOfView(XingyouUserContext userContext,SmartList<UiAction> list) throws Exception {
  ...
  // -----------------------------------\\ list-of-view 处理 //-----------------------------------v
	 ...
	 * @throws Exception
	 */
 	public Object wxappview(XingyouUserContext userContext, String uiActionId) throws Exception{
	  SerializeScope vscope = XingyouViewScope.getInstance().getUiActionDetailScope().clone();
