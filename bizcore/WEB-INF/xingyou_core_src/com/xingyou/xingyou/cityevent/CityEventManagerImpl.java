...
public class CityEventManagerImpl extends CustomXingyouCheckerManager implements CityEventManager, BusinessHandler{
	...
	@Override
	public CityEventDAO daoOf(XingyouUserContext userContext) {
	...
	protected void throwExceptionWithMessage(String value) throws CityEventManagerException{
 	...
 	protected CityEvent saveCityEvent(XingyouUserContext userContext, CityEvent cityEvent, String [] tokensExpr) throws Exception{	
 	...
 	protected CityEvent saveCityEventDetail(XingyouUserContext userContext, CityEvent cityEvent) throws Exception{	
 	...
 	public CityEvent loadCityEvent(XingyouUserContext userContext, String cityEventId, String [] tokensExpr) throws Exception{				
 	 ...
 	 public CityEvent searchCityEvent(XingyouUserContext userContext, String cityEventId, String textToSearch,String [] tokensExpr) throws Exception{				
 	...
 	protected CityEvent present(XingyouUserContext userContext, CityEvent cityEvent, Map<String, Object> tokens) throws Exception {
 	...
 	public CityEvent loadCityEventDetail(XingyouUserContext userContext, String cityEventId) throws Exception{	
 		CityEvent cityEvent = loadCityEvent( userContext, cityEventId, allTokens());
 		return present(userContext,cityEvent, allTokens());
		
 	}
 	
 	public Object view(XingyouUserContext userContext, String cityEventId) throws Exception{	
 		CityEvent cityEvent = loadCityEvent( userContext, cityEventId, viewTokens());
 		return present(userContext,cityEvent, allTokens());
		
 	}
 	protected CityEvent saveCityEvent(XingyouUserContext userContext, CityEvent cityEvent, Map<String,Object>tokens) throws Exception{	
 		return cityEventDaoOf(userContext).save(cityEvent, tokens);
 	}
 	protected CityEvent loadCityEvent(XingyouUserContext userContext, String cityEventId, Map<String,Object>tokens) throws Exception{	
		checkerOf(userContext).checkIdOfCityEvent(cityEventId);
		checkerOf(userContext).throwExceptionIfHasErrors( CityEventManagerException.class);
 	...
 	protected<T extends BaseEntity> void addActions(XingyouUserContext userContext, CityEvent cityEvent, Map<String, Object> tokens){
	...
	}// end method of protected<T extends BaseEntity> void addActions(XingyouUserContext userContext, CityEvent cityEvent, Map<String, Object> tokens){
	...
	protected void checkParamsForUpdatingCityEvent(XingyouUserContext userContext,String cityEventId, int cityEventVersion, String property, String newValueExpr,String [] tokensExpr)throws Exception
	{
	...
	public CityEvent clone(XingyouUserContext userContext, String fromCityEventId) throws Exception{
	...
	public CityEvent internalSaveCityEvent(XingyouUserContext userContext, CityEvent cityEvent, Map<String,Object> options) throws Exception
	{
	...
	public CityEvent updateCityEventProperty(XingyouUserContext userContext,String cityEventId, int cityEventVersion, String property, String newValueExpr,String [] tokensExpr) throws Exception
	{
		checkParamsForUpdatingCityEvent(userContext, cityEventId, cityEventVersion, property, newValueExpr, tokensExpr);
	...
	protected void checkParamsForTransferingAnotherCityServiceCenter(XingyouUserContext userContext, String cityEventId, String anotherCityServiceCenterId) throws Exception
 	{
 ...
 //--------------------------------------------------------------
	...
	public void delete(XingyouUserContext userContext, String cityEventId, int cityEventVersion) throws Exception {
	...
	public CityEvent forgetByAll(XingyouUserContext userContext, String cityEventId, int cityEventVersion) throws Exception {
		return forgetByAllInternal(userContext, cityEventId, cityEventVersion);
	}
	protected CityEvent forgetByAllInternal(XingyouUserContext userContext,
			String cityEventId, int cityEventVersion) throws Exception{
	...
	protected CityEvent breakWithEventAttendanceByPotentialCustomer(XingyouUserContext userContext, String cityEventId, String potentialCustomerId,  String [] tokensExpr)
		 throws Exception{
	...
	protected void checkParamsForAddingEventAttendance(XingyouUserContext userContext, String cityEventId, String name, String potentialCustomerId, String description,String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForUpdatingEventAttendanceProperties(XingyouUserContext userContext, String cityEventId,String id,String name,String description,String [] tokensExpr) throws Exception {
	...
	public  CityEvent updateEventAttendanceProperties(XingyouUserContext userContext, String cityEventId, String id,String name,String description, String [] tokensExpr) throws Exception
	{
	...
	protected EventAttendance createEventAttendance(XingyouUserContext userContext, String name, String potentialCustomerId, String description) throws Exception{
	...
	protected void checkParamsForRemovingEventAttendanceList(XingyouUserContext userContext, String cityEventId,
	...
	public  CityEvent removeEventAttendanceList(XingyouUserContext userContext, String cityEventId,
			String eventAttendanceIds[],String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForRemovingEventAttendance(XingyouUserContext userContext, String cityEventId,
	...
	public  CityEvent removeEventAttendance(XingyouUserContext userContext, String cityEventId,
		String eventAttendanceId, int eventAttendanceVersion,String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForCopyingEventAttendance(XingyouUserContext userContext, String cityEventId,
		String eventAttendanceId, int eventAttendanceVersion,String [] tokensExpr) throws Exception{
	...
	public  CityEvent copyEventAttendanceFrom(XingyouUserContext userContext, String cityEventId,
		String eventAttendanceId, int eventAttendanceVersion,String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForUpdatingEventAttendance(XingyouUserContext userContext, String cityEventId, String eventAttendanceId, int eventAttendanceVersion, String property, String newValueExpr,String [] tokensExpr) throws Exception{
	...
	public  CityEvent updateEventAttendance(XingyouUserContext userContext, String cityEventId, String eventAttendanceId, int eventAttendanceVersion, String property, String newValueExpr,String [] tokensExpr)
			throws Exception{
	...
	*/
	...
	// -----------------------------------// list-of-view 处理 \\-----------------------------------
    protected void enhanceForListOfView(XingyouUserContext userContext,SmartList<CityEvent> list) throws Exception {
  ...
  // -----------------------------------\\ list-of-view 处理 //-----------------------------------v
	 ...
	 * @throws Exception
	 */
 	public Object wxappview(XingyouUserContext userContext, String cityEventId) throws Exception{
	  SerializeScope vscope = XingyouViewScope.getInstance().getCityEventDetailScope().clone();
