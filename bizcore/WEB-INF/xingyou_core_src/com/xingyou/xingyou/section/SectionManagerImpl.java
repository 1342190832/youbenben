...
public class SectionManagerImpl extends CustomXingyouCheckerManager implements SectionManager, BusinessHandler{
	...
	@Override
	public SectionDAO daoOf(XingyouUserContext userContext) {
	...
	protected void throwExceptionWithMessage(String value) throws SectionManagerException{
 	...
 	protected Section saveSection(XingyouUserContext userContext, Section section, String [] tokensExpr) throws Exception{	
 	...
 	protected Section saveSectionDetail(XingyouUserContext userContext, Section section) throws Exception{	
 	...
 	public Section loadSection(XingyouUserContext userContext, String sectionId, String [] tokensExpr) throws Exception{				
 	 ...
 	 public Section searchSection(XingyouUserContext userContext, String sectionId, String textToSearch,String [] tokensExpr) throws Exception{				
 	...
 	protected Section present(XingyouUserContext userContext, Section section, Map<String, Object> tokens) throws Exception {
 	...
 	public Section loadSectionDetail(XingyouUserContext userContext, String sectionId) throws Exception{	
 		Section section = loadSection( userContext, sectionId, allTokens());
 		return present(userContext,section, allTokens());
		
 	}
 	
 	public Object view(XingyouUserContext userContext, String sectionId) throws Exception{	
 		Section section = loadSection( userContext, sectionId, viewTokens());
 		return present(userContext,section, allTokens());
		
 	}
 	protected Section saveSection(XingyouUserContext userContext, Section section, Map<String,Object>tokens) throws Exception{	
 		return sectionDaoOf(userContext).save(section, tokens);
 	}
 	protected Section loadSection(XingyouUserContext userContext, String sectionId, Map<String,Object>tokens) throws Exception{	
		checkerOf(userContext).checkIdOfSection(sectionId);
		checkerOf(userContext).throwExceptionIfHasErrors( SectionManagerException.class);
 	...
 	protected<T extends BaseEntity> void addActions(XingyouUserContext userContext, Section section, Map<String, Object> tokens){
	...
	}// end method of protected<T extends BaseEntity> void addActions(XingyouUserContext userContext, Section section, Map<String, Object> tokens){
	...
	protected void checkParamsForUpdatingSection(XingyouUserContext userContext,String sectionId, int sectionVersion, String property, String newValueExpr,String [] tokensExpr)throws Exception
	{
	...
	public Section clone(XingyouUserContext userContext, String fromSectionId) throws Exception{
	...
	public Section internalSaveSection(XingyouUserContext userContext, Section section, Map<String,Object> options) throws Exception
	{
	...
	public Section updateSectionProperty(XingyouUserContext userContext,String sectionId, int sectionVersion, String property, String newValueExpr,String [] tokensExpr) throws Exception
	{
		checkParamsForUpdatingSection(userContext, sectionId, sectionVersion, property, newValueExpr, tokensExpr);
	...
	protected void checkParamsForTransferingAnotherPage(XingyouUserContext userContext, String sectionId, String anotherPageId) throws Exception
 	{
 ...
 //--------------------------------------------------------------
	...
	public void delete(XingyouUserContext userContext, String sectionId, int sectionVersion) throws Exception {
	...
	public Section forgetByAll(XingyouUserContext userContext, String sectionId, int sectionVersion) throws Exception {
		return forgetByAllInternal(userContext, sectionId, sectionVersion);
	}
	protected Section forgetByAllInternal(XingyouUserContext userContext,
			String sectionId, int sectionVersion) throws Exception{
	...
	// -----------------------------------// list-of-view 处理 \\-----------------------------------
    protected void enhanceForListOfView(XingyouUserContext userContext,SmartList<Section> list) throws Exception {
  ...
  // -----------------------------------\\ list-of-view 处理 //-----------------------------------v
	 ...
	 * @throws Exception
	 */
 	public Object wxappview(XingyouUserContext userContext, String sectionId) throws Exception{
	  SerializeScope vscope = XingyouViewScope.getInstance().getSectionDetailScope().clone();
