...
@JsonSerialize(using = XingyouExceptionJsonSerializer.class)
public class XingyouException extends Exception implements MessageContainer {
    ...
    public XingyouException() {
        super();
    }
    
	
    public XingyouException(String message) {
        super(message);
    }
    public XingyouException(Message message) {
    	super();
        this.addErrorMessage(message);
    }
	public XingyouException(List<Message> messageList) {
        super();
    ...
    public XingyouException(String message, Throwable cause) {
        super(message, cause);
    }


    public XingyouException(Throwable cause) {
        super(cause);
    }
