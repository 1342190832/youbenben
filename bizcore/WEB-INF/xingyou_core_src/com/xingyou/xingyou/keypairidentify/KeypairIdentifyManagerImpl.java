...
import com.xingyou.xingyou.publickeytype.CandidatePublicKeyType;
...
public class KeypairIdentifyManagerImpl extends CustomXingyouCheckerManager implements KeypairIdentifyManager, BusinessHandler{
	...
	@Override
	public KeypairIdentifyDAO daoOf(XingyouUserContext userContext) {
	...
	protected void throwExceptionWithMessage(String value) throws KeypairIdentifyManagerException{
 	...
 	protected KeypairIdentify saveKeypairIdentify(XingyouUserContext userContext, KeypairIdentify keypairIdentify, String [] tokensExpr) throws Exception{	
 	...
 	protected KeypairIdentify saveKeypairIdentifyDetail(XingyouUserContext userContext, KeypairIdentify keypairIdentify) throws Exception{	
 	...
 	public KeypairIdentify loadKeypairIdentify(XingyouUserContext userContext, String keypairIdentifyId, String [] tokensExpr) throws Exception{				
 	 ...
 	 public KeypairIdentify searchKeypairIdentify(XingyouUserContext userContext, String keypairIdentifyId, String textToSearch,String [] tokensExpr) throws Exception{				
 	...
 	protected KeypairIdentify present(XingyouUserContext userContext, KeypairIdentify keypairIdentify, Map<String, Object> tokens) throws Exception {
 	...
 	public KeypairIdentify loadKeypairIdentifyDetail(XingyouUserContext userContext, String keypairIdentifyId) throws Exception{	
 	...
 	public Object view(XingyouUserContext userContext, String keypairIdentifyId) throws Exception{	
 		KeypairIdentify keypairIdentify = loadKeypairIdentify( userContext, keypairIdentifyId, viewTokens());
 		return present(userContext,keypairIdentify, allTokens());
		
 	}
 	protected KeypairIdentify saveKeypairIdentify(XingyouUserContext userContext, KeypairIdentify keypairIdentify, Map<String,Object>tokens) throws Exception{	
 		return keypairIdentifyDaoOf(userContext).save(keypairIdentify, tokens);
 	}
 	protected KeypairIdentify loadKeypairIdentify(XingyouUserContext userContext, String keypairIdentifyId, Map<String,Object>tokens) throws Exception{	
		checkerOf(userContext).checkIdOfKeypairIdentify(keypairIdentifyId);
		checkerOf(userContext).throwExceptionIfHasErrors( KeypairIdentifyManagerException.class);
 	...
 	protected<T extends BaseEntity> void addActions(XingyouUserContext userContext, KeypairIdentify keypairIdentify, Map<String, Object> tokens){
	...
	}// end method of protected<T extends BaseEntity> void addActions(XingyouUserContext userContext, KeypairIdentify keypairIdentify, Map<String, Object> tokens){
	...
	protected void checkParamsForUpdatingKeypairIdentify(XingyouUserContext userContext,String keypairIdentifyId, int keypairIdentifyVersion, String property, String newValueExpr,String [] tokensExpr)throws Exception
	{
	...
	public KeypairIdentify clone(XingyouUserContext userContext, String fromKeypairIdentifyId) throws Exception{
	...
	public KeypairIdentify internalSaveKeypairIdentify(XingyouUserContext userContext, KeypairIdentify keypairIdentify, Map<String,Object> options) throws Exception
	{
	...
	public KeypairIdentify updateKeypairIdentifyProperty(XingyouUserContext userContext,String keypairIdentifyId, int keypairIdentifyVersion, String property, String newValueExpr,String [] tokensExpr) throws Exception
	{
		checkParamsForUpdatingKeypairIdentify(userContext, keypairIdentifyId, keypairIdentifyVersion, property, newValueExpr, tokensExpr);
	...
	protected void checkParamsForTransferingAnotherKeyType(XingyouUserContext userContext, String keypairIdentifyId, String anotherKeyTypeId) throws Exception
 	{
	...
	public CandidatePublicKeyType requestCandidateKeyType(XingyouUserContext userContext, String ownerClass, String id, String filterKey, int pageNo) throws Exception {
 	...
 	protected void checkParamsForTransferingAnotherSecUser(XingyouUserContext userContext, String keypairIdentifyId, String anotherSecUserId) throws Exception
 	{
	...
	protected void checkParamsForTransferingAnotherSecUserWithLogin(XingyouUserContext userContext, String keypairIdentifyId, String anotherLogin) throws Exception
 	{
 	...
 	public KeypairIdentify transferToAnotherSecUserWithLogin(XingyouUserContext userContext, String keypairIdentifyId, String anotherLogin) throws Exception
 	{
	...
	protected void checkParamsForTransferingAnotherSecUserWithEmail(XingyouUserContext userContext, String keypairIdentifyId, String anotherEmail) throws Exception
 	{
 	...
 	public KeypairIdentify transferToAnotherSecUserWithEmail(XingyouUserContext userContext, String keypairIdentifyId, String anotherEmail) throws Exception
 	{
	...
	protected void checkParamsForTransferingAnotherSecUserWithMobile(XingyouUserContext userContext, String keypairIdentifyId, String anotherMobile) throws Exception
 	{
 	...
 	public KeypairIdentify transferToAnotherSecUserWithMobile(XingyouUserContext userContext, String keypairIdentifyId, String anotherMobile) throws Exception
 	{
 ...
 //--------------------------------------------------------------
 	...
 	protected PublicKeyType loadPublicKeyType(XingyouUserContext userContext, String newKeyTypeId, Map<String,Object> options) throws Exception
 	{
	...
	public void delete(XingyouUserContext userContext, String keypairIdentifyId, int keypairIdentifyVersion) throws Exception {
	...
	public KeypairIdentify forgetByAll(XingyouUserContext userContext, String keypairIdentifyId, int keypairIdentifyVersion) throws Exception {
		return forgetByAllInternal(userContext, keypairIdentifyId, keypairIdentifyVersion);
	}
	protected KeypairIdentify forgetByAllInternal(XingyouUserContext userContext,
			String keypairIdentifyId, int keypairIdentifyVersion) throws Exception{
	...
	// -----------------------------------// list-of-view 处理 \\-----------------------------------
    protected void enhanceForListOfView(XingyouUserContext userContext,SmartList<KeypairIdentify> list) throws Exception {
    	if (list == null || list.isEmpty()){
    		return;
    	}
		List<PublicKeyType> keyTypeList = XingyouBaseUtils.collectReferencedObjectWithType(userContext, list, PublicKeyType.class);
  ...
  // -----------------------------------\\ list-of-view 处理 //-----------------------------------v
	 ...
	 * @throws Exception
	 */
 	public Object wxappview(XingyouUserContext userContext, String keypairIdentifyId) throws Exception{
	  SerializeScope vscope = XingyouViewScope.getInstance().getKeypairIdentifyDetailScope().clone();
