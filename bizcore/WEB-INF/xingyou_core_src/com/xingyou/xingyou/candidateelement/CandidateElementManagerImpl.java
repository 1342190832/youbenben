...
import com.xingyou.xingyou.candidatecontainer.CandidateCandidateContainer;
...
public class CandidateElementManagerImpl extends CustomXingyouCheckerManager implements CandidateElementManager, BusinessHandler{
	...
	@Override
	public CandidateElementDAO daoOf(XingyouUserContext userContext) {
	...
	protected void throwExceptionWithMessage(String value) throws CandidateElementManagerException{
 	...
 	protected CandidateElement saveCandidateElement(XingyouUserContext userContext, CandidateElement candidateElement, String [] tokensExpr) throws Exception{	
 	...
 	protected CandidateElement saveCandidateElementDetail(XingyouUserContext userContext, CandidateElement candidateElement) throws Exception{	
 	...
 	public CandidateElement loadCandidateElement(XingyouUserContext userContext, String candidateElementId, String [] tokensExpr) throws Exception{				
 	 ...
 	 public CandidateElement searchCandidateElement(XingyouUserContext userContext, String candidateElementId, String textToSearch,String [] tokensExpr) throws Exception{				
 	...
 	protected CandidateElement present(XingyouUserContext userContext, CandidateElement candidateElement, Map<String, Object> tokens) throws Exception {
 	...
 	public CandidateElement loadCandidateElementDetail(XingyouUserContext userContext, String candidateElementId) throws Exception{	
 	...
 	public Object view(XingyouUserContext userContext, String candidateElementId) throws Exception{	
 		CandidateElement candidateElement = loadCandidateElement( userContext, candidateElementId, viewTokens());
 		return present(userContext,candidateElement, allTokens());
		
 	}
 	protected CandidateElement saveCandidateElement(XingyouUserContext userContext, CandidateElement candidateElement, Map<String,Object>tokens) throws Exception{	
 		return candidateElementDaoOf(userContext).save(candidateElement, tokens);
 	}
 	protected CandidateElement loadCandidateElement(XingyouUserContext userContext, String candidateElementId, Map<String,Object>tokens) throws Exception{	
		checkerOf(userContext).checkIdOfCandidateElement(candidateElementId);
		checkerOf(userContext).throwExceptionIfHasErrors( CandidateElementManagerException.class);
 	...
 	protected<T extends BaseEntity> void addActions(XingyouUserContext userContext, CandidateElement candidateElement, Map<String, Object> tokens){
	...
	}// end method of protected<T extends BaseEntity> void addActions(XingyouUserContext userContext, CandidateElement candidateElement, Map<String, Object> tokens){
	...
	protected void checkParamsForUpdatingCandidateElement(XingyouUserContext userContext,String candidateElementId, int candidateElementVersion, String property, String newValueExpr,String [] tokensExpr)throws Exception
	{
	...
	public CandidateElement clone(XingyouUserContext userContext, String fromCandidateElementId) throws Exception{
	...
	public CandidateElement internalSaveCandidateElement(XingyouUserContext userContext, CandidateElement candidateElement, Map<String,Object> options) throws Exception
	{
	...
	public CandidateElement updateCandidateElementProperty(XingyouUserContext userContext,String candidateElementId, int candidateElementVersion, String property, String newValueExpr,String [] tokensExpr) throws Exception
	{
		checkParamsForUpdatingCandidateElement(userContext, candidateElementId, candidateElementVersion, property, newValueExpr, tokensExpr);
	...
	protected void checkParamsForTransferingAnotherContainer(XingyouUserContext userContext, String candidateElementId, String anotherContainerId) throws Exception
 	{
	...
	public CandidateCandidateContainer requestCandidateContainer(XingyouUserContext userContext, String ownerClass, String id, String filterKey, int pageNo) throws Exception {
 ...
 //--------------------------------------------------------------
 	...
 	protected CandidateContainer loadCandidateContainer(XingyouUserContext userContext, String newContainerId, Map<String,Object> options) throws Exception
 	{
	...
	public void delete(XingyouUserContext userContext, String candidateElementId, int candidateElementVersion) throws Exception {
	...
	public CandidateElement forgetByAll(XingyouUserContext userContext, String candidateElementId, int candidateElementVersion) throws Exception {
		return forgetByAllInternal(userContext, candidateElementId, candidateElementVersion);
	}
	protected CandidateElement forgetByAllInternal(XingyouUserContext userContext,
			String candidateElementId, int candidateElementVersion) throws Exception{
	...
	// -----------------------------------// list-of-view 处理 \\-----------------------------------
    protected void enhanceForListOfView(XingyouUserContext userContext,SmartList<CandidateElement> list) throws Exception {
    	if (list == null || list.isEmpty()){
    		return;
    	}
		List<CandidateContainer> containerList = XingyouBaseUtils.collectReferencedObjectWithType(userContext, list, CandidateContainer.class);
  ...
  // -----------------------------------\\ list-of-view 处理 //-----------------------------------v
	 ...
	 * @throws Exception
	 */
 	public Object wxappview(XingyouUserContext userContext, String candidateElementId) throws Exception{
	  SerializeScope vscope = XingyouViewScope.getInstance().getCandidateElementDetailScope().clone();
