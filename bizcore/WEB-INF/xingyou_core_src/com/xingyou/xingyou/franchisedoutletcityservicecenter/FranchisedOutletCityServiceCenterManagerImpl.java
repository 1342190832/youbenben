...
public class FranchisedOutletCityServiceCenterManagerImpl extends CustomXingyouCheckerManager implements FranchisedOutletCityServiceCenterManager, BusinessHandler{
	...
	@Override
	public FranchisedOutletCityServiceCenterDAO daoOf(XingyouUserContext userContext) {
	...
	protected void throwExceptionWithMessage(String value) throws FranchisedOutletCityServiceCenterManagerException{
 	...
 	protected FranchisedOutletCityServiceCenter saveFranchisedOutletCityServiceCenter(XingyouUserContext userContext, FranchisedOutletCityServiceCenter franchisedOutletCityServiceCenter, String [] tokensExpr) throws Exception{	
 	...
 	protected FranchisedOutletCityServiceCenter saveFranchisedOutletCityServiceCenterDetail(XingyouUserContext userContext, FranchisedOutletCityServiceCenter franchisedOutletCityServiceCenter) throws Exception{	
 	...
 	public FranchisedOutletCityServiceCenter loadFranchisedOutletCityServiceCenter(XingyouUserContext userContext, String franchisedOutletCityServiceCenterId, String [] tokensExpr) throws Exception{				
 	 ...
 	 public FranchisedOutletCityServiceCenter searchFranchisedOutletCityServiceCenter(XingyouUserContext userContext, String franchisedOutletCityServiceCenterId, String textToSearch,String [] tokensExpr) throws Exception{				
 	...
 	protected FranchisedOutletCityServiceCenter present(XingyouUserContext userContext, FranchisedOutletCityServiceCenter franchisedOutletCityServiceCenter, Map<String, Object> tokens) throws Exception {
 	...
 	public FranchisedOutletCityServiceCenter loadFranchisedOutletCityServiceCenterDetail(XingyouUserContext userContext, String franchisedOutletCityServiceCenterId) throws Exception{	
 	...
 	public Object view(XingyouUserContext userContext, String franchisedOutletCityServiceCenterId) throws Exception{	
 	...
 	protected FranchisedOutletCityServiceCenter saveFranchisedOutletCityServiceCenter(XingyouUserContext userContext, FranchisedOutletCityServiceCenter franchisedOutletCityServiceCenter, Map<String,Object>tokens) throws Exception{	
 		return franchisedOutletCityServiceCenterDaoOf(userContext).save(franchisedOutletCityServiceCenter, tokens);
 	}
 	protected FranchisedOutletCityServiceCenter loadFranchisedOutletCityServiceCenter(XingyouUserContext userContext, String franchisedOutletCityServiceCenterId, Map<String,Object>tokens) throws Exception{	
		checkerOf(userContext).checkIdOfFranchisedOutletCityServiceCenter(franchisedOutletCityServiceCenterId);
		checkerOf(userContext).throwExceptionIfHasErrors( FranchisedOutletCityServiceCenterManagerException.class);
 	...
 	protected<T extends BaseEntity> void addActions(XingyouUserContext userContext, FranchisedOutletCityServiceCenter franchisedOutletCityServiceCenter, Map<String, Object> tokens){
	...
	}// end method of protected<T extends BaseEntity> void addActions(XingyouUserContext userContext, FranchisedOutletCityServiceCenter franchisedOutletCityServiceCenter, Map<String, Object> tokens){
	...
	protected void checkParamsForUpdatingFranchisedOutletCityServiceCenter(XingyouUserContext userContext,String franchisedOutletCityServiceCenterId, int franchisedOutletCityServiceCenterVersion, String property, String newValueExpr,String [] tokensExpr)throws Exception
	{
	...
	public FranchisedOutletCityServiceCenter clone(XingyouUserContext userContext, String fromFranchisedOutletCityServiceCenterId) throws Exception{
	...
	public FranchisedOutletCityServiceCenter internalSaveFranchisedOutletCityServiceCenter(XingyouUserContext userContext, FranchisedOutletCityServiceCenter franchisedOutletCityServiceCenter, Map<String,Object> options) throws Exception
	{
	...
	public FranchisedOutletCityServiceCenter updateFranchisedOutletCityServiceCenterProperty(XingyouUserContext userContext,String franchisedOutletCityServiceCenterId, int franchisedOutletCityServiceCenterVersion, String property, String newValueExpr,String [] tokensExpr) throws Exception
	{
		checkParamsForUpdatingFranchisedOutletCityServiceCenter(userContext, franchisedOutletCityServiceCenterId, franchisedOutletCityServiceCenterVersion, property, newValueExpr, tokensExpr);
	...
	protected void checkParamsForTransferingAnotherBelongsTo(XingyouUserContext userContext, String franchisedOutletCityServiceCenterId, String anotherBelongsToId) throws Exception
 	{
	...
	public CandidateFranchisedOutletCityCenter requestCandidateBelongsTo(XingyouUserContext userContext, String ownerClass, String id, String filterKey, int pageNo) throws Exception {
 ...
 //--------------------------------------------------------------
 	...
 	protected FranchisedOutletCityCenter loadFranchisedOutletCityCenter(XingyouUserContext userContext, String newBelongsToId, Map<String,Object> options) throws Exception
 	{
	...
	public void delete(XingyouUserContext userContext, String franchisedOutletCityServiceCenterId, int franchisedOutletCityServiceCenterVersion) throws Exception {
	...
	public FranchisedOutletCityServiceCenter forgetByAll(XingyouUserContext userContext, String franchisedOutletCityServiceCenterId, int franchisedOutletCityServiceCenterVersion) throws Exception {
		return forgetByAllInternal(userContext, franchisedOutletCityServiceCenterId, franchisedOutletCityServiceCenterVersion);
	}
	protected FranchisedOutletCityServiceCenter forgetByAllInternal(XingyouUserContext userContext,
			String franchisedOutletCityServiceCenterId, int franchisedOutletCityServiceCenterVersion) throws Exception{
	...
	protected FranchisedOutletCityServiceCenter breakWithPotentialCustomerByCityPartner(XingyouUserContext userContext, String franchisedOutletCityServiceCenterId, String cityPartnerId,  String [] tokensExpr)
		 throws Exception{
	...
	protected void checkParamsForAddingCityPartner(XingyouUserContext userContext, String franchisedOutletCityServiceCenterId, String name, String mobile, String description,String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForUpdatingCityPartnerProperties(XingyouUserContext userContext, String franchisedOutletCityServiceCenterId,String id,String name,String mobile,String description,String [] tokensExpr) throws Exception {
	...
	public  FranchisedOutletCityServiceCenter updateCityPartnerProperties(XingyouUserContext userContext, String franchisedOutletCityServiceCenterId, String id,String name,String mobile,String description, String [] tokensExpr) throws Exception
	{
	...
	protected CityPartner createCityPartner(XingyouUserContext userContext, String name, String mobile, String description) throws Exception{
	...
	protected void checkParamsForRemovingCityPartnerList(XingyouUserContext userContext, String franchisedOutletCityServiceCenterId,
	...
	public  FranchisedOutletCityServiceCenter removeCityPartnerList(XingyouUserContext userContext, String franchisedOutletCityServiceCenterId,
			String cityPartnerIds[],String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForRemovingCityPartner(XingyouUserContext userContext, String franchisedOutletCityServiceCenterId,
	...
	public  FranchisedOutletCityServiceCenter removeCityPartner(XingyouUserContext userContext, String franchisedOutletCityServiceCenterId,
		String cityPartnerId, int cityPartnerVersion,String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForCopyingCityPartner(XingyouUserContext userContext, String franchisedOutletCityServiceCenterId,
		String cityPartnerId, int cityPartnerVersion,String [] tokensExpr) throws Exception{
	...
	public  FranchisedOutletCityServiceCenter copyCityPartnerFrom(XingyouUserContext userContext, String franchisedOutletCityServiceCenterId,
		String cityPartnerId, int cityPartnerVersion,String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForUpdatingCityPartner(XingyouUserContext userContext, String franchisedOutletCityServiceCenterId, String cityPartnerId, int cityPartnerVersion, String property, String newValueExpr,String [] tokensExpr) throws Exception{
	...
	public  FranchisedOutletCityServiceCenter updateCityPartner(XingyouUserContext userContext, String franchisedOutletCityServiceCenterId, String cityPartnerId, int cityPartnerVersion, String property, String newValueExpr,String [] tokensExpr)
			throws Exception{
	...
	*/
	...
	protected void checkParamsForAddingPotentialCustomer(XingyouUserContext userContext, String franchisedOutletCityServiceCenterId, String name, String mobile, String cityPartnerId, String description,String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForUpdatingPotentialCustomerProperties(XingyouUserContext userContext, String franchisedOutletCityServiceCenterId,String id,String name,String mobile,String description,String [] tokensExpr) throws Exception {
	...
	public  FranchisedOutletCityServiceCenter updatePotentialCustomerProperties(XingyouUserContext userContext, String franchisedOutletCityServiceCenterId, String id,String name,String mobile,String description, String [] tokensExpr) throws Exception
	{
	...
	protected PotentialCustomer createPotentialCustomer(XingyouUserContext userContext, String name, String mobile, String cityPartnerId, String description) throws Exception{
	...
	protected void checkParamsForRemovingPotentialCustomerList(XingyouUserContext userContext, String franchisedOutletCityServiceCenterId,
	...
	public  FranchisedOutletCityServiceCenter removePotentialCustomerList(XingyouUserContext userContext, String franchisedOutletCityServiceCenterId,
			String potentialCustomerIds[],String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForRemovingPotentialCustomer(XingyouUserContext userContext, String franchisedOutletCityServiceCenterId,
	...
	public  FranchisedOutletCityServiceCenter removePotentialCustomer(XingyouUserContext userContext, String franchisedOutletCityServiceCenterId,
		String potentialCustomerId, int potentialCustomerVersion,String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForCopyingPotentialCustomer(XingyouUserContext userContext, String franchisedOutletCityServiceCenterId,
		String potentialCustomerId, int potentialCustomerVersion,String [] tokensExpr) throws Exception{
	...
	public  FranchisedOutletCityServiceCenter copyPotentialCustomerFrom(XingyouUserContext userContext, String franchisedOutletCityServiceCenterId,
		String potentialCustomerId, int potentialCustomerVersion,String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForUpdatingPotentialCustomer(XingyouUserContext userContext, String franchisedOutletCityServiceCenterId, String potentialCustomerId, int potentialCustomerVersion, String property, String newValueExpr,String [] tokensExpr) throws Exception{
	...
	public  FranchisedOutletCityServiceCenter updatePotentialCustomer(XingyouUserContext userContext, String franchisedOutletCityServiceCenterId, String potentialCustomerId, int potentialCustomerVersion, String property, String newValueExpr,String [] tokensExpr)
			throws Exception{
	...
	*/
	...
	protected void checkParamsForAddingCityEvent(XingyouUserContext userContext, String franchisedOutletCityServiceCenterId, String name, String mobile, String description,String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForUpdatingCityEventProperties(XingyouUserContext userContext, String franchisedOutletCityServiceCenterId,String id,String name,String mobile,String description,String [] tokensExpr) throws Exception {
	...
	public  FranchisedOutletCityServiceCenter updateCityEventProperties(XingyouUserContext userContext, String franchisedOutletCityServiceCenterId, String id,String name,String mobile,String description, String [] tokensExpr) throws Exception
	{
	...
	protected CityEvent createCityEvent(XingyouUserContext userContext, String name, String mobile, String description) throws Exception{
	...
	protected void checkParamsForRemovingCityEventList(XingyouUserContext userContext, String franchisedOutletCityServiceCenterId,
	...
	public  FranchisedOutletCityServiceCenter removeCityEventList(XingyouUserContext userContext, String franchisedOutletCityServiceCenterId,
			String cityEventIds[],String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForRemovingCityEvent(XingyouUserContext userContext, String franchisedOutletCityServiceCenterId,
	...
	public  FranchisedOutletCityServiceCenter removeCityEvent(XingyouUserContext userContext, String franchisedOutletCityServiceCenterId,
		String cityEventId, int cityEventVersion,String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForCopyingCityEvent(XingyouUserContext userContext, String franchisedOutletCityServiceCenterId,
		String cityEventId, int cityEventVersion,String [] tokensExpr) throws Exception{
	...
	public  FranchisedOutletCityServiceCenter copyCityEventFrom(XingyouUserContext userContext, String franchisedOutletCityServiceCenterId,
		String cityEventId, int cityEventVersion,String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForUpdatingCityEvent(XingyouUserContext userContext, String franchisedOutletCityServiceCenterId, String cityEventId, int cityEventVersion, String property, String newValueExpr,String [] tokensExpr) throws Exception{
	...
	public  FranchisedOutletCityServiceCenter updateCityEvent(XingyouUserContext userContext, String franchisedOutletCityServiceCenterId, String cityEventId, int cityEventVersion, String property, String newValueExpr,String [] tokensExpr)
			throws Exception{
	...
	*/
	...
	// -----------------------------------// list-of-view 处理 \\-----------------------------------
    protected void enhanceForListOfView(XingyouUserContext userContext,SmartList<FranchisedOutletCityServiceCenter> list) throws Exception {
    	if (list == null || list.isEmpty()){
    		return;
    	}
		List<FranchisedOutletCityCenter> belongsToList = XingyouBaseUtils.collectReferencedObjectWithType(userContext, list, FranchisedOutletCityCenter.class);
  ...
  // -----------------------------------\\ list-of-view 处理 //-----------------------------------v
	 ...
	 * @throws Exception
	 */
 	public Object wxappview(XingyouUserContext userContext, String franchisedOutletCityServiceCenterId) throws Exception{
	  SerializeScope vscope = XingyouViewScope.getInstance().getFranchisedOutletCityServiceCenterDetailScope().clone();
    ...
    String pageTitle = "特许经销城市服务中心"+"详情";
		...
		vscope.field("cityPartnerListSection", XingyouListOfViewScope.getInstance()
		...
		vscope.field("cityEventListSection", XingyouListOfViewScope.getInstance()
