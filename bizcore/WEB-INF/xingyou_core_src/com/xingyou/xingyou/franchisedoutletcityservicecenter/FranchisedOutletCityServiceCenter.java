...
@JsonSerialize(using = FranchisedOutletCityServiceCenterSerializer.class)
public class FranchisedOutletCityServiceCenter extends BaseEntity implements  java.io.Serializable{
	...
	public static final String INTERNAL_TYPE="FranchisedOutletCityServiceCenter";
	...
	protected		FranchisedOutletCityCenter	mBelongsTo          ;
	...
	public 	FranchisedOutletCityServiceCenter(){
		// lazy load for all the properties
	}
	public 	static FranchisedOutletCityServiceCenter withId(String id){
	...
	public 	static FranchisedOutletCityServiceCenter refById(String id){
		return withId(id);
	}
	...
	public FranchisedOutletCityServiceCenter updateId(String id){
		this.mId = trimString(id);;
		this.changed = true;
		return this;
	}
	...
	public FranchisedOutletCityServiceCenter updateName(String name){
		this.mName = trimString(name);;
		this.changed = true;
		return this;
	}
	...
	public FranchisedOutletCityServiceCenter updateFounded(Date founded){
		this.mFounded = founded;;
		this.changed = true;
		return this;
	}
	...
	public void setBelongsTo(FranchisedOutletCityCenter belongsTo){
		this.mBelongsTo = belongsTo;;
	}
	public FranchisedOutletCityCenter getBelongsTo(){
		return this.mBelongsTo;
	}
	public FranchisedOutletCityServiceCenter updateBelongsTo(FranchisedOutletCityCenter belongsTo){
		this.mBelongsTo = belongsTo;;
		this.changed = true;
		return this;
	}
	public void mergeBelongsTo(FranchisedOutletCityCenter belongsTo){
	...
	public FranchisedOutletCityServiceCenter updateLastUpdateTime(DateTime lastUpdateTime){
		this.mLastUpdateTime = lastUpdateTime;;
		this.changed = true;
		return this;
	}
	...
	public FranchisedOutletCityServiceCenter updateVersion(int version){
		this.mVersion = version;;
		this.changed = true;
		return this;
	}
	...
	public  void setCityPartnerList(SmartList<CityPartner> cityPartnerList){
		for( CityPartner cityPartner:cityPartnerList){
			cityPartner.setTownServiceCenter(this);
		}
	...
	public  CityPartner removeCityPartner(CityPartner cityPartnerIndex){
        ...
        // cityPartner.clearTownServiceCenter(); //disconnect with TownServiceCenter
        cityPartner.clearFromAll(); //disconnect with TownServiceCenter
	...
	public  void breakWithCityPartner(CityPartner cityPartner){
		...
		cityPartner.setTownServiceCenter(null);
	...
	public BaseEntity copyTo(BaseEntity baseDest){
		...
		if(baseDest instanceof FranchisedOutletCityServiceCenter){
		
		
			FranchisedOutletCityServiceCenter dest =(FranchisedOutletCityServiceCenter)baseDest;
	...
	public String toString(){
		...
		stringBuilder.append("FranchisedOutletCityServiceCenter{");
		stringBuilder.append("\tid='"+getId()+"';");
		stringBuilder.append("\tname='"+getName()+"';");
		stringBuilder.append("\tfounded='"+getFounded()+"';");
		if(getBelongsTo() != null ){
 			stringBuilder.append("\tbelongsTo='FranchisedOutletCityCenter("+getBelongsTo().getId()+")';");
 		}
