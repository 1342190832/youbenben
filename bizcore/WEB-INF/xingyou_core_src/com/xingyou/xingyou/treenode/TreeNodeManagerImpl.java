...
public class TreeNodeManagerImpl extends CustomXingyouCheckerManager implements TreeNodeManager, BusinessHandler{
	...
	@Override
	public TreeNodeDAO daoOf(XingyouUserContext userContext) {
	...
	protected void throwExceptionWithMessage(String value) throws TreeNodeManagerException{
 	...
 	protected TreeNode saveTreeNode(XingyouUserContext userContext, TreeNode treeNode, String [] tokensExpr) throws Exception{	
 	...
 	protected TreeNode saveTreeNodeDetail(XingyouUserContext userContext, TreeNode treeNode) throws Exception{	
 	...
 	public TreeNode loadTreeNode(XingyouUserContext userContext, String treeNodeId, String [] tokensExpr) throws Exception{				
 	 ...
 	 public TreeNode searchTreeNode(XingyouUserContext userContext, String treeNodeId, String textToSearch,String [] tokensExpr) throws Exception{				
 	...
 	protected TreeNode present(XingyouUserContext userContext, TreeNode treeNode, Map<String, Object> tokens) throws Exception {
 	...
 	public TreeNode loadTreeNodeDetail(XingyouUserContext userContext, String treeNodeId) throws Exception{	
 		TreeNode treeNode = loadTreeNode( userContext, treeNodeId, allTokens());
 		return present(userContext,treeNode, allTokens());
		
 	}
 	
 	public Object view(XingyouUserContext userContext, String treeNodeId) throws Exception{	
 		TreeNode treeNode = loadTreeNode( userContext, treeNodeId, viewTokens());
 		return present(userContext,treeNode, allTokens());
		
 	}
 	protected TreeNode saveTreeNode(XingyouUserContext userContext, TreeNode treeNode, Map<String,Object>tokens) throws Exception{	
 		return treeNodeDaoOf(userContext).save(treeNode, tokens);
 	}
 	protected TreeNode loadTreeNode(XingyouUserContext userContext, String treeNodeId, Map<String,Object>tokens) throws Exception{	
		checkerOf(userContext).checkIdOfTreeNode(treeNodeId);
		checkerOf(userContext).throwExceptionIfHasErrors( TreeNodeManagerException.class);
 	...
 	protected<T extends BaseEntity> void addActions(XingyouUserContext userContext, TreeNode treeNode, Map<String, Object> tokens){
	...
	}// end method of protected<T extends BaseEntity> void addActions(XingyouUserContext userContext, TreeNode treeNode, Map<String, Object> tokens){
	...
	protected void checkParamsForUpdatingTreeNode(XingyouUserContext userContext,String treeNodeId, int treeNodeVersion, String property, String newValueExpr,String [] tokensExpr)throws Exception
	{
	...
	public TreeNode clone(XingyouUserContext userContext, String fromTreeNodeId) throws Exception{
	...
	public TreeNode internalSaveTreeNode(XingyouUserContext userContext, TreeNode treeNode, Map<String,Object> options) throws Exception
	{
	...
	public TreeNode updateTreeNodeProperty(XingyouUserContext userContext,String treeNodeId, int treeNodeVersion, String property, String newValueExpr,String [] tokensExpr) throws Exception
	{
		checkParamsForUpdatingTreeNode(userContext, treeNodeId, treeNodeVersion, property, newValueExpr, tokensExpr);
...
//--------------------------------------------------------------
	...
	public void delete(XingyouUserContext userContext, String treeNodeId, int treeNodeVersion) throws Exception {
	...
	public TreeNode forgetByAll(XingyouUserContext userContext, String treeNodeId, int treeNodeVersion) throws Exception {
		return forgetByAllInternal(userContext, treeNodeId, treeNodeVersion);
	}
	protected TreeNode forgetByAllInternal(XingyouUserContext userContext,
			String treeNodeId, int treeNodeVersion) throws Exception{
	...
	// -----------------------------------// list-of-view 处理 \\-----------------------------------
    protected void enhanceForListOfView(XingyouUserContext userContext,SmartList<TreeNode> list) throws Exception {
  ...
  // -----------------------------------\\ list-of-view 处理 //-----------------------------------v
	 ...
	 * @throws Exception
	 */
 	public Object wxappview(XingyouUserContext userContext, String treeNodeId) throws Exception{
	  SerializeScope vscope = XingyouViewScope.getInstance().getTreeNodeDetailScope().clone();
