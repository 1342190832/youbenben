...
import com.xingyou.xingyou.levelthreecategory.CandidateLevelThreeCategory;
...
public class ProductManagerImpl extends CustomXingyouCheckerManager implements ProductManager, BusinessHandler{
	...
	@Override
	public ProductDAO daoOf(XingyouUserContext userContext) {
	...
	protected void throwExceptionWithMessage(String value) throws ProductManagerException{
 	...
 	protected Product saveProduct(XingyouUserContext userContext, Product product, String [] tokensExpr) throws Exception{	
 	...
 	protected Product saveProductDetail(XingyouUserContext userContext, Product product) throws Exception{	
 	...
 	public Product loadProduct(XingyouUserContext userContext, String productId, String [] tokensExpr) throws Exception{				
 	 ...
 	 public Product searchProduct(XingyouUserContext userContext, String productId, String textToSearch,String [] tokensExpr) throws Exception{				
 	...
 	protected Product present(XingyouUserContext userContext, Product product, Map<String, Object> tokens) throws Exception {
 	...
 	public Product loadProductDetail(XingyouUserContext userContext, String productId) throws Exception{	
 		Product product = loadProduct( userContext, productId, allTokens());
 		return present(userContext,product, allTokens());
		
 	}
 	
 	public Object view(XingyouUserContext userContext, String productId) throws Exception{	
 		Product product = loadProduct( userContext, productId, viewTokens());
 		return present(userContext,product, allTokens());
		
 	}
 	protected Product saveProduct(XingyouUserContext userContext, Product product, Map<String,Object>tokens) throws Exception{	
 		return productDaoOf(userContext).save(product, tokens);
 	}
 	protected Product loadProduct(XingyouUserContext userContext, String productId, Map<String,Object>tokens) throws Exception{	
		checkerOf(userContext).checkIdOfProduct(productId);
		checkerOf(userContext).throwExceptionIfHasErrors( ProductManagerException.class);
 	...
 	protected<T extends BaseEntity> void addActions(XingyouUserContext userContext, Product product, Map<String, Object> tokens){
	...
	}// end method of protected<T extends BaseEntity> void addActions(XingyouUserContext userContext, Product product, Map<String, Object> tokens){
	...
	protected void checkParamsForUpdatingProduct(XingyouUserContext userContext,String productId, int productVersion, String property, String newValueExpr,String [] tokensExpr)throws Exception
	{
	...
	public Product clone(XingyouUserContext userContext, String fromProductId) throws Exception{
	...
	public Product internalSaveProduct(XingyouUserContext userContext, Product product, Map<String,Object> options) throws Exception
	{
	...
	public Product updateProductProperty(XingyouUserContext userContext,String productId, int productVersion, String property, String newValueExpr,String [] tokensExpr) throws Exception
	{
		checkParamsForUpdatingProduct(userContext, productId, productVersion, property, newValueExpr, tokensExpr);
	...
	protected void checkParamsForTransferingAnotherParentCategory(XingyouUserContext userContext, String productId, String anotherParentCategoryId) throws Exception
 	{
	...
	public CandidateLevelThreeCategory requestCandidateParentCategory(XingyouUserContext userContext, String ownerClass, String id, String filterKey, int pageNo) throws Exception {
 ...
 //--------------------------------------------------------------
 	...
 	protected LevelThreeCategory loadLevelThreeCategory(XingyouUserContext userContext, String newParentCategoryId, Map<String,Object> options) throws Exception
 	{
	...
	public void delete(XingyouUserContext userContext, String productId, int productVersion) throws Exception {
	...
	public Product forgetByAll(XingyouUserContext userContext, String productId, int productVersion) throws Exception {
		return forgetByAllInternal(userContext, productId, productVersion);
	}
	protected Product forgetByAllInternal(XingyouUserContext userContext,
			String productId, int productVersion) throws Exception{
	...
	protected void checkParamsForAddingSku(XingyouUserContext userContext, String productId, String name, String size, String barcode, String packageType, String netContent, BigDecimal price, String picture,String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForUpdatingSkuProperties(XingyouUserContext userContext, String productId,String id,String name,String size,String barcode,String packageType,String netContent,BigDecimal price,String picture,String [] tokensExpr) throws Exception {
	...
	public  Product updateSkuProperties(XingyouUserContext userContext, String productId, String id,String name,String size,String barcode,String packageType,String netContent,BigDecimal price,String picture, String [] tokensExpr) throws Exception
	{
	...
	protected Sku createSku(XingyouUserContext userContext, String name, String size, String barcode, String packageType, String netContent, BigDecimal price, String picture) throws Exception{
	...
	protected void checkParamsForRemovingSkuList(XingyouUserContext userContext, String productId,
	...
	public  Product removeSkuList(XingyouUserContext userContext, String productId,
			String skuIds[],String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForRemovingSku(XingyouUserContext userContext, String productId,
	...
	public  Product removeSku(XingyouUserContext userContext, String productId,
		String skuId, int skuVersion,String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForCopyingSku(XingyouUserContext userContext, String productId,
		String skuId, int skuVersion,String [] tokensExpr) throws Exception{
	...
	public  Product copySkuFrom(XingyouUserContext userContext, String productId,
		String skuId, int skuVersion,String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForUpdatingSku(XingyouUserContext userContext, String productId, String skuId, int skuVersion, String property, String newValueExpr,String [] tokensExpr) throws Exception{
	...
	public  Product updateSku(XingyouUserContext userContext, String productId, String skuId, int skuVersion, String property, String newValueExpr,String [] tokensExpr)
			throws Exception{
	...
	*/
	...
	// -----------------------------------// list-of-view 处理 \\-----------------------------------
    protected void enhanceForListOfView(XingyouUserContext userContext,SmartList<Product> list) throws Exception {
    	if (list == null || list.isEmpty()){
    		return;
    	}
		List<LevelThreeCategory> parentCategoryList = XingyouBaseUtils.collectReferencedObjectWithType(userContext, list, LevelThreeCategory.class);
  ...
  // -----------------------------------\\ list-of-view 处理 //-----------------------------------v
	 ...
	 * @throws Exception
	 */
 	public Object wxappview(XingyouUserContext userContext, String productId) throws Exception{
	  SerializeScope vscope = XingyouViewScope.getInstance().getProductDetailScope().clone();
    ...
    String pageTitle = "产品"+"详情";
		...
		vscope.field("skuListSection", XingyouListOfViewScope.getInstance()
