...
public class SlideTable{
	...
	public static final String []ALL_CLOUMNS = {COLUMN_ID,COLUMN_DISPLAY_ORDER,COLUMN_NAME,COLUMN_IMAGE_URL,COLUMN_VIDEO_URL,COLUMN_LINK_TO_URL,COLUMN_PAGE,COLUMN_VERSION};
	public static final String []NORMAL_CLOUMNS = {COLUMN_DISPLAY_ORDER,COLUMN_NAME,COLUMN_IMAGE_URL,COLUMN_VIDEO_URL,COLUMN_LINK_TO_URL,COLUMN_PAGE};
