...
import com.xingyou.xingyou.cityevent.CandidateCityEvent;
...
public class EventAttendanceManagerImpl extends CustomXingyouCheckerManager implements EventAttendanceManager, BusinessHandler{
	...
	@Override
	public EventAttendanceDAO daoOf(XingyouUserContext userContext) {
	...
	protected void throwExceptionWithMessage(String value) throws EventAttendanceManagerException{
 	...
 	protected EventAttendance saveEventAttendance(XingyouUserContext userContext, EventAttendance eventAttendance, String [] tokensExpr) throws Exception{	
 	...
 	protected EventAttendance saveEventAttendanceDetail(XingyouUserContext userContext, EventAttendance eventAttendance) throws Exception{	
 	...
 	public EventAttendance loadEventAttendance(XingyouUserContext userContext, String eventAttendanceId, String [] tokensExpr) throws Exception{				
 	 ...
 	 public EventAttendance searchEventAttendance(XingyouUserContext userContext, String eventAttendanceId, String textToSearch,String [] tokensExpr) throws Exception{				
 	...
 	protected EventAttendance present(XingyouUserContext userContext, EventAttendance eventAttendance, Map<String, Object> tokens) throws Exception {
 	...
 	public EventAttendance loadEventAttendanceDetail(XingyouUserContext userContext, String eventAttendanceId) throws Exception{	
 	...
 	public Object view(XingyouUserContext userContext, String eventAttendanceId) throws Exception{	
 		EventAttendance eventAttendance = loadEventAttendance( userContext, eventAttendanceId, viewTokens());
 		return present(userContext,eventAttendance, allTokens());
		
 	}
 	protected EventAttendance saveEventAttendance(XingyouUserContext userContext, EventAttendance eventAttendance, Map<String,Object>tokens) throws Exception{	
 		return eventAttendanceDaoOf(userContext).save(eventAttendance, tokens);
 	}
 	protected EventAttendance loadEventAttendance(XingyouUserContext userContext, String eventAttendanceId, Map<String,Object>tokens) throws Exception{	
		checkerOf(userContext).checkIdOfEventAttendance(eventAttendanceId);
		checkerOf(userContext).throwExceptionIfHasErrors( EventAttendanceManagerException.class);
 	...
 	protected<T extends BaseEntity> void addActions(XingyouUserContext userContext, EventAttendance eventAttendance, Map<String, Object> tokens){
	...
	}// end method of protected<T extends BaseEntity> void addActions(XingyouUserContext userContext, EventAttendance eventAttendance, Map<String, Object> tokens){
	...
	protected void checkParamsForUpdatingEventAttendance(XingyouUserContext userContext,String eventAttendanceId, int eventAttendanceVersion, String property, String newValueExpr,String [] tokensExpr)throws Exception
	{
	...
	public EventAttendance clone(XingyouUserContext userContext, String fromEventAttendanceId) throws Exception{
	...
	public EventAttendance internalSaveEventAttendance(XingyouUserContext userContext, EventAttendance eventAttendance, Map<String,Object> options) throws Exception
	{
	...
	public EventAttendance updateEventAttendanceProperty(XingyouUserContext userContext,String eventAttendanceId, int eventAttendanceVersion, String property, String newValueExpr,String [] tokensExpr) throws Exception
	{
		checkParamsForUpdatingEventAttendance(userContext, eventAttendanceId, eventAttendanceVersion, property, newValueExpr, tokensExpr);
	...
	protected void checkParamsForTransferingAnotherPotentialCustomer(XingyouUserContext userContext, String eventAttendanceId, String anotherPotentialCustomerId) throws Exception
 	{
	...
	public CandidatePotentialCustomer requestCandidatePotentialCustomer(XingyouUserContext userContext, String ownerClass, String id, String filterKey, int pageNo) throws Exception {
 	...
 	protected void checkParamsForTransferingAnotherCityEvent(XingyouUserContext userContext, String eventAttendanceId, String anotherCityEventId) throws Exception
 	{
	...
	public CandidateCityEvent requestCandidateCityEvent(XingyouUserContext userContext, String ownerClass, String id, String filterKey, int pageNo) throws Exception {
 ...
 //--------------------------------------------------------------
 	...
 	protected CityEvent loadCityEvent(XingyouUserContext userContext, String newCityEventId, Map<String,Object> options) throws Exception
 	{
	...
	public void delete(XingyouUserContext userContext, String eventAttendanceId, int eventAttendanceVersion) throws Exception {
	...
	public EventAttendance forgetByAll(XingyouUserContext userContext, String eventAttendanceId, int eventAttendanceVersion) throws Exception {
		return forgetByAllInternal(userContext, eventAttendanceId, eventAttendanceVersion);
	}
	protected EventAttendance forgetByAllInternal(XingyouUserContext userContext,
			String eventAttendanceId, int eventAttendanceVersion) throws Exception{
	...
	// -----------------------------------// list-of-view 处理 \\-----------------------------------
    protected void enhanceForListOfView(XingyouUserContext userContext,SmartList<EventAttendance> list) throws Exception {
		...
		List<CityEvent> cityEventList = XingyouBaseUtils.collectReferencedObjectWithType(userContext, list, CityEvent.class);
  ...
  // -----------------------------------\\ list-of-view 处理 //-----------------------------------v
	 ...
	 * @throws Exception
	 */
 	public Object wxappview(XingyouUserContext userContext, String eventAttendanceId) throws Exception{
	  SerializeScope vscope = XingyouViewScope.getInstance().getEventAttendanceDetailScope().clone();
