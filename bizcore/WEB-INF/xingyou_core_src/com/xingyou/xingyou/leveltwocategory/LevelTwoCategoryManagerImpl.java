...
import com.xingyou.xingyou.levelonecategory.CandidateLevelOneCategory;
...
public class LevelTwoCategoryManagerImpl extends CustomXingyouCheckerManager implements LevelTwoCategoryManager, BusinessHandler{
	...
	@Override
	public LevelTwoCategoryDAO daoOf(XingyouUserContext userContext) {
	...
	protected void throwExceptionWithMessage(String value) throws LevelTwoCategoryManagerException{
 	...
 	protected LevelTwoCategory saveLevelTwoCategory(XingyouUserContext userContext, LevelTwoCategory levelTwoCategory, String [] tokensExpr) throws Exception{	
 	...
 	protected LevelTwoCategory saveLevelTwoCategoryDetail(XingyouUserContext userContext, LevelTwoCategory levelTwoCategory) throws Exception{	
 	...
 	public LevelTwoCategory loadLevelTwoCategory(XingyouUserContext userContext, String levelTwoCategoryId, String [] tokensExpr) throws Exception{				
 	 ...
 	 public LevelTwoCategory searchLevelTwoCategory(XingyouUserContext userContext, String levelTwoCategoryId, String textToSearch,String [] tokensExpr) throws Exception{				
 	...
 	protected LevelTwoCategory present(XingyouUserContext userContext, LevelTwoCategory levelTwoCategory, Map<String, Object> tokens) throws Exception {
 	...
 	public LevelTwoCategory loadLevelTwoCategoryDetail(XingyouUserContext userContext, String levelTwoCategoryId) throws Exception{	
 	...
 	public Object view(XingyouUserContext userContext, String levelTwoCategoryId) throws Exception{	
 		LevelTwoCategory levelTwoCategory = loadLevelTwoCategory( userContext, levelTwoCategoryId, viewTokens());
 		return present(userContext,levelTwoCategory, allTokens());
		
 	}
 	protected LevelTwoCategory saveLevelTwoCategory(XingyouUserContext userContext, LevelTwoCategory levelTwoCategory, Map<String,Object>tokens) throws Exception{	
 		return levelTwoCategoryDaoOf(userContext).save(levelTwoCategory, tokens);
 	}
 	protected LevelTwoCategory loadLevelTwoCategory(XingyouUserContext userContext, String levelTwoCategoryId, Map<String,Object>tokens) throws Exception{	
		checkerOf(userContext).checkIdOfLevelTwoCategory(levelTwoCategoryId);
		checkerOf(userContext).throwExceptionIfHasErrors( LevelTwoCategoryManagerException.class);
 	...
 	protected<T extends BaseEntity> void addActions(XingyouUserContext userContext, LevelTwoCategory levelTwoCategory, Map<String, Object> tokens){
	...
	}// end method of protected<T extends BaseEntity> void addActions(XingyouUserContext userContext, LevelTwoCategory levelTwoCategory, Map<String, Object> tokens){
	...
	protected void checkParamsForUpdatingLevelTwoCategory(XingyouUserContext userContext,String levelTwoCategoryId, int levelTwoCategoryVersion, String property, String newValueExpr,String [] tokensExpr)throws Exception
	{
	...
	public LevelTwoCategory clone(XingyouUserContext userContext, String fromLevelTwoCategoryId) throws Exception{
	...
	public LevelTwoCategory internalSaveLevelTwoCategory(XingyouUserContext userContext, LevelTwoCategory levelTwoCategory, Map<String,Object> options) throws Exception
	{
	...
	public LevelTwoCategory updateLevelTwoCategoryProperty(XingyouUserContext userContext,String levelTwoCategoryId, int levelTwoCategoryVersion, String property, String newValueExpr,String [] tokensExpr) throws Exception
	{
		checkParamsForUpdatingLevelTwoCategory(userContext, levelTwoCategoryId, levelTwoCategoryVersion, property, newValueExpr, tokensExpr);
	...
	protected void checkParamsForTransferingAnotherParentCategory(XingyouUserContext userContext, String levelTwoCategoryId, String anotherParentCategoryId) throws Exception
 	{
	...
	public CandidateLevelOneCategory requestCandidateParentCategory(XingyouUserContext userContext, String ownerClass, String id, String filterKey, int pageNo) throws Exception {
 ...
 //--------------------------------------------------------------
 	...
 	protected LevelOneCategory loadLevelOneCategory(XingyouUserContext userContext, String newParentCategoryId, Map<String,Object> options) throws Exception
 	{
	...
	public void delete(XingyouUserContext userContext, String levelTwoCategoryId, int levelTwoCategoryVersion) throws Exception {
	...
	public LevelTwoCategory forgetByAll(XingyouUserContext userContext, String levelTwoCategoryId, int levelTwoCategoryVersion) throws Exception {
		return forgetByAllInternal(userContext, levelTwoCategoryId, levelTwoCategoryVersion);
	}
	protected LevelTwoCategory forgetByAllInternal(XingyouUserContext userContext,
			String levelTwoCategoryId, int levelTwoCategoryVersion) throws Exception{
	...
	protected void checkParamsForAddingLevelThreeCategory(XingyouUserContext userContext, String levelTwoCategoryId, String name,String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForUpdatingLevelThreeCategoryProperties(XingyouUserContext userContext, String levelTwoCategoryId,String id,String name,String [] tokensExpr) throws Exception {
	...
	public  LevelTwoCategory updateLevelThreeCategoryProperties(XingyouUserContext userContext, String levelTwoCategoryId, String id,String name, String [] tokensExpr) throws Exception
	{
	...
	protected LevelThreeCategory createLevelThreeCategory(XingyouUserContext userContext, String name) throws Exception{
	...
	protected void checkParamsForRemovingLevelThreeCategoryList(XingyouUserContext userContext, String levelTwoCategoryId,
	...
	public  LevelTwoCategory removeLevelThreeCategoryList(XingyouUserContext userContext, String levelTwoCategoryId,
			String levelThreeCategoryIds[],String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForRemovingLevelThreeCategory(XingyouUserContext userContext, String levelTwoCategoryId,
	...
	public  LevelTwoCategory removeLevelThreeCategory(XingyouUserContext userContext, String levelTwoCategoryId,
		String levelThreeCategoryId, int levelThreeCategoryVersion,String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForCopyingLevelThreeCategory(XingyouUserContext userContext, String levelTwoCategoryId,
		String levelThreeCategoryId, int levelThreeCategoryVersion,String [] tokensExpr) throws Exception{
	...
	public  LevelTwoCategory copyLevelThreeCategoryFrom(XingyouUserContext userContext, String levelTwoCategoryId,
		String levelThreeCategoryId, int levelThreeCategoryVersion,String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForUpdatingLevelThreeCategory(XingyouUserContext userContext, String levelTwoCategoryId, String levelThreeCategoryId, int levelThreeCategoryVersion, String property, String newValueExpr,String [] tokensExpr) throws Exception{
	...
	public  LevelTwoCategory updateLevelThreeCategory(XingyouUserContext userContext, String levelTwoCategoryId, String levelThreeCategoryId, int levelThreeCategoryVersion, String property, String newValueExpr,String [] tokensExpr)
			throws Exception{
	...
	*/
	...
	// -----------------------------------// list-of-view 处理 \\-----------------------------------
    protected void enhanceForListOfView(XingyouUserContext userContext,SmartList<LevelTwoCategory> list) throws Exception {
    	if (list == null || list.isEmpty()){
    		return;
    	}
		List<LevelOneCategory> parentCategoryList = XingyouBaseUtils.collectReferencedObjectWithType(userContext, list, LevelOneCategory.class);
  ...
  // -----------------------------------\\ list-of-view 处理 //-----------------------------------v
	 ...
	 * @throws Exception
	 */
 	public Object wxappview(XingyouUserContext userContext, String levelTwoCategoryId) throws Exception{
	  SerializeScope vscope = XingyouViewScope.getInstance().getLevelTwoCategoryDetailScope().clone();
    ...
    String pageTitle = "二级分类"+"详情";
		...
		vscope.field("levelThreeCategoryListSection", XingyouListOfViewScope.getInstance()
