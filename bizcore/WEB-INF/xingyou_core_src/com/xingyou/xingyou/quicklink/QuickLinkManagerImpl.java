...
public class QuickLinkManagerImpl extends CustomXingyouCheckerManager implements QuickLinkManager, BusinessHandler{
	...
	@Override
	public QuickLinkDAO daoOf(XingyouUserContext userContext) {
	...
	protected void throwExceptionWithMessage(String value) throws QuickLinkManagerException{
 	...
 	protected QuickLink saveQuickLink(XingyouUserContext userContext, QuickLink quickLink, String [] tokensExpr) throws Exception{	
 	...
 	protected QuickLink saveQuickLinkDetail(XingyouUserContext userContext, QuickLink quickLink) throws Exception{	
 	...
 	public QuickLink loadQuickLink(XingyouUserContext userContext, String quickLinkId, String [] tokensExpr) throws Exception{				
 	 ...
 	 public QuickLink searchQuickLink(XingyouUserContext userContext, String quickLinkId, String textToSearch,String [] tokensExpr) throws Exception{				
 	...
 	protected QuickLink present(XingyouUserContext userContext, QuickLink quickLink, Map<String, Object> tokens) throws Exception {
 	...
 	public QuickLink loadQuickLinkDetail(XingyouUserContext userContext, String quickLinkId) throws Exception{	
 		QuickLink quickLink = loadQuickLink( userContext, quickLinkId, allTokens());
 		return present(userContext,quickLink, allTokens());
		
 	}
 	
 	public Object view(XingyouUserContext userContext, String quickLinkId) throws Exception{	
 		QuickLink quickLink = loadQuickLink( userContext, quickLinkId, viewTokens());
 		return present(userContext,quickLink, allTokens());
		
 	}
 	protected QuickLink saveQuickLink(XingyouUserContext userContext, QuickLink quickLink, Map<String,Object>tokens) throws Exception{	
 		return quickLinkDaoOf(userContext).save(quickLink, tokens);
 	}
 	protected QuickLink loadQuickLink(XingyouUserContext userContext, String quickLinkId, Map<String,Object>tokens) throws Exception{	
		checkerOf(userContext).checkIdOfQuickLink(quickLinkId);
		checkerOf(userContext).throwExceptionIfHasErrors( QuickLinkManagerException.class);
 	...
 	protected<T extends BaseEntity> void addActions(XingyouUserContext userContext, QuickLink quickLink, Map<String, Object> tokens){
	...
	}// end method of protected<T extends BaseEntity> void addActions(XingyouUserContext userContext, QuickLink quickLink, Map<String, Object> tokens){
	...
	protected void checkParamsForUpdatingQuickLink(XingyouUserContext userContext,String quickLinkId, int quickLinkVersion, String property, String newValueExpr,String [] tokensExpr)throws Exception
	{
	...
	public QuickLink clone(XingyouUserContext userContext, String fromQuickLinkId) throws Exception{
	...
	public QuickLink internalSaveQuickLink(XingyouUserContext userContext, QuickLink quickLink, Map<String,Object> options) throws Exception
	{
	...
	public QuickLink updateQuickLinkProperty(XingyouUserContext userContext,String quickLinkId, int quickLinkVersion, String property, String newValueExpr,String [] tokensExpr) throws Exception
	{
		checkParamsForUpdatingQuickLink(userContext, quickLinkId, quickLinkVersion, property, newValueExpr, tokensExpr);
	...
	protected void checkParamsForTransferingAnotherApp(XingyouUserContext userContext, String quickLinkId, String anotherAppId) throws Exception
 	{
 ...
 //--------------------------------------------------------------
	...
	public void delete(XingyouUserContext userContext, String quickLinkId, int quickLinkVersion) throws Exception {
	...
	public QuickLink forgetByAll(XingyouUserContext userContext, String quickLinkId, int quickLinkVersion) throws Exception {
		return forgetByAllInternal(userContext, quickLinkId, quickLinkVersion);
	}
	protected QuickLink forgetByAllInternal(XingyouUserContext userContext,
			String quickLinkId, int quickLinkVersion) throws Exception{
	...
	// -----------------------------------// list-of-view 处理 \\-----------------------------------
    protected void enhanceForListOfView(XingyouUserContext userContext,SmartList<QuickLink> list) throws Exception {
  ...
  // -----------------------------------\\ list-of-view 处理 //-----------------------------------v
	 ...
	 * @throws Exception
	 */
 	public Object wxappview(XingyouUserContext userContext, String quickLinkId) throws Exception{
	  SerializeScope vscope = XingyouViewScope.getInstance().getQuickLinkDetailScope().clone();
