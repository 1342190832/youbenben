...
import com.xingyou.xingyou.userapp.CandidateUserApp;
...
public class ListAccessManagerImpl extends CustomXingyouCheckerManager implements ListAccessManager, BusinessHandler{
	...
	@Override
	public ListAccessDAO daoOf(XingyouUserContext userContext) {
	...
	protected void throwExceptionWithMessage(String value) throws ListAccessManagerException{
 	...
 	protected ListAccess saveListAccess(XingyouUserContext userContext, ListAccess listAccess, String [] tokensExpr) throws Exception{	
 	...
 	protected ListAccess saveListAccessDetail(XingyouUserContext userContext, ListAccess listAccess) throws Exception{	
 	...
 	public ListAccess loadListAccess(XingyouUserContext userContext, String listAccessId, String [] tokensExpr) throws Exception{				
 	 ...
 	 public ListAccess searchListAccess(XingyouUserContext userContext, String listAccessId, String textToSearch,String [] tokensExpr) throws Exception{				
 	...
 	protected ListAccess present(XingyouUserContext userContext, ListAccess listAccess, Map<String, Object> tokens) throws Exception {
 	...
 	public ListAccess loadListAccessDetail(XingyouUserContext userContext, String listAccessId) throws Exception{	
 		ListAccess listAccess = loadListAccess( userContext, listAccessId, allTokens());
 		return present(userContext,listAccess, allTokens());
		
 	}
 	
 	public Object view(XingyouUserContext userContext, String listAccessId) throws Exception{	
 		ListAccess listAccess = loadListAccess( userContext, listAccessId, viewTokens());
 		return present(userContext,listAccess, allTokens());
		
 	}
 	protected ListAccess saveListAccess(XingyouUserContext userContext, ListAccess listAccess, Map<String,Object>tokens) throws Exception{	
 		return listAccessDaoOf(userContext).save(listAccess, tokens);
 	}
 	protected ListAccess loadListAccess(XingyouUserContext userContext, String listAccessId, Map<String,Object>tokens) throws Exception{	
		checkerOf(userContext).checkIdOfListAccess(listAccessId);
		checkerOf(userContext).throwExceptionIfHasErrors( ListAccessManagerException.class);
 	...
 	protected<T extends BaseEntity> void addActions(XingyouUserContext userContext, ListAccess listAccess, Map<String, Object> tokens){
	...
	}// end method of protected<T extends BaseEntity> void addActions(XingyouUserContext userContext, ListAccess listAccess, Map<String, Object> tokens){
	...
	protected void checkParamsForUpdatingListAccess(XingyouUserContext userContext,String listAccessId, int listAccessVersion, String property, String newValueExpr,String [] tokensExpr)throws Exception
	{
	...
	public ListAccess clone(XingyouUserContext userContext, String fromListAccessId) throws Exception{
	...
	public ListAccess internalSaveListAccess(XingyouUserContext userContext, ListAccess listAccess, Map<String,Object> options) throws Exception
	{
	...
	public ListAccess updateListAccessProperty(XingyouUserContext userContext,String listAccessId, int listAccessVersion, String property, String newValueExpr,String [] tokensExpr) throws Exception
	{
		checkParamsForUpdatingListAccess(userContext, listAccessId, listAccessVersion, property, newValueExpr, tokensExpr);
	...
	protected void checkParamsForTransferingAnotherApp(XingyouUserContext userContext, String listAccessId, String anotherAppId) throws Exception
 	{
	...
	public CandidateUserApp requestCandidateApp(XingyouUserContext userContext, String ownerClass, String id, String filterKey, int pageNo) throws Exception {
 ...
 //--------------------------------------------------------------
 	...
 	protected UserApp loadUserApp(XingyouUserContext userContext, String newAppId, Map<String,Object> options) throws Exception
 	{
	...
	public void delete(XingyouUserContext userContext, String listAccessId, int listAccessVersion) throws Exception {
	...
	public ListAccess forgetByAll(XingyouUserContext userContext, String listAccessId, int listAccessVersion) throws Exception {
		return forgetByAllInternal(userContext, listAccessId, listAccessVersion);
	}
	protected ListAccess forgetByAllInternal(XingyouUserContext userContext,
			String listAccessId, int listAccessVersion) throws Exception{
	...
	// -----------------------------------// list-of-view 处理 \\-----------------------------------
    protected void enhanceForListOfView(XingyouUserContext userContext,SmartList<ListAccess> list) throws Exception {
    	if (list == null || list.isEmpty()){
    		return;
    	}
		List<UserApp> appList = XingyouBaseUtils.collectReferencedObjectWithType(userContext, list, UserApp.class);
  ...
  // -----------------------------------\\ list-of-view 处理 //-----------------------------------v
	 ...
	 * @throws Exception
	 */
 	public Object wxappview(XingyouUserContext userContext, String listAccessId) throws Exception{
	  SerializeScope vscope = XingyouViewScope.getInstance().getListAccessDetailScope().clone();
