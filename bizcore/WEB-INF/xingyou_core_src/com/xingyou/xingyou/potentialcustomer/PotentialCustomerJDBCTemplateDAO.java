...
public class PotentialCustomerJDBCTemplateDAO extends XingyouBaseDAOImpl implements PotentialCustomerDAO{
	...
	*/
	...
	protected PotentialCustomer loadInternalPotentialCustomer(AccessKey accessKey, Map<String,Object> loadOptions) throws Exception{
 	...
 	protected PotentialCustomer extractCityServiceCenter(PotentialCustomer potentialCustomer, Map<String,Object> options) throws Exception{
		...
		FranchisedOutletCityServiceCenter cityServiceCenter = getFranchisedOutletCityServiceCenterDAO().load(cityServiceCenterId,options);
	...
	protected PotentialCustomer analyzeEventAttendanceList(PotentialCustomer potentialCustomer, Map<String,Object> options){
 	...
 	public SmartList<PotentialCustomer> findPotentialCustomerByCityServiceCenter(String franchisedOutletCityServiceCenterId,Map<String,Object> options){
 	
  		SmartList<PotentialCustomer> resultList = queryWith(PotentialCustomerTable.COLUMN_CITY_SERVICE_CENTER, franchisedOutletCityServiceCenterId, options, getPotentialCustomerMapper());
		// analyzePotentialCustomerByCityServiceCenter(resultList, franchisedOutletCityServiceCenterId, options);
		return resultList;
 	}
 	 
 
 	public SmartList<PotentialCustomer> findPotentialCustomerByCityServiceCenter(String franchisedOutletCityServiceCenterId, int start, int count,Map<String,Object> options){
 		
 		SmartList<PotentialCustomer> resultList =  queryWithRange(PotentialCustomerTable.COLUMN_CITY_SERVICE_CENTER, franchisedOutletCityServiceCenterId, options, getPotentialCustomerMapper(), start, count);
 		//analyzePotentialCustomerByCityServiceCenter(resultList, franchisedOutletCityServiceCenterId, options);
 		return resultList;
 		
 	}
 	public void analyzePotentialCustomerByCityServiceCenter(SmartList<PotentialCustomer> resultList, String franchisedOutletCityServiceCenterId, Map<String,Object> options){
		if(resultList==null){
			return;//do nothing when the list is null.
		}
		
 		MultipleAccessKey filterKey = new MultipleAccessKey();
 		filterKey.put(PotentialCustomer.CITY_SERVICE_CENTER_PROPERTY, franchisedOutletCityServiceCenterId);
 	...
 	@Override
 	public int countPotentialCustomerByCityServiceCenter(String franchisedOutletCityServiceCenterId,Map<String,Object> options){

 		return countWith(PotentialCustomerTable.COLUMN_CITY_SERVICE_CENTER, franchisedOutletCityServiceCenterId, options);
 	}
 	@Override
	...
	//======================================================================================
 	...
 	protected PotentialCustomer saveCityServiceCenter(PotentialCustomer potentialCustomer, Map<String,Object> options){
 		...
 		getFranchisedOutletCityServiceCenterDAO().save(potentialCustomer.getCityServiceCenter(),options);
 		return potentialCustomer;
    ...
    public SmartList<PotentialCustomer> requestCandidatePotentialCustomerForPotentialCustomerContactPerson(XingyouUserContext userContext, String ownerClass, String id, String filterKey, int pageNo, int pageSize) throws Exception {
    ...
    public SmartList<PotentialCustomer> requestCandidatePotentialCustomerForPotentialCustomerContact(XingyouUserContext userContext, String ownerClass, String id, String filterKey, int pageNo, int pageSize) throws Exception {
        // NOTE: by default, ignore owner info, just return all by filter key.
		// You need override this method if you have different candidate-logic
		return findAllCandidateByFilter(PotentialCustomerTable.COLUMN_NAME, PotentialCustomerTable.COLUMN_CITY_SERVICE_CENTER, filterKey, pageNo, pageSize, getPotentialCustomerMapper());
    }
		
    public SmartList<PotentialCustomer> requestCandidatePotentialCustomerForEventAttendance(XingyouUserContext userContext, String ownerClass, String id, String filterKey, int pageNo, int pageSize) throws Exception {
        // NOTE: by default, ignore owner info, just return all by filter key.
		// You need override this method if you have different candidate-logic
		return findAllCandidateByFilter(PotentialCustomerTable.COLUMN_NAME, PotentialCustomerTable.COLUMN_CITY_SERVICE_CENTER, filterKey, pageNo, pageSize, getPotentialCustomerMapper());
    }
	...
	public SmartList<PotentialCustomerContactPerson> loadOurPotentialCustomerContactPersonList(XingyouUserContext userContext, List<PotentialCustomer> us, Map<String,Object> options) throws Exception{
	...
	public SmartList<PotentialCustomerContact> loadOurPotentialCustomerContactList(XingyouUserContext userContext, List<PotentialCustomer> us, Map<String,Object> options) throws Exception{
		if (us == null || us.isEmpty()){
			return new SmartList<>();
		}
		Set<String> ids = us.stream().map(it->it.getId()).collect(Collectors.toSet());
	...
	public SmartList<EventAttendance> loadOurEventAttendanceList(XingyouUserContext userContext, List<PotentialCustomer> us, Map<String,Object> options) throws Exception{
		if (us == null || us.isEmpty()){
			return new SmartList<>();
		}
		Set<String> ids = us.stream().map(it->it.getId()).collect(Collectors.toSet());
