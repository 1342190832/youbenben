...
public class XingyouExceptionJsonSerializer extends  JsonSerializer<XingyouException> {
	...
	@Override
	public void serialize(XingyouException exception, JsonGenerator jgen,
	...
	protected void writeExceptionMessage(String message, XingyouException exception,
	...
	protected void writeStartObject(XingyouException exception, JsonGenerator jgen,SerializerProvider provider)throws IOException,JsonProcessingException{
		jgen.writeStartObject();
		writeClassField(CLASS,exception,jgen,provider);
	}
	
	private static final String MESSAGE_LIST = "messageList";
	protected void writeEndObject(XingyouException exception, JsonGenerator jgen,SerializerProvider provider)throws IOException,JsonProcessingException{
		
		writeMessageList(MESSAGE_LIST,exception,jgen,provider);
		jgen.writeEndObject();
	}
	protected void writeClassField(String fieldName,XingyouException exception,
	...
	protected void writeMessageList(String fieldName,XingyouException exception,
			JsonGenerator jgen, SerializerProvider provider)
			throws IOException, JsonProcessingException {
		if(exception == null){
			return; //do nothing when base entity is null
