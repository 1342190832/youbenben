package com.xingyou.xingyou.utils;
...
public class BaseBizHelper {
	protected CustomXingyouUserContextImpl userContext;
	protected static final Map<String, Object> EO = new HashMap<>();
	protected Map<String, Object> cache;
	
	public CustomXingyouUserContextImpl getUserContext() {
		return userContext;
	}
	public void setUserContext(CustomXingyouUserContextImpl userContext) {
		this.userContext = userContext;
	}

	protected static <T extends BaseBizHelper> T _OF(CustomXingyouUserContextImpl ctx, Class<T> clazz) {
		return _OF(ctx, clazz, false);
	}
			
	protected static <T extends BaseBizHelper> T _OF(CustomXingyouUserContextImpl ctx,
