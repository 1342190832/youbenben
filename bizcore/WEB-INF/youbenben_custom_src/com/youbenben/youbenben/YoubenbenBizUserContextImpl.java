...
public class YoubenbenBizUserContextImpl extends YoubenbenUserContextImpl{
	...
	protected BaseYoubenbenFormProcessor inputFormData;
	protected BaseYoubenbenFormProcessor outputFormData;
	...
	public String getPostMd5Key(YoubenbenBizUserContextImpl ctx) {
	...
	public BaseYoubenbenFormProcessor getInputFormData() {
		return inputFormData;
	}
	public void setInputFormData(BaseYoubenbenFormProcessor inputFormData) {
		this.inputFormData = inputFormData;
	}
	public BaseYoubenbenFormProcessor getOutputFormData() {
		return outputFormData;
	}
	public void setOutputFormData(BaseYoubenbenFormProcessor outputFormData) {
