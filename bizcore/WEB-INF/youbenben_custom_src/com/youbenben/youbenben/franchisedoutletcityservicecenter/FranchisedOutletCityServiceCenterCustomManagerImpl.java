...
这个类已经被配置到了相应的Spring配置文件 WEB-INF/youbenben_custom_src/META-INF/youbenben_custom.xml 中，
...
public class FranchisedOutletCityServiceCenterCustomManagerImpl extends FranchisedOutletCityServiceCenterManagerImpl{
