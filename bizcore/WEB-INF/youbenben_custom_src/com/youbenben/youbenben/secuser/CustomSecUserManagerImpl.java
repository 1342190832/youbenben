...
import com.youbenben.youbenben.LoginForm;
import com.youbenben.youbenben.BaseEntity;
import com.youbenben.youbenben.CommonError;
import com.youbenben.youbenben.DAOGroup;
import com.youbenben.youbenben.ManagerGroup;

import com.youbenben.youbenben.UserContextImpl;
import com.youbenben.youbenben.userapp.UserApp;
import com.youbenben.youbenben.YoubenbenUserContext;
import com.youbenben.youbenben.userapp.*;
import com.youbenben.youbenben.listaccess.*;
import com.youbenben.youbenben.YoubenbenObjectChecker;
import com.youbenben.youbenben.loginhistory.LoginHistory;
import com.youbenben.youbenben.Message;
import com.youbenben.youbenben.CustomYoubenbenUserContextImpl;
...
public class CustomSecUserManagerImpl extends SecUserManagerImpl implements
   ...
   public void setBlockChainAdvancer(BlockChainAdvancer pBlockChainAdvancer){
    ...
    public String confirmSession(YoubenbenUserContext userContext){
    ...
    public Object resetPassword(YoubenbenUserContext userContext, String mobile, int verifycationCode, String newPassword) {
    ...
    public Object resetPasswordWithoutLogin(YoubenbenUserContext userContext, String loginType, String loginKey, int verifycationCode, String newPassword) {
        SecUser user;
        try {
    ...
    public Object selectApp(YoubenbenUserContext userContext,
    ...
    public SecUser manage(YoubenbenUserContext userContext) throws Exception{
        SecUser user = cachedUser(userContext);
    ...
    protected SecUser cachedUser(YoubenbenUserContext userContext)
    {
        return (SecUser)userContext.getCachedObject(this.getUserKey(userContext), SecUser.class);
    }

    public SecUser getCachedSecUser(YoubenbenUserContext userContext) {
    ...
    protected Object gotoApp(YoubenbenUserContext userContext, UserApp app) throws Exception {
    ...
    public String getVerificationCode(YoubenbenUserContext userContext,String mobile){
    ...
    protected void sendVerificationCode(YoubenbenUserContext userContext, String mobile,String code) throws Exception{
    ...
    protected int getRandomVerificationCode(YoubenbenUserContext userContex, int length){
    ...
    protected String getBeanName(YoubenbenUserContext userContext, UserApp app){
    ...
    protected String getTargetObjectId(YoubenbenUserContext userContext, UserApp app){

        return  app.getObjectId();

    }
    protected String getServiceType(YoubenbenUserContext userContext, UserApp app){

        return app.getObjectType();
    }
    protected String getMethodName(YoubenbenUserContext userContext, UserApp app){
    ...
    public Object home(YoubenbenUserContext userContext) {
    ...
    public Object loginWithEmail(YoubenbenUserContext userContext, String email,
            Password password) {

        return loginInternal(userContext,"email",email, password);

    }
    public Object login(YoubenbenUserContext userContext, String email,
            Password password) {
    ...
    public Object loginWithLogin(YoubenbenUserContext userContext, String email,
            Password password) {

        return loginInternal(userContext,"login",email, password);

    }
    public Object loginWithMobile(YoubenbenUserContext userContext, String email,
            Password password) {
        return loginInternal(userContext,"mobile",email, password);

    }
    protected SecUser loadUserWith(YoubenbenUserContext userContext, String type, String userId) throws Exception{
    ...
    protected Object loginInternal(YoubenbenUserContext userContext, String type, String userId,
            Password password) {
     ...
     */
    protected Object loginTheSecUserInternal(YoubenbenUserContext userContext, SecUser user, String loginComments) throws Exception {
		...
		iamService.onLoginSecUserInternalSuccess((YoubenbenUserContextImpl) userContext, user);
    ...
    public Object showlogin(YoubenbenUserContext userContext) {
    ...
    protected LoginForm showSessionExpired(YoubenbenUserContext userContext) {
    ...
    public BaseUserContext loadUserConext(HttpServletRequest request)
        ...
        YoubenbenUserContextImpl uc = createNewConext(path);
        init(uc, request);
        return uc;
    }
    ...
    protected YoubenbenObjectChecker checker;
    public YoubenbenObjectChecker getChecker(){
        return checker;
    }

    public void setChecker(YoubenbenObjectChecker checker){
    ...
    protected void init(UserContextImpl userContext, HttpServletRequest request) {
        ...
        userContext.setChecker((YoubenbenObjectChecker)beanFactory.getBean(getCheckerBeanName()));
    ...
    protected YoubenbenUserContextImpl createNewConext(String path) {

        return new CustomYoubenbenUserContextImpl();
    ...
    public Object checkOtherLogin(YoubenbenUserContext userContext) throws Exception {
	...
	protected void checkUserHasManagementAccess(YoubenbenUserContext userContext, String objectType, String objectId)
	...
	public UserApp updateAppPermission(YoubenbenUserContext userContext, String secUserId, String userAppId, int version,
	...
	public UserApp updateListAccess(YoubenbenUserContext userContext, String secUserId, String userAppId, String displayName,
	...
	public UserApp loadUserAppWithUser(YoubenbenUserContext userContext, String secUserId, String objectType,
    ...
    public Object changeCurUserPassword(YoubenbenUserContext userContext, String currentPassword, String newPassword)
			throws Exception {
	...
	public String testIfHasManagementAccess(YoubenbenUserContext userContext,String objectType,String objectId) {
		try {
			this.checkUserHasManagementAccess(userContext, objectType, objectId);
			return "OK";
		}catch(Exception e){
    ...
    public Map<String, Object> testoss(YoubenbenUserContext userContext) throws SecUserManagerException {
