...
public class OriginalVoucherCreationManagerImpl extends CustomRetailscmCheckerManager implements OriginalVoucherCreationManager, BusinessHandler{
...
//--------------------------------------------------------------
	...
	*/
	...
	// -----------------------------------// list-of-view 处理 \\-----------------------------------
    protected void enhanceForListOfView(RetailscmUserContext userContext,SmartList<OriginalVoucherCreation> list) throws Exception {
  ...
  // -----------------------------------\\ list-of-view 处理 //-----------------------------------v
	 ...
	 * @throws Exception
	 */
 	public Object wxappview(RetailscmUserContext userContext, String originalVoucherCreationId) throws Exception{
	  SerializeScope vscope = RetailscmViewScope.getInstance().getOriginalVoucherCreationDetailScope().clone();
