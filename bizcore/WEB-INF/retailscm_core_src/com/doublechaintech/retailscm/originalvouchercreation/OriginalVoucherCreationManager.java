...
public interface OriginalVoucherCreationManager extends BaseManager{
	...
	//public  OriginalVoucherManager getOriginalVoucherManager(RetailscmUserContext userContext, String originalVoucherCreationId, String title, String madeBy, String receivedBy, String voucherType, String voucherImage, String belongsToId, String confirmationId, String auditingId ,String [] tokensExpr)  throws Exception;
