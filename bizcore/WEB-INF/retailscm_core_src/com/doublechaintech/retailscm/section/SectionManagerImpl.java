...
public class SectionManagerImpl extends CustomRetailscmCheckerManager implements SectionManager, BusinessHandler{
	...
	public Section createSection(RetailscmUserContext userContext, String title,String brief,String icon,String viewGroup,String linkToUrl,String pageId) throws Exception
	//public Section createSection(RetailscmUserContext userContext,String title, String brief, String icon, String viewGroup, String linkToUrl, String pageId) throws Exception
	{
