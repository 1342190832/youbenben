...
public class OriginalVoucherManagerImpl extends CustomRetailscmCheckerManager implements OriginalVoucherManager, BusinessHandler{
 ...
 //--------------------------------------------------------------
    ...
    protected void enhanceForListOfView(RetailscmUserContext userContext,SmartList<OriginalVoucher> list) throws Exception {
		...
		List<OriginalVoucherCreation> creationList = RetailscmBaseUtils.collectReferencedObjectWithType(userContext, list, OriginalVoucherCreation.class);
		userContext.getDAOGroup().enhanceList(creationList, OriginalVoucherCreation.class);
		List<OriginalVoucherConfirmation> confirmationList = RetailscmBaseUtils.collectReferencedObjectWithType(userContext, list, OriginalVoucherConfirmation.class);
		userContext.getDAOGroup().enhanceList(confirmationList, OriginalVoucherConfirmation.class);
		List<OriginalVoucherAuditing> auditingList = RetailscmBaseUtils.collectReferencedObjectWithType(userContext, list, OriginalVoucherAuditing.class);
