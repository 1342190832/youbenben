...
public class RetailscmCandidatesUtil extends BaseCandidatesUtil{
	...
	protected BaseCandidateEntity<? extends BaseEntity> executeQuery(RetailscmUserContext userContext, CandidateQuery query, String sql,
		...
		case "supply_order_confirmation":
			currentDAO = (RetailscmBaseDAOImpl)userContext.getDAOGroup().getSupplyOrderConfirmationDAO();
		...
		case "supply_order_approval":
			currentDAO = (RetailscmBaseDAOImpl)userContext.getDAOGroup().getSupplyOrderApprovalDAO();
		...
		case "supply_order_processing":
			currentDAO = (RetailscmBaseDAOImpl)userContext.getDAOGroup().getSupplyOrderProcessingDAO();
		...
		case "supply_order_picking":
			currentDAO = (RetailscmBaseDAOImpl)userContext.getDAOGroup().getSupplyOrderPickingDAO();
		...
		case "supply_order_shipment":
			currentDAO = (RetailscmBaseDAOImpl)userContext.getDAOGroup().getSupplyOrderShipmentDAO();
		...
		case "supply_order_delivery":
			currentDAO = (RetailscmBaseDAOImpl)userContext.getDAOGroup().getSupplyOrderDeliveryDAO();
		...
		case "retail_store_order_confirmation":
			currentDAO = (RetailscmBaseDAOImpl)userContext.getDAOGroup().getRetailStoreOrderConfirmationDAO();
		...
		case "retail_store_order_approval":
			currentDAO = (RetailscmBaseDAOImpl)userContext.getDAOGroup().getRetailStoreOrderApprovalDAO();
		...
		case "retail_store_order_processing":
			currentDAO = (RetailscmBaseDAOImpl)userContext.getDAOGroup().getRetailStoreOrderProcessingDAO();
		...
		case "retail_store_order_picking":
			currentDAO = (RetailscmBaseDAOImpl)userContext.getDAOGroup().getRetailStoreOrderPickingDAO();
		...
		case "retail_store_order_shipment":
			currentDAO = (RetailscmBaseDAOImpl)userContext.getDAOGroup().getRetailStoreOrderShipmentDAO();
		...
		case "retail_store_order_delivery":
			currentDAO = (RetailscmBaseDAOImpl)userContext.getDAOGroup().getRetailStoreOrderDeliveryDAO();
		...
		case "goods_packaging":
			currentDAO = (RetailscmBaseDAOImpl)userContext.getDAOGroup().getGoodsPackagingDAO();
		...
		case "accounting_document_creation":
			currentDAO = (RetailscmBaseDAOImpl)userContext.getDAOGroup().getAccountingDocumentCreationDAO();
		...
		case "accounting_document_confirmation":
			currentDAO = (RetailscmBaseDAOImpl)userContext.getDAOGroup().getAccountingDocumentConfirmationDAO();
		...
		case "accounting_document_auditing":
			currentDAO = (RetailscmBaseDAOImpl)userContext.getDAOGroup().getAccountingDocumentAuditingDAO();
		...
		case "accounting_document_posting":
			currentDAO = (RetailscmBaseDAOImpl)userContext.getDAOGroup().getAccountingDocumentPostingDAO();
		...
		case "original_voucher_creation":
			currentDAO = (RetailscmBaseDAOImpl)userContext.getDAOGroup().getOriginalVoucherCreationDAO();
		...
		case "original_voucher_confirmation":
			currentDAO = (RetailscmBaseDAOImpl)userContext.getDAOGroup().getOriginalVoucherConfirmationDAO();
		...
		case "original_voucher_auditing":
			currentDAO = (RetailscmBaseDAOImpl)userContext.getDAOGroup().getOriginalVoucherAuditingDAO();
		...
		case "job_application":
			currentDAO = (RetailscmBaseDAOImpl)userContext.getDAOGroup().getJobApplicationDAO();
		...
		case "employee_boarding":
			currentDAO = (RetailscmBaseDAOImpl)userContext.getDAOGroup().getEmployeeBoardingDAO();
