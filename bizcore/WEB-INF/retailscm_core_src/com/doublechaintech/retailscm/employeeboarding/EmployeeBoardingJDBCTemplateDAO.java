...
public class EmployeeBoardingJDBCTemplateDAO extends RetailscmBaseDAOImpl implements EmployeeBoardingDAO{
	...
	*/
    ...
    public SmartList<EmployeeBoarding> requestCandidateEmployeeBoardingForEmployee(RetailscmUserContext userContext, String ownerClass, String id, String filterKey, int pageNo, int pageSize) throws Exception {
		...
		return findAllCandidateByFilter(EmployeeBoardingTable.COLUMN_WHO, null, filterKey, pageNo, pageSize, getEmployeeBoardingMapper());
    }
