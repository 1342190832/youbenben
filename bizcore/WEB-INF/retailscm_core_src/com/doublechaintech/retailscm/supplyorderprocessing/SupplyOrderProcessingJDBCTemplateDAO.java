...
public class SupplyOrderProcessingJDBCTemplateDAO extends RetailscmBaseDAOImpl implements SupplyOrderProcessingDAO{
	...
	*/
	...
	public SmartList<SupplyOrderProcessing> loadAll() {
	    return this.loadAll(getSupplyOrderProcessingMapper());
	}
    ...
    public SmartList<SupplyOrderProcessing> requestCandidateSupplyOrderProcessingForConsumerOrder(RetailscmUserContext userContext, String ownerClass, String id, String filterKey, int pageNo, int pageSize) throws Exception {
		...
		return findAllCandidateByFilter(SupplyOrderProcessingTable.COLUMN_WHO, null, filterKey, pageNo, pageSize, getSupplyOrderProcessingMapper());
    }
