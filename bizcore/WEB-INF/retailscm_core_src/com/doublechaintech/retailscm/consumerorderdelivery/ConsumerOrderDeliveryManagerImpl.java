...
public class ConsumerOrderDeliveryManagerImpl extends CustomRetailscmCheckerManager implements ConsumerOrderDeliveryManager, BusinessHandler{
	...
	@Override
	public ConsumerOrderDeliveryDAO daoOf(RetailscmUserContext userContext) {
...
//--------------------------------------------------------------
	...
	// -----------------------------------// list-of-view 处理 \\-----------------------------------
    protected void enhanceForListOfView(RetailscmUserContext userContext,SmartList<ConsumerOrderDelivery> list) throws Exception {
  ...
  // -----------------------------------\\ list-of-view 处理 //-----------------------------------v
	 ...
	 * @throws Exception
	 */
 	public Object wxappview(RetailscmUserContext userContext, String consumerOrderDeliveryId) throws Exception{
	  SerializeScope vscope = RetailscmViewScope.getInstance().getConsumerOrderDeliveryDetailScope().clone();
