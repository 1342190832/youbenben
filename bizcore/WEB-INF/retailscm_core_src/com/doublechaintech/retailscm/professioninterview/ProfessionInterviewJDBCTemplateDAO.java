...
public class ProfessionInterviewJDBCTemplateDAO extends RetailscmBaseDAOImpl implements ProfessionInterviewDAO{
	...
	*/
	...
	public SmartList<ProfessionInterview> loadAll() {
	    return this.loadAll(getProfessionInterviewMapper());
	}
    ...
    public SmartList<ProfessionInterview> requestCandidateProfessionInterviewForEmployee(RetailscmUserContext userContext, String ownerClass, String id, String filterKey, int pageNo, int pageSize) throws Exception {
		...
		return findAllCandidateByFilter(ProfessionInterviewTable.COLUMN_WHO, null, filterKey, pageNo, pageSize, getProfessionInterviewMapper());
    }
