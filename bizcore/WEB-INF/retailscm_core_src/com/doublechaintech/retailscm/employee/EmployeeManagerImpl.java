 ...
 //--------------------------------------------------------------
	...
	*/
    ...
    protected void enhanceForListOfView(RetailscmUserContext userContext,SmartList<Employee> list) throws Exception {
		...
		List<JobApplication> jobApplicationList = RetailscmBaseUtils.collectReferencedObjectWithType(userContext, list, JobApplication.class);
		userContext.getDAOGroup().enhanceList(jobApplicationList, JobApplication.class);
		List<ProfessionInterview> professionInterviewList = RetailscmBaseUtils.collectReferencedObjectWithType(userContext, list, ProfessionInterview.class);
		userContext.getDAOGroup().enhanceList(professionInterviewList, ProfessionInterview.class);
		List<HrInterview> hrInterviewList = RetailscmBaseUtils.collectReferencedObjectWithType(userContext, list, HrInterview.class);
		userContext.getDAOGroup().enhanceList(hrInterviewList, HrInterview.class);
		List<OfferApproval> offerApprovalList = RetailscmBaseUtils.collectReferencedObjectWithType(userContext, list, OfferApproval.class);
		userContext.getDAOGroup().enhanceList(offerApprovalList, OfferApproval.class);
		List<OfferAcceptance> offerAcceptanceList = RetailscmBaseUtils.collectReferencedObjectWithType(userContext, list, OfferAcceptance.class);
		userContext.getDAOGroup().enhanceList(offerAcceptanceList, OfferAcceptance.class);
		List<EmployeeBoarding> employeeBoardingList = RetailscmBaseUtils.collectReferencedObjectWithType(userContext, list, EmployeeBoarding.class);
		userContext.getDAOGroup().enhanceList(employeeBoardingList, EmployeeBoarding.class);
		List<Termination> terminationList = RetailscmBaseUtils.collectReferencedObjectWithType(userContext, list, Termination.class);
	...
	public Object listByJobApplication(RetailscmUserContext userContext,String jobApplicationId) throws Exception {
		return listPageByJobApplication(userContext, jobApplicationId, 0, 20);
	}
	@SuppressWarnings({ "unchecked", "rawtypes" })
	public Object listPageByJobApplication(RetailscmUserContext userContext,String jobApplicationId, int start, int count) throws Exception {
	...
	public Object listByProfessionInterview(RetailscmUserContext userContext,String professionInterviewId) throws Exception {
		return listPageByProfessionInterview(userContext, professionInterviewId, 0, 20);
	}
	@SuppressWarnings({ "unchecked", "rawtypes" })
	public Object listPageByProfessionInterview(RetailscmUserContext userContext,String professionInterviewId, int start, int count) throws Exception {
	...
	public Object listByHrInterview(RetailscmUserContext userContext,String hrInterviewId) throws Exception {
		return listPageByHrInterview(userContext, hrInterviewId, 0, 20);
	}
	@SuppressWarnings({ "unchecked", "rawtypes" })
	public Object listPageByHrInterview(RetailscmUserContext userContext,String hrInterviewId, int start, int count) throws Exception {
	...
	public Object listByOfferApproval(RetailscmUserContext userContext,String offerApprovalId) throws Exception {
		return listPageByOfferApproval(userContext, offerApprovalId, 0, 20);
	}
	@SuppressWarnings({ "unchecked", "rawtypes" })
	public Object listPageByOfferApproval(RetailscmUserContext userContext,String offerApprovalId, int start, int count) throws Exception {
	...
	public Object listByOfferAcceptance(RetailscmUserContext userContext,String offerAcceptanceId) throws Exception {
		return listPageByOfferAcceptance(userContext, offerAcceptanceId, 0, 20);
	}
	@SuppressWarnings({ "unchecked", "rawtypes" })
	public Object listPageByOfferAcceptance(RetailscmUserContext userContext,String offerAcceptanceId, int start, int count) throws Exception {
	...
	public Object listByEmployeeBoarding(RetailscmUserContext userContext,String employeeBoardingId) throws Exception {
		return listPageByEmployeeBoarding(userContext, employeeBoardingId, 0, 20);
	}
	@SuppressWarnings({ "unchecked", "rawtypes" })
	public Object listPageByEmployeeBoarding(RetailscmUserContext userContext,String employeeBoardingId, int start, int count) throws Exception {
	...
	public Object listByTermination(RetailscmUserContext userContext,String terminationId) throws Exception {
		return listPageByTermination(userContext, terminationId, 0, 20);
	}
	@SuppressWarnings({ "unchecked", "rawtypes" })
	public Object listPageByTermination(RetailscmUserContext userContext,String terminationId, int start, int count) throws Exception {
