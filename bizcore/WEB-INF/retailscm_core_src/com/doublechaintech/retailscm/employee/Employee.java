...
public class Employee extends BaseEntity implements  java.io.Serializable{
	...
	public Object[] toFlatArray(){
		return new Object[]{getId(), getCompany(), getTitle(), getDepartment(), getFamilyName(), getGivenName(), getEmail(), getCity(), getAddress(), getCellPhone(), getOccupation(), getResponsibleFor(), getCurrentSalaryGrade(), getSalaryAccount(), getJobApplication(), getProfessionInterview(), getHrInterview(), getOfferApproval(), getOfferAcceptance(), getEmployeeBoarding(), getTermination(), getLastUpdateTime(), getVersion()};
	}
