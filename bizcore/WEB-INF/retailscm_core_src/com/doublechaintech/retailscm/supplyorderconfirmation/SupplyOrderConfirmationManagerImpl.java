...
public class SupplyOrderConfirmationManagerImpl extends CustomRetailscmCheckerManager implements SupplyOrderConfirmationManager, BusinessHandler{
...
//--------------------------------------------------------------
	...
	*/
	...
	// -----------------------------------// list-of-view 处理 \\-----------------------------------
    protected void enhanceForListOfView(RetailscmUserContext userContext,SmartList<SupplyOrderConfirmation> list) throws Exception {
  ...
  // -----------------------------------\\ list-of-view 处理 //-----------------------------------v
	 ...
	 * @throws Exception
	 */
 	public Object wxappview(RetailscmUserContext userContext, String supplyOrderConfirmationId) throws Exception{
	  SerializeScope vscope = RetailscmViewScope.getInstance().getSupplyOrderConfirmationDetailScope().clone();
