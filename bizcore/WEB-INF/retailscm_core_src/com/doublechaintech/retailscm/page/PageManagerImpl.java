...
public class PageManagerImpl extends CustomRetailscmCheckerManager implements PageManager, BusinessHandler{
	...
	public Page createPage(RetailscmUserContext userContext, String pageTitle,String linkToUrl,String pageTypeId,String mobileAppId) throws Exception
	//public Page createPage(RetailscmUserContext userContext,String pageTitle, String linkToUrl, String pageTypeId, String mobileAppId) throws Exception
	{
 ...
 //--------------------------------------------------------------
	...
	protected void checkParamsForAddingSlide(RetailscmUserContext userContext, String pageId, int displayOrder, String name, String imageUrl, String videoUrl, String linkToUrl,String [] tokensExpr) throws Exception{
	...
	public  Page addSlide(RetailscmUserContext userContext, String pageId, int displayOrder, String name, String imageUrl, String videoUrl, String linkToUrl, String [] tokensExpr) throws Exception
	{
	...
	protected void checkParamsForUpdatingSlideProperties(RetailscmUserContext userContext, String pageId,String id,int displayOrder,String name,String imageUrl,String videoUrl,String linkToUrl,String [] tokensExpr) throws Exception {
	...
	public  Page updateSlideProperties(RetailscmUserContext userContext, String pageId, String id,int displayOrder,String name,String imageUrl,String videoUrl,String linkToUrl, String [] tokensExpr) throws Exception
	{
	...
	protected Slide createSlide(RetailscmUserContext userContext, int displayOrder, String name, String imageUrl, String videoUrl, String linkToUrl) throws Exception{
	...
	*/
	...
	protected void checkParamsForAddingUiAction(RetailscmUserContext userContext, String pageId, String code, String icon, String title, String brief, String imageUrl, String linkToUrl, String extraData,String [] tokensExpr) throws Exception{
	...
	public  Page addUiAction(RetailscmUserContext userContext, String pageId, String code, String icon, String title, String brief, String imageUrl, String linkToUrl, String extraData, String [] tokensExpr) throws Exception
	{
	...
	protected void checkParamsForUpdatingUiActionProperties(RetailscmUserContext userContext, String pageId,String id,String code,String icon,String title,String brief,String imageUrl,String linkToUrl,String extraData,String [] tokensExpr) throws Exception {
	...
	public  Page updateUiActionProperties(RetailscmUserContext userContext, String pageId, String id,String code,String icon,String title,String brief,String imageUrl,String linkToUrl,String extraData, String [] tokensExpr) throws Exception
	{
	...
	protected UiAction createUiAction(RetailscmUserContext userContext, String code, String icon, String title, String brief, String imageUrl, String linkToUrl, String extraData) throws Exception{
	...
	*/
	...
	protected void checkParamsForAddingSection(RetailscmUserContext userContext, String pageId, String title, String brief, String icon, String viewGroup, String linkToUrl,String [] tokensExpr) throws Exception{
	...
	public  Page addSection(RetailscmUserContext userContext, String pageId, String title, String brief, String icon, String viewGroup, String linkToUrl, String [] tokensExpr) throws Exception
	{
	...
	protected void checkParamsForUpdatingSectionProperties(RetailscmUserContext userContext, String pageId,String id,String title,String brief,String icon,String viewGroup,String linkToUrl,String [] tokensExpr) throws Exception {
	...
	public  Page updateSectionProperties(RetailscmUserContext userContext, String pageId, String id,String title,String brief,String icon,String viewGroup,String linkToUrl, String [] tokensExpr) throws Exception
	{
	...
	protected Section createSection(RetailscmUserContext userContext, String title, String brief, String icon, String viewGroup, String linkToUrl) throws Exception{
