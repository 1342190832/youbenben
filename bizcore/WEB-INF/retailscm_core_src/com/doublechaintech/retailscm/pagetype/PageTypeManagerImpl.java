...
public class PageTypeManagerImpl extends CustomRetailscmCheckerManager implements PageTypeManager, BusinessHandler{
 ...
 //--------------------------------------------------------------
	...
	protected void checkParamsForAddingPage(RetailscmUserContext userContext, String pageTypeId, String pageTitle, String linkToUrl, String mobileAppId,String [] tokensExpr) throws Exception{
	...
	public  PageType addPage(RetailscmUserContext userContext, String pageTypeId, String pageTitle, String linkToUrl, String mobileAppId, String [] tokensExpr) throws Exception
	{
	...
	protected void checkParamsForUpdatingPageProperties(RetailscmUserContext userContext, String pageTypeId,String id,String pageTitle,String linkToUrl,String [] tokensExpr) throws Exception {
	...
	public  PageType updatePageProperties(RetailscmUserContext userContext, String pageTypeId, String id,String pageTitle,String linkToUrl, String [] tokensExpr) throws Exception
	{
	...
	protected Page createPage(RetailscmUserContext userContext, String pageTitle, String linkToUrl, String mobileAppId) throws Exception{
