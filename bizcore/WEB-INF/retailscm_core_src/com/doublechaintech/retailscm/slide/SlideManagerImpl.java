...
public class SlideManagerImpl extends CustomRetailscmCheckerManager implements SlideManager, BusinessHandler{
	...
	public Slide createSlide(RetailscmUserContext userContext, int displayOrder,String name,String imageUrl,String videoUrl,String linkToUrl,String pageId) throws Exception
	//public Slide createSlide(RetailscmUserContext userContext,int displayOrder, String name, String imageUrl, String videoUrl, String linkToUrl, String pageId) throws Exception
	{
