...
public class ConsumerOrderApprovalManagerImpl extends CustomRetailscmCheckerManager implements ConsumerOrderApprovalManager, BusinessHandler{
...
//--------------------------------------------------------------
	...
	// -----------------------------------// list-of-view 处理 \\-----------------------------------
    protected void enhanceForListOfView(RetailscmUserContext userContext,SmartList<ConsumerOrderApproval> list) throws Exception {
  ...
  // -----------------------------------\\ list-of-view 处理 //-----------------------------------v
	 ...
	 * @throws Exception
	 */
 	public Object wxappview(RetailscmUserContext userContext, String consumerOrderApprovalId) throws Exception{
	  SerializeScope vscope = RetailscmViewScope.getInstance().getConsumerOrderApprovalDetailScope().clone();
