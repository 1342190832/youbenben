 ...
 //--------------------------------------------------------------
	...
	*/
    ...
    protected void enhanceForListOfView(RetailscmUserContext userContext,SmartList<Goods> list) throws Exception {
		...
		List<GoodsPackaging> packagingList = RetailscmBaseUtils.collectReferencedObjectWithType(userContext, list, GoodsPackaging.class);
	...
	public Object listByPackaging(RetailscmUserContext userContext,String packagingId) throws Exception {
		return listPageByPackaging(userContext, packagingId, 0, 20);
	}
	@SuppressWarnings({ "unchecked", "rawtypes" })
	public Object listPageByPackaging(RetailscmUserContext userContext,String packagingId, int start, int count) throws Exception {
