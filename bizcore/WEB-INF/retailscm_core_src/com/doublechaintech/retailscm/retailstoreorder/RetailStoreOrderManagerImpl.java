 ...
 //--------------------------------------------------------------
	...
	*/
    ...
    protected void enhanceForListOfView(RetailscmUserContext userContext,SmartList<RetailStoreOrder> list) throws Exception {
		...
		List<RetailStoreOrderConfirmation> confirmationList = RetailscmBaseUtils.collectReferencedObjectWithType(userContext, list, RetailStoreOrderConfirmation.class);
		userContext.getDAOGroup().enhanceList(confirmationList, RetailStoreOrderConfirmation.class);
		List<RetailStoreOrderApproval> approvalList = RetailscmBaseUtils.collectReferencedObjectWithType(userContext, list, RetailStoreOrderApproval.class);
		userContext.getDAOGroup().enhanceList(approvalList, RetailStoreOrderApproval.class);
		List<RetailStoreOrderProcessing> processingList = RetailscmBaseUtils.collectReferencedObjectWithType(userContext, list, RetailStoreOrderProcessing.class);
		userContext.getDAOGroup().enhanceList(processingList, RetailStoreOrderProcessing.class);
		List<RetailStoreOrderPicking> pickingList = RetailscmBaseUtils.collectReferencedObjectWithType(userContext, list, RetailStoreOrderPicking.class);
		userContext.getDAOGroup().enhanceList(pickingList, RetailStoreOrderPicking.class);
		List<RetailStoreOrderShipment> shipmentList = RetailscmBaseUtils.collectReferencedObjectWithType(userContext, list, RetailStoreOrderShipment.class);
		userContext.getDAOGroup().enhanceList(shipmentList, RetailStoreOrderShipment.class);
		List<RetailStoreOrderDelivery> deliveryList = RetailscmBaseUtils.collectReferencedObjectWithType(userContext, list, RetailStoreOrderDelivery.class);
