...
public class OriginalVoucherConfirmationManagerImpl extends CustomRetailscmCheckerManager implements OriginalVoucherConfirmationManager, BusinessHandler{
...
//--------------------------------------------------------------
	...
	*/
	...
	// -----------------------------------// list-of-view 处理 \\-----------------------------------
    protected void enhanceForListOfView(RetailscmUserContext userContext,SmartList<OriginalVoucherConfirmation> list) throws Exception {
  ...
  // -----------------------------------\\ list-of-view 处理 //-----------------------------------v
	 ...
	 * @throws Exception
	 */
 	public Object wxappview(RetailscmUserContext userContext, String originalVoucherConfirmationId) throws Exception{
	  SerializeScope vscope = RetailscmViewScope.getInstance().getOriginalVoucherConfirmationDetailScope().clone();
