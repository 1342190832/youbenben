...
public class OriginalVoucherConfirmationJDBCTemplateDAO extends RetailscmBaseDAOImpl implements OriginalVoucherConfirmationDAO{
	...
	*/
	...
	public SmartList<OriginalVoucherConfirmation> loadAll() {
	    return this.loadAll(getOriginalVoucherConfirmationMapper());
	}
    ...
    public SmartList<OriginalVoucherConfirmation> requestCandidateOriginalVoucherConfirmationForOriginalVoucher(RetailscmUserContext userContext, String ownerClass, String id, String filterKey, int pageNo, int pageSize) throws Exception {
		...
		return findAllCandidateByFilter(OriginalVoucherConfirmationTable.COLUMN_WHO, null, filterKey, pageNo, pageSize, getOriginalVoucherConfirmationMapper());
    }
