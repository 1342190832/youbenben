...
public class RetailStoreOrderShipmentJDBCTemplateDAO extends RetailscmBaseDAOImpl implements RetailStoreOrderShipmentDAO{
	...
	*/
	...
	public SmartList<RetailStoreOrderShipment> loadAll() {
	    return this.loadAll(getRetailStoreOrderShipmentMapper());
	}
    ...
    public SmartList<RetailStoreOrderShipment> requestCandidateRetailStoreOrderShipmentForRetailStoreOrder(RetailscmUserContext userContext, String ownerClass, String id, String filterKey, int pageNo, int pageSize) throws Exception {
		...
		return findAllCandidateByFilter(RetailStoreOrderShipmentTable.COLUMN_WHO, null, filterKey, pageNo, pageSize, getRetailStoreOrderShipmentMapper());
    }
