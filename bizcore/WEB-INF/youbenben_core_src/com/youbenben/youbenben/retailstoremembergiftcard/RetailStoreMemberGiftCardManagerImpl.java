...
public class RetailStoreMemberGiftCardManagerImpl extends CustomYoubenbenCheckerManager implements RetailStoreMemberGiftCardManager, BusinessHandler{
	...
	@Override
	public RetailStoreMemberGiftCardDAO daoOf(YoubenbenUserContext userContext) {
	...
	protected void throwExceptionWithMessage(String value) throws RetailStoreMemberGiftCardManagerException{
 	...
 	protected RetailStoreMemberGiftCard saveRetailStoreMemberGiftCard(YoubenbenUserContext userContext, RetailStoreMemberGiftCard retailStoreMemberGiftCard, String [] tokensExpr) throws Exception{	
 	...
 	protected RetailStoreMemberGiftCard saveRetailStoreMemberGiftCardDetail(YoubenbenUserContext userContext, RetailStoreMemberGiftCard retailStoreMemberGiftCard) throws Exception{	
 	...
 	public RetailStoreMemberGiftCard loadRetailStoreMemberGiftCard(YoubenbenUserContext userContext, String retailStoreMemberGiftCardId, String [] tokensExpr) throws Exception{				
 	 ...
 	 public RetailStoreMemberGiftCard searchRetailStoreMemberGiftCard(YoubenbenUserContext userContext, String retailStoreMemberGiftCardId, String textToSearch,String [] tokensExpr) throws Exception{				
 	...
 	protected RetailStoreMemberGiftCard present(YoubenbenUserContext userContext, RetailStoreMemberGiftCard retailStoreMemberGiftCard, Map<String, Object> tokens) throws Exception {
 	...
 	public RetailStoreMemberGiftCard loadRetailStoreMemberGiftCardDetail(YoubenbenUserContext userContext, String retailStoreMemberGiftCardId) throws Exception{	
 	...
 	public Object view(YoubenbenUserContext userContext, String retailStoreMemberGiftCardId) throws Exception{	
 	...
 	protected RetailStoreMemberGiftCard saveRetailStoreMemberGiftCard(YoubenbenUserContext userContext, RetailStoreMemberGiftCard retailStoreMemberGiftCard, Map<String,Object>tokens) throws Exception{	
 		return retailStoreMemberGiftCardDaoOf(userContext).save(retailStoreMemberGiftCard, tokens);
 	}
 	protected RetailStoreMemberGiftCard loadRetailStoreMemberGiftCard(YoubenbenUserContext userContext, String retailStoreMemberGiftCardId, Map<String,Object>tokens) throws Exception{	
		checkerOf(userContext).checkIdOfRetailStoreMemberGiftCard(retailStoreMemberGiftCardId);
		checkerOf(userContext).throwExceptionIfHasErrors( RetailStoreMemberGiftCardManagerException.class);
 	...
 	protected<T extends BaseEntity> void addActions(YoubenbenUserContext userContext, RetailStoreMemberGiftCard retailStoreMemberGiftCard, Map<String, Object> tokens){
	...
	}// end method of protected<T extends BaseEntity> void addActions(YoubenbenUserContext userContext, RetailStoreMemberGiftCard retailStoreMemberGiftCard, Map<String, Object> tokens){
	...
	protected void checkParamsForUpdatingRetailStoreMemberGiftCard(YoubenbenUserContext userContext,String retailStoreMemberGiftCardId, int retailStoreMemberGiftCardVersion, String property, String newValueExpr,String [] tokensExpr)throws Exception
	{
	...
	public RetailStoreMemberGiftCard clone(YoubenbenUserContext userContext, String fromRetailStoreMemberGiftCardId) throws Exception{
	...
	public RetailStoreMemberGiftCard internalSaveRetailStoreMemberGiftCard(YoubenbenUserContext userContext, RetailStoreMemberGiftCard retailStoreMemberGiftCard, Map<String,Object> options) throws Exception
	{
	...
	public RetailStoreMemberGiftCard updateRetailStoreMemberGiftCardProperty(YoubenbenUserContext userContext,String retailStoreMemberGiftCardId, int retailStoreMemberGiftCardVersion, String property, String newValueExpr,String [] tokensExpr) throws Exception
	{
		checkParamsForUpdatingRetailStoreMemberGiftCard(userContext, retailStoreMemberGiftCardId, retailStoreMemberGiftCardVersion, property, newValueExpr, tokensExpr);
	...
	protected void checkParamsForTransferingAnotherOwner(YoubenbenUserContext userContext, String retailStoreMemberGiftCardId, String anotherOwnerId) throws Exception
 	{
 ...
 //--------------------------------------------------------------
	...
	public void delete(YoubenbenUserContext userContext, String retailStoreMemberGiftCardId, int retailStoreMemberGiftCardVersion) throws Exception {
	...
	public RetailStoreMemberGiftCard forgetByAll(YoubenbenUserContext userContext, String retailStoreMemberGiftCardId, int retailStoreMemberGiftCardVersion) throws Exception {
		return forgetByAllInternal(userContext, retailStoreMemberGiftCardId, retailStoreMemberGiftCardVersion);
	}
	protected RetailStoreMemberGiftCard forgetByAllInternal(YoubenbenUserContext userContext,
			String retailStoreMemberGiftCardId, int retailStoreMemberGiftCardVersion) throws Exception{
	...
	protected RetailStoreMemberGiftCard breakWithRetailStoreMemberGiftCardConsumeRecordByBizOrder(YoubenbenUserContext userContext, String retailStoreMemberGiftCardId, String bizOrderId,  String [] tokensExpr)
		 throws Exception{
	...
	protected void checkParamsForAddingRetailStoreMemberGiftCardConsumeRecord(YoubenbenUserContext userContext, String retailStoreMemberGiftCardId, Date occureTime, String bizOrderId, String number, BigDecimal amount,String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForUpdatingRetailStoreMemberGiftCardConsumeRecordProperties(YoubenbenUserContext userContext, String retailStoreMemberGiftCardId,String id,Date occureTime,String number,BigDecimal amount,String [] tokensExpr) throws Exception {
	...
	public  RetailStoreMemberGiftCard updateRetailStoreMemberGiftCardConsumeRecordProperties(YoubenbenUserContext userContext, String retailStoreMemberGiftCardId, String id,Date occureTime,String number,BigDecimal amount, String [] tokensExpr) throws Exception
	{
	...
	protected RetailStoreMemberGiftCardConsumeRecord createRetailStoreMemberGiftCardConsumeRecord(YoubenbenUserContext userContext, Date occureTime, String bizOrderId, String number, BigDecimal amount) throws Exception{
	...
	protected void checkParamsForRemovingRetailStoreMemberGiftCardConsumeRecordList(YoubenbenUserContext userContext, String retailStoreMemberGiftCardId,
	...
	public  RetailStoreMemberGiftCard removeRetailStoreMemberGiftCardConsumeRecordList(YoubenbenUserContext userContext, String retailStoreMemberGiftCardId,
			String retailStoreMemberGiftCardConsumeRecordIds[],String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForRemovingRetailStoreMemberGiftCardConsumeRecord(YoubenbenUserContext userContext, String retailStoreMemberGiftCardId,
	...
	public  RetailStoreMemberGiftCard removeRetailStoreMemberGiftCardConsumeRecord(YoubenbenUserContext userContext, String retailStoreMemberGiftCardId,
		String retailStoreMemberGiftCardConsumeRecordId, int retailStoreMemberGiftCardConsumeRecordVersion,String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForCopyingRetailStoreMemberGiftCardConsumeRecord(YoubenbenUserContext userContext, String retailStoreMemberGiftCardId,
		String retailStoreMemberGiftCardConsumeRecordId, int retailStoreMemberGiftCardConsumeRecordVersion,String [] tokensExpr) throws Exception{
	...
	public  RetailStoreMemberGiftCard copyRetailStoreMemberGiftCardConsumeRecordFrom(YoubenbenUserContext userContext, String retailStoreMemberGiftCardId,
		String retailStoreMemberGiftCardConsumeRecordId, int retailStoreMemberGiftCardConsumeRecordVersion,String [] tokensExpr) throws Exception{
	...
	public  RetailStoreMemberGiftCard updateRetailStoreMemberGiftCardConsumeRecord(YoubenbenUserContext userContext, String retailStoreMemberGiftCardId, String retailStoreMemberGiftCardConsumeRecordId, int retailStoreMemberGiftCardConsumeRecordVersion, String property, String newValueExpr,String [] tokensExpr)
			throws Exception{
	...
	*/
	...
	// -----------------------------------// list-of-view 处理 \\-----------------------------------
    protected void enhanceForListOfView(YoubenbenUserContext userContext,SmartList<RetailStoreMemberGiftCard> list) throws Exception {
  ...
  // -----------------------------------\\ list-of-view 处理 //-----------------------------------v
	 ...
	 * @throws Exception
	 */
 	public Object wxappview(YoubenbenUserContext userContext, String retailStoreMemberGiftCardId) throws Exception{
	  SerializeScope vscope = YoubenbenViewScope.getInstance().getRetailStoreMemberGiftCardDetailScope().clone();
