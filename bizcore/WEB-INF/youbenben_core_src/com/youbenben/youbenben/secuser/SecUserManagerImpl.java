...
import com.youbenben.youbenben.userdomain.CandidateUserDomain;
...
public class SecUserManagerImpl extends CustomYoubenbenCheckerManager implements SecUserManager, BusinessHandler{
	...
	@Override
	public SecUserDAO daoOf(YoubenbenUserContext userContext) {
	...
	protected void throwExceptionWithMessage(String value) throws SecUserManagerException{
 	...
 	protected SecUser saveSecUser(YoubenbenUserContext userContext, SecUser secUser, String [] tokensExpr) throws Exception{	
 	...
 	protected SecUser saveSecUserDetail(YoubenbenUserContext userContext, SecUser secUser) throws Exception{	
 	...
 	public SecUser loadSecUser(YoubenbenUserContext userContext, String secUserId, String [] tokensExpr) throws Exception{				
 	 ...
 	 public SecUser searchSecUser(YoubenbenUserContext userContext, String secUserId, String textToSearch,String [] tokensExpr) throws Exception{				
 	...
 	protected SecUser present(YoubenbenUserContext userContext, SecUser secUser, Map<String, Object> tokens) throws Exception {
 	...
 	public SecUser loadSecUserDetail(YoubenbenUserContext userContext, String secUserId) throws Exception{	
 		SecUser secUser = loadSecUser( userContext, secUserId, allTokens());
 		return present(userContext,secUser, allTokens());
		
 	}
 	
 	public Object view(YoubenbenUserContext userContext, String secUserId) throws Exception{	
 		SecUser secUser = loadSecUser( userContext, secUserId, viewTokens());
 		return present(userContext,secUser, allTokens());
		
 	}
 	protected SecUser saveSecUser(YoubenbenUserContext userContext, SecUser secUser, Map<String,Object>tokens) throws Exception{	
 		return secUserDaoOf(userContext).save(secUser, tokens);
 	}
 	protected SecUser loadSecUser(YoubenbenUserContext userContext, String secUserId, Map<String,Object>tokens) throws Exception{	
		checkerOf(userContext).checkIdOfSecUser(secUserId);
		checkerOf(userContext).throwExceptionIfHasErrors( SecUserManagerException.class);
	...
	public SecUser loadSecUserWithMobile(YoubenbenUserContext userContext, String mobile, Map<String,Object>tokens) throws Exception{	
 	...
 	protected<T extends BaseEntity> void addActions(YoubenbenUserContext userContext, SecUser secUser, Map<String, Object> tokens){
	...
	}// end method of protected<T extends BaseEntity> void addActions(YoubenbenUserContext userContext, SecUser secUser, Map<String, Object> tokens){
	...
	protected void checkParamsForUpdatingSecUser(YoubenbenUserContext userContext,String secUserId, int secUserVersion, String property, String newValueExpr,String [] tokensExpr)throws Exception
	{
	...
	public SecUser clone(YoubenbenUserContext userContext, String fromSecUserId) throws Exception{
	...
	public SecUser internalSaveSecUser(YoubenbenUserContext userContext, SecUser secUser, Map<String,Object> options) throws Exception
	{
	...
	public SecUser updateSecUserProperty(YoubenbenUserContext userContext,String secUserId, int secUserVersion, String property, String newValueExpr,String [] tokensExpr) throws Exception
	{
		checkParamsForUpdatingSecUser(userContext, secUserId, secUserVersion, property, newValueExpr, tokensExpr);
	...
	protected void checkParamsForTransferingAnotherDomain(YoubenbenUserContext userContext, String secUserId, String anotherDomainId) throws Exception
 	{
	...
	public CandidateUserDomain requestCandidateDomain(YoubenbenUserContext userContext, String ownerClass, String id, String filterKey, int pageNo) throws Exception {
 ...
 //--------------------------------------------------------------
 	...
 	protected UserDomain loadUserDomain(YoubenbenUserContext userContext, String newDomainId, Map<String,Object> options) throws Exception
 	{
	...
	public void delete(YoubenbenUserContext userContext, String secUserId, int secUserVersion) throws Exception {
	...
	public SecUser forgetByAll(YoubenbenUserContext userContext, String secUserId, int secUserVersion) throws Exception {
		return forgetByAllInternal(userContext, secUserId, secUserVersion);
	}
	protected SecUser forgetByAllInternal(YoubenbenUserContext userContext,
			String secUserId, int secUserVersion) throws Exception{
	...
	protected SecUser breakWithUserAppByObjectId(YoubenbenUserContext userContext, String secUserId, String objectIdId,  String [] tokensExpr)
		 throws Exception{
	...
	protected SecUser breakWithWechatWorkappIdentifyByCorpId(YoubenbenUserContext userContext, String secUserId, String corpIdId,  String [] tokensExpr)
		 throws Exception{
	...
	protected SecUser breakWithWechatWorkappIdentifyByUserId(YoubenbenUserContext userContext, String secUserId, String userIdId,  String [] tokensExpr)
		 throws Exception{
	...
	protected SecUser breakWithWechatMiniappIdentifyByOpenId(YoubenbenUserContext userContext, String secUserId, String openIdId,  String [] tokensExpr)
		 throws Exception{
	...
	protected SecUser breakWithWechatMiniappIdentifyByAppId(YoubenbenUserContext userContext, String secUserId, String appIdId,  String [] tokensExpr)
		 throws Exception{
	...
	protected SecUser breakWithKeypairIdentifyByKeyType(YoubenbenUserContext userContext, String secUserId, String keyTypeId,  String [] tokensExpr)
		 throws Exception{
	...
	protected void checkParamsForAddingUserApp(YoubenbenUserContext userContext, String secUserId, String title, String appIcon, boolean fullAccess, String permission, String objectType, String objectId, String location,String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForUpdatingUserAppProperties(YoubenbenUserContext userContext, String secUserId,String id,String title,String appIcon,boolean fullAccess,String permission,String objectType,String objectId,String location,String [] tokensExpr) throws Exception {
	...
	public  SecUser updateUserAppProperties(YoubenbenUserContext userContext, String secUserId, String id,String title,String appIcon,boolean fullAccess,String permission,String objectType,String objectId,String location, String [] tokensExpr) throws Exception
	{
	...
	protected UserApp createUserApp(YoubenbenUserContext userContext, String title, String appIcon, boolean fullAccess, String permission, String objectType, String objectId, String location) throws Exception{
	...
	protected void checkParamsForRemovingUserAppList(YoubenbenUserContext userContext, String secUserId,
	...
	public  SecUser removeUserAppList(YoubenbenUserContext userContext, String secUserId,
			String userAppIds[],String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForRemovingUserApp(YoubenbenUserContext userContext, String secUserId,
	...
	public  SecUser removeUserApp(YoubenbenUserContext userContext, String secUserId,
		String userAppId, int userAppVersion,String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForCopyingUserApp(YoubenbenUserContext userContext, String secUserId,
		String userAppId, int userAppVersion,String [] tokensExpr) throws Exception{
	...
	public  SecUser copyUserAppFrom(YoubenbenUserContext userContext, String secUserId,
		String userAppId, int userAppVersion,String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForUpdatingUserApp(YoubenbenUserContext userContext, String secUserId, String userAppId, int userAppVersion, String property, String newValueExpr,String [] tokensExpr) throws Exception{
	...
	public  SecUser updateUserApp(YoubenbenUserContext userContext, String secUserId, String userAppId, int userAppVersion, String property, String newValueExpr,String [] tokensExpr)
			throws Exception{
	...
	*/
	...
	protected void checkParamsForAddingLoginHistory(YoubenbenUserContext userContext, String secUserId, String fromIp, String description,String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForUpdatingLoginHistoryProperties(YoubenbenUserContext userContext, String secUserId,String id,String fromIp,String description,String [] tokensExpr) throws Exception {
	...
	public  SecUser updateLoginHistoryProperties(YoubenbenUserContext userContext, String secUserId, String id,String fromIp,String description, String [] tokensExpr) throws Exception
	{
	...
	protected LoginHistory createLoginHistory(YoubenbenUserContext userContext, String fromIp, String description) throws Exception{
	...
	protected void checkParamsForRemovingLoginHistoryList(YoubenbenUserContext userContext, String secUserId,
	...
	public  SecUser removeLoginHistoryList(YoubenbenUserContext userContext, String secUserId,
			String loginHistoryIds[],String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForRemovingLoginHistory(YoubenbenUserContext userContext, String secUserId,
	...
	public  SecUser removeLoginHistory(YoubenbenUserContext userContext, String secUserId,
		String loginHistoryId, int loginHistoryVersion,String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForCopyingLoginHistory(YoubenbenUserContext userContext, String secUserId,
		String loginHistoryId, int loginHistoryVersion,String [] tokensExpr) throws Exception{
	...
	public  SecUser copyLoginHistoryFrom(YoubenbenUserContext userContext, String secUserId,
		String loginHistoryId, int loginHistoryVersion,String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForUpdatingLoginHistory(YoubenbenUserContext userContext, String secUserId, String loginHistoryId, int loginHistoryVersion, String property, String newValueExpr,String [] tokensExpr) throws Exception{
	...
	public  SecUser updateLoginHistory(YoubenbenUserContext userContext, String secUserId, String loginHistoryId, int loginHistoryVersion, String property, String newValueExpr,String [] tokensExpr)
			throws Exception{
	...
	*/
	...
	protected void checkParamsForAddingWechatWorkappIdentify(YoubenbenUserContext userContext, String secUserId, String corpId, String userId, DateTime lastLoginTime,String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForUpdatingWechatWorkappIdentifyProperties(YoubenbenUserContext userContext, String secUserId,String id,String corpId,String userId,DateTime lastLoginTime,String [] tokensExpr) throws Exception {
	...
	public  SecUser updateWechatWorkappIdentifyProperties(YoubenbenUserContext userContext, String secUserId, String id,String corpId,String userId,DateTime lastLoginTime, String [] tokensExpr) throws Exception
	{
	...
	protected WechatWorkappIdentify createWechatWorkappIdentify(YoubenbenUserContext userContext, String corpId, String userId, DateTime lastLoginTime) throws Exception{
	...
	protected void checkParamsForRemovingWechatWorkappIdentifyList(YoubenbenUserContext userContext, String secUserId,
	...
	public  SecUser removeWechatWorkappIdentifyList(YoubenbenUserContext userContext, String secUserId,
			String wechatWorkappIdentifyIds[],String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForRemovingWechatWorkappIdentify(YoubenbenUserContext userContext, String secUserId,
	...
	public  SecUser removeWechatWorkappIdentify(YoubenbenUserContext userContext, String secUserId,
		String wechatWorkappIdentifyId, int wechatWorkappIdentifyVersion,String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForCopyingWechatWorkappIdentify(YoubenbenUserContext userContext, String secUserId,
		String wechatWorkappIdentifyId, int wechatWorkappIdentifyVersion,String [] tokensExpr) throws Exception{
	...
	public  SecUser copyWechatWorkappIdentifyFrom(YoubenbenUserContext userContext, String secUserId,
		String wechatWorkappIdentifyId, int wechatWorkappIdentifyVersion,String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForUpdatingWechatWorkappIdentify(YoubenbenUserContext userContext, String secUserId, String wechatWorkappIdentifyId, int wechatWorkappIdentifyVersion, String property, String newValueExpr,String [] tokensExpr) throws Exception{
	...
	public  SecUser updateWechatWorkappIdentify(YoubenbenUserContext userContext, String secUserId, String wechatWorkappIdentifyId, int wechatWorkappIdentifyVersion, String property, String newValueExpr,String [] tokensExpr)
			throws Exception{
	...
	*/
	...
	protected void checkParamsForAddingWechatMiniappIdentify(YoubenbenUserContext userContext, String secUserId, String openId, String appId, DateTime lastLoginTime,String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForUpdatingWechatMiniappIdentifyProperties(YoubenbenUserContext userContext, String secUserId,String id,String openId,String appId,DateTime lastLoginTime,String [] tokensExpr) throws Exception {
	...
	public  SecUser updateWechatMiniappIdentifyProperties(YoubenbenUserContext userContext, String secUserId, String id,String openId,String appId,DateTime lastLoginTime, String [] tokensExpr) throws Exception
	{
	...
	protected WechatMiniappIdentify createWechatMiniappIdentify(YoubenbenUserContext userContext, String openId, String appId, DateTime lastLoginTime) throws Exception{
	...
	protected void checkParamsForRemovingWechatMiniappIdentifyList(YoubenbenUserContext userContext, String secUserId,
	...
	public  SecUser removeWechatMiniappIdentifyList(YoubenbenUserContext userContext, String secUserId,
			String wechatMiniappIdentifyIds[],String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForRemovingWechatMiniappIdentify(YoubenbenUserContext userContext, String secUserId,
	...
	public  SecUser removeWechatMiniappIdentify(YoubenbenUserContext userContext, String secUserId,
		String wechatMiniappIdentifyId, int wechatMiniappIdentifyVersion,String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForCopyingWechatMiniappIdentify(YoubenbenUserContext userContext, String secUserId,
		String wechatMiniappIdentifyId, int wechatMiniappIdentifyVersion,String [] tokensExpr) throws Exception{
	...
	public  SecUser copyWechatMiniappIdentifyFrom(YoubenbenUserContext userContext, String secUserId,
		String wechatMiniappIdentifyId, int wechatMiniappIdentifyVersion,String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForUpdatingWechatMiniappIdentify(YoubenbenUserContext userContext, String secUserId, String wechatMiniappIdentifyId, int wechatMiniappIdentifyVersion, String property, String newValueExpr,String [] tokensExpr) throws Exception{
	...
	public  SecUser updateWechatMiniappIdentify(YoubenbenUserContext userContext, String secUserId, String wechatMiniappIdentifyId, int wechatMiniappIdentifyVersion, String property, String newValueExpr,String [] tokensExpr)
			throws Exception{
	...
	*/
	...
	protected void checkParamsForAddingKeypairIdentify(YoubenbenUserContext userContext, String secUserId, String publicKey, String keyTypeId,String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForUpdatingKeypairIdentifyProperties(YoubenbenUserContext userContext, String secUserId,String id,String publicKey,String [] tokensExpr) throws Exception {
	...
	public  SecUser updateKeypairIdentifyProperties(YoubenbenUserContext userContext, String secUserId, String id,String publicKey, String [] tokensExpr) throws Exception
	{
	...
	protected KeypairIdentify createKeypairIdentify(YoubenbenUserContext userContext, String publicKey, String keyTypeId) throws Exception{
	...
	protected void checkParamsForRemovingKeypairIdentifyList(YoubenbenUserContext userContext, String secUserId,
	...
	public  SecUser removeKeypairIdentifyList(YoubenbenUserContext userContext, String secUserId,
			String keypairIdentifyIds[],String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForRemovingKeypairIdentify(YoubenbenUserContext userContext, String secUserId,
	...
	public  SecUser removeKeypairIdentify(YoubenbenUserContext userContext, String secUserId,
		String keypairIdentifyId, int keypairIdentifyVersion,String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForCopyingKeypairIdentify(YoubenbenUserContext userContext, String secUserId,
		String keypairIdentifyId, int keypairIdentifyVersion,String [] tokensExpr) throws Exception{
	...
	public  SecUser copyKeypairIdentifyFrom(YoubenbenUserContext userContext, String secUserId,
		String keypairIdentifyId, int keypairIdentifyVersion,String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForUpdatingKeypairIdentify(YoubenbenUserContext userContext, String secUserId, String keypairIdentifyId, int keypairIdentifyVersion, String property, String newValueExpr,String [] tokensExpr) throws Exception{
	...
	public  SecUser updateKeypairIdentify(YoubenbenUserContext userContext, String secUserId, String keypairIdentifyId, int keypairIdentifyVersion, String property, String newValueExpr,String [] tokensExpr)
			throws Exception{
	...
	*/
	...
	// -----------------------------------// list-of-view 处理 \\-----------------------------------
    protected void enhanceForListOfView(YoubenbenUserContext userContext,SmartList<SecUser> list) throws Exception {
    	if (list == null || list.isEmpty()){
    		return;
    	}
		List<UserDomain> domainList = YoubenbenBaseUtils.collectReferencedObjectWithType(userContext, list, UserDomain.class);
  ...
  // -----------------------------------\\ list-of-view 处理 //-----------------------------------v
	 ...
	 * @throws Exception
	 */
 	public Object wxappview(YoubenbenUserContext userContext, String secUserId) throws Exception{
	  SerializeScope vscope = YoubenbenViewScope.getInstance().getSecUserDetailScope().clone();
    ...
    String pageTitle = "安全用户"+"详情";
		...
		vscope.field("userAppListSection", YoubenbenListOfViewScope.getInstance()
		...
		vscope.field("loginHistoryListSection", YoubenbenListOfViewScope.getInstance()
		...
		vscope.field("wechatWorkappIdentifyListSection", YoubenbenListOfViewScope.getInstance()
		...
		vscope.field("wechatMiniappIdentifyListSection", YoubenbenListOfViewScope.getInstance()
		...
		vscope.field("keypairIdentifyListSection", YoubenbenListOfViewScope.getInstance()
