...
public abstract class BaseViewPage extends HashMap<String, Object> {
	...
	public void assemblerContent(YoubenbenUserContext userContext, String requestName) throws Exception {
		setPageTitle("尚未实现");
	}
	public Map<String, Object> doRender(YoubenbenUserContext userContext) {
	...
	protected CustomSerializer getCustomSerializerByObject(Object object) {
		...
		if (object instanceof BaseYoubenbenFormProcessor) {
	...
	protected class FormProcessorSerializer implements CustomSerializer {
		@Override
		public Object serialize(SerializeScope serializeScope, Object value, String path) {
			BaseYoubenbenFormProcessor form = (BaseYoubenbenFormProcessor) value;
			if (form == null) {
				return null;
			}
