...
import com.youbenben.youbenben.secuser.SecUserCustomManagerImpl;
import com.youbenben.youbenben.userapp.UserApp;
import com.youbenben.youbenben.userapp.UserAppTokens;
import com.terapico.utils.CollectionUtils;

public class YoubenbenUserContextImpl extends UserContextImpl implements YoubenbenUserContext{
	...
	static final String RESOURCE_PATH="com.youbenben.youbenben.YoubenbenResources";
	static final String CUSTOM_RESOURCE_PATH="com.youbenben.youbenben.YoubenbenCustomResources";
    ...
    /*
    public static SecUser getSecUser(YoubenbenUserContext userContext) {
	...
	public static UserApp getSingleUserAppByObjectName(YoubenbenUserContext userContext, String objectName)
			throws Exception {
		SecUserCustomManagerImpl secUserManager = (SecUserCustomManagerImpl) userContext.getManagerGroup()
				.getSecUserManager();
		SecUser secUser = secUserManager.getCachedSecUser(userContext);
	...
	*/
	public static SmartList<UserApp> getUserAppByName(YoubenbenUserContext userContext, SecUser secUser, String objectName) {
	...
	public static UserApp getUserAppByBindedEntity(YoubenbenUserContext userContext, BaseEntity userAppBindedObject) {
		MultipleAccessKey key = new MultipleAccessKey();
	...
	private YoubenbenObjectChecker checker;
