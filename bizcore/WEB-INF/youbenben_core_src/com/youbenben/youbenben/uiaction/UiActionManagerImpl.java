...
import com.youbenben.youbenben.page.CandidatePage;
...
public class UiActionManagerImpl extends CustomYoubenbenCheckerManager implements UiActionManager, BusinessHandler{
	...
	@Override
	public UiActionDAO daoOf(YoubenbenUserContext userContext) {
	...
	protected void throwExceptionWithMessage(String value) throws UiActionManagerException{
 	...
 	protected UiAction saveUiAction(YoubenbenUserContext userContext, UiAction uiAction, String [] tokensExpr) throws Exception{	
 	...
 	protected UiAction saveUiActionDetail(YoubenbenUserContext userContext, UiAction uiAction) throws Exception{	
 	...
 	public UiAction loadUiAction(YoubenbenUserContext userContext, String uiActionId, String [] tokensExpr) throws Exception{				
 	 ...
 	 public UiAction searchUiAction(YoubenbenUserContext userContext, String uiActionId, String textToSearch,String [] tokensExpr) throws Exception{				
 	...
 	protected UiAction present(YoubenbenUserContext userContext, UiAction uiAction, Map<String, Object> tokens) throws Exception {
 	...
 	public UiAction loadUiActionDetail(YoubenbenUserContext userContext, String uiActionId) throws Exception{	
 		UiAction uiAction = loadUiAction( userContext, uiActionId, allTokens());
 		return present(userContext,uiAction, allTokens());
		
 	}
 	
 	public Object view(YoubenbenUserContext userContext, String uiActionId) throws Exception{	
 		UiAction uiAction = loadUiAction( userContext, uiActionId, viewTokens());
 		return present(userContext,uiAction, allTokens());
		
 	}
 	protected UiAction saveUiAction(YoubenbenUserContext userContext, UiAction uiAction, Map<String,Object>tokens) throws Exception{	
 		return uiActionDaoOf(userContext).save(uiAction, tokens);
 	}
 	protected UiAction loadUiAction(YoubenbenUserContext userContext, String uiActionId, Map<String,Object>tokens) throws Exception{	
		checkerOf(userContext).checkIdOfUiAction(uiActionId);
		checkerOf(userContext).throwExceptionIfHasErrors( UiActionManagerException.class);
 	...
 	protected<T extends BaseEntity> void addActions(YoubenbenUserContext userContext, UiAction uiAction, Map<String, Object> tokens){
	...
	}// end method of protected<T extends BaseEntity> void addActions(YoubenbenUserContext userContext, UiAction uiAction, Map<String, Object> tokens){
	...
	protected void checkParamsForUpdatingUiAction(YoubenbenUserContext userContext,String uiActionId, int uiActionVersion, String property, String newValueExpr,String [] tokensExpr)throws Exception
	{
	...
	public UiAction clone(YoubenbenUserContext userContext, String fromUiActionId) throws Exception{
	...
	public UiAction internalSaveUiAction(YoubenbenUserContext userContext, UiAction uiAction, Map<String,Object> options) throws Exception
	{
	...
	public UiAction updateUiActionProperty(YoubenbenUserContext userContext,String uiActionId, int uiActionVersion, String property, String newValueExpr,String [] tokensExpr) throws Exception
	{
		checkParamsForUpdatingUiAction(userContext, uiActionId, uiActionVersion, property, newValueExpr, tokensExpr);
	...
	protected void checkParamsForTransferingAnotherPage(YoubenbenUserContext userContext, String uiActionId, String anotherPageId) throws Exception
 	{
	...
	public CandidatePage requestCandidatePage(YoubenbenUserContext userContext, String ownerClass, String id, String filterKey, int pageNo) throws Exception {
 ...
 //--------------------------------------------------------------
 	...
 	protected Page loadPage(YoubenbenUserContext userContext, String newPageId, Map<String,Object> options) throws Exception
 	{
	...
	public void delete(YoubenbenUserContext userContext, String uiActionId, int uiActionVersion) throws Exception {
	...
	public UiAction forgetByAll(YoubenbenUserContext userContext, String uiActionId, int uiActionVersion) throws Exception {
		return forgetByAllInternal(userContext, uiActionId, uiActionVersion);
	}
	protected UiAction forgetByAllInternal(YoubenbenUserContext userContext,
			String uiActionId, int uiActionVersion) throws Exception{
	...
	// -----------------------------------// list-of-view 处理 \\-----------------------------------
    protected void enhanceForListOfView(YoubenbenUserContext userContext,SmartList<UiAction> list) throws Exception {
    	if (list == null || list.isEmpty()){
    		return;
    	}
		List<Page> pageList = YoubenbenBaseUtils.collectReferencedObjectWithType(userContext, list, Page.class);
  ...
  // -----------------------------------\\ list-of-view 处理 //-----------------------------------v
	 ...
	 * @throws Exception
	 */
 	public Object wxappview(YoubenbenUserContext userContext, String uiActionId) throws Exception{
	  SerializeScope vscope = YoubenbenViewScope.getInstance().getUiActionDetailScope().clone();
