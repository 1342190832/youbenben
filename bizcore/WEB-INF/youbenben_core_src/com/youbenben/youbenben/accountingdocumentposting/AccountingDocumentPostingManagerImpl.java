...
public class AccountingDocumentPostingManagerImpl extends CustomYoubenbenCheckerManager implements AccountingDocumentPostingManager, BusinessHandler{
	...
	@Override
	public AccountingDocumentPostingDAO daoOf(YoubenbenUserContext userContext) {
	...
	protected void throwExceptionWithMessage(String value) throws AccountingDocumentPostingManagerException{
 	...
 	protected AccountingDocumentPosting saveAccountingDocumentPosting(YoubenbenUserContext userContext, AccountingDocumentPosting accountingDocumentPosting, String [] tokensExpr) throws Exception{	
 	...
 	protected AccountingDocumentPosting saveAccountingDocumentPostingDetail(YoubenbenUserContext userContext, AccountingDocumentPosting accountingDocumentPosting) throws Exception{	
 	...
 	public AccountingDocumentPosting loadAccountingDocumentPosting(YoubenbenUserContext userContext, String accountingDocumentPostingId, String [] tokensExpr) throws Exception{				
 	 ...
 	 public AccountingDocumentPosting searchAccountingDocumentPosting(YoubenbenUserContext userContext, String accountingDocumentPostingId, String textToSearch,String [] tokensExpr) throws Exception{				
 	...
 	protected AccountingDocumentPosting present(YoubenbenUserContext userContext, AccountingDocumentPosting accountingDocumentPosting, Map<String, Object> tokens) throws Exception {
 	...
 	public AccountingDocumentPosting loadAccountingDocumentPostingDetail(YoubenbenUserContext userContext, String accountingDocumentPostingId) throws Exception{	
 	...
 	public Object view(YoubenbenUserContext userContext, String accountingDocumentPostingId) throws Exception{	
 	...
 	protected AccountingDocumentPosting saveAccountingDocumentPosting(YoubenbenUserContext userContext, AccountingDocumentPosting accountingDocumentPosting, Map<String,Object>tokens) throws Exception{	
 		return accountingDocumentPostingDaoOf(userContext).save(accountingDocumentPosting, tokens);
 	}
 	protected AccountingDocumentPosting loadAccountingDocumentPosting(YoubenbenUserContext userContext, String accountingDocumentPostingId, Map<String,Object>tokens) throws Exception{	
		checkerOf(userContext).checkIdOfAccountingDocumentPosting(accountingDocumentPostingId);
		checkerOf(userContext).throwExceptionIfHasErrors( AccountingDocumentPostingManagerException.class);
 	...
 	protected<T extends BaseEntity> void addActions(YoubenbenUserContext userContext, AccountingDocumentPosting accountingDocumentPosting, Map<String, Object> tokens){
	...
	}// end method of protected<T extends BaseEntity> void addActions(YoubenbenUserContext userContext, AccountingDocumentPosting accountingDocumentPosting, Map<String, Object> tokens){
	...
	protected void checkParamsForUpdatingAccountingDocumentPosting(YoubenbenUserContext userContext,String accountingDocumentPostingId, int accountingDocumentPostingVersion, String property, String newValueExpr,String [] tokensExpr)throws Exception
	{
	...
	public AccountingDocumentPosting clone(YoubenbenUserContext userContext, String fromAccountingDocumentPostingId) throws Exception{
	...
	public AccountingDocumentPosting internalSaveAccountingDocumentPosting(YoubenbenUserContext userContext, AccountingDocumentPosting accountingDocumentPosting, Map<String,Object> options) throws Exception
	{
	...
	public AccountingDocumentPosting updateAccountingDocumentPostingProperty(YoubenbenUserContext userContext,String accountingDocumentPostingId, int accountingDocumentPostingVersion, String property, String newValueExpr,String [] tokensExpr) throws Exception
	{
		checkParamsForUpdatingAccountingDocumentPosting(userContext, accountingDocumentPostingId, accountingDocumentPostingVersion, property, newValueExpr, tokensExpr);
...
//--------------------------------------------------------------
	...
	public void delete(YoubenbenUserContext userContext, String accountingDocumentPostingId, int accountingDocumentPostingVersion) throws Exception {
	...
	public AccountingDocumentPosting forgetByAll(YoubenbenUserContext userContext, String accountingDocumentPostingId, int accountingDocumentPostingVersion) throws Exception {
		return forgetByAllInternal(userContext, accountingDocumentPostingId, accountingDocumentPostingVersion);
	}
	protected AccountingDocumentPosting forgetByAllInternal(YoubenbenUserContext userContext,
			String accountingDocumentPostingId, int accountingDocumentPostingVersion) throws Exception{
	...
	protected AccountingDocumentPosting breakWithAccountingDocumentByAccountingPeriod(YoubenbenUserContext userContext, String accountingDocumentPostingId, String accountingPeriodId,  String [] tokensExpr)
		 throws Exception{
	...
	protected AccountingDocumentPosting breakWithAccountingDocumentByDocumentType(YoubenbenUserContext userContext, String accountingDocumentPostingId, String documentTypeId,  String [] tokensExpr)
		 throws Exception{
	...
	protected AccountingDocumentPosting breakWithAccountingDocumentByCreation(YoubenbenUserContext userContext, String accountingDocumentPostingId, String creationId,  String [] tokensExpr)
		 throws Exception{
	...
	protected AccountingDocumentPosting breakWithAccountingDocumentByConfirmation(YoubenbenUserContext userContext, String accountingDocumentPostingId, String confirmationId,  String [] tokensExpr)
		 throws Exception{
	...
	protected AccountingDocumentPosting breakWithAccountingDocumentByAuditing(YoubenbenUserContext userContext, String accountingDocumentPostingId, String auditingId,  String [] tokensExpr)
		 throws Exception{
	...
	protected void checkParamsForAddingAccountingDocument(YoubenbenUserContext userContext, String accountingDocumentPostingId, String name, Date accountingDocumentDate, String accountingPeriodId, String documentTypeId, String creationId, String confirmationId, String auditingId,String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForUpdatingAccountingDocumentProperties(YoubenbenUserContext userContext, String accountingDocumentPostingId,String id,String name,Date accountingDocumentDate,String [] tokensExpr) throws Exception {
	...
	public  AccountingDocumentPosting updateAccountingDocumentProperties(YoubenbenUserContext userContext, String accountingDocumentPostingId, String id,String name,Date accountingDocumentDate, String [] tokensExpr) throws Exception
	{
	...
	protected AccountingDocument createAccountingDocument(YoubenbenUserContext userContext, String name, Date accountingDocumentDate, String accountingPeriodId, String documentTypeId, String creationId, String confirmationId, String auditingId) throws Exception{
	...
	protected void checkParamsForRemovingAccountingDocumentList(YoubenbenUserContext userContext, String accountingDocumentPostingId,
	...
	public  AccountingDocumentPosting removeAccountingDocumentList(YoubenbenUserContext userContext, String accountingDocumentPostingId,
			String accountingDocumentIds[],String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForRemovingAccountingDocument(YoubenbenUserContext userContext, String accountingDocumentPostingId,
	...
	public  AccountingDocumentPosting removeAccountingDocument(YoubenbenUserContext userContext, String accountingDocumentPostingId,
		String accountingDocumentId, int accountingDocumentVersion,String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForCopyingAccountingDocument(YoubenbenUserContext userContext, String accountingDocumentPostingId,
		String accountingDocumentId, int accountingDocumentVersion,String [] tokensExpr) throws Exception{
	...
	public  AccountingDocumentPosting copyAccountingDocumentFrom(YoubenbenUserContext userContext, String accountingDocumentPostingId,
		String accountingDocumentId, int accountingDocumentVersion,String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForUpdatingAccountingDocument(YoubenbenUserContext userContext, String accountingDocumentPostingId, String accountingDocumentId, int accountingDocumentVersion, String property, String newValueExpr,String [] tokensExpr) throws Exception{
	...
	public  AccountingDocumentPosting updateAccountingDocument(YoubenbenUserContext userContext, String accountingDocumentPostingId, String accountingDocumentId, int accountingDocumentVersion, String property, String newValueExpr,String [] tokensExpr)
			throws Exception{
	...
	*/
	...
	// -----------------------------------// list-of-view 处理 \\-----------------------------------
    protected void enhanceForListOfView(YoubenbenUserContext userContext,SmartList<AccountingDocumentPosting> list) throws Exception {
  ...
  // -----------------------------------\\ list-of-view 处理 //-----------------------------------v
	 ...
	 * @throws Exception
	 */
 	public Object wxappview(YoubenbenUserContext userContext, String accountingDocumentPostingId) throws Exception{
	  SerializeScope vscope = YoubenbenViewScope.getInstance().getAccountingDocumentPostingDetailScope().clone();
