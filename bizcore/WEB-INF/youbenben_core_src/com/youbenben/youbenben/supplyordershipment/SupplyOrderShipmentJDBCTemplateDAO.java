...
public class SupplyOrderShipmentJDBCTemplateDAO extends YoubenbenBaseDAOImpl implements SupplyOrderShipmentDAO{
	...
	*/
	...
	public SmartList<SupplyOrderShipment> loadAll() {
	    return this.loadAll(getSupplyOrderShipmentMapper());
	}
    ...
    public SmartList<SupplyOrderShipment> requestCandidateSupplyOrderShipmentForConsumerOrder(YoubenbenUserContext userContext, String ownerClass, String id, String filterKey, int pageNo, int pageSize) throws Exception {
		...
		return findAllCandidateByFilter(SupplyOrderShipmentTable.COLUMN_WHO, null, filterKey, pageNo, pageSize, getSupplyOrderShipmentMapper());
    }
