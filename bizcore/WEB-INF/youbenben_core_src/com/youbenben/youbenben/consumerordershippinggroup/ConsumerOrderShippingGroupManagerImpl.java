...
public class ConsumerOrderShippingGroupManagerImpl extends CustomYoubenbenCheckerManager implements ConsumerOrderShippingGroupManager, BusinessHandler{
	...
	@Override
	public ConsumerOrderShippingGroupDAO daoOf(YoubenbenUserContext userContext) {
	...
	protected void throwExceptionWithMessage(String value) throws ConsumerOrderShippingGroupManagerException{
 	...
 	protected ConsumerOrderShippingGroup saveConsumerOrderShippingGroup(YoubenbenUserContext userContext, ConsumerOrderShippingGroup consumerOrderShippingGroup, String [] tokensExpr) throws Exception{	
 	...
 	protected ConsumerOrderShippingGroup saveConsumerOrderShippingGroupDetail(YoubenbenUserContext userContext, ConsumerOrderShippingGroup consumerOrderShippingGroup) throws Exception{	
 	...
 	public ConsumerOrderShippingGroup loadConsumerOrderShippingGroup(YoubenbenUserContext userContext, String consumerOrderShippingGroupId, String [] tokensExpr) throws Exception{				
 	 ...
 	 public ConsumerOrderShippingGroup searchConsumerOrderShippingGroup(YoubenbenUserContext userContext, String consumerOrderShippingGroupId, String textToSearch,String [] tokensExpr) throws Exception{				
 	...
 	protected ConsumerOrderShippingGroup present(YoubenbenUserContext userContext, ConsumerOrderShippingGroup consumerOrderShippingGroup, Map<String, Object> tokens) throws Exception {
 	...
 	public ConsumerOrderShippingGroup loadConsumerOrderShippingGroupDetail(YoubenbenUserContext userContext, String consumerOrderShippingGroupId) throws Exception{	
 	...
 	public Object view(YoubenbenUserContext userContext, String consumerOrderShippingGroupId) throws Exception{	
 	...
 	protected ConsumerOrderShippingGroup saveConsumerOrderShippingGroup(YoubenbenUserContext userContext, ConsumerOrderShippingGroup consumerOrderShippingGroup, Map<String,Object>tokens) throws Exception{	
 		return consumerOrderShippingGroupDaoOf(userContext).save(consumerOrderShippingGroup, tokens);
 	}
 	protected ConsumerOrderShippingGroup loadConsumerOrderShippingGroup(YoubenbenUserContext userContext, String consumerOrderShippingGroupId, Map<String,Object>tokens) throws Exception{	
		checkerOf(userContext).checkIdOfConsumerOrderShippingGroup(consumerOrderShippingGroupId);
		checkerOf(userContext).throwExceptionIfHasErrors( ConsumerOrderShippingGroupManagerException.class);
 	...
 	protected<T extends BaseEntity> void addActions(YoubenbenUserContext userContext, ConsumerOrderShippingGroup consumerOrderShippingGroup, Map<String, Object> tokens){
	...
	}// end method of protected<T extends BaseEntity> void addActions(YoubenbenUserContext userContext, ConsumerOrderShippingGroup consumerOrderShippingGroup, Map<String, Object> tokens){
	...
	protected void checkParamsForUpdatingConsumerOrderShippingGroup(YoubenbenUserContext userContext,String consumerOrderShippingGroupId, int consumerOrderShippingGroupVersion, String property, String newValueExpr,String [] tokensExpr)throws Exception
	{
	...
	public ConsumerOrderShippingGroup clone(YoubenbenUserContext userContext, String fromConsumerOrderShippingGroupId) throws Exception{
	...
	public ConsumerOrderShippingGroup internalSaveConsumerOrderShippingGroup(YoubenbenUserContext userContext, ConsumerOrderShippingGroup consumerOrderShippingGroup, Map<String,Object> options) throws Exception
	{
	...
	public ConsumerOrderShippingGroup updateConsumerOrderShippingGroupProperty(YoubenbenUserContext userContext,String consumerOrderShippingGroupId, int consumerOrderShippingGroupVersion, String property, String newValueExpr,String [] tokensExpr) throws Exception
	{
		checkParamsForUpdatingConsumerOrderShippingGroup(userContext, consumerOrderShippingGroupId, consumerOrderShippingGroupVersion, property, newValueExpr, tokensExpr);
	...
	protected void checkParamsForTransferingAnotherBizOrder(YoubenbenUserContext userContext, String consumerOrderShippingGroupId, String anotherBizOrderId) throws Exception
 	{
 ...
 //--------------------------------------------------------------
	...
	public void delete(YoubenbenUserContext userContext, String consumerOrderShippingGroupId, int consumerOrderShippingGroupVersion) throws Exception {
	...
	public ConsumerOrderShippingGroup forgetByAll(YoubenbenUserContext userContext, String consumerOrderShippingGroupId, int consumerOrderShippingGroupVersion) throws Exception {
		return forgetByAllInternal(userContext, consumerOrderShippingGroupId, consumerOrderShippingGroupVersion);
	}
	protected ConsumerOrderShippingGroup forgetByAllInternal(YoubenbenUserContext userContext,
			String consumerOrderShippingGroupId, int consumerOrderShippingGroupVersion) throws Exception{
	...
	// -----------------------------------// list-of-view 处理 \\-----------------------------------
    protected void enhanceForListOfView(YoubenbenUserContext userContext,SmartList<ConsumerOrderShippingGroup> list) throws Exception {
  ...
  // -----------------------------------\\ list-of-view 处理 //-----------------------------------v
	 ...
	 * @throws Exception
	 */
 	public Object wxappview(YoubenbenUserContext userContext, String consumerOrderShippingGroupId) throws Exception{
	  SerializeScope vscope = YoubenbenViewScope.getInstance().getConsumerOrderShippingGroupDetailScope().clone();
