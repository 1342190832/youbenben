...
public class AccountingDocument extends BaseEntity implements  java.io.Serializable{
	...
	public Object[] toFlatArray(){
		return new Object[]{getId(), getName(), getAccountingDocumentDate(), getAccountingPeriod(), getDocumentType(), getCreation(), getConfirmation(), getAuditing(), getPosting(), getVersion()};
	}
