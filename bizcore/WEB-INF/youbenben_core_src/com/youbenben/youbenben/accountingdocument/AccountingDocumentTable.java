...
public class AccountingDocumentTable{
	...
	public static final String []ALL_CLOUMNS = {COLUMN_ID,COLUMN_NAME,COLUMN_ACCOUNTING_DOCUMENT_DATE,COLUMN_ACCOUNTING_PERIOD,COLUMN_DOCUMENT_TYPE,COLUMN_CREATION,COLUMN_CONFIRMATION,COLUMN_AUDITING,COLUMN_POSTING,COLUMN_VERSION};
	public static final String []NORMAL_CLOUMNS = {COLUMN_NAME,COLUMN_ACCOUNTING_DOCUMENT_DATE,COLUMN_ACCOUNTING_PERIOD,COLUMN_DOCUMENT_TYPE,COLUMN_CREATION,COLUMN_CONFIRMATION,COLUMN_AUDITING,COLUMN_POSTING};
