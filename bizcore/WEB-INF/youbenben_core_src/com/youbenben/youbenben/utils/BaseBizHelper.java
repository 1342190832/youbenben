package com.youbenben.youbenben.utils;
...
public class BaseBizHelper {
	protected CustomYoubenbenUserContextImpl userContext;
	protected static final Map<String, Object> EO = new HashMap<>();
	protected Map<String, Object> cache;
	
	public CustomYoubenbenUserContextImpl getUserContext() {
		return userContext;
	}
	public void setUserContext(CustomYoubenbenUserContextImpl userContext) {
		this.userContext = userContext;
	}

	protected static <T extends BaseBizHelper> T _OF(CustomYoubenbenUserContextImpl ctx, Class<T> clazz) {
		return _OF(ctx, clazz, false);
	}
			
	protected static <T extends BaseBizHelper> T _OF(CustomYoubenbenUserContextImpl ctx,
