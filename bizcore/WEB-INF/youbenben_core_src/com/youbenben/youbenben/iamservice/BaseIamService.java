...
// import com.youbenben.youbenben.YoubenbenBizUserContextImpl;
import com.youbenben.youbenben.YoubenbenUserContextImpl;
import com.youbenben.youbenben.UserContext;
...
public abstract class BaseIamService {
	...
	public LoginResult doLogin(YoubenbenUserContextImpl userContext, LoginContext loginContext, BusinessHandler bizHandler) throws Exception {
	 ...
	 * @throws Exception 
	 */
	protected void onAuthenticateNewUserLogged(YoubenbenUserContextImpl userContext, LoginContext loginContext,
	 ...
	 * 
	 */
	protected void onAuthenticateUserLogged(YoubenbenUserContextImpl userContext, LoginContext loginContext,
			LoginResult loginResult, IdentificationHandler idHandler, BusinessHandler bizHandler) throws Exception {
		// 回调业务
	...
	// 为兼容旧版本secUser登录接口
	public void onLoginSecUserInternalSuccess(YoubenbenUserContextImpl userContext, SecUser user) {
		String tokenKey = userContext.tokenId();
		// 生成 jwtToken
	 ...
	 */
	protected boolean isLoginClientSupportSession(YoubenbenUserContextImpl userContext, LoginContext loginContext,
	 ...
	 */
	protected void onAuthenticationFailed(YoubenbenUserContextImpl userContext, LoginContext loginContext, LoginResult loginResult,
	 ...
	 * @return
	 */
	protected IdentificationHandler selectIdentificationHandler(YoubenbenUserContextImpl userContext, LoginContext loginContext) {
		if (idHandlers == null) {
	...
	protected String getLoginInfoCacheKey(YoubenbenUserContextImpl userContext) {
		return this.getCacheKey(userContext, "loginInfo");
	}
	protected String getJwtTokenCacheKey(YoubenbenUserContextImpl userContext) {
		return this.getCacheKey(userContext, "jwtToken");
	}
	
	// 获取token key的优先级为: jwtToken->cookie->session id
	public String getTokenKey(YoubenbenUserContextImpl userContext) {
	...
	protected void cacheJwtToken(YoubenbenUserContextImpl userContext, DecodedJWT jwtToken) {
		userContext.putIntoContextLocalStorage(getJwtTokenCacheKey(userContext), jwtToken);
	}
	protected DecodedJWT getCachedJwtToken(YoubenbenUserContextImpl userContext) {
		return (DecodedJWT) userContext.getFromContextLocalStorage(getJwtTokenCacheKey(userContext));
	}
	
	protected DecodedJWT getJwtTokenFromCookie(YoubenbenUserContextImpl userContext) {
	...
	protected DecodedJWT getJwtTokenFromHeader(YoubenbenUserContextImpl userContext) {
	...
	public Map<String, Object> getCachedLoginInfo(YoubenbenUserContextImpl userContext) {
	...
	protected String getCacheKey(UserContext userContext, String prefix){
		return "youbenben:"+prefix+":"+userContext.tokenId();
	}
	protected String getUserKey(UserContext userContext){
		return "youbenben:user:"+userContext.tokenId();
	}
	protected String getCurrentAppKey(UserContext userContext){
		return getUserKey(userContext)+":currentApp";
	}
	protected void fixUserContextTokenId(YoubenbenUserContextImpl userContext, String tokenKey) {
		if (!userContext.tokenId().equals(tokenKey)) {
			userContext.setTokenId(tokenKey);
		}
	}
	public SecUser tryToLoadSecUser(YoubenbenUserContextImpl userContext, Map<String, Object> loginInfo){
		if(loginInfo == null) {
			return null;
		}
	...
	public UserApp tryToLoadUserApp(YoubenbenUserContextImpl userContext, Map<String, Object> loginInfo){
		if(loginInfo == null) {
			return null;
		}
	 ...
	 * @param loginInfo2 */
	public void onCheckAccessWhenAnonymousFound(YoubenbenUserContextImpl userContext, Map<String, Object> loginInfo) {
...
//	
//	
//	protected boolean onSecUserNotFoundWhenCheckAccess(YoubenbenUserContextImpl userContext, Map<String, Object> loginInfo,
//			SecUser secUser, UserApp userApp) {
//		return false;
//	}
//	protected boolean onSecUserFoundWhenCheckAccess(YoubenbenUserContextImpl userContext, Map<String, Object> loginInfo,
//			SecUser secUser, UserApp userApp) {
//		return true;
//	}
//	protected boolean onSecUserAppFoundWhenCheckAccess(YoubenbenUserContextImpl userContext, Map<String, Object> loginInfo,
//			SecUser secUser, UserApp userApp) {
//		return true;
//	}
//	protected SecUser tryToLoadSecUser(YoubenbenUserContextImpl userContext, Map<String, Object> loginInfo){
//		if(loginInfo == null) {
//			return null;
//		}
//		String secUserId = (String) loginInfo.get("secUser");
...
//		}
//	}
//	protected UserApp tryToLoadUserApp(YoubenbenUserContextImpl userContext, Map<String, Object> loginInfo){
//		if(loginInfo == null) {
//			return null;
//		}
//		
...
//	
//	
//	public Object exampleLoginByAccountPassword(YoubenbenUserContextImpl userContext, String acct, String password) throws Exception {
//		
//		BusinessHandler bizHandler = new BusinessHandler() {
//			public void onAuthenticationFailed(YoubenbenUserContextImpl userContext, LoginContext loginContext,
//					LoginResult loginResult, IdentificationHandler idHandler, BusinessHandler bizHandler)
//					throws Exception {
//				onFailExample(userContext, loginContext, loginResult, idHandler, bizHandler);
//			}
//			public void onAuthenticateNewUserLogged(YoubenbenUserContextImpl userContext, LoginContext loginContext,
//					LoginResult loginResult, IdentificationHandler idHandler, BusinessHandler bizHandler)
//					throws Exception {
//				onNewExample(userContext, loginContext, loginResult, idHandler, bizHandler);
//			}
//			public void onAuthenticateUserLogged(YoubenbenUserContextImpl userContext, LoginContext loginContext,
//					LoginResult loginResult, IdentificationHandler idHandler, BusinessHandler bizHandler)
//					throws Exception {
...
//	}
//	
//	protected Object onFailExample(YoubenbenUserContextImpl userContext, LoginContext loginContext, LoginResult loginResult,
//			IdentificationHandler idHandler, BusinessHandler bizHandler) {
//		// TODO Auto-generated method stub
//		return null;
//	}
//	protected Object onNewExample(YoubenbenUserContextImpl userContext, LoginContext loginContext, LoginResult loginResult,
//			IdentificationHandler idHandler, BusinessHandler bizHandler) {
//		// 新用户来了,我也不知道该干嘛,所以报错
...
//		return null;
//	}
//	protected Object onSuccessExample(YoubenbenUserContextImpl userContext, LoginContext loginContext, LoginResult loginResult,
//			IdentificationHandler idHandler, BusinessHandler bizHandler) {
//		// 成功了就直接记载第一个userApp
//		SecUser secUser = loginResult.getLoginContext().getLoginTarget().getSecUser();
