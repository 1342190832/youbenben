...
public abstract class BaseIdentificationHandler implements IdentificationHandler{
	...
	protected String getVeriyCodeCacheKey(YoubenbenUserContext userContext, String mobile) {
		return String.format("vcode:%s:%s", mobile, "login");
	}

	protected String getWehatSessionKeyCacheKey(YoubenbenUserContext userContext, String appId, String openId) {
