...
public class WechatMiniprogramHandler extends BaseIdentificationHandler {
	...
	@Override
	public LoginResult authenticate(YoubenbenUserContext userContext, LoginContext loginContext) {
	...
	protected boolean authenticateWithCode(YoubenbenUserContext userContext, String code, LoginResult result) throws Exception{
	...
	@Override
	public void bindWithSecUser(YoubenbenUserContext userContext, LoginContext loginContext) throws Exception {
	...
	protected SmartList<WechatMiniappIdentify> getIdentifyRecords(YoubenbenUserContext userContext,
