...
public class QuickLinkManagerImpl extends CustomYoubenbenCheckerManager implements QuickLinkManager, BusinessHandler{
	...
	@Override
	public QuickLinkDAO daoOf(YoubenbenUserContext userContext) {
	...
	protected void throwExceptionWithMessage(String value) throws QuickLinkManagerException{
 	...
 	protected QuickLink saveQuickLink(YoubenbenUserContext userContext, QuickLink quickLink, String [] tokensExpr) throws Exception{	
 	...
 	protected QuickLink saveQuickLinkDetail(YoubenbenUserContext userContext, QuickLink quickLink) throws Exception{	
 	...
 	public QuickLink loadQuickLink(YoubenbenUserContext userContext, String quickLinkId, String [] tokensExpr) throws Exception{				
 	 ...
 	 public QuickLink searchQuickLink(YoubenbenUserContext userContext, String quickLinkId, String textToSearch,String [] tokensExpr) throws Exception{				
 	...
 	protected QuickLink present(YoubenbenUserContext userContext, QuickLink quickLink, Map<String, Object> tokens) throws Exception {
 	...
 	public QuickLink loadQuickLinkDetail(YoubenbenUserContext userContext, String quickLinkId) throws Exception{	
 		QuickLink quickLink = loadQuickLink( userContext, quickLinkId, allTokens());
 		return present(userContext,quickLink, allTokens());
		
 	}
 	
 	public Object view(YoubenbenUserContext userContext, String quickLinkId) throws Exception{	
 		QuickLink quickLink = loadQuickLink( userContext, quickLinkId, viewTokens());
 		return present(userContext,quickLink, allTokens());
		
 	}
 	protected QuickLink saveQuickLink(YoubenbenUserContext userContext, QuickLink quickLink, Map<String,Object>tokens) throws Exception{	
 		return quickLinkDaoOf(userContext).save(quickLink, tokens);
 	}
 	protected QuickLink loadQuickLink(YoubenbenUserContext userContext, String quickLinkId, Map<String,Object>tokens) throws Exception{	
		checkerOf(userContext).checkIdOfQuickLink(quickLinkId);
		checkerOf(userContext).throwExceptionIfHasErrors( QuickLinkManagerException.class);
 	...
 	protected<T extends BaseEntity> void addActions(YoubenbenUserContext userContext, QuickLink quickLink, Map<String, Object> tokens){
	...
	}// end method of protected<T extends BaseEntity> void addActions(YoubenbenUserContext userContext, QuickLink quickLink, Map<String, Object> tokens){
	...
	protected void checkParamsForUpdatingQuickLink(YoubenbenUserContext userContext,String quickLinkId, int quickLinkVersion, String property, String newValueExpr,String [] tokensExpr)throws Exception
	{
	...
	public QuickLink clone(YoubenbenUserContext userContext, String fromQuickLinkId) throws Exception{
	...
	public QuickLink internalSaveQuickLink(YoubenbenUserContext userContext, QuickLink quickLink, Map<String,Object> options) throws Exception
	{
	...
	public QuickLink updateQuickLinkProperty(YoubenbenUserContext userContext,String quickLinkId, int quickLinkVersion, String property, String newValueExpr,String [] tokensExpr) throws Exception
	{
		checkParamsForUpdatingQuickLink(userContext, quickLinkId, quickLinkVersion, property, newValueExpr, tokensExpr);
	...
	protected void checkParamsForTransferingAnotherApp(YoubenbenUserContext userContext, String quickLinkId, String anotherAppId) throws Exception
 	{
 ...
 //--------------------------------------------------------------
	...
	public void delete(YoubenbenUserContext userContext, String quickLinkId, int quickLinkVersion) throws Exception {
	...
	public QuickLink forgetByAll(YoubenbenUserContext userContext, String quickLinkId, int quickLinkVersion) throws Exception {
		return forgetByAllInternal(userContext, quickLinkId, quickLinkVersion);
	}
	protected QuickLink forgetByAllInternal(YoubenbenUserContext userContext,
			String quickLinkId, int quickLinkVersion) throws Exception{
	...
	// -----------------------------------// list-of-view 处理 \\-----------------------------------
    protected void enhanceForListOfView(YoubenbenUserContext userContext,SmartList<QuickLink> list) throws Exception {
  ...
  // -----------------------------------\\ list-of-view 处理 //-----------------------------------v
	 ...
	 * @throws Exception
	 */
 	public Object wxappview(YoubenbenUserContext userContext, String quickLinkId) throws Exception{
	  SerializeScope vscope = YoubenbenViewScope.getInstance().getQuickLinkDetailScope().clone();
