...
public class OfferAcceptanceJDBCTemplateDAO extends YoubenbenBaseDAOImpl implements OfferAcceptanceDAO{
	...
	*/
	...
	public SmartList<OfferAcceptance> loadAll() {
	    return this.loadAll(getOfferAcceptanceMapper());
	}
    ...
    public SmartList<OfferAcceptance> requestCandidateOfferAcceptanceForEmployee(YoubenbenUserContext userContext, String ownerClass, String id, String filterKey, int pageNo, int pageSize) throws Exception {
		...
		return findAllCandidateByFilter(OfferAcceptanceTable.COLUMN_WHO, null, filterKey, pageNo, pageSize, getOfferAcceptanceMapper());
    }
