...
public class LevelTwoDepartmentJDBCTemplateDAO extends YoubenbenBaseDAOImpl implements LevelTwoDepartmentDAO{
	...
	*/
    ...
    public SmartList<LevelTwoDepartment> requestCandidateLevelTwoDepartmentForLevelThreeDepartment(YoubenbenUserContext userContext, String ownerClass, String id, String filterKey, int pageNo, int pageSize) throws Exception {
	...
	public SmartList<LevelThreeDepartment> loadOurLevelThreeDepartmentList(YoubenbenUserContext userContext, List<LevelTwoDepartment> us, Map<String,Object> options) throws Exception{
