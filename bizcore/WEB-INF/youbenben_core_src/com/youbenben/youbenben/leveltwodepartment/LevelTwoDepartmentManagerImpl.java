...
import com.youbenben.youbenben.levelonedepartment.CandidateLevelOneDepartment;
...
public class LevelTwoDepartmentManagerImpl extends CustomYoubenbenCheckerManager implements LevelTwoDepartmentManager, BusinessHandler{
	...
	@Override
	public LevelTwoDepartmentDAO daoOf(YoubenbenUserContext userContext) {
	...
	protected void throwExceptionWithMessage(String value) throws LevelTwoDepartmentManagerException{
 	...
 	protected LevelTwoDepartment saveLevelTwoDepartment(YoubenbenUserContext userContext, LevelTwoDepartment levelTwoDepartment, String [] tokensExpr) throws Exception{	
 	...
 	protected LevelTwoDepartment saveLevelTwoDepartmentDetail(YoubenbenUserContext userContext, LevelTwoDepartment levelTwoDepartment) throws Exception{	
 	...
 	public LevelTwoDepartment loadLevelTwoDepartment(YoubenbenUserContext userContext, String levelTwoDepartmentId, String [] tokensExpr) throws Exception{				
 	 ...
 	 public LevelTwoDepartment searchLevelTwoDepartment(YoubenbenUserContext userContext, String levelTwoDepartmentId, String textToSearch,String [] tokensExpr) throws Exception{				
 	...
 	protected LevelTwoDepartment present(YoubenbenUserContext userContext, LevelTwoDepartment levelTwoDepartment, Map<String, Object> tokens) throws Exception {
 	...
 	public LevelTwoDepartment loadLevelTwoDepartmentDetail(YoubenbenUserContext userContext, String levelTwoDepartmentId) throws Exception{	
 	...
 	public Object view(YoubenbenUserContext userContext, String levelTwoDepartmentId) throws Exception{	
 		LevelTwoDepartment levelTwoDepartment = loadLevelTwoDepartment( userContext, levelTwoDepartmentId, viewTokens());
 		return present(userContext,levelTwoDepartment, allTokens());
		
 	}
 	protected LevelTwoDepartment saveLevelTwoDepartment(YoubenbenUserContext userContext, LevelTwoDepartment levelTwoDepartment, Map<String,Object>tokens) throws Exception{	
 		return levelTwoDepartmentDaoOf(userContext).save(levelTwoDepartment, tokens);
 	}
 	protected LevelTwoDepartment loadLevelTwoDepartment(YoubenbenUserContext userContext, String levelTwoDepartmentId, Map<String,Object>tokens) throws Exception{	
		checkerOf(userContext).checkIdOfLevelTwoDepartment(levelTwoDepartmentId);
		checkerOf(userContext).throwExceptionIfHasErrors( LevelTwoDepartmentManagerException.class);
 	...
 	protected<T extends BaseEntity> void addActions(YoubenbenUserContext userContext, LevelTwoDepartment levelTwoDepartment, Map<String, Object> tokens){
	...
	}// end method of protected<T extends BaseEntity> void addActions(YoubenbenUserContext userContext, LevelTwoDepartment levelTwoDepartment, Map<String, Object> tokens){
	...
	protected void checkParamsForUpdatingLevelTwoDepartment(YoubenbenUserContext userContext,String levelTwoDepartmentId, int levelTwoDepartmentVersion, String property, String newValueExpr,String [] tokensExpr)throws Exception
	{
	...
	public LevelTwoDepartment clone(YoubenbenUserContext userContext, String fromLevelTwoDepartmentId) throws Exception{
	...
	public LevelTwoDepartment internalSaveLevelTwoDepartment(YoubenbenUserContext userContext, LevelTwoDepartment levelTwoDepartment, Map<String,Object> options) throws Exception
	{
	...
	public LevelTwoDepartment updateLevelTwoDepartmentProperty(YoubenbenUserContext userContext,String levelTwoDepartmentId, int levelTwoDepartmentVersion, String property, String newValueExpr,String [] tokensExpr) throws Exception
	{
		checkParamsForUpdatingLevelTwoDepartment(userContext, levelTwoDepartmentId, levelTwoDepartmentVersion, property, newValueExpr, tokensExpr);
	...
	protected void checkParamsForTransferingAnotherBelongsTo(YoubenbenUserContext userContext, String levelTwoDepartmentId, String anotherBelongsToId) throws Exception
 	{
	...
	public CandidateLevelOneDepartment requestCandidateBelongsTo(YoubenbenUserContext userContext, String ownerClass, String id, String filterKey, int pageNo) throws Exception {
 ...
 //--------------------------------------------------------------
 	...
 	protected LevelOneDepartment loadLevelOneDepartment(YoubenbenUserContext userContext, String newBelongsToId, Map<String,Object> options) throws Exception
 	{
	...
	public void delete(YoubenbenUserContext userContext, String levelTwoDepartmentId, int levelTwoDepartmentVersion) throws Exception {
	...
	public LevelTwoDepartment forgetByAll(YoubenbenUserContext userContext, String levelTwoDepartmentId, int levelTwoDepartmentVersion) throws Exception {
		return forgetByAllInternal(userContext, levelTwoDepartmentId, levelTwoDepartmentVersion);
	}
	protected LevelTwoDepartment forgetByAllInternal(YoubenbenUserContext userContext,
			String levelTwoDepartmentId, int levelTwoDepartmentVersion) throws Exception{
	...
	protected void checkParamsForAddingLevelThreeDepartment(YoubenbenUserContext userContext, String levelTwoDepartmentId, String name, String description, Date founded,String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForUpdatingLevelThreeDepartmentProperties(YoubenbenUserContext userContext, String levelTwoDepartmentId,String id,String name,String description,Date founded,String [] tokensExpr) throws Exception {
	...
	public  LevelTwoDepartment updateLevelThreeDepartmentProperties(YoubenbenUserContext userContext, String levelTwoDepartmentId, String id,String name,String description,Date founded, String [] tokensExpr) throws Exception
	{
	...
	protected LevelThreeDepartment createLevelThreeDepartment(YoubenbenUserContext userContext, String name, String description, Date founded) throws Exception{
	...
	protected void checkParamsForRemovingLevelThreeDepartmentList(YoubenbenUserContext userContext, String levelTwoDepartmentId,
	...
	public  LevelTwoDepartment removeLevelThreeDepartmentList(YoubenbenUserContext userContext, String levelTwoDepartmentId,
			String levelThreeDepartmentIds[],String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForRemovingLevelThreeDepartment(YoubenbenUserContext userContext, String levelTwoDepartmentId,
	...
	public  LevelTwoDepartment removeLevelThreeDepartment(YoubenbenUserContext userContext, String levelTwoDepartmentId,
		String levelThreeDepartmentId, int levelThreeDepartmentVersion,String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForCopyingLevelThreeDepartment(YoubenbenUserContext userContext, String levelTwoDepartmentId,
		String levelThreeDepartmentId, int levelThreeDepartmentVersion,String [] tokensExpr) throws Exception{
	...
	public  LevelTwoDepartment copyLevelThreeDepartmentFrom(YoubenbenUserContext userContext, String levelTwoDepartmentId,
		String levelThreeDepartmentId, int levelThreeDepartmentVersion,String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForUpdatingLevelThreeDepartment(YoubenbenUserContext userContext, String levelTwoDepartmentId, String levelThreeDepartmentId, int levelThreeDepartmentVersion, String property, String newValueExpr,String [] tokensExpr) throws Exception{
	...
	public  LevelTwoDepartment updateLevelThreeDepartment(YoubenbenUserContext userContext, String levelTwoDepartmentId, String levelThreeDepartmentId, int levelThreeDepartmentVersion, String property, String newValueExpr,String [] tokensExpr)
			throws Exception{
	...
	*/
	...
	// -----------------------------------// list-of-view 处理 \\-----------------------------------
    protected void enhanceForListOfView(YoubenbenUserContext userContext,SmartList<LevelTwoDepartment> list) throws Exception {
    	if (list == null || list.isEmpty()){
    		return;
    	}
		List<LevelOneDepartment> belongsToList = YoubenbenBaseUtils.collectReferencedObjectWithType(userContext, list, LevelOneDepartment.class);
  ...
  // -----------------------------------\\ list-of-view 处理 //-----------------------------------v
	 ...
	 * @throws Exception
	 */
 	public Object wxappview(YoubenbenUserContext userContext, String levelTwoDepartmentId) throws Exception{
	  SerializeScope vscope = YoubenbenViewScope.getInstance().getLevelTwoDepartmentDetailScope().clone();
    ...
    String pageTitle = "二级部门"+"详情";
		...
		vscope.field("levelThreeDepartmentListSection", YoubenbenListOfViewScope.getInstance()
