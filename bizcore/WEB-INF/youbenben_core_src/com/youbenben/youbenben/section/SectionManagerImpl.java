...
public class SectionManagerImpl extends CustomYoubenbenCheckerManager implements SectionManager, BusinessHandler{
	...
	@Override
	public SectionDAO daoOf(YoubenbenUserContext userContext) {
	...
	protected void throwExceptionWithMessage(String value) throws SectionManagerException{
 	...
 	protected Section saveSection(YoubenbenUserContext userContext, Section section, String [] tokensExpr) throws Exception{	
 	...
 	protected Section saveSectionDetail(YoubenbenUserContext userContext, Section section) throws Exception{	
 	...
 	public Section loadSection(YoubenbenUserContext userContext, String sectionId, String [] tokensExpr) throws Exception{				
 	 ...
 	 public Section searchSection(YoubenbenUserContext userContext, String sectionId, String textToSearch,String [] tokensExpr) throws Exception{				
 	...
 	protected Section present(YoubenbenUserContext userContext, Section section, Map<String, Object> tokens) throws Exception {
 	...
 	public Section loadSectionDetail(YoubenbenUserContext userContext, String sectionId) throws Exception{	
 		Section section = loadSection( userContext, sectionId, allTokens());
 		return present(userContext,section, allTokens());
		
 	}
 	
 	public Object view(YoubenbenUserContext userContext, String sectionId) throws Exception{	
 		Section section = loadSection( userContext, sectionId, viewTokens());
 		return present(userContext,section, allTokens());
		
 	}
 	protected Section saveSection(YoubenbenUserContext userContext, Section section, Map<String,Object>tokens) throws Exception{	
 		return sectionDaoOf(userContext).save(section, tokens);
 	}
 	protected Section loadSection(YoubenbenUserContext userContext, String sectionId, Map<String,Object>tokens) throws Exception{	
		checkerOf(userContext).checkIdOfSection(sectionId);
		checkerOf(userContext).throwExceptionIfHasErrors( SectionManagerException.class);
 	...
 	protected<T extends BaseEntity> void addActions(YoubenbenUserContext userContext, Section section, Map<String, Object> tokens){
	...
	}// end method of protected<T extends BaseEntity> void addActions(YoubenbenUserContext userContext, Section section, Map<String, Object> tokens){
	...
	protected void checkParamsForUpdatingSection(YoubenbenUserContext userContext,String sectionId, int sectionVersion, String property, String newValueExpr,String [] tokensExpr)throws Exception
	{
	...
	public Section clone(YoubenbenUserContext userContext, String fromSectionId) throws Exception{
	...
	public Section internalSaveSection(YoubenbenUserContext userContext, Section section, Map<String,Object> options) throws Exception
	{
	...
	public Section updateSectionProperty(YoubenbenUserContext userContext,String sectionId, int sectionVersion, String property, String newValueExpr,String [] tokensExpr) throws Exception
	{
		checkParamsForUpdatingSection(userContext, sectionId, sectionVersion, property, newValueExpr, tokensExpr);
	...
	protected void checkParamsForTransferingAnotherPage(YoubenbenUserContext userContext, String sectionId, String anotherPageId) throws Exception
 	{
 ...
 //--------------------------------------------------------------
	...
	public void delete(YoubenbenUserContext userContext, String sectionId, int sectionVersion) throws Exception {
	...
	public Section forgetByAll(YoubenbenUserContext userContext, String sectionId, int sectionVersion) throws Exception {
		return forgetByAllInternal(userContext, sectionId, sectionVersion);
	}
	protected Section forgetByAllInternal(YoubenbenUserContext userContext,
			String sectionId, int sectionVersion) throws Exception{
	...
	// -----------------------------------// list-of-view 处理 \\-----------------------------------
    protected void enhanceForListOfView(YoubenbenUserContext userContext,SmartList<Section> list) throws Exception {
  ...
  // -----------------------------------\\ list-of-view 处理 //-----------------------------------v
	 ...
	 * @throws Exception
	 */
 	public Object wxappview(YoubenbenUserContext userContext, String sectionId) throws Exception{
	  SerializeScope vscope = YoubenbenViewScope.getInstance().getSectionDetailScope().clone();
