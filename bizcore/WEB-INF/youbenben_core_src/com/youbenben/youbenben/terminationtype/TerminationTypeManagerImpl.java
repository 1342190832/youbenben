...
public class TerminationTypeManagerImpl extends CustomYoubenbenCheckerManager implements TerminationTypeManager, BusinessHandler{
	...
	@Override
	public TerminationTypeDAO daoOf(YoubenbenUserContext userContext) {
	...
	protected void throwExceptionWithMessage(String value) throws TerminationTypeManagerException{
 	...
 	protected TerminationType saveTerminationType(YoubenbenUserContext userContext, TerminationType terminationType, String [] tokensExpr) throws Exception{	
 	...
 	protected TerminationType saveTerminationTypeDetail(YoubenbenUserContext userContext, TerminationType terminationType) throws Exception{	
 	...
 	public TerminationType loadTerminationType(YoubenbenUserContext userContext, String terminationTypeId, String [] tokensExpr) throws Exception{				
 	 ...
 	 public TerminationType searchTerminationType(YoubenbenUserContext userContext, String terminationTypeId, String textToSearch,String [] tokensExpr) throws Exception{				
 	...
 	protected TerminationType present(YoubenbenUserContext userContext, TerminationType terminationType, Map<String, Object> tokens) throws Exception {
 	...
 	public TerminationType loadTerminationTypeDetail(YoubenbenUserContext userContext, String terminationTypeId) throws Exception{	
 	...
 	public Object view(YoubenbenUserContext userContext, String terminationTypeId) throws Exception{	
 		TerminationType terminationType = loadTerminationType( userContext, terminationTypeId, viewTokens());
 		return present(userContext,terminationType, allTokens());
		
 	}
 	protected TerminationType saveTerminationType(YoubenbenUserContext userContext, TerminationType terminationType, Map<String,Object>tokens) throws Exception{	
 		return terminationTypeDaoOf(userContext).save(terminationType, tokens);
 	}
 	protected TerminationType loadTerminationType(YoubenbenUserContext userContext, String terminationTypeId, Map<String,Object>tokens) throws Exception{	
		checkerOf(userContext).checkIdOfTerminationType(terminationTypeId);
		checkerOf(userContext).throwExceptionIfHasErrors( TerminationTypeManagerException.class);
 	...
 	protected<T extends BaseEntity> void addActions(YoubenbenUserContext userContext, TerminationType terminationType, Map<String, Object> tokens){
	...
	}// end method of protected<T extends BaseEntity> void addActions(YoubenbenUserContext userContext, TerminationType terminationType, Map<String, Object> tokens){
	...
	protected void checkParamsForUpdatingTerminationType(YoubenbenUserContext userContext,String terminationTypeId, int terminationTypeVersion, String property, String newValueExpr,String [] tokensExpr)throws Exception
	{
	...
	public TerminationType clone(YoubenbenUserContext userContext, String fromTerminationTypeId) throws Exception{
	...
	public TerminationType internalSaveTerminationType(YoubenbenUserContext userContext, TerminationType terminationType, Map<String,Object> options) throws Exception
	{
	...
	public TerminationType updateTerminationTypeProperty(YoubenbenUserContext userContext,String terminationTypeId, int terminationTypeVersion, String property, String newValueExpr,String [] tokensExpr) throws Exception
	{
		checkParamsForUpdatingTerminationType(userContext, terminationTypeId, terminationTypeVersion, property, newValueExpr, tokensExpr);
	...
	protected void checkParamsForTransferingAnotherCompany(YoubenbenUserContext userContext, String terminationTypeId, String anotherCompanyId) throws Exception
 	{
 ...
 //--------------------------------------------------------------
	...
	public void delete(YoubenbenUserContext userContext, String terminationTypeId, int terminationTypeVersion) throws Exception {
	...
	public TerminationType forgetByAll(YoubenbenUserContext userContext, String terminationTypeId, int terminationTypeVersion) throws Exception {
		return forgetByAllInternal(userContext, terminationTypeId, terminationTypeVersion);
	}
	protected TerminationType forgetByAllInternal(YoubenbenUserContext userContext,
			String terminationTypeId, int terminationTypeVersion) throws Exception{
	...
	protected TerminationType breakWithTerminationByReason(YoubenbenUserContext userContext, String terminationTypeId, String reasonId,  String [] tokensExpr)
		 throws Exception{
	...
	protected void checkParamsForAddingTermination(YoubenbenUserContext userContext, String terminationTypeId, String reasonId, String comment,String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForUpdatingTerminationProperties(YoubenbenUserContext userContext, String terminationTypeId,String id,String comment,String [] tokensExpr) throws Exception {
	...
	public  TerminationType updateTerminationProperties(YoubenbenUserContext userContext, String terminationTypeId, String id,String comment, String [] tokensExpr) throws Exception
	{
	...
	protected Termination createTermination(YoubenbenUserContext userContext, String reasonId, String comment) throws Exception{
	...
	protected void checkParamsForRemovingTerminationList(YoubenbenUserContext userContext, String terminationTypeId,
	...
	public  TerminationType removeTerminationList(YoubenbenUserContext userContext, String terminationTypeId,
			String terminationIds[],String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForRemovingTermination(YoubenbenUserContext userContext, String terminationTypeId,
	...
	public  TerminationType removeTermination(YoubenbenUserContext userContext, String terminationTypeId,
		String terminationId, int terminationVersion,String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForCopyingTermination(YoubenbenUserContext userContext, String terminationTypeId,
		String terminationId, int terminationVersion,String [] tokensExpr) throws Exception{
	...
	public  TerminationType copyTerminationFrom(YoubenbenUserContext userContext, String terminationTypeId,
		String terminationId, int terminationVersion,String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForUpdatingTermination(YoubenbenUserContext userContext, String terminationTypeId, String terminationId, int terminationVersion, String property, String newValueExpr,String [] tokensExpr) throws Exception{
	...
	public  TerminationType updateTermination(YoubenbenUserContext userContext, String terminationTypeId, String terminationId, int terminationVersion, String property, String newValueExpr,String [] tokensExpr)
			throws Exception{
	...
	*/
	...
	// -----------------------------------// list-of-view 处理 \\-----------------------------------
    protected void enhanceForListOfView(YoubenbenUserContext userContext,SmartList<TerminationType> list) throws Exception {
  ...
  // -----------------------------------\\ list-of-view 处理 //-----------------------------------v
	 ...
	 * @throws Exception
	 */
 	public Object wxappview(YoubenbenUserContext userContext, String terminationTypeId) throws Exception{
	  SerializeScope vscope = YoubenbenViewScope.getInstance().getTerminationTypeDetailScope().clone();
