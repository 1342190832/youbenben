...
import com.youbenben.youbenben.citypartner.CandidateCityPartner;
...
public class PotentialCustomerManagerImpl extends CustomYoubenbenCheckerManager implements PotentialCustomerManager, BusinessHandler{
	...
	@Override
	public PotentialCustomerDAO daoOf(YoubenbenUserContext userContext) {
	...
	protected void throwExceptionWithMessage(String value) throws PotentialCustomerManagerException{
 	...
 	protected PotentialCustomer savePotentialCustomer(YoubenbenUserContext userContext, PotentialCustomer potentialCustomer, String [] tokensExpr) throws Exception{	
 	...
 	protected PotentialCustomer savePotentialCustomerDetail(YoubenbenUserContext userContext, PotentialCustomer potentialCustomer) throws Exception{	
 	...
 	public PotentialCustomer loadPotentialCustomer(YoubenbenUserContext userContext, String potentialCustomerId, String [] tokensExpr) throws Exception{				
 	 ...
 	 public PotentialCustomer searchPotentialCustomer(YoubenbenUserContext userContext, String potentialCustomerId, String textToSearch,String [] tokensExpr) throws Exception{				
 	...
 	protected PotentialCustomer present(YoubenbenUserContext userContext, PotentialCustomer potentialCustomer, Map<String, Object> tokens) throws Exception {
 	...
 	public PotentialCustomer loadPotentialCustomerDetail(YoubenbenUserContext userContext, String potentialCustomerId) throws Exception{	
 	...
 	public Object view(YoubenbenUserContext userContext, String potentialCustomerId) throws Exception{	
 		PotentialCustomer potentialCustomer = loadPotentialCustomer( userContext, potentialCustomerId, viewTokens());
 		return present(userContext,potentialCustomer, allTokens());
		
 	}
 	protected PotentialCustomer savePotentialCustomer(YoubenbenUserContext userContext, PotentialCustomer potentialCustomer, Map<String,Object>tokens) throws Exception{	
 		return potentialCustomerDaoOf(userContext).save(potentialCustomer, tokens);
 	}
 	protected PotentialCustomer loadPotentialCustomer(YoubenbenUserContext userContext, String potentialCustomerId, Map<String,Object>tokens) throws Exception{	
		checkerOf(userContext).checkIdOfPotentialCustomer(potentialCustomerId);
		checkerOf(userContext).throwExceptionIfHasErrors( PotentialCustomerManagerException.class);
 	...
 	protected<T extends BaseEntity> void addActions(YoubenbenUserContext userContext, PotentialCustomer potentialCustomer, Map<String, Object> tokens){
	...
	}// end method of protected<T extends BaseEntity> void addActions(YoubenbenUserContext userContext, PotentialCustomer potentialCustomer, Map<String, Object> tokens){
	...
	protected void checkParamsForUpdatingPotentialCustomer(YoubenbenUserContext userContext,String potentialCustomerId, int potentialCustomerVersion, String property, String newValueExpr,String [] tokensExpr)throws Exception
	{
	...
	public PotentialCustomer clone(YoubenbenUserContext userContext, String fromPotentialCustomerId) throws Exception{
	...
	public PotentialCustomer internalSavePotentialCustomer(YoubenbenUserContext userContext, PotentialCustomer potentialCustomer, Map<String,Object> options) throws Exception
	{
	...
	public PotentialCustomer updatePotentialCustomerProperty(YoubenbenUserContext userContext,String potentialCustomerId, int potentialCustomerVersion, String property, String newValueExpr,String [] tokensExpr) throws Exception
	{
		checkParamsForUpdatingPotentialCustomer(userContext, potentialCustomerId, potentialCustomerVersion, property, newValueExpr, tokensExpr);
	...
	protected void checkParamsForTransferingAnotherCityServiceCenter(YoubenbenUserContext userContext, String potentialCustomerId, String anotherCityServiceCenterId) throws Exception
 	{
	...
	public CandidateRetailStoreCityServiceCenter requestCandidateCityServiceCenter(YoubenbenUserContext userContext, String ownerClass, String id, String filterKey, int pageNo) throws Exception {
 	...
 	protected void checkParamsForTransferingAnotherCityPartner(YoubenbenUserContext userContext, String potentialCustomerId, String anotherCityPartnerId) throws Exception
 	{
	...
	public CandidateCityPartner requestCandidateCityPartner(YoubenbenUserContext userContext, String ownerClass, String id, String filterKey, int pageNo) throws Exception {
 ...
 //--------------------------------------------------------------
 	...
 	protected CityPartner loadCityPartner(YoubenbenUserContext userContext, String newCityPartnerId, Map<String,Object> options) throws Exception
 	{
	...
	public void delete(YoubenbenUserContext userContext, String potentialCustomerId, int potentialCustomerVersion) throws Exception {
	...
	public PotentialCustomer forgetByAll(YoubenbenUserContext userContext, String potentialCustomerId, int potentialCustomerVersion) throws Exception {
		return forgetByAllInternal(userContext, potentialCustomerId, potentialCustomerVersion);
	}
	protected PotentialCustomer forgetByAllInternal(YoubenbenUserContext userContext,
			String potentialCustomerId, int potentialCustomerVersion) throws Exception{
	...
	protected PotentialCustomer breakWithPotentialCustomerContactByCityPartner(YoubenbenUserContext userContext, String potentialCustomerId, String cityPartnerId,  String [] tokensExpr)
		 throws Exception{
	...
	protected PotentialCustomer breakWithPotentialCustomerContactByContactTo(YoubenbenUserContext userContext, String potentialCustomerId, String contactToId,  String [] tokensExpr)
		 throws Exception{
	...
	protected PotentialCustomer breakWithEventAttendanceByCityEvent(YoubenbenUserContext userContext, String potentialCustomerId, String cityEventId,  String [] tokensExpr)
		 throws Exception{
	...
	protected void checkParamsForAddingPotentialCustomerContactPerson(YoubenbenUserContext userContext, String potentialCustomerId, String name, String mobile, String description,String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForUpdatingPotentialCustomerContactPersonProperties(YoubenbenUserContext userContext, String potentialCustomerId,String id,String name,String mobile,String description,String [] tokensExpr) throws Exception {
	...
	public  PotentialCustomer updatePotentialCustomerContactPersonProperties(YoubenbenUserContext userContext, String potentialCustomerId, String id,String name,String mobile,String description, String [] tokensExpr) throws Exception
	{
	...
	protected PotentialCustomerContactPerson createPotentialCustomerContactPerson(YoubenbenUserContext userContext, String name, String mobile, String description) throws Exception{
	...
	protected void checkParamsForRemovingPotentialCustomerContactPersonList(YoubenbenUserContext userContext, String potentialCustomerId,
	...
	public  PotentialCustomer removePotentialCustomerContactPersonList(YoubenbenUserContext userContext, String potentialCustomerId,
			String potentialCustomerContactPersonIds[],String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForRemovingPotentialCustomerContactPerson(YoubenbenUserContext userContext, String potentialCustomerId,
	...
	public  PotentialCustomer removePotentialCustomerContactPerson(YoubenbenUserContext userContext, String potentialCustomerId,
		String potentialCustomerContactPersonId, int potentialCustomerContactPersonVersion,String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForCopyingPotentialCustomerContactPerson(YoubenbenUserContext userContext, String potentialCustomerId,
		String potentialCustomerContactPersonId, int potentialCustomerContactPersonVersion,String [] tokensExpr) throws Exception{
	...
	public  PotentialCustomer copyPotentialCustomerContactPersonFrom(YoubenbenUserContext userContext, String potentialCustomerId,
		String potentialCustomerContactPersonId, int potentialCustomerContactPersonVersion,String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForUpdatingPotentialCustomerContactPerson(YoubenbenUserContext userContext, String potentialCustomerId, String potentialCustomerContactPersonId, int potentialCustomerContactPersonVersion, String property, String newValueExpr,String [] tokensExpr) throws Exception{
	...
	public  PotentialCustomer updatePotentialCustomerContactPerson(YoubenbenUserContext userContext, String potentialCustomerId, String potentialCustomerContactPersonId, int potentialCustomerContactPersonVersion, String property, String newValueExpr,String [] tokensExpr)
			throws Exception{
	...
	*/
	...
	protected void checkParamsForAddingPotentialCustomerContact(YoubenbenUserContext userContext, String potentialCustomerId, String name, Date contactDate, String contactMethod, String cityPartnerId, String contactToId, String description,String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForUpdatingPotentialCustomerContactProperties(YoubenbenUserContext userContext, String potentialCustomerId,String id,String name,Date contactDate,String contactMethod,String description,String [] tokensExpr) throws Exception {
	...
	public  PotentialCustomer updatePotentialCustomerContactProperties(YoubenbenUserContext userContext, String potentialCustomerId, String id,String name,Date contactDate,String contactMethod,String description, String [] tokensExpr) throws Exception
	{
	...
	protected PotentialCustomerContact createPotentialCustomerContact(YoubenbenUserContext userContext, String name, Date contactDate, String contactMethod, String cityPartnerId, String contactToId, String description) throws Exception{
	...
	protected void checkParamsForRemovingPotentialCustomerContactList(YoubenbenUserContext userContext, String potentialCustomerId,
	...
	public  PotentialCustomer removePotentialCustomerContactList(YoubenbenUserContext userContext, String potentialCustomerId,
			String potentialCustomerContactIds[],String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForRemovingPotentialCustomerContact(YoubenbenUserContext userContext, String potentialCustomerId,
	...
	public  PotentialCustomer removePotentialCustomerContact(YoubenbenUserContext userContext, String potentialCustomerId,
		String potentialCustomerContactId, int potentialCustomerContactVersion,String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForCopyingPotentialCustomerContact(YoubenbenUserContext userContext, String potentialCustomerId,
		String potentialCustomerContactId, int potentialCustomerContactVersion,String [] tokensExpr) throws Exception{
	...
	public  PotentialCustomer copyPotentialCustomerContactFrom(YoubenbenUserContext userContext, String potentialCustomerId,
		String potentialCustomerContactId, int potentialCustomerContactVersion,String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForUpdatingPotentialCustomerContact(YoubenbenUserContext userContext, String potentialCustomerId, String potentialCustomerContactId, int potentialCustomerContactVersion, String property, String newValueExpr,String [] tokensExpr) throws Exception{
	...
	public  PotentialCustomer updatePotentialCustomerContact(YoubenbenUserContext userContext, String potentialCustomerId, String potentialCustomerContactId, int potentialCustomerContactVersion, String property, String newValueExpr,String [] tokensExpr)
			throws Exception{
	...
	*/
	...
	protected void checkParamsForAddingEventAttendance(YoubenbenUserContext userContext, String potentialCustomerId, String name, String cityEventId, String description,String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForUpdatingEventAttendanceProperties(YoubenbenUserContext userContext, String potentialCustomerId,String id,String name,String description,String [] tokensExpr) throws Exception {
	...
	public  PotentialCustomer updateEventAttendanceProperties(YoubenbenUserContext userContext, String potentialCustomerId, String id,String name,String description, String [] tokensExpr) throws Exception
	{
	...
	protected EventAttendance createEventAttendance(YoubenbenUserContext userContext, String name, String cityEventId, String description) throws Exception{
	...
	protected void checkParamsForRemovingEventAttendanceList(YoubenbenUserContext userContext, String potentialCustomerId,
	...
	public  PotentialCustomer removeEventAttendanceList(YoubenbenUserContext userContext, String potentialCustomerId,
			String eventAttendanceIds[],String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForRemovingEventAttendance(YoubenbenUserContext userContext, String potentialCustomerId,
	...
	public  PotentialCustomer removeEventAttendance(YoubenbenUserContext userContext, String potentialCustomerId,
		String eventAttendanceId, int eventAttendanceVersion,String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForCopyingEventAttendance(YoubenbenUserContext userContext, String potentialCustomerId,
		String eventAttendanceId, int eventAttendanceVersion,String [] tokensExpr) throws Exception{
	...
	public  PotentialCustomer copyEventAttendanceFrom(YoubenbenUserContext userContext, String potentialCustomerId,
		String eventAttendanceId, int eventAttendanceVersion,String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForUpdatingEventAttendance(YoubenbenUserContext userContext, String potentialCustomerId, String eventAttendanceId, int eventAttendanceVersion, String property, String newValueExpr,String [] tokensExpr) throws Exception{
	...
	public  PotentialCustomer updateEventAttendance(YoubenbenUserContext userContext, String potentialCustomerId, String eventAttendanceId, int eventAttendanceVersion, String property, String newValueExpr,String [] tokensExpr)
			throws Exception{
	...
	*/
	...
	// -----------------------------------// list-of-view 处理 \\-----------------------------------
    protected void enhanceForListOfView(YoubenbenUserContext userContext,SmartList<PotentialCustomer> list) throws Exception {
		...
		List<CityPartner> cityPartnerList = YoubenbenBaseUtils.collectReferencedObjectWithType(userContext, list, CityPartner.class);
  ...
  // -----------------------------------\\ list-of-view 处理 //-----------------------------------v
	 ...
	 * @throws Exception
	 */
 	public Object wxappview(YoubenbenUserContext userContext, String potentialCustomerId) throws Exception{
	  SerializeScope vscope = YoubenbenViewScope.getInstance().getPotentialCustomerDetailScope().clone();
    ...
    String pageTitle = "潜在的客户"+"详情";
		...
		vscope.field("potentialCustomerContactPersonListSection", YoubenbenListOfViewScope.getInstance()
