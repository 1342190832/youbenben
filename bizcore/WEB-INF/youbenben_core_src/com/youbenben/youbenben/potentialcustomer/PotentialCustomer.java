...
public class PotentialCustomer extends BaseEntity implements  java.io.Serializable{
	...
	protected		FranchisedOutletCityServiceCenter	mCityServiceCenter  ;
	...
	public void setCityServiceCenter(FranchisedOutletCityServiceCenter cityServiceCenter){
		this.mCityServiceCenter = cityServiceCenter;;
	}
	public FranchisedOutletCityServiceCenter getCityServiceCenter(){
		return this.mCityServiceCenter;
	}
	public PotentialCustomer updateCityServiceCenter(FranchisedOutletCityServiceCenter cityServiceCenter){
		this.mCityServiceCenter = cityServiceCenter;;
		this.changed = true;
		return this;
	}
	public void mergeCityServiceCenter(FranchisedOutletCityServiceCenter cityServiceCenter){
	...
	public String toString(){
		...
		if(getCityServiceCenter() != null ){
 			stringBuilder.append("\tcityServiceCenter='FranchisedOutletCityServiceCenter("+getCityServiceCenter().getId()+")';");
 		}
