...
public class PotentialCustomerMapper extends BaseRowMapper<PotentialCustomer>{
	...
	protected void setMobile(PotentialCustomer potentialCustomer, ResultSet rs, int rowNumber) throws SQLException{
 	...
 	protected void setCityServiceCenter(PotentialCustomer potentialCustomer, ResultSet rs, int rowNumber) throws SQLException{
 		String franchisedOutletCityServiceCenterId = rs.getString(PotentialCustomerTable.COLUMN_CITY_SERVICE_CENTER);
 		...
 		FranchisedOutletCityServiceCenter franchisedOutletCityServiceCenter = potentialCustomer.getCityServiceCenter();
 		...
 		potentialCustomer.setCityServiceCenter(createEmptyCityServiceCenter(franchisedOutletCityServiceCenterId));
 	}
	...
	protected void setVersion(PotentialCustomer potentialCustomer, ResultSet rs, int rowNumber) throws SQLException{
 	...
 	protected FranchisedOutletCityServiceCenter  createEmptyCityServiceCenter(String franchisedOutletCityServiceCenterId){
