...
public class SlideManagerImpl extends CustomYoubenbenCheckerManager implements SlideManager, BusinessHandler{
	...
	@Override
	public SlideDAO daoOf(YoubenbenUserContext userContext) {
	...
	protected void throwExceptionWithMessage(String value) throws SlideManagerException{
 	...
 	protected Slide saveSlide(YoubenbenUserContext userContext, Slide slide, String [] tokensExpr) throws Exception{	
 	...
 	protected Slide saveSlideDetail(YoubenbenUserContext userContext, Slide slide) throws Exception{	
 	...
 	public Slide loadSlide(YoubenbenUserContext userContext, String slideId, String [] tokensExpr) throws Exception{				
 	 ...
 	 public Slide searchSlide(YoubenbenUserContext userContext, String slideId, String textToSearch,String [] tokensExpr) throws Exception{				
 	...
 	protected Slide present(YoubenbenUserContext userContext, Slide slide, Map<String, Object> tokens) throws Exception {
 	...
 	public Slide loadSlideDetail(YoubenbenUserContext userContext, String slideId) throws Exception{	
 		Slide slide = loadSlide( userContext, slideId, allTokens());
 		return present(userContext,slide, allTokens());
		
 	}
 	
 	public Object view(YoubenbenUserContext userContext, String slideId) throws Exception{	
 		Slide slide = loadSlide( userContext, slideId, viewTokens());
 		return present(userContext,slide, allTokens());
		
 	}
 	protected Slide saveSlide(YoubenbenUserContext userContext, Slide slide, Map<String,Object>tokens) throws Exception{	
 		return slideDaoOf(userContext).save(slide, tokens);
 	}
 	protected Slide loadSlide(YoubenbenUserContext userContext, String slideId, Map<String,Object>tokens) throws Exception{	
		checkerOf(userContext).checkIdOfSlide(slideId);
		checkerOf(userContext).throwExceptionIfHasErrors( SlideManagerException.class);
 	...
 	protected<T extends BaseEntity> void addActions(YoubenbenUserContext userContext, Slide slide, Map<String, Object> tokens){
	...
	}// end method of protected<T extends BaseEntity> void addActions(YoubenbenUserContext userContext, Slide slide, Map<String, Object> tokens){
	...
	protected void checkParamsForUpdatingSlide(YoubenbenUserContext userContext,String slideId, int slideVersion, String property, String newValueExpr,String [] tokensExpr)throws Exception
	{
	...
	public Slide clone(YoubenbenUserContext userContext, String fromSlideId) throws Exception{
	...
	public Slide internalSaveSlide(YoubenbenUserContext userContext, Slide slide, Map<String,Object> options) throws Exception
	{
	...
	public Slide updateSlideProperty(YoubenbenUserContext userContext,String slideId, int slideVersion, String property, String newValueExpr,String [] tokensExpr) throws Exception
	{
		checkParamsForUpdatingSlide(userContext, slideId, slideVersion, property, newValueExpr, tokensExpr);
	...
	protected void checkParamsForTransferingAnotherPage(YoubenbenUserContext userContext, String slideId, String anotherPageId) throws Exception
 	{
 ...
 //--------------------------------------------------------------
	...
	public void delete(YoubenbenUserContext userContext, String slideId, int slideVersion) throws Exception {
	...
	public Slide forgetByAll(YoubenbenUserContext userContext, String slideId, int slideVersion) throws Exception {
		return forgetByAllInternal(userContext, slideId, slideVersion);
	}
	protected Slide forgetByAllInternal(YoubenbenUserContext userContext,
			String slideId, int slideVersion) throws Exception{
	...
	// -----------------------------------// list-of-view 处理 \\-----------------------------------
    protected void enhanceForListOfView(YoubenbenUserContext userContext,SmartList<Slide> list) throws Exception {
  ...
  // -----------------------------------\\ list-of-view 处理 //-----------------------------------v
	 ...
	 * @throws Exception
	 */
 	public Object wxappview(YoubenbenUserContext userContext, String slideId) throws Exception{
	  SerializeScope vscope = YoubenbenViewScope.getInstance().getSlideDetailScope().clone();
