...
import com.youbenben.youbenben.retailstoremembergiftcard.CandidateRetailStoreMemberGiftCard;
import com.youbenben.youbenben.consumerorder.CandidateConsumerOrder;
...
public class RetailStoreMemberGiftCardConsumeRecordManagerImpl extends CustomYoubenbenCheckerManager implements RetailStoreMemberGiftCardConsumeRecordManager, BusinessHandler{
	...
	@Override
	public RetailStoreMemberGiftCardConsumeRecordDAO daoOf(YoubenbenUserContext userContext) {
	...
	protected void throwExceptionWithMessage(String value) throws RetailStoreMemberGiftCardConsumeRecordManagerException{
 	...
 	protected RetailStoreMemberGiftCardConsumeRecord saveRetailStoreMemberGiftCardConsumeRecord(YoubenbenUserContext userContext, RetailStoreMemberGiftCardConsumeRecord retailStoreMemberGiftCardConsumeRecord, String [] tokensExpr) throws Exception{	
 	...
 	protected RetailStoreMemberGiftCardConsumeRecord saveRetailStoreMemberGiftCardConsumeRecordDetail(YoubenbenUserContext userContext, RetailStoreMemberGiftCardConsumeRecord retailStoreMemberGiftCardConsumeRecord) throws Exception{	
 	...
 	public RetailStoreMemberGiftCardConsumeRecord loadRetailStoreMemberGiftCardConsumeRecord(YoubenbenUserContext userContext, String retailStoreMemberGiftCardConsumeRecordId, String [] tokensExpr) throws Exception{				
 	 ...
 	 public RetailStoreMemberGiftCardConsumeRecord searchRetailStoreMemberGiftCardConsumeRecord(YoubenbenUserContext userContext, String retailStoreMemberGiftCardConsumeRecordId, String textToSearch,String [] tokensExpr) throws Exception{				
 	...
 	protected RetailStoreMemberGiftCardConsumeRecord present(YoubenbenUserContext userContext, RetailStoreMemberGiftCardConsumeRecord retailStoreMemberGiftCardConsumeRecord, Map<String, Object> tokens) throws Exception {
 	...
 	public RetailStoreMemberGiftCardConsumeRecord loadRetailStoreMemberGiftCardConsumeRecordDetail(YoubenbenUserContext userContext, String retailStoreMemberGiftCardConsumeRecordId) throws Exception{	
 	...
 	public Object view(YoubenbenUserContext userContext, String retailStoreMemberGiftCardConsumeRecordId) throws Exception{	
 	...
 	protected RetailStoreMemberGiftCardConsumeRecord saveRetailStoreMemberGiftCardConsumeRecord(YoubenbenUserContext userContext, RetailStoreMemberGiftCardConsumeRecord retailStoreMemberGiftCardConsumeRecord, Map<String,Object>tokens) throws Exception{	
 		return retailStoreMemberGiftCardConsumeRecordDaoOf(userContext).save(retailStoreMemberGiftCardConsumeRecord, tokens);
 	}
 	protected RetailStoreMemberGiftCardConsumeRecord loadRetailStoreMemberGiftCardConsumeRecord(YoubenbenUserContext userContext, String retailStoreMemberGiftCardConsumeRecordId, Map<String,Object>tokens) throws Exception{	
		checkerOf(userContext).checkIdOfRetailStoreMemberGiftCardConsumeRecord(retailStoreMemberGiftCardConsumeRecordId);
		checkerOf(userContext).throwExceptionIfHasErrors( RetailStoreMemberGiftCardConsumeRecordManagerException.class);
 	...
 	protected<T extends BaseEntity> void addActions(YoubenbenUserContext userContext, RetailStoreMemberGiftCardConsumeRecord retailStoreMemberGiftCardConsumeRecord, Map<String, Object> tokens){
	...
	}// end method of protected<T extends BaseEntity> void addActions(YoubenbenUserContext userContext, RetailStoreMemberGiftCardConsumeRecord retailStoreMemberGiftCardConsumeRecord, Map<String, Object> tokens){
	...
	protected void checkParamsForUpdatingRetailStoreMemberGiftCardConsumeRecord(YoubenbenUserContext userContext,String retailStoreMemberGiftCardConsumeRecordId, int retailStoreMemberGiftCardConsumeRecordVersion, String property, String newValueExpr,String [] tokensExpr)throws Exception
	{
	...
	public RetailStoreMemberGiftCardConsumeRecord clone(YoubenbenUserContext userContext, String fromRetailStoreMemberGiftCardConsumeRecordId) throws Exception{
	...
	public RetailStoreMemberGiftCardConsumeRecord internalSaveRetailStoreMemberGiftCardConsumeRecord(YoubenbenUserContext userContext, RetailStoreMemberGiftCardConsumeRecord retailStoreMemberGiftCardConsumeRecord, Map<String,Object> options) throws Exception
	{
	...
	public RetailStoreMemberGiftCardConsumeRecord updateRetailStoreMemberGiftCardConsumeRecordProperty(YoubenbenUserContext userContext,String retailStoreMemberGiftCardConsumeRecordId, int retailStoreMemberGiftCardConsumeRecordVersion, String property, String newValueExpr,String [] tokensExpr) throws Exception
	{
		checkParamsForUpdatingRetailStoreMemberGiftCardConsumeRecord(userContext, retailStoreMemberGiftCardConsumeRecordId, retailStoreMemberGiftCardConsumeRecordVersion, property, newValueExpr, tokensExpr);
	...
	protected void checkParamsForTransferingAnotherOwner(YoubenbenUserContext userContext, String retailStoreMemberGiftCardConsumeRecordId, String anotherOwnerId) throws Exception
 	{
	...
	public CandidateRetailStoreMemberGiftCard requestCandidateOwner(YoubenbenUserContext userContext, String ownerClass, String id, String filterKey, int pageNo) throws Exception {
 	...
 	protected void checkParamsForTransferingAnotherBizOrder(YoubenbenUserContext userContext, String retailStoreMemberGiftCardConsumeRecordId, String anotherBizOrderId) throws Exception
 	{
	...
	public CandidateConsumerOrder requestCandidateBizOrder(YoubenbenUserContext userContext, String ownerClass, String id, String filterKey, int pageNo) throws Exception {
 ...
 //--------------------------------------------------------------
 	...
 	protected RetailStoreMemberGiftCard loadRetailStoreMemberGiftCard(YoubenbenUserContext userContext, String newOwnerId, Map<String,Object> options) throws Exception
 	{
 	...
 	protected ConsumerOrder loadConsumerOrder(YoubenbenUserContext userContext, String newBizOrderId, Map<String,Object> options) throws Exception
 	{
	...
	public void delete(YoubenbenUserContext userContext, String retailStoreMemberGiftCardConsumeRecordId, int retailStoreMemberGiftCardConsumeRecordVersion) throws Exception {
	...
	public RetailStoreMemberGiftCardConsumeRecord forgetByAll(YoubenbenUserContext userContext, String retailStoreMemberGiftCardConsumeRecordId, int retailStoreMemberGiftCardConsumeRecordVersion) throws Exception {
	...
	protected RetailStoreMemberGiftCardConsumeRecord forgetByAllInternal(YoubenbenUserContext userContext,
			String retailStoreMemberGiftCardConsumeRecordId, int retailStoreMemberGiftCardConsumeRecordVersion) throws Exception{
	...
	// -----------------------------------// list-of-view 处理 \\-----------------------------------
    protected void enhanceForListOfView(YoubenbenUserContext userContext,SmartList<RetailStoreMemberGiftCardConsumeRecord> list) throws Exception {
    	if (list == null || list.isEmpty()){
    		return;
    	}
		List<RetailStoreMemberGiftCard> ownerList = YoubenbenBaseUtils.collectReferencedObjectWithType(userContext, list, RetailStoreMemberGiftCard.class);
		userContext.getDAOGroup().enhanceList(ownerList, RetailStoreMemberGiftCard.class);
		List<ConsumerOrder> bizOrderList = YoubenbenBaseUtils.collectReferencedObjectWithType(userContext, list, ConsumerOrder.class);
  ...
  // -----------------------------------\\ list-of-view 处理 //-----------------------------------v
	 ...
	 * @throws Exception
	 */
 	public Object wxappview(YoubenbenUserContext userContext, String retailStoreMemberGiftCardConsumeRecordId) throws Exception{
	  SerializeScope vscope = YoubenbenViewScope.getInstance().getRetailStoreMemberGiftCardConsumeRecordDetailScope().clone();
