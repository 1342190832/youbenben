...
public class RetailStoreOrderShipment extends BaseEntity implements  java.io.Serializable{
	...
	public 	static RetailStoreOrderShipment withId(String id){
	...
	public 	static RetailStoreOrderShipment refById(String id){
		return withId(id);
	}
	...
	public Object[] toFlatArray(){
		return new Object[]{getId(), getWho(), getShipTime(), getVersion()};
	}
