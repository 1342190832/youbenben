...
public class RetailStoreOrderApprovalManagerImpl extends CustomYoubenbenCheckerManager implements RetailStoreOrderApprovalManager, BusinessHandler{
	...
	@Override
	public RetailStoreOrderApprovalDAO daoOf(YoubenbenUserContext userContext) {
	...
	protected void throwExceptionWithMessage(String value) throws RetailStoreOrderApprovalManagerException{
 	...
 	protected RetailStoreOrderApproval saveRetailStoreOrderApproval(YoubenbenUserContext userContext, RetailStoreOrderApproval retailStoreOrderApproval, String [] tokensExpr) throws Exception{	
 	...
 	protected RetailStoreOrderApproval saveRetailStoreOrderApprovalDetail(YoubenbenUserContext userContext, RetailStoreOrderApproval retailStoreOrderApproval) throws Exception{	
 	...
 	public RetailStoreOrderApproval loadRetailStoreOrderApproval(YoubenbenUserContext userContext, String retailStoreOrderApprovalId, String [] tokensExpr) throws Exception{				
 	 ...
 	 public RetailStoreOrderApproval searchRetailStoreOrderApproval(YoubenbenUserContext userContext, String retailStoreOrderApprovalId, String textToSearch,String [] tokensExpr) throws Exception{				
 	...
 	protected RetailStoreOrderApproval present(YoubenbenUserContext userContext, RetailStoreOrderApproval retailStoreOrderApproval, Map<String, Object> tokens) throws Exception {
 	...
 	public RetailStoreOrderApproval loadRetailStoreOrderApprovalDetail(YoubenbenUserContext userContext, String retailStoreOrderApprovalId) throws Exception{	
 	...
 	public Object view(YoubenbenUserContext userContext, String retailStoreOrderApprovalId) throws Exception{	
 	...
 	protected RetailStoreOrderApproval saveRetailStoreOrderApproval(YoubenbenUserContext userContext, RetailStoreOrderApproval retailStoreOrderApproval, Map<String,Object>tokens) throws Exception{	
 		return retailStoreOrderApprovalDaoOf(userContext).save(retailStoreOrderApproval, tokens);
 	}
 	protected RetailStoreOrderApproval loadRetailStoreOrderApproval(YoubenbenUserContext userContext, String retailStoreOrderApprovalId, Map<String,Object>tokens) throws Exception{	
		checkerOf(userContext).checkIdOfRetailStoreOrderApproval(retailStoreOrderApprovalId);
		checkerOf(userContext).throwExceptionIfHasErrors( RetailStoreOrderApprovalManagerException.class);
 	...
 	protected<T extends BaseEntity> void addActions(YoubenbenUserContext userContext, RetailStoreOrderApproval retailStoreOrderApproval, Map<String, Object> tokens){
	...
	}// end method of protected<T extends BaseEntity> void addActions(YoubenbenUserContext userContext, RetailStoreOrderApproval retailStoreOrderApproval, Map<String, Object> tokens){
	...
	protected void checkParamsForUpdatingRetailStoreOrderApproval(YoubenbenUserContext userContext,String retailStoreOrderApprovalId, int retailStoreOrderApprovalVersion, String property, String newValueExpr,String [] tokensExpr)throws Exception
	{
	...
	public RetailStoreOrderApproval clone(YoubenbenUserContext userContext, String fromRetailStoreOrderApprovalId) throws Exception{
	...
	public RetailStoreOrderApproval internalSaveRetailStoreOrderApproval(YoubenbenUserContext userContext, RetailStoreOrderApproval retailStoreOrderApproval, Map<String,Object> options) throws Exception
	{
	...
	public RetailStoreOrderApproval updateRetailStoreOrderApprovalProperty(YoubenbenUserContext userContext,String retailStoreOrderApprovalId, int retailStoreOrderApprovalVersion, String property, String newValueExpr,String [] tokensExpr) throws Exception
	{
		checkParamsForUpdatingRetailStoreOrderApproval(userContext, retailStoreOrderApprovalId, retailStoreOrderApprovalVersion, property, newValueExpr, tokensExpr);
...
//--------------------------------------------------------------
	...
	public void delete(YoubenbenUserContext userContext, String retailStoreOrderApprovalId, int retailStoreOrderApprovalVersion) throws Exception {
	...
	public RetailStoreOrderApproval forgetByAll(YoubenbenUserContext userContext, String retailStoreOrderApprovalId, int retailStoreOrderApprovalVersion) throws Exception {
		return forgetByAllInternal(userContext, retailStoreOrderApprovalId, retailStoreOrderApprovalVersion);
	}
	protected RetailStoreOrderApproval forgetByAllInternal(YoubenbenUserContext userContext,
			String retailStoreOrderApprovalId, int retailStoreOrderApprovalVersion) throws Exception{
	...
	protected RetailStoreOrderApproval breakWithRetailStoreOrderByBuyer(YoubenbenUserContext userContext, String retailStoreOrderApprovalId, String buyerId,  String [] tokensExpr)
		 throws Exception{
	...
	protected RetailStoreOrderApproval breakWithRetailStoreOrderBySeller(YoubenbenUserContext userContext, String retailStoreOrderApprovalId, String sellerId,  String [] tokensExpr)
		 throws Exception{
	...
	protected RetailStoreOrderApproval breakWithRetailStoreOrderByConfirmation(YoubenbenUserContext userContext, String retailStoreOrderApprovalId, String confirmationId,  String [] tokensExpr)
		 throws Exception{
	...
	protected RetailStoreOrderApproval breakWithRetailStoreOrderByProcessing(YoubenbenUserContext userContext, String retailStoreOrderApprovalId, String processingId,  String [] tokensExpr)
		 throws Exception{
	...
	protected RetailStoreOrderApproval breakWithRetailStoreOrderByPicking(YoubenbenUserContext userContext, String retailStoreOrderApprovalId, String pickingId,  String [] tokensExpr)
		 throws Exception{
	...
	protected RetailStoreOrderApproval breakWithRetailStoreOrderByShipment(YoubenbenUserContext userContext, String retailStoreOrderApprovalId, String shipmentId,  String [] tokensExpr)
		 throws Exception{
	...
	protected RetailStoreOrderApproval breakWithRetailStoreOrderByDelivery(YoubenbenUserContext userContext, String retailStoreOrderApprovalId, String deliveryId,  String [] tokensExpr)
		 throws Exception{
	...
	protected void checkParamsForUpdatingRetailStoreOrderProperties(YoubenbenUserContext userContext, String retailStoreOrderApprovalId,String id,String title,BigDecimal totalAmount,String [] tokensExpr) throws Exception {
	...
	public  RetailStoreOrderApproval updateRetailStoreOrderProperties(YoubenbenUserContext userContext, String retailStoreOrderApprovalId, String id,String title,BigDecimal totalAmount, String [] tokensExpr) throws Exception
	{
	...
	protected RetailStoreOrder createRetailStoreOrder(YoubenbenUserContext userContext, String buyerId, String sellerId, String title, BigDecimal totalAmount, String confirmationId, String processingId, String pickingId, String shipmentId, String deliveryId) throws Exception{
	...
	protected void checkParamsForRemovingRetailStoreOrderList(YoubenbenUserContext userContext, String retailStoreOrderApprovalId,
	...
	public  RetailStoreOrderApproval removeRetailStoreOrderList(YoubenbenUserContext userContext, String retailStoreOrderApprovalId,
			String retailStoreOrderIds[],String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForRemovingRetailStoreOrder(YoubenbenUserContext userContext, String retailStoreOrderApprovalId,
	...
	public  RetailStoreOrderApproval removeRetailStoreOrder(YoubenbenUserContext userContext, String retailStoreOrderApprovalId,
		String retailStoreOrderId, int retailStoreOrderVersion,String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForCopyingRetailStoreOrder(YoubenbenUserContext userContext, String retailStoreOrderApprovalId,
		String retailStoreOrderId, int retailStoreOrderVersion,String [] tokensExpr) throws Exception{
	...
	public  RetailStoreOrderApproval copyRetailStoreOrderFrom(YoubenbenUserContext userContext, String retailStoreOrderApprovalId,
		String retailStoreOrderId, int retailStoreOrderVersion,String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForUpdatingRetailStoreOrder(YoubenbenUserContext userContext, String retailStoreOrderApprovalId, String retailStoreOrderId, int retailStoreOrderVersion, String property, String newValueExpr,String [] tokensExpr) throws Exception{
	...
	public  RetailStoreOrderApproval updateRetailStoreOrder(YoubenbenUserContext userContext, String retailStoreOrderApprovalId, String retailStoreOrderId, int retailStoreOrderVersion, String property, String newValueExpr,String [] tokensExpr)
			throws Exception{
	...
	*/
	...
	// -----------------------------------// list-of-view 处理 \\-----------------------------------
    protected void enhanceForListOfView(YoubenbenUserContext userContext,SmartList<RetailStoreOrderApproval> list) throws Exception {
  ...
  // -----------------------------------\\ list-of-view 处理 //-----------------------------------v
	 ...
	 * @throws Exception
	 */
 	public Object wxappview(YoubenbenUserContext userContext, String retailStoreOrderApprovalId) throws Exception{
	  SerializeScope vscope = YoubenbenViewScope.getInstance().getRetailStoreOrderApprovalDetailScope().clone();
