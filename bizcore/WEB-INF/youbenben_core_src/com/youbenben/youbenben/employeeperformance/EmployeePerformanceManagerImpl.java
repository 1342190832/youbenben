...
public class EmployeePerformanceManagerImpl extends CustomYoubenbenCheckerManager implements EmployeePerformanceManager, BusinessHandler{
	...
	@Override
	public EmployeePerformanceDAO daoOf(YoubenbenUserContext userContext) {
	...
	protected void throwExceptionWithMessage(String value) throws EmployeePerformanceManagerException{
 	...
 	protected EmployeePerformance saveEmployeePerformance(YoubenbenUserContext userContext, EmployeePerformance employeePerformance, String [] tokensExpr) throws Exception{	
 	...
 	protected EmployeePerformance saveEmployeePerformanceDetail(YoubenbenUserContext userContext, EmployeePerformance employeePerformance) throws Exception{	
 	...
 	public EmployeePerformance loadEmployeePerformance(YoubenbenUserContext userContext, String employeePerformanceId, String [] tokensExpr) throws Exception{				
 	 ...
 	 public EmployeePerformance searchEmployeePerformance(YoubenbenUserContext userContext, String employeePerformanceId, String textToSearch,String [] tokensExpr) throws Exception{				
 	...
 	protected EmployeePerformance present(YoubenbenUserContext userContext, EmployeePerformance employeePerformance, Map<String, Object> tokens) throws Exception {
 	...
 	public EmployeePerformance loadEmployeePerformanceDetail(YoubenbenUserContext userContext, String employeePerformanceId) throws Exception{	
 	...
 	public Object view(YoubenbenUserContext userContext, String employeePerformanceId) throws Exception{	
 		EmployeePerformance employeePerformance = loadEmployeePerformance( userContext, employeePerformanceId, viewTokens());
 		return present(userContext,employeePerformance, allTokens());
		
 	}
 	protected EmployeePerformance saveEmployeePerformance(YoubenbenUserContext userContext, EmployeePerformance employeePerformance, Map<String,Object>tokens) throws Exception{	
 		return employeePerformanceDaoOf(userContext).save(employeePerformance, tokens);
 	}
 	protected EmployeePerformance loadEmployeePerformance(YoubenbenUserContext userContext, String employeePerformanceId, Map<String,Object>tokens) throws Exception{	
		checkerOf(userContext).checkIdOfEmployeePerformance(employeePerformanceId);
		checkerOf(userContext).throwExceptionIfHasErrors( EmployeePerformanceManagerException.class);
 	...
 	protected<T extends BaseEntity> void addActions(YoubenbenUserContext userContext, EmployeePerformance employeePerformance, Map<String, Object> tokens){
	...
	}// end method of protected<T extends BaseEntity> void addActions(YoubenbenUserContext userContext, EmployeePerformance employeePerformance, Map<String, Object> tokens){
	...
	protected void checkParamsForUpdatingEmployeePerformance(YoubenbenUserContext userContext,String employeePerformanceId, int employeePerformanceVersion, String property, String newValueExpr,String [] tokensExpr)throws Exception
	{
	...
	public EmployeePerformance clone(YoubenbenUserContext userContext, String fromEmployeePerformanceId) throws Exception{
	...
	public EmployeePerformance internalSaveEmployeePerformance(YoubenbenUserContext userContext, EmployeePerformance employeePerformance, Map<String,Object> options) throws Exception
	{
	...
	public EmployeePerformance updateEmployeePerformanceProperty(YoubenbenUserContext userContext,String employeePerformanceId, int employeePerformanceVersion, String property, String newValueExpr,String [] tokensExpr) throws Exception
	{
		checkParamsForUpdatingEmployeePerformance(userContext, employeePerformanceId, employeePerformanceVersion, property, newValueExpr, tokensExpr);
	...
	protected void checkParamsForTransferingAnotherEmployee(YoubenbenUserContext userContext, String employeePerformanceId, String anotherEmployeeId) throws Exception
 	{
 ...
 //--------------------------------------------------------------
	...
	public void delete(YoubenbenUserContext userContext, String employeePerformanceId, int employeePerformanceVersion) throws Exception {
	...
	public EmployeePerformance forgetByAll(YoubenbenUserContext userContext, String employeePerformanceId, int employeePerformanceVersion) throws Exception {
		return forgetByAllInternal(userContext, employeePerformanceId, employeePerformanceVersion);
	}
	protected EmployeePerformance forgetByAllInternal(YoubenbenUserContext userContext,
			String employeePerformanceId, int employeePerformanceVersion) throws Exception{
	...
	// -----------------------------------// list-of-view 处理 \\-----------------------------------
    protected void enhanceForListOfView(YoubenbenUserContext userContext,SmartList<EmployeePerformance> list) throws Exception {
  ...
  // -----------------------------------\\ list-of-view 处理 //-----------------------------------v
	 ...
	 * @throws Exception
	 */
 	public Object wxappview(YoubenbenUserContext userContext, String employeePerformanceId) throws Exception{
	  SerializeScope vscope = YoubenbenViewScope.getInstance().getEmployeePerformanceDetailScope().clone();
