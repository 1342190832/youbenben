...
import com.youbenben.youbenben.cityevent.CandidateCityEvent;
...
public class EventAttendanceManagerImpl extends CustomYoubenbenCheckerManager implements EventAttendanceManager, BusinessHandler{
	...
	@Override
	public EventAttendanceDAO daoOf(YoubenbenUserContext userContext) {
	...
	protected void throwExceptionWithMessage(String value) throws EventAttendanceManagerException{
 	...
 	protected EventAttendance saveEventAttendance(YoubenbenUserContext userContext, EventAttendance eventAttendance, String [] tokensExpr) throws Exception{	
 	...
 	protected EventAttendance saveEventAttendanceDetail(YoubenbenUserContext userContext, EventAttendance eventAttendance) throws Exception{	
 	...
 	public EventAttendance loadEventAttendance(YoubenbenUserContext userContext, String eventAttendanceId, String [] tokensExpr) throws Exception{				
 	 ...
 	 public EventAttendance searchEventAttendance(YoubenbenUserContext userContext, String eventAttendanceId, String textToSearch,String [] tokensExpr) throws Exception{				
 	...
 	protected EventAttendance present(YoubenbenUserContext userContext, EventAttendance eventAttendance, Map<String, Object> tokens) throws Exception {
 	...
 	public EventAttendance loadEventAttendanceDetail(YoubenbenUserContext userContext, String eventAttendanceId) throws Exception{	
 	...
 	public Object view(YoubenbenUserContext userContext, String eventAttendanceId) throws Exception{	
 		EventAttendance eventAttendance = loadEventAttendance( userContext, eventAttendanceId, viewTokens());
 		return present(userContext,eventAttendance, allTokens());
		
 	}
 	protected EventAttendance saveEventAttendance(YoubenbenUserContext userContext, EventAttendance eventAttendance, Map<String,Object>tokens) throws Exception{	
 		return eventAttendanceDaoOf(userContext).save(eventAttendance, tokens);
 	}
 	protected EventAttendance loadEventAttendance(YoubenbenUserContext userContext, String eventAttendanceId, Map<String,Object>tokens) throws Exception{	
		checkerOf(userContext).checkIdOfEventAttendance(eventAttendanceId);
		checkerOf(userContext).throwExceptionIfHasErrors( EventAttendanceManagerException.class);
 	...
 	protected<T extends BaseEntity> void addActions(YoubenbenUserContext userContext, EventAttendance eventAttendance, Map<String, Object> tokens){
	...
	}// end method of protected<T extends BaseEntity> void addActions(YoubenbenUserContext userContext, EventAttendance eventAttendance, Map<String, Object> tokens){
	...
	protected void checkParamsForUpdatingEventAttendance(YoubenbenUserContext userContext,String eventAttendanceId, int eventAttendanceVersion, String property, String newValueExpr,String [] tokensExpr)throws Exception
	{
	...
	public EventAttendance clone(YoubenbenUserContext userContext, String fromEventAttendanceId) throws Exception{
	...
	public EventAttendance internalSaveEventAttendance(YoubenbenUserContext userContext, EventAttendance eventAttendance, Map<String,Object> options) throws Exception
	{
	...
	public EventAttendance updateEventAttendanceProperty(YoubenbenUserContext userContext,String eventAttendanceId, int eventAttendanceVersion, String property, String newValueExpr,String [] tokensExpr) throws Exception
	{
		checkParamsForUpdatingEventAttendance(userContext, eventAttendanceId, eventAttendanceVersion, property, newValueExpr, tokensExpr);
	...
	protected void checkParamsForTransferingAnotherPotentialCustomer(YoubenbenUserContext userContext, String eventAttendanceId, String anotherPotentialCustomerId) throws Exception
 	{
	...
	public CandidatePotentialCustomer requestCandidatePotentialCustomer(YoubenbenUserContext userContext, String ownerClass, String id, String filterKey, int pageNo) throws Exception {
 	...
 	protected void checkParamsForTransferingAnotherCityEvent(YoubenbenUserContext userContext, String eventAttendanceId, String anotherCityEventId) throws Exception
 	{
	...
	public CandidateCityEvent requestCandidateCityEvent(YoubenbenUserContext userContext, String ownerClass, String id, String filterKey, int pageNo) throws Exception {
 ...
 //--------------------------------------------------------------
 	...
 	protected CityEvent loadCityEvent(YoubenbenUserContext userContext, String newCityEventId, Map<String,Object> options) throws Exception
 	{
	...
	public void delete(YoubenbenUserContext userContext, String eventAttendanceId, int eventAttendanceVersion) throws Exception {
	...
	public EventAttendance forgetByAll(YoubenbenUserContext userContext, String eventAttendanceId, int eventAttendanceVersion) throws Exception {
		return forgetByAllInternal(userContext, eventAttendanceId, eventAttendanceVersion);
	}
	protected EventAttendance forgetByAllInternal(YoubenbenUserContext userContext,
			String eventAttendanceId, int eventAttendanceVersion) throws Exception{
	...
	// -----------------------------------// list-of-view 处理 \\-----------------------------------
    protected void enhanceForListOfView(YoubenbenUserContext userContext,SmartList<EventAttendance> list) throws Exception {
		...
		List<CityEvent> cityEventList = YoubenbenBaseUtils.collectReferencedObjectWithType(userContext, list, CityEvent.class);
  ...
  // -----------------------------------\\ list-of-view 处理 //-----------------------------------v
	 ...
	 * @throws Exception
	 */
 	public Object wxappview(YoubenbenUserContext userContext, String eventAttendanceId) throws Exception{
	  SerializeScope vscope = YoubenbenViewScope.getInstance().getEventAttendanceDetailScope().clone();
