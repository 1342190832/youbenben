...
public class MemberRewardPointRedemptionManagerImpl extends CustomYoubenbenCheckerManager implements MemberRewardPointRedemptionManager, BusinessHandler{
	...
	@Override
	public MemberRewardPointRedemptionDAO daoOf(YoubenbenUserContext userContext) {
	...
	protected void throwExceptionWithMessage(String value) throws MemberRewardPointRedemptionManagerException{
 	...
 	protected MemberRewardPointRedemption saveMemberRewardPointRedemption(YoubenbenUserContext userContext, MemberRewardPointRedemption memberRewardPointRedemption, String [] tokensExpr) throws Exception{	
 	...
 	protected MemberRewardPointRedemption saveMemberRewardPointRedemptionDetail(YoubenbenUserContext userContext, MemberRewardPointRedemption memberRewardPointRedemption) throws Exception{	
 	...
 	public MemberRewardPointRedemption loadMemberRewardPointRedemption(YoubenbenUserContext userContext, String memberRewardPointRedemptionId, String [] tokensExpr) throws Exception{				
 	 ...
 	 public MemberRewardPointRedemption searchMemberRewardPointRedemption(YoubenbenUserContext userContext, String memberRewardPointRedemptionId, String textToSearch,String [] tokensExpr) throws Exception{				
 	...
 	protected MemberRewardPointRedemption present(YoubenbenUserContext userContext, MemberRewardPointRedemption memberRewardPointRedemption, Map<String, Object> tokens) throws Exception {
 	...
 	public MemberRewardPointRedemption loadMemberRewardPointRedemptionDetail(YoubenbenUserContext userContext, String memberRewardPointRedemptionId) throws Exception{	
 	...
 	public Object view(YoubenbenUserContext userContext, String memberRewardPointRedemptionId) throws Exception{	
 	...
 	protected MemberRewardPointRedemption saveMemberRewardPointRedemption(YoubenbenUserContext userContext, MemberRewardPointRedemption memberRewardPointRedemption, Map<String,Object>tokens) throws Exception{	
 		return memberRewardPointRedemptionDaoOf(userContext).save(memberRewardPointRedemption, tokens);
 	}
 	protected MemberRewardPointRedemption loadMemberRewardPointRedemption(YoubenbenUserContext userContext, String memberRewardPointRedemptionId, Map<String,Object>tokens) throws Exception{	
		checkerOf(userContext).checkIdOfMemberRewardPointRedemption(memberRewardPointRedemptionId);
		checkerOf(userContext).throwExceptionIfHasErrors( MemberRewardPointRedemptionManagerException.class);
 	...
 	protected<T extends BaseEntity> void addActions(YoubenbenUserContext userContext, MemberRewardPointRedemption memberRewardPointRedemption, Map<String, Object> tokens){
	...
	}// end method of protected<T extends BaseEntity> void addActions(YoubenbenUserContext userContext, MemberRewardPointRedemption memberRewardPointRedemption, Map<String, Object> tokens){
	...
	protected void checkParamsForUpdatingMemberRewardPointRedemption(YoubenbenUserContext userContext,String memberRewardPointRedemptionId, int memberRewardPointRedemptionVersion, String property, String newValueExpr,String [] tokensExpr)throws Exception
	{
	...
	public MemberRewardPointRedemption clone(YoubenbenUserContext userContext, String fromMemberRewardPointRedemptionId) throws Exception{
	...
	public MemberRewardPointRedemption internalSaveMemberRewardPointRedemption(YoubenbenUserContext userContext, MemberRewardPointRedemption memberRewardPointRedemption, Map<String,Object> options) throws Exception
	{
	...
	public MemberRewardPointRedemption updateMemberRewardPointRedemptionProperty(YoubenbenUserContext userContext,String memberRewardPointRedemptionId, int memberRewardPointRedemptionVersion, String property, String newValueExpr,String [] tokensExpr) throws Exception
	{
		checkParamsForUpdatingMemberRewardPointRedemption(userContext, memberRewardPointRedemptionId, memberRewardPointRedemptionVersion, property, newValueExpr, tokensExpr);
	...
	protected void checkParamsForTransferingAnotherOwner(YoubenbenUserContext userContext, String memberRewardPointRedemptionId, String anotherOwnerId) throws Exception
 	{
 ...
 //--------------------------------------------------------------
	...
	public void delete(YoubenbenUserContext userContext, String memberRewardPointRedemptionId, int memberRewardPointRedemptionVersion) throws Exception {
	...
	public MemberRewardPointRedemption forgetByAll(YoubenbenUserContext userContext, String memberRewardPointRedemptionId, int memberRewardPointRedemptionVersion) throws Exception {
		return forgetByAllInternal(userContext, memberRewardPointRedemptionId, memberRewardPointRedemptionVersion);
	}
	protected MemberRewardPointRedemption forgetByAllInternal(YoubenbenUserContext userContext,
			String memberRewardPointRedemptionId, int memberRewardPointRedemptionVersion) throws Exception{
	...
	// -----------------------------------// list-of-view 处理 \\-----------------------------------
    protected void enhanceForListOfView(YoubenbenUserContext userContext,SmartList<MemberRewardPointRedemption> list) throws Exception {
  ...
  // -----------------------------------\\ list-of-view 处理 //-----------------------------------v
	 ...
	 * @throws Exception
	 */
 	public Object wxappview(YoubenbenUserContext userContext, String memberRewardPointRedemptionId) throws Exception{
	  SerializeScope vscope = YoubenbenViewScope.getInstance().getMemberRewardPointRedemptionDetailScope().clone();
