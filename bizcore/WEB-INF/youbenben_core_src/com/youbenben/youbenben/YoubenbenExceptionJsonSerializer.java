...
public class YoubenbenExceptionJsonSerializer extends  JsonSerializer<YoubenbenException> {
	...
	@Override
	public void serialize(YoubenbenException exception, JsonGenerator jgen,
	...
	protected void writeExceptionMessage(String message, YoubenbenException exception,
	...
	protected void writeStartObject(YoubenbenException exception, JsonGenerator jgen,SerializerProvider provider)throws IOException,JsonProcessingException{
		jgen.writeStartObject();
		writeClassField(CLASS,exception,jgen,provider);
	}
	
	private static final String MESSAGE_LIST = "messageList";
	protected void writeEndObject(YoubenbenException exception, JsonGenerator jgen,SerializerProvider provider)throws IOException,JsonProcessingException{
		
		writeMessageList(MESSAGE_LIST,exception,jgen,provider);
		jgen.writeEndObject();
	}
	protected void writeClassField(String fieldName,YoubenbenException exception,
	...
	protected void writeMessageList(String fieldName,YoubenbenException exception,
			JsonGenerator jgen, SerializerProvider provider)
			throws IOException, JsonProcessingException {
		if(exception == null){
			return; //do nothing when base entity is null
