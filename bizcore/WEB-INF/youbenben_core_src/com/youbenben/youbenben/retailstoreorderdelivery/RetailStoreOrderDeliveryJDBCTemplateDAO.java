...
public class RetailStoreOrderDeliveryJDBCTemplateDAO extends YoubenbenBaseDAOImpl implements RetailStoreOrderDeliveryDAO{
	...
	*/
	...
	public SmartList<RetailStoreOrderDelivery> loadAll() {
	    return this.loadAll(getRetailStoreOrderDeliveryMapper());
	}
    ...
    public SmartList<RetailStoreOrderDelivery> requestCandidateRetailStoreOrderDeliveryForRetailStoreOrder(YoubenbenUserContext userContext, String ownerClass, String id, String filterKey, int pageNo, int pageSize) throws Exception {
		...
		return findAllCandidateByFilter(RetailStoreOrderDeliveryTable.COLUMN_WHO, null, filterKey, pageNo, pageSize, getRetailStoreOrderDeliveryMapper());
    }
