...
public class RetailStoreOrderDeliveryManagerImpl extends CustomYoubenbenCheckerManager implements RetailStoreOrderDeliveryManager, BusinessHandler{
	...
	@Override
	public RetailStoreOrderDeliveryDAO daoOf(YoubenbenUserContext userContext) {
	...
	protected void throwExceptionWithMessage(String value) throws RetailStoreOrderDeliveryManagerException{
 	...
 	protected RetailStoreOrderDelivery saveRetailStoreOrderDelivery(YoubenbenUserContext userContext, RetailStoreOrderDelivery retailStoreOrderDelivery, String [] tokensExpr) throws Exception{	
 	...
 	protected RetailStoreOrderDelivery saveRetailStoreOrderDeliveryDetail(YoubenbenUserContext userContext, RetailStoreOrderDelivery retailStoreOrderDelivery) throws Exception{	
 	...
 	public RetailStoreOrderDelivery loadRetailStoreOrderDelivery(YoubenbenUserContext userContext, String retailStoreOrderDeliveryId, String [] tokensExpr) throws Exception{				
 	 ...
 	 public RetailStoreOrderDelivery searchRetailStoreOrderDelivery(YoubenbenUserContext userContext, String retailStoreOrderDeliveryId, String textToSearch,String [] tokensExpr) throws Exception{				
 	...
 	protected RetailStoreOrderDelivery present(YoubenbenUserContext userContext, RetailStoreOrderDelivery retailStoreOrderDelivery, Map<String, Object> tokens) throws Exception {
 	...
 	public RetailStoreOrderDelivery loadRetailStoreOrderDeliveryDetail(YoubenbenUserContext userContext, String retailStoreOrderDeliveryId) throws Exception{	
 	...
 	public Object view(YoubenbenUserContext userContext, String retailStoreOrderDeliveryId) throws Exception{	
 	...
 	protected RetailStoreOrderDelivery saveRetailStoreOrderDelivery(YoubenbenUserContext userContext, RetailStoreOrderDelivery retailStoreOrderDelivery, Map<String,Object>tokens) throws Exception{	
 		return retailStoreOrderDeliveryDaoOf(userContext).save(retailStoreOrderDelivery, tokens);
 	}
 	protected RetailStoreOrderDelivery loadRetailStoreOrderDelivery(YoubenbenUserContext userContext, String retailStoreOrderDeliveryId, Map<String,Object>tokens) throws Exception{	
		checkerOf(userContext).checkIdOfRetailStoreOrderDelivery(retailStoreOrderDeliveryId);
		checkerOf(userContext).throwExceptionIfHasErrors( RetailStoreOrderDeliveryManagerException.class);
 	...
 	protected<T extends BaseEntity> void addActions(YoubenbenUserContext userContext, RetailStoreOrderDelivery retailStoreOrderDelivery, Map<String, Object> tokens){
	...
	}// end method of protected<T extends BaseEntity> void addActions(YoubenbenUserContext userContext, RetailStoreOrderDelivery retailStoreOrderDelivery, Map<String, Object> tokens){
	...
	protected void checkParamsForUpdatingRetailStoreOrderDelivery(YoubenbenUserContext userContext,String retailStoreOrderDeliveryId, int retailStoreOrderDeliveryVersion, String property, String newValueExpr,String [] tokensExpr)throws Exception
	{
	...
	public RetailStoreOrderDelivery clone(YoubenbenUserContext userContext, String fromRetailStoreOrderDeliveryId) throws Exception{
	...
	public RetailStoreOrderDelivery internalSaveRetailStoreOrderDelivery(YoubenbenUserContext userContext, RetailStoreOrderDelivery retailStoreOrderDelivery, Map<String,Object> options) throws Exception
	{
	...
	public RetailStoreOrderDelivery updateRetailStoreOrderDeliveryProperty(YoubenbenUserContext userContext,String retailStoreOrderDeliveryId, int retailStoreOrderDeliveryVersion, String property, String newValueExpr,String [] tokensExpr) throws Exception
	{
		checkParamsForUpdatingRetailStoreOrderDelivery(userContext, retailStoreOrderDeliveryId, retailStoreOrderDeliveryVersion, property, newValueExpr, tokensExpr);
...
//--------------------------------------------------------------
	...
	public void delete(YoubenbenUserContext userContext, String retailStoreOrderDeliveryId, int retailStoreOrderDeliveryVersion) throws Exception {
	...
	public RetailStoreOrderDelivery forgetByAll(YoubenbenUserContext userContext, String retailStoreOrderDeliveryId, int retailStoreOrderDeliveryVersion) throws Exception {
		return forgetByAllInternal(userContext, retailStoreOrderDeliveryId, retailStoreOrderDeliveryVersion);
	}
	protected RetailStoreOrderDelivery forgetByAllInternal(YoubenbenUserContext userContext,
			String retailStoreOrderDeliveryId, int retailStoreOrderDeliveryVersion) throws Exception{
	...
	protected RetailStoreOrderDelivery breakWithRetailStoreOrderByBuyer(YoubenbenUserContext userContext, String retailStoreOrderDeliveryId, String buyerId,  String [] tokensExpr)
		 throws Exception{
	...
	protected RetailStoreOrderDelivery breakWithRetailStoreOrderBySeller(YoubenbenUserContext userContext, String retailStoreOrderDeliveryId, String sellerId,  String [] tokensExpr)
		 throws Exception{
	...
	protected RetailStoreOrderDelivery breakWithRetailStoreOrderByConfirmation(YoubenbenUserContext userContext, String retailStoreOrderDeliveryId, String confirmationId,  String [] tokensExpr)
		 throws Exception{
	...
	protected RetailStoreOrderDelivery breakWithRetailStoreOrderByApproval(YoubenbenUserContext userContext, String retailStoreOrderDeliveryId, String approvalId,  String [] tokensExpr)
		 throws Exception{
	...
	protected RetailStoreOrderDelivery breakWithRetailStoreOrderByProcessing(YoubenbenUserContext userContext, String retailStoreOrderDeliveryId, String processingId,  String [] tokensExpr)
		 throws Exception{
	...
	protected RetailStoreOrderDelivery breakWithRetailStoreOrderByPicking(YoubenbenUserContext userContext, String retailStoreOrderDeliveryId, String pickingId,  String [] tokensExpr)
		 throws Exception{
	...
	protected RetailStoreOrderDelivery breakWithRetailStoreOrderByShipment(YoubenbenUserContext userContext, String retailStoreOrderDeliveryId, String shipmentId,  String [] tokensExpr)
		 throws Exception{
	...
	protected void checkParamsForUpdatingRetailStoreOrderProperties(YoubenbenUserContext userContext, String retailStoreOrderDeliveryId,String id,String title,BigDecimal totalAmount,String [] tokensExpr) throws Exception {
	...
	public  RetailStoreOrderDelivery updateRetailStoreOrderProperties(YoubenbenUserContext userContext, String retailStoreOrderDeliveryId, String id,String title,BigDecimal totalAmount, String [] tokensExpr) throws Exception
	{
	...
	protected RetailStoreOrder createRetailStoreOrder(YoubenbenUserContext userContext, String buyerId, String sellerId, String title, BigDecimal totalAmount, String confirmationId, String approvalId, String processingId, String pickingId, String shipmentId) throws Exception{
	...
	protected void checkParamsForRemovingRetailStoreOrderList(YoubenbenUserContext userContext, String retailStoreOrderDeliveryId,
	...
	public  RetailStoreOrderDelivery removeRetailStoreOrderList(YoubenbenUserContext userContext, String retailStoreOrderDeliveryId,
			String retailStoreOrderIds[],String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForRemovingRetailStoreOrder(YoubenbenUserContext userContext, String retailStoreOrderDeliveryId,
	...
	public  RetailStoreOrderDelivery removeRetailStoreOrder(YoubenbenUserContext userContext, String retailStoreOrderDeliveryId,
		String retailStoreOrderId, int retailStoreOrderVersion,String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForCopyingRetailStoreOrder(YoubenbenUserContext userContext, String retailStoreOrderDeliveryId,
		String retailStoreOrderId, int retailStoreOrderVersion,String [] tokensExpr) throws Exception{
	...
	public  RetailStoreOrderDelivery copyRetailStoreOrderFrom(YoubenbenUserContext userContext, String retailStoreOrderDeliveryId,
		String retailStoreOrderId, int retailStoreOrderVersion,String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForUpdatingRetailStoreOrder(YoubenbenUserContext userContext, String retailStoreOrderDeliveryId, String retailStoreOrderId, int retailStoreOrderVersion, String property, String newValueExpr,String [] tokensExpr) throws Exception{
	...
	public  RetailStoreOrderDelivery updateRetailStoreOrder(YoubenbenUserContext userContext, String retailStoreOrderDeliveryId, String retailStoreOrderId, int retailStoreOrderVersion, String property, String newValueExpr,String [] tokensExpr)
			throws Exception{
	...
	*/
	...
	// -----------------------------------// list-of-view 处理 \\-----------------------------------
    protected void enhanceForListOfView(YoubenbenUserContext userContext,SmartList<RetailStoreOrderDelivery> list) throws Exception {
  ...
  // -----------------------------------\\ list-of-view 处理 //-----------------------------------v
	 ...
	 * @throws Exception
	 */
 	public Object wxappview(YoubenbenUserContext userContext, String retailStoreOrderDeliveryId) throws Exception{
	  SerializeScope vscope = YoubenbenViewScope.getInstance().getRetailStoreOrderDeliveryDetailScope().clone();
