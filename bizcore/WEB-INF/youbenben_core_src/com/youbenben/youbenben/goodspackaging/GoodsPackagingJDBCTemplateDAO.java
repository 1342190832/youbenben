...
public class GoodsPackagingJDBCTemplateDAO extends YoubenbenBaseDAOImpl implements GoodsPackagingDAO{
	...
	*/
    ...
    public SmartList<GoodsPackaging> requestCandidateGoodsPackagingForGoods(YoubenbenUserContext userContext, String ownerClass, String id, String filterKey, int pageNo, int pageSize) throws Exception {
        // NOTE: by default, ignore owner info, just return all by filter key.
		// You need override this method if you have different candidate-logic
		return findAllCandidateByFilter(GoodsPackagingTable.COLUMN_PACKAGE_NAME, null, filterKey, pageNo, pageSize, getGoodsPackagingMapper());
    }
	...
	public SmartList<Goods> loadOurGoodsList(YoubenbenUserContext userContext, List<GoodsPackaging> us, Map<String,Object> options) throws Exception{
	...
	@Override
	public CandidateGoodsPackaging executeCandidatesQuery(CandidateQuery query, String sql, Object ... parmeters) throws Exception {
