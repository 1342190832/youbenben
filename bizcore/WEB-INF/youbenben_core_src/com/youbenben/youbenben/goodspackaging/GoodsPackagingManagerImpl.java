...
public class GoodsPackagingManagerImpl extends CustomYoubenbenCheckerManager implements GoodsPackagingManager, BusinessHandler{
	...
	@Override
	public GoodsPackagingDAO daoOf(YoubenbenUserContext userContext) {
	...
	protected void throwExceptionWithMessage(String value) throws GoodsPackagingManagerException{
 	...
 	protected GoodsPackaging saveGoodsPackaging(YoubenbenUserContext userContext, GoodsPackaging goodsPackaging, String [] tokensExpr) throws Exception{	
 	...
 	protected GoodsPackaging saveGoodsPackagingDetail(YoubenbenUserContext userContext, GoodsPackaging goodsPackaging) throws Exception{	
 	...
 	public GoodsPackaging loadGoodsPackaging(YoubenbenUserContext userContext, String goodsPackagingId, String [] tokensExpr) throws Exception{				
 	 ...
 	 public GoodsPackaging searchGoodsPackaging(YoubenbenUserContext userContext, String goodsPackagingId, String textToSearch,String [] tokensExpr) throws Exception{				
 	...
 	protected GoodsPackaging present(YoubenbenUserContext userContext, GoodsPackaging goodsPackaging, Map<String, Object> tokens) throws Exception {
 	...
 	public GoodsPackaging loadGoodsPackagingDetail(YoubenbenUserContext userContext, String goodsPackagingId) throws Exception{	
 	...
 	public Object view(YoubenbenUserContext userContext, String goodsPackagingId) throws Exception{	
 		GoodsPackaging goodsPackaging = loadGoodsPackaging( userContext, goodsPackagingId, viewTokens());
 		return present(userContext,goodsPackaging, allTokens());
		
 	}
 	protected GoodsPackaging saveGoodsPackaging(YoubenbenUserContext userContext, GoodsPackaging goodsPackaging, Map<String,Object>tokens) throws Exception{	
 		return goodsPackagingDaoOf(userContext).save(goodsPackaging, tokens);
 	}
 	protected GoodsPackaging loadGoodsPackaging(YoubenbenUserContext userContext, String goodsPackagingId, Map<String,Object>tokens) throws Exception{	
		checkerOf(userContext).checkIdOfGoodsPackaging(goodsPackagingId);
		checkerOf(userContext).throwExceptionIfHasErrors( GoodsPackagingManagerException.class);
 	...
 	protected<T extends BaseEntity> void addActions(YoubenbenUserContext userContext, GoodsPackaging goodsPackaging, Map<String, Object> tokens){
	...
	}// end method of protected<T extends BaseEntity> void addActions(YoubenbenUserContext userContext, GoodsPackaging goodsPackaging, Map<String, Object> tokens){
	...
	protected void checkParamsForUpdatingGoodsPackaging(YoubenbenUserContext userContext,String goodsPackagingId, int goodsPackagingVersion, String property, String newValueExpr,String [] tokensExpr)throws Exception
	{
	...
	public GoodsPackaging clone(YoubenbenUserContext userContext, String fromGoodsPackagingId) throws Exception{
	...
	public GoodsPackaging internalSaveGoodsPackaging(YoubenbenUserContext userContext, GoodsPackaging goodsPackaging, Map<String,Object> options) throws Exception
	{
	...
	public GoodsPackaging updateGoodsPackagingProperty(YoubenbenUserContext userContext,String goodsPackagingId, int goodsPackagingVersion, String property, String newValueExpr,String [] tokensExpr) throws Exception
	{
		checkParamsForUpdatingGoodsPackaging(userContext, goodsPackagingId, goodsPackagingVersion, property, newValueExpr, tokensExpr);
...
//--------------------------------------------------------------
	...
	public void delete(YoubenbenUserContext userContext, String goodsPackagingId, int goodsPackagingVersion) throws Exception {
	...
	public GoodsPackaging forgetByAll(YoubenbenUserContext userContext, String goodsPackagingId, int goodsPackagingVersion) throws Exception {
		return forgetByAllInternal(userContext, goodsPackagingId, goodsPackagingVersion);
	}
	protected GoodsPackaging forgetByAllInternal(YoubenbenUserContext userContext,
			String goodsPackagingId, int goodsPackagingVersion) throws Exception{
	...
	protected GoodsPackaging breakWithGoodsBySku(YoubenbenUserContext userContext, String goodsPackagingId, String skuId,  String [] tokensExpr)
		 throws Exception{
	...
	protected GoodsPackaging breakWithGoodsByReceivingSpace(YoubenbenUserContext userContext, String goodsPackagingId, String receivingSpaceId,  String [] tokensExpr)
		 throws Exception{
	...
	protected GoodsPackaging breakWithGoodsByGoodsAllocation(YoubenbenUserContext userContext, String goodsPackagingId, String goodsAllocationId,  String [] tokensExpr)
		 throws Exception{
	...
	protected GoodsPackaging breakWithGoodsBySmartPallet(YoubenbenUserContext userContext, String goodsPackagingId, String smartPalletId,  String [] tokensExpr)
		 throws Exception{
	...
	protected GoodsPackaging breakWithGoodsByShippingSpace(YoubenbenUserContext userContext, String goodsPackagingId, String shippingSpaceId,  String [] tokensExpr)
		 throws Exception{
	...
	protected GoodsPackaging breakWithGoodsByTransportTask(YoubenbenUserContext userContext, String goodsPackagingId, String transportTaskId,  String [] tokensExpr)
		 throws Exception{
	...
	protected GoodsPackaging breakWithGoodsByRetailStore(YoubenbenUserContext userContext, String goodsPackagingId, String retailStoreId,  String [] tokensExpr)
		 throws Exception{
	...
	protected GoodsPackaging breakWithGoodsByBizOrder(YoubenbenUserContext userContext, String goodsPackagingId, String bizOrderId,  String [] tokensExpr)
		 throws Exception{
	...
	protected GoodsPackaging breakWithGoodsByRetailStoreOrder(YoubenbenUserContext userContext, String goodsPackagingId, String retailStoreOrderId,  String [] tokensExpr)
		 throws Exception{
	...
	protected void checkParamsForAddingGoods(YoubenbenUserContext userContext, String goodsPackagingId, String name, String rfid, String uom, int maxPackage, Date expireTime, String skuId, String receivingSpaceId, String goodsAllocationId, String smartPalletId, String shippingSpaceId, String transportTaskId, String retailStoreId, String bizOrderId, String retailStoreOrderId,String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForUpdatingGoodsProperties(YoubenbenUserContext userContext, String goodsPackagingId,String id,String name,String rfid,String uom,int maxPackage,Date expireTime,String [] tokensExpr) throws Exception {
	...
	public  GoodsPackaging updateGoodsProperties(YoubenbenUserContext userContext, String goodsPackagingId, String id,String name,String rfid,String uom,int maxPackage,Date expireTime, String [] tokensExpr) throws Exception
	{
	...
	protected void checkParamsForRemovingGoodsList(YoubenbenUserContext userContext, String goodsPackagingId,
	...
	public  GoodsPackaging removeGoodsList(YoubenbenUserContext userContext, String goodsPackagingId,
			String goodsIds[],String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForRemovingGoods(YoubenbenUserContext userContext, String goodsPackagingId,
	...
	public  GoodsPackaging removeGoods(YoubenbenUserContext userContext, String goodsPackagingId,
		String goodsId, int goodsVersion,String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForCopyingGoods(YoubenbenUserContext userContext, String goodsPackagingId,
		String goodsId, int goodsVersion,String [] tokensExpr) throws Exception{
	...
	public  GoodsPackaging copyGoodsFrom(YoubenbenUserContext userContext, String goodsPackagingId,
		String goodsId, int goodsVersion,String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForUpdatingGoods(YoubenbenUserContext userContext, String goodsPackagingId, String goodsId, int goodsVersion, String property, String newValueExpr,String [] tokensExpr) throws Exception{
	...
	public  GoodsPackaging updateGoods(YoubenbenUserContext userContext, String goodsPackagingId, String goodsId, int goodsVersion, String property, String newValueExpr,String [] tokensExpr)
			throws Exception{
	...
	*/
	...
	// -----------------------------------// list-of-view 处理 \\-----------------------------------
    protected void enhanceForListOfView(YoubenbenUserContext userContext,SmartList<GoodsPackaging> list) throws Exception {
  ...
  // -----------------------------------\\ list-of-view 处理 //-----------------------------------v
	 ...
	 * @throws Exception
	 */
 	public Object wxappview(YoubenbenUserContext userContext, String goodsPackagingId) throws Exception{
	  SerializeScope vscope = YoubenbenViewScope.getInstance().getGoodsPackagingDetailScope().clone();
