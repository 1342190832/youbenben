...
public class TerminationReasonManagerImpl extends CustomYoubenbenCheckerManager implements TerminationReasonManager, BusinessHandler{
	...
	@Override
	public TerminationReasonDAO daoOf(YoubenbenUserContext userContext) {
	...
	protected void throwExceptionWithMessage(String value) throws TerminationReasonManagerException{
 	...
 	protected TerminationReason saveTerminationReason(YoubenbenUserContext userContext, TerminationReason terminationReason, String [] tokensExpr) throws Exception{	
 	...
 	protected TerminationReason saveTerminationReasonDetail(YoubenbenUserContext userContext, TerminationReason terminationReason) throws Exception{	
 	...
 	public TerminationReason loadTerminationReason(YoubenbenUserContext userContext, String terminationReasonId, String [] tokensExpr) throws Exception{				
 	 ...
 	 public TerminationReason searchTerminationReason(YoubenbenUserContext userContext, String terminationReasonId, String textToSearch,String [] tokensExpr) throws Exception{				
 	...
 	protected TerminationReason present(YoubenbenUserContext userContext, TerminationReason terminationReason, Map<String, Object> tokens) throws Exception {
 	...
 	public TerminationReason loadTerminationReasonDetail(YoubenbenUserContext userContext, String terminationReasonId) throws Exception{	
 	...
 	public Object view(YoubenbenUserContext userContext, String terminationReasonId) throws Exception{	
 		TerminationReason terminationReason = loadTerminationReason( userContext, terminationReasonId, viewTokens());
 		return present(userContext,terminationReason, allTokens());
		
 	}
 	protected TerminationReason saveTerminationReason(YoubenbenUserContext userContext, TerminationReason terminationReason, Map<String,Object>tokens) throws Exception{	
 		return terminationReasonDaoOf(userContext).save(terminationReason, tokens);
 	}
 	protected TerminationReason loadTerminationReason(YoubenbenUserContext userContext, String terminationReasonId, Map<String,Object>tokens) throws Exception{	
		checkerOf(userContext).checkIdOfTerminationReason(terminationReasonId);
		checkerOf(userContext).throwExceptionIfHasErrors( TerminationReasonManagerException.class);
 	...
 	protected<T extends BaseEntity> void addActions(YoubenbenUserContext userContext, TerminationReason terminationReason, Map<String, Object> tokens){
	...
	}// end method of protected<T extends BaseEntity> void addActions(YoubenbenUserContext userContext, TerminationReason terminationReason, Map<String, Object> tokens){
	...
	protected void checkParamsForUpdatingTerminationReason(YoubenbenUserContext userContext,String terminationReasonId, int terminationReasonVersion, String property, String newValueExpr,String [] tokensExpr)throws Exception
	{
	...
	public TerminationReason clone(YoubenbenUserContext userContext, String fromTerminationReasonId) throws Exception{
	...
	public TerminationReason internalSaveTerminationReason(YoubenbenUserContext userContext, TerminationReason terminationReason, Map<String,Object> options) throws Exception
	{
	...
	public TerminationReason updateTerminationReasonProperty(YoubenbenUserContext userContext,String terminationReasonId, int terminationReasonVersion, String property, String newValueExpr,String [] tokensExpr) throws Exception
	{
		checkParamsForUpdatingTerminationReason(userContext, terminationReasonId, terminationReasonVersion, property, newValueExpr, tokensExpr);
	...
	protected void checkParamsForTransferingAnotherCompany(YoubenbenUserContext userContext, String terminationReasonId, String anotherCompanyId) throws Exception
 	{
 ...
 //--------------------------------------------------------------
	...
	public void delete(YoubenbenUserContext userContext, String terminationReasonId, int terminationReasonVersion) throws Exception {
	...
	public TerminationReason forgetByAll(YoubenbenUserContext userContext, String terminationReasonId, int terminationReasonVersion) throws Exception {
		return forgetByAllInternal(userContext, terminationReasonId, terminationReasonVersion);
	}
	protected TerminationReason forgetByAllInternal(YoubenbenUserContext userContext,
			String terminationReasonId, int terminationReasonVersion) throws Exception{
	...
	protected TerminationReason breakWithTerminationByType(YoubenbenUserContext userContext, String terminationReasonId, String typeId,  String [] tokensExpr)
		 throws Exception{
	...
	protected void checkParamsForAddingTermination(YoubenbenUserContext userContext, String terminationReasonId, String typeId, String comment,String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForUpdatingTerminationProperties(YoubenbenUserContext userContext, String terminationReasonId,String id,String comment,String [] tokensExpr) throws Exception {
	...
	public  TerminationReason updateTerminationProperties(YoubenbenUserContext userContext, String terminationReasonId, String id,String comment, String [] tokensExpr) throws Exception
	{
	...
	protected Termination createTermination(YoubenbenUserContext userContext, String typeId, String comment) throws Exception{
	...
	protected void checkParamsForRemovingTerminationList(YoubenbenUserContext userContext, String terminationReasonId,
	...
	public  TerminationReason removeTerminationList(YoubenbenUserContext userContext, String terminationReasonId,
			String terminationIds[],String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForRemovingTermination(YoubenbenUserContext userContext, String terminationReasonId,
	...
	public  TerminationReason removeTermination(YoubenbenUserContext userContext, String terminationReasonId,
		String terminationId, int terminationVersion,String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForCopyingTermination(YoubenbenUserContext userContext, String terminationReasonId,
		String terminationId, int terminationVersion,String [] tokensExpr) throws Exception{
	...
	public  TerminationReason copyTerminationFrom(YoubenbenUserContext userContext, String terminationReasonId,
		String terminationId, int terminationVersion,String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForUpdatingTermination(YoubenbenUserContext userContext, String terminationReasonId, String terminationId, int terminationVersion, String property, String newValueExpr,String [] tokensExpr) throws Exception{
	...
	public  TerminationReason updateTermination(YoubenbenUserContext userContext, String terminationReasonId, String terminationId, int terminationVersion, String property, String newValueExpr,String [] tokensExpr)
			throws Exception{
	...
	*/
	...
	// -----------------------------------// list-of-view 处理 \\-----------------------------------
    protected void enhanceForListOfView(YoubenbenUserContext userContext,SmartList<TerminationReason> list) throws Exception {
  ...
  // -----------------------------------\\ list-of-view 处理 //-----------------------------------v
	 ...
	 * @throws Exception
	 */
 	public Object wxappview(YoubenbenUserContext userContext, String terminationReasonId) throws Exception{
	  SerializeScope vscope = YoubenbenViewScope.getInstance().getTerminationReasonDetailScope().clone();
    ...
    String pageTitle = "雇佣终止的原因"+"详情";
		...
		vscope.field("terminationListSection", YoubenbenListOfViewScope.getInstance()
