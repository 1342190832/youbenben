...
public class SmartPalletManagerImpl extends CustomYoubenbenCheckerManager implements SmartPalletManager, BusinessHandler{
	...
	@Override
	public SmartPalletDAO daoOf(YoubenbenUserContext userContext) {
	...
	protected void throwExceptionWithMessage(String value) throws SmartPalletManagerException{
 	...
 	protected SmartPallet saveSmartPallet(YoubenbenUserContext userContext, SmartPallet smartPallet, String [] tokensExpr) throws Exception{	
 	...
 	protected SmartPallet saveSmartPalletDetail(YoubenbenUserContext userContext, SmartPallet smartPallet) throws Exception{	
 	...
 	public SmartPallet loadSmartPallet(YoubenbenUserContext userContext, String smartPalletId, String [] tokensExpr) throws Exception{				
 	 ...
 	 public SmartPallet searchSmartPallet(YoubenbenUserContext userContext, String smartPalletId, String textToSearch,String [] tokensExpr) throws Exception{				
 	...
 	protected SmartPallet present(YoubenbenUserContext userContext, SmartPallet smartPallet, Map<String, Object> tokens) throws Exception {
 	...
 	public SmartPallet loadSmartPalletDetail(YoubenbenUserContext userContext, String smartPalletId) throws Exception{	
 	...
 	public Object view(YoubenbenUserContext userContext, String smartPalletId) throws Exception{	
 		SmartPallet smartPallet = loadSmartPallet( userContext, smartPalletId, viewTokens());
 		return present(userContext,smartPallet, allTokens());
		
 	}
 	protected SmartPallet saveSmartPallet(YoubenbenUserContext userContext, SmartPallet smartPallet, Map<String,Object>tokens) throws Exception{	
 		return smartPalletDaoOf(userContext).save(smartPallet, tokens);
 	}
 	protected SmartPallet loadSmartPallet(YoubenbenUserContext userContext, String smartPalletId, Map<String,Object>tokens) throws Exception{	
		checkerOf(userContext).checkIdOfSmartPallet(smartPalletId);
		checkerOf(userContext).throwExceptionIfHasErrors( SmartPalletManagerException.class);
 	...
 	protected<T extends BaseEntity> void addActions(YoubenbenUserContext userContext, SmartPallet smartPallet, Map<String, Object> tokens){
	...
	}// end method of protected<T extends BaseEntity> void addActions(YoubenbenUserContext userContext, SmartPallet smartPallet, Map<String, Object> tokens){
	...
	protected void checkParamsForUpdatingSmartPallet(YoubenbenUserContext userContext,String smartPalletId, int smartPalletVersion, String property, String newValueExpr,String [] tokensExpr)throws Exception
	{
	...
	public SmartPallet clone(YoubenbenUserContext userContext, String fromSmartPalletId) throws Exception{
	...
	public SmartPallet internalSaveSmartPallet(YoubenbenUserContext userContext, SmartPallet smartPallet, Map<String,Object> options) throws Exception
	{
	...
	public SmartPallet updateSmartPalletProperty(YoubenbenUserContext userContext,String smartPalletId, int smartPalletVersion, String property, String newValueExpr,String [] tokensExpr) throws Exception
	{
		checkParamsForUpdatingSmartPallet(userContext, smartPalletId, smartPalletVersion, property, newValueExpr, tokensExpr);
	...
	protected void checkParamsForTransferingAnotherWarehouse(YoubenbenUserContext userContext, String smartPalletId, String anotherWarehouseId) throws Exception
 	{
 ...
 //--------------------------------------------------------------
	...
	public void delete(YoubenbenUserContext userContext, String smartPalletId, int smartPalletVersion) throws Exception {
	...
	public SmartPallet forgetByAll(YoubenbenUserContext userContext, String smartPalletId, int smartPalletVersion) throws Exception {
		return forgetByAllInternal(userContext, smartPalletId, smartPalletVersion);
	}
	protected SmartPallet forgetByAllInternal(YoubenbenUserContext userContext,
			String smartPalletId, int smartPalletVersion) throws Exception{
	...
	protected SmartPallet breakWithGoodsBySku(YoubenbenUserContext userContext, String smartPalletId, String skuId,  String [] tokensExpr)
		 throws Exception{
	...
	protected SmartPallet breakWithGoodsByReceivingSpace(YoubenbenUserContext userContext, String smartPalletId, String receivingSpaceId,  String [] tokensExpr)
		 throws Exception{
	...
	protected SmartPallet breakWithGoodsByGoodsAllocation(YoubenbenUserContext userContext, String smartPalletId, String goodsAllocationId,  String [] tokensExpr)
		 throws Exception{
	...
	protected SmartPallet breakWithGoodsByShippingSpace(YoubenbenUserContext userContext, String smartPalletId, String shippingSpaceId,  String [] tokensExpr)
		 throws Exception{
	...
	protected SmartPallet breakWithGoodsByTransportTask(YoubenbenUserContext userContext, String smartPalletId, String transportTaskId,  String [] tokensExpr)
		 throws Exception{
	...
	protected SmartPallet breakWithGoodsByRetailStore(YoubenbenUserContext userContext, String smartPalletId, String retailStoreId,  String [] tokensExpr)
		 throws Exception{
	...
	protected SmartPallet breakWithGoodsByBizOrder(YoubenbenUserContext userContext, String smartPalletId, String bizOrderId,  String [] tokensExpr)
		 throws Exception{
	...
	protected SmartPallet breakWithGoodsByRetailStoreOrder(YoubenbenUserContext userContext, String smartPalletId, String retailStoreOrderId,  String [] tokensExpr)
		 throws Exception{
	...
	protected SmartPallet breakWithGoodsByPackaging(YoubenbenUserContext userContext, String smartPalletId, String packagingId,  String [] tokensExpr)
		 throws Exception{
	...
	protected void checkParamsForUpdatingGoodsProperties(YoubenbenUserContext userContext, String smartPalletId,String id,String name,String rfid,String uom,int maxPackage,Date expireTime,String [] tokensExpr) throws Exception {
	...
	public  SmartPallet updateGoodsProperties(YoubenbenUserContext userContext, String smartPalletId, String id,String name,String rfid,String uom,int maxPackage,Date expireTime, String [] tokensExpr) throws Exception
	{
	...
	protected Goods createGoods(YoubenbenUserContext userContext, String name, String rfid, String uom, int maxPackage, Date expireTime, String skuId, String receivingSpaceId, String goodsAllocationId, String shippingSpaceId, String transportTaskId, String retailStoreId, String bizOrderId, String retailStoreOrderId, String packagingId) throws Exception{
	...
	protected void checkParamsForRemovingGoodsList(YoubenbenUserContext userContext, String smartPalletId,
	...
	public  SmartPallet removeGoodsList(YoubenbenUserContext userContext, String smartPalletId,
			String goodsIds[],String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForRemovingGoods(YoubenbenUserContext userContext, String smartPalletId,
	...
	public  SmartPallet removeGoods(YoubenbenUserContext userContext, String smartPalletId,
		String goodsId, int goodsVersion,String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForCopyingGoods(YoubenbenUserContext userContext, String smartPalletId,
		String goodsId, int goodsVersion,String [] tokensExpr) throws Exception{
	...
	public  SmartPallet copyGoodsFrom(YoubenbenUserContext userContext, String smartPalletId,
		String goodsId, int goodsVersion,String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForUpdatingGoods(YoubenbenUserContext userContext, String smartPalletId, String goodsId, int goodsVersion, String property, String newValueExpr,String [] tokensExpr) throws Exception{
	...
	public  SmartPallet updateGoods(YoubenbenUserContext userContext, String smartPalletId, String goodsId, int goodsVersion, String property, String newValueExpr,String [] tokensExpr)
			throws Exception{
	...
	*/
	...
	// -----------------------------------// list-of-view 处理 \\-----------------------------------
    protected void enhanceForListOfView(YoubenbenUserContext userContext,SmartList<SmartPallet> list) throws Exception {
  ...
  // -----------------------------------\\ list-of-view 处理 //-----------------------------------v
	 ...
	 * @throws Exception
	 */
 	public Object wxappview(YoubenbenUserContext userContext, String smartPalletId) throws Exception{
	  SerializeScope vscope = YoubenbenViewScope.getInstance().getSmartPalletDetailScope().clone();
