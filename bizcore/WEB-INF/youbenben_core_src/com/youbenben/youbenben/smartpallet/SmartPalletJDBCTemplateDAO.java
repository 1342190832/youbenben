...
public class SmartPalletJDBCTemplateDAO extends YoubenbenBaseDAOImpl implements SmartPalletDAO{
	...
	*/
    ...
    public SmartList<SmartPallet> requestCandidateSmartPalletForGoods(YoubenbenUserContext userContext, String ownerClass, String id, String filterKey, int pageNo, int pageSize) throws Exception {
	...
	public SmartList<Goods> loadOurGoodsList(YoubenbenUserContext userContext, List<SmartPallet> us, Map<String,Object> options) throws Exception{
