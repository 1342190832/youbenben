...
public class SalaryGradeManagerImpl extends CustomYoubenbenCheckerManager implements SalaryGradeManager, BusinessHandler{
	...
	@Override
	public SalaryGradeDAO daoOf(YoubenbenUserContext userContext) {
	...
	protected void throwExceptionWithMessage(String value) throws SalaryGradeManagerException{
 	...
 	protected SalaryGrade saveSalaryGrade(YoubenbenUserContext userContext, SalaryGrade salaryGrade, String [] tokensExpr) throws Exception{	
 	...
 	protected SalaryGrade saveSalaryGradeDetail(YoubenbenUserContext userContext, SalaryGrade salaryGrade) throws Exception{	
 	...
 	public SalaryGrade loadSalaryGrade(YoubenbenUserContext userContext, String salaryGradeId, String [] tokensExpr) throws Exception{				
 	 ...
 	 public SalaryGrade searchSalaryGrade(YoubenbenUserContext userContext, String salaryGradeId, String textToSearch,String [] tokensExpr) throws Exception{				
 	...
 	protected SalaryGrade present(YoubenbenUserContext userContext, SalaryGrade salaryGrade, Map<String, Object> tokens) throws Exception {
 	...
 	public SalaryGrade loadSalaryGradeDetail(YoubenbenUserContext userContext, String salaryGradeId) throws Exception{	
 	...
 	public Object view(YoubenbenUserContext userContext, String salaryGradeId) throws Exception{	
 		SalaryGrade salaryGrade = loadSalaryGrade( userContext, salaryGradeId, viewTokens());
 		return present(userContext,salaryGrade, allTokens());
		
 	}
 	protected SalaryGrade saveSalaryGrade(YoubenbenUserContext userContext, SalaryGrade salaryGrade, Map<String,Object>tokens) throws Exception{	
 		return salaryGradeDaoOf(userContext).save(salaryGrade, tokens);
 	}
 	protected SalaryGrade loadSalaryGrade(YoubenbenUserContext userContext, String salaryGradeId, Map<String,Object>tokens) throws Exception{	
		checkerOf(userContext).checkIdOfSalaryGrade(salaryGradeId);
		checkerOf(userContext).throwExceptionIfHasErrors( SalaryGradeManagerException.class);
 	...
 	protected<T extends BaseEntity> void addActions(YoubenbenUserContext userContext, SalaryGrade salaryGrade, Map<String, Object> tokens){
	...
	}// end method of protected<T extends BaseEntity> void addActions(YoubenbenUserContext userContext, SalaryGrade salaryGrade, Map<String, Object> tokens){
	...
	protected void checkParamsForUpdatingSalaryGrade(YoubenbenUserContext userContext,String salaryGradeId, int salaryGradeVersion, String property, String newValueExpr,String [] tokensExpr)throws Exception
	{
	...
	public SalaryGrade clone(YoubenbenUserContext userContext, String fromSalaryGradeId) throws Exception{
	...
	public SalaryGrade internalSaveSalaryGrade(YoubenbenUserContext userContext, SalaryGrade salaryGrade, Map<String,Object> options) throws Exception
	{
	...
	public SalaryGrade updateSalaryGradeProperty(YoubenbenUserContext userContext,String salaryGradeId, int salaryGradeVersion, String property, String newValueExpr,String [] tokensExpr) throws Exception
	{
		checkParamsForUpdatingSalaryGrade(userContext, salaryGradeId, salaryGradeVersion, property, newValueExpr, tokensExpr);
	...
	protected void checkParamsForTransferingAnotherCompany(YoubenbenUserContext userContext, String salaryGradeId, String anotherCompanyId) throws Exception
 	{
 ...
 //--------------------------------------------------------------
	...
	public void delete(YoubenbenUserContext userContext, String salaryGradeId, int salaryGradeVersion) throws Exception {
	...
	public SalaryGrade forgetByAll(YoubenbenUserContext userContext, String salaryGradeId, int salaryGradeVersion) throws Exception {
		return forgetByAllInternal(userContext, salaryGradeId, salaryGradeVersion);
	}
	protected SalaryGrade forgetByAllInternal(YoubenbenUserContext userContext,
			String salaryGradeId, int salaryGradeVersion) throws Exception{
	...
	protected SalaryGrade breakWithEmployeeByCompany(YoubenbenUserContext userContext, String salaryGradeId, String companyId,  String [] tokensExpr)
		 throws Exception{
	...
	protected SalaryGrade breakWithEmployeeByDepartment(YoubenbenUserContext userContext, String salaryGradeId, String departmentId,  String [] tokensExpr)
		 throws Exception{
	...
	protected SalaryGrade breakWithEmployeeByOccupation(YoubenbenUserContext userContext, String salaryGradeId, String occupationId,  String [] tokensExpr)
		 throws Exception{
	...
	protected SalaryGrade breakWithEmployeeByResponsibleFor(YoubenbenUserContext userContext, String salaryGradeId, String responsibleForId,  String [] tokensExpr)
		 throws Exception{
	...
	protected SalaryGrade breakWithEmployeeByJobApplication(YoubenbenUserContext userContext, String salaryGradeId, String jobApplicationId,  String [] tokensExpr)
		 throws Exception{
	...
	protected SalaryGrade breakWithEmployeeByProfessionInterview(YoubenbenUserContext userContext, String salaryGradeId, String professionInterviewId,  String [] tokensExpr)
		 throws Exception{
	...
	protected SalaryGrade breakWithEmployeeByHrInterview(YoubenbenUserContext userContext, String salaryGradeId, String hrInterviewId,  String [] tokensExpr)
		 throws Exception{
	...
	protected SalaryGrade breakWithEmployeeByOfferApproval(YoubenbenUserContext userContext, String salaryGradeId, String offerApprovalId,  String [] tokensExpr)
		 throws Exception{
	...
	protected SalaryGrade breakWithEmployeeByOfferAcceptance(YoubenbenUserContext userContext, String salaryGradeId, String offerAcceptanceId,  String [] tokensExpr)
		 throws Exception{
	...
	protected SalaryGrade breakWithEmployeeByEmployeeBoarding(YoubenbenUserContext userContext, String salaryGradeId, String employeeBoardingId,  String [] tokensExpr)
		 throws Exception{
	...
	protected SalaryGrade breakWithEmployeeByTermination(YoubenbenUserContext userContext, String salaryGradeId, String terminationId,  String [] tokensExpr)
		 throws Exception{
	...
	protected SalaryGrade breakWithEmployeeSalarySheetByEmployee(YoubenbenUserContext userContext, String salaryGradeId, String employeeId,  String [] tokensExpr)
		 throws Exception{
	...
	protected SalaryGrade breakWithEmployeeSalarySheetByPayingOff(YoubenbenUserContext userContext, String salaryGradeId, String payingOffId,  String [] tokensExpr)
		 throws Exception{
	...
	protected void checkParamsForAddingEmployee(YoubenbenUserContext userContext, String salaryGradeId, String companyId, String title, String departmentId, String familyName, String givenName, String email, String city, String address, String cellPhone, String occupationId, String responsibleForId, String salaryAccount, String jobApplicationId, String professionInterviewId, String hrInterviewId, String offerApprovalId, String offerAcceptanceId, String employeeBoardingId, String terminationId,String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForUpdatingEmployeeProperties(YoubenbenUserContext userContext, String salaryGradeId,String id,String title,String familyName,String givenName,String email,String city,String address,String cellPhone,String salaryAccount,String [] tokensExpr) throws Exception {
	...
	public  SalaryGrade updateEmployeeProperties(YoubenbenUserContext userContext, String salaryGradeId, String id,String title,String familyName,String givenName,String email,String city,String address,String cellPhone,String salaryAccount, String [] tokensExpr) throws Exception
	{
	...
	protected Employee createEmployee(YoubenbenUserContext userContext, String companyId, String title, String departmentId, String familyName, String givenName, String email, String city, String address, String cellPhone, String occupationId, String responsibleForId, String salaryAccount, String jobApplicationId, String professionInterviewId, String hrInterviewId, String offerApprovalId, String offerAcceptanceId, String employeeBoardingId, String terminationId) throws Exception{
	...
	protected void checkParamsForRemovingEmployeeList(YoubenbenUserContext userContext, String salaryGradeId,
	...
	public  SalaryGrade removeEmployeeList(YoubenbenUserContext userContext, String salaryGradeId,
			String employeeIds[],String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForRemovingEmployee(YoubenbenUserContext userContext, String salaryGradeId,
	...
	public  SalaryGrade removeEmployee(YoubenbenUserContext userContext, String salaryGradeId,
		String employeeId, int employeeVersion,String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForCopyingEmployee(YoubenbenUserContext userContext, String salaryGradeId,
		String employeeId, int employeeVersion,String [] tokensExpr) throws Exception{
	...
	public  SalaryGrade copyEmployeeFrom(YoubenbenUserContext userContext, String salaryGradeId,
		String employeeId, int employeeVersion,String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForUpdatingEmployee(YoubenbenUserContext userContext, String salaryGradeId, String employeeId, int employeeVersion, String property, String newValueExpr,String [] tokensExpr) throws Exception{
	...
	public  SalaryGrade updateEmployee(YoubenbenUserContext userContext, String salaryGradeId, String employeeId, int employeeVersion, String property, String newValueExpr,String [] tokensExpr)
			throws Exception{
	...
	*/
	...
	protected void checkParamsForAddingEmployeeSalarySheet(YoubenbenUserContext userContext, String salaryGradeId, String employeeId, BigDecimal baseSalary, BigDecimal bonus, BigDecimal reward, BigDecimal personalTax, BigDecimal socialSecurity, BigDecimal housingFound, BigDecimal jobInsurance, String payingOffId,String [] tokensExpr) throws Exception{
	...
	protected EmployeeSalarySheet createEmployeeSalarySheet(YoubenbenUserContext userContext, String employeeId, BigDecimal baseSalary, BigDecimal bonus, BigDecimal reward, BigDecimal personalTax, BigDecimal socialSecurity, BigDecimal housingFound, BigDecimal jobInsurance, String payingOffId) throws Exception{
	...
	protected void checkParamsForRemovingEmployeeSalarySheetList(YoubenbenUserContext userContext, String salaryGradeId,
	...
	public  SalaryGrade removeEmployeeSalarySheetList(YoubenbenUserContext userContext, String salaryGradeId,
			String employeeSalarySheetIds[],String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForRemovingEmployeeSalarySheet(YoubenbenUserContext userContext, String salaryGradeId,
	...
	public  SalaryGrade removeEmployeeSalarySheet(YoubenbenUserContext userContext, String salaryGradeId,
		String employeeSalarySheetId, int employeeSalarySheetVersion,String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForCopyingEmployeeSalarySheet(YoubenbenUserContext userContext, String salaryGradeId,
		String employeeSalarySheetId, int employeeSalarySheetVersion,String [] tokensExpr) throws Exception{
	...
	public  SalaryGrade copyEmployeeSalarySheetFrom(YoubenbenUserContext userContext, String salaryGradeId,
		String employeeSalarySheetId, int employeeSalarySheetVersion,String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForUpdatingEmployeeSalarySheet(YoubenbenUserContext userContext, String salaryGradeId, String employeeSalarySheetId, int employeeSalarySheetVersion, String property, String newValueExpr,String [] tokensExpr) throws Exception{
	...
	public  SalaryGrade updateEmployeeSalarySheet(YoubenbenUserContext userContext, String salaryGradeId, String employeeSalarySheetId, int employeeSalarySheetVersion, String property, String newValueExpr,String [] tokensExpr)
			throws Exception{
	...
	*/
	...
	// -----------------------------------// list-of-view 处理 \\-----------------------------------
    protected void enhanceForListOfView(YoubenbenUserContext userContext,SmartList<SalaryGrade> list) throws Exception {
  ...
  // -----------------------------------\\ list-of-view 处理 //-----------------------------------v
	 ...
	 * @throws Exception
	 */
 	public Object wxappview(YoubenbenUserContext userContext, String salaryGradeId) throws Exception{
	  SerializeScope vscope = YoubenbenViewScope.getInstance().getSalaryGradeDetailScope().clone();
