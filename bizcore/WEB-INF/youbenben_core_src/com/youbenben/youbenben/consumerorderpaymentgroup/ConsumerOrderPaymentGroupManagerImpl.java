...
public class ConsumerOrderPaymentGroupManagerImpl extends CustomYoubenbenCheckerManager implements ConsumerOrderPaymentGroupManager, BusinessHandler{
	...
	@Override
	public ConsumerOrderPaymentGroupDAO daoOf(YoubenbenUserContext userContext) {
	...
	protected void throwExceptionWithMessage(String value) throws ConsumerOrderPaymentGroupManagerException{
 	...
 	protected ConsumerOrderPaymentGroup saveConsumerOrderPaymentGroup(YoubenbenUserContext userContext, ConsumerOrderPaymentGroup consumerOrderPaymentGroup, String [] tokensExpr) throws Exception{	
 	...
 	protected ConsumerOrderPaymentGroup saveConsumerOrderPaymentGroupDetail(YoubenbenUserContext userContext, ConsumerOrderPaymentGroup consumerOrderPaymentGroup) throws Exception{	
 	...
 	public ConsumerOrderPaymentGroup loadConsumerOrderPaymentGroup(YoubenbenUserContext userContext, String consumerOrderPaymentGroupId, String [] tokensExpr) throws Exception{				
 	 ...
 	 public ConsumerOrderPaymentGroup searchConsumerOrderPaymentGroup(YoubenbenUserContext userContext, String consumerOrderPaymentGroupId, String textToSearch,String [] tokensExpr) throws Exception{				
 	...
 	protected ConsumerOrderPaymentGroup present(YoubenbenUserContext userContext, ConsumerOrderPaymentGroup consumerOrderPaymentGroup, Map<String, Object> tokens) throws Exception {
 	...
 	public ConsumerOrderPaymentGroup loadConsumerOrderPaymentGroupDetail(YoubenbenUserContext userContext, String consumerOrderPaymentGroupId) throws Exception{	
 	...
 	public Object view(YoubenbenUserContext userContext, String consumerOrderPaymentGroupId) throws Exception{	
 	...
 	protected ConsumerOrderPaymentGroup saveConsumerOrderPaymentGroup(YoubenbenUserContext userContext, ConsumerOrderPaymentGroup consumerOrderPaymentGroup, Map<String,Object>tokens) throws Exception{	
 		return consumerOrderPaymentGroupDaoOf(userContext).save(consumerOrderPaymentGroup, tokens);
 	}
 	protected ConsumerOrderPaymentGroup loadConsumerOrderPaymentGroup(YoubenbenUserContext userContext, String consumerOrderPaymentGroupId, Map<String,Object>tokens) throws Exception{	
		checkerOf(userContext).checkIdOfConsumerOrderPaymentGroup(consumerOrderPaymentGroupId);
		checkerOf(userContext).throwExceptionIfHasErrors( ConsumerOrderPaymentGroupManagerException.class);
 	...
 	protected<T extends BaseEntity> void addActions(YoubenbenUserContext userContext, ConsumerOrderPaymentGroup consumerOrderPaymentGroup, Map<String, Object> tokens){
	...
	}// end method of protected<T extends BaseEntity> void addActions(YoubenbenUserContext userContext, ConsumerOrderPaymentGroup consumerOrderPaymentGroup, Map<String, Object> tokens){
	...
	protected void checkParamsForUpdatingConsumerOrderPaymentGroup(YoubenbenUserContext userContext,String consumerOrderPaymentGroupId, int consumerOrderPaymentGroupVersion, String property, String newValueExpr,String [] tokensExpr)throws Exception
	{
	...
	public ConsumerOrderPaymentGroup clone(YoubenbenUserContext userContext, String fromConsumerOrderPaymentGroupId) throws Exception{
	...
	public ConsumerOrderPaymentGroup internalSaveConsumerOrderPaymentGroup(YoubenbenUserContext userContext, ConsumerOrderPaymentGroup consumerOrderPaymentGroup, Map<String,Object> options) throws Exception
	{
	...
	public ConsumerOrderPaymentGroup updateConsumerOrderPaymentGroupProperty(YoubenbenUserContext userContext,String consumerOrderPaymentGroupId, int consumerOrderPaymentGroupVersion, String property, String newValueExpr,String [] tokensExpr) throws Exception
	{
		checkParamsForUpdatingConsumerOrderPaymentGroup(userContext, consumerOrderPaymentGroupId, consumerOrderPaymentGroupVersion, property, newValueExpr, tokensExpr);
	...
	protected void checkParamsForTransferingAnotherBizOrder(YoubenbenUserContext userContext, String consumerOrderPaymentGroupId, String anotherBizOrderId) throws Exception
 	{
 ...
 //--------------------------------------------------------------
	...
	public void delete(YoubenbenUserContext userContext, String consumerOrderPaymentGroupId, int consumerOrderPaymentGroupVersion) throws Exception {
	...
	public ConsumerOrderPaymentGroup forgetByAll(YoubenbenUserContext userContext, String consumerOrderPaymentGroupId, int consumerOrderPaymentGroupVersion) throws Exception {
		return forgetByAllInternal(userContext, consumerOrderPaymentGroupId, consumerOrderPaymentGroupVersion);
	}
	protected ConsumerOrderPaymentGroup forgetByAllInternal(YoubenbenUserContext userContext,
			String consumerOrderPaymentGroupId, int consumerOrderPaymentGroupVersion) throws Exception{
	...
	// -----------------------------------// list-of-view 处理 \\-----------------------------------
    protected void enhanceForListOfView(YoubenbenUserContext userContext,SmartList<ConsumerOrderPaymentGroup> list) throws Exception {
  ...
  // -----------------------------------\\ list-of-view 处理 //-----------------------------------v
	 ...
	 * @throws Exception
	 */
 	public Object wxappview(YoubenbenUserContext userContext, String consumerOrderPaymentGroupId) throws Exception{
	  SerializeScope vscope = YoubenbenViewScope.getInstance().getConsumerOrderPaymentGroupDetailScope().clone();
