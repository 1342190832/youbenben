...
public class PublicHolidayManagerImpl extends CustomYoubenbenCheckerManager implements PublicHolidayManager, BusinessHandler{
	...
	@Override
	public PublicHolidayDAO daoOf(YoubenbenUserContext userContext) {
	...
	protected void throwExceptionWithMessage(String value) throws PublicHolidayManagerException{
 	...
 	protected PublicHoliday savePublicHoliday(YoubenbenUserContext userContext, PublicHoliday publicHoliday, String [] tokensExpr) throws Exception{	
 	...
 	protected PublicHoliday savePublicHolidayDetail(YoubenbenUserContext userContext, PublicHoliday publicHoliday) throws Exception{	
 	...
 	public PublicHoliday loadPublicHoliday(YoubenbenUserContext userContext, String publicHolidayId, String [] tokensExpr) throws Exception{				
 	 ...
 	 public PublicHoliday searchPublicHoliday(YoubenbenUserContext userContext, String publicHolidayId, String textToSearch,String [] tokensExpr) throws Exception{				
 	...
 	protected PublicHoliday present(YoubenbenUserContext userContext, PublicHoliday publicHoliday, Map<String, Object> tokens) throws Exception {
 	...
 	public PublicHoliday loadPublicHolidayDetail(YoubenbenUserContext userContext, String publicHolidayId) throws Exception{	
 	...
 	public Object view(YoubenbenUserContext userContext, String publicHolidayId) throws Exception{	
 		PublicHoliday publicHoliday = loadPublicHoliday( userContext, publicHolidayId, viewTokens());
 		return present(userContext,publicHoliday, allTokens());
		
 	}
 	protected PublicHoliday savePublicHoliday(YoubenbenUserContext userContext, PublicHoliday publicHoliday, Map<String,Object>tokens) throws Exception{	
 		return publicHolidayDaoOf(userContext).save(publicHoliday, tokens);
 	}
 	protected PublicHoliday loadPublicHoliday(YoubenbenUserContext userContext, String publicHolidayId, Map<String,Object>tokens) throws Exception{	
		checkerOf(userContext).checkIdOfPublicHoliday(publicHolidayId);
		checkerOf(userContext).throwExceptionIfHasErrors( PublicHolidayManagerException.class);
 	...
 	protected<T extends BaseEntity> void addActions(YoubenbenUserContext userContext, PublicHoliday publicHoliday, Map<String, Object> tokens){
	...
	}// end method of protected<T extends BaseEntity> void addActions(YoubenbenUserContext userContext, PublicHoliday publicHoliday, Map<String, Object> tokens){
	...
	protected void checkParamsForUpdatingPublicHoliday(YoubenbenUserContext userContext,String publicHolidayId, int publicHolidayVersion, String property, String newValueExpr,String [] tokensExpr)throws Exception
	{
	...
	public PublicHoliday clone(YoubenbenUserContext userContext, String fromPublicHolidayId) throws Exception{
	...
	public PublicHoliday internalSavePublicHoliday(YoubenbenUserContext userContext, PublicHoliday publicHoliday, Map<String,Object> options) throws Exception
	{
	...
	public PublicHoliday updatePublicHolidayProperty(YoubenbenUserContext userContext,String publicHolidayId, int publicHolidayVersion, String property, String newValueExpr,String [] tokensExpr) throws Exception
	{
		checkParamsForUpdatingPublicHoliday(userContext, publicHolidayId, publicHolidayVersion, property, newValueExpr, tokensExpr);
	...
	protected void checkParamsForTransferingAnotherCompany(YoubenbenUserContext userContext, String publicHolidayId, String anotherCompanyId) throws Exception
 	{
 ...
 //--------------------------------------------------------------
	...
	public void delete(YoubenbenUserContext userContext, String publicHolidayId, int publicHolidayVersion) throws Exception {
	...
	public PublicHoliday forgetByAll(YoubenbenUserContext userContext, String publicHolidayId, int publicHolidayVersion) throws Exception {
		return forgetByAllInternal(userContext, publicHolidayId, publicHolidayVersion);
	}
	protected PublicHoliday forgetByAllInternal(YoubenbenUserContext userContext,
			String publicHolidayId, int publicHolidayVersion) throws Exception{
	...
	// -----------------------------------// list-of-view 处理 \\-----------------------------------
    protected void enhanceForListOfView(YoubenbenUserContext userContext,SmartList<PublicHoliday> list) throws Exception {
  ...
  // -----------------------------------\\ list-of-view 处理 //-----------------------------------v
	 ...
	 * @throws Exception
	 */
 	public Object wxappview(YoubenbenUserContext userContext, String publicHolidayId) throws Exception{
	  SerializeScope vscope = YoubenbenViewScope.getInstance().getPublicHolidayDetailScope().clone();
