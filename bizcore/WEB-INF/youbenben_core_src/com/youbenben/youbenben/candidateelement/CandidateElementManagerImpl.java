...
import com.youbenben.youbenben.candidatecontainer.CandidateCandidateContainer;
...
public class CandidateElementManagerImpl extends CustomYoubenbenCheckerManager implements CandidateElementManager, BusinessHandler{
	...
	@Override
	public CandidateElementDAO daoOf(YoubenbenUserContext userContext) {
	...
	protected void throwExceptionWithMessage(String value) throws CandidateElementManagerException{
 	...
 	protected CandidateElement saveCandidateElement(YoubenbenUserContext userContext, CandidateElement candidateElement, String [] tokensExpr) throws Exception{	
 	...
 	protected CandidateElement saveCandidateElementDetail(YoubenbenUserContext userContext, CandidateElement candidateElement) throws Exception{	
 	...
 	public CandidateElement loadCandidateElement(YoubenbenUserContext userContext, String candidateElementId, String [] tokensExpr) throws Exception{				
 	 ...
 	 public CandidateElement searchCandidateElement(YoubenbenUserContext userContext, String candidateElementId, String textToSearch,String [] tokensExpr) throws Exception{				
 	...
 	protected CandidateElement present(YoubenbenUserContext userContext, CandidateElement candidateElement, Map<String, Object> tokens) throws Exception {
 	...
 	public CandidateElement loadCandidateElementDetail(YoubenbenUserContext userContext, String candidateElementId) throws Exception{	
 	...
 	public Object view(YoubenbenUserContext userContext, String candidateElementId) throws Exception{	
 		CandidateElement candidateElement = loadCandidateElement( userContext, candidateElementId, viewTokens());
 		return present(userContext,candidateElement, allTokens());
		
 	}
 	protected CandidateElement saveCandidateElement(YoubenbenUserContext userContext, CandidateElement candidateElement, Map<String,Object>tokens) throws Exception{	
 		return candidateElementDaoOf(userContext).save(candidateElement, tokens);
 	}
 	protected CandidateElement loadCandidateElement(YoubenbenUserContext userContext, String candidateElementId, Map<String,Object>tokens) throws Exception{	
		checkerOf(userContext).checkIdOfCandidateElement(candidateElementId);
		checkerOf(userContext).throwExceptionIfHasErrors( CandidateElementManagerException.class);
 	...
 	protected<T extends BaseEntity> void addActions(YoubenbenUserContext userContext, CandidateElement candidateElement, Map<String, Object> tokens){
	...
	}// end method of protected<T extends BaseEntity> void addActions(YoubenbenUserContext userContext, CandidateElement candidateElement, Map<String, Object> tokens){
	...
	protected void checkParamsForUpdatingCandidateElement(YoubenbenUserContext userContext,String candidateElementId, int candidateElementVersion, String property, String newValueExpr,String [] tokensExpr)throws Exception
	{
	...
	public CandidateElement clone(YoubenbenUserContext userContext, String fromCandidateElementId) throws Exception{
	...
	public CandidateElement internalSaveCandidateElement(YoubenbenUserContext userContext, CandidateElement candidateElement, Map<String,Object> options) throws Exception
	{
	...
	public CandidateElement updateCandidateElementProperty(YoubenbenUserContext userContext,String candidateElementId, int candidateElementVersion, String property, String newValueExpr,String [] tokensExpr) throws Exception
	{
		checkParamsForUpdatingCandidateElement(userContext, candidateElementId, candidateElementVersion, property, newValueExpr, tokensExpr);
	...
	protected void checkParamsForTransferingAnotherContainer(YoubenbenUserContext userContext, String candidateElementId, String anotherContainerId) throws Exception
 	{
	...
	public CandidateCandidateContainer requestCandidateContainer(YoubenbenUserContext userContext, String ownerClass, String id, String filterKey, int pageNo) throws Exception {
 ...
 //--------------------------------------------------------------
 	...
 	protected CandidateContainer loadCandidateContainer(YoubenbenUserContext userContext, String newContainerId, Map<String,Object> options) throws Exception
 	{
	...
	public void delete(YoubenbenUserContext userContext, String candidateElementId, int candidateElementVersion) throws Exception {
	...
	public CandidateElement forgetByAll(YoubenbenUserContext userContext, String candidateElementId, int candidateElementVersion) throws Exception {
		return forgetByAllInternal(userContext, candidateElementId, candidateElementVersion);
	}
	protected CandidateElement forgetByAllInternal(YoubenbenUserContext userContext,
			String candidateElementId, int candidateElementVersion) throws Exception{
	...
	// -----------------------------------// list-of-view 处理 \\-----------------------------------
    protected void enhanceForListOfView(YoubenbenUserContext userContext,SmartList<CandidateElement> list) throws Exception {
    	if (list == null || list.isEmpty()){
    		return;
    	}
		List<CandidateContainer> containerList = YoubenbenBaseUtils.collectReferencedObjectWithType(userContext, list, CandidateContainer.class);
  ...
  // -----------------------------------\\ list-of-view 处理 //-----------------------------------v
	 ...
	 * @throws Exception
	 */
 	public Object wxappview(YoubenbenUserContext userContext, String candidateElementId) throws Exception{
	  SerializeScope vscope = YoubenbenViewScope.getInstance().getCandidateElementDetailScope().clone();
