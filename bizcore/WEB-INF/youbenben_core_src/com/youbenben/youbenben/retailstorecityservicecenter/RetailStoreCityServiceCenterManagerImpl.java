...
import com.youbenben.youbenben.retailstoreprovincecenter.CandidateRetailStoreProvinceCenter;
...
public class RetailStoreCityServiceCenterManagerImpl extends CustomYoubenbenCheckerManager implements RetailStoreCityServiceCenterManager, BusinessHandler{
	...
	@Override
	public RetailStoreCityServiceCenterDAO daoOf(YoubenbenUserContext userContext) {
	...
	protected void throwExceptionWithMessage(String value) throws RetailStoreCityServiceCenterManagerException{
 	...
 	protected RetailStoreCityServiceCenter saveRetailStoreCityServiceCenter(YoubenbenUserContext userContext, RetailStoreCityServiceCenter retailStoreCityServiceCenter, String [] tokensExpr) throws Exception{	
 	...
 	protected RetailStoreCityServiceCenter saveRetailStoreCityServiceCenterDetail(YoubenbenUserContext userContext, RetailStoreCityServiceCenter retailStoreCityServiceCenter) throws Exception{	
 	...
 	public RetailStoreCityServiceCenter loadRetailStoreCityServiceCenter(YoubenbenUserContext userContext, String retailStoreCityServiceCenterId, String [] tokensExpr) throws Exception{				
 	 ...
 	 public RetailStoreCityServiceCenter searchRetailStoreCityServiceCenter(YoubenbenUserContext userContext, String retailStoreCityServiceCenterId, String textToSearch,String [] tokensExpr) throws Exception{				
 	...
 	protected RetailStoreCityServiceCenter present(YoubenbenUserContext userContext, RetailStoreCityServiceCenter retailStoreCityServiceCenter, Map<String, Object> tokens) throws Exception {
 	...
 	public RetailStoreCityServiceCenter loadRetailStoreCityServiceCenterDetail(YoubenbenUserContext userContext, String retailStoreCityServiceCenterId) throws Exception{	
 	...
 	public Object view(YoubenbenUserContext userContext, String retailStoreCityServiceCenterId) throws Exception{	
 	...
 	protected RetailStoreCityServiceCenter saveRetailStoreCityServiceCenter(YoubenbenUserContext userContext, RetailStoreCityServiceCenter retailStoreCityServiceCenter, Map<String,Object>tokens) throws Exception{	
 		return retailStoreCityServiceCenterDaoOf(userContext).save(retailStoreCityServiceCenter, tokens);
 	}
 	protected RetailStoreCityServiceCenter loadRetailStoreCityServiceCenter(YoubenbenUserContext userContext, String retailStoreCityServiceCenterId, Map<String,Object>tokens) throws Exception{	
		checkerOf(userContext).checkIdOfRetailStoreCityServiceCenter(retailStoreCityServiceCenterId);
		checkerOf(userContext).throwExceptionIfHasErrors( RetailStoreCityServiceCenterManagerException.class);
 	...
 	protected<T extends BaseEntity> void addActions(YoubenbenUserContext userContext, RetailStoreCityServiceCenter retailStoreCityServiceCenter, Map<String, Object> tokens){
	...
	}// end method of protected<T extends BaseEntity> void addActions(YoubenbenUserContext userContext, RetailStoreCityServiceCenter retailStoreCityServiceCenter, Map<String, Object> tokens){
	...
	protected void checkParamsForUpdatingRetailStoreCityServiceCenter(YoubenbenUserContext userContext,String retailStoreCityServiceCenterId, int retailStoreCityServiceCenterVersion, String property, String newValueExpr,String [] tokensExpr)throws Exception
	{
	...
	public RetailStoreCityServiceCenter clone(YoubenbenUserContext userContext, String fromRetailStoreCityServiceCenterId) throws Exception{
	...
	public RetailStoreCityServiceCenter internalSaveRetailStoreCityServiceCenter(YoubenbenUserContext userContext, RetailStoreCityServiceCenter retailStoreCityServiceCenter, Map<String,Object> options) throws Exception
	{
	...
	public RetailStoreCityServiceCenter updateRetailStoreCityServiceCenterProperty(YoubenbenUserContext userContext,String retailStoreCityServiceCenterId, int retailStoreCityServiceCenterVersion, String property, String newValueExpr,String [] tokensExpr) throws Exception
	{
		checkParamsForUpdatingRetailStoreCityServiceCenter(userContext, retailStoreCityServiceCenterId, retailStoreCityServiceCenterVersion, property, newValueExpr, tokensExpr);
	...
	protected void checkParamsForTransferingAnotherBelongsTo(YoubenbenUserContext userContext, String retailStoreCityServiceCenterId, String anotherBelongsToId) throws Exception
 	{
	...
	public CandidateRetailStoreProvinceCenter requestCandidateBelongsTo(YoubenbenUserContext userContext, String ownerClass, String id, String filterKey, int pageNo) throws Exception {
 ...
 //--------------------------------------------------------------
 	...
 	protected RetailStoreProvinceCenter loadRetailStoreProvinceCenter(YoubenbenUserContext userContext, String newBelongsToId, Map<String,Object> options) throws Exception
 	{
	...
	public void delete(YoubenbenUserContext userContext, String retailStoreCityServiceCenterId, int retailStoreCityServiceCenterVersion) throws Exception {
	...
	public RetailStoreCityServiceCenter forgetByAll(YoubenbenUserContext userContext, String retailStoreCityServiceCenterId, int retailStoreCityServiceCenterVersion) throws Exception {
		return forgetByAllInternal(userContext, retailStoreCityServiceCenterId, retailStoreCityServiceCenterVersion);
	}
	protected RetailStoreCityServiceCenter forgetByAllInternal(YoubenbenUserContext userContext,
			String retailStoreCityServiceCenterId, int retailStoreCityServiceCenterVersion) throws Exception{
	...
	protected RetailStoreCityServiceCenter breakWithPotentialCustomerByCityPartner(YoubenbenUserContext userContext, String retailStoreCityServiceCenterId, String cityPartnerId,  String [] tokensExpr)
		 throws Exception{
	...
	protected RetailStoreCityServiceCenter breakWithRetailStoreByRetailStoreCountryCenter(YoubenbenUserContext userContext, String retailStoreCityServiceCenterId, String retailStoreCountryCenterId,  String [] tokensExpr)
		 throws Exception{
	...
	protected RetailStoreCityServiceCenter breakWithRetailStoreByCreation(YoubenbenUserContext userContext, String retailStoreCityServiceCenterId, String creationId,  String [] tokensExpr)
		 throws Exception{
	...
	protected RetailStoreCityServiceCenter breakWithRetailStoreByInvestmentInvitation(YoubenbenUserContext userContext, String retailStoreCityServiceCenterId, String investmentInvitationId,  String [] tokensExpr)
		 throws Exception{
	...
	protected RetailStoreCityServiceCenter breakWithRetailStoreByFranchising(YoubenbenUserContext userContext, String retailStoreCityServiceCenterId, String franchisingId,  String [] tokensExpr)
		 throws Exception{
	...
	protected RetailStoreCityServiceCenter breakWithRetailStoreByDecoration(YoubenbenUserContext userContext, String retailStoreCityServiceCenterId, String decorationId,  String [] tokensExpr)
		 throws Exception{
	...
	protected RetailStoreCityServiceCenter breakWithRetailStoreByOpening(YoubenbenUserContext userContext, String retailStoreCityServiceCenterId, String openingId,  String [] tokensExpr)
		 throws Exception{
	...
	protected RetailStoreCityServiceCenter breakWithRetailStoreByClosing(YoubenbenUserContext userContext, String retailStoreCityServiceCenterId, String closingId,  String [] tokensExpr)
		 throws Exception{
	...
	protected void checkParamsForAddingCityPartner(YoubenbenUserContext userContext, String retailStoreCityServiceCenterId, String name, String mobile, String description,String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForUpdatingCityPartnerProperties(YoubenbenUserContext userContext, String retailStoreCityServiceCenterId,String id,String name,String mobile,String description,String [] tokensExpr) throws Exception {
	...
	public  RetailStoreCityServiceCenter updateCityPartnerProperties(YoubenbenUserContext userContext, String retailStoreCityServiceCenterId, String id,String name,String mobile,String description, String [] tokensExpr) throws Exception
	{
	...
	protected void checkParamsForRemovingCityPartnerList(YoubenbenUserContext userContext, String retailStoreCityServiceCenterId,
	...
	public  RetailStoreCityServiceCenter removeCityPartnerList(YoubenbenUserContext userContext, String retailStoreCityServiceCenterId,
			String cityPartnerIds[],String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForRemovingCityPartner(YoubenbenUserContext userContext, String retailStoreCityServiceCenterId,
	...
	public  RetailStoreCityServiceCenter removeCityPartner(YoubenbenUserContext userContext, String retailStoreCityServiceCenterId,
		String cityPartnerId, int cityPartnerVersion,String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForCopyingCityPartner(YoubenbenUserContext userContext, String retailStoreCityServiceCenterId,
		String cityPartnerId, int cityPartnerVersion,String [] tokensExpr) throws Exception{
	...
	public  RetailStoreCityServiceCenter copyCityPartnerFrom(YoubenbenUserContext userContext, String retailStoreCityServiceCenterId,
		String cityPartnerId, int cityPartnerVersion,String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForUpdatingCityPartner(YoubenbenUserContext userContext, String retailStoreCityServiceCenterId, String cityPartnerId, int cityPartnerVersion, String property, String newValueExpr,String [] tokensExpr) throws Exception{
	...
	public  RetailStoreCityServiceCenter updateCityPartner(YoubenbenUserContext userContext, String retailStoreCityServiceCenterId, String cityPartnerId, int cityPartnerVersion, String property, String newValueExpr,String [] tokensExpr)
			throws Exception{
	...
	*/
	...
	protected void checkParamsForAddingPotentialCustomer(YoubenbenUserContext userContext, String retailStoreCityServiceCenterId, String name, String mobile, String cityPartnerId, String description,String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForUpdatingPotentialCustomerProperties(YoubenbenUserContext userContext, String retailStoreCityServiceCenterId,String id,String name,String mobile,String description,String [] tokensExpr) throws Exception {
	...
	public  RetailStoreCityServiceCenter updatePotentialCustomerProperties(YoubenbenUserContext userContext, String retailStoreCityServiceCenterId, String id,String name,String mobile,String description, String [] tokensExpr) throws Exception
	{
	...
	protected void checkParamsForRemovingPotentialCustomerList(YoubenbenUserContext userContext, String retailStoreCityServiceCenterId,
	...
	public  RetailStoreCityServiceCenter removePotentialCustomerList(YoubenbenUserContext userContext, String retailStoreCityServiceCenterId,
			String potentialCustomerIds[],String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForRemovingPotentialCustomer(YoubenbenUserContext userContext, String retailStoreCityServiceCenterId,
	...
	public  RetailStoreCityServiceCenter removePotentialCustomer(YoubenbenUserContext userContext, String retailStoreCityServiceCenterId,
		String potentialCustomerId, int potentialCustomerVersion,String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForCopyingPotentialCustomer(YoubenbenUserContext userContext, String retailStoreCityServiceCenterId,
		String potentialCustomerId, int potentialCustomerVersion,String [] tokensExpr) throws Exception{
	...
	public  RetailStoreCityServiceCenter copyPotentialCustomerFrom(YoubenbenUserContext userContext, String retailStoreCityServiceCenterId,
		String potentialCustomerId, int potentialCustomerVersion,String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForUpdatingPotentialCustomer(YoubenbenUserContext userContext, String retailStoreCityServiceCenterId, String potentialCustomerId, int potentialCustomerVersion, String property, String newValueExpr,String [] tokensExpr) throws Exception{
	...
	public  RetailStoreCityServiceCenter updatePotentialCustomer(YoubenbenUserContext userContext, String retailStoreCityServiceCenterId, String potentialCustomerId, int potentialCustomerVersion, String property, String newValueExpr,String [] tokensExpr)
			throws Exception{
	...
	*/
	...
	protected void checkParamsForAddingCityEvent(YoubenbenUserContext userContext, String retailStoreCityServiceCenterId, String name, String mobile, String description,String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForUpdatingCityEventProperties(YoubenbenUserContext userContext, String retailStoreCityServiceCenterId,String id,String name,String mobile,String description,String [] tokensExpr) throws Exception {
	...
	public  RetailStoreCityServiceCenter updateCityEventProperties(YoubenbenUserContext userContext, String retailStoreCityServiceCenterId, String id,String name,String mobile,String description, String [] tokensExpr) throws Exception
	{
	...
	protected void checkParamsForRemovingCityEventList(YoubenbenUserContext userContext, String retailStoreCityServiceCenterId,
	...
	public  RetailStoreCityServiceCenter removeCityEventList(YoubenbenUserContext userContext, String retailStoreCityServiceCenterId,
			String cityEventIds[],String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForRemovingCityEvent(YoubenbenUserContext userContext, String retailStoreCityServiceCenterId,
	...
	public  RetailStoreCityServiceCenter removeCityEvent(YoubenbenUserContext userContext, String retailStoreCityServiceCenterId,
		String cityEventId, int cityEventVersion,String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForCopyingCityEvent(YoubenbenUserContext userContext, String retailStoreCityServiceCenterId,
		String cityEventId, int cityEventVersion,String [] tokensExpr) throws Exception{
	...
	public  RetailStoreCityServiceCenter copyCityEventFrom(YoubenbenUserContext userContext, String retailStoreCityServiceCenterId,
		String cityEventId, int cityEventVersion,String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForUpdatingCityEvent(YoubenbenUserContext userContext, String retailStoreCityServiceCenterId, String cityEventId, int cityEventVersion, String property, String newValueExpr,String [] tokensExpr) throws Exception{
	...
	public  RetailStoreCityServiceCenter updateCityEvent(YoubenbenUserContext userContext, String retailStoreCityServiceCenterId, String cityEventId, int cityEventVersion, String property, String newValueExpr,String [] tokensExpr)
			throws Exception{
	...
	*/
	...
	protected void checkParamsForUpdatingRetailStoreProperties(YoubenbenUserContext userContext, String retailStoreCityServiceCenterId,String id,String name,String telephone,String owner,Date founded,BigDecimal latitude,BigDecimal longitude,String description,String [] tokensExpr) throws Exception {
	...
	public  RetailStoreCityServiceCenter updateRetailStoreProperties(YoubenbenUserContext userContext, String retailStoreCityServiceCenterId, String id,String name,String telephone,String owner,Date founded,BigDecimal latitude,BigDecimal longitude,String description, String [] tokensExpr) throws Exception
	{
	...
	protected RetailStore createRetailStore(YoubenbenUserContext userContext, String name, String telephone, String owner, String retailStoreCountryCenterId, String creationId, String investmentInvitationId, String franchisingId, String decorationId, String openingId, String closingId, Date founded, BigDecimal latitude, BigDecimal longitude, String description) throws Exception{
	...
	protected void checkParamsForRemovingRetailStoreList(YoubenbenUserContext userContext, String retailStoreCityServiceCenterId,
	...
	public  RetailStoreCityServiceCenter removeRetailStoreList(YoubenbenUserContext userContext, String retailStoreCityServiceCenterId,
			String retailStoreIds[],String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForRemovingRetailStore(YoubenbenUserContext userContext, String retailStoreCityServiceCenterId,
	...
	public  RetailStoreCityServiceCenter removeRetailStore(YoubenbenUserContext userContext, String retailStoreCityServiceCenterId,
		String retailStoreId, int retailStoreVersion,String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForCopyingRetailStore(YoubenbenUserContext userContext, String retailStoreCityServiceCenterId,
		String retailStoreId, int retailStoreVersion,String [] tokensExpr) throws Exception{
	...
	public  RetailStoreCityServiceCenter copyRetailStoreFrom(YoubenbenUserContext userContext, String retailStoreCityServiceCenterId,
		String retailStoreId, int retailStoreVersion,String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForUpdatingRetailStore(YoubenbenUserContext userContext, String retailStoreCityServiceCenterId, String retailStoreId, int retailStoreVersion, String property, String newValueExpr,String [] tokensExpr) throws Exception{
	...
	public  RetailStoreCityServiceCenter updateRetailStore(YoubenbenUserContext userContext, String retailStoreCityServiceCenterId, String retailStoreId, int retailStoreVersion, String property, String newValueExpr,String [] tokensExpr)
			throws Exception{
	...
	*/
	...
	// -----------------------------------// list-of-view 处理 \\-----------------------------------
    protected void enhanceForListOfView(YoubenbenUserContext userContext,SmartList<RetailStoreCityServiceCenter> list) throws Exception {
    	if (list == null || list.isEmpty()){
    		return;
    	}
		List<RetailStoreProvinceCenter> belongsToList = YoubenbenBaseUtils.collectReferencedObjectWithType(userContext, list, RetailStoreProvinceCenter.class);
  ...
  // -----------------------------------\\ list-of-view 处理 //-----------------------------------v
	 ...
	 * @throws Exception
	 */
 	public Object wxappview(YoubenbenUserContext userContext, String retailStoreCityServiceCenterId) throws Exception{
	  SerializeScope vscope = YoubenbenViewScope.getInstance().getRetailStoreCityServiceCenterDetailScope().clone();
