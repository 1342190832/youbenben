...
public class TrainingCourseTypeManagerImpl extends CustomYoubenbenCheckerManager implements TrainingCourseTypeManager, BusinessHandler{
	...
	@Override
	public TrainingCourseTypeDAO daoOf(YoubenbenUserContext userContext) {
	...
	protected void throwExceptionWithMessage(String value) throws TrainingCourseTypeManagerException{
 	...
 	protected TrainingCourseType saveTrainingCourseType(YoubenbenUserContext userContext, TrainingCourseType trainingCourseType, String [] tokensExpr) throws Exception{	
 	...
 	protected TrainingCourseType saveTrainingCourseTypeDetail(YoubenbenUserContext userContext, TrainingCourseType trainingCourseType) throws Exception{	
 	...
 	public TrainingCourseType loadTrainingCourseType(YoubenbenUserContext userContext, String trainingCourseTypeId, String [] tokensExpr) throws Exception{				
 	 ...
 	 public TrainingCourseType searchTrainingCourseType(YoubenbenUserContext userContext, String trainingCourseTypeId, String textToSearch,String [] tokensExpr) throws Exception{				
 	...
 	protected TrainingCourseType present(YoubenbenUserContext userContext, TrainingCourseType trainingCourseType, Map<String, Object> tokens) throws Exception {
 	...
 	public TrainingCourseType loadTrainingCourseTypeDetail(YoubenbenUserContext userContext, String trainingCourseTypeId) throws Exception{	
 	...
 	public Object view(YoubenbenUserContext userContext, String trainingCourseTypeId) throws Exception{	
 		TrainingCourseType trainingCourseType = loadTrainingCourseType( userContext, trainingCourseTypeId, viewTokens());
 		return present(userContext,trainingCourseType, allTokens());
		
 	}
 	protected TrainingCourseType saveTrainingCourseType(YoubenbenUserContext userContext, TrainingCourseType trainingCourseType, Map<String,Object>tokens) throws Exception{	
 		return trainingCourseTypeDaoOf(userContext).save(trainingCourseType, tokens);
 	}
 	protected TrainingCourseType loadTrainingCourseType(YoubenbenUserContext userContext, String trainingCourseTypeId, Map<String,Object>tokens) throws Exception{	
		checkerOf(userContext).checkIdOfTrainingCourseType(trainingCourseTypeId);
		checkerOf(userContext).throwExceptionIfHasErrors( TrainingCourseTypeManagerException.class);
 	...
 	protected<T extends BaseEntity> void addActions(YoubenbenUserContext userContext, TrainingCourseType trainingCourseType, Map<String, Object> tokens){
	...
	}// end method of protected<T extends BaseEntity> void addActions(YoubenbenUserContext userContext, TrainingCourseType trainingCourseType, Map<String, Object> tokens){
	...
	protected void checkParamsForUpdatingTrainingCourseType(YoubenbenUserContext userContext,String trainingCourseTypeId, int trainingCourseTypeVersion, String property, String newValueExpr,String [] tokensExpr)throws Exception
	{
	...
	public TrainingCourseType clone(YoubenbenUserContext userContext, String fromTrainingCourseTypeId) throws Exception{
	...
	public TrainingCourseType internalSaveTrainingCourseType(YoubenbenUserContext userContext, TrainingCourseType trainingCourseType, Map<String,Object> options) throws Exception
	{
	...
	public TrainingCourseType updateTrainingCourseTypeProperty(YoubenbenUserContext userContext,String trainingCourseTypeId, int trainingCourseTypeVersion, String property, String newValueExpr,String [] tokensExpr) throws Exception
	{
		checkParamsForUpdatingTrainingCourseType(userContext, trainingCourseTypeId, trainingCourseTypeVersion, property, newValueExpr, tokensExpr);
	...
	protected void checkParamsForTransferingAnotherCompany(YoubenbenUserContext userContext, String trainingCourseTypeId, String anotherCompanyId) throws Exception
 	{
 ...
 //--------------------------------------------------------------
	...
	public void delete(YoubenbenUserContext userContext, String trainingCourseTypeId, int trainingCourseTypeVersion) throws Exception {
	...
	public TrainingCourseType forgetByAll(YoubenbenUserContext userContext, String trainingCourseTypeId, int trainingCourseTypeVersion) throws Exception {
		return forgetByAllInternal(userContext, trainingCourseTypeId, trainingCourseTypeVersion);
	}
	protected TrainingCourseType forgetByAllInternal(YoubenbenUserContext userContext,
			String trainingCourseTypeId, int trainingCourseTypeVersion) throws Exception{
	...
	protected TrainingCourseType breakWithCompanyTrainingByCompany(YoubenbenUserContext userContext, String trainingCourseTypeId, String companyId,  String [] tokensExpr)
		 throws Exception{
	...
	protected TrainingCourseType breakWithCompanyTrainingByInstructor(YoubenbenUserContext userContext, String trainingCourseTypeId, String instructorId,  String [] tokensExpr)
		 throws Exception{
	...
	protected void checkParamsForAddingCompanyTraining(YoubenbenUserContext userContext, String trainingCourseTypeId, String title, String companyId, String instructorId, Date timeStart, int durationHours,String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForUpdatingCompanyTrainingProperties(YoubenbenUserContext userContext, String trainingCourseTypeId,String id,String title,Date timeStart,int durationHours,String [] tokensExpr) throws Exception {
	...
	public  TrainingCourseType updateCompanyTrainingProperties(YoubenbenUserContext userContext, String trainingCourseTypeId, String id,String title,Date timeStart,int durationHours, String [] tokensExpr) throws Exception
	{
	...
	protected CompanyTraining createCompanyTraining(YoubenbenUserContext userContext, String title, String companyId, String instructorId, Date timeStart, int durationHours) throws Exception{
	...
	protected void checkParamsForRemovingCompanyTrainingList(YoubenbenUserContext userContext, String trainingCourseTypeId,
	...
	public  TrainingCourseType removeCompanyTrainingList(YoubenbenUserContext userContext, String trainingCourseTypeId,
			String companyTrainingIds[],String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForRemovingCompanyTraining(YoubenbenUserContext userContext, String trainingCourseTypeId,
	...
	public  TrainingCourseType removeCompanyTraining(YoubenbenUserContext userContext, String trainingCourseTypeId,
		String companyTrainingId, int companyTrainingVersion,String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForCopyingCompanyTraining(YoubenbenUserContext userContext, String trainingCourseTypeId,
		String companyTrainingId, int companyTrainingVersion,String [] tokensExpr) throws Exception{
	...
	public  TrainingCourseType copyCompanyTrainingFrom(YoubenbenUserContext userContext, String trainingCourseTypeId,
		String companyTrainingId, int companyTrainingVersion,String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForUpdatingCompanyTraining(YoubenbenUserContext userContext, String trainingCourseTypeId, String companyTrainingId, int companyTrainingVersion, String property, String newValueExpr,String [] tokensExpr) throws Exception{
	...
	public  TrainingCourseType updateCompanyTraining(YoubenbenUserContext userContext, String trainingCourseTypeId, String companyTrainingId, int companyTrainingVersion, String property, String newValueExpr,String [] tokensExpr)
			throws Exception{
	...
	*/
	...
	// -----------------------------------// list-of-view 处理 \\-----------------------------------
    protected void enhanceForListOfView(YoubenbenUserContext userContext,SmartList<TrainingCourseType> list) throws Exception {
  ...
  // -----------------------------------\\ list-of-view 处理 //-----------------------------------v
	 ...
	 * @throws Exception
	 */
 	public Object wxappview(YoubenbenUserContext userContext, String trainingCourseTypeId) throws Exception{
	  SerializeScope vscope = YoubenbenViewScope.getInstance().getTrainingCourseTypeDetailScope().clone();
