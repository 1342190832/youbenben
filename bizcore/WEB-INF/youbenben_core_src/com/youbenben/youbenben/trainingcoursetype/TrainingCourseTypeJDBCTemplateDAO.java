...
public class TrainingCourseTypeJDBCTemplateDAO extends YoubenbenBaseDAOImpl implements TrainingCourseTypeDAO{
	...
	*/
    ...
    public SmartList<TrainingCourseType> requestCandidateTrainingCourseTypeForCompanyTraining(YoubenbenUserContext userContext, String ownerClass, String id, String filterKey, int pageNo, int pageSize) throws Exception {
	...
	public SmartList<CompanyTraining> loadOurCompanyTrainingList(YoubenbenUserContext userContext, List<TrainingCourseType> us, Map<String,Object> options) throws Exception{
