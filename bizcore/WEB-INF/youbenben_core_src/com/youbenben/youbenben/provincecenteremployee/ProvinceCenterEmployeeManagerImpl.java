...
import com.youbenben.youbenben.provincecenterdepartment.CandidateProvinceCenterDepartment;
...
public class ProvinceCenterEmployeeManagerImpl extends CustomYoubenbenCheckerManager implements ProvinceCenterEmployeeManager, BusinessHandler{
	...
	@Override
	public ProvinceCenterEmployeeDAO daoOf(YoubenbenUserContext userContext) {
	...
	protected void throwExceptionWithMessage(String value) throws ProvinceCenterEmployeeManagerException{
 	...
 	protected ProvinceCenterEmployee saveProvinceCenterEmployee(YoubenbenUserContext userContext, ProvinceCenterEmployee provinceCenterEmployee, String [] tokensExpr) throws Exception{	
 	...
 	protected ProvinceCenterEmployee saveProvinceCenterEmployeeDetail(YoubenbenUserContext userContext, ProvinceCenterEmployee provinceCenterEmployee) throws Exception{	
 	...
 	public ProvinceCenterEmployee loadProvinceCenterEmployee(YoubenbenUserContext userContext, String provinceCenterEmployeeId, String [] tokensExpr) throws Exception{				
 	 ...
 	 public ProvinceCenterEmployee searchProvinceCenterEmployee(YoubenbenUserContext userContext, String provinceCenterEmployeeId, String textToSearch,String [] tokensExpr) throws Exception{				
 	...
 	protected ProvinceCenterEmployee present(YoubenbenUserContext userContext, ProvinceCenterEmployee provinceCenterEmployee, Map<String, Object> tokens) throws Exception {
 	...
 	public ProvinceCenterEmployee loadProvinceCenterEmployeeDetail(YoubenbenUserContext userContext, String provinceCenterEmployeeId) throws Exception{	
 	...
 	public Object view(YoubenbenUserContext userContext, String provinceCenterEmployeeId) throws Exception{	
 		ProvinceCenterEmployee provinceCenterEmployee = loadProvinceCenterEmployee( userContext, provinceCenterEmployeeId, viewTokens());
 		return present(userContext,provinceCenterEmployee, allTokens());
		
 	}
 	protected ProvinceCenterEmployee saveProvinceCenterEmployee(YoubenbenUserContext userContext, ProvinceCenterEmployee provinceCenterEmployee, Map<String,Object>tokens) throws Exception{	
 		return provinceCenterEmployeeDaoOf(userContext).save(provinceCenterEmployee, tokens);
 	}
 	protected ProvinceCenterEmployee loadProvinceCenterEmployee(YoubenbenUserContext userContext, String provinceCenterEmployeeId, Map<String,Object>tokens) throws Exception{	
		checkerOf(userContext).checkIdOfProvinceCenterEmployee(provinceCenterEmployeeId);
		checkerOf(userContext).throwExceptionIfHasErrors( ProvinceCenterEmployeeManagerException.class);
 	...
 	protected<T extends BaseEntity> void addActions(YoubenbenUserContext userContext, ProvinceCenterEmployee provinceCenterEmployee, Map<String, Object> tokens){
	...
	}// end method of protected<T extends BaseEntity> void addActions(YoubenbenUserContext userContext, ProvinceCenterEmployee provinceCenterEmployee, Map<String, Object> tokens){
	...
	protected void checkParamsForUpdatingProvinceCenterEmployee(YoubenbenUserContext userContext,String provinceCenterEmployeeId, int provinceCenterEmployeeVersion, String property, String newValueExpr,String [] tokensExpr)throws Exception
	{
	...
	public ProvinceCenterEmployee clone(YoubenbenUserContext userContext, String fromProvinceCenterEmployeeId) throws Exception{
	...
	public ProvinceCenterEmployee internalSaveProvinceCenterEmployee(YoubenbenUserContext userContext, ProvinceCenterEmployee provinceCenterEmployee, Map<String,Object> options) throws Exception
	{
	...
	public ProvinceCenterEmployee updateProvinceCenterEmployeeProperty(YoubenbenUserContext userContext,String provinceCenterEmployeeId, int provinceCenterEmployeeVersion, String property, String newValueExpr,String [] tokensExpr) throws Exception
	{
		checkParamsForUpdatingProvinceCenterEmployee(userContext, provinceCenterEmployeeId, provinceCenterEmployeeVersion, property, newValueExpr, tokensExpr);
	...
	protected void checkParamsForTransferingAnotherDepartment(YoubenbenUserContext userContext, String provinceCenterEmployeeId, String anotherDepartmentId) throws Exception
 	{
	...
	public CandidateProvinceCenterDepartment requestCandidateDepartment(YoubenbenUserContext userContext, String ownerClass, String id, String filterKey, int pageNo) throws Exception {
 	...
 	protected void checkParamsForTransferingAnotherProvinceCenter(YoubenbenUserContext userContext, String provinceCenterEmployeeId, String anotherProvinceCenterId) throws Exception
 	{
 ...
 //--------------------------------------------------------------
 	...
 	protected ProvinceCenterDepartment loadProvinceCenterDepartment(YoubenbenUserContext userContext, String newDepartmentId, Map<String,Object> options) throws Exception
 	{
	...
	public void delete(YoubenbenUserContext userContext, String provinceCenterEmployeeId, int provinceCenterEmployeeVersion) throws Exception {
	...
	public ProvinceCenterEmployee forgetByAll(YoubenbenUserContext userContext, String provinceCenterEmployeeId, int provinceCenterEmployeeVersion) throws Exception {
		return forgetByAllInternal(userContext, provinceCenterEmployeeId, provinceCenterEmployeeVersion);
	}
	protected ProvinceCenterEmployee forgetByAllInternal(YoubenbenUserContext userContext,
			String provinceCenterEmployeeId, int provinceCenterEmployeeVersion) throws Exception{
	...
	// -----------------------------------// list-of-view 处理 \\-----------------------------------
    protected void enhanceForListOfView(YoubenbenUserContext userContext,SmartList<ProvinceCenterEmployee> list) throws Exception {
    	if (list == null || list.isEmpty()){
    		return;
    	}
		List<ProvinceCenterDepartment> departmentList = YoubenbenBaseUtils.collectReferencedObjectWithType(userContext, list, ProvinceCenterDepartment.class);
  ...
  // -----------------------------------\\ list-of-view 处理 //-----------------------------------v
	 ...
	 * @throws Exception
	 */
 	public Object wxappview(YoubenbenUserContext userContext, String provinceCenterEmployeeId) throws Exception{
	  SerializeScope vscope = YoubenbenViewScope.getInstance().getProvinceCenterEmployeeDetailScope().clone();
