...
public class OccupationTypeJDBCTemplateDAO extends YoubenbenBaseDAOImpl implements OccupationTypeDAO{
	...
	*/
    ...
    public SmartList<OccupationType> requestCandidateOccupationTypeForEmployee(YoubenbenUserContext userContext, String ownerClass, String id, String filterKey, int pageNo, int pageSize) throws Exception {
	...
	public SmartList<Employee> loadOurEmployeeList(YoubenbenUserContext userContext, List<OccupationType> us, Map<String,Object> options) throws Exception{
