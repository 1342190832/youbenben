...
import com.youbenben.youbenben.potentialcustomercontactperson.CandidatePotentialCustomerContactPerson;
...
public class PotentialCustomerContactManagerImpl extends CustomYoubenbenCheckerManager implements PotentialCustomerContactManager, BusinessHandler{
	...
	@Override
	public PotentialCustomerContactDAO daoOf(YoubenbenUserContext userContext) {
	...
	protected void throwExceptionWithMessage(String value) throws PotentialCustomerContactManagerException{
 	...
 	protected PotentialCustomerContact savePotentialCustomerContact(YoubenbenUserContext userContext, PotentialCustomerContact potentialCustomerContact, String [] tokensExpr) throws Exception{	
 	...
 	protected PotentialCustomerContact savePotentialCustomerContactDetail(YoubenbenUserContext userContext, PotentialCustomerContact potentialCustomerContact) throws Exception{	
 	...
 	public PotentialCustomerContact loadPotentialCustomerContact(YoubenbenUserContext userContext, String potentialCustomerContactId, String [] tokensExpr) throws Exception{				
 	 ...
 	 public PotentialCustomerContact searchPotentialCustomerContact(YoubenbenUserContext userContext, String potentialCustomerContactId, String textToSearch,String [] tokensExpr) throws Exception{				
 	...
 	protected PotentialCustomerContact present(YoubenbenUserContext userContext, PotentialCustomerContact potentialCustomerContact, Map<String, Object> tokens) throws Exception {
 	...
 	public PotentialCustomerContact loadPotentialCustomerContactDetail(YoubenbenUserContext userContext, String potentialCustomerContactId) throws Exception{	
 	...
 	public Object view(YoubenbenUserContext userContext, String potentialCustomerContactId) throws Exception{	
 	...
 	protected PotentialCustomerContact savePotentialCustomerContact(YoubenbenUserContext userContext, PotentialCustomerContact potentialCustomerContact, Map<String,Object>tokens) throws Exception{	
 		return potentialCustomerContactDaoOf(userContext).save(potentialCustomerContact, tokens);
 	}
 	protected PotentialCustomerContact loadPotentialCustomerContact(YoubenbenUserContext userContext, String potentialCustomerContactId, Map<String,Object>tokens) throws Exception{	
		checkerOf(userContext).checkIdOfPotentialCustomerContact(potentialCustomerContactId);
		checkerOf(userContext).throwExceptionIfHasErrors( PotentialCustomerContactManagerException.class);
 	...
 	protected<T extends BaseEntity> void addActions(YoubenbenUserContext userContext, PotentialCustomerContact potentialCustomerContact, Map<String, Object> tokens){
	...
	}// end method of protected<T extends BaseEntity> void addActions(YoubenbenUserContext userContext, PotentialCustomerContact potentialCustomerContact, Map<String, Object> tokens){
	...
	protected void checkParamsForUpdatingPotentialCustomerContact(YoubenbenUserContext userContext,String potentialCustomerContactId, int potentialCustomerContactVersion, String property, String newValueExpr,String [] tokensExpr)throws Exception
	{
	...
	public PotentialCustomerContact clone(YoubenbenUserContext userContext, String fromPotentialCustomerContactId) throws Exception{
	...
	public PotentialCustomerContact internalSavePotentialCustomerContact(YoubenbenUserContext userContext, PotentialCustomerContact potentialCustomerContact, Map<String,Object> options) throws Exception
	{
	...
	public PotentialCustomerContact updatePotentialCustomerContactProperty(YoubenbenUserContext userContext,String potentialCustomerContactId, int potentialCustomerContactVersion, String property, String newValueExpr,String [] tokensExpr) throws Exception
	{
		checkParamsForUpdatingPotentialCustomerContact(userContext, potentialCustomerContactId, potentialCustomerContactVersion, property, newValueExpr, tokensExpr);
	...
	protected void checkParamsForTransferingAnotherPotentialCustomer(YoubenbenUserContext userContext, String potentialCustomerContactId, String anotherPotentialCustomerId) throws Exception
 	{
	...
	public CandidatePotentialCustomer requestCandidatePotentialCustomer(YoubenbenUserContext userContext, String ownerClass, String id, String filterKey, int pageNo) throws Exception {
 	...
 	protected void checkParamsForTransferingAnotherCityPartner(YoubenbenUserContext userContext, String potentialCustomerContactId, String anotherCityPartnerId) throws Exception
 	{
	...
	public CandidateCityPartner requestCandidateCityPartner(YoubenbenUserContext userContext, String ownerClass, String id, String filterKey, int pageNo) throws Exception {
 	...
 	protected void checkParamsForTransferingAnotherContactTo(YoubenbenUserContext userContext, String potentialCustomerContactId, String anotherContactToId) throws Exception
 	{
	...
	public CandidatePotentialCustomerContactPerson requestCandidateContactTo(YoubenbenUserContext userContext, String ownerClass, String id, String filterKey, int pageNo) throws Exception {
 ...
 //--------------------------------------------------------------
 	...
 	protected PotentialCustomerContactPerson loadPotentialCustomerContactPerson(YoubenbenUserContext userContext, String newContactToId, Map<String,Object> options) throws Exception
 	{
	...
	public void delete(YoubenbenUserContext userContext, String potentialCustomerContactId, int potentialCustomerContactVersion) throws Exception {
	...
	public PotentialCustomerContact forgetByAll(YoubenbenUserContext userContext, String potentialCustomerContactId, int potentialCustomerContactVersion) throws Exception {
		return forgetByAllInternal(userContext, potentialCustomerContactId, potentialCustomerContactVersion);
	}
	protected PotentialCustomerContact forgetByAllInternal(YoubenbenUserContext userContext,
			String potentialCustomerContactId, int potentialCustomerContactVersion) throws Exception{
	...
	// -----------------------------------// list-of-view 处理 \\-----------------------------------
    protected void enhanceForListOfView(YoubenbenUserContext userContext,SmartList<PotentialCustomerContact> list) throws Exception {
		...
		List<PotentialCustomerContactPerson> contactToList = YoubenbenBaseUtils.collectReferencedObjectWithType(userContext, list, PotentialCustomerContactPerson.class);
  ...
  // -----------------------------------\\ list-of-view 处理 //-----------------------------------v
	 ...
	 * @throws Exception
	 */
 	public Object wxappview(YoubenbenUserContext userContext, String potentialCustomerContactId) throws Exception{
	  SerializeScope vscope = YoubenbenViewScope.getInstance().getPotentialCustomerContactDetailScope().clone();
