...
public class ProvinceCenterDepartmentManagerImpl extends CustomYoubenbenCheckerManager implements ProvinceCenterDepartmentManager, BusinessHandler{
	...
	@Override
	public ProvinceCenterDepartmentDAO daoOf(YoubenbenUserContext userContext) {
	...
	protected void throwExceptionWithMessage(String value) throws ProvinceCenterDepartmentManagerException{
 	...
 	protected ProvinceCenterDepartment saveProvinceCenterDepartment(YoubenbenUserContext userContext, ProvinceCenterDepartment provinceCenterDepartment, String [] tokensExpr) throws Exception{	
 	...
 	protected ProvinceCenterDepartment saveProvinceCenterDepartmentDetail(YoubenbenUserContext userContext, ProvinceCenterDepartment provinceCenterDepartment) throws Exception{	
 	...
 	public ProvinceCenterDepartment loadProvinceCenterDepartment(YoubenbenUserContext userContext, String provinceCenterDepartmentId, String [] tokensExpr) throws Exception{				
 	 ...
 	 public ProvinceCenterDepartment searchProvinceCenterDepartment(YoubenbenUserContext userContext, String provinceCenterDepartmentId, String textToSearch,String [] tokensExpr) throws Exception{				
 	...
 	protected ProvinceCenterDepartment present(YoubenbenUserContext userContext, ProvinceCenterDepartment provinceCenterDepartment, Map<String, Object> tokens) throws Exception {
 	...
 	public ProvinceCenterDepartment loadProvinceCenterDepartmentDetail(YoubenbenUserContext userContext, String provinceCenterDepartmentId) throws Exception{	
 	...
 	public Object view(YoubenbenUserContext userContext, String provinceCenterDepartmentId) throws Exception{	
 	...
 	protected ProvinceCenterDepartment saveProvinceCenterDepartment(YoubenbenUserContext userContext, ProvinceCenterDepartment provinceCenterDepartment, Map<String,Object>tokens) throws Exception{	
 		return provinceCenterDepartmentDaoOf(userContext).save(provinceCenterDepartment, tokens);
 	}
 	protected ProvinceCenterDepartment loadProvinceCenterDepartment(YoubenbenUserContext userContext, String provinceCenterDepartmentId, Map<String,Object>tokens) throws Exception{	
		checkerOf(userContext).checkIdOfProvinceCenterDepartment(provinceCenterDepartmentId);
		checkerOf(userContext).throwExceptionIfHasErrors( ProvinceCenterDepartmentManagerException.class);
 	...
 	protected<T extends BaseEntity> void addActions(YoubenbenUserContext userContext, ProvinceCenterDepartment provinceCenterDepartment, Map<String, Object> tokens){
	...
	}// end method of protected<T extends BaseEntity> void addActions(YoubenbenUserContext userContext, ProvinceCenterDepartment provinceCenterDepartment, Map<String, Object> tokens){
	...
	protected void checkParamsForUpdatingProvinceCenterDepartment(YoubenbenUserContext userContext,String provinceCenterDepartmentId, int provinceCenterDepartmentVersion, String property, String newValueExpr,String [] tokensExpr)throws Exception
	{
	...
	public ProvinceCenterDepartment clone(YoubenbenUserContext userContext, String fromProvinceCenterDepartmentId) throws Exception{
	...
	public ProvinceCenterDepartment internalSaveProvinceCenterDepartment(YoubenbenUserContext userContext, ProvinceCenterDepartment provinceCenterDepartment, Map<String,Object> options) throws Exception
	{
	...
	public ProvinceCenterDepartment updateProvinceCenterDepartmentProperty(YoubenbenUserContext userContext,String provinceCenterDepartmentId, int provinceCenterDepartmentVersion, String property, String newValueExpr,String [] tokensExpr) throws Exception
	{
		checkParamsForUpdatingProvinceCenterDepartment(userContext, provinceCenterDepartmentId, provinceCenterDepartmentVersion, property, newValueExpr, tokensExpr);
	...
	protected void checkParamsForTransferingAnotherProvinceCenter(YoubenbenUserContext userContext, String provinceCenterDepartmentId, String anotherProvinceCenterId) throws Exception
 	{
	...
	public CandidateRetailStoreProvinceCenter requestCandidateProvinceCenter(YoubenbenUserContext userContext, String ownerClass, String id, String filterKey, int pageNo) throws Exception {
 ...
 //--------------------------------------------------------------
 	...
 	protected RetailStoreProvinceCenter loadRetailStoreProvinceCenter(YoubenbenUserContext userContext, String newProvinceCenterId, Map<String,Object> options) throws Exception
 	{
	...
	public void delete(YoubenbenUserContext userContext, String provinceCenterDepartmentId, int provinceCenterDepartmentVersion) throws Exception {
	...
	public ProvinceCenterDepartment forgetByAll(YoubenbenUserContext userContext, String provinceCenterDepartmentId, int provinceCenterDepartmentVersion) throws Exception {
		return forgetByAllInternal(userContext, provinceCenterDepartmentId, provinceCenterDepartmentVersion);
	}
	protected ProvinceCenterDepartment forgetByAllInternal(YoubenbenUserContext userContext,
			String provinceCenterDepartmentId, int provinceCenterDepartmentVersion) throws Exception{
	...
	protected ProvinceCenterDepartment breakWithProvinceCenterEmployeeByProvinceCenter(YoubenbenUserContext userContext, String provinceCenterDepartmentId, String provinceCenterId,  String [] tokensExpr)
		 throws Exception{
	...
	protected void checkParamsForAddingProvinceCenterEmployee(YoubenbenUserContext userContext, String provinceCenterDepartmentId, String name, String mobile, String email, Date founded, String provinceCenterId,String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForUpdatingProvinceCenterEmployeeProperties(YoubenbenUserContext userContext, String provinceCenterDepartmentId,String id,String name,String mobile,String email,Date founded,String [] tokensExpr) throws Exception {
	...
	public  ProvinceCenterDepartment updateProvinceCenterEmployeeProperties(YoubenbenUserContext userContext, String provinceCenterDepartmentId, String id,String name,String mobile,String email,Date founded, String [] tokensExpr) throws Exception
	{
	...
	protected ProvinceCenterEmployee createProvinceCenterEmployee(YoubenbenUserContext userContext, String name, String mobile, String email, Date founded, String provinceCenterId) throws Exception{
	...
	protected void checkParamsForRemovingProvinceCenterEmployeeList(YoubenbenUserContext userContext, String provinceCenterDepartmentId,
	...
	public  ProvinceCenterDepartment removeProvinceCenterEmployeeList(YoubenbenUserContext userContext, String provinceCenterDepartmentId,
			String provinceCenterEmployeeIds[],String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForRemovingProvinceCenterEmployee(YoubenbenUserContext userContext, String provinceCenterDepartmentId,
	...
	public  ProvinceCenterDepartment removeProvinceCenterEmployee(YoubenbenUserContext userContext, String provinceCenterDepartmentId,
		String provinceCenterEmployeeId, int provinceCenterEmployeeVersion,String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForCopyingProvinceCenterEmployee(YoubenbenUserContext userContext, String provinceCenterDepartmentId,
		String provinceCenterEmployeeId, int provinceCenterEmployeeVersion,String [] tokensExpr) throws Exception{
	...
	public  ProvinceCenterDepartment copyProvinceCenterEmployeeFrom(YoubenbenUserContext userContext, String provinceCenterDepartmentId,
		String provinceCenterEmployeeId, int provinceCenterEmployeeVersion,String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForUpdatingProvinceCenterEmployee(YoubenbenUserContext userContext, String provinceCenterDepartmentId, String provinceCenterEmployeeId, int provinceCenterEmployeeVersion, String property, String newValueExpr,String [] tokensExpr) throws Exception{
	...
	public  ProvinceCenterDepartment updateProvinceCenterEmployee(YoubenbenUserContext userContext, String provinceCenterDepartmentId, String provinceCenterEmployeeId, int provinceCenterEmployeeVersion, String property, String newValueExpr,String [] tokensExpr)
			throws Exception{
	...
	*/
	...
	// -----------------------------------// list-of-view 处理 \\-----------------------------------
    protected void enhanceForListOfView(YoubenbenUserContext userContext,SmartList<ProvinceCenterDepartment> list) throws Exception {
    	if (list == null || list.isEmpty()){
    		return;
    	}
		List<RetailStoreProvinceCenter> provinceCenterList = YoubenbenBaseUtils.collectReferencedObjectWithType(userContext, list, RetailStoreProvinceCenter.class);
  ...
  // -----------------------------------\\ list-of-view 处理 //-----------------------------------v
	 ...
	 * @throws Exception
	 */
 	public Object wxappview(YoubenbenUserContext userContext, String provinceCenterDepartmentId) throws Exception{
	  SerializeScope vscope = YoubenbenViewScope.getInstance().getProvinceCenterDepartmentDetailScope().clone();
