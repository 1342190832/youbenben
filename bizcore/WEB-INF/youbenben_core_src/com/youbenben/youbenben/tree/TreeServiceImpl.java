...
public class TreeServiceImpl extends CustomYoubenbenCheckerManager implements TreeService {

    @Override
    public Node loadTree(YoubenbenUserContext ctx, String nodeId, String nodeType) throws Exception {
    ...
    @Override
    public Node loadAncestors(YoubenbenUserContext ctx, String nodeId, String nodeType) throws Exception {
        SmartList<TreeNode> nodes = loadTreeNode(ctx, nodeId, nodeType);
    ...
    public SmartList<TreeNode> loadTreeNode(YoubenbenUserContext ctx, String nodeId, String nodeType) {
     ...
     * @throws Exception
     */
    private <T extends BaseEntity> Node<T> extractTreeFromRoot(YoubenbenUserContext ctx, TreeNode pRoot) throws Exception {
    ...
    private <T extends BaseEntity> Node<T> extractAncestors(YoubenbenUserContext ctx, TreeNode pNode) throws Exception {
    ...
    @Override
    public Node addChild(YoubenbenUserContext ctx, Node nodeTree, String childId, String childType) throws Exception {
    ...
    public Node ensureRoot(YoubenbenUserContext ctx) throws Exception {
    ...
    @Override
    public Node deleteChild(YoubenbenUserContext ctx, Node parent, Node child) throws Exception {
        //do nothing
    ...
    private Node buildInternalTree(YoubenbenUserContext ctx, final List<TreeNode> pTreeNodes) throws Exception {
