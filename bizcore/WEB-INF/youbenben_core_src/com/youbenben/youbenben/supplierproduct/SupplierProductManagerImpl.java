...
public class SupplierProductManagerImpl extends CustomYoubenbenCheckerManager implements SupplierProductManager, BusinessHandler{
	...
	@Override
	public SupplierProductDAO daoOf(YoubenbenUserContext userContext) {
	...
	protected void throwExceptionWithMessage(String value) throws SupplierProductManagerException{
 	...
 	protected SupplierProduct saveSupplierProduct(YoubenbenUserContext userContext, SupplierProduct supplierProduct, String [] tokensExpr) throws Exception{	
 	...
 	protected SupplierProduct saveSupplierProductDetail(YoubenbenUserContext userContext, SupplierProduct supplierProduct) throws Exception{	
 	...
 	public SupplierProduct loadSupplierProduct(YoubenbenUserContext userContext, String supplierProductId, String [] tokensExpr) throws Exception{				
 	 ...
 	 public SupplierProduct searchSupplierProduct(YoubenbenUserContext userContext, String supplierProductId, String textToSearch,String [] tokensExpr) throws Exception{				
 	...
 	protected SupplierProduct present(YoubenbenUserContext userContext, SupplierProduct supplierProduct, Map<String, Object> tokens) throws Exception {
 	...
 	public SupplierProduct loadSupplierProductDetail(YoubenbenUserContext userContext, String supplierProductId) throws Exception{	
 	...
 	public Object view(YoubenbenUserContext userContext, String supplierProductId) throws Exception{	
 		SupplierProduct supplierProduct = loadSupplierProduct( userContext, supplierProductId, viewTokens());
 		return present(userContext,supplierProduct, allTokens());
		
 	}
 	protected SupplierProduct saveSupplierProduct(YoubenbenUserContext userContext, SupplierProduct supplierProduct, Map<String,Object>tokens) throws Exception{	
 		return supplierProductDaoOf(userContext).save(supplierProduct, tokens);
 	}
 	protected SupplierProduct loadSupplierProduct(YoubenbenUserContext userContext, String supplierProductId, Map<String,Object>tokens) throws Exception{	
		checkerOf(userContext).checkIdOfSupplierProduct(supplierProductId);
		checkerOf(userContext).throwExceptionIfHasErrors( SupplierProductManagerException.class);
 	...
 	protected<T extends BaseEntity> void addActions(YoubenbenUserContext userContext, SupplierProduct supplierProduct, Map<String, Object> tokens){
	...
	}// end method of protected<T extends BaseEntity> void addActions(YoubenbenUserContext userContext, SupplierProduct supplierProduct, Map<String, Object> tokens){
	...
	protected void checkParamsForUpdatingSupplierProduct(YoubenbenUserContext userContext,String supplierProductId, int supplierProductVersion, String property, String newValueExpr,String [] tokensExpr)throws Exception
	{
	...
	public SupplierProduct clone(YoubenbenUserContext userContext, String fromSupplierProductId) throws Exception{
	...
	public SupplierProduct internalSaveSupplierProduct(YoubenbenUserContext userContext, SupplierProduct supplierProduct, Map<String,Object> options) throws Exception
	{
	...
	public SupplierProduct updateSupplierProductProperty(YoubenbenUserContext userContext,String supplierProductId, int supplierProductVersion, String property, String newValueExpr,String [] tokensExpr) throws Exception
	{
		checkParamsForUpdatingSupplierProduct(userContext, supplierProductId, supplierProductVersion, property, newValueExpr, tokensExpr);
	...
	protected void checkParamsForTransferingAnotherSupplier(YoubenbenUserContext userContext, String supplierProductId, String anotherSupplierId) throws Exception
 	{
	...
	public CandidateGoodsSupplier requestCandidateSupplier(YoubenbenUserContext userContext, String ownerClass, String id, String filterKey, int pageNo) throws Exception {
 ...
 //--------------------------------------------------------------
 	...
 	protected GoodsSupplier loadGoodsSupplier(YoubenbenUserContext userContext, String newSupplierId, Map<String,Object> options) throws Exception
 	{
	...
	public void delete(YoubenbenUserContext userContext, String supplierProductId, int supplierProductVersion) throws Exception {
	...
	public SupplierProduct forgetByAll(YoubenbenUserContext userContext, String supplierProductId, int supplierProductVersion) throws Exception {
		return forgetByAllInternal(userContext, supplierProductId, supplierProductVersion);
	}
	protected SupplierProduct forgetByAllInternal(YoubenbenUserContext userContext,
			String supplierProductId, int supplierProductVersion) throws Exception{
	...
	protected void checkParamsForAddingProductSupplyDuration(YoubenbenUserContext userContext, String supplierProductId, int quantity, String duration, BigDecimal price,String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForUpdatingProductSupplyDurationProperties(YoubenbenUserContext userContext, String supplierProductId,String id,int quantity,String duration,BigDecimal price,String [] tokensExpr) throws Exception {
	...
	public  SupplierProduct updateProductSupplyDurationProperties(YoubenbenUserContext userContext, String supplierProductId, String id,int quantity,String duration,BigDecimal price, String [] tokensExpr) throws Exception
	{
	...
	protected ProductSupplyDuration createProductSupplyDuration(YoubenbenUserContext userContext, int quantity, String duration, BigDecimal price) throws Exception{
	...
	protected void checkParamsForRemovingProductSupplyDurationList(YoubenbenUserContext userContext, String supplierProductId,
	...
	public  SupplierProduct removeProductSupplyDurationList(YoubenbenUserContext userContext, String supplierProductId,
			String productSupplyDurationIds[],String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForRemovingProductSupplyDuration(YoubenbenUserContext userContext, String supplierProductId,
	...
	public  SupplierProduct removeProductSupplyDuration(YoubenbenUserContext userContext, String supplierProductId,
		String productSupplyDurationId, int productSupplyDurationVersion,String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForCopyingProductSupplyDuration(YoubenbenUserContext userContext, String supplierProductId,
		String productSupplyDurationId, int productSupplyDurationVersion,String [] tokensExpr) throws Exception{
	...
	public  SupplierProduct copyProductSupplyDurationFrom(YoubenbenUserContext userContext, String supplierProductId,
		String productSupplyDurationId, int productSupplyDurationVersion,String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForUpdatingProductSupplyDuration(YoubenbenUserContext userContext, String supplierProductId, String productSupplyDurationId, int productSupplyDurationVersion, String property, String newValueExpr,String [] tokensExpr) throws Exception{
	...
	public  SupplierProduct updateProductSupplyDuration(YoubenbenUserContext userContext, String supplierProductId, String productSupplyDurationId, int productSupplyDurationVersion, String property, String newValueExpr,String [] tokensExpr)
			throws Exception{
	...
	*/
	...
	// -----------------------------------// list-of-view 处理 \\-----------------------------------
    protected void enhanceForListOfView(YoubenbenUserContext userContext,SmartList<SupplierProduct> list) throws Exception {
    	if (list == null || list.isEmpty()){
    		return;
    	}
		List<GoodsSupplier> supplierList = YoubenbenBaseUtils.collectReferencedObjectWithType(userContext, list, GoodsSupplier.class);
  ...
  // -----------------------------------\\ list-of-view 处理 //-----------------------------------v
	 ...
	 * @throws Exception
	 */
 	public Object wxappview(YoubenbenUserContext userContext, String supplierProductId) throws Exception{
	  SerializeScope vscope = YoubenbenViewScope.getInstance().getSupplierProductDetailScope().clone();
    ...
    String pageTitle = "供应商的产品"+"详情";
		...
		vscope.field("productSupplyDurationListSection", YoubenbenListOfViewScope.getInstance()
