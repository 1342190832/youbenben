...
public class SupplierProductJDBCTemplateDAO extends YoubenbenBaseDAOImpl implements SupplierProductDAO{
	...
	*/
    ...
    public SmartList<SupplierProduct> requestCandidateSupplierProductForProductSupplyDuration(YoubenbenUserContext userContext, String ownerClass, String id, String filterKey, int pageNo, int pageSize) throws Exception {
	...
	public SmartList<ProductSupplyDuration> loadOurProductSupplyDurationList(YoubenbenUserContext userContext, List<SupplierProduct> us, Map<String,Object> options) throws Exception{
