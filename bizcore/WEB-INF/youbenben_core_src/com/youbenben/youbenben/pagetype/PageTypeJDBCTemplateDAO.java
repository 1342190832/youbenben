...
public class PageTypeJDBCTemplateDAO extends YoubenbenBaseDAOImpl implements PageTypeDAO{
	...
	*/
    ...
    public SmartList<PageType> requestCandidatePageTypeForPage(YoubenbenUserContext userContext, String ownerClass, String id, String filterKey, int pageNo, int pageSize) throws Exception {
	...
	public SmartList<Page> loadOurPageList(YoubenbenUserContext userContext, List<PageType> us, Map<String,Object> options) throws Exception{
