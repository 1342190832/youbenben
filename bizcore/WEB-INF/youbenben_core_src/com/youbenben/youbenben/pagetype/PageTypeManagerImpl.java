...
public class PageTypeManagerImpl extends CustomYoubenbenCheckerManager implements PageTypeManager, BusinessHandler{
	...
	@Override
	public PageTypeDAO daoOf(YoubenbenUserContext userContext) {
	...
	protected void throwExceptionWithMessage(String value) throws PageTypeManagerException{
 	...
 	protected PageType savePageType(YoubenbenUserContext userContext, PageType pageType, String [] tokensExpr) throws Exception{	
 	...
 	protected PageType savePageTypeDetail(YoubenbenUserContext userContext, PageType pageType) throws Exception{	
 	...
 	public PageType loadPageType(YoubenbenUserContext userContext, String pageTypeId, String [] tokensExpr) throws Exception{				
 	 ...
 	 public PageType searchPageType(YoubenbenUserContext userContext, String pageTypeId, String textToSearch,String [] tokensExpr) throws Exception{				
 	...
 	protected PageType present(YoubenbenUserContext userContext, PageType pageType, Map<String, Object> tokens) throws Exception {
 	...
 	public PageType loadPageTypeDetail(YoubenbenUserContext userContext, String pageTypeId) throws Exception{	
 		PageType pageType = loadPageType( userContext, pageTypeId, allTokens());
 		return present(userContext,pageType, allTokens());
		
 	}
 	
 	public Object view(YoubenbenUserContext userContext, String pageTypeId) throws Exception{	
 		PageType pageType = loadPageType( userContext, pageTypeId, viewTokens());
 		return present(userContext,pageType, allTokens());
		
 	}
 	protected PageType savePageType(YoubenbenUserContext userContext, PageType pageType, Map<String,Object>tokens) throws Exception{	
 		return pageTypeDaoOf(userContext).save(pageType, tokens);
 	}
 	protected PageType loadPageType(YoubenbenUserContext userContext, String pageTypeId, Map<String,Object>tokens) throws Exception{	
		checkerOf(userContext).checkIdOfPageType(pageTypeId);
		checkerOf(userContext).throwExceptionIfHasErrors( PageTypeManagerException.class);
	...
	public PageType loadPageTypeWithCode(YoubenbenUserContext userContext, String code, Map<String,Object>tokens) throws Exception{	
 	...
 	protected<T extends BaseEntity> void addActions(YoubenbenUserContext userContext, PageType pageType, Map<String, Object> tokens){
	...
	}// end method of protected<T extends BaseEntity> void addActions(YoubenbenUserContext userContext, PageType pageType, Map<String, Object> tokens){
	...
	protected void checkParamsForUpdatingPageType(YoubenbenUserContext userContext,String pageTypeId, int pageTypeVersion, String property, String newValueExpr,String [] tokensExpr)throws Exception
	{
	...
	public PageType clone(YoubenbenUserContext userContext, String fromPageTypeId) throws Exception{
	...
	public PageType internalSavePageType(YoubenbenUserContext userContext, PageType pageType, Map<String,Object> options) throws Exception
	{
	...
	public PageType updatePageTypeProperty(YoubenbenUserContext userContext,String pageTypeId, int pageTypeVersion, String property, String newValueExpr,String [] tokensExpr) throws Exception
	{
		checkParamsForUpdatingPageType(userContext, pageTypeId, pageTypeVersion, property, newValueExpr, tokensExpr);
	...
	protected void checkParamsForTransferingAnotherMobileApp(YoubenbenUserContext userContext, String pageTypeId, String anotherMobileAppId) throws Exception
 	{
 ...
 //--------------------------------------------------------------
	...
	public void delete(YoubenbenUserContext userContext, String pageTypeId, int pageTypeVersion) throws Exception {
	...
	public PageType forgetByAll(YoubenbenUserContext userContext, String pageTypeId, int pageTypeVersion) throws Exception {
		return forgetByAllInternal(userContext, pageTypeId, pageTypeVersion);
	}
	protected PageType forgetByAllInternal(YoubenbenUserContext userContext,
			String pageTypeId, int pageTypeVersion) throws Exception{
	...
	protected PageType breakWithPageByMobileApp(YoubenbenUserContext userContext, String pageTypeId, String mobileAppId,  String [] tokensExpr)
		 throws Exception{
	...
	protected void checkParamsForAddingPage(YoubenbenUserContext userContext, String pageTypeId, String pageTitle, String linkToUrl, String mobileAppId,String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForUpdatingPageProperties(YoubenbenUserContext userContext, String pageTypeId,String id,String pageTitle,String linkToUrl,String [] tokensExpr) throws Exception {
	...
	public  PageType updatePageProperties(YoubenbenUserContext userContext, String pageTypeId, String id,String pageTitle,String linkToUrl, String [] tokensExpr) throws Exception
	{
	...
	protected Page createPage(YoubenbenUserContext userContext, String pageTitle, String linkToUrl, String mobileAppId) throws Exception{
	...
	protected void checkParamsForRemovingPageList(YoubenbenUserContext userContext, String pageTypeId,
	...
	public  PageType removePageList(YoubenbenUserContext userContext, String pageTypeId,
			String pageIds[],String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForRemovingPage(YoubenbenUserContext userContext, String pageTypeId,
	...
	public  PageType removePage(YoubenbenUserContext userContext, String pageTypeId,
		String pageId, int pageVersion,String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForCopyingPage(YoubenbenUserContext userContext, String pageTypeId,
		String pageId, int pageVersion,String [] tokensExpr) throws Exception{
	...
	public  PageType copyPageFrom(YoubenbenUserContext userContext, String pageTypeId,
		String pageId, int pageVersion,String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForUpdatingPage(YoubenbenUserContext userContext, String pageTypeId, String pageId, int pageVersion, String property, String newValueExpr,String [] tokensExpr) throws Exception{
	...
	public  PageType updatePage(YoubenbenUserContext userContext, String pageTypeId, String pageId, int pageVersion, String property, String newValueExpr,String [] tokensExpr)
			throws Exception{
	...
	*/
	...
	// -----------------------------------// list-of-view 处理 \\-----------------------------------
    protected void enhanceForListOfView(YoubenbenUserContext userContext,SmartList<PageType> list) throws Exception {
  ...
  // -----------------------------------\\ list-of-view 处理 //-----------------------------------v
	 ...
	 * @throws Exception
	 */
 	public Object wxappview(YoubenbenUserContext userContext, String pageTypeId) throws Exception{
	  SerializeScope vscope = YoubenbenViewScope.getInstance().getPageTypeDetailScope().clone();
