...
public class TransportTruckManagerImpl extends CustomYoubenbenCheckerManager implements TransportTruckManager, BusinessHandler{
	...
	@Override
	public TransportTruckDAO daoOf(YoubenbenUserContext userContext) {
	...
	protected void throwExceptionWithMessage(String value) throws TransportTruckManagerException{
 	...
 	protected TransportTruck saveTransportTruck(YoubenbenUserContext userContext, TransportTruck transportTruck, String [] tokensExpr) throws Exception{	
 	...
 	protected TransportTruck saveTransportTruckDetail(YoubenbenUserContext userContext, TransportTruck transportTruck) throws Exception{	
 	...
 	public TransportTruck loadTransportTruck(YoubenbenUserContext userContext, String transportTruckId, String [] tokensExpr) throws Exception{				
 	 ...
 	 public TransportTruck searchTransportTruck(YoubenbenUserContext userContext, String transportTruckId, String textToSearch,String [] tokensExpr) throws Exception{				
 	...
 	protected TransportTruck present(YoubenbenUserContext userContext, TransportTruck transportTruck, Map<String, Object> tokens) throws Exception {
 	...
 	public TransportTruck loadTransportTruckDetail(YoubenbenUserContext userContext, String transportTruckId) throws Exception{	
 	...
 	public Object view(YoubenbenUserContext userContext, String transportTruckId) throws Exception{	
 		TransportTruck transportTruck = loadTransportTruck( userContext, transportTruckId, viewTokens());
 		return present(userContext,transportTruck, allTokens());
		
 	}
 	protected TransportTruck saveTransportTruck(YoubenbenUserContext userContext, TransportTruck transportTruck, Map<String,Object>tokens) throws Exception{	
 		return transportTruckDaoOf(userContext).save(transportTruck, tokens);
 	}
 	protected TransportTruck loadTransportTruck(YoubenbenUserContext userContext, String transportTruckId, Map<String,Object>tokens) throws Exception{	
		checkerOf(userContext).checkIdOfTransportTruck(transportTruckId);
		checkerOf(userContext).throwExceptionIfHasErrors( TransportTruckManagerException.class);
 	...
 	protected<T extends BaseEntity> void addActions(YoubenbenUserContext userContext, TransportTruck transportTruck, Map<String, Object> tokens){
	...
	}// end method of protected<T extends BaseEntity> void addActions(YoubenbenUserContext userContext, TransportTruck transportTruck, Map<String, Object> tokens){
	...
	protected void checkParamsForUpdatingTransportTruck(YoubenbenUserContext userContext,String transportTruckId, int transportTruckVersion, String property, String newValueExpr,String [] tokensExpr)throws Exception
	{
	...
	public TransportTruck clone(YoubenbenUserContext userContext, String fromTransportTruckId) throws Exception{
	...
	public TransportTruck internalSaveTransportTruck(YoubenbenUserContext userContext, TransportTruck transportTruck, Map<String,Object> options) throws Exception
	{
	...
	public TransportTruck updateTransportTruckProperty(YoubenbenUserContext userContext,String transportTruckId, int transportTruckVersion, String property, String newValueExpr,String [] tokensExpr) throws Exception
	{
		checkParamsForUpdatingTransportTruck(userContext, transportTruckId, transportTruckVersion, property, newValueExpr, tokensExpr);
	...
	protected void checkParamsForTransferingAnotherOwner(YoubenbenUserContext userContext, String transportTruckId, String anotherOwnerId) throws Exception
 	{
	...
	public CandidateTransportFleet requestCandidateOwner(YoubenbenUserContext userContext, String ownerClass, String id, String filterKey, int pageNo) throws Exception {
 ...
 //--------------------------------------------------------------
 	...
 	protected TransportFleet loadTransportFleet(YoubenbenUserContext userContext, String newOwnerId, Map<String,Object> options) throws Exception
 	{
	...
	public void delete(YoubenbenUserContext userContext, String transportTruckId, int transportTruckVersion) throws Exception {
	...
	public TransportTruck forgetByAll(YoubenbenUserContext userContext, String transportTruckId, int transportTruckVersion) throws Exception {
		return forgetByAllInternal(userContext, transportTruckId, transportTruckVersion);
	}
	protected TransportTruck forgetByAllInternal(YoubenbenUserContext userContext,
			String transportTruckId, int transportTruckVersion) throws Exception{
	...
	protected TransportTruck breakWithTransportTaskByEnd(YoubenbenUserContext userContext, String transportTruckId, String endId,  String [] tokensExpr)
		 throws Exception{
	...
	protected TransportTruck breakWithTransportTaskByDriver(YoubenbenUserContext userContext, String transportTruckId, String driverId,  String [] tokensExpr)
		 throws Exception{
	...
	protected TransportTruck breakWithTransportTaskByBelongsTo(YoubenbenUserContext userContext, String transportTruckId, String belongsToId,  String [] tokensExpr)
		 throws Exception{
	...
	protected void checkParamsForAddingTransportTask(YoubenbenUserContext userContext, String transportTruckId, String name, String start, Date beginTime, String endId, String driverId, String belongsToId, BigDecimal latitude, BigDecimal longitude,String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForUpdatingTransportTaskProperties(YoubenbenUserContext userContext, String transportTruckId,String id,String name,String start,Date beginTime,BigDecimal latitude,BigDecimal longitude,String [] tokensExpr) throws Exception {
	...
	public  TransportTruck updateTransportTaskProperties(YoubenbenUserContext userContext, String transportTruckId, String id,String name,String start,Date beginTime,BigDecimal latitude,BigDecimal longitude, String [] tokensExpr) throws Exception
	{
	...
	protected TransportTask createTransportTask(YoubenbenUserContext userContext, String name, String start, Date beginTime, String endId, String driverId, String belongsToId, BigDecimal latitude, BigDecimal longitude) throws Exception{
	...
	protected void checkParamsForRemovingTransportTaskList(YoubenbenUserContext userContext, String transportTruckId,
	...
	public  TransportTruck removeTransportTaskList(YoubenbenUserContext userContext, String transportTruckId,
			String transportTaskIds[],String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForRemovingTransportTask(YoubenbenUserContext userContext, String transportTruckId,
	...
	public  TransportTruck removeTransportTask(YoubenbenUserContext userContext, String transportTruckId,
		String transportTaskId, int transportTaskVersion,String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForCopyingTransportTask(YoubenbenUserContext userContext, String transportTruckId,
		String transportTaskId, int transportTaskVersion,String [] tokensExpr) throws Exception{
	...
	public  TransportTruck copyTransportTaskFrom(YoubenbenUserContext userContext, String transportTruckId,
		String transportTaskId, int transportTaskVersion,String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForUpdatingTransportTask(YoubenbenUserContext userContext, String transportTruckId, String transportTaskId, int transportTaskVersion, String property, String newValueExpr,String [] tokensExpr) throws Exception{
	...
	public  TransportTruck updateTransportTask(YoubenbenUserContext userContext, String transportTruckId, String transportTaskId, int transportTaskVersion, String property, String newValueExpr,String [] tokensExpr)
			throws Exception{
	...
	*/
	...
	// -----------------------------------// list-of-view 处理 \\-----------------------------------
    protected void enhanceForListOfView(YoubenbenUserContext userContext,SmartList<TransportTruck> list) throws Exception {
    	if (list == null || list.isEmpty()){
    		return;
    	}
		List<TransportFleet> ownerList = YoubenbenBaseUtils.collectReferencedObjectWithType(userContext, list, TransportFleet.class);
  ...
  // -----------------------------------\\ list-of-view 处理 //-----------------------------------v
	 ...
	 * @throws Exception
	 */
 	public Object wxappview(YoubenbenUserContext userContext, String transportTruckId) throws Exception{
	  SerializeScope vscope = YoubenbenViewScope.getInstance().getTransportTruckDetailScope().clone();
