...
public class RetailStoreClosingJDBCTemplateDAO extends YoubenbenBaseDAOImpl implements RetailStoreClosingDAO{
	...
	*/
    ...
    public SmartList<RetailStoreClosing> requestCandidateRetailStoreClosingForRetailStore(YoubenbenUserContext userContext, String ownerClass, String id, String filterKey, int pageNo, int pageSize) throws Exception {
	...
	public SmartList<RetailStore> loadOurRetailStoreList(YoubenbenUserContext userContext, List<RetailStoreClosing> us, Map<String,Object> options) throws Exception{
