...
public class RetailStoreClosingManagerImpl extends CustomYoubenbenCheckerManager implements RetailStoreClosingManager, BusinessHandler{
	...
	@Override
	public RetailStoreClosingDAO daoOf(YoubenbenUserContext userContext) {
	...
	protected void throwExceptionWithMessage(String value) throws RetailStoreClosingManagerException{
 	...
 	protected RetailStoreClosing saveRetailStoreClosing(YoubenbenUserContext userContext, RetailStoreClosing retailStoreClosing, String [] tokensExpr) throws Exception{	
 	...
 	protected RetailStoreClosing saveRetailStoreClosingDetail(YoubenbenUserContext userContext, RetailStoreClosing retailStoreClosing) throws Exception{	
 	...
 	public RetailStoreClosing loadRetailStoreClosing(YoubenbenUserContext userContext, String retailStoreClosingId, String [] tokensExpr) throws Exception{				
 	 ...
 	 public RetailStoreClosing searchRetailStoreClosing(YoubenbenUserContext userContext, String retailStoreClosingId, String textToSearch,String [] tokensExpr) throws Exception{				
 	...
 	protected RetailStoreClosing present(YoubenbenUserContext userContext, RetailStoreClosing retailStoreClosing, Map<String, Object> tokens) throws Exception {
 	...
 	public RetailStoreClosing loadRetailStoreClosingDetail(YoubenbenUserContext userContext, String retailStoreClosingId) throws Exception{	
 	...
 	public Object view(YoubenbenUserContext userContext, String retailStoreClosingId) throws Exception{	
 		RetailStoreClosing retailStoreClosing = loadRetailStoreClosing( userContext, retailStoreClosingId, viewTokens());
 		return present(userContext,retailStoreClosing, allTokens());
		
 	}
 	protected RetailStoreClosing saveRetailStoreClosing(YoubenbenUserContext userContext, RetailStoreClosing retailStoreClosing, Map<String,Object>tokens) throws Exception{	
 		return retailStoreClosingDaoOf(userContext).save(retailStoreClosing, tokens);
 	}
 	protected RetailStoreClosing loadRetailStoreClosing(YoubenbenUserContext userContext, String retailStoreClosingId, Map<String,Object>tokens) throws Exception{	
		checkerOf(userContext).checkIdOfRetailStoreClosing(retailStoreClosingId);
		checkerOf(userContext).throwExceptionIfHasErrors( RetailStoreClosingManagerException.class);
 	...
 	protected<T extends BaseEntity> void addActions(YoubenbenUserContext userContext, RetailStoreClosing retailStoreClosing, Map<String, Object> tokens){
	...
	}// end method of protected<T extends BaseEntity> void addActions(YoubenbenUserContext userContext, RetailStoreClosing retailStoreClosing, Map<String, Object> tokens){
	...
	protected void checkParamsForUpdatingRetailStoreClosing(YoubenbenUserContext userContext,String retailStoreClosingId, int retailStoreClosingVersion, String property, String newValueExpr,String [] tokensExpr)throws Exception
	{
	...
	public RetailStoreClosing clone(YoubenbenUserContext userContext, String fromRetailStoreClosingId) throws Exception{
	...
	public RetailStoreClosing internalSaveRetailStoreClosing(YoubenbenUserContext userContext, RetailStoreClosing retailStoreClosing, Map<String,Object> options) throws Exception
	{
	...
	public RetailStoreClosing updateRetailStoreClosingProperty(YoubenbenUserContext userContext,String retailStoreClosingId, int retailStoreClosingVersion, String property, String newValueExpr,String [] tokensExpr) throws Exception
	{
		checkParamsForUpdatingRetailStoreClosing(userContext, retailStoreClosingId, retailStoreClosingVersion, property, newValueExpr, tokensExpr);
...
//--------------------------------------------------------------
	...
	public void delete(YoubenbenUserContext userContext, String retailStoreClosingId, int retailStoreClosingVersion) throws Exception {
	...
	public RetailStoreClosing forgetByAll(YoubenbenUserContext userContext, String retailStoreClosingId, int retailStoreClosingVersion) throws Exception {
		return forgetByAllInternal(userContext, retailStoreClosingId, retailStoreClosingVersion);
	}
	protected RetailStoreClosing forgetByAllInternal(YoubenbenUserContext userContext,
			String retailStoreClosingId, int retailStoreClosingVersion) throws Exception{
	...
	protected RetailStoreClosing breakWithRetailStoreByRetailStoreCountryCenter(YoubenbenUserContext userContext, String retailStoreClosingId, String retailStoreCountryCenterId,  String [] tokensExpr)
		 throws Exception{
	...
	protected RetailStoreClosing breakWithRetailStoreByCityServiceCenter(YoubenbenUserContext userContext, String retailStoreClosingId, String cityServiceCenterId,  String [] tokensExpr)
		 throws Exception{
	...
	protected RetailStoreClosing breakWithRetailStoreByCreation(YoubenbenUserContext userContext, String retailStoreClosingId, String creationId,  String [] tokensExpr)
		 throws Exception{
	...
	protected RetailStoreClosing breakWithRetailStoreByInvestmentInvitation(YoubenbenUserContext userContext, String retailStoreClosingId, String investmentInvitationId,  String [] tokensExpr)
		 throws Exception{
	...
	protected RetailStoreClosing breakWithRetailStoreByFranchising(YoubenbenUserContext userContext, String retailStoreClosingId, String franchisingId,  String [] tokensExpr)
		 throws Exception{
	...
	protected RetailStoreClosing breakWithRetailStoreByDecoration(YoubenbenUserContext userContext, String retailStoreClosingId, String decorationId,  String [] tokensExpr)
		 throws Exception{
	...
	protected RetailStoreClosing breakWithRetailStoreByOpening(YoubenbenUserContext userContext, String retailStoreClosingId, String openingId,  String [] tokensExpr)
		 throws Exception{
	...
	protected void checkParamsForUpdatingRetailStoreProperties(YoubenbenUserContext userContext, String retailStoreClosingId,String id,String name,String telephone,String owner,Date founded,BigDecimal latitude,BigDecimal longitude,String description,String [] tokensExpr) throws Exception {
	...
	public  RetailStoreClosing updateRetailStoreProperties(YoubenbenUserContext userContext, String retailStoreClosingId, String id,String name,String telephone,String owner,Date founded,BigDecimal latitude,BigDecimal longitude,String description, String [] tokensExpr) throws Exception
	{
	...
	protected void checkParamsForRemovingRetailStoreList(YoubenbenUserContext userContext, String retailStoreClosingId,
	...
	public  RetailStoreClosing removeRetailStoreList(YoubenbenUserContext userContext, String retailStoreClosingId,
			String retailStoreIds[],String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForRemovingRetailStore(YoubenbenUserContext userContext, String retailStoreClosingId,
	...
	public  RetailStoreClosing removeRetailStore(YoubenbenUserContext userContext, String retailStoreClosingId,
		String retailStoreId, int retailStoreVersion,String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForCopyingRetailStore(YoubenbenUserContext userContext, String retailStoreClosingId,
		String retailStoreId, int retailStoreVersion,String [] tokensExpr) throws Exception{
	...
	public  RetailStoreClosing copyRetailStoreFrom(YoubenbenUserContext userContext, String retailStoreClosingId,
		String retailStoreId, int retailStoreVersion,String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForUpdatingRetailStore(YoubenbenUserContext userContext, String retailStoreClosingId, String retailStoreId, int retailStoreVersion, String property, String newValueExpr,String [] tokensExpr) throws Exception{
	...
	public  RetailStoreClosing updateRetailStore(YoubenbenUserContext userContext, String retailStoreClosingId, String retailStoreId, int retailStoreVersion, String property, String newValueExpr,String [] tokensExpr)
			throws Exception{
	...
	*/
	...
	// -----------------------------------// list-of-view 处理 \\-----------------------------------
    protected void enhanceForListOfView(YoubenbenUserContext userContext,SmartList<RetailStoreClosing> list) throws Exception {
  ...
  // -----------------------------------\\ list-of-view 处理 //-----------------------------------v
	 ...
	 * @throws Exception
	 */
 	public Object wxappview(YoubenbenUserContext userContext, String retailStoreClosingId) throws Exception{
	  SerializeScope vscope = YoubenbenViewScope.getInstance().getRetailStoreClosingDetailScope().clone();
