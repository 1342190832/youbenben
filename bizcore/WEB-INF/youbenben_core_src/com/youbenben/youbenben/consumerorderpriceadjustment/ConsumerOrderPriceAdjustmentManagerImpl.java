...
public class ConsumerOrderPriceAdjustmentManagerImpl extends CustomYoubenbenCheckerManager implements ConsumerOrderPriceAdjustmentManager, BusinessHandler{
	...
	@Override
	public ConsumerOrderPriceAdjustmentDAO daoOf(YoubenbenUserContext userContext) {
	...
	protected void throwExceptionWithMessage(String value) throws ConsumerOrderPriceAdjustmentManagerException{
 	...
 	protected ConsumerOrderPriceAdjustment saveConsumerOrderPriceAdjustment(YoubenbenUserContext userContext, ConsumerOrderPriceAdjustment consumerOrderPriceAdjustment, String [] tokensExpr) throws Exception{	
 	...
 	protected ConsumerOrderPriceAdjustment saveConsumerOrderPriceAdjustmentDetail(YoubenbenUserContext userContext, ConsumerOrderPriceAdjustment consumerOrderPriceAdjustment) throws Exception{	
 	...
 	public ConsumerOrderPriceAdjustment loadConsumerOrderPriceAdjustment(YoubenbenUserContext userContext, String consumerOrderPriceAdjustmentId, String [] tokensExpr) throws Exception{				
 	 ...
 	 public ConsumerOrderPriceAdjustment searchConsumerOrderPriceAdjustment(YoubenbenUserContext userContext, String consumerOrderPriceAdjustmentId, String textToSearch,String [] tokensExpr) throws Exception{				
 	...
 	protected ConsumerOrderPriceAdjustment present(YoubenbenUserContext userContext, ConsumerOrderPriceAdjustment consumerOrderPriceAdjustment, Map<String, Object> tokens) throws Exception {
 	...
 	public ConsumerOrderPriceAdjustment loadConsumerOrderPriceAdjustmentDetail(YoubenbenUserContext userContext, String consumerOrderPriceAdjustmentId) throws Exception{	
 	...
 	public Object view(YoubenbenUserContext userContext, String consumerOrderPriceAdjustmentId) throws Exception{	
 	...
 	protected ConsumerOrderPriceAdjustment saveConsumerOrderPriceAdjustment(YoubenbenUserContext userContext, ConsumerOrderPriceAdjustment consumerOrderPriceAdjustment, Map<String,Object>tokens) throws Exception{	
 		return consumerOrderPriceAdjustmentDaoOf(userContext).save(consumerOrderPriceAdjustment, tokens);
 	}
 	protected ConsumerOrderPriceAdjustment loadConsumerOrderPriceAdjustment(YoubenbenUserContext userContext, String consumerOrderPriceAdjustmentId, Map<String,Object>tokens) throws Exception{	
		checkerOf(userContext).checkIdOfConsumerOrderPriceAdjustment(consumerOrderPriceAdjustmentId);
		checkerOf(userContext).throwExceptionIfHasErrors( ConsumerOrderPriceAdjustmentManagerException.class);
 	...
 	protected<T extends BaseEntity> void addActions(YoubenbenUserContext userContext, ConsumerOrderPriceAdjustment consumerOrderPriceAdjustment, Map<String, Object> tokens){
	...
	}// end method of protected<T extends BaseEntity> void addActions(YoubenbenUserContext userContext, ConsumerOrderPriceAdjustment consumerOrderPriceAdjustment, Map<String, Object> tokens){
	...
	protected void checkParamsForUpdatingConsumerOrderPriceAdjustment(YoubenbenUserContext userContext,String consumerOrderPriceAdjustmentId, int consumerOrderPriceAdjustmentVersion, String property, String newValueExpr,String [] tokensExpr)throws Exception
	{
	...
	public ConsumerOrderPriceAdjustment clone(YoubenbenUserContext userContext, String fromConsumerOrderPriceAdjustmentId) throws Exception{
	...
	public ConsumerOrderPriceAdjustment internalSaveConsumerOrderPriceAdjustment(YoubenbenUserContext userContext, ConsumerOrderPriceAdjustment consumerOrderPriceAdjustment, Map<String,Object> options) throws Exception
	{
	...
	public ConsumerOrderPriceAdjustment updateConsumerOrderPriceAdjustmentProperty(YoubenbenUserContext userContext,String consumerOrderPriceAdjustmentId, int consumerOrderPriceAdjustmentVersion, String property, String newValueExpr,String [] tokensExpr) throws Exception
	{
		checkParamsForUpdatingConsumerOrderPriceAdjustment(userContext, consumerOrderPriceAdjustmentId, consumerOrderPriceAdjustmentVersion, property, newValueExpr, tokensExpr);
	...
	protected void checkParamsForTransferingAnotherBizOrder(YoubenbenUserContext userContext, String consumerOrderPriceAdjustmentId, String anotherBizOrderId) throws Exception
 	{
 ...
 //--------------------------------------------------------------
	...
	public void delete(YoubenbenUserContext userContext, String consumerOrderPriceAdjustmentId, int consumerOrderPriceAdjustmentVersion) throws Exception {
	...
	public ConsumerOrderPriceAdjustment forgetByAll(YoubenbenUserContext userContext, String consumerOrderPriceAdjustmentId, int consumerOrderPriceAdjustmentVersion) throws Exception {
		return forgetByAllInternal(userContext, consumerOrderPriceAdjustmentId, consumerOrderPriceAdjustmentVersion);
	}
	protected ConsumerOrderPriceAdjustment forgetByAllInternal(YoubenbenUserContext userContext,
			String consumerOrderPriceAdjustmentId, int consumerOrderPriceAdjustmentVersion) throws Exception{
	...
	// -----------------------------------// list-of-view 处理 \\-----------------------------------
    protected void enhanceForListOfView(YoubenbenUserContext userContext,SmartList<ConsumerOrderPriceAdjustment> list) throws Exception {
  ...
  // -----------------------------------\\ list-of-view 处理 //-----------------------------------v
	 ...
	 * @throws Exception
	 */
 	public Object wxappview(YoubenbenUserContext userContext, String consumerOrderPriceAdjustmentId) throws Exception{
	  SerializeScope vscope = YoubenbenViewScope.getInstance().getConsumerOrderPriceAdjustmentDetailScope().clone();
