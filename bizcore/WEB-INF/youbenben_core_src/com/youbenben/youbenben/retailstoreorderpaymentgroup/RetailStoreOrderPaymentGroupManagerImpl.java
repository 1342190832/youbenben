...
public class RetailStoreOrderPaymentGroupManagerImpl extends CustomYoubenbenCheckerManager implements RetailStoreOrderPaymentGroupManager, BusinessHandler{
	...
	@Override
	public RetailStoreOrderPaymentGroupDAO daoOf(YoubenbenUserContext userContext) {
	...
	protected void throwExceptionWithMessage(String value) throws RetailStoreOrderPaymentGroupManagerException{
 	...
 	protected RetailStoreOrderPaymentGroup saveRetailStoreOrderPaymentGroup(YoubenbenUserContext userContext, RetailStoreOrderPaymentGroup retailStoreOrderPaymentGroup, String [] tokensExpr) throws Exception{	
 	...
 	protected RetailStoreOrderPaymentGroup saveRetailStoreOrderPaymentGroupDetail(YoubenbenUserContext userContext, RetailStoreOrderPaymentGroup retailStoreOrderPaymentGroup) throws Exception{	
 	...
 	public RetailStoreOrderPaymentGroup loadRetailStoreOrderPaymentGroup(YoubenbenUserContext userContext, String retailStoreOrderPaymentGroupId, String [] tokensExpr) throws Exception{				
 	 ...
 	 public RetailStoreOrderPaymentGroup searchRetailStoreOrderPaymentGroup(YoubenbenUserContext userContext, String retailStoreOrderPaymentGroupId, String textToSearch,String [] tokensExpr) throws Exception{				
 	...
 	protected RetailStoreOrderPaymentGroup present(YoubenbenUserContext userContext, RetailStoreOrderPaymentGroup retailStoreOrderPaymentGroup, Map<String, Object> tokens) throws Exception {
 	...
 	public RetailStoreOrderPaymentGroup loadRetailStoreOrderPaymentGroupDetail(YoubenbenUserContext userContext, String retailStoreOrderPaymentGroupId) throws Exception{	
 	...
 	public Object view(YoubenbenUserContext userContext, String retailStoreOrderPaymentGroupId) throws Exception{	
 	...
 	protected RetailStoreOrderPaymentGroup saveRetailStoreOrderPaymentGroup(YoubenbenUserContext userContext, RetailStoreOrderPaymentGroup retailStoreOrderPaymentGroup, Map<String,Object>tokens) throws Exception{	
 		return retailStoreOrderPaymentGroupDaoOf(userContext).save(retailStoreOrderPaymentGroup, tokens);
 	}
 	protected RetailStoreOrderPaymentGroup loadRetailStoreOrderPaymentGroup(YoubenbenUserContext userContext, String retailStoreOrderPaymentGroupId, Map<String,Object>tokens) throws Exception{	
		checkerOf(userContext).checkIdOfRetailStoreOrderPaymentGroup(retailStoreOrderPaymentGroupId);
		checkerOf(userContext).throwExceptionIfHasErrors( RetailStoreOrderPaymentGroupManagerException.class);
 	...
 	protected<T extends BaseEntity> void addActions(YoubenbenUserContext userContext, RetailStoreOrderPaymentGroup retailStoreOrderPaymentGroup, Map<String, Object> tokens){
	...
	}// end method of protected<T extends BaseEntity> void addActions(YoubenbenUserContext userContext, RetailStoreOrderPaymentGroup retailStoreOrderPaymentGroup, Map<String, Object> tokens){
	...
	protected void checkParamsForUpdatingRetailStoreOrderPaymentGroup(YoubenbenUserContext userContext,String retailStoreOrderPaymentGroupId, int retailStoreOrderPaymentGroupVersion, String property, String newValueExpr,String [] tokensExpr)throws Exception
	{
	...
	public RetailStoreOrderPaymentGroup clone(YoubenbenUserContext userContext, String fromRetailStoreOrderPaymentGroupId) throws Exception{
	...
	public RetailStoreOrderPaymentGroup internalSaveRetailStoreOrderPaymentGroup(YoubenbenUserContext userContext, RetailStoreOrderPaymentGroup retailStoreOrderPaymentGroup, Map<String,Object> options) throws Exception
	{
	...
	public RetailStoreOrderPaymentGroup updateRetailStoreOrderPaymentGroupProperty(YoubenbenUserContext userContext,String retailStoreOrderPaymentGroupId, int retailStoreOrderPaymentGroupVersion, String property, String newValueExpr,String [] tokensExpr) throws Exception
	{
		checkParamsForUpdatingRetailStoreOrderPaymentGroup(userContext, retailStoreOrderPaymentGroupId, retailStoreOrderPaymentGroupVersion, property, newValueExpr, tokensExpr);
	...
	protected void checkParamsForTransferingAnotherBizOrder(YoubenbenUserContext userContext, String retailStoreOrderPaymentGroupId, String anotherBizOrderId) throws Exception
 	{
 ...
 //--------------------------------------------------------------
	...
	public void delete(YoubenbenUserContext userContext, String retailStoreOrderPaymentGroupId, int retailStoreOrderPaymentGroupVersion) throws Exception {
	...
	public RetailStoreOrderPaymentGroup forgetByAll(YoubenbenUserContext userContext, String retailStoreOrderPaymentGroupId, int retailStoreOrderPaymentGroupVersion) throws Exception {
		return forgetByAllInternal(userContext, retailStoreOrderPaymentGroupId, retailStoreOrderPaymentGroupVersion);
	}
	protected RetailStoreOrderPaymentGroup forgetByAllInternal(YoubenbenUserContext userContext,
			String retailStoreOrderPaymentGroupId, int retailStoreOrderPaymentGroupVersion) throws Exception{
	...
	// -----------------------------------// list-of-view 处理 \\-----------------------------------
    protected void enhanceForListOfView(YoubenbenUserContext userContext,SmartList<RetailStoreOrderPaymentGroup> list) throws Exception {
  ...
  // -----------------------------------\\ list-of-view 处理 //-----------------------------------v
	 ...
	 * @throws Exception
	 */
 	public Object wxappview(YoubenbenUserContext userContext, String retailStoreOrderPaymentGroupId) throws Exception{
	  SerializeScope vscope = YoubenbenViewScope.getInstance().getRetailStoreOrderPaymentGroupDetailScope().clone();
