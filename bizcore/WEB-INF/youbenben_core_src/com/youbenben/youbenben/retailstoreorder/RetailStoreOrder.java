...
public class RetailStoreOrder extends BaseEntity implements  java.io.Serializable{
	...
	public Object[] toFlatArray(){
		return new Object[]{getId(), getBuyer(), getSeller(), getTitle(), getTotalAmount(), getConfirmation(), getApproval(), getProcessing(), getPicking(), getShipment(), getDelivery(), getLastUpdateTime(), getVersion()};
	}
