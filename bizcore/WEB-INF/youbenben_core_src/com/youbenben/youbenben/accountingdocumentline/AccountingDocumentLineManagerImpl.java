...
import com.youbenben.youbenben.accountingsubject.CandidateAccountingSubject;
...
public class AccountingDocumentLineManagerImpl extends CustomYoubenbenCheckerManager implements AccountingDocumentLineManager, BusinessHandler{
	...
	@Override
	public AccountingDocumentLineDAO daoOf(YoubenbenUserContext userContext) {
	...
	protected void throwExceptionWithMessage(String value) throws AccountingDocumentLineManagerException{
 	...
 	protected AccountingDocumentLine saveAccountingDocumentLine(YoubenbenUserContext userContext, AccountingDocumentLine accountingDocumentLine, String [] tokensExpr) throws Exception{	
 	...
 	protected AccountingDocumentLine saveAccountingDocumentLineDetail(YoubenbenUserContext userContext, AccountingDocumentLine accountingDocumentLine) throws Exception{	
 	...
 	public AccountingDocumentLine loadAccountingDocumentLine(YoubenbenUserContext userContext, String accountingDocumentLineId, String [] tokensExpr) throws Exception{				
 	 ...
 	 public AccountingDocumentLine searchAccountingDocumentLine(YoubenbenUserContext userContext, String accountingDocumentLineId, String textToSearch,String [] tokensExpr) throws Exception{				
 	...
 	protected AccountingDocumentLine present(YoubenbenUserContext userContext, AccountingDocumentLine accountingDocumentLine, Map<String, Object> tokens) throws Exception {
 	...
 	public AccountingDocumentLine loadAccountingDocumentLineDetail(YoubenbenUserContext userContext, String accountingDocumentLineId) throws Exception{	
 	...
 	public Object view(YoubenbenUserContext userContext, String accountingDocumentLineId) throws Exception{	
 		AccountingDocumentLine accountingDocumentLine = loadAccountingDocumentLine( userContext, accountingDocumentLineId, viewTokens());
 		return present(userContext,accountingDocumentLine, allTokens());
		
 	}
 	protected AccountingDocumentLine saveAccountingDocumentLine(YoubenbenUserContext userContext, AccountingDocumentLine accountingDocumentLine, Map<String,Object>tokens) throws Exception{	
 		return accountingDocumentLineDaoOf(userContext).save(accountingDocumentLine, tokens);
 	}
 	protected AccountingDocumentLine loadAccountingDocumentLine(YoubenbenUserContext userContext, String accountingDocumentLineId, Map<String,Object>tokens) throws Exception{	
		checkerOf(userContext).checkIdOfAccountingDocumentLine(accountingDocumentLineId);
		checkerOf(userContext).throwExceptionIfHasErrors( AccountingDocumentLineManagerException.class);
 	...
 	protected<T extends BaseEntity> void addActions(YoubenbenUserContext userContext, AccountingDocumentLine accountingDocumentLine, Map<String, Object> tokens){
	...
	}// end method of protected<T extends BaseEntity> void addActions(YoubenbenUserContext userContext, AccountingDocumentLine accountingDocumentLine, Map<String, Object> tokens){
	...
	protected void checkParamsForUpdatingAccountingDocumentLine(YoubenbenUserContext userContext,String accountingDocumentLineId, int accountingDocumentLineVersion, String property, String newValueExpr,String [] tokensExpr)throws Exception
	{
	...
	public AccountingDocumentLine clone(YoubenbenUserContext userContext, String fromAccountingDocumentLineId) throws Exception{
	...
	public AccountingDocumentLine internalSaveAccountingDocumentLine(YoubenbenUserContext userContext, AccountingDocumentLine accountingDocumentLine, Map<String,Object> options) throws Exception
	{
	...
	public AccountingDocumentLine updateAccountingDocumentLineProperty(YoubenbenUserContext userContext,String accountingDocumentLineId, int accountingDocumentLineVersion, String property, String newValueExpr,String [] tokensExpr) throws Exception
	{
		checkParamsForUpdatingAccountingDocumentLine(userContext, accountingDocumentLineId, accountingDocumentLineVersion, property, newValueExpr, tokensExpr);
	...
	protected void checkParamsForTransferingAnotherBelongsTo(YoubenbenUserContext userContext, String accountingDocumentLineId, String anotherBelongsToId) throws Exception
 	{
	...
	public CandidateAccountingDocument requestCandidateBelongsTo(YoubenbenUserContext userContext, String ownerClass, String id, String filterKey, int pageNo) throws Exception {
 	...
 	protected void checkParamsForTransferingAnotherAccountingSubject(YoubenbenUserContext userContext, String accountingDocumentLineId, String anotherAccountingSubjectId) throws Exception
 	{
	...
	public CandidateAccountingSubject requestCandidateAccountingSubject(YoubenbenUserContext userContext, String ownerClass, String id, String filterKey, int pageNo) throws Exception {
 ...
 //--------------------------------------------------------------
 	...
 	protected AccountingSubject loadAccountingSubject(YoubenbenUserContext userContext, String newAccountingSubjectId, Map<String,Object> options) throws Exception
 	{
	...
	public void delete(YoubenbenUserContext userContext, String accountingDocumentLineId, int accountingDocumentLineVersion) throws Exception {
	...
	public AccountingDocumentLine forgetByAll(YoubenbenUserContext userContext, String accountingDocumentLineId, int accountingDocumentLineVersion) throws Exception {
		return forgetByAllInternal(userContext, accountingDocumentLineId, accountingDocumentLineVersion);
	}
	protected AccountingDocumentLine forgetByAllInternal(YoubenbenUserContext userContext,
			String accountingDocumentLineId, int accountingDocumentLineVersion) throws Exception{
	...
	// -----------------------------------// list-of-view 处理 \\-----------------------------------
    protected void enhanceForListOfView(YoubenbenUserContext userContext,SmartList<AccountingDocumentLine> list) throws Exception {
		...
		List<AccountingSubject> accountingSubjectList = YoubenbenBaseUtils.collectReferencedObjectWithType(userContext, list, AccountingSubject.class);
  ...
  // -----------------------------------\\ list-of-view 处理 //-----------------------------------v
	 ...
	 * @throws Exception
	 */
 	public Object wxappview(YoubenbenUserContext userContext, String accountingDocumentLineId) throws Exception{
	  SerializeScope vscope = YoubenbenViewScope.getInstance().getAccountingDocumentLineDetailScope().clone();
