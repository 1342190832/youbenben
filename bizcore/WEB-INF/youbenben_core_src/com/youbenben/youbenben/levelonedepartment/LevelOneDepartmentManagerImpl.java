...
public class LevelOneDepartmentManagerImpl extends CustomYoubenbenCheckerManager implements LevelOneDepartmentManager, BusinessHandler{
	...
	@Override
	public LevelOneDepartmentDAO daoOf(YoubenbenUserContext userContext) {
	...
	protected void throwExceptionWithMessage(String value) throws LevelOneDepartmentManagerException{
 	...
 	protected LevelOneDepartment saveLevelOneDepartment(YoubenbenUserContext userContext, LevelOneDepartment levelOneDepartment, String [] tokensExpr) throws Exception{	
 	...
 	protected LevelOneDepartment saveLevelOneDepartmentDetail(YoubenbenUserContext userContext, LevelOneDepartment levelOneDepartment) throws Exception{	
 	...
 	public LevelOneDepartment loadLevelOneDepartment(YoubenbenUserContext userContext, String levelOneDepartmentId, String [] tokensExpr) throws Exception{				
 	 ...
 	 public LevelOneDepartment searchLevelOneDepartment(YoubenbenUserContext userContext, String levelOneDepartmentId, String textToSearch,String [] tokensExpr) throws Exception{				
 	...
 	protected LevelOneDepartment present(YoubenbenUserContext userContext, LevelOneDepartment levelOneDepartment, Map<String, Object> tokens) throws Exception {
 	...
 	public LevelOneDepartment loadLevelOneDepartmentDetail(YoubenbenUserContext userContext, String levelOneDepartmentId) throws Exception{	
 	...
 	public Object view(YoubenbenUserContext userContext, String levelOneDepartmentId) throws Exception{	
 		LevelOneDepartment levelOneDepartment = loadLevelOneDepartment( userContext, levelOneDepartmentId, viewTokens());
 		return present(userContext,levelOneDepartment, allTokens());
		
 	}
 	protected LevelOneDepartment saveLevelOneDepartment(YoubenbenUserContext userContext, LevelOneDepartment levelOneDepartment, Map<String,Object>tokens) throws Exception{	
 		return levelOneDepartmentDaoOf(userContext).save(levelOneDepartment, tokens);
 	}
 	protected LevelOneDepartment loadLevelOneDepartment(YoubenbenUserContext userContext, String levelOneDepartmentId, Map<String,Object>tokens) throws Exception{	
		checkerOf(userContext).checkIdOfLevelOneDepartment(levelOneDepartmentId);
		checkerOf(userContext).throwExceptionIfHasErrors( LevelOneDepartmentManagerException.class);
 	...
 	protected<T extends BaseEntity> void addActions(YoubenbenUserContext userContext, LevelOneDepartment levelOneDepartment, Map<String, Object> tokens){
	...
	}// end method of protected<T extends BaseEntity> void addActions(YoubenbenUserContext userContext, LevelOneDepartment levelOneDepartment, Map<String, Object> tokens){
	...
	protected void checkParamsForUpdatingLevelOneDepartment(YoubenbenUserContext userContext,String levelOneDepartmentId, int levelOneDepartmentVersion, String property, String newValueExpr,String [] tokensExpr)throws Exception
	{
	...
	public LevelOneDepartment clone(YoubenbenUserContext userContext, String fromLevelOneDepartmentId) throws Exception{
	...
	public LevelOneDepartment internalSaveLevelOneDepartment(YoubenbenUserContext userContext, LevelOneDepartment levelOneDepartment, Map<String,Object> options) throws Exception
	{
	...
	public LevelOneDepartment updateLevelOneDepartmentProperty(YoubenbenUserContext userContext,String levelOneDepartmentId, int levelOneDepartmentVersion, String property, String newValueExpr,String [] tokensExpr) throws Exception
	{
		checkParamsForUpdatingLevelOneDepartment(userContext, levelOneDepartmentId, levelOneDepartmentVersion, property, newValueExpr, tokensExpr);
	...
	protected void checkParamsForTransferingAnotherBelongsTo(YoubenbenUserContext userContext, String levelOneDepartmentId, String anotherBelongsToId) throws Exception
 	{
	...
	public CandidateRetailStoreCountryCenter requestCandidateBelongsTo(YoubenbenUserContext userContext, String ownerClass, String id, String filterKey, int pageNo) throws Exception {
 ...
 //--------------------------------------------------------------
 	...
 	protected RetailStoreCountryCenter loadRetailStoreCountryCenter(YoubenbenUserContext userContext, String newBelongsToId, Map<String,Object> options) throws Exception
 	{
	...
	public void delete(YoubenbenUserContext userContext, String levelOneDepartmentId, int levelOneDepartmentVersion) throws Exception {
	...
	public LevelOneDepartment forgetByAll(YoubenbenUserContext userContext, String levelOneDepartmentId, int levelOneDepartmentVersion) throws Exception {
		return forgetByAllInternal(userContext, levelOneDepartmentId, levelOneDepartmentVersion);
	}
	protected LevelOneDepartment forgetByAllInternal(YoubenbenUserContext userContext,
			String levelOneDepartmentId, int levelOneDepartmentVersion) throws Exception{
	...
	protected void checkParamsForAddingLevelTwoDepartment(YoubenbenUserContext userContext, String levelOneDepartmentId, String name, String description, Date founded,String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForUpdatingLevelTwoDepartmentProperties(YoubenbenUserContext userContext, String levelOneDepartmentId,String id,String name,String description,Date founded,String [] tokensExpr) throws Exception {
	...
	public  LevelOneDepartment updateLevelTwoDepartmentProperties(YoubenbenUserContext userContext, String levelOneDepartmentId, String id,String name,String description,Date founded, String [] tokensExpr) throws Exception
	{
	...
	protected LevelTwoDepartment createLevelTwoDepartment(YoubenbenUserContext userContext, String name, String description, Date founded) throws Exception{
	...
	protected void checkParamsForRemovingLevelTwoDepartmentList(YoubenbenUserContext userContext, String levelOneDepartmentId,
	...
	public  LevelOneDepartment removeLevelTwoDepartmentList(YoubenbenUserContext userContext, String levelOneDepartmentId,
			String levelTwoDepartmentIds[],String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForRemovingLevelTwoDepartment(YoubenbenUserContext userContext, String levelOneDepartmentId,
	...
	public  LevelOneDepartment removeLevelTwoDepartment(YoubenbenUserContext userContext, String levelOneDepartmentId,
		String levelTwoDepartmentId, int levelTwoDepartmentVersion,String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForCopyingLevelTwoDepartment(YoubenbenUserContext userContext, String levelOneDepartmentId,
		String levelTwoDepartmentId, int levelTwoDepartmentVersion,String [] tokensExpr) throws Exception{
	...
	public  LevelOneDepartment copyLevelTwoDepartmentFrom(YoubenbenUserContext userContext, String levelOneDepartmentId,
		String levelTwoDepartmentId, int levelTwoDepartmentVersion,String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForUpdatingLevelTwoDepartment(YoubenbenUserContext userContext, String levelOneDepartmentId, String levelTwoDepartmentId, int levelTwoDepartmentVersion, String property, String newValueExpr,String [] tokensExpr) throws Exception{
	...
	public  LevelOneDepartment updateLevelTwoDepartment(YoubenbenUserContext userContext, String levelOneDepartmentId, String levelTwoDepartmentId, int levelTwoDepartmentVersion, String property, String newValueExpr,String [] tokensExpr)
			throws Exception{
	...
	*/
	...
	// -----------------------------------// list-of-view 处理 \\-----------------------------------
    protected void enhanceForListOfView(YoubenbenUserContext userContext,SmartList<LevelOneDepartment> list) throws Exception {
    	if (list == null || list.isEmpty()){
    		return;
    	}
		List<RetailStoreCountryCenter> belongsToList = YoubenbenBaseUtils.collectReferencedObjectWithType(userContext, list, RetailStoreCountryCenter.class);
  ...
  // -----------------------------------\\ list-of-view 处理 //-----------------------------------v
	 ...
	 * @throws Exception
	 */
 	public Object wxappview(YoubenbenUserContext userContext, String levelOneDepartmentId) throws Exception{
	  SerializeScope vscope = YoubenbenViewScope.getInstance().getLevelOneDepartmentDetailScope().clone();
    ...
    String pageTitle = "一级部门"+"详情";
		...
		vscope.field("levelTwoDepartmentListSection", YoubenbenListOfViewScope.getInstance()
