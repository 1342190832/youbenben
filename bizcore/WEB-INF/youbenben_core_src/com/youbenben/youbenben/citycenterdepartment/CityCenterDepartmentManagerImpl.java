...
public class CityCenterDepartmentManagerImpl extends CustomYoubenbenCheckerManager implements CityCenterDepartmentManager, BusinessHandler{
	...
	@Override
	public CityCenterDepartmentDAO daoOf(YoubenbenUserContext userContext) {
	...
	protected void throwExceptionWithMessage(String value) throws CityCenterDepartmentManagerException{
 	...
 	protected CityCenterDepartment saveCityCenterDepartment(YoubenbenUserContext userContext, CityCenterDepartment cityCenterDepartment, String [] tokensExpr) throws Exception{	
 	...
 	protected CityCenterDepartment saveCityCenterDepartmentDetail(YoubenbenUserContext userContext, CityCenterDepartment cityCenterDepartment) throws Exception{	
 	...
 	public CityCenterDepartment loadCityCenterDepartment(YoubenbenUserContext userContext, String cityCenterDepartmentId, String [] tokensExpr) throws Exception{				
 	 ...
 	 public CityCenterDepartment searchCityCenterDepartment(YoubenbenUserContext userContext, String cityCenterDepartmentId, String textToSearch,String [] tokensExpr) throws Exception{				
 	...
 	protected CityCenterDepartment present(YoubenbenUserContext userContext, CityCenterDepartment cityCenterDepartment, Map<String, Object> tokens) throws Exception {
 	...
 	public CityCenterDepartment loadCityCenterDepartmentDetail(YoubenbenUserContext userContext, String cityCenterDepartmentId) throws Exception{	
 	...
 	public Object view(YoubenbenUserContext userContext, String cityCenterDepartmentId) throws Exception{	
 		CityCenterDepartment cityCenterDepartment = loadCityCenterDepartment( userContext, cityCenterDepartmentId, viewTokens());
 		return present(userContext,cityCenterDepartment, allTokens());
		
 	}
 	protected CityCenterDepartment saveCityCenterDepartment(YoubenbenUserContext userContext, CityCenterDepartment cityCenterDepartment, Map<String,Object>tokens) throws Exception{	
 		return cityCenterDepartmentDaoOf(userContext).save(cityCenterDepartment, tokens);
 	}
 	protected CityCenterDepartment loadCityCenterDepartment(YoubenbenUserContext userContext, String cityCenterDepartmentId, Map<String,Object>tokens) throws Exception{	
		checkerOf(userContext).checkIdOfCityCenterDepartment(cityCenterDepartmentId);
		checkerOf(userContext).throwExceptionIfHasErrors( CityCenterDepartmentManagerException.class);
 	...
 	protected<T extends BaseEntity> void addActions(YoubenbenUserContext userContext, CityCenterDepartment cityCenterDepartment, Map<String, Object> tokens){
	...
	}// end method of protected<T extends BaseEntity> void addActions(YoubenbenUserContext userContext, CityCenterDepartment cityCenterDepartment, Map<String, Object> tokens){
	...
	protected void checkParamsForUpdatingCityCenterDepartment(YoubenbenUserContext userContext,String cityCenterDepartmentId, int cityCenterDepartmentVersion, String property, String newValueExpr,String [] tokensExpr)throws Exception
	{
	...
	public CityCenterDepartment clone(YoubenbenUserContext userContext, String fromCityCenterDepartmentId) throws Exception{
	...
	public CityCenterDepartment internalSaveCityCenterDepartment(YoubenbenUserContext userContext, CityCenterDepartment cityCenterDepartment, Map<String,Object> options) throws Exception
	{
	...
	public CityCenterDepartment updateCityCenterDepartmentProperty(YoubenbenUserContext userContext,String cityCenterDepartmentId, int cityCenterDepartmentVersion, String property, String newValueExpr,String [] tokensExpr) throws Exception
	{
		checkParamsForUpdatingCityCenterDepartment(userContext, cityCenterDepartmentId, cityCenterDepartmentVersion, property, newValueExpr, tokensExpr);
	...
	protected void checkParamsForTransferingAnotherCityCenter(YoubenbenUserContext userContext, String cityCenterDepartmentId, String anotherCityCenterId) throws Exception
 	{
 ...
 //--------------------------------------------------------------
	...
	public void delete(YoubenbenUserContext userContext, String cityCenterDepartmentId, int cityCenterDepartmentVersion) throws Exception {
	...
	public CityCenterDepartment forgetByAll(YoubenbenUserContext userContext, String cityCenterDepartmentId, int cityCenterDepartmentVersion) throws Exception {
		return forgetByAllInternal(userContext, cityCenterDepartmentId, cityCenterDepartmentVersion);
	}
	protected CityCenterDepartment forgetByAllInternal(YoubenbenUserContext userContext,
			String cityCenterDepartmentId, int cityCenterDepartmentVersion) throws Exception{
	...
	protected CityCenterDepartment breakWithCityCenterEmployeeByCityCenter(YoubenbenUserContext userContext, String cityCenterDepartmentId, String cityCenterId,  String [] tokensExpr)
		 throws Exception{
	...
	protected void checkParamsForAddingCityCenterEmployee(YoubenbenUserContext userContext, String cityCenterDepartmentId, String name, String mobile, String email, Date founded, String cityCenterId,String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForUpdatingCityCenterEmployeeProperties(YoubenbenUserContext userContext, String cityCenterDepartmentId,String id,String name,String mobile,String email,Date founded,String [] tokensExpr) throws Exception {
	...
	public  CityCenterDepartment updateCityCenterEmployeeProperties(YoubenbenUserContext userContext, String cityCenterDepartmentId, String id,String name,String mobile,String email,Date founded, String [] tokensExpr) throws Exception
	{
	...
	protected CityCenterEmployee createCityCenterEmployee(YoubenbenUserContext userContext, String name, String mobile, String email, Date founded, String cityCenterId) throws Exception{
	...
	protected void checkParamsForRemovingCityCenterEmployeeList(YoubenbenUserContext userContext, String cityCenterDepartmentId,
	...
	public  CityCenterDepartment removeCityCenterEmployeeList(YoubenbenUserContext userContext, String cityCenterDepartmentId,
			String cityCenterEmployeeIds[],String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForRemovingCityCenterEmployee(YoubenbenUserContext userContext, String cityCenterDepartmentId,
	...
	public  CityCenterDepartment removeCityCenterEmployee(YoubenbenUserContext userContext, String cityCenterDepartmentId,
		String cityCenterEmployeeId, int cityCenterEmployeeVersion,String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForCopyingCityCenterEmployee(YoubenbenUserContext userContext, String cityCenterDepartmentId,
		String cityCenterEmployeeId, int cityCenterEmployeeVersion,String [] tokensExpr) throws Exception{
	...
	public  CityCenterDepartment copyCityCenterEmployeeFrom(YoubenbenUserContext userContext, String cityCenterDepartmentId,
		String cityCenterEmployeeId, int cityCenterEmployeeVersion,String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForUpdatingCityCenterEmployee(YoubenbenUserContext userContext, String cityCenterDepartmentId, String cityCenterEmployeeId, int cityCenterEmployeeVersion, String property, String newValueExpr,String [] tokensExpr) throws Exception{
	...
	public  CityCenterDepartment updateCityCenterEmployee(YoubenbenUserContext userContext, String cityCenterDepartmentId, String cityCenterEmployeeId, int cityCenterEmployeeVersion, String property, String newValueExpr,String [] tokensExpr)
			throws Exception{
	...
	*/
	...
	// -----------------------------------// list-of-view 处理 \\-----------------------------------
    protected void enhanceForListOfView(YoubenbenUserContext userContext,SmartList<CityCenterDepartment> list) throws Exception {
  ...
  // -----------------------------------\\ list-of-view 处理 //-----------------------------------v
	 ...
	 * @throws Exception
	 */
 	public Object wxappview(YoubenbenUserContext userContext, String cityCenterDepartmentId) throws Exception{
	  SerializeScope vscope = YoubenbenViewScope.getInstance().getCityCenterDepartmentDetailScope().clone();
