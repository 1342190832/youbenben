...
public class MemberWishlistManagerImpl extends CustomYoubenbenCheckerManager implements MemberWishlistManager, BusinessHandler{
	...
	@Override
	public MemberWishlistDAO daoOf(YoubenbenUserContext userContext) {
	...
	protected void throwExceptionWithMessage(String value) throws MemberWishlistManagerException{
 	...
 	protected MemberWishlist saveMemberWishlist(YoubenbenUserContext userContext, MemberWishlist memberWishlist, String [] tokensExpr) throws Exception{	
 	...
 	protected MemberWishlist saveMemberWishlistDetail(YoubenbenUserContext userContext, MemberWishlist memberWishlist) throws Exception{	
 	...
 	public MemberWishlist loadMemberWishlist(YoubenbenUserContext userContext, String memberWishlistId, String [] tokensExpr) throws Exception{				
 	 ...
 	 public MemberWishlist searchMemberWishlist(YoubenbenUserContext userContext, String memberWishlistId, String textToSearch,String [] tokensExpr) throws Exception{				
 	...
 	protected MemberWishlist present(YoubenbenUserContext userContext, MemberWishlist memberWishlist, Map<String, Object> tokens) throws Exception {
 	...
 	public MemberWishlist loadMemberWishlistDetail(YoubenbenUserContext userContext, String memberWishlistId) throws Exception{	
 	...
 	public Object view(YoubenbenUserContext userContext, String memberWishlistId) throws Exception{	
 		MemberWishlist memberWishlist = loadMemberWishlist( userContext, memberWishlistId, viewTokens());
 		return present(userContext,memberWishlist, allTokens());
		
 	}
 	protected MemberWishlist saveMemberWishlist(YoubenbenUserContext userContext, MemberWishlist memberWishlist, Map<String,Object>tokens) throws Exception{	
 		return memberWishlistDaoOf(userContext).save(memberWishlist, tokens);
 	}
 	protected MemberWishlist loadMemberWishlist(YoubenbenUserContext userContext, String memberWishlistId, Map<String,Object>tokens) throws Exception{	
		checkerOf(userContext).checkIdOfMemberWishlist(memberWishlistId);
		checkerOf(userContext).throwExceptionIfHasErrors( MemberWishlistManagerException.class);
 	...
 	protected<T extends BaseEntity> void addActions(YoubenbenUserContext userContext, MemberWishlist memberWishlist, Map<String, Object> tokens){
	...
	}// end method of protected<T extends BaseEntity> void addActions(YoubenbenUserContext userContext, MemberWishlist memberWishlist, Map<String, Object> tokens){
	...
	protected void checkParamsForUpdatingMemberWishlist(YoubenbenUserContext userContext,String memberWishlistId, int memberWishlistVersion, String property, String newValueExpr,String [] tokensExpr)throws Exception
	{
	...
	public MemberWishlist clone(YoubenbenUserContext userContext, String fromMemberWishlistId) throws Exception{
	...
	public MemberWishlist internalSaveMemberWishlist(YoubenbenUserContext userContext, MemberWishlist memberWishlist, Map<String,Object> options) throws Exception
	{
	...
	public MemberWishlist updateMemberWishlistProperty(YoubenbenUserContext userContext,String memberWishlistId, int memberWishlistVersion, String property, String newValueExpr,String [] tokensExpr) throws Exception
	{
		checkParamsForUpdatingMemberWishlist(userContext, memberWishlistId, memberWishlistVersion, property, newValueExpr, tokensExpr);
	...
	protected void checkParamsForTransferingAnotherOwner(YoubenbenUserContext userContext, String memberWishlistId, String anotherOwnerId) throws Exception
 	{
 ...
 //--------------------------------------------------------------
	...
	public void delete(YoubenbenUserContext userContext, String memberWishlistId, int memberWishlistVersion) throws Exception {
	...
	public MemberWishlist forgetByAll(YoubenbenUserContext userContext, String memberWishlistId, int memberWishlistVersion) throws Exception {
		return forgetByAllInternal(userContext, memberWishlistId, memberWishlistVersion);
	}
	protected MemberWishlist forgetByAllInternal(YoubenbenUserContext userContext,
			String memberWishlistId, int memberWishlistVersion) throws Exception{
	...
	protected void checkParamsForAddingMemberWishlistProduct(YoubenbenUserContext userContext, String memberWishlistId, String name,String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForUpdatingMemberWishlistProductProperties(YoubenbenUserContext userContext, String memberWishlistId,String id,String name,String [] tokensExpr) throws Exception {
	...
	public  MemberWishlist updateMemberWishlistProductProperties(YoubenbenUserContext userContext, String memberWishlistId, String id,String name, String [] tokensExpr) throws Exception
	{
	...
	protected MemberWishlistProduct createMemberWishlistProduct(YoubenbenUserContext userContext, String name) throws Exception{
	...
	protected void checkParamsForRemovingMemberWishlistProductList(YoubenbenUserContext userContext, String memberWishlistId,
	...
	public  MemberWishlist removeMemberWishlistProductList(YoubenbenUserContext userContext, String memberWishlistId,
			String memberWishlistProductIds[],String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForRemovingMemberWishlistProduct(YoubenbenUserContext userContext, String memberWishlistId,
	...
	public  MemberWishlist removeMemberWishlistProduct(YoubenbenUserContext userContext, String memberWishlistId,
		String memberWishlistProductId, int memberWishlistProductVersion,String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForCopyingMemberWishlistProduct(YoubenbenUserContext userContext, String memberWishlistId,
		String memberWishlistProductId, int memberWishlistProductVersion,String [] tokensExpr) throws Exception{
	...
	public  MemberWishlist copyMemberWishlistProductFrom(YoubenbenUserContext userContext, String memberWishlistId,
		String memberWishlistProductId, int memberWishlistProductVersion,String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForUpdatingMemberWishlistProduct(YoubenbenUserContext userContext, String memberWishlistId, String memberWishlistProductId, int memberWishlistProductVersion, String property, String newValueExpr,String [] tokensExpr) throws Exception{
	...
	public  MemberWishlist updateMemberWishlistProduct(YoubenbenUserContext userContext, String memberWishlistId, String memberWishlistProductId, int memberWishlistProductVersion, String property, String newValueExpr,String [] tokensExpr)
			throws Exception{
	...
	*/
	...
	// -----------------------------------// list-of-view 处理 \\-----------------------------------
    protected void enhanceForListOfView(YoubenbenUserContext userContext,SmartList<MemberWishlist> list) throws Exception {
  ...
  // -----------------------------------\\ list-of-view 处理 //-----------------------------------v
	 ...
	 * @throws Exception
	 */
 	public Object wxappview(YoubenbenUserContext userContext, String memberWishlistId) throws Exception{
	  SerializeScope vscope = YoubenbenViewScope.getInstance().getMemberWishlistDetailScope().clone();
    ...
    String pageTitle = "会员收藏"+"详情";
		...
		vscope.field("memberWishlistProductListSection", YoubenbenListOfViewScope.getInstance()
