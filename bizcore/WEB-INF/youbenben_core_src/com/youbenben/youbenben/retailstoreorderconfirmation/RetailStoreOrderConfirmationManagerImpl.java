...
public class RetailStoreOrderConfirmationManagerImpl extends CustomYoubenbenCheckerManager implements RetailStoreOrderConfirmationManager, BusinessHandler{
	...
	@Override
	public RetailStoreOrderConfirmationDAO daoOf(YoubenbenUserContext userContext) {
	...
	protected void throwExceptionWithMessage(String value) throws RetailStoreOrderConfirmationManagerException{
 	...
 	protected RetailStoreOrderConfirmation saveRetailStoreOrderConfirmation(YoubenbenUserContext userContext, RetailStoreOrderConfirmation retailStoreOrderConfirmation, String [] tokensExpr) throws Exception{	
 	...
 	protected RetailStoreOrderConfirmation saveRetailStoreOrderConfirmationDetail(YoubenbenUserContext userContext, RetailStoreOrderConfirmation retailStoreOrderConfirmation) throws Exception{	
 	...
 	public RetailStoreOrderConfirmation loadRetailStoreOrderConfirmation(YoubenbenUserContext userContext, String retailStoreOrderConfirmationId, String [] tokensExpr) throws Exception{				
 	 ...
 	 public RetailStoreOrderConfirmation searchRetailStoreOrderConfirmation(YoubenbenUserContext userContext, String retailStoreOrderConfirmationId, String textToSearch,String [] tokensExpr) throws Exception{				
 	...
 	protected RetailStoreOrderConfirmation present(YoubenbenUserContext userContext, RetailStoreOrderConfirmation retailStoreOrderConfirmation, Map<String, Object> tokens) throws Exception {
 	...
 	public RetailStoreOrderConfirmation loadRetailStoreOrderConfirmationDetail(YoubenbenUserContext userContext, String retailStoreOrderConfirmationId) throws Exception{	
 	...
 	public Object view(YoubenbenUserContext userContext, String retailStoreOrderConfirmationId) throws Exception{	
 	...
 	protected RetailStoreOrderConfirmation saveRetailStoreOrderConfirmation(YoubenbenUserContext userContext, RetailStoreOrderConfirmation retailStoreOrderConfirmation, Map<String,Object>tokens) throws Exception{	
 		return retailStoreOrderConfirmationDaoOf(userContext).save(retailStoreOrderConfirmation, tokens);
 	}
 	protected RetailStoreOrderConfirmation loadRetailStoreOrderConfirmation(YoubenbenUserContext userContext, String retailStoreOrderConfirmationId, Map<String,Object>tokens) throws Exception{	
		checkerOf(userContext).checkIdOfRetailStoreOrderConfirmation(retailStoreOrderConfirmationId);
		checkerOf(userContext).throwExceptionIfHasErrors( RetailStoreOrderConfirmationManagerException.class);
 	...
 	protected<T extends BaseEntity> void addActions(YoubenbenUserContext userContext, RetailStoreOrderConfirmation retailStoreOrderConfirmation, Map<String, Object> tokens){
	...
	}// end method of protected<T extends BaseEntity> void addActions(YoubenbenUserContext userContext, RetailStoreOrderConfirmation retailStoreOrderConfirmation, Map<String, Object> tokens){
	...
	protected void checkParamsForUpdatingRetailStoreOrderConfirmation(YoubenbenUserContext userContext,String retailStoreOrderConfirmationId, int retailStoreOrderConfirmationVersion, String property, String newValueExpr,String [] tokensExpr)throws Exception
	{
	...
	public RetailStoreOrderConfirmation clone(YoubenbenUserContext userContext, String fromRetailStoreOrderConfirmationId) throws Exception{
	...
	public RetailStoreOrderConfirmation internalSaveRetailStoreOrderConfirmation(YoubenbenUserContext userContext, RetailStoreOrderConfirmation retailStoreOrderConfirmation, Map<String,Object> options) throws Exception
	{
	...
	public RetailStoreOrderConfirmation updateRetailStoreOrderConfirmationProperty(YoubenbenUserContext userContext,String retailStoreOrderConfirmationId, int retailStoreOrderConfirmationVersion, String property, String newValueExpr,String [] tokensExpr) throws Exception
	{
		checkParamsForUpdatingRetailStoreOrderConfirmation(userContext, retailStoreOrderConfirmationId, retailStoreOrderConfirmationVersion, property, newValueExpr, tokensExpr);
...
//--------------------------------------------------------------
	...
	public void delete(YoubenbenUserContext userContext, String retailStoreOrderConfirmationId, int retailStoreOrderConfirmationVersion) throws Exception {
	...
	public RetailStoreOrderConfirmation forgetByAll(YoubenbenUserContext userContext, String retailStoreOrderConfirmationId, int retailStoreOrderConfirmationVersion) throws Exception {
		return forgetByAllInternal(userContext, retailStoreOrderConfirmationId, retailStoreOrderConfirmationVersion);
	}
	protected RetailStoreOrderConfirmation forgetByAllInternal(YoubenbenUserContext userContext,
			String retailStoreOrderConfirmationId, int retailStoreOrderConfirmationVersion) throws Exception{
	...
	protected RetailStoreOrderConfirmation breakWithRetailStoreOrderByBuyer(YoubenbenUserContext userContext, String retailStoreOrderConfirmationId, String buyerId,  String [] tokensExpr)
		 throws Exception{
	...
	protected RetailStoreOrderConfirmation breakWithRetailStoreOrderBySeller(YoubenbenUserContext userContext, String retailStoreOrderConfirmationId, String sellerId,  String [] tokensExpr)
		 throws Exception{
	...
	protected RetailStoreOrderConfirmation breakWithRetailStoreOrderByApproval(YoubenbenUserContext userContext, String retailStoreOrderConfirmationId, String approvalId,  String [] tokensExpr)
		 throws Exception{
	...
	protected RetailStoreOrderConfirmation breakWithRetailStoreOrderByProcessing(YoubenbenUserContext userContext, String retailStoreOrderConfirmationId, String processingId,  String [] tokensExpr)
		 throws Exception{
	...
	protected RetailStoreOrderConfirmation breakWithRetailStoreOrderByPicking(YoubenbenUserContext userContext, String retailStoreOrderConfirmationId, String pickingId,  String [] tokensExpr)
		 throws Exception{
	...
	protected RetailStoreOrderConfirmation breakWithRetailStoreOrderByShipment(YoubenbenUserContext userContext, String retailStoreOrderConfirmationId, String shipmentId,  String [] tokensExpr)
		 throws Exception{
	...
	protected RetailStoreOrderConfirmation breakWithRetailStoreOrderByDelivery(YoubenbenUserContext userContext, String retailStoreOrderConfirmationId, String deliveryId,  String [] tokensExpr)
		 throws Exception{
	...
	protected void checkParamsForUpdatingRetailStoreOrderProperties(YoubenbenUserContext userContext, String retailStoreOrderConfirmationId,String id,String title,BigDecimal totalAmount,String [] tokensExpr) throws Exception {
	...
	public  RetailStoreOrderConfirmation updateRetailStoreOrderProperties(YoubenbenUserContext userContext, String retailStoreOrderConfirmationId, String id,String title,BigDecimal totalAmount, String [] tokensExpr) throws Exception
	{
	...
	protected RetailStoreOrder createRetailStoreOrder(YoubenbenUserContext userContext, String buyerId, String sellerId, String title, BigDecimal totalAmount, String approvalId, String processingId, String pickingId, String shipmentId, String deliveryId) throws Exception{
	...
	protected void checkParamsForRemovingRetailStoreOrderList(YoubenbenUserContext userContext, String retailStoreOrderConfirmationId,
	...
	public  RetailStoreOrderConfirmation removeRetailStoreOrderList(YoubenbenUserContext userContext, String retailStoreOrderConfirmationId,
			String retailStoreOrderIds[],String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForRemovingRetailStoreOrder(YoubenbenUserContext userContext, String retailStoreOrderConfirmationId,
	...
	public  RetailStoreOrderConfirmation removeRetailStoreOrder(YoubenbenUserContext userContext, String retailStoreOrderConfirmationId,
		String retailStoreOrderId, int retailStoreOrderVersion,String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForCopyingRetailStoreOrder(YoubenbenUserContext userContext, String retailStoreOrderConfirmationId,
		String retailStoreOrderId, int retailStoreOrderVersion,String [] tokensExpr) throws Exception{
	...
	public  RetailStoreOrderConfirmation copyRetailStoreOrderFrom(YoubenbenUserContext userContext, String retailStoreOrderConfirmationId,
		String retailStoreOrderId, int retailStoreOrderVersion,String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForUpdatingRetailStoreOrder(YoubenbenUserContext userContext, String retailStoreOrderConfirmationId, String retailStoreOrderId, int retailStoreOrderVersion, String property, String newValueExpr,String [] tokensExpr) throws Exception{
	...
	public  RetailStoreOrderConfirmation updateRetailStoreOrder(YoubenbenUserContext userContext, String retailStoreOrderConfirmationId, String retailStoreOrderId, int retailStoreOrderVersion, String property, String newValueExpr,String [] tokensExpr)
			throws Exception{
	...
	*/
	...
	// -----------------------------------// list-of-view 处理 \\-----------------------------------
    protected void enhanceForListOfView(YoubenbenUserContext userContext,SmartList<RetailStoreOrderConfirmation> list) throws Exception {
  ...
  // -----------------------------------\\ list-of-view 处理 //-----------------------------------v
	 ...
	 * @throws Exception
	 */
 	public Object wxappview(YoubenbenUserContext userContext, String retailStoreOrderConfirmationId) throws Exception{
	  SerializeScope vscope = YoubenbenViewScope.getInstance().getRetailStoreOrderConfirmationDetailScope().clone();
