...
public class RetailStoreOrderConfirmationJDBCTemplateDAO extends YoubenbenBaseDAOImpl implements RetailStoreOrderConfirmationDAO{
	...
	*/
	...
	public SmartList<RetailStoreOrderConfirmation> loadAll() {
	    return this.loadAll(getRetailStoreOrderConfirmationMapper());
	}
    ...
    public SmartList<RetailStoreOrderConfirmation> requestCandidateRetailStoreOrderConfirmationForRetailStoreOrder(YoubenbenUserContext userContext, String ownerClass, String id, String filterKey, int pageNo, int pageSize) throws Exception {
		...
		return findAllCandidateByFilter(RetailStoreOrderConfirmationTable.COLUMN_WHO, null, filterKey, pageNo, pageSize, getRetailStoreOrderConfirmationMapper());
    }
