...
import com.youbenben.youbenben.product.CandidateProduct;
...
public class SkuManagerImpl extends CustomYoubenbenCheckerManager implements SkuManager, BusinessHandler{
	...
	@Override
	public SkuDAO daoOf(YoubenbenUserContext userContext) {
	...
	protected void throwExceptionWithMessage(String value) throws SkuManagerException{
 	...
 	protected Sku saveSku(YoubenbenUserContext userContext, Sku sku, String [] tokensExpr) throws Exception{	
 	...
 	protected Sku saveSkuDetail(YoubenbenUserContext userContext, Sku sku) throws Exception{	
 	...
 	public Sku loadSku(YoubenbenUserContext userContext, String skuId, String [] tokensExpr) throws Exception{				
 	 ...
 	 public Sku searchSku(YoubenbenUserContext userContext, String skuId, String textToSearch,String [] tokensExpr) throws Exception{				
 	...
 	protected Sku present(YoubenbenUserContext userContext, Sku sku, Map<String, Object> tokens) throws Exception {
 	...
 	public Sku loadSkuDetail(YoubenbenUserContext userContext, String skuId) throws Exception{	
 		Sku sku = loadSku( userContext, skuId, allTokens());
 		return present(userContext,sku, allTokens());
		
 	}
 	
 	public Object view(YoubenbenUserContext userContext, String skuId) throws Exception{	
 		Sku sku = loadSku( userContext, skuId, viewTokens());
 		return present(userContext,sku, allTokens());
		
 	}
 	protected Sku saveSku(YoubenbenUserContext userContext, Sku sku, Map<String,Object>tokens) throws Exception{	
 		return skuDaoOf(userContext).save(sku, tokens);
 	}
 	protected Sku loadSku(YoubenbenUserContext userContext, String skuId, Map<String,Object>tokens) throws Exception{	
		checkerOf(userContext).checkIdOfSku(skuId);
		checkerOf(userContext).throwExceptionIfHasErrors( SkuManagerException.class);
 	...
 	protected<T extends BaseEntity> void addActions(YoubenbenUserContext userContext, Sku sku, Map<String, Object> tokens){
	...
	}// end method of protected<T extends BaseEntity> void addActions(YoubenbenUserContext userContext, Sku sku, Map<String, Object> tokens){
	...
	protected void checkParamsForUpdatingSku(YoubenbenUserContext userContext,String skuId, int skuVersion, String property, String newValueExpr,String [] tokensExpr)throws Exception
	{
	...
	public Sku clone(YoubenbenUserContext userContext, String fromSkuId) throws Exception{
	...
	public Sku internalSaveSku(YoubenbenUserContext userContext, Sku sku, Map<String,Object> options) throws Exception
	{
	...
	public Sku updateSkuProperty(YoubenbenUserContext userContext,String skuId, int skuVersion, String property, String newValueExpr,String [] tokensExpr) throws Exception
	{
		checkParamsForUpdatingSku(userContext, skuId, skuVersion, property, newValueExpr, tokensExpr);
	...
	protected void checkParamsForTransferingAnotherProduct(YoubenbenUserContext userContext, String skuId, String anotherProductId) throws Exception
 	{
	...
	public CandidateProduct requestCandidateProduct(YoubenbenUserContext userContext, String ownerClass, String id, String filterKey, int pageNo) throws Exception {
 ...
 //--------------------------------------------------------------
 	...
 	protected Product loadProduct(YoubenbenUserContext userContext, String newProductId, Map<String,Object> options) throws Exception
 	{
	...
	public void delete(YoubenbenUserContext userContext, String skuId, int skuVersion) throws Exception {
	...
	public Sku forgetByAll(YoubenbenUserContext userContext, String skuId, int skuVersion) throws Exception {
		return forgetByAllInternal(userContext, skuId, skuVersion);
	}
	protected Sku forgetByAllInternal(YoubenbenUserContext userContext,
			String skuId, int skuVersion) throws Exception{
	...
	protected Sku breakWithGoodsByReceivingSpace(YoubenbenUserContext userContext, String skuId, String receivingSpaceId,  String [] tokensExpr)
		 throws Exception{
	...
	protected Sku breakWithGoodsByGoodsAllocation(YoubenbenUserContext userContext, String skuId, String goodsAllocationId,  String [] tokensExpr)
		 throws Exception{
	...
	protected Sku breakWithGoodsBySmartPallet(YoubenbenUserContext userContext, String skuId, String smartPalletId,  String [] tokensExpr)
		 throws Exception{
	...
	protected Sku breakWithGoodsByShippingSpace(YoubenbenUserContext userContext, String skuId, String shippingSpaceId,  String [] tokensExpr)
		 throws Exception{
	...
	protected Sku breakWithGoodsByTransportTask(YoubenbenUserContext userContext, String skuId, String transportTaskId,  String [] tokensExpr)
		 throws Exception{
	...
	protected Sku breakWithGoodsByRetailStore(YoubenbenUserContext userContext, String skuId, String retailStoreId,  String [] tokensExpr)
		 throws Exception{
	...
	protected Sku breakWithGoodsByBizOrder(YoubenbenUserContext userContext, String skuId, String bizOrderId,  String [] tokensExpr)
		 throws Exception{
	...
	protected Sku breakWithGoodsByRetailStoreOrder(YoubenbenUserContext userContext, String skuId, String retailStoreOrderId,  String [] tokensExpr)
		 throws Exception{
	...
	protected Sku breakWithGoodsByPackaging(YoubenbenUserContext userContext, String skuId, String packagingId,  String [] tokensExpr)
		 throws Exception{
	...
	protected void checkParamsForUpdatingGoodsProperties(YoubenbenUserContext userContext, String skuId,String id,String name,String rfid,String uom,int maxPackage,Date expireTime,String [] tokensExpr) throws Exception {
	...
	public  Sku updateGoodsProperties(YoubenbenUserContext userContext, String skuId, String id,String name,String rfid,String uom,int maxPackage,Date expireTime, String [] tokensExpr) throws Exception
	{
	...
	protected Goods createGoods(YoubenbenUserContext userContext, String name, String rfid, String uom, int maxPackage, Date expireTime, String receivingSpaceId, String goodsAllocationId, String smartPalletId, String shippingSpaceId, String transportTaskId, String retailStoreId, String bizOrderId, String retailStoreOrderId, String packagingId) throws Exception{
	...
	protected void checkParamsForRemovingGoodsList(YoubenbenUserContext userContext, String skuId,
	...
	public  Sku removeGoodsList(YoubenbenUserContext userContext, String skuId,
			String goodsIds[],String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForRemovingGoods(YoubenbenUserContext userContext, String skuId,
	...
	public  Sku removeGoods(YoubenbenUserContext userContext, String skuId,
		String goodsId, int goodsVersion,String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForCopyingGoods(YoubenbenUserContext userContext, String skuId,
		String goodsId, int goodsVersion,String [] tokensExpr) throws Exception{
	...
	public  Sku copyGoodsFrom(YoubenbenUserContext userContext, String skuId,
		String goodsId, int goodsVersion,String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForUpdatingGoods(YoubenbenUserContext userContext, String skuId, String goodsId, int goodsVersion, String property, String newValueExpr,String [] tokensExpr) throws Exception{
	...
	public  Sku updateGoods(YoubenbenUserContext userContext, String skuId, String goodsId, int goodsVersion, String property, String newValueExpr,String [] tokensExpr)
			throws Exception{
	...
	*/
	...
	// -----------------------------------// list-of-view 处理 \\-----------------------------------
    protected void enhanceForListOfView(YoubenbenUserContext userContext,SmartList<Sku> list) throws Exception {
    	if (list == null || list.isEmpty()){
    		return;
    	}
		List<Product> productList = YoubenbenBaseUtils.collectReferencedObjectWithType(userContext, list, Product.class);
  ...
  // -----------------------------------\\ list-of-view 处理 //-----------------------------------v
	 ...
	 * @throws Exception
	 */
 	public Object wxappview(YoubenbenUserContext userContext, String skuId) throws Exception{
	  SerializeScope vscope = YoubenbenViewScope.getInstance().getSkuDetailScope().clone();
