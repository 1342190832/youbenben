...
public class SkuJDBCTemplateDAO extends YoubenbenBaseDAOImpl implements SkuDAO{
	...
	*/
    ...
    public SmartList<Sku> requestCandidateSkuForGoods(YoubenbenUserContext userContext, String ownerClass, String id, String filterKey, int pageNo, int pageSize) throws Exception {
	...
	public SmartList<Goods> loadOurGoodsList(YoubenbenUserContext userContext, List<Sku> us, Map<String,Object> options) throws Exception{
