...
public class RetailStoreFranchisingJDBCTemplateDAO extends YoubenbenBaseDAOImpl implements RetailStoreFranchisingDAO{
	...
	*/
    ...
    public SmartList<RetailStoreFranchising> requestCandidateRetailStoreFranchisingForRetailStore(YoubenbenUserContext userContext, String ownerClass, String id, String filterKey, int pageNo, int pageSize) throws Exception {
	...
	public SmartList<RetailStore> loadOurRetailStoreList(YoubenbenUserContext userContext, List<RetailStoreFranchising> us, Map<String,Object> options) throws Exception{
