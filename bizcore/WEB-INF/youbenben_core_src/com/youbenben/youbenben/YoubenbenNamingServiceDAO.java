...
public class YoubenbenNamingServiceDAO extends CommonJDBCTemplateDAO {

	private static Map<String, String[]>namingTableMap;
	static {
		namingTableMap = new HashMap<String, String[]>();
		namingTableMap.put("FranchisedOutletProvinceCenter", new String[]{"franchised_outlet_province_center_data","name"});
		...
		namingTableMap.put("FranchisedOutletCityCenter", new String[]{"franchised_outlet_city_center_data","name"});
		namingTableMap.put("CityCenterDepartment", new String[]{"city_center_department_data","name"});
		namingTableMap.put("CityCenterEmployee", new String[]{"city_center_employee_data","name"});
		namingTableMap.put("FranchisedOutletCityServiceCenter", new String[]{"franchised_outlet_city_service_center_data","name"});
