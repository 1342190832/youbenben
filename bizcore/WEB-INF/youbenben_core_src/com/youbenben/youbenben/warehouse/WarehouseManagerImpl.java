...
public class WarehouseManagerImpl extends CustomYoubenbenCheckerManager implements WarehouseManager, BusinessHandler{
	...
	@Override
	public WarehouseDAO daoOf(YoubenbenUserContext userContext) {
	...
	protected void throwExceptionWithMessage(String value) throws WarehouseManagerException{
 	...
 	protected Warehouse saveWarehouse(YoubenbenUserContext userContext, Warehouse warehouse, String [] tokensExpr) throws Exception{	
 	...
 	protected Warehouse saveWarehouseDetail(YoubenbenUserContext userContext, Warehouse warehouse) throws Exception{	
 	...
 	public Warehouse loadWarehouse(YoubenbenUserContext userContext, String warehouseId, String [] tokensExpr) throws Exception{				
 	 ...
 	 public Warehouse searchWarehouse(YoubenbenUserContext userContext, String warehouseId, String textToSearch,String [] tokensExpr) throws Exception{				
 	...
 	protected Warehouse present(YoubenbenUserContext userContext, Warehouse warehouse, Map<String, Object> tokens) throws Exception {
 	...
 	public Warehouse loadWarehouseDetail(YoubenbenUserContext userContext, String warehouseId) throws Exception{	
 		Warehouse warehouse = loadWarehouse( userContext, warehouseId, allTokens());
 		return present(userContext,warehouse, allTokens());
		
 	}
 	
 	public Object view(YoubenbenUserContext userContext, String warehouseId) throws Exception{	
 		Warehouse warehouse = loadWarehouse( userContext, warehouseId, viewTokens());
 		return present(userContext,warehouse, allTokens());
		
 	}
 	protected Warehouse saveWarehouse(YoubenbenUserContext userContext, Warehouse warehouse, Map<String,Object>tokens) throws Exception{	
 		return warehouseDaoOf(userContext).save(warehouse, tokens);
 	}
 	protected Warehouse loadWarehouse(YoubenbenUserContext userContext, String warehouseId, Map<String,Object>tokens) throws Exception{	
		checkerOf(userContext).checkIdOfWarehouse(warehouseId);
		checkerOf(userContext).throwExceptionIfHasErrors( WarehouseManagerException.class);
 	...
 	protected<T extends BaseEntity> void addActions(YoubenbenUserContext userContext, Warehouse warehouse, Map<String, Object> tokens){
	...
	}// end method of protected<T extends BaseEntity> void addActions(YoubenbenUserContext userContext, Warehouse warehouse, Map<String, Object> tokens){
	...
	protected void checkParamsForUpdatingWarehouse(YoubenbenUserContext userContext,String warehouseId, int warehouseVersion, String property, String newValueExpr,String [] tokensExpr)throws Exception
	{
	...
	public Warehouse clone(YoubenbenUserContext userContext, String fromWarehouseId) throws Exception{
	...
	public Warehouse internalSaveWarehouse(YoubenbenUserContext userContext, Warehouse warehouse, Map<String,Object> options) throws Exception
	{
	...
	public Warehouse updateWarehouseProperty(YoubenbenUserContext userContext,String warehouseId, int warehouseVersion, String property, String newValueExpr,String [] tokensExpr) throws Exception
	{
		checkParamsForUpdatingWarehouse(userContext, warehouseId, warehouseVersion, property, newValueExpr, tokensExpr);
	...
	protected void checkParamsForTransferingAnotherOwner(YoubenbenUserContext userContext, String warehouseId, String anotherOwnerId) throws Exception
 	{
 ...
 //--------------------------------------------------------------
	...
	public void delete(YoubenbenUserContext userContext, String warehouseId, int warehouseVersion) throws Exception {
	...
	public Warehouse forgetByAll(YoubenbenUserContext userContext, String warehouseId, int warehouseVersion) throws Exception {
		return forgetByAllInternal(userContext, warehouseId, warehouseVersion);
	}
	protected Warehouse forgetByAllInternal(YoubenbenUserContext userContext,
			String warehouseId, int warehouseVersion) throws Exception{
	...
	protected void checkParamsForAddingStorageSpace(YoubenbenUserContext userContext, String warehouseId, String location, String contactNumber, String totalArea, BigDecimal latitude, BigDecimal longitude,String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForUpdatingStorageSpaceProperties(YoubenbenUserContext userContext, String warehouseId,String id,String location,String contactNumber,String totalArea,BigDecimal latitude,BigDecimal longitude,String [] tokensExpr) throws Exception {
	...
	public  Warehouse updateStorageSpaceProperties(YoubenbenUserContext userContext, String warehouseId, String id,String location,String contactNumber,String totalArea,BigDecimal latitude,BigDecimal longitude, String [] tokensExpr) throws Exception
	{
	...
	protected StorageSpace createStorageSpace(YoubenbenUserContext userContext, String location, String contactNumber, String totalArea, BigDecimal latitude, BigDecimal longitude) throws Exception{
	...
	protected void checkParamsForRemovingStorageSpaceList(YoubenbenUserContext userContext, String warehouseId,
	...
	public  Warehouse removeStorageSpaceList(YoubenbenUserContext userContext, String warehouseId,
			String storageSpaceIds[],String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForRemovingStorageSpace(YoubenbenUserContext userContext, String warehouseId,
	...
	public  Warehouse removeStorageSpace(YoubenbenUserContext userContext, String warehouseId,
		String storageSpaceId, int storageSpaceVersion,String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForCopyingStorageSpace(YoubenbenUserContext userContext, String warehouseId,
		String storageSpaceId, int storageSpaceVersion,String [] tokensExpr) throws Exception{
	...
	public  Warehouse copyStorageSpaceFrom(YoubenbenUserContext userContext, String warehouseId,
		String storageSpaceId, int storageSpaceVersion,String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForUpdatingStorageSpace(YoubenbenUserContext userContext, String warehouseId, String storageSpaceId, int storageSpaceVersion, String property, String newValueExpr,String [] tokensExpr) throws Exception{
	...
	public  Warehouse updateStorageSpace(YoubenbenUserContext userContext, String warehouseId, String storageSpaceId, int storageSpaceVersion, String property, String newValueExpr,String [] tokensExpr)
			throws Exception{
	...
	*/
	...
	protected void checkParamsForAddingSmartPallet(YoubenbenUserContext userContext, String warehouseId, String location, String contactNumber, String totalArea, BigDecimal latitude, BigDecimal longitude,String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForUpdatingSmartPalletProperties(YoubenbenUserContext userContext, String warehouseId,String id,String location,String contactNumber,String totalArea,BigDecimal latitude,BigDecimal longitude,String [] tokensExpr) throws Exception {
	...
	public  Warehouse updateSmartPalletProperties(YoubenbenUserContext userContext, String warehouseId, String id,String location,String contactNumber,String totalArea,BigDecimal latitude,BigDecimal longitude, String [] tokensExpr) throws Exception
	{
	...
	protected SmartPallet createSmartPallet(YoubenbenUserContext userContext, String location, String contactNumber, String totalArea, BigDecimal latitude, BigDecimal longitude) throws Exception{
	...
	protected void checkParamsForRemovingSmartPalletList(YoubenbenUserContext userContext, String warehouseId,
	...
	public  Warehouse removeSmartPalletList(YoubenbenUserContext userContext, String warehouseId,
			String smartPalletIds[],String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForRemovingSmartPallet(YoubenbenUserContext userContext, String warehouseId,
	...
	public  Warehouse removeSmartPallet(YoubenbenUserContext userContext, String warehouseId,
		String smartPalletId, int smartPalletVersion,String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForCopyingSmartPallet(YoubenbenUserContext userContext, String warehouseId,
		String smartPalletId, int smartPalletVersion,String [] tokensExpr) throws Exception{
	...
	public  Warehouse copySmartPalletFrom(YoubenbenUserContext userContext, String warehouseId,
		String smartPalletId, int smartPalletVersion,String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForUpdatingSmartPallet(YoubenbenUserContext userContext, String warehouseId, String smartPalletId, int smartPalletVersion, String property, String newValueExpr,String [] tokensExpr) throws Exception{
	...
	public  Warehouse updateSmartPallet(YoubenbenUserContext userContext, String warehouseId, String smartPalletId, int smartPalletVersion, String property, String newValueExpr,String [] tokensExpr)
			throws Exception{
	...
	*/
	...
	protected void checkParamsForAddingSupplierSpace(YoubenbenUserContext userContext, String warehouseId, String location, String contactNumber, String totalArea, BigDecimal latitude, BigDecimal longitude,String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForUpdatingSupplierSpaceProperties(YoubenbenUserContext userContext, String warehouseId,String id,String location,String contactNumber,String totalArea,BigDecimal latitude,BigDecimal longitude,String [] tokensExpr) throws Exception {
	...
	public  Warehouse updateSupplierSpaceProperties(YoubenbenUserContext userContext, String warehouseId, String id,String location,String contactNumber,String totalArea,BigDecimal latitude,BigDecimal longitude, String [] tokensExpr) throws Exception
	{
	...
	protected SupplierSpace createSupplierSpace(YoubenbenUserContext userContext, String location, String contactNumber, String totalArea, BigDecimal latitude, BigDecimal longitude) throws Exception{
	...
	protected void checkParamsForRemovingSupplierSpaceList(YoubenbenUserContext userContext, String warehouseId,
	...
	public  Warehouse removeSupplierSpaceList(YoubenbenUserContext userContext, String warehouseId,
			String supplierSpaceIds[],String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForRemovingSupplierSpace(YoubenbenUserContext userContext, String warehouseId,
	...
	public  Warehouse removeSupplierSpace(YoubenbenUserContext userContext, String warehouseId,
		String supplierSpaceId, int supplierSpaceVersion,String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForCopyingSupplierSpace(YoubenbenUserContext userContext, String warehouseId,
		String supplierSpaceId, int supplierSpaceVersion,String [] tokensExpr) throws Exception{
	...
	public  Warehouse copySupplierSpaceFrom(YoubenbenUserContext userContext, String warehouseId,
		String supplierSpaceId, int supplierSpaceVersion,String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForUpdatingSupplierSpace(YoubenbenUserContext userContext, String warehouseId, String supplierSpaceId, int supplierSpaceVersion, String property, String newValueExpr,String [] tokensExpr) throws Exception{
	...
	public  Warehouse updateSupplierSpace(YoubenbenUserContext userContext, String warehouseId, String supplierSpaceId, int supplierSpaceVersion, String property, String newValueExpr,String [] tokensExpr)
			throws Exception{
	...
	*/
	...
	protected void checkParamsForAddingReceivingSpace(YoubenbenUserContext userContext, String warehouseId, String location, String contactNumber, String description, String totalArea, BigDecimal latitude, BigDecimal longitude,String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForUpdatingReceivingSpaceProperties(YoubenbenUserContext userContext, String warehouseId,String id,String location,String contactNumber,String description,String totalArea,BigDecimal latitude,BigDecimal longitude,String [] tokensExpr) throws Exception {
	...
	public  Warehouse updateReceivingSpaceProperties(YoubenbenUserContext userContext, String warehouseId, String id,String location,String contactNumber,String description,String totalArea,BigDecimal latitude,BigDecimal longitude, String [] tokensExpr) throws Exception
	{
	...
	protected ReceivingSpace createReceivingSpace(YoubenbenUserContext userContext, String location, String contactNumber, String description, String totalArea, BigDecimal latitude, BigDecimal longitude) throws Exception{
	...
	protected void checkParamsForRemovingReceivingSpaceList(YoubenbenUserContext userContext, String warehouseId,
	...
	public  Warehouse removeReceivingSpaceList(YoubenbenUserContext userContext, String warehouseId,
			String receivingSpaceIds[],String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForRemovingReceivingSpace(YoubenbenUserContext userContext, String warehouseId,
	...
	public  Warehouse removeReceivingSpace(YoubenbenUserContext userContext, String warehouseId,
		String receivingSpaceId, int receivingSpaceVersion,String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForCopyingReceivingSpace(YoubenbenUserContext userContext, String warehouseId,
		String receivingSpaceId, int receivingSpaceVersion,String [] tokensExpr) throws Exception{
	...
	public  Warehouse copyReceivingSpaceFrom(YoubenbenUserContext userContext, String warehouseId,
		String receivingSpaceId, int receivingSpaceVersion,String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForUpdatingReceivingSpace(YoubenbenUserContext userContext, String warehouseId, String receivingSpaceId, int receivingSpaceVersion, String property, String newValueExpr,String [] tokensExpr) throws Exception{
	...
	public  Warehouse updateReceivingSpace(YoubenbenUserContext userContext, String warehouseId, String receivingSpaceId, int receivingSpaceVersion, String property, String newValueExpr,String [] tokensExpr)
			throws Exception{
	...
	*/
	...
	protected void checkParamsForAddingShippingSpace(YoubenbenUserContext userContext, String warehouseId, String location, String contactNumber, String totalArea, BigDecimal latitude, BigDecimal longitude, String description,String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForUpdatingShippingSpaceProperties(YoubenbenUserContext userContext, String warehouseId,String id,String location,String contactNumber,String totalArea,BigDecimal latitude,BigDecimal longitude,String description,String [] tokensExpr) throws Exception {
	...
	public  Warehouse updateShippingSpaceProperties(YoubenbenUserContext userContext, String warehouseId, String id,String location,String contactNumber,String totalArea,BigDecimal latitude,BigDecimal longitude,String description, String [] tokensExpr) throws Exception
	{
	...
	protected ShippingSpace createShippingSpace(YoubenbenUserContext userContext, String location, String contactNumber, String totalArea, BigDecimal latitude, BigDecimal longitude, String description) throws Exception{
	...
	protected void checkParamsForRemovingShippingSpaceList(YoubenbenUserContext userContext, String warehouseId,
	...
	public  Warehouse removeShippingSpaceList(YoubenbenUserContext userContext, String warehouseId,
			String shippingSpaceIds[],String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForRemovingShippingSpace(YoubenbenUserContext userContext, String warehouseId,
	...
	public  Warehouse removeShippingSpace(YoubenbenUserContext userContext, String warehouseId,
		String shippingSpaceId, int shippingSpaceVersion,String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForCopyingShippingSpace(YoubenbenUserContext userContext, String warehouseId,
		String shippingSpaceId, int shippingSpaceVersion,String [] tokensExpr) throws Exception{
	...
	public  Warehouse copyShippingSpaceFrom(YoubenbenUserContext userContext, String warehouseId,
		String shippingSpaceId, int shippingSpaceVersion,String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForUpdatingShippingSpace(YoubenbenUserContext userContext, String warehouseId, String shippingSpaceId, int shippingSpaceVersion, String property, String newValueExpr,String [] tokensExpr) throws Exception{
	...
	public  Warehouse updateShippingSpace(YoubenbenUserContext userContext, String warehouseId, String shippingSpaceId, int shippingSpaceVersion, String property, String newValueExpr,String [] tokensExpr)
			throws Exception{
	...
	*/
	...
	protected void checkParamsForAddingDamageSpace(YoubenbenUserContext userContext, String warehouseId, String location, String contactNumber, String totalArea, BigDecimal latitude, BigDecimal longitude,String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForUpdatingDamageSpaceProperties(YoubenbenUserContext userContext, String warehouseId,String id,String location,String contactNumber,String totalArea,BigDecimal latitude,BigDecimal longitude,String [] tokensExpr) throws Exception {
	...
	public  Warehouse updateDamageSpaceProperties(YoubenbenUserContext userContext, String warehouseId, String id,String location,String contactNumber,String totalArea,BigDecimal latitude,BigDecimal longitude, String [] tokensExpr) throws Exception
	{
	...
	protected DamageSpace createDamageSpace(YoubenbenUserContext userContext, String location, String contactNumber, String totalArea, BigDecimal latitude, BigDecimal longitude) throws Exception{
	...
	protected void checkParamsForRemovingDamageSpaceList(YoubenbenUserContext userContext, String warehouseId,
	...
	public  Warehouse removeDamageSpaceList(YoubenbenUserContext userContext, String warehouseId,
			String damageSpaceIds[],String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForRemovingDamageSpace(YoubenbenUserContext userContext, String warehouseId,
	...
	public  Warehouse removeDamageSpace(YoubenbenUserContext userContext, String warehouseId,
		String damageSpaceId, int damageSpaceVersion,String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForCopyingDamageSpace(YoubenbenUserContext userContext, String warehouseId,
		String damageSpaceId, int damageSpaceVersion,String [] tokensExpr) throws Exception{
	...
	public  Warehouse copyDamageSpaceFrom(YoubenbenUserContext userContext, String warehouseId,
		String damageSpaceId, int damageSpaceVersion,String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForUpdatingDamageSpace(YoubenbenUserContext userContext, String warehouseId, String damageSpaceId, int damageSpaceVersion, String property, String newValueExpr,String [] tokensExpr) throws Exception{
	...
	public  Warehouse updateDamageSpace(YoubenbenUserContext userContext, String warehouseId, String damageSpaceId, int damageSpaceVersion, String property, String newValueExpr,String [] tokensExpr)
			throws Exception{
	...
	*/
	...
	protected void checkParamsForAddingWarehouseAsset(YoubenbenUserContext userContext, String warehouseId, String name, String position,String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForUpdatingWarehouseAssetProperties(YoubenbenUserContext userContext, String warehouseId,String id,String name,String position,String [] tokensExpr) throws Exception {
	...
	public  Warehouse updateWarehouseAssetProperties(YoubenbenUserContext userContext, String warehouseId, String id,String name,String position, String [] tokensExpr) throws Exception
	{
	...
	protected WarehouseAsset createWarehouseAsset(YoubenbenUserContext userContext, String name, String position) throws Exception{
	...
	protected void checkParamsForRemovingWarehouseAssetList(YoubenbenUserContext userContext, String warehouseId,
	...
	public  Warehouse removeWarehouseAssetList(YoubenbenUserContext userContext, String warehouseId,
			String warehouseAssetIds[],String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForRemovingWarehouseAsset(YoubenbenUserContext userContext, String warehouseId,
	...
	public  Warehouse removeWarehouseAsset(YoubenbenUserContext userContext, String warehouseId,
		String warehouseAssetId, int warehouseAssetVersion,String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForCopyingWarehouseAsset(YoubenbenUserContext userContext, String warehouseId,
		String warehouseAssetId, int warehouseAssetVersion,String [] tokensExpr) throws Exception{
	...
	public  Warehouse copyWarehouseAssetFrom(YoubenbenUserContext userContext, String warehouseId,
		String warehouseAssetId, int warehouseAssetVersion,String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForUpdatingWarehouseAsset(YoubenbenUserContext userContext, String warehouseId, String warehouseAssetId, int warehouseAssetVersion, String property, String newValueExpr,String [] tokensExpr) throws Exception{
	...
	public  Warehouse updateWarehouseAsset(YoubenbenUserContext userContext, String warehouseId, String warehouseAssetId, int warehouseAssetVersion, String property, String newValueExpr,String [] tokensExpr)
			throws Exception{
	...
	*/
	...
	// -----------------------------------// list-of-view 处理 \\-----------------------------------
    protected void enhanceForListOfView(YoubenbenUserContext userContext,SmartList<Warehouse> list) throws Exception {
  ...
  // -----------------------------------\\ list-of-view 处理 //-----------------------------------v
	 ...
	 * @throws Exception
	 */
 	public Object wxappview(YoubenbenUserContext userContext, String warehouseId) throws Exception{
	  SerializeScope vscope = YoubenbenViewScope.getInstance().getWarehouseDetailScope().clone();
    ...
    String pageTitle = "仓库"+"详情";
		...
		vscope.field("storageSpaceListSection", YoubenbenListOfViewScope.getInstance()
		...
		vscope.field("smartPalletListSection", YoubenbenListOfViewScope.getInstance()
		...
		vscope.field("supplierSpaceListSection", YoubenbenListOfViewScope.getInstance()
		...
		vscope.field("receivingSpaceListSection", YoubenbenListOfViewScope.getInstance()
		...
		vscope.field("shippingSpaceListSection", YoubenbenListOfViewScope.getInstance()
		...
		vscope.field("damageSpaceListSection", YoubenbenListOfViewScope.getInstance()
		...
		vscope.field("warehouseAssetListSection", YoubenbenListOfViewScope.getInstance()
