...
public class InstructorJDBCTemplateDAO extends YoubenbenBaseDAOImpl implements InstructorDAO{
	...
	*/
    ...
    public SmartList<Instructor> requestCandidateInstructorForCompanyTraining(YoubenbenUserContext userContext, String ownerClass, String id, String filterKey, int pageNo, int pageSize) throws Exception {
	...
	public SmartList<CompanyTraining> loadOurCompanyTrainingList(YoubenbenUserContext userContext, List<Instructor> us, Map<String,Object> options) throws Exception{
