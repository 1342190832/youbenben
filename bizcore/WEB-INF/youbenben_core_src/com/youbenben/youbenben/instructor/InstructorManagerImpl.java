...
public class InstructorManagerImpl extends CustomYoubenbenCheckerManager implements InstructorManager, BusinessHandler{
	...
	@Override
	public InstructorDAO daoOf(YoubenbenUserContext userContext) {
	...
	protected void throwExceptionWithMessage(String value) throws InstructorManagerException{
 	...
 	protected Instructor saveInstructor(YoubenbenUserContext userContext, Instructor instructor, String [] tokensExpr) throws Exception{	
 	...
 	protected Instructor saveInstructorDetail(YoubenbenUserContext userContext, Instructor instructor) throws Exception{	

 		
 		return saveInstructor(userContext, instructor, allTokens());
 	}
 	
 	public Instructor loadInstructor(YoubenbenUserContext userContext, String instructorId, String [] tokensExpr) throws Exception{				
 	 ...
 	 public Instructor searchInstructor(YoubenbenUserContext userContext, String instructorId, String textToSearch,String [] tokensExpr) throws Exception{				
 	...
 	protected Instructor present(YoubenbenUserContext userContext, Instructor instructor, Map<String, Object> tokens) throws Exception {
 	...
 	public Instructor loadInstructorDetail(YoubenbenUserContext userContext, String instructorId) throws Exception{	
 		Instructor instructor = loadInstructor( userContext, instructorId, allTokens());
 		return present(userContext,instructor, allTokens());
		
 	}
 	
 	public Object view(YoubenbenUserContext userContext, String instructorId) throws Exception{	
 		Instructor instructor = loadInstructor( userContext, instructorId, viewTokens());
 		return present(userContext,instructor, allTokens());
		
 	}
 	protected Instructor saveInstructor(YoubenbenUserContext userContext, Instructor instructor, Map<String,Object>tokens) throws Exception{	
 		return instructorDaoOf(userContext).save(instructor, tokens);
 	}
 	protected Instructor loadInstructor(YoubenbenUserContext userContext, String instructorId, Map<String,Object>tokens) throws Exception{	
		checkerOf(userContext).checkIdOfInstructor(instructorId);
		checkerOf(userContext).throwExceptionIfHasErrors( InstructorManagerException.class);
 	...
 	protected<T extends BaseEntity> void addActions(YoubenbenUserContext userContext, Instructor instructor, Map<String, Object> tokens){
	...
	}// end method of protected<T extends BaseEntity> void addActions(YoubenbenUserContext userContext, Instructor instructor, Map<String, Object> tokens){
	...
	public Instructor createInstructor(YoubenbenUserContext userContext, String title,String familyName,String givenName,String cellPhone,String email,String companyId,String introduction) throws Exception
	//public Instructor createInstructor(YoubenbenUserContext userContext,String title, String familyName, String givenName, String cellPhone, String email, String companyId, String introduction) throws Exception
	{
	...
	protected void checkParamsForUpdatingInstructor(YoubenbenUserContext userContext,String instructorId, int instructorVersion, String property, String newValueExpr,String [] tokensExpr)throws Exception
	{
	...
	public Instructor clone(YoubenbenUserContext userContext, String fromInstructorId) throws Exception{

		return instructorDaoOf(userContext).clone(fromInstructorId, this.allTokens());
	}

	public Instructor internalSaveInstructor(YoubenbenUserContext userContext, Instructor instructor) throws Exception
	{
		return internalSaveInstructor(userContext, instructor, allTokens());

	}
	public Instructor internalSaveInstructor(YoubenbenUserContext userContext, Instructor instructor, Map<String,Object> options) throws Exception
	{
	...
	public Instructor updateInstructor(YoubenbenUserContext userContext,String instructorId, int instructorVersion, String property, String newValueExpr,String [] tokensExpr) throws Exception
	{
		checkParamsForUpdatingInstructor(userContext, instructorId, instructorVersion, property, newValueExpr, tokensExpr);
	...
	public Instructor updateInstructorProperty(YoubenbenUserContext userContext,String instructorId, int instructorVersion, String property, String newValueExpr,String [] tokensExpr) throws Exception
	{
		checkParamsForUpdatingInstructor(userContext, instructorId, instructorVersion, property, newValueExpr, tokensExpr);
	...
	protected void checkParamsForTransferingAnotherCompany(YoubenbenUserContext userContext, String instructorId, String anotherCompanyId) throws Exception
 	{
 	...
 	public Instructor transferToAnotherCompany(YoubenbenUserContext userContext, String instructorId, String anotherCompanyId) throws Exception
 	{
 ...
 //--------------------------------------------------------------
	...
	public void delete(YoubenbenUserContext userContext, String instructorId, int instructorVersion) throws Exception {
	...
	public Instructor forgetByAll(YoubenbenUserContext userContext, String instructorId, int instructorVersion) throws Exception {
		return forgetByAllInternal(userContext, instructorId, instructorVersion);
	}
	protected Instructor forgetByAllInternal(YoubenbenUserContext userContext,
			String instructorId, int instructorVersion) throws Exception{
	...
	protected Instructor breakWithCompanyTrainingByCompany(YoubenbenUserContext userContext, String instructorId, String companyId,  String [] tokensExpr)
		 throws Exception{
	...
	protected Instructor breakWithCompanyTrainingByTrainingCourseType(YoubenbenUserContext userContext, String instructorId, String trainingCourseTypeId,  String [] tokensExpr)
		 throws Exception{
	...
	protected void checkParamsForAddingCompanyTraining(YoubenbenUserContext userContext, String instructorId, String title, String companyId, String trainingCourseTypeId, Date timeStart, int durationHours,String [] tokensExpr) throws Exception{
	...
	public  Instructor addCompanyTraining(YoubenbenUserContext userContext, String instructorId, String title, String companyId, String trainingCourseTypeId, Date timeStart, int durationHours, String [] tokensExpr) throws Exception
	{
	...
	protected void checkParamsForUpdatingCompanyTrainingProperties(YoubenbenUserContext userContext, String instructorId,String id,String title,Date timeStart,int durationHours,String [] tokensExpr) throws Exception {
	...
	public  Instructor updateCompanyTrainingProperties(YoubenbenUserContext userContext, String instructorId, String id,String title,Date timeStart,int durationHours, String [] tokensExpr) throws Exception
	{
	...
	protected CompanyTraining createCompanyTraining(YoubenbenUserContext userContext, String title, String companyId, String trainingCourseTypeId, Date timeStart, int durationHours) throws Exception{
	...
	protected void checkParamsForRemovingCompanyTrainingList(YoubenbenUserContext userContext, String instructorId,
	...
	public  Instructor removeCompanyTrainingList(YoubenbenUserContext userContext, String instructorId,
			String companyTrainingIds[],String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForRemovingCompanyTraining(YoubenbenUserContext userContext, String instructorId,
	...
	public  Instructor removeCompanyTraining(YoubenbenUserContext userContext, String instructorId,
		String companyTrainingId, int companyTrainingVersion,String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForCopyingCompanyTraining(YoubenbenUserContext userContext, String instructorId,
		String companyTrainingId, int companyTrainingVersion,String [] tokensExpr) throws Exception{
	...
	public  Instructor copyCompanyTrainingFrom(YoubenbenUserContext userContext, String instructorId,
		String companyTrainingId, int companyTrainingVersion,String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForUpdatingCompanyTraining(YoubenbenUserContext userContext, String instructorId, String companyTrainingId, int companyTrainingVersion, String property, String newValueExpr,String [] tokensExpr) throws Exception{
	...
	public  Instructor updateCompanyTraining(YoubenbenUserContext userContext, String instructorId, String companyTrainingId, int companyTrainingVersion, String property, String newValueExpr,String [] tokensExpr)
			throws Exception{
	...
	*/
	...
	public void onNewInstanceCreated(YoubenbenUserContext userContext, Instructor newCreated) throws Exception{
	...
	// -----------------------------------// list-of-view 处理 \\-----------------------------------
    protected void enhanceForListOfView(YoubenbenUserContext userContext,SmartList<Instructor> list) throws Exception {
  ...
  // -----------------------------------\\ list-of-view 处理 //-----------------------------------v
	 ...
	 * @throws Exception
	 */
 	public Object wxappview(YoubenbenUserContext userContext, String instructorId) throws Exception{
	  SerializeScope vscope = YoubenbenViewScope.getInstance().getInstructorDetailScope().clone();
