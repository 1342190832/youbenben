...
import com.youbenben.youbenben.levelthreecategory.CandidateLevelThreeCategory;
...
public class ProductManagerImpl extends CustomYoubenbenCheckerManager implements ProductManager, BusinessHandler{
	...
	@Override
	public ProductDAO daoOf(YoubenbenUserContext userContext) {
	...
	protected void throwExceptionWithMessage(String value) throws ProductManagerException{
 	...
 	protected Product saveProduct(YoubenbenUserContext userContext, Product product, String [] tokensExpr) throws Exception{	
 	...
 	protected Product saveProductDetail(YoubenbenUserContext userContext, Product product) throws Exception{	
 	...
 	public Product loadProduct(YoubenbenUserContext userContext, String productId, String [] tokensExpr) throws Exception{				
 	 ...
 	 public Product searchProduct(YoubenbenUserContext userContext, String productId, String textToSearch,String [] tokensExpr) throws Exception{				
 	...
 	protected Product present(YoubenbenUserContext userContext, Product product, Map<String, Object> tokens) throws Exception {
 	...
 	public Product loadProductDetail(YoubenbenUserContext userContext, String productId) throws Exception{	
 		Product product = loadProduct( userContext, productId, allTokens());
 		return present(userContext,product, allTokens());
		
 	}
 	
 	public Object view(YoubenbenUserContext userContext, String productId) throws Exception{	
 		Product product = loadProduct( userContext, productId, viewTokens());
 		return present(userContext,product, allTokens());
		
 	}
 	protected Product saveProduct(YoubenbenUserContext userContext, Product product, Map<String,Object>tokens) throws Exception{	
 		return productDaoOf(userContext).save(product, tokens);
 	}
 	protected Product loadProduct(YoubenbenUserContext userContext, String productId, Map<String,Object>tokens) throws Exception{	
		checkerOf(userContext).checkIdOfProduct(productId);
		checkerOf(userContext).throwExceptionIfHasErrors( ProductManagerException.class);
 	...
 	protected<T extends BaseEntity> void addActions(YoubenbenUserContext userContext, Product product, Map<String, Object> tokens){
	...
	}// end method of protected<T extends BaseEntity> void addActions(YoubenbenUserContext userContext, Product product, Map<String, Object> tokens){
	...
	protected void checkParamsForUpdatingProduct(YoubenbenUserContext userContext,String productId, int productVersion, String property, String newValueExpr,String [] tokensExpr)throws Exception
	{
	...
	public Product clone(YoubenbenUserContext userContext, String fromProductId) throws Exception{
	...
	public Product internalSaveProduct(YoubenbenUserContext userContext, Product product, Map<String,Object> options) throws Exception
	{
	...
	public Product updateProductProperty(YoubenbenUserContext userContext,String productId, int productVersion, String property, String newValueExpr,String [] tokensExpr) throws Exception
	{
		checkParamsForUpdatingProduct(userContext, productId, productVersion, property, newValueExpr, tokensExpr);
	...
	protected void checkParamsForTransferingAnotherParentCategory(YoubenbenUserContext userContext, String productId, String anotherParentCategoryId) throws Exception
 	{
	...
	public CandidateLevelThreeCategory requestCandidateParentCategory(YoubenbenUserContext userContext, String ownerClass, String id, String filterKey, int pageNo) throws Exception {
 ...
 //--------------------------------------------------------------
 	...
 	protected LevelThreeCategory loadLevelThreeCategory(YoubenbenUserContext userContext, String newParentCategoryId, Map<String,Object> options) throws Exception
 	{
	...
	public void delete(YoubenbenUserContext userContext, String productId, int productVersion) throws Exception {
	...
	public Product forgetByAll(YoubenbenUserContext userContext, String productId, int productVersion) throws Exception {
		return forgetByAllInternal(userContext, productId, productVersion);
	}
	protected Product forgetByAllInternal(YoubenbenUserContext userContext,
			String productId, int productVersion) throws Exception{
	...
	protected void checkParamsForAddingSku(YoubenbenUserContext userContext, String productId, String name, String size, String barcode, String packageType, String netContent, BigDecimal price, String picture,String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForUpdatingSkuProperties(YoubenbenUserContext userContext, String productId,String id,String name,String size,String barcode,String packageType,String netContent,BigDecimal price,String picture,String [] tokensExpr) throws Exception {
	...
	public  Product updateSkuProperties(YoubenbenUserContext userContext, String productId, String id,String name,String size,String barcode,String packageType,String netContent,BigDecimal price,String picture, String [] tokensExpr) throws Exception
	{
	...
	protected Sku createSku(YoubenbenUserContext userContext, String name, String size, String barcode, String packageType, String netContent, BigDecimal price, String picture) throws Exception{
	...
	protected void checkParamsForRemovingSkuList(YoubenbenUserContext userContext, String productId,
	...
	public  Product removeSkuList(YoubenbenUserContext userContext, String productId,
			String skuIds[],String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForRemovingSku(YoubenbenUserContext userContext, String productId,
	...
	public  Product removeSku(YoubenbenUserContext userContext, String productId,
		String skuId, int skuVersion,String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForCopyingSku(YoubenbenUserContext userContext, String productId,
		String skuId, int skuVersion,String [] tokensExpr) throws Exception{
	...
	public  Product copySkuFrom(YoubenbenUserContext userContext, String productId,
		String skuId, int skuVersion,String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForUpdatingSku(YoubenbenUserContext userContext, String productId, String skuId, int skuVersion, String property, String newValueExpr,String [] tokensExpr) throws Exception{
	...
	public  Product updateSku(YoubenbenUserContext userContext, String productId, String skuId, int skuVersion, String property, String newValueExpr,String [] tokensExpr)
			throws Exception{
	...
	*/
	...
	// -----------------------------------// list-of-view 处理 \\-----------------------------------
    protected void enhanceForListOfView(YoubenbenUserContext userContext,SmartList<Product> list) throws Exception {
    	if (list == null || list.isEmpty()){
    		return;
    	}
		List<LevelThreeCategory> parentCategoryList = YoubenbenBaseUtils.collectReferencedObjectWithType(userContext, list, LevelThreeCategory.class);
  ...
  // -----------------------------------\\ list-of-view 处理 //-----------------------------------v
	 ...
	 * @throws Exception
	 */
 	public Object wxappview(YoubenbenUserContext userContext, String productId) throws Exception{
	  SerializeScope vscope = YoubenbenViewScope.getInstance().getProductDetailScope().clone();
    ...
    String pageTitle = "产品"+"详情";
		...
		vscope.field("skuListSection", YoubenbenListOfViewScope.getInstance()
