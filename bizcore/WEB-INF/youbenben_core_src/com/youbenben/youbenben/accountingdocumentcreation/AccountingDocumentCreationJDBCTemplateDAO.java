...
public class AccountingDocumentCreationJDBCTemplateDAO extends YoubenbenBaseDAOImpl implements AccountingDocumentCreationDAO{
	...
	*/
	...
	public SmartList<AccountingDocumentCreation> loadAll() {
	    return this.loadAll(getAccountingDocumentCreationMapper());
	}
    ...
    public SmartList<AccountingDocumentCreation> requestCandidateAccountingDocumentCreationForAccountingDocument(YoubenbenUserContext userContext, String ownerClass, String id, String filterKey, int pageNo, int pageSize) throws Exception {
        // NOTE: by default, ignore owner info, just return all by filter key.
		// You need override this method if you have different candidate-logic
		return findAllCandidateByFilter(AccountingDocumentCreationTable.COLUMN_WHO, null, filterKey, pageNo, pageSize, getAccountingDocumentCreationMapper());
    }
	...
	public SmartList<AccountingDocument> loadOurAccountingDocumentList(YoubenbenUserContext userContext, List<AccountingDocumentCreation> us, Map<String,Object> options) throws Exception{
