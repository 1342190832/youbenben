...
public class AccountingDocumentCreationManagerImpl extends CustomYoubenbenCheckerManager implements AccountingDocumentCreationManager, BusinessHandler{
	...
	@Override
	public AccountingDocumentCreationDAO daoOf(YoubenbenUserContext userContext) {
	...
	protected void throwExceptionWithMessage(String value) throws AccountingDocumentCreationManagerException{
 	...
 	protected AccountingDocumentCreation saveAccountingDocumentCreation(YoubenbenUserContext userContext, AccountingDocumentCreation accountingDocumentCreation, String [] tokensExpr) throws Exception{	
 	...
 	protected AccountingDocumentCreation saveAccountingDocumentCreationDetail(YoubenbenUserContext userContext, AccountingDocumentCreation accountingDocumentCreation) throws Exception{	
 	...
 	public AccountingDocumentCreation loadAccountingDocumentCreation(YoubenbenUserContext userContext, String accountingDocumentCreationId, String [] tokensExpr) throws Exception{				
 	 ...
 	 public AccountingDocumentCreation searchAccountingDocumentCreation(YoubenbenUserContext userContext, String accountingDocumentCreationId, String textToSearch,String [] tokensExpr) throws Exception{				
 	...
 	protected AccountingDocumentCreation present(YoubenbenUserContext userContext, AccountingDocumentCreation accountingDocumentCreation, Map<String, Object> tokens) throws Exception {
 	...
 	public AccountingDocumentCreation loadAccountingDocumentCreationDetail(YoubenbenUserContext userContext, String accountingDocumentCreationId) throws Exception{	
 	...
 	public Object view(YoubenbenUserContext userContext, String accountingDocumentCreationId) throws Exception{	
 	...
 	protected AccountingDocumentCreation saveAccountingDocumentCreation(YoubenbenUserContext userContext, AccountingDocumentCreation accountingDocumentCreation, Map<String,Object>tokens) throws Exception{	
 		return accountingDocumentCreationDaoOf(userContext).save(accountingDocumentCreation, tokens);
 	}
 	protected AccountingDocumentCreation loadAccountingDocumentCreation(YoubenbenUserContext userContext, String accountingDocumentCreationId, Map<String,Object>tokens) throws Exception{	
		checkerOf(userContext).checkIdOfAccountingDocumentCreation(accountingDocumentCreationId);
		checkerOf(userContext).throwExceptionIfHasErrors( AccountingDocumentCreationManagerException.class);
 	...
 	protected<T extends BaseEntity> void addActions(YoubenbenUserContext userContext, AccountingDocumentCreation accountingDocumentCreation, Map<String, Object> tokens){
	...
	}// end method of protected<T extends BaseEntity> void addActions(YoubenbenUserContext userContext, AccountingDocumentCreation accountingDocumentCreation, Map<String, Object> tokens){
	...
	protected void checkParamsForUpdatingAccountingDocumentCreation(YoubenbenUserContext userContext,String accountingDocumentCreationId, int accountingDocumentCreationVersion, String property, String newValueExpr,String [] tokensExpr)throws Exception
	{
	...
	public AccountingDocumentCreation clone(YoubenbenUserContext userContext, String fromAccountingDocumentCreationId) throws Exception{
	...
	public AccountingDocumentCreation internalSaveAccountingDocumentCreation(YoubenbenUserContext userContext, AccountingDocumentCreation accountingDocumentCreation, Map<String,Object> options) throws Exception
	{
	...
	public AccountingDocumentCreation updateAccountingDocumentCreationProperty(YoubenbenUserContext userContext,String accountingDocumentCreationId, int accountingDocumentCreationVersion, String property, String newValueExpr,String [] tokensExpr) throws Exception
	{
		checkParamsForUpdatingAccountingDocumentCreation(userContext, accountingDocumentCreationId, accountingDocumentCreationVersion, property, newValueExpr, tokensExpr);
...
//--------------------------------------------------------------
	...
	public void delete(YoubenbenUserContext userContext, String accountingDocumentCreationId, int accountingDocumentCreationVersion) throws Exception {
	...
	public AccountingDocumentCreation forgetByAll(YoubenbenUserContext userContext, String accountingDocumentCreationId, int accountingDocumentCreationVersion) throws Exception {
		return forgetByAllInternal(userContext, accountingDocumentCreationId, accountingDocumentCreationVersion);
	}
	protected AccountingDocumentCreation forgetByAllInternal(YoubenbenUserContext userContext,
			String accountingDocumentCreationId, int accountingDocumentCreationVersion) throws Exception{
	...
	protected AccountingDocumentCreation breakWithAccountingDocumentByAccountingPeriod(YoubenbenUserContext userContext, String accountingDocumentCreationId, String accountingPeriodId,  String [] tokensExpr)
		 throws Exception{
	...
	protected AccountingDocumentCreation breakWithAccountingDocumentByDocumentType(YoubenbenUserContext userContext, String accountingDocumentCreationId, String documentTypeId,  String [] tokensExpr)
		 throws Exception{
	...
	protected AccountingDocumentCreation breakWithAccountingDocumentByConfirmation(YoubenbenUserContext userContext, String accountingDocumentCreationId, String confirmationId,  String [] tokensExpr)
		 throws Exception{
	...
	protected AccountingDocumentCreation breakWithAccountingDocumentByAuditing(YoubenbenUserContext userContext, String accountingDocumentCreationId, String auditingId,  String [] tokensExpr)
		 throws Exception{
	...
	protected AccountingDocumentCreation breakWithAccountingDocumentByPosting(YoubenbenUserContext userContext, String accountingDocumentCreationId, String postingId,  String [] tokensExpr)
		 throws Exception{
	...
	protected void checkParamsForAddingAccountingDocument(YoubenbenUserContext userContext, String accountingDocumentCreationId, String name, Date accountingDocumentDate, String accountingPeriodId, String documentTypeId, String confirmationId, String auditingId, String postingId,String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForUpdatingAccountingDocumentProperties(YoubenbenUserContext userContext, String accountingDocumentCreationId,String id,String name,Date accountingDocumentDate,String [] tokensExpr) throws Exception {
	...
	public  AccountingDocumentCreation updateAccountingDocumentProperties(YoubenbenUserContext userContext, String accountingDocumentCreationId, String id,String name,Date accountingDocumentDate, String [] tokensExpr) throws Exception
	{
	...
	protected AccountingDocument createAccountingDocument(YoubenbenUserContext userContext, String name, Date accountingDocumentDate, String accountingPeriodId, String documentTypeId, String confirmationId, String auditingId, String postingId) throws Exception{
	...
	protected void checkParamsForRemovingAccountingDocumentList(YoubenbenUserContext userContext, String accountingDocumentCreationId,
	...
	public  AccountingDocumentCreation removeAccountingDocumentList(YoubenbenUserContext userContext, String accountingDocumentCreationId,
			String accountingDocumentIds[],String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForRemovingAccountingDocument(YoubenbenUserContext userContext, String accountingDocumentCreationId,
	...
	public  AccountingDocumentCreation removeAccountingDocument(YoubenbenUserContext userContext, String accountingDocumentCreationId,
		String accountingDocumentId, int accountingDocumentVersion,String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForCopyingAccountingDocument(YoubenbenUserContext userContext, String accountingDocumentCreationId,
		String accountingDocumentId, int accountingDocumentVersion,String [] tokensExpr) throws Exception{
	...
	public  AccountingDocumentCreation copyAccountingDocumentFrom(YoubenbenUserContext userContext, String accountingDocumentCreationId,
		String accountingDocumentId, int accountingDocumentVersion,String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForUpdatingAccountingDocument(YoubenbenUserContext userContext, String accountingDocumentCreationId, String accountingDocumentId, int accountingDocumentVersion, String property, String newValueExpr,String [] tokensExpr) throws Exception{
	...
	public  AccountingDocumentCreation updateAccountingDocument(YoubenbenUserContext userContext, String accountingDocumentCreationId, String accountingDocumentId, int accountingDocumentVersion, String property, String newValueExpr,String [] tokensExpr)
			throws Exception{
	...
	*/
	...
	// -----------------------------------// list-of-view 处理 \\-----------------------------------
    protected void enhanceForListOfView(YoubenbenUserContext userContext,SmartList<AccountingDocumentCreation> list) throws Exception {
  ...
  // -----------------------------------\\ list-of-view 处理 //-----------------------------------v
	 ...
	 * @throws Exception
	 */
 	public Object wxappview(YoubenbenUserContext userContext, String accountingDocumentCreationId) throws Exception{
	  SerializeScope vscope = YoubenbenViewScope.getInstance().getAccountingDocumentCreationDetailScope().clone();
