...
public class AccountingDocumentAuditingManagerImpl extends CustomYoubenbenCheckerManager implements AccountingDocumentAuditingManager, BusinessHandler{
	...
	@Override
	public AccountingDocumentAuditingDAO daoOf(YoubenbenUserContext userContext) {
	...
	protected void throwExceptionWithMessage(String value) throws AccountingDocumentAuditingManagerException{
 	...
 	protected AccountingDocumentAuditing saveAccountingDocumentAuditing(YoubenbenUserContext userContext, AccountingDocumentAuditing accountingDocumentAuditing, String [] tokensExpr) throws Exception{	
 	...
 	protected AccountingDocumentAuditing saveAccountingDocumentAuditingDetail(YoubenbenUserContext userContext, AccountingDocumentAuditing accountingDocumentAuditing) throws Exception{	
 	...
 	public AccountingDocumentAuditing loadAccountingDocumentAuditing(YoubenbenUserContext userContext, String accountingDocumentAuditingId, String [] tokensExpr) throws Exception{				
 	 ...
 	 public AccountingDocumentAuditing searchAccountingDocumentAuditing(YoubenbenUserContext userContext, String accountingDocumentAuditingId, String textToSearch,String [] tokensExpr) throws Exception{				
 	...
 	protected AccountingDocumentAuditing present(YoubenbenUserContext userContext, AccountingDocumentAuditing accountingDocumentAuditing, Map<String, Object> tokens) throws Exception {
 	...
 	public AccountingDocumentAuditing loadAccountingDocumentAuditingDetail(YoubenbenUserContext userContext, String accountingDocumentAuditingId) throws Exception{	
 	...
 	public Object view(YoubenbenUserContext userContext, String accountingDocumentAuditingId) throws Exception{	
 	...
 	protected AccountingDocumentAuditing saveAccountingDocumentAuditing(YoubenbenUserContext userContext, AccountingDocumentAuditing accountingDocumentAuditing, Map<String,Object>tokens) throws Exception{	
 		return accountingDocumentAuditingDaoOf(userContext).save(accountingDocumentAuditing, tokens);
 	}
 	protected AccountingDocumentAuditing loadAccountingDocumentAuditing(YoubenbenUserContext userContext, String accountingDocumentAuditingId, Map<String,Object>tokens) throws Exception{	
		checkerOf(userContext).checkIdOfAccountingDocumentAuditing(accountingDocumentAuditingId);
		checkerOf(userContext).throwExceptionIfHasErrors( AccountingDocumentAuditingManagerException.class);
 	...
 	protected<T extends BaseEntity> void addActions(YoubenbenUserContext userContext, AccountingDocumentAuditing accountingDocumentAuditing, Map<String, Object> tokens){
	...
	}// end method of protected<T extends BaseEntity> void addActions(YoubenbenUserContext userContext, AccountingDocumentAuditing accountingDocumentAuditing, Map<String, Object> tokens){
	...
	protected void checkParamsForUpdatingAccountingDocumentAuditing(YoubenbenUserContext userContext,String accountingDocumentAuditingId, int accountingDocumentAuditingVersion, String property, String newValueExpr,String [] tokensExpr)throws Exception
	{
	...
	public AccountingDocumentAuditing clone(YoubenbenUserContext userContext, String fromAccountingDocumentAuditingId) throws Exception{
	...
	public AccountingDocumentAuditing internalSaveAccountingDocumentAuditing(YoubenbenUserContext userContext, AccountingDocumentAuditing accountingDocumentAuditing, Map<String,Object> options) throws Exception
	{
	...
	public AccountingDocumentAuditing updateAccountingDocumentAuditingProperty(YoubenbenUserContext userContext,String accountingDocumentAuditingId, int accountingDocumentAuditingVersion, String property, String newValueExpr,String [] tokensExpr) throws Exception
	{
		checkParamsForUpdatingAccountingDocumentAuditing(userContext, accountingDocumentAuditingId, accountingDocumentAuditingVersion, property, newValueExpr, tokensExpr);
...
//--------------------------------------------------------------
	...
	public void delete(YoubenbenUserContext userContext, String accountingDocumentAuditingId, int accountingDocumentAuditingVersion) throws Exception {
	...
	public AccountingDocumentAuditing forgetByAll(YoubenbenUserContext userContext, String accountingDocumentAuditingId, int accountingDocumentAuditingVersion) throws Exception {
		return forgetByAllInternal(userContext, accountingDocumentAuditingId, accountingDocumentAuditingVersion);
	}
	protected AccountingDocumentAuditing forgetByAllInternal(YoubenbenUserContext userContext,
			String accountingDocumentAuditingId, int accountingDocumentAuditingVersion) throws Exception{
	...
	protected AccountingDocumentAuditing breakWithAccountingDocumentByAccountingPeriod(YoubenbenUserContext userContext, String accountingDocumentAuditingId, String accountingPeriodId,  String [] tokensExpr)
		 throws Exception{
	...
	protected AccountingDocumentAuditing breakWithAccountingDocumentByDocumentType(YoubenbenUserContext userContext, String accountingDocumentAuditingId, String documentTypeId,  String [] tokensExpr)
		 throws Exception{
	...
	protected AccountingDocumentAuditing breakWithAccountingDocumentByCreation(YoubenbenUserContext userContext, String accountingDocumentAuditingId, String creationId,  String [] tokensExpr)
		 throws Exception{
	...
	protected AccountingDocumentAuditing breakWithAccountingDocumentByConfirmation(YoubenbenUserContext userContext, String accountingDocumentAuditingId, String confirmationId,  String [] tokensExpr)
		 throws Exception{
	...
	protected AccountingDocumentAuditing breakWithAccountingDocumentByPosting(YoubenbenUserContext userContext, String accountingDocumentAuditingId, String postingId,  String [] tokensExpr)
		 throws Exception{
	...
	protected void checkParamsForUpdatingAccountingDocumentProperties(YoubenbenUserContext userContext, String accountingDocumentAuditingId,String id,String name,Date accountingDocumentDate,String [] tokensExpr) throws Exception {
	...
	public  AccountingDocumentAuditing updateAccountingDocumentProperties(YoubenbenUserContext userContext, String accountingDocumentAuditingId, String id,String name,Date accountingDocumentDate, String [] tokensExpr) throws Exception
	{
	...
	protected AccountingDocument createAccountingDocument(YoubenbenUserContext userContext, String name, Date accountingDocumentDate, String accountingPeriodId, String documentTypeId, String creationId, String confirmationId, String postingId) throws Exception{
	...
	protected void checkParamsForRemovingAccountingDocumentList(YoubenbenUserContext userContext, String accountingDocumentAuditingId,
	...
	public  AccountingDocumentAuditing removeAccountingDocumentList(YoubenbenUserContext userContext, String accountingDocumentAuditingId,
			String accountingDocumentIds[],String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForRemovingAccountingDocument(YoubenbenUserContext userContext, String accountingDocumentAuditingId,
	...
	public  AccountingDocumentAuditing removeAccountingDocument(YoubenbenUserContext userContext, String accountingDocumentAuditingId,
		String accountingDocumentId, int accountingDocumentVersion,String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForCopyingAccountingDocument(YoubenbenUserContext userContext, String accountingDocumentAuditingId,
		String accountingDocumentId, int accountingDocumentVersion,String [] tokensExpr) throws Exception{
	...
	public  AccountingDocumentAuditing copyAccountingDocumentFrom(YoubenbenUserContext userContext, String accountingDocumentAuditingId,
		String accountingDocumentId, int accountingDocumentVersion,String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForUpdatingAccountingDocument(YoubenbenUserContext userContext, String accountingDocumentAuditingId, String accountingDocumentId, int accountingDocumentVersion, String property, String newValueExpr,String [] tokensExpr) throws Exception{
	...
	public  AccountingDocumentAuditing updateAccountingDocument(YoubenbenUserContext userContext, String accountingDocumentAuditingId, String accountingDocumentId, int accountingDocumentVersion, String property, String newValueExpr,String [] tokensExpr)
			throws Exception{
	...
	*/
	...
	// -----------------------------------// list-of-view 处理 \\-----------------------------------
    protected void enhanceForListOfView(YoubenbenUserContext userContext,SmartList<AccountingDocumentAuditing> list) throws Exception {
  ...
  // -----------------------------------\\ list-of-view 处理 //-----------------------------------v
	 ...
	 * @throws Exception
	 */
 	public Object wxappview(YoubenbenUserContext userContext, String accountingDocumentAuditingId) throws Exception{
	  SerializeScope vscope = YoubenbenViewScope.getInstance().getAccountingDocumentAuditingDetailScope().clone();
