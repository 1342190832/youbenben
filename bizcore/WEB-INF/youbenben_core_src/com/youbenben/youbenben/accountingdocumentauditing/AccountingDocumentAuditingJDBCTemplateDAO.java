...
public class AccountingDocumentAuditingJDBCTemplateDAO extends YoubenbenBaseDAOImpl implements AccountingDocumentAuditingDAO{
	...
	*/
	...
	public SmartList<AccountingDocumentAuditing> loadAll() {
	    return this.loadAll(getAccountingDocumentAuditingMapper());
	}
    ...
    public SmartList<AccountingDocumentAuditing> requestCandidateAccountingDocumentAuditingForAccountingDocument(YoubenbenUserContext userContext, String ownerClass, String id, String filterKey, int pageNo, int pageSize) throws Exception {
		...
		return findAllCandidateByFilter(AccountingDocumentAuditingTable.COLUMN_WHO, null, filterKey, pageNo, pageSize, getAccountingDocumentAuditingMapper());
    }
