...
public class PublicKeyTypeManagerImpl extends CustomYoubenbenCheckerManager implements PublicKeyTypeManager, BusinessHandler{
	...
	@Override
	public PublicKeyTypeDAO daoOf(YoubenbenUserContext userContext) {
	...
	protected void throwExceptionWithMessage(String value) throws PublicKeyTypeManagerException{
 	...
 	protected PublicKeyType savePublicKeyType(YoubenbenUserContext userContext, PublicKeyType publicKeyType, String [] tokensExpr) throws Exception{	
 	...
 	protected PublicKeyType savePublicKeyTypeDetail(YoubenbenUserContext userContext, PublicKeyType publicKeyType) throws Exception{	
 	...
 	public PublicKeyType loadPublicKeyType(YoubenbenUserContext userContext, String publicKeyTypeId, String [] tokensExpr) throws Exception{				
 	 ...
 	 public PublicKeyType searchPublicKeyType(YoubenbenUserContext userContext, String publicKeyTypeId, String textToSearch,String [] tokensExpr) throws Exception{				
 	...
 	protected PublicKeyType present(YoubenbenUserContext userContext, PublicKeyType publicKeyType, Map<String, Object> tokens) throws Exception {
 	...
 	public PublicKeyType loadPublicKeyTypeDetail(YoubenbenUserContext userContext, String publicKeyTypeId) throws Exception{	
 	...
 	public Object view(YoubenbenUserContext userContext, String publicKeyTypeId) throws Exception{	
 		PublicKeyType publicKeyType = loadPublicKeyType( userContext, publicKeyTypeId, viewTokens());
 		return present(userContext,publicKeyType, allTokens());
		
 	}
 	protected PublicKeyType savePublicKeyType(YoubenbenUserContext userContext, PublicKeyType publicKeyType, Map<String,Object>tokens) throws Exception{	
 		return publicKeyTypeDaoOf(userContext).save(publicKeyType, tokens);
 	}
 	protected PublicKeyType loadPublicKeyType(YoubenbenUserContext userContext, String publicKeyTypeId, Map<String,Object>tokens) throws Exception{	
		checkerOf(userContext).checkIdOfPublicKeyType(publicKeyTypeId);
		checkerOf(userContext).throwExceptionIfHasErrors( PublicKeyTypeManagerException.class);
 	...
 	protected<T extends BaseEntity> void addActions(YoubenbenUserContext userContext, PublicKeyType publicKeyType, Map<String, Object> tokens){
	...
	}// end method of protected<T extends BaseEntity> void addActions(YoubenbenUserContext userContext, PublicKeyType publicKeyType, Map<String, Object> tokens){
	...
	protected void checkParamsForUpdatingPublicKeyType(YoubenbenUserContext userContext,String publicKeyTypeId, int publicKeyTypeVersion, String property, String newValueExpr,String [] tokensExpr)throws Exception
	{
	...
	public PublicKeyType clone(YoubenbenUserContext userContext, String fromPublicKeyTypeId) throws Exception{
	...
	public PublicKeyType internalSavePublicKeyType(YoubenbenUserContext userContext, PublicKeyType publicKeyType, Map<String,Object> options) throws Exception
	{
	...
	public PublicKeyType updatePublicKeyTypeProperty(YoubenbenUserContext userContext,String publicKeyTypeId, int publicKeyTypeVersion, String property, String newValueExpr,String [] tokensExpr) throws Exception
	{
		checkParamsForUpdatingPublicKeyType(userContext, publicKeyTypeId, publicKeyTypeVersion, property, newValueExpr, tokensExpr);
	...
	protected void checkParamsForTransferingAnotherDomain(YoubenbenUserContext userContext, String publicKeyTypeId, String anotherDomainId) throws Exception
 	{
 ...
 //--------------------------------------------------------------
	...
	public void delete(YoubenbenUserContext userContext, String publicKeyTypeId, int publicKeyTypeVersion) throws Exception {
	...
	public PublicKeyType forgetByAll(YoubenbenUserContext userContext, String publicKeyTypeId, int publicKeyTypeVersion) throws Exception {
		return forgetByAllInternal(userContext, publicKeyTypeId, publicKeyTypeVersion);
	}
	protected PublicKeyType forgetByAllInternal(YoubenbenUserContext userContext,
			String publicKeyTypeId, int publicKeyTypeVersion) throws Exception{
	...
	protected PublicKeyType breakWithKeypairIdentifyBySecUser(YoubenbenUserContext userContext, String publicKeyTypeId, String secUserId,  String [] tokensExpr)
		 throws Exception{
	...
	protected void checkParamsForAddingKeypairIdentify(YoubenbenUserContext userContext, String publicKeyTypeId, String publicKey, String secUserId,String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForUpdatingKeypairIdentifyProperties(YoubenbenUserContext userContext, String publicKeyTypeId,String id,String publicKey,String [] tokensExpr) throws Exception {
	...
	public  PublicKeyType updateKeypairIdentifyProperties(YoubenbenUserContext userContext, String publicKeyTypeId, String id,String publicKey, String [] tokensExpr) throws Exception
	{
	...
	protected KeypairIdentify createKeypairIdentify(YoubenbenUserContext userContext, String publicKey, String secUserId) throws Exception{
	...
	protected void checkParamsForRemovingKeypairIdentifyList(YoubenbenUserContext userContext, String publicKeyTypeId,
	...
	public  PublicKeyType removeKeypairIdentifyList(YoubenbenUserContext userContext, String publicKeyTypeId,
			String keypairIdentifyIds[],String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForRemovingKeypairIdentify(YoubenbenUserContext userContext, String publicKeyTypeId,
	...
	public  PublicKeyType removeKeypairIdentify(YoubenbenUserContext userContext, String publicKeyTypeId,
		String keypairIdentifyId, int keypairIdentifyVersion,String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForCopyingKeypairIdentify(YoubenbenUserContext userContext, String publicKeyTypeId,
		String keypairIdentifyId, int keypairIdentifyVersion,String [] tokensExpr) throws Exception{
	...
	public  PublicKeyType copyKeypairIdentifyFrom(YoubenbenUserContext userContext, String publicKeyTypeId,
		String keypairIdentifyId, int keypairIdentifyVersion,String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForUpdatingKeypairIdentify(YoubenbenUserContext userContext, String publicKeyTypeId, String keypairIdentifyId, int keypairIdentifyVersion, String property, String newValueExpr,String [] tokensExpr) throws Exception{
	...
	public  PublicKeyType updateKeypairIdentify(YoubenbenUserContext userContext, String publicKeyTypeId, String keypairIdentifyId, int keypairIdentifyVersion, String property, String newValueExpr,String [] tokensExpr)
			throws Exception{
	...
	*/
	...
	// -----------------------------------// list-of-view 处理 \\-----------------------------------
    protected void enhanceForListOfView(YoubenbenUserContext userContext,SmartList<PublicKeyType> list) throws Exception {
  ...
  // -----------------------------------\\ list-of-view 处理 //-----------------------------------v
	 ...
	 * @throws Exception
	 */
 	public Object wxappview(YoubenbenUserContext userContext, String publicKeyTypeId) throws Exception{
	  SerializeScope vscope = YoubenbenViewScope.getInstance().getPublicKeyTypeDetailScope().clone();
