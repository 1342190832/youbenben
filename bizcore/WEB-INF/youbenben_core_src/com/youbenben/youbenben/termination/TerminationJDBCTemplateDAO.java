...
public class TerminationJDBCTemplateDAO extends YoubenbenBaseDAOImpl implements TerminationDAO{
	...
	*/
    ...
    public SmartList<Termination> requestCandidateTerminationForEmployee(YoubenbenUserContext userContext, String ownerClass, String id, String filterKey, int pageNo, int pageSize) throws Exception {
		...
		return findAllCandidateByFilter(TerminationTable.COLUMN_REASON, TerminationTable.COLUMN_REASON, filterKey, pageNo, pageSize, getTerminationMapper());
    }
