...
import com.youbenben.youbenben.terminationtype.CandidateTerminationType;
import com.youbenben.youbenben.terminationreason.CandidateTerminationReason;
...
public class TerminationManagerImpl extends CustomYoubenbenCheckerManager implements TerminationManager, BusinessHandler{
	...
	@Override
	public TerminationDAO daoOf(YoubenbenUserContext userContext) {
	...
	protected void throwExceptionWithMessage(String value) throws TerminationManagerException{
 	...
 	protected Termination saveTermination(YoubenbenUserContext userContext, Termination termination, String [] tokensExpr) throws Exception{	
 	...
 	protected Termination saveTerminationDetail(YoubenbenUserContext userContext, Termination termination) throws Exception{	
 	...
 	public Termination loadTermination(YoubenbenUserContext userContext, String terminationId, String [] tokensExpr) throws Exception{				
 	 ...
 	 public Termination searchTermination(YoubenbenUserContext userContext, String terminationId, String textToSearch,String [] tokensExpr) throws Exception{				
 	...
 	protected Termination present(YoubenbenUserContext userContext, Termination termination, Map<String, Object> tokens) throws Exception {
 	...
 	public Termination loadTerminationDetail(YoubenbenUserContext userContext, String terminationId) throws Exception{	
 	...
 	public Object view(YoubenbenUserContext userContext, String terminationId) throws Exception{	
 		Termination termination = loadTermination( userContext, terminationId, viewTokens());
 		return present(userContext,termination, allTokens());
		
 	}
 	protected Termination saveTermination(YoubenbenUserContext userContext, Termination termination, Map<String,Object>tokens) throws Exception{	
 		return terminationDaoOf(userContext).save(termination, tokens);
 	}
 	protected Termination loadTermination(YoubenbenUserContext userContext, String terminationId, Map<String,Object>tokens) throws Exception{	
		checkerOf(userContext).checkIdOfTermination(terminationId);
		checkerOf(userContext).throwExceptionIfHasErrors( TerminationManagerException.class);
 	...
 	protected<T extends BaseEntity> void addActions(YoubenbenUserContext userContext, Termination termination, Map<String, Object> tokens){
	...
	}// end method of protected<T extends BaseEntity> void addActions(YoubenbenUserContext userContext, Termination termination, Map<String, Object> tokens){
	...
	protected void checkParamsForUpdatingTermination(YoubenbenUserContext userContext,String terminationId, int terminationVersion, String property, String newValueExpr,String [] tokensExpr)throws Exception
	{
	...
	public Termination clone(YoubenbenUserContext userContext, String fromTerminationId) throws Exception{
	...
	public Termination internalSaveTermination(YoubenbenUserContext userContext, Termination termination, Map<String,Object> options) throws Exception
	{
	...
	public Termination updateTerminationProperty(YoubenbenUserContext userContext,String terminationId, int terminationVersion, String property, String newValueExpr,String [] tokensExpr) throws Exception
	{
		checkParamsForUpdatingTermination(userContext, terminationId, terminationVersion, property, newValueExpr, tokensExpr);
	...
	protected void checkParamsForTransferingAnotherReason(YoubenbenUserContext userContext, String terminationId, String anotherReasonId) throws Exception
 	{
	...
	public CandidateTerminationReason requestCandidateReason(YoubenbenUserContext userContext, String ownerClass, String id, String filterKey, int pageNo) throws Exception {
 	...
 	protected void checkParamsForTransferingAnotherType(YoubenbenUserContext userContext, String terminationId, String anotherTypeId) throws Exception
 	{
	...
	public CandidateTerminationType requestCandidateType(YoubenbenUserContext userContext, String ownerClass, String id, String filterKey, int pageNo) throws Exception {
 ...
 //--------------------------------------------------------------
 	...
 	protected TerminationReason loadTerminationReason(YoubenbenUserContext userContext, String newReasonId, Map<String,Object> options) throws Exception
 	{
 	...
 	protected TerminationType loadTerminationType(YoubenbenUserContext userContext, String newTypeId, Map<String,Object> options) throws Exception
 	{
	...
	public void delete(YoubenbenUserContext userContext, String terminationId, int terminationVersion) throws Exception {
	...
	public Termination forgetByAll(YoubenbenUserContext userContext, String terminationId, int terminationVersion) throws Exception {
		return forgetByAllInternal(userContext, terminationId, terminationVersion);
	}
	protected Termination forgetByAllInternal(YoubenbenUserContext userContext,
			String terminationId, int terminationVersion) throws Exception{
	...
	protected Termination breakWithEmployeeByCompany(YoubenbenUserContext userContext, String terminationId, String companyId,  String [] tokensExpr)
		 throws Exception{
	...
	protected Termination breakWithEmployeeByDepartment(YoubenbenUserContext userContext, String terminationId, String departmentId,  String [] tokensExpr)
		 throws Exception{
	...
	protected Termination breakWithEmployeeByOccupation(YoubenbenUserContext userContext, String terminationId, String occupationId,  String [] tokensExpr)
		 throws Exception{
	...
	protected Termination breakWithEmployeeByResponsibleFor(YoubenbenUserContext userContext, String terminationId, String responsibleForId,  String [] tokensExpr)
		 throws Exception{
	...
	protected Termination breakWithEmployeeByCurrentSalaryGrade(YoubenbenUserContext userContext, String terminationId, String currentSalaryGradeId,  String [] tokensExpr)
		 throws Exception{
	...
	protected Termination breakWithEmployeeByJobApplication(YoubenbenUserContext userContext, String terminationId, String jobApplicationId,  String [] tokensExpr)
		 throws Exception{
	...
	protected Termination breakWithEmployeeByProfessionInterview(YoubenbenUserContext userContext, String terminationId, String professionInterviewId,  String [] tokensExpr)
		 throws Exception{
	...
	protected Termination breakWithEmployeeByHrInterview(YoubenbenUserContext userContext, String terminationId, String hrInterviewId,  String [] tokensExpr)
		 throws Exception{
	...
	protected Termination breakWithEmployeeByOfferApproval(YoubenbenUserContext userContext, String terminationId, String offerApprovalId,  String [] tokensExpr)
		 throws Exception{
	...
	protected Termination breakWithEmployeeByOfferAcceptance(YoubenbenUserContext userContext, String terminationId, String offerAcceptanceId,  String [] tokensExpr)
		 throws Exception{
	...
	protected Termination breakWithEmployeeByEmployeeBoarding(YoubenbenUserContext userContext, String terminationId, String employeeBoardingId,  String [] tokensExpr)
		 throws Exception{
	...
	protected void checkParamsForAddingEmployee(YoubenbenUserContext userContext, String terminationId, String companyId, String title, String departmentId, String familyName, String givenName, String email, String city, String address, String cellPhone, String occupationId, String responsibleForId, String currentSalaryGradeId, String salaryAccount, String jobApplicationId, String professionInterviewId, String hrInterviewId, String offerApprovalId, String offerAcceptanceId, String employeeBoardingId,String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForUpdatingEmployeeProperties(YoubenbenUserContext userContext, String terminationId,String id,String title,String familyName,String givenName,String email,String city,String address,String cellPhone,String salaryAccount,String [] tokensExpr) throws Exception {
	...
	public  Termination updateEmployeeProperties(YoubenbenUserContext userContext, String terminationId, String id,String title,String familyName,String givenName,String email,String city,String address,String cellPhone,String salaryAccount, String [] tokensExpr) throws Exception
	{
	...
	protected void checkParamsForRemovingEmployeeList(YoubenbenUserContext userContext, String terminationId,
	...
	public  Termination removeEmployeeList(YoubenbenUserContext userContext, String terminationId,
			String employeeIds[],String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForRemovingEmployee(YoubenbenUserContext userContext, String terminationId,
	...
	public  Termination removeEmployee(YoubenbenUserContext userContext, String terminationId,
		String employeeId, int employeeVersion,String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForCopyingEmployee(YoubenbenUserContext userContext, String terminationId,
		String employeeId, int employeeVersion,String [] tokensExpr) throws Exception{
	...
	public  Termination copyEmployeeFrom(YoubenbenUserContext userContext, String terminationId,
		String employeeId, int employeeVersion,String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForUpdatingEmployee(YoubenbenUserContext userContext, String terminationId, String employeeId, int employeeVersion, String property, String newValueExpr,String [] tokensExpr) throws Exception{
	...
	public  Termination updateEmployee(YoubenbenUserContext userContext, String terminationId, String employeeId, int employeeVersion, String property, String newValueExpr,String [] tokensExpr)
			throws Exception{
	...
	*/
	...
	// -----------------------------------// list-of-view 处理 \\-----------------------------------
    protected void enhanceForListOfView(YoubenbenUserContext userContext,SmartList<Termination> list) throws Exception {
    	if (list == null || list.isEmpty()){
    		return;
    	}
		List<TerminationReason> reasonList = YoubenbenBaseUtils.collectReferencedObjectWithType(userContext, list, TerminationReason.class);
		userContext.getDAOGroup().enhanceList(reasonList, TerminationReason.class);
		List<TerminationType> typeList = YoubenbenBaseUtils.collectReferencedObjectWithType(userContext, list, TerminationType.class);
  ...
  // -----------------------------------\\ list-of-view 处理 //-----------------------------------v
	 ...
	 * @throws Exception
	 */
 	public Object wxappview(YoubenbenUserContext userContext, String terminationId) throws Exception{
	  SerializeScope vscope = YoubenbenViewScope.getInstance().getTerminationDetailScope().clone();
