...
import com.youbenben.youbenben.memberwishlist.CandidateMemberWishlist;
...
public class MemberWishlistProductManagerImpl extends CustomYoubenbenCheckerManager implements MemberWishlistProductManager, BusinessHandler{
	...
	@Override
	public MemberWishlistProductDAO daoOf(YoubenbenUserContext userContext) {
	...
	protected void throwExceptionWithMessage(String value) throws MemberWishlistProductManagerException{
 	...
 	protected MemberWishlistProduct saveMemberWishlistProduct(YoubenbenUserContext userContext, MemberWishlistProduct memberWishlistProduct, String [] tokensExpr) throws Exception{	
 	...
 	protected MemberWishlistProduct saveMemberWishlistProductDetail(YoubenbenUserContext userContext, MemberWishlistProduct memberWishlistProduct) throws Exception{	
 	...
 	public MemberWishlistProduct loadMemberWishlistProduct(YoubenbenUserContext userContext, String memberWishlistProductId, String [] tokensExpr) throws Exception{				
 	 ...
 	 public MemberWishlistProduct searchMemberWishlistProduct(YoubenbenUserContext userContext, String memberWishlistProductId, String textToSearch,String [] tokensExpr) throws Exception{				
 	...
 	protected MemberWishlistProduct present(YoubenbenUserContext userContext, MemberWishlistProduct memberWishlistProduct, Map<String, Object> tokens) throws Exception {
 	...
 	public MemberWishlistProduct loadMemberWishlistProductDetail(YoubenbenUserContext userContext, String memberWishlistProductId) throws Exception{	
 	...
 	public Object view(YoubenbenUserContext userContext, String memberWishlistProductId) throws Exception{	
 		MemberWishlistProduct memberWishlistProduct = loadMemberWishlistProduct( userContext, memberWishlistProductId, viewTokens());
 		return present(userContext,memberWishlistProduct, allTokens());
		
 	}
 	protected MemberWishlistProduct saveMemberWishlistProduct(YoubenbenUserContext userContext, MemberWishlistProduct memberWishlistProduct, Map<String,Object>tokens) throws Exception{	
 		return memberWishlistProductDaoOf(userContext).save(memberWishlistProduct, tokens);
 	}
 	protected MemberWishlistProduct loadMemberWishlistProduct(YoubenbenUserContext userContext, String memberWishlistProductId, Map<String,Object>tokens) throws Exception{	
		checkerOf(userContext).checkIdOfMemberWishlistProduct(memberWishlistProductId);
		checkerOf(userContext).throwExceptionIfHasErrors( MemberWishlistProductManagerException.class);
 	...
 	protected<T extends BaseEntity> void addActions(YoubenbenUserContext userContext, MemberWishlistProduct memberWishlistProduct, Map<String, Object> tokens){
	...
	}// end method of protected<T extends BaseEntity> void addActions(YoubenbenUserContext userContext, MemberWishlistProduct memberWishlistProduct, Map<String, Object> tokens){
	...
	protected void checkParamsForUpdatingMemberWishlistProduct(YoubenbenUserContext userContext,String memberWishlistProductId, int memberWishlistProductVersion, String property, String newValueExpr,String [] tokensExpr)throws Exception
	{
	...
	public MemberWishlistProduct clone(YoubenbenUserContext userContext, String fromMemberWishlistProductId) throws Exception{
	...
	public MemberWishlistProduct internalSaveMemberWishlistProduct(YoubenbenUserContext userContext, MemberWishlistProduct memberWishlistProduct, Map<String,Object> options) throws Exception
	{
	...
	public MemberWishlistProduct updateMemberWishlistProductProperty(YoubenbenUserContext userContext,String memberWishlistProductId, int memberWishlistProductVersion, String property, String newValueExpr,String [] tokensExpr) throws Exception
	{
		checkParamsForUpdatingMemberWishlistProduct(userContext, memberWishlistProductId, memberWishlistProductVersion, property, newValueExpr, tokensExpr);
	...
	protected void checkParamsForTransferingAnotherOwner(YoubenbenUserContext userContext, String memberWishlistProductId, String anotherOwnerId) throws Exception
 	{
	...
	public CandidateMemberWishlist requestCandidateOwner(YoubenbenUserContext userContext, String ownerClass, String id, String filterKey, int pageNo) throws Exception {
 ...
 //--------------------------------------------------------------
 	...
 	protected MemberWishlist loadMemberWishlist(YoubenbenUserContext userContext, String newOwnerId, Map<String,Object> options) throws Exception
 	{
	...
	public void delete(YoubenbenUserContext userContext, String memberWishlistProductId, int memberWishlistProductVersion) throws Exception {
	...
	public MemberWishlistProduct forgetByAll(YoubenbenUserContext userContext, String memberWishlistProductId, int memberWishlistProductVersion) throws Exception {
		return forgetByAllInternal(userContext, memberWishlistProductId, memberWishlistProductVersion);
	}
	protected MemberWishlistProduct forgetByAllInternal(YoubenbenUserContext userContext,
			String memberWishlistProductId, int memberWishlistProductVersion) throws Exception{
	...
	// -----------------------------------// list-of-view 处理 \\-----------------------------------
    protected void enhanceForListOfView(YoubenbenUserContext userContext,SmartList<MemberWishlistProduct> list) throws Exception {
    	if (list == null || list.isEmpty()){
    		return;
    	}
		List<MemberWishlist> ownerList = YoubenbenBaseUtils.collectReferencedObjectWithType(userContext, list, MemberWishlist.class);
  ...
  // -----------------------------------\\ list-of-view 处理 //-----------------------------------v
	 ...
	 * @throws Exception
	 */
 	public Object wxappview(YoubenbenUserContext userContext, String memberWishlistProductId) throws Exception{
	  SerializeScope vscope = YoubenbenViewScope.getInstance().getMemberWishlistProductDetailScope().clone();
