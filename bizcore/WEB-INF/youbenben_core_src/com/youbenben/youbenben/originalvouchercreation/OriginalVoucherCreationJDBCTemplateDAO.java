...
public class OriginalVoucherCreationJDBCTemplateDAO extends YoubenbenBaseDAOImpl implements OriginalVoucherCreationDAO{
	...
	*/
	...
	public SmartList<OriginalVoucherCreation> loadAll() {
	    return this.loadAll(getOriginalVoucherCreationMapper());
	}
    ...
    public SmartList<OriginalVoucherCreation> requestCandidateOriginalVoucherCreationForOriginalVoucher(YoubenbenUserContext userContext, String ownerClass, String id, String filterKey, int pageNo, int pageSize) throws Exception {
		...
		return findAllCandidateByFilter(OriginalVoucherCreationTable.COLUMN_WHO, null, filterKey, pageNo, pageSize, getOriginalVoucherCreationMapper());
    }
