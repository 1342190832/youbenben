...
public class ConsumerOrderShipmentJDBCTemplateDAO extends YoubenbenBaseDAOImpl implements ConsumerOrderShipmentDAO{
	...
	*/
	...
	public SmartList<ConsumerOrderShipment> loadAll() {
	    return this.loadAll(getConsumerOrderShipmentMapper());
	}
	...
	public CandidateConsumerOrderShipment executeCandidatesQuery(CandidateQuery query, String sql, Object ... parmeters) throws Exception {
		...
		CandidateConsumerOrderShipment result = new CandidateConsumerOrderShipment();
