...
public class TransportTaskTrackManagerImpl extends CustomYoubenbenCheckerManager implements TransportTaskTrackManager, BusinessHandler{
	...
	@Override
	public TransportTaskTrackDAO daoOf(YoubenbenUserContext userContext) {
	...
	protected void throwExceptionWithMessage(String value) throws TransportTaskTrackManagerException{
 	...
 	protected TransportTaskTrack saveTransportTaskTrack(YoubenbenUserContext userContext, TransportTaskTrack transportTaskTrack, String [] tokensExpr) throws Exception{	
 	...
 	protected TransportTaskTrack saveTransportTaskTrackDetail(YoubenbenUserContext userContext, TransportTaskTrack transportTaskTrack) throws Exception{	
 	...
 	public TransportTaskTrack loadTransportTaskTrack(YoubenbenUserContext userContext, String transportTaskTrackId, String [] tokensExpr) throws Exception{				
 	 ...
 	 public TransportTaskTrack searchTransportTaskTrack(YoubenbenUserContext userContext, String transportTaskTrackId, String textToSearch,String [] tokensExpr) throws Exception{				
 	...
 	protected TransportTaskTrack present(YoubenbenUserContext userContext, TransportTaskTrack transportTaskTrack, Map<String, Object> tokens) throws Exception {
 	...
 	public TransportTaskTrack loadTransportTaskTrackDetail(YoubenbenUserContext userContext, String transportTaskTrackId) throws Exception{	
 	...
 	public Object view(YoubenbenUserContext userContext, String transportTaskTrackId) throws Exception{	
 		TransportTaskTrack transportTaskTrack = loadTransportTaskTrack( userContext, transportTaskTrackId, viewTokens());
 		return present(userContext,transportTaskTrack, allTokens());
		
 	}
 	protected TransportTaskTrack saveTransportTaskTrack(YoubenbenUserContext userContext, TransportTaskTrack transportTaskTrack, Map<String,Object>tokens) throws Exception{	
 		return transportTaskTrackDaoOf(userContext).save(transportTaskTrack, tokens);
 	}
 	protected TransportTaskTrack loadTransportTaskTrack(YoubenbenUserContext userContext, String transportTaskTrackId, Map<String,Object>tokens) throws Exception{	
		checkerOf(userContext).checkIdOfTransportTaskTrack(transportTaskTrackId);
		checkerOf(userContext).throwExceptionIfHasErrors( TransportTaskTrackManagerException.class);
 	...
 	protected<T extends BaseEntity> void addActions(YoubenbenUserContext userContext, TransportTaskTrack transportTaskTrack, Map<String, Object> tokens){
	...
	}// end method of protected<T extends BaseEntity> void addActions(YoubenbenUserContext userContext, TransportTaskTrack transportTaskTrack, Map<String, Object> tokens){
	...
	protected void checkParamsForUpdatingTransportTaskTrack(YoubenbenUserContext userContext,String transportTaskTrackId, int transportTaskTrackVersion, String property, String newValueExpr,String [] tokensExpr)throws Exception
	{
	...
	public TransportTaskTrack clone(YoubenbenUserContext userContext, String fromTransportTaskTrackId) throws Exception{
	...
	public TransportTaskTrack internalSaveTransportTaskTrack(YoubenbenUserContext userContext, TransportTaskTrack transportTaskTrack, Map<String,Object> options) throws Exception
	{
	...
	public TransportTaskTrack updateTransportTaskTrackProperty(YoubenbenUserContext userContext,String transportTaskTrackId, int transportTaskTrackVersion, String property, String newValueExpr,String [] tokensExpr) throws Exception
	{
		checkParamsForUpdatingTransportTaskTrack(userContext, transportTaskTrackId, transportTaskTrackVersion, property, newValueExpr, tokensExpr);
	...
	protected void checkParamsForTransferingAnotherMovement(YoubenbenUserContext userContext, String transportTaskTrackId, String anotherMovementId) throws Exception
 	{
	...
	public CandidateTransportTask requestCandidateMovement(YoubenbenUserContext userContext, String ownerClass, String id, String filterKey, int pageNo) throws Exception {
 ...
 //--------------------------------------------------------------
 	...
 	protected TransportTask loadTransportTask(YoubenbenUserContext userContext, String newMovementId, Map<String,Object> options) throws Exception
 	{
	...
	public void delete(YoubenbenUserContext userContext, String transportTaskTrackId, int transportTaskTrackVersion) throws Exception {
	...
	public TransportTaskTrack forgetByAll(YoubenbenUserContext userContext, String transportTaskTrackId, int transportTaskTrackVersion) throws Exception {
		return forgetByAllInternal(userContext, transportTaskTrackId, transportTaskTrackVersion);
	}
	protected TransportTaskTrack forgetByAllInternal(YoubenbenUserContext userContext,
			String transportTaskTrackId, int transportTaskTrackVersion) throws Exception{
	...
	// -----------------------------------// list-of-view 处理 \\-----------------------------------
    protected void enhanceForListOfView(YoubenbenUserContext userContext,SmartList<TransportTaskTrack> list) throws Exception {
    	if (list == null || list.isEmpty()){
    		return;
    	}
		List<TransportTask> movementList = YoubenbenBaseUtils.collectReferencedObjectWithType(userContext, list, TransportTask.class);
  ...
  // -----------------------------------\\ list-of-view 处理 //-----------------------------------v
	 ...
	 * @throws Exception
	 */
 	public Object wxappview(YoubenbenUserContext userContext, String transportTaskTrackId) throws Exception{
	  SerializeScope vscope = YoubenbenViewScope.getInstance().getTransportTaskTrackDetailScope().clone();
