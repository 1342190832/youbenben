...
public class PayingOffManagerImpl extends CustomYoubenbenCheckerManager implements PayingOffManager, BusinessHandler{
	...
	@Override
	public PayingOffDAO daoOf(YoubenbenUserContext userContext) {
	...
	protected void throwExceptionWithMessage(String value) throws PayingOffManagerException{
 	...
 	protected PayingOff savePayingOff(YoubenbenUserContext userContext, PayingOff payingOff, String [] tokensExpr) throws Exception{	
 	...
 	protected PayingOff savePayingOffDetail(YoubenbenUserContext userContext, PayingOff payingOff) throws Exception{	
 	...
 	public PayingOff loadPayingOff(YoubenbenUserContext userContext, String payingOffId, String [] tokensExpr) throws Exception{				
 	 ...
 	 public PayingOff searchPayingOff(YoubenbenUserContext userContext, String payingOffId, String textToSearch,String [] tokensExpr) throws Exception{				
 	...
 	protected PayingOff present(YoubenbenUserContext userContext, PayingOff payingOff, Map<String, Object> tokens) throws Exception {
 	...
 	public PayingOff loadPayingOffDetail(YoubenbenUserContext userContext, String payingOffId) throws Exception{	
 		PayingOff payingOff = loadPayingOff( userContext, payingOffId, allTokens());
 		return present(userContext,payingOff, allTokens());
		
 	}
 	
 	public Object view(YoubenbenUserContext userContext, String payingOffId) throws Exception{	
 		PayingOff payingOff = loadPayingOff( userContext, payingOffId, viewTokens());
 		return present(userContext,payingOff, allTokens());
		
 	}
 	protected PayingOff savePayingOff(YoubenbenUserContext userContext, PayingOff payingOff, Map<String,Object>tokens) throws Exception{	
 		return payingOffDaoOf(userContext).save(payingOff, tokens);
 	}
 	protected PayingOff loadPayingOff(YoubenbenUserContext userContext, String payingOffId, Map<String,Object>tokens) throws Exception{	
		checkerOf(userContext).checkIdOfPayingOff(payingOffId);
		checkerOf(userContext).throwExceptionIfHasErrors( PayingOffManagerException.class);
 	...
 	protected<T extends BaseEntity> void addActions(YoubenbenUserContext userContext, PayingOff payingOff, Map<String, Object> tokens){
	...
	}// end method of protected<T extends BaseEntity> void addActions(YoubenbenUserContext userContext, PayingOff payingOff, Map<String, Object> tokens){
	...
	protected void checkParamsForUpdatingPayingOff(YoubenbenUserContext userContext,String payingOffId, int payingOffVersion, String property, String newValueExpr,String [] tokensExpr)throws Exception
	{
	...
	public PayingOff clone(YoubenbenUserContext userContext, String fromPayingOffId) throws Exception{
	...
	public PayingOff internalSavePayingOff(YoubenbenUserContext userContext, PayingOff payingOff, Map<String,Object> options) throws Exception
	{
	...
	public PayingOff updatePayingOffProperty(YoubenbenUserContext userContext,String payingOffId, int payingOffVersion, String property, String newValueExpr,String [] tokensExpr) throws Exception
	{
		checkParamsForUpdatingPayingOff(userContext, payingOffId, payingOffVersion, property, newValueExpr, tokensExpr);
	...
	protected void checkParamsForTransferingAnotherPaidFor(YoubenbenUserContext userContext, String payingOffId, String anotherPaidForId) throws Exception
 	{
	...
	public CandidateEmployee requestCandidatePaidFor(YoubenbenUserContext userContext, String ownerClass, String id, String filterKey, int pageNo) throws Exception {
 ...
 //--------------------------------------------------------------
 	...
 	protected Employee loadEmployee(YoubenbenUserContext userContext, String newPaidForId, Map<String,Object> options) throws Exception
 	{
	...
	public void delete(YoubenbenUserContext userContext, String payingOffId, int payingOffVersion) throws Exception {
	...
	public PayingOff forgetByAll(YoubenbenUserContext userContext, String payingOffId, int payingOffVersion) throws Exception {
		return forgetByAllInternal(userContext, payingOffId, payingOffVersion);
	}
	protected PayingOff forgetByAllInternal(YoubenbenUserContext userContext,
			String payingOffId, int payingOffVersion) throws Exception{
	...
	protected PayingOff breakWithEmployeeSalarySheetByEmployee(YoubenbenUserContext userContext, String payingOffId, String employeeId,  String [] tokensExpr)
		 throws Exception{
	...
	protected PayingOff breakWithEmployeeSalarySheetByCurrentSalaryGrade(YoubenbenUserContext userContext, String payingOffId, String currentSalaryGradeId,  String [] tokensExpr)
		 throws Exception{
	...
	public  PayingOff updateEmployeeSalarySheetProperties(YoubenbenUserContext userContext, String payingOffId, String id,BigDecimal baseSalary,BigDecimal bonus,BigDecimal reward,BigDecimal personalTax,BigDecimal socialSecurity,BigDecimal housingFound,BigDecimal jobInsurance, String [] tokensExpr) throws Exception
	{
	...
	protected void checkParamsForRemovingEmployeeSalarySheetList(YoubenbenUserContext userContext, String payingOffId,
	...
	public  PayingOff removeEmployeeSalarySheetList(YoubenbenUserContext userContext, String payingOffId,
			String employeeSalarySheetIds[],String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForRemovingEmployeeSalarySheet(YoubenbenUserContext userContext, String payingOffId,
	...
	public  PayingOff removeEmployeeSalarySheet(YoubenbenUserContext userContext, String payingOffId,
		String employeeSalarySheetId, int employeeSalarySheetVersion,String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForCopyingEmployeeSalarySheet(YoubenbenUserContext userContext, String payingOffId,
		String employeeSalarySheetId, int employeeSalarySheetVersion,String [] tokensExpr) throws Exception{
	...
	public  PayingOff copyEmployeeSalarySheetFrom(YoubenbenUserContext userContext, String payingOffId,
		String employeeSalarySheetId, int employeeSalarySheetVersion,String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForUpdatingEmployeeSalarySheet(YoubenbenUserContext userContext, String payingOffId, String employeeSalarySheetId, int employeeSalarySheetVersion, String property, String newValueExpr,String [] tokensExpr) throws Exception{
	...
	public  PayingOff updateEmployeeSalarySheet(YoubenbenUserContext userContext, String payingOffId, String employeeSalarySheetId, int employeeSalarySheetVersion, String property, String newValueExpr,String [] tokensExpr)
			throws Exception{
	...
	*/
	...
	// -----------------------------------// list-of-view 处理 \\-----------------------------------
    protected void enhanceForListOfView(YoubenbenUserContext userContext,SmartList<PayingOff> list) throws Exception {
    	if (list == null || list.isEmpty()){
    		return;
    	}
		List<Employee> paidForList = YoubenbenBaseUtils.collectReferencedObjectWithType(userContext, list, Employee.class);
  ...
  // -----------------------------------\\ list-of-view 处理 //-----------------------------------v
	 ...
	 * @throws Exception
	 */
 	public Object wxappview(YoubenbenUserContext userContext, String payingOffId) throws Exception{
	  SerializeScope vscope = YoubenbenViewScope.getInstance().getPayingOffDetailScope().clone();
