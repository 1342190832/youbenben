...
public class RetailStoreDecorationJDBCTemplateDAO extends YoubenbenBaseDAOImpl implements RetailStoreDecorationDAO{
	...
	*/
    ...
    public SmartList<RetailStoreDecoration> requestCandidateRetailStoreDecorationForRetailStore(YoubenbenUserContext userContext, String ownerClass, String id, String filterKey, int pageNo, int pageSize) throws Exception {
	...
	public SmartList<RetailStore> loadOurRetailStoreList(YoubenbenUserContext userContext, List<RetailStoreDecoration> us, Map<String,Object> options) throws Exception{
