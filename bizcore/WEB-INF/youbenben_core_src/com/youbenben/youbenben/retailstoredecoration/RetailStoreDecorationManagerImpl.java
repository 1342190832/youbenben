...
public class RetailStoreDecorationManagerImpl extends CustomYoubenbenCheckerManager implements RetailStoreDecorationManager, BusinessHandler{
	...
	@Override
	public RetailStoreDecorationDAO daoOf(YoubenbenUserContext userContext) {
	...
	protected void throwExceptionWithMessage(String value) throws RetailStoreDecorationManagerException{
 	...
 	protected RetailStoreDecoration saveRetailStoreDecoration(YoubenbenUserContext userContext, RetailStoreDecoration retailStoreDecoration, String [] tokensExpr) throws Exception{	
 	...
 	protected RetailStoreDecoration saveRetailStoreDecorationDetail(YoubenbenUserContext userContext, RetailStoreDecoration retailStoreDecoration) throws Exception{	
 	...
 	public RetailStoreDecoration loadRetailStoreDecoration(YoubenbenUserContext userContext, String retailStoreDecorationId, String [] tokensExpr) throws Exception{				
 	 ...
 	 public RetailStoreDecoration searchRetailStoreDecoration(YoubenbenUserContext userContext, String retailStoreDecorationId, String textToSearch,String [] tokensExpr) throws Exception{				
 	...
 	protected RetailStoreDecoration present(YoubenbenUserContext userContext, RetailStoreDecoration retailStoreDecoration, Map<String, Object> tokens) throws Exception {
 	...
 	public RetailStoreDecoration loadRetailStoreDecorationDetail(YoubenbenUserContext userContext, String retailStoreDecorationId) throws Exception{	
 	...
 	public Object view(YoubenbenUserContext userContext, String retailStoreDecorationId) throws Exception{	
 		RetailStoreDecoration retailStoreDecoration = loadRetailStoreDecoration( userContext, retailStoreDecorationId, viewTokens());
 		return present(userContext,retailStoreDecoration, allTokens());
		
 	}
 	protected RetailStoreDecoration saveRetailStoreDecoration(YoubenbenUserContext userContext, RetailStoreDecoration retailStoreDecoration, Map<String,Object>tokens) throws Exception{	
 		return retailStoreDecorationDaoOf(userContext).save(retailStoreDecoration, tokens);
 	}
 	protected RetailStoreDecoration loadRetailStoreDecoration(YoubenbenUserContext userContext, String retailStoreDecorationId, Map<String,Object>tokens) throws Exception{	
		checkerOf(userContext).checkIdOfRetailStoreDecoration(retailStoreDecorationId);
		checkerOf(userContext).throwExceptionIfHasErrors( RetailStoreDecorationManagerException.class);
 	...
 	protected<T extends BaseEntity> void addActions(YoubenbenUserContext userContext, RetailStoreDecoration retailStoreDecoration, Map<String, Object> tokens){
	...
	}// end method of protected<T extends BaseEntity> void addActions(YoubenbenUserContext userContext, RetailStoreDecoration retailStoreDecoration, Map<String, Object> tokens){
	...
	protected void checkParamsForUpdatingRetailStoreDecoration(YoubenbenUserContext userContext,String retailStoreDecorationId, int retailStoreDecorationVersion, String property, String newValueExpr,String [] tokensExpr)throws Exception
	{
	...
	public RetailStoreDecoration clone(YoubenbenUserContext userContext, String fromRetailStoreDecorationId) throws Exception{
	...
	public RetailStoreDecoration internalSaveRetailStoreDecoration(YoubenbenUserContext userContext, RetailStoreDecoration retailStoreDecoration, Map<String,Object> options) throws Exception
	{
	...
	public RetailStoreDecoration updateRetailStoreDecorationProperty(YoubenbenUserContext userContext,String retailStoreDecorationId, int retailStoreDecorationVersion, String property, String newValueExpr,String [] tokensExpr) throws Exception
	{
		checkParamsForUpdatingRetailStoreDecoration(userContext, retailStoreDecorationId, retailStoreDecorationVersion, property, newValueExpr, tokensExpr);
...
//--------------------------------------------------------------
	...
	public void delete(YoubenbenUserContext userContext, String retailStoreDecorationId, int retailStoreDecorationVersion) throws Exception {
	...
	public RetailStoreDecoration forgetByAll(YoubenbenUserContext userContext, String retailStoreDecorationId, int retailStoreDecorationVersion) throws Exception {
		return forgetByAllInternal(userContext, retailStoreDecorationId, retailStoreDecorationVersion);
	}
	protected RetailStoreDecoration forgetByAllInternal(YoubenbenUserContext userContext,
			String retailStoreDecorationId, int retailStoreDecorationVersion) throws Exception{
	...
	protected RetailStoreDecoration breakWithRetailStoreByRetailStoreCountryCenter(YoubenbenUserContext userContext, String retailStoreDecorationId, String retailStoreCountryCenterId,  String [] tokensExpr)
		 throws Exception{
	...
	protected RetailStoreDecoration breakWithRetailStoreByCityServiceCenter(YoubenbenUserContext userContext, String retailStoreDecorationId, String cityServiceCenterId,  String [] tokensExpr)
		 throws Exception{
	...
	protected RetailStoreDecoration breakWithRetailStoreByCreation(YoubenbenUserContext userContext, String retailStoreDecorationId, String creationId,  String [] tokensExpr)
		 throws Exception{
	...
	protected RetailStoreDecoration breakWithRetailStoreByInvestmentInvitation(YoubenbenUserContext userContext, String retailStoreDecorationId, String investmentInvitationId,  String [] tokensExpr)
		 throws Exception{
	...
	protected RetailStoreDecoration breakWithRetailStoreByFranchising(YoubenbenUserContext userContext, String retailStoreDecorationId, String franchisingId,  String [] tokensExpr)
		 throws Exception{
	...
	protected RetailStoreDecoration breakWithRetailStoreByOpening(YoubenbenUserContext userContext, String retailStoreDecorationId, String openingId,  String [] tokensExpr)
		 throws Exception{
	...
	protected RetailStoreDecoration breakWithRetailStoreByClosing(YoubenbenUserContext userContext, String retailStoreDecorationId, String closingId,  String [] tokensExpr)
		 throws Exception{
	...
	protected void checkParamsForUpdatingRetailStoreProperties(YoubenbenUserContext userContext, String retailStoreDecorationId,String id,String name,String telephone,String owner,Date founded,BigDecimal latitude,BigDecimal longitude,String description,String [] tokensExpr) throws Exception {
	...
	public  RetailStoreDecoration updateRetailStoreProperties(YoubenbenUserContext userContext, String retailStoreDecorationId, String id,String name,String telephone,String owner,Date founded,BigDecimal latitude,BigDecimal longitude,String description, String [] tokensExpr) throws Exception
	{
	...
	protected RetailStore createRetailStore(YoubenbenUserContext userContext, String name, String telephone, String owner, String retailStoreCountryCenterId, String cityServiceCenterId, String creationId, String investmentInvitationId, String franchisingId, String openingId, String closingId, Date founded, BigDecimal latitude, BigDecimal longitude, String description) throws Exception{
	...
	protected void checkParamsForRemovingRetailStoreList(YoubenbenUserContext userContext, String retailStoreDecorationId,
	...
	public  RetailStoreDecoration removeRetailStoreList(YoubenbenUserContext userContext, String retailStoreDecorationId,
			String retailStoreIds[],String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForRemovingRetailStore(YoubenbenUserContext userContext, String retailStoreDecorationId,
	...
	public  RetailStoreDecoration removeRetailStore(YoubenbenUserContext userContext, String retailStoreDecorationId,
		String retailStoreId, int retailStoreVersion,String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForCopyingRetailStore(YoubenbenUserContext userContext, String retailStoreDecorationId,
		String retailStoreId, int retailStoreVersion,String [] tokensExpr) throws Exception{
	...
	public  RetailStoreDecoration copyRetailStoreFrom(YoubenbenUserContext userContext, String retailStoreDecorationId,
		String retailStoreId, int retailStoreVersion,String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForUpdatingRetailStore(YoubenbenUserContext userContext, String retailStoreDecorationId, String retailStoreId, int retailStoreVersion, String property, String newValueExpr,String [] tokensExpr) throws Exception{
	...
	public  RetailStoreDecoration updateRetailStore(YoubenbenUserContext userContext, String retailStoreDecorationId, String retailStoreId, int retailStoreVersion, String property, String newValueExpr,String [] tokensExpr)
			throws Exception{
	...
	*/
	...
	// -----------------------------------// list-of-view 处理 \\-----------------------------------
    protected void enhanceForListOfView(YoubenbenUserContext userContext,SmartList<RetailStoreDecoration> list) throws Exception {
  ...
  // -----------------------------------\\ list-of-view 处理 //-----------------------------------v
	 ...
	 * @throws Exception
	 */
 	public Object wxappview(YoubenbenUserContext userContext, String retailStoreDecorationId) throws Exception{
	  SerializeScope vscope = YoubenbenViewScope.getInstance().getRetailStoreDecorationDetailScope().clone();
