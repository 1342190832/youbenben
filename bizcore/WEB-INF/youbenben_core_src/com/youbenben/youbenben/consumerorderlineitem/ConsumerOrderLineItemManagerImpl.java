...
public class ConsumerOrderLineItemManagerImpl extends CustomYoubenbenCheckerManager implements ConsumerOrderLineItemManager, BusinessHandler{
	...
	@Override
	public ConsumerOrderLineItemDAO daoOf(YoubenbenUserContext userContext) {
	...
	protected void throwExceptionWithMessage(String value) throws ConsumerOrderLineItemManagerException{
 	...
 	protected ConsumerOrderLineItem saveConsumerOrderLineItem(YoubenbenUserContext userContext, ConsumerOrderLineItem consumerOrderLineItem, String [] tokensExpr) throws Exception{	
 	...
 	protected ConsumerOrderLineItem saveConsumerOrderLineItemDetail(YoubenbenUserContext userContext, ConsumerOrderLineItem consumerOrderLineItem) throws Exception{	
 	...
 	public ConsumerOrderLineItem loadConsumerOrderLineItem(YoubenbenUserContext userContext, String consumerOrderLineItemId, String [] tokensExpr) throws Exception{				
 	 ...
 	 public ConsumerOrderLineItem searchConsumerOrderLineItem(YoubenbenUserContext userContext, String consumerOrderLineItemId, String textToSearch,String [] tokensExpr) throws Exception{				
 	...
 	protected ConsumerOrderLineItem present(YoubenbenUserContext userContext, ConsumerOrderLineItem consumerOrderLineItem, Map<String, Object> tokens) throws Exception {
 	...
 	public ConsumerOrderLineItem loadConsumerOrderLineItemDetail(YoubenbenUserContext userContext, String consumerOrderLineItemId) throws Exception{	
 	...
 	public Object view(YoubenbenUserContext userContext, String consumerOrderLineItemId) throws Exception{	
 		ConsumerOrderLineItem consumerOrderLineItem = loadConsumerOrderLineItem( userContext, consumerOrderLineItemId, viewTokens());
 		return present(userContext,consumerOrderLineItem, allTokens());
		
 	}
 	protected ConsumerOrderLineItem saveConsumerOrderLineItem(YoubenbenUserContext userContext, ConsumerOrderLineItem consumerOrderLineItem, Map<String,Object>tokens) throws Exception{	
 		return consumerOrderLineItemDaoOf(userContext).save(consumerOrderLineItem, tokens);
 	}
 	protected ConsumerOrderLineItem loadConsumerOrderLineItem(YoubenbenUserContext userContext, String consumerOrderLineItemId, Map<String,Object>tokens) throws Exception{	
		checkerOf(userContext).checkIdOfConsumerOrderLineItem(consumerOrderLineItemId);
		checkerOf(userContext).throwExceptionIfHasErrors( ConsumerOrderLineItemManagerException.class);
 	...
 	protected<T extends BaseEntity> void addActions(YoubenbenUserContext userContext, ConsumerOrderLineItem consumerOrderLineItem, Map<String, Object> tokens){
	...
	}// end method of protected<T extends BaseEntity> void addActions(YoubenbenUserContext userContext, ConsumerOrderLineItem consumerOrderLineItem, Map<String, Object> tokens){
	...
	protected void checkParamsForUpdatingConsumerOrderLineItem(YoubenbenUserContext userContext,String consumerOrderLineItemId, int consumerOrderLineItemVersion, String property, String newValueExpr,String [] tokensExpr)throws Exception
	{
	...
	public ConsumerOrderLineItem clone(YoubenbenUserContext userContext, String fromConsumerOrderLineItemId) throws Exception{
	...
	public ConsumerOrderLineItem internalSaveConsumerOrderLineItem(YoubenbenUserContext userContext, ConsumerOrderLineItem consumerOrderLineItem, Map<String,Object> options) throws Exception
	{
	...
	public ConsumerOrderLineItem updateConsumerOrderLineItemProperty(YoubenbenUserContext userContext,String consumerOrderLineItemId, int consumerOrderLineItemVersion, String property, String newValueExpr,String [] tokensExpr) throws Exception
	{
		checkParamsForUpdatingConsumerOrderLineItem(userContext, consumerOrderLineItemId, consumerOrderLineItemVersion, property, newValueExpr, tokensExpr);
	...
	protected void checkParamsForTransferingAnotherBizOrder(YoubenbenUserContext userContext, String consumerOrderLineItemId, String anotherBizOrderId) throws Exception
 	{
 ...
 //--------------------------------------------------------------
	...
	public void delete(YoubenbenUserContext userContext, String consumerOrderLineItemId, int consumerOrderLineItemVersion) throws Exception {
	...
	public ConsumerOrderLineItem forgetByAll(YoubenbenUserContext userContext, String consumerOrderLineItemId, int consumerOrderLineItemVersion) throws Exception {
		return forgetByAllInternal(userContext, consumerOrderLineItemId, consumerOrderLineItemVersion);
	}
	protected ConsumerOrderLineItem forgetByAllInternal(YoubenbenUserContext userContext,
			String consumerOrderLineItemId, int consumerOrderLineItemVersion) throws Exception{
	...
	// -----------------------------------// list-of-view 处理 \\-----------------------------------
    protected void enhanceForListOfView(YoubenbenUserContext userContext,SmartList<ConsumerOrderLineItem> list) throws Exception {
  ...
  // -----------------------------------\\ list-of-view 处理 //-----------------------------------v
	 ...
	 * @throws Exception
	 */
 	public Object wxappview(YoubenbenUserContext userContext, String consumerOrderLineItemId) throws Exception{
	  SerializeScope vscope = YoubenbenViewScope.getInstance().getConsumerOrderLineItemDetailScope().clone();
