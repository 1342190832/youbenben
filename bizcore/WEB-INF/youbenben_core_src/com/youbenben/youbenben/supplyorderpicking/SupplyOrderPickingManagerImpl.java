...
public class SupplyOrderPickingManagerImpl extends CustomYoubenbenCheckerManager implements SupplyOrderPickingManager, BusinessHandler{
	...
	@Override
	public SupplyOrderPickingDAO daoOf(YoubenbenUserContext userContext) {
	...
	protected void throwExceptionWithMessage(String value) throws SupplyOrderPickingManagerException{
 	...
 	protected SupplyOrderPicking saveSupplyOrderPicking(YoubenbenUserContext userContext, SupplyOrderPicking supplyOrderPicking, String [] tokensExpr) throws Exception{	
 	...
 	protected SupplyOrderPicking saveSupplyOrderPickingDetail(YoubenbenUserContext userContext, SupplyOrderPicking supplyOrderPicking) throws Exception{	
 	...
 	public SupplyOrderPicking loadSupplyOrderPicking(YoubenbenUserContext userContext, String supplyOrderPickingId, String [] tokensExpr) throws Exception{				
 	 ...
 	 public SupplyOrderPicking searchSupplyOrderPicking(YoubenbenUserContext userContext, String supplyOrderPickingId, String textToSearch,String [] tokensExpr) throws Exception{				
 	...
 	protected SupplyOrderPicking present(YoubenbenUserContext userContext, SupplyOrderPicking supplyOrderPicking, Map<String, Object> tokens) throws Exception {
 	...
 	public SupplyOrderPicking loadSupplyOrderPickingDetail(YoubenbenUserContext userContext, String supplyOrderPickingId) throws Exception{	
 	...
 	public Object view(YoubenbenUserContext userContext, String supplyOrderPickingId) throws Exception{	
 		SupplyOrderPicking supplyOrderPicking = loadSupplyOrderPicking( userContext, supplyOrderPickingId, viewTokens());
 		return present(userContext,supplyOrderPicking, allTokens());
		
 	}
 	protected SupplyOrderPicking saveSupplyOrderPicking(YoubenbenUserContext userContext, SupplyOrderPicking supplyOrderPicking, Map<String,Object>tokens) throws Exception{	
 		return supplyOrderPickingDaoOf(userContext).save(supplyOrderPicking, tokens);
 	}
 	protected SupplyOrderPicking loadSupplyOrderPicking(YoubenbenUserContext userContext, String supplyOrderPickingId, Map<String,Object>tokens) throws Exception{	
		checkerOf(userContext).checkIdOfSupplyOrderPicking(supplyOrderPickingId);
		checkerOf(userContext).throwExceptionIfHasErrors( SupplyOrderPickingManagerException.class);
 	...
 	protected<T extends BaseEntity> void addActions(YoubenbenUserContext userContext, SupplyOrderPicking supplyOrderPicking, Map<String, Object> tokens){
	...
	}// end method of protected<T extends BaseEntity> void addActions(YoubenbenUserContext userContext, SupplyOrderPicking supplyOrderPicking, Map<String, Object> tokens){
	...
	protected void checkParamsForUpdatingSupplyOrderPicking(YoubenbenUserContext userContext,String supplyOrderPickingId, int supplyOrderPickingVersion, String property, String newValueExpr,String [] tokensExpr)throws Exception
	{
	...
	public SupplyOrderPicking clone(YoubenbenUserContext userContext, String fromSupplyOrderPickingId) throws Exception{
	...
	public SupplyOrderPicking internalSaveSupplyOrderPicking(YoubenbenUserContext userContext, SupplyOrderPicking supplyOrderPicking, Map<String,Object> options) throws Exception
	{
	...
	public SupplyOrderPicking updateSupplyOrderPickingProperty(YoubenbenUserContext userContext,String supplyOrderPickingId, int supplyOrderPickingVersion, String property, String newValueExpr,String [] tokensExpr) throws Exception
	{
		checkParamsForUpdatingSupplyOrderPicking(userContext, supplyOrderPickingId, supplyOrderPickingVersion, property, newValueExpr, tokensExpr);
...
//--------------------------------------------------------------
	...
	public void delete(YoubenbenUserContext userContext, String supplyOrderPickingId, int supplyOrderPickingVersion) throws Exception {
	...
	public SupplyOrderPicking forgetByAll(YoubenbenUserContext userContext, String supplyOrderPickingId, int supplyOrderPickingVersion) throws Exception {
		return forgetByAllInternal(userContext, supplyOrderPickingId, supplyOrderPickingVersion);
	}
	protected SupplyOrderPicking forgetByAllInternal(YoubenbenUserContext userContext,
			String supplyOrderPickingId, int supplyOrderPickingVersion) throws Exception{
	...
	protected SupplyOrderPicking breakWithSupplyOrderByBuyer(YoubenbenUserContext userContext, String supplyOrderPickingId, String buyerId,  String [] tokensExpr)
		 throws Exception{
	...
	protected SupplyOrderPicking breakWithSupplyOrderBySeller(YoubenbenUserContext userContext, String supplyOrderPickingId, String sellerId,  String [] tokensExpr)
		 throws Exception{
	...
	protected SupplyOrderPicking breakWithSupplyOrderByConfirmation(YoubenbenUserContext userContext, String supplyOrderPickingId, String confirmationId,  String [] tokensExpr)
		 throws Exception{
	...
	protected SupplyOrderPicking breakWithSupplyOrderByApproval(YoubenbenUserContext userContext, String supplyOrderPickingId, String approvalId,  String [] tokensExpr)
		 throws Exception{
	...
	protected SupplyOrderPicking breakWithSupplyOrderByProcessing(YoubenbenUserContext userContext, String supplyOrderPickingId, String processingId,  String [] tokensExpr)
		 throws Exception{
	...
	protected SupplyOrderPicking breakWithSupplyOrderByShipment(YoubenbenUserContext userContext, String supplyOrderPickingId, String shipmentId,  String [] tokensExpr)
		 throws Exception{
	...
	protected SupplyOrderPicking breakWithSupplyOrderByDelivery(YoubenbenUserContext userContext, String supplyOrderPickingId, String deliveryId,  String [] tokensExpr)
		 throws Exception{
	...
	protected void checkParamsForUpdatingSupplyOrderProperties(YoubenbenUserContext userContext, String supplyOrderPickingId,String id,String title,BigDecimal totalAmount,String [] tokensExpr) throws Exception {
	...
	public  SupplyOrderPicking updateSupplyOrderProperties(YoubenbenUserContext userContext, String supplyOrderPickingId, String id,String title,BigDecimal totalAmount, String [] tokensExpr) throws Exception
	{
	...
	protected SupplyOrder createSupplyOrder(YoubenbenUserContext userContext, String buyerId, String sellerId, String title, BigDecimal totalAmount, String confirmationId, String approvalId, String processingId, String shipmentId, String deliveryId) throws Exception{
	...
	protected void checkParamsForRemovingSupplyOrderList(YoubenbenUserContext userContext, String supplyOrderPickingId,
	...
	public  SupplyOrderPicking removeSupplyOrderList(YoubenbenUserContext userContext, String supplyOrderPickingId,
			String supplyOrderIds[],String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForRemovingSupplyOrder(YoubenbenUserContext userContext, String supplyOrderPickingId,
	...
	public  SupplyOrderPicking removeSupplyOrder(YoubenbenUserContext userContext, String supplyOrderPickingId,
		String supplyOrderId, int supplyOrderVersion,String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForCopyingSupplyOrder(YoubenbenUserContext userContext, String supplyOrderPickingId,
		String supplyOrderId, int supplyOrderVersion,String [] tokensExpr) throws Exception{
	...
	public  SupplyOrderPicking copySupplyOrderFrom(YoubenbenUserContext userContext, String supplyOrderPickingId,
		String supplyOrderId, int supplyOrderVersion,String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForUpdatingSupplyOrder(YoubenbenUserContext userContext, String supplyOrderPickingId, String supplyOrderId, int supplyOrderVersion, String property, String newValueExpr,String [] tokensExpr) throws Exception{
	...
	public  SupplyOrderPicking updateSupplyOrder(YoubenbenUserContext userContext, String supplyOrderPickingId, String supplyOrderId, int supplyOrderVersion, String property, String newValueExpr,String [] tokensExpr)
			throws Exception{
	...
	*/
	...
	// -----------------------------------// list-of-view 处理 \\-----------------------------------
    protected void enhanceForListOfView(YoubenbenUserContext userContext,SmartList<SupplyOrderPicking> list) throws Exception {
  ...
  // -----------------------------------\\ list-of-view 处理 //-----------------------------------v
	 ...
	 * @throws Exception
	 */
 	public Object wxappview(YoubenbenUserContext userContext, String supplyOrderPickingId) throws Exception{
	  SerializeScope vscope = YoubenbenViewScope.getInstance().getSupplyOrderPickingDetailScope().clone();
