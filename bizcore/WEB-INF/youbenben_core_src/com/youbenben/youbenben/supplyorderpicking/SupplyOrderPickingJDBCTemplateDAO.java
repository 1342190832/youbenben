...
public class SupplyOrderPickingJDBCTemplateDAO extends YoubenbenBaseDAOImpl implements SupplyOrderPickingDAO{
	...
	*/
	...
	public SmartList<SupplyOrderPicking> loadAll() {
	    return this.loadAll(getSupplyOrderPickingMapper());
	}
    ...
    public SmartList<SupplyOrderPicking> requestCandidateSupplyOrderPickingForSupplyOrder(YoubenbenUserContext userContext, String ownerClass, String id, String filterKey, int pageNo, int pageSize) throws Exception {
		...
		return findAllCandidateByFilter(SupplyOrderPickingTable.COLUMN_WHO, null, filterKey, pageNo, pageSize, getSupplyOrderPickingMapper());
    }
