...
import com.youbenben.youbenben.userapp.CandidateUserApp;
...
public class ListAccessManagerImpl extends CustomYoubenbenCheckerManager implements ListAccessManager, BusinessHandler{
	...
	@Override
	public ListAccessDAO daoOf(YoubenbenUserContext userContext) {
	...
	protected void throwExceptionWithMessage(String value) throws ListAccessManagerException{
 	...
 	protected ListAccess saveListAccess(YoubenbenUserContext userContext, ListAccess listAccess, String [] tokensExpr) throws Exception{	
 	...
 	protected ListAccess saveListAccessDetail(YoubenbenUserContext userContext, ListAccess listAccess) throws Exception{	
 	...
 	public ListAccess loadListAccess(YoubenbenUserContext userContext, String listAccessId, String [] tokensExpr) throws Exception{				
 	 ...
 	 public ListAccess searchListAccess(YoubenbenUserContext userContext, String listAccessId, String textToSearch,String [] tokensExpr) throws Exception{				
 	...
 	protected ListAccess present(YoubenbenUserContext userContext, ListAccess listAccess, Map<String, Object> tokens) throws Exception {
 	...
 	public ListAccess loadListAccessDetail(YoubenbenUserContext userContext, String listAccessId) throws Exception{	
 		ListAccess listAccess = loadListAccess( userContext, listAccessId, allTokens());
 		return present(userContext,listAccess, allTokens());
		
 	}
 	
 	public Object view(YoubenbenUserContext userContext, String listAccessId) throws Exception{	
 		ListAccess listAccess = loadListAccess( userContext, listAccessId, viewTokens());
 		return present(userContext,listAccess, allTokens());
		
 	}
 	protected ListAccess saveListAccess(YoubenbenUserContext userContext, ListAccess listAccess, Map<String,Object>tokens) throws Exception{	
 		return listAccessDaoOf(userContext).save(listAccess, tokens);
 	}
 	protected ListAccess loadListAccess(YoubenbenUserContext userContext, String listAccessId, Map<String,Object>tokens) throws Exception{	
		checkerOf(userContext).checkIdOfListAccess(listAccessId);
		checkerOf(userContext).throwExceptionIfHasErrors( ListAccessManagerException.class);
 	...
 	protected<T extends BaseEntity> void addActions(YoubenbenUserContext userContext, ListAccess listAccess, Map<String, Object> tokens){
	...
	}// end method of protected<T extends BaseEntity> void addActions(YoubenbenUserContext userContext, ListAccess listAccess, Map<String, Object> tokens){
	...
	protected void checkParamsForUpdatingListAccess(YoubenbenUserContext userContext,String listAccessId, int listAccessVersion, String property, String newValueExpr,String [] tokensExpr)throws Exception
	{
	...
	public ListAccess clone(YoubenbenUserContext userContext, String fromListAccessId) throws Exception{
	...
	public ListAccess internalSaveListAccess(YoubenbenUserContext userContext, ListAccess listAccess, Map<String,Object> options) throws Exception
	{
	...
	public ListAccess updateListAccessProperty(YoubenbenUserContext userContext,String listAccessId, int listAccessVersion, String property, String newValueExpr,String [] tokensExpr) throws Exception
	{
		checkParamsForUpdatingListAccess(userContext, listAccessId, listAccessVersion, property, newValueExpr, tokensExpr);
	...
	protected void checkParamsForTransferingAnotherApp(YoubenbenUserContext userContext, String listAccessId, String anotherAppId) throws Exception
 	{
	...
	public CandidateUserApp requestCandidateApp(YoubenbenUserContext userContext, String ownerClass, String id, String filterKey, int pageNo) throws Exception {
 ...
 //--------------------------------------------------------------
 	...
 	protected UserApp loadUserApp(YoubenbenUserContext userContext, String newAppId, Map<String,Object> options) throws Exception
 	{
	...
	public void delete(YoubenbenUserContext userContext, String listAccessId, int listAccessVersion) throws Exception {
	...
	public ListAccess forgetByAll(YoubenbenUserContext userContext, String listAccessId, int listAccessVersion) throws Exception {
		return forgetByAllInternal(userContext, listAccessId, listAccessVersion);
	}
	protected ListAccess forgetByAllInternal(YoubenbenUserContext userContext,
			String listAccessId, int listAccessVersion) throws Exception{
	...
	// -----------------------------------// list-of-view 处理 \\-----------------------------------
    protected void enhanceForListOfView(YoubenbenUserContext userContext,SmartList<ListAccess> list) throws Exception {
    	if (list == null || list.isEmpty()){
    		return;
    	}
		List<UserApp> appList = YoubenbenBaseUtils.collectReferencedObjectWithType(userContext, list, UserApp.class);
  ...
  // -----------------------------------\\ list-of-view 处理 //-----------------------------------v
	 ...
	 * @throws Exception
	 */
 	public Object wxappview(YoubenbenUserContext userContext, String listAccessId) throws Exception{
	  SerializeScope vscope = YoubenbenViewScope.getInstance().getListAccessDetailScope().clone();
