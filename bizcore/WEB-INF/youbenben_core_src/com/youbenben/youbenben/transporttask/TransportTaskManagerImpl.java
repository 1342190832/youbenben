...
import com.youbenben.youbenben.transporttruck.CandidateTransportTruck;
import com.youbenben.youbenben.truckdriver.CandidateTruckDriver;
...
public class TransportTaskManagerImpl extends CustomYoubenbenCheckerManager implements TransportTaskManager, BusinessHandler{
	...
	@Override
	public TransportTaskDAO daoOf(YoubenbenUserContext userContext) {
	...
	protected void throwExceptionWithMessage(String value) throws TransportTaskManagerException{
 	...
 	protected TransportTask saveTransportTask(YoubenbenUserContext userContext, TransportTask transportTask, String [] tokensExpr) throws Exception{	
 	...
 	protected TransportTask saveTransportTaskDetail(YoubenbenUserContext userContext, TransportTask transportTask) throws Exception{	
 	...
 	public TransportTask loadTransportTask(YoubenbenUserContext userContext, String transportTaskId, String [] tokensExpr) throws Exception{				
 	 ...
 	 public TransportTask searchTransportTask(YoubenbenUserContext userContext, String transportTaskId, String textToSearch,String [] tokensExpr) throws Exception{				
 	...
 	protected TransportTask present(YoubenbenUserContext userContext, TransportTask transportTask, Map<String, Object> tokens) throws Exception {
 	...
 	public TransportTask loadTransportTaskDetail(YoubenbenUserContext userContext, String transportTaskId) throws Exception{	
 	...
 	public Object view(YoubenbenUserContext userContext, String transportTaskId) throws Exception{	
 		TransportTask transportTask = loadTransportTask( userContext, transportTaskId, viewTokens());
 		return present(userContext,transportTask, allTokens());
		
 	}
 	protected TransportTask saveTransportTask(YoubenbenUserContext userContext, TransportTask transportTask, Map<String,Object>tokens) throws Exception{	
 		return transportTaskDaoOf(userContext).save(transportTask, tokens);
 	}
 	protected TransportTask loadTransportTask(YoubenbenUserContext userContext, String transportTaskId, Map<String,Object>tokens) throws Exception{	
		checkerOf(userContext).checkIdOfTransportTask(transportTaskId);
		checkerOf(userContext).throwExceptionIfHasErrors( TransportTaskManagerException.class);
 	...
 	protected<T extends BaseEntity> void addActions(YoubenbenUserContext userContext, TransportTask transportTask, Map<String, Object> tokens){
	...
	}// end method of protected<T extends BaseEntity> void addActions(YoubenbenUserContext userContext, TransportTask transportTask, Map<String, Object> tokens){
	...
	protected void checkParamsForUpdatingTransportTask(YoubenbenUserContext userContext,String transportTaskId, int transportTaskVersion, String property, String newValueExpr,String [] tokensExpr)throws Exception
	{
	...
	public TransportTask clone(YoubenbenUserContext userContext, String fromTransportTaskId) throws Exception{
	...
	public TransportTask internalSaveTransportTask(YoubenbenUserContext userContext, TransportTask transportTask, Map<String,Object> options) throws Exception
	{
	...
	public TransportTask updateTransportTaskProperty(YoubenbenUserContext userContext,String transportTaskId, int transportTaskVersion, String property, String newValueExpr,String [] tokensExpr) throws Exception
	{
		checkParamsForUpdatingTransportTask(userContext, transportTaskId, transportTaskVersion, property, newValueExpr, tokensExpr);
	...
	protected void checkParamsForTransferingAnotherEnd(YoubenbenUserContext userContext, String transportTaskId, String anotherEndId) throws Exception
 	{
	...
	public CandidateRetailStore requestCandidateEnd(YoubenbenUserContext userContext, String ownerClass, String id, String filterKey, int pageNo) throws Exception {
 	...
 	protected void checkParamsForTransferingAnotherDriver(YoubenbenUserContext userContext, String transportTaskId, String anotherDriverId) throws Exception
 	{
	...
	public CandidateTruckDriver requestCandidateDriver(YoubenbenUserContext userContext, String ownerClass, String id, String filterKey, int pageNo) throws Exception {
 	...
 	protected void checkParamsForTransferingAnotherTruck(YoubenbenUserContext userContext, String transportTaskId, String anotherTruckId) throws Exception
 	{
	...
	public CandidateTransportTruck requestCandidateTruck(YoubenbenUserContext userContext, String ownerClass, String id, String filterKey, int pageNo) throws Exception {
 	...
 	protected void checkParamsForTransferingAnotherBelongsTo(YoubenbenUserContext userContext, String transportTaskId, String anotherBelongsToId) throws Exception
 	{
 ...
 //--------------------------------------------------------------
 	...
 	protected TruckDriver loadTruckDriver(YoubenbenUserContext userContext, String newDriverId, Map<String,Object> options) throws Exception
 	{
 	...
 	protected RetailStore loadRetailStore(YoubenbenUserContext userContext, String newEndId, Map<String,Object> options) throws Exception
 	{
 	...
 	protected TransportTruck loadTransportTruck(YoubenbenUserContext userContext, String newTruckId, Map<String,Object> options) throws Exception
 	{
	...
	public void delete(YoubenbenUserContext userContext, String transportTaskId, int transportTaskVersion) throws Exception {
	...
	public TransportTask forgetByAll(YoubenbenUserContext userContext, String transportTaskId, int transportTaskVersion) throws Exception {
		return forgetByAllInternal(userContext, transportTaskId, transportTaskVersion);
	}
	protected TransportTask forgetByAllInternal(YoubenbenUserContext userContext,
			String transportTaskId, int transportTaskVersion) throws Exception{
	...
	protected TransportTask breakWithGoodsBySku(YoubenbenUserContext userContext, String transportTaskId, String skuId,  String [] tokensExpr)
		 throws Exception{
	...
	protected TransportTask breakWithGoodsByReceivingSpace(YoubenbenUserContext userContext, String transportTaskId, String receivingSpaceId,  String [] tokensExpr)
		 throws Exception{
	...
	protected TransportTask breakWithGoodsByGoodsAllocation(YoubenbenUserContext userContext, String transportTaskId, String goodsAllocationId,  String [] tokensExpr)
		 throws Exception{
	...
	protected TransportTask breakWithGoodsBySmartPallet(YoubenbenUserContext userContext, String transportTaskId, String smartPalletId,  String [] tokensExpr)
		 throws Exception{
	...
	protected TransportTask breakWithGoodsByShippingSpace(YoubenbenUserContext userContext, String transportTaskId, String shippingSpaceId,  String [] tokensExpr)
		 throws Exception{
	...
	protected TransportTask breakWithGoodsByRetailStore(YoubenbenUserContext userContext, String transportTaskId, String retailStoreId,  String [] tokensExpr)
		 throws Exception{
	...
	protected TransportTask breakWithGoodsByBizOrder(YoubenbenUserContext userContext, String transportTaskId, String bizOrderId,  String [] tokensExpr)
		 throws Exception{
	...
	protected TransportTask breakWithGoodsByRetailStoreOrder(YoubenbenUserContext userContext, String transportTaskId, String retailStoreOrderId,  String [] tokensExpr)
		 throws Exception{
	...
	protected TransportTask breakWithGoodsByPackaging(YoubenbenUserContext userContext, String transportTaskId, String packagingId,  String [] tokensExpr)
		 throws Exception{
			...
			synchronized(transportTask){
				...
				transportTaskDaoOf(userContext).planToRemoveGoodsListWithPackaging(transportTask, packagingId, this.emptyOptions());
	...
	protected void checkParamsForAddingGoods(YoubenbenUserContext userContext, String transportTaskId, String name, String rfid, String uom, int maxPackage, Date expireTime, String skuId, String receivingSpaceId, String goodsAllocationId, String smartPalletId, String shippingSpaceId, String retailStoreId, String bizOrderId, String retailStoreOrderId, String packagingId,String [] tokensExpr) throws Exception{
	...
	public  TransportTask addGoods(YoubenbenUserContext userContext, String transportTaskId, String name, String rfid, String uom, int maxPackage, Date expireTime, String skuId, String receivingSpaceId, String goodsAllocationId, String smartPalletId, String shippingSpaceId, String retailStoreId, String bizOrderId, String retailStoreOrderId, String packagingId, String [] tokensExpr) throws Exception
	{
		...
		checkParamsForAddingGoods(userContext,transportTaskId,name, rfid, uom, maxPackage, expireTime, skuId, receivingSpaceId, goodsAllocationId, smartPalletId, shippingSpaceId, retailStoreId, bizOrderId, retailStoreOrderId, packagingId,tokensExpr);

		Goods goods = createGoods(userContext,name, rfid, uom, maxPackage, expireTime, skuId, receivingSpaceId, goodsAllocationId, smartPalletId, shippingSpaceId, retailStoreId, bizOrderId, retailStoreOrderId, packagingId);
	...
	protected void checkParamsForUpdatingGoodsProperties(YoubenbenUserContext userContext, String transportTaskId,String id,String name,String rfid,String uom,int maxPackage,Date expireTime,String [] tokensExpr) throws Exception {
	...
	public  TransportTask updateGoodsProperties(YoubenbenUserContext userContext, String transportTaskId, String id,String name,String rfid,String uom,int maxPackage,Date expireTime, String [] tokensExpr) throws Exception
	{
	...
	protected void checkParamsForRemovingGoodsList(YoubenbenUserContext userContext, String transportTaskId,
	...
	public  TransportTask removeGoodsList(YoubenbenUserContext userContext, String transportTaskId,
			String goodsIds[],String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForRemovingGoods(YoubenbenUserContext userContext, String transportTaskId,
	...
	public  TransportTask removeGoods(YoubenbenUserContext userContext, String transportTaskId,
		String goodsId, int goodsVersion,String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForCopyingGoods(YoubenbenUserContext userContext, String transportTaskId,
		String goodsId, int goodsVersion,String [] tokensExpr) throws Exception{
	...
	public  TransportTask copyGoodsFrom(YoubenbenUserContext userContext, String transportTaskId,
		String goodsId, int goodsVersion,String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForUpdatingGoods(YoubenbenUserContext userContext, String transportTaskId, String goodsId, int goodsVersion, String property, String newValueExpr,String [] tokensExpr) throws Exception{
	...
	public  TransportTask updateGoods(YoubenbenUserContext userContext, String transportTaskId, String goodsId, int goodsVersion, String property, String newValueExpr,String [] tokensExpr)
			throws Exception{
	...
	*/
	...
	protected void checkParamsForAddingTransportTaskTrack(YoubenbenUserContext userContext, String transportTaskId, Date trackTime, BigDecimal latitude, BigDecimal longitude,String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForUpdatingTransportTaskTrackProperties(YoubenbenUserContext userContext, String transportTaskId,String id,Date trackTime,BigDecimal latitude,BigDecimal longitude,String [] tokensExpr) throws Exception {
	...
	public  TransportTask updateTransportTaskTrackProperties(YoubenbenUserContext userContext, String transportTaskId, String id,Date trackTime,BigDecimal latitude,BigDecimal longitude, String [] tokensExpr) throws Exception
	{
	...
	protected TransportTaskTrack createTransportTaskTrack(YoubenbenUserContext userContext, Date trackTime, BigDecimal latitude, BigDecimal longitude) throws Exception{
	...
	protected void checkParamsForRemovingTransportTaskTrackList(YoubenbenUserContext userContext, String transportTaskId,
	...
	public  TransportTask removeTransportTaskTrackList(YoubenbenUserContext userContext, String transportTaskId,
			String transportTaskTrackIds[],String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForRemovingTransportTaskTrack(YoubenbenUserContext userContext, String transportTaskId,
	...
	public  TransportTask removeTransportTaskTrack(YoubenbenUserContext userContext, String transportTaskId,
		String transportTaskTrackId, int transportTaskTrackVersion,String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForCopyingTransportTaskTrack(YoubenbenUserContext userContext, String transportTaskId,
		String transportTaskTrackId, int transportTaskTrackVersion,String [] tokensExpr) throws Exception{
	...
	public  TransportTask copyTransportTaskTrackFrom(YoubenbenUserContext userContext, String transportTaskId,
		String transportTaskTrackId, int transportTaskTrackVersion,String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForUpdatingTransportTaskTrack(YoubenbenUserContext userContext, String transportTaskId, String transportTaskTrackId, int transportTaskTrackVersion, String property, String newValueExpr,String [] tokensExpr) throws Exception{
	...
	public  TransportTask updateTransportTaskTrack(YoubenbenUserContext userContext, String transportTaskId, String transportTaskTrackId, int transportTaskTrackVersion, String property, String newValueExpr,String [] tokensExpr)
			throws Exception{
	...
	*/
	...
	// -----------------------------------// list-of-view 处理 \\-----------------------------------
    protected void enhanceForListOfView(YoubenbenUserContext userContext,SmartList<TransportTask> list) throws Exception {
    	if (list == null || list.isEmpty()){
    		return;
    	}
		List<RetailStore> endList = YoubenbenBaseUtils.collectReferencedObjectWithType(userContext, list, RetailStore.class);
		userContext.getDAOGroup().enhanceList(endList, RetailStore.class);
		List<TruckDriver> driverList = YoubenbenBaseUtils.collectReferencedObjectWithType(userContext, list, TruckDriver.class);
		userContext.getDAOGroup().enhanceList(driverList, TruckDriver.class);
		List<TransportTruck> truckList = YoubenbenBaseUtils.collectReferencedObjectWithType(userContext, list, TransportTruck.class);
  ...
  // -----------------------------------\\ list-of-view 处理 //-----------------------------------v
	 ...
	 * @throws Exception
	 */
 	public Object wxappview(YoubenbenUserContext userContext, String transportTaskId) throws Exception{
	  SerializeScope vscope = YoubenbenViewScope.getInstance().getTransportTaskDetailScope().clone();
    ...
    String pageTitle = "运输任务"+"详情";
		...
		vscope.field("transportTaskTrackListSection", YoubenbenListOfViewScope.getInstance()
