...
public class TransportTaskJDBCTemplateDAO extends YoubenbenBaseDAOImpl implements TransportTaskDAO{
	...
	*/
    ...
    public SmartList<TransportTask> requestCandidateTransportTaskForGoods(YoubenbenUserContext userContext, String ownerClass, String id, String filterKey, int pageNo, int pageSize) throws Exception {
    ...
    public SmartList<TransportTask> requestCandidateTransportTaskForTransportTaskTrack(YoubenbenUserContext userContext, String ownerClass, String id, String filterKey, int pageNo, int pageSize) throws Exception {
        // NOTE: by default, ignore owner info, just return all by filter key.
		// You need override this method if you have different candidate-logic
		return findAllCandidateByFilter(TransportTaskTable.COLUMN_NAME, TransportTaskTable.COLUMN_END, filterKey, pageNo, pageSize, getTransportTaskMapper());
    }
	...
	public SmartList<Goods> loadOurGoodsList(YoubenbenUserContext userContext, List<TransportTask> us, Map<String,Object> options) throws Exception{
	...
	public SmartList<TransportTaskTrack> loadOurTransportTaskTrackList(YoubenbenUserContext userContext, List<TransportTask> us, Map<String,Object> options) throws Exception{
		if (us == null || us.isEmpty()){
			return new SmartList<>();
		}
		Set<String> ids = us.stream().map(it->it.getId()).collect(Collectors.toSet());
