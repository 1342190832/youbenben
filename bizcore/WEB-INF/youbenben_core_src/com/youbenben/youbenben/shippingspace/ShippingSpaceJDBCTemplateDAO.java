...
public class ShippingSpaceJDBCTemplateDAO extends YoubenbenBaseDAOImpl implements ShippingSpaceDAO{
	...
	*/
    ...
    public SmartList<ShippingSpace> requestCandidateShippingSpaceForGoods(YoubenbenUserContext userContext, String ownerClass, String id, String filterKey, int pageNo, int pageSize) throws Exception {
	...
	public SmartList<Goods> loadOurGoodsList(YoubenbenUserContext userContext, List<ShippingSpace> us, Map<String,Object> options) throws Exception{
