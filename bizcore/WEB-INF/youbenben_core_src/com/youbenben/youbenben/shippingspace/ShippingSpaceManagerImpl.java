...
public class ShippingSpaceManagerImpl extends CustomYoubenbenCheckerManager implements ShippingSpaceManager, BusinessHandler{
	...
	@Override
	public ShippingSpaceDAO daoOf(YoubenbenUserContext userContext) {
	...
	protected void throwExceptionWithMessage(String value) throws ShippingSpaceManagerException{
 	...
 	protected ShippingSpace saveShippingSpace(YoubenbenUserContext userContext, ShippingSpace shippingSpace, String [] tokensExpr) throws Exception{	
 	...
 	protected ShippingSpace saveShippingSpaceDetail(YoubenbenUserContext userContext, ShippingSpace shippingSpace) throws Exception{	
 	...
 	public ShippingSpace loadShippingSpace(YoubenbenUserContext userContext, String shippingSpaceId, String [] tokensExpr) throws Exception{				
 	 ...
 	 public ShippingSpace searchShippingSpace(YoubenbenUserContext userContext, String shippingSpaceId, String textToSearch,String [] tokensExpr) throws Exception{				
 	...
 	protected ShippingSpace present(YoubenbenUserContext userContext, ShippingSpace shippingSpace, Map<String, Object> tokens) throws Exception {
 	...
 	public ShippingSpace loadShippingSpaceDetail(YoubenbenUserContext userContext, String shippingSpaceId) throws Exception{	
 	...
 	public Object view(YoubenbenUserContext userContext, String shippingSpaceId) throws Exception{	
 		ShippingSpace shippingSpace = loadShippingSpace( userContext, shippingSpaceId, viewTokens());
 		return present(userContext,shippingSpace, allTokens());
		
 	}
 	protected ShippingSpace saveShippingSpace(YoubenbenUserContext userContext, ShippingSpace shippingSpace, Map<String,Object>tokens) throws Exception{	
 		return shippingSpaceDaoOf(userContext).save(shippingSpace, tokens);
 	}
 	protected ShippingSpace loadShippingSpace(YoubenbenUserContext userContext, String shippingSpaceId, Map<String,Object>tokens) throws Exception{	
		checkerOf(userContext).checkIdOfShippingSpace(shippingSpaceId);
		checkerOf(userContext).throwExceptionIfHasErrors( ShippingSpaceManagerException.class);
 	...
 	protected<T extends BaseEntity> void addActions(YoubenbenUserContext userContext, ShippingSpace shippingSpace, Map<String, Object> tokens){
	...
	}// end method of protected<T extends BaseEntity> void addActions(YoubenbenUserContext userContext, ShippingSpace shippingSpace, Map<String, Object> tokens){
	...
	protected void checkParamsForUpdatingShippingSpace(YoubenbenUserContext userContext,String shippingSpaceId, int shippingSpaceVersion, String property, String newValueExpr,String [] tokensExpr)throws Exception
	{
	...
	public ShippingSpace clone(YoubenbenUserContext userContext, String fromShippingSpaceId) throws Exception{
	...
	public ShippingSpace internalSaveShippingSpace(YoubenbenUserContext userContext, ShippingSpace shippingSpace, Map<String,Object> options) throws Exception
	{
	...
	public ShippingSpace updateShippingSpaceProperty(YoubenbenUserContext userContext,String shippingSpaceId, int shippingSpaceVersion, String property, String newValueExpr,String [] tokensExpr) throws Exception
	{
		checkParamsForUpdatingShippingSpace(userContext, shippingSpaceId, shippingSpaceVersion, property, newValueExpr, tokensExpr);
	...
	protected void checkParamsForTransferingAnotherWarehouse(YoubenbenUserContext userContext, String shippingSpaceId, String anotherWarehouseId) throws Exception
 	{
 ...
 //--------------------------------------------------------------
	...
	public void delete(YoubenbenUserContext userContext, String shippingSpaceId, int shippingSpaceVersion) throws Exception {
	...
	public ShippingSpace forgetByAll(YoubenbenUserContext userContext, String shippingSpaceId, int shippingSpaceVersion) throws Exception {
		return forgetByAllInternal(userContext, shippingSpaceId, shippingSpaceVersion);
	}
	protected ShippingSpace forgetByAllInternal(YoubenbenUserContext userContext,
			String shippingSpaceId, int shippingSpaceVersion) throws Exception{
	...
	protected ShippingSpace breakWithGoodsBySku(YoubenbenUserContext userContext, String shippingSpaceId, String skuId,  String [] tokensExpr)
		 throws Exception{
	...
	protected ShippingSpace breakWithGoodsByReceivingSpace(YoubenbenUserContext userContext, String shippingSpaceId, String receivingSpaceId,  String [] tokensExpr)
		 throws Exception{
	...
	protected ShippingSpace breakWithGoodsByGoodsAllocation(YoubenbenUserContext userContext, String shippingSpaceId, String goodsAllocationId,  String [] tokensExpr)
		 throws Exception{
	...
	protected ShippingSpace breakWithGoodsBySmartPallet(YoubenbenUserContext userContext, String shippingSpaceId, String smartPalletId,  String [] tokensExpr)
		 throws Exception{
	...
	protected ShippingSpace breakWithGoodsByTransportTask(YoubenbenUserContext userContext, String shippingSpaceId, String transportTaskId,  String [] tokensExpr)
		 throws Exception{
	...
	protected ShippingSpace breakWithGoodsByRetailStore(YoubenbenUserContext userContext, String shippingSpaceId, String retailStoreId,  String [] tokensExpr)
		 throws Exception{
	...
	protected ShippingSpace breakWithGoodsByBizOrder(YoubenbenUserContext userContext, String shippingSpaceId, String bizOrderId,  String [] tokensExpr)
		 throws Exception{
	...
	protected ShippingSpace breakWithGoodsByRetailStoreOrder(YoubenbenUserContext userContext, String shippingSpaceId, String retailStoreOrderId,  String [] tokensExpr)
		 throws Exception{
	...
	protected ShippingSpace breakWithGoodsByPackaging(YoubenbenUserContext userContext, String shippingSpaceId, String packagingId,  String [] tokensExpr)
		 throws Exception{
	...
	protected void checkParamsForAddingGoods(YoubenbenUserContext userContext, String shippingSpaceId, String name, String rfid, String uom, int maxPackage, Date expireTime, String skuId, String receivingSpaceId, String goodsAllocationId, String smartPalletId, String transportTaskId, String retailStoreId, String bizOrderId, String retailStoreOrderId, String packagingId,String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForUpdatingGoodsProperties(YoubenbenUserContext userContext, String shippingSpaceId,String id,String name,String rfid,String uom,int maxPackage,Date expireTime,String [] tokensExpr) throws Exception {
	...
	public  ShippingSpace updateGoodsProperties(YoubenbenUserContext userContext, String shippingSpaceId, String id,String name,String rfid,String uom,int maxPackage,Date expireTime, String [] tokensExpr) throws Exception
	{
	...
	protected void checkParamsForRemovingGoodsList(YoubenbenUserContext userContext, String shippingSpaceId,
	...
	public  ShippingSpace removeGoodsList(YoubenbenUserContext userContext, String shippingSpaceId,
			String goodsIds[],String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForRemovingGoods(YoubenbenUserContext userContext, String shippingSpaceId,
	...
	public  ShippingSpace removeGoods(YoubenbenUserContext userContext, String shippingSpaceId,
		String goodsId, int goodsVersion,String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForCopyingGoods(YoubenbenUserContext userContext, String shippingSpaceId,
		String goodsId, int goodsVersion,String [] tokensExpr) throws Exception{
	...
	public  ShippingSpace copyGoodsFrom(YoubenbenUserContext userContext, String shippingSpaceId,
		String goodsId, int goodsVersion,String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForUpdatingGoods(YoubenbenUserContext userContext, String shippingSpaceId, String goodsId, int goodsVersion, String property, String newValueExpr,String [] tokensExpr) throws Exception{
	...
	public  ShippingSpace updateGoods(YoubenbenUserContext userContext, String shippingSpaceId, String goodsId, int goodsVersion, String property, String newValueExpr,String [] tokensExpr)
			throws Exception{
	...
	*/
	...
	// -----------------------------------// list-of-view 处理 \\-----------------------------------
    protected void enhanceForListOfView(YoubenbenUserContext userContext,SmartList<ShippingSpace> list) throws Exception {
  ...
  // -----------------------------------\\ list-of-view 处理 //-----------------------------------v
	 ...
	 * @throws Exception
	 */
 	public Object wxappview(YoubenbenUserContext userContext, String shippingSpaceId) throws Exception{
	  SerializeScope vscope = YoubenbenViewScope.getInstance().getShippingSpaceDetailScope().clone();
