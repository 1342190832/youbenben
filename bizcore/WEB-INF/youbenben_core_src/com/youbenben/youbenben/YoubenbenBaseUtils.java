...
public class YoubenbenBaseUtils {
	...
	public static String getCacheAccessKey(YoubenbenUserContext ctx) {
	...
	protected static BaseEntity loadCanCacheInLocal(YoubenbenUserContext userContext, String type, String id) throws Exception {
	...
	public static <T extends BaseEntity> List<T> collectReferencedObjectWithType(YoubenbenUserContext userContext,
	...
	private static <T extends BaseEntity> void collectReferedObjectIdSet(YoubenbenUserContext userContext,
	...
	public static int getAppBuildVersion(YoubenbenUserContext ctx) {
		return getBuildVersion(getRequestAppVersion(ctx));
	}
	protected static boolean startFromVersion(YoubenbenUserContext ctx, int version) {
     ...
     * "x-app-version" : "9"
	 */
	public static String getRequestAppVersion(YoubenbenUserContext userContext) {
		return userContext.getRequestHeader("x-app-version");
	}
	public static String getRequestAppDevice(YoubenbenUserContext userContext) {
		return userContext.getRequestHeader("x-app-device");
	}
	public static String getRequestAppType(YoubenbenUserContext userContext) {
	...
	public static PageType getPageType(YoubenbenUserContext userContext, String code) throws Exception {
	...
	public static <T> T loadBaseEntityById(YoubenbenUserContext ctx, String type, String id) throws Exception {
		return loadBaseEntityById(ctx, type, id, null);
	}
	public static <T> T loadBaseEntityById(YoubenbenUserContext ctx, String type, String id, Consumer<T> enhancer) throws Exception {
		String key = type+":"+id;
	...
	public static <T extends BaseEntity> void appendLinkToUrl(YoubenbenUserContext ctx, List<T> list,
			Function<T, String> makeFunc) {
		if (list == null || list.isEmpty()) {
			return;
		}
		list.forEach(it -> {
			it.addItemToValueMap(YoubenbenBaseConstants.X_LINK_TO_URL, makeFunc.apply(it));
		});
	}

	public static <T extends BaseEntity> void appendLinkToUrl(YoubenbenUserContext ctx, T obj, String url) {
		if (obj == null) {
			return;
		}
		obj.addItemToValueMap(YoubenbenBaseConstants.X_LINK_TO_URL, url);
	}

	public static ButtonViewComponent addAction(YoubenbenUserContext ctx, BaseEntity obj, String title, String code,
			String linkToUrl) {
	...
	public static void setAction(YoubenbenUserContext ctx, BaseEntity obj, String title, String code, String linkToUrl) {
		ButtonViewComponent actionBtn = new ButtonViewComponent(title, null, code);
		actionBtn.setLinkToUrl(linkToUrl);
