...
public class ReceivingSpaceJDBCTemplateDAO extends YoubenbenBaseDAOImpl implements ReceivingSpaceDAO{
	...
	*/
    ...
    public SmartList<ReceivingSpace> requestCandidateReceivingSpaceForGoods(YoubenbenUserContext userContext, String ownerClass, String id, String filterKey, int pageNo, int pageSize) throws Exception {
	...
	public SmartList<Goods> loadOurGoodsList(YoubenbenUserContext userContext, List<ReceivingSpace> us, Map<String,Object> options) throws Exception{
