...
public class ReceivingSpaceManagerImpl extends CustomYoubenbenCheckerManager implements ReceivingSpaceManager, BusinessHandler{
	...
	@Override
	public ReceivingSpaceDAO daoOf(YoubenbenUserContext userContext) {
	...
	protected void throwExceptionWithMessage(String value) throws ReceivingSpaceManagerException{
 	...
 	protected ReceivingSpace saveReceivingSpace(YoubenbenUserContext userContext, ReceivingSpace receivingSpace, String [] tokensExpr) throws Exception{	
 	...
 	protected ReceivingSpace saveReceivingSpaceDetail(YoubenbenUserContext userContext, ReceivingSpace receivingSpace) throws Exception{	
 	...
 	public ReceivingSpace loadReceivingSpace(YoubenbenUserContext userContext, String receivingSpaceId, String [] tokensExpr) throws Exception{				
 	 ...
 	 public ReceivingSpace searchReceivingSpace(YoubenbenUserContext userContext, String receivingSpaceId, String textToSearch,String [] tokensExpr) throws Exception{				
 	...
 	protected ReceivingSpace present(YoubenbenUserContext userContext, ReceivingSpace receivingSpace, Map<String, Object> tokens) throws Exception {
 	...
 	public ReceivingSpace loadReceivingSpaceDetail(YoubenbenUserContext userContext, String receivingSpaceId) throws Exception{	
 	...
 	public Object view(YoubenbenUserContext userContext, String receivingSpaceId) throws Exception{	
 		ReceivingSpace receivingSpace = loadReceivingSpace( userContext, receivingSpaceId, viewTokens());
 		return present(userContext,receivingSpace, allTokens());
		
 	}
 	protected ReceivingSpace saveReceivingSpace(YoubenbenUserContext userContext, ReceivingSpace receivingSpace, Map<String,Object>tokens) throws Exception{	
 		return receivingSpaceDaoOf(userContext).save(receivingSpace, tokens);
 	}
 	protected ReceivingSpace loadReceivingSpace(YoubenbenUserContext userContext, String receivingSpaceId, Map<String,Object>tokens) throws Exception{	
		checkerOf(userContext).checkIdOfReceivingSpace(receivingSpaceId);
		checkerOf(userContext).throwExceptionIfHasErrors( ReceivingSpaceManagerException.class);
 	...
 	protected<T extends BaseEntity> void addActions(YoubenbenUserContext userContext, ReceivingSpace receivingSpace, Map<String, Object> tokens){
	...
	}// end method of protected<T extends BaseEntity> void addActions(YoubenbenUserContext userContext, ReceivingSpace receivingSpace, Map<String, Object> tokens){
	...
	protected void checkParamsForUpdatingReceivingSpace(YoubenbenUserContext userContext,String receivingSpaceId, int receivingSpaceVersion, String property, String newValueExpr,String [] tokensExpr)throws Exception
	{
	...
	public ReceivingSpace clone(YoubenbenUserContext userContext, String fromReceivingSpaceId) throws Exception{
	...
	public ReceivingSpace internalSaveReceivingSpace(YoubenbenUserContext userContext, ReceivingSpace receivingSpace, Map<String,Object> options) throws Exception
	{
	...
	public ReceivingSpace updateReceivingSpaceProperty(YoubenbenUserContext userContext,String receivingSpaceId, int receivingSpaceVersion, String property, String newValueExpr,String [] tokensExpr) throws Exception
	{
		checkParamsForUpdatingReceivingSpace(userContext, receivingSpaceId, receivingSpaceVersion, property, newValueExpr, tokensExpr);
	...
	protected void checkParamsForTransferingAnotherWarehouse(YoubenbenUserContext userContext, String receivingSpaceId, String anotherWarehouseId) throws Exception
 	{
 ...
 //--------------------------------------------------------------
	...
	public void delete(YoubenbenUserContext userContext, String receivingSpaceId, int receivingSpaceVersion) throws Exception {
	...
	public ReceivingSpace forgetByAll(YoubenbenUserContext userContext, String receivingSpaceId, int receivingSpaceVersion) throws Exception {
		return forgetByAllInternal(userContext, receivingSpaceId, receivingSpaceVersion);
	}
	protected ReceivingSpace forgetByAllInternal(YoubenbenUserContext userContext,
			String receivingSpaceId, int receivingSpaceVersion) throws Exception{
	...
	protected ReceivingSpace breakWithGoodsBySku(YoubenbenUserContext userContext, String receivingSpaceId, String skuId,  String [] tokensExpr)
		 throws Exception{
	...
	protected ReceivingSpace breakWithGoodsByGoodsAllocation(YoubenbenUserContext userContext, String receivingSpaceId, String goodsAllocationId,  String [] tokensExpr)
		 throws Exception{
	...
	protected ReceivingSpace breakWithGoodsBySmartPallet(YoubenbenUserContext userContext, String receivingSpaceId, String smartPalletId,  String [] tokensExpr)
		 throws Exception{
	...
	protected ReceivingSpace breakWithGoodsByShippingSpace(YoubenbenUserContext userContext, String receivingSpaceId, String shippingSpaceId,  String [] tokensExpr)
		 throws Exception{
	...
	protected ReceivingSpace breakWithGoodsByTransportTask(YoubenbenUserContext userContext, String receivingSpaceId, String transportTaskId,  String [] tokensExpr)
		 throws Exception{
	...
	protected ReceivingSpace breakWithGoodsByRetailStore(YoubenbenUserContext userContext, String receivingSpaceId, String retailStoreId,  String [] tokensExpr)
		 throws Exception{
	...
	protected ReceivingSpace breakWithGoodsByBizOrder(YoubenbenUserContext userContext, String receivingSpaceId, String bizOrderId,  String [] tokensExpr)
		 throws Exception{
	...
	protected ReceivingSpace breakWithGoodsByRetailStoreOrder(YoubenbenUserContext userContext, String receivingSpaceId, String retailStoreOrderId,  String [] tokensExpr)
		 throws Exception{
	...
	protected ReceivingSpace breakWithGoodsByPackaging(YoubenbenUserContext userContext, String receivingSpaceId, String packagingId,  String [] tokensExpr)
		 throws Exception{
			...
			synchronized(receivingSpace){
				...
				receivingSpaceDaoOf(userContext).planToRemoveGoodsListWithPackaging(receivingSpace, packagingId, this.emptyOptions());
	...
	public  ReceivingSpace addGoods(YoubenbenUserContext userContext, String receivingSpaceId, String name, String rfid, String uom, int maxPackage, Date expireTime, String skuId, String goodsAllocationId, String smartPalletId, String shippingSpaceId, String transportTaskId, String retailStoreId, String bizOrderId, String retailStoreOrderId, String packagingId, String [] tokensExpr) throws Exception
	{
		...
		checkParamsForAddingGoods(userContext,receivingSpaceId,name, rfid, uom, maxPackage, expireTime, skuId, goodsAllocationId, smartPalletId, shippingSpaceId, transportTaskId, retailStoreId, bizOrderId, retailStoreOrderId, packagingId,tokensExpr);

		Goods goods = createGoods(userContext,name, rfid, uom, maxPackage, expireTime, skuId, goodsAllocationId, smartPalletId, shippingSpaceId, transportTaskId, retailStoreId, bizOrderId, retailStoreOrderId, packagingId);
	...
	protected void checkParamsForUpdatingGoodsProperties(YoubenbenUserContext userContext, String receivingSpaceId,String id,String name,String rfid,String uom,int maxPackage,Date expireTime,String [] tokensExpr) throws Exception {
	...
	public  ReceivingSpace updateGoodsProperties(YoubenbenUserContext userContext, String receivingSpaceId, String id,String name,String rfid,String uom,int maxPackage,Date expireTime, String [] tokensExpr) throws Exception
	{
	...
	protected Goods createGoods(YoubenbenUserContext userContext, String name, String rfid, String uom, int maxPackage, Date expireTime, String skuId, String goodsAllocationId, String smartPalletId, String shippingSpaceId, String transportTaskId, String retailStoreId, String bizOrderId, String retailStoreOrderId, String packagingId) throws Exception{
	...
	protected void checkParamsForRemovingGoodsList(YoubenbenUserContext userContext, String receivingSpaceId,
	...
	public  ReceivingSpace removeGoodsList(YoubenbenUserContext userContext, String receivingSpaceId,
			String goodsIds[],String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForRemovingGoods(YoubenbenUserContext userContext, String receivingSpaceId,
	...
	public  ReceivingSpace removeGoods(YoubenbenUserContext userContext, String receivingSpaceId,
		String goodsId, int goodsVersion,String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForCopyingGoods(YoubenbenUserContext userContext, String receivingSpaceId,
		String goodsId, int goodsVersion,String [] tokensExpr) throws Exception{
	...
	public  ReceivingSpace copyGoodsFrom(YoubenbenUserContext userContext, String receivingSpaceId,
		String goodsId, int goodsVersion,String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForUpdatingGoods(YoubenbenUserContext userContext, String receivingSpaceId, String goodsId, int goodsVersion, String property, String newValueExpr,String [] tokensExpr) throws Exception{
	...
	public  ReceivingSpace updateGoods(YoubenbenUserContext userContext, String receivingSpaceId, String goodsId, int goodsVersion, String property, String newValueExpr,String [] tokensExpr)
			throws Exception{
	...
	*/
	...
	// -----------------------------------// list-of-view 处理 \\-----------------------------------
    protected void enhanceForListOfView(YoubenbenUserContext userContext,SmartList<ReceivingSpace> list) throws Exception {
  ...
  // -----------------------------------\\ list-of-view 处理 //-----------------------------------v
	 ...
	 * @throws Exception
	 */
 	public Object wxappview(YoubenbenUserContext userContext, String receivingSpaceId) throws Exception{
	  SerializeScope vscope = YoubenbenViewScope.getInstance().getReceivingSpaceDetailScope().clone();
