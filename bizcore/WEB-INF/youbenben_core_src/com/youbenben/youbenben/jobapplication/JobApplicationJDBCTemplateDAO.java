...
public class JobApplicationJDBCTemplateDAO extends YoubenbenBaseDAOImpl implements JobApplicationDAO{
	...
	*/
	...
	public SmartList<JobApplication> loadAll() {
	    return this.loadAll(getJobApplicationMapper());
	}
    ...
    public SmartList<JobApplication> requestCandidateJobApplicationForEmployee(YoubenbenUserContext userContext, String ownerClass, String id, String filterKey, int pageNo, int pageSize) throws Exception {
        // NOTE: by default, ignore owner info, just return all by filter key.
		// You need override this method if you have different candidate-logic
		return findAllCandidateByFilter(JobApplicationTable.COLUMN_APPLICATION_TIME, null, filterKey, pageNo, pageSize, getJobApplicationMapper());
    }
	...
	public SmartList<Employee> loadOurEmployeeList(YoubenbenUserContext userContext, List<JobApplication> us, Map<String,Object> options) throws Exception{
