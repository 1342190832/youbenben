...
public class AccountSetManagerImpl extends CustomYoubenbenCheckerManager implements AccountSetManager, BusinessHandler{
	...
	@Override
	public AccountSetDAO daoOf(YoubenbenUserContext userContext) {
	...
	protected void throwExceptionWithMessage(String value) throws AccountSetManagerException{
 	...
 	protected AccountSet saveAccountSet(YoubenbenUserContext userContext, AccountSet accountSet, String [] tokensExpr) throws Exception{	
 	...
 	protected AccountSet saveAccountSetDetail(YoubenbenUserContext userContext, AccountSet accountSet) throws Exception{	
 	...
 	public AccountSet loadAccountSet(YoubenbenUserContext userContext, String accountSetId, String [] tokensExpr) throws Exception{				
 	 ...
 	 public AccountSet searchAccountSet(YoubenbenUserContext userContext, String accountSetId, String textToSearch,String [] tokensExpr) throws Exception{				
 	...
 	protected AccountSet present(YoubenbenUserContext userContext, AccountSet accountSet, Map<String, Object> tokens) throws Exception {
 	...
 	public AccountSet loadAccountSetDetail(YoubenbenUserContext userContext, String accountSetId) throws Exception{	
 		AccountSet accountSet = loadAccountSet( userContext, accountSetId, allTokens());
 		return present(userContext,accountSet, allTokens());
		
 	}
 	
 	public Object view(YoubenbenUserContext userContext, String accountSetId) throws Exception{	
 		AccountSet accountSet = loadAccountSet( userContext, accountSetId, viewTokens());
 		return present(userContext,accountSet, allTokens());
		
 	}
 	protected AccountSet saveAccountSet(YoubenbenUserContext userContext, AccountSet accountSet, Map<String,Object>tokens) throws Exception{	
 		return accountSetDaoOf(userContext).save(accountSet, tokens);
 	}
 	protected AccountSet loadAccountSet(YoubenbenUserContext userContext, String accountSetId, Map<String,Object>tokens) throws Exception{	
		checkerOf(userContext).checkIdOfAccountSet(accountSetId);
		checkerOf(userContext).throwExceptionIfHasErrors( AccountSetManagerException.class);
 	...
 	protected<T extends BaseEntity> void addActions(YoubenbenUserContext userContext, AccountSet accountSet, Map<String, Object> tokens){
	...
	}// end method of protected<T extends BaseEntity> void addActions(YoubenbenUserContext userContext, AccountSet accountSet, Map<String, Object> tokens){
	...
	protected void checkParamsForUpdatingAccountSet(YoubenbenUserContext userContext,String accountSetId, int accountSetVersion, String property, String newValueExpr,String [] tokensExpr)throws Exception
	{
	...
	public AccountSet clone(YoubenbenUserContext userContext, String fromAccountSetId) throws Exception{
	...
	public AccountSet internalSaveAccountSet(YoubenbenUserContext userContext, AccountSet accountSet, Map<String,Object> options) throws Exception
	{
	...
	public AccountSet updateAccountSetProperty(YoubenbenUserContext userContext,String accountSetId, int accountSetVersion, String property, String newValueExpr,String [] tokensExpr) throws Exception
	{
		checkParamsForUpdatingAccountSet(userContext, accountSetId, accountSetVersion, property, newValueExpr, tokensExpr);
	...
	protected void checkParamsForTransferingAnotherCountryCenter(YoubenbenUserContext userContext, String accountSetId, String anotherCountryCenterId) throws Exception
 	{
	...
	public CandidateRetailStoreCountryCenter requestCandidateCountryCenter(YoubenbenUserContext userContext, String ownerClass, String id, String filterKey, int pageNo) throws Exception {
 	...
 	protected void checkParamsForTransferingAnotherRetailStore(YoubenbenUserContext userContext, String accountSetId, String anotherRetailStoreId) throws Exception
 	{
	...
	public CandidateRetailStore requestCandidateRetailStore(YoubenbenUserContext userContext, String ownerClass, String id, String filterKey, int pageNo) throws Exception {
 	...
 	protected void checkParamsForTransferingAnotherGoodsSupplier(YoubenbenUserContext userContext, String accountSetId, String anotherGoodsSupplierId) throws Exception
 	{
	...
	public CandidateGoodsSupplier requestCandidateGoodsSupplier(YoubenbenUserContext userContext, String ownerClass, String id, String filterKey, int pageNo) throws Exception {
 ...
 //--------------------------------------------------------------
 	...
 	protected RetailStoreCountryCenter loadRetailStoreCountryCenter(YoubenbenUserContext userContext, String newCountryCenterId, Map<String,Object> options) throws Exception
 	{
 	...
 	protected GoodsSupplier loadGoodsSupplier(YoubenbenUserContext userContext, String newGoodsSupplierId, Map<String,Object> options) throws Exception
 	{
	...
	public void delete(YoubenbenUserContext userContext, String accountSetId, int accountSetVersion) throws Exception {
	...
	public AccountSet forgetByAll(YoubenbenUserContext userContext, String accountSetId, int accountSetVersion) throws Exception {
		return forgetByAllInternal(userContext, accountSetId, accountSetVersion);
	}
	protected AccountSet forgetByAllInternal(YoubenbenUserContext userContext,
			String accountSetId, int accountSetVersion) throws Exception{
	...
	protected void checkParamsForAddingAccountingSubject(YoubenbenUserContext userContext, String accountSetId, String accountingSubjectCode, String accountingSubjectName, int accountingSubjectClassCode, String accountingSubjectClassName,String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForUpdatingAccountingSubjectProperties(YoubenbenUserContext userContext, String accountSetId,String id,String accountingSubjectCode,String accountingSubjectName,int accountingSubjectClassCode,String accountingSubjectClassName,String [] tokensExpr) throws Exception {
	...
	public  AccountSet updateAccountingSubjectProperties(YoubenbenUserContext userContext, String accountSetId, String id,String accountingSubjectCode,String accountingSubjectName,int accountingSubjectClassCode,String accountingSubjectClassName, String [] tokensExpr) throws Exception
	{
	...
	protected AccountingSubject createAccountingSubject(YoubenbenUserContext userContext, String accountingSubjectCode, String accountingSubjectName, int accountingSubjectClassCode, String accountingSubjectClassName) throws Exception{
	...
	protected void checkParamsForRemovingAccountingSubjectList(YoubenbenUserContext userContext, String accountSetId,
	...
	public  AccountSet removeAccountingSubjectList(YoubenbenUserContext userContext, String accountSetId,
			String accountingSubjectIds[],String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForRemovingAccountingSubject(YoubenbenUserContext userContext, String accountSetId,
	...
	public  AccountSet removeAccountingSubject(YoubenbenUserContext userContext, String accountSetId,
		String accountingSubjectId, int accountingSubjectVersion,String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForCopyingAccountingSubject(YoubenbenUserContext userContext, String accountSetId,
		String accountingSubjectId, int accountingSubjectVersion,String [] tokensExpr) throws Exception{
	...
	public  AccountSet copyAccountingSubjectFrom(YoubenbenUserContext userContext, String accountSetId,
		String accountingSubjectId, int accountingSubjectVersion,String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForUpdatingAccountingSubject(YoubenbenUserContext userContext, String accountSetId, String accountingSubjectId, int accountingSubjectVersion, String property, String newValueExpr,String [] tokensExpr) throws Exception{
	...
	public  AccountSet updateAccountingSubject(YoubenbenUserContext userContext, String accountSetId, String accountingSubjectId, int accountingSubjectVersion, String property, String newValueExpr,String [] tokensExpr)
			throws Exception{
	...
	*/
	...
	protected void checkParamsForAddingAccountingPeriod(YoubenbenUserContext userContext, String accountSetId, String name, Date startDate, Date endDate,String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForUpdatingAccountingPeriodProperties(YoubenbenUserContext userContext, String accountSetId,String id,String name,Date startDate,Date endDate,String [] tokensExpr) throws Exception {
	...
	public  AccountSet updateAccountingPeriodProperties(YoubenbenUserContext userContext, String accountSetId, String id,String name,Date startDate,Date endDate, String [] tokensExpr) throws Exception
	{
	...
	protected AccountingPeriod createAccountingPeriod(YoubenbenUserContext userContext, String name, Date startDate, Date endDate) throws Exception{
	...
	protected void checkParamsForRemovingAccountingPeriodList(YoubenbenUserContext userContext, String accountSetId,
	...
	public  AccountSet removeAccountingPeriodList(YoubenbenUserContext userContext, String accountSetId,
			String accountingPeriodIds[],String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForRemovingAccountingPeriod(YoubenbenUserContext userContext, String accountSetId,
	...
	public  AccountSet removeAccountingPeriod(YoubenbenUserContext userContext, String accountSetId,
		String accountingPeriodId, int accountingPeriodVersion,String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForCopyingAccountingPeriod(YoubenbenUserContext userContext, String accountSetId,
		String accountingPeriodId, int accountingPeriodVersion,String [] tokensExpr) throws Exception{
	...
	public  AccountSet copyAccountingPeriodFrom(YoubenbenUserContext userContext, String accountSetId,
		String accountingPeriodId, int accountingPeriodVersion,String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForUpdatingAccountingPeriod(YoubenbenUserContext userContext, String accountSetId, String accountingPeriodId, int accountingPeriodVersion, String property, String newValueExpr,String [] tokensExpr) throws Exception{
	...
	public  AccountSet updateAccountingPeriod(YoubenbenUserContext userContext, String accountSetId, String accountingPeriodId, int accountingPeriodVersion, String property, String newValueExpr,String [] tokensExpr)
			throws Exception{
	...
	*/
	...
	protected void checkParamsForAddingAccountingDocumentType(YoubenbenUserContext userContext, String accountSetId, String name, String description,String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForUpdatingAccountingDocumentTypeProperties(YoubenbenUserContext userContext, String accountSetId,String id,String name,String description,String [] tokensExpr) throws Exception {
	...
	public  AccountSet updateAccountingDocumentTypeProperties(YoubenbenUserContext userContext, String accountSetId, String id,String name,String description, String [] tokensExpr) throws Exception
	{
	...
	protected AccountingDocumentType createAccountingDocumentType(YoubenbenUserContext userContext, String name, String description) throws Exception{
	...
	protected void checkParamsForRemovingAccountingDocumentTypeList(YoubenbenUserContext userContext, String accountSetId,
	...
	public  AccountSet removeAccountingDocumentTypeList(YoubenbenUserContext userContext, String accountSetId,
			String accountingDocumentTypeIds[],String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForRemovingAccountingDocumentType(YoubenbenUserContext userContext, String accountSetId,
	...
	public  AccountSet removeAccountingDocumentType(YoubenbenUserContext userContext, String accountSetId,
		String accountingDocumentTypeId, int accountingDocumentTypeVersion,String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForCopyingAccountingDocumentType(YoubenbenUserContext userContext, String accountSetId,
		String accountingDocumentTypeId, int accountingDocumentTypeVersion,String [] tokensExpr) throws Exception{
	...
	public  AccountSet copyAccountingDocumentTypeFrom(YoubenbenUserContext userContext, String accountSetId,
		String accountingDocumentTypeId, int accountingDocumentTypeVersion,String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForUpdatingAccountingDocumentType(YoubenbenUserContext userContext, String accountSetId, String accountingDocumentTypeId, int accountingDocumentTypeVersion, String property, String newValueExpr,String [] tokensExpr) throws Exception{
	...
	public  AccountSet updateAccountingDocumentType(YoubenbenUserContext userContext, String accountSetId, String accountingDocumentTypeId, int accountingDocumentTypeVersion, String property, String newValueExpr,String [] tokensExpr)
			throws Exception{
	...
	*/
	...
	// -----------------------------------// list-of-view 处理 \\-----------------------------------
    protected void enhanceForListOfView(YoubenbenUserContext userContext,SmartList<AccountSet> list) throws Exception {
    	if (list == null || list.isEmpty()){
    		return;
    	}
		List<RetailStoreCountryCenter> countryCenterList = YoubenbenBaseUtils.collectReferencedObjectWithType(userContext, list, RetailStoreCountryCenter.class);
		...
		List<GoodsSupplier> goodsSupplierList = YoubenbenBaseUtils.collectReferencedObjectWithType(userContext, list, GoodsSupplier.class);
  ...
  // -----------------------------------\\ list-of-view 处理 //-----------------------------------v
	 ...
	 * @throws Exception
	 */
 	public Object wxappview(YoubenbenUserContext userContext, String accountSetId) throws Exception{
	  SerializeScope vscope = YoubenbenViewScope.getInstance().getAccountSetDetailScope().clone();
    ...
    String pageTitle = "账套"+"详情";
		...
		vscope.field("accountingSubjectListSection", YoubenbenListOfViewScope.getInstance()
		...
		vscope.field("accountingPeriodListSection", YoubenbenListOfViewScope.getInstance()
		...
		vscope.field("accountingDocumentTypeListSection", YoubenbenListOfViewScope.getInstance()
