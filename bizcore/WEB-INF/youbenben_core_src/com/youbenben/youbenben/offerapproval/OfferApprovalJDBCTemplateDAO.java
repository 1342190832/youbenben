...
public class OfferApprovalJDBCTemplateDAO extends YoubenbenBaseDAOImpl implements OfferApprovalDAO{
	...
	*/
	...
	public SmartList<OfferApproval> loadAll() {
	    return this.loadAll(getOfferApprovalMapper());
	}
    ...
    public SmartList<OfferApproval> requestCandidateOfferApprovalForEmployee(YoubenbenUserContext userContext, String ownerClass, String id, String filterKey, int pageNo, int pageSize) throws Exception {
        // NOTE: by default, ignore owner info, just return all by filter key.
		// You need override this method if you have different candidate-logic
		return findAllCandidateByFilter(OfferApprovalTable.COLUMN_WHO, null, filterKey, pageNo, pageSize, getOfferApprovalMapper());
    }
	...
	public SmartList<Employee> loadOurEmployeeList(YoubenbenUserContext userContext, List<OfferApproval> us, Map<String,Object> options) throws Exception{
	...
	@Override
	public CandidateOfferApproval executeCandidatesQuery(CandidateQuery query, String sql, Object ... parmeters) throws Exception {
