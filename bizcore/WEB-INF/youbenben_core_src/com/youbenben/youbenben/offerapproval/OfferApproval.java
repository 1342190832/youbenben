...
public class OfferApproval extends BaseEntity implements  java.io.Serializable{
	...
	public 	static OfferApproval withId(String id){
	...
	public 	static OfferApproval refById(String id){
		return withId(id);
	}
	...
	public Object[] toFlatArray(){
		return new Object[]{getId(), getWho(), getApproveTime(), getComments(), getVersion()};
	}
