...
public class OfferApprovalManagerImpl extends CustomYoubenbenCheckerManager implements OfferApprovalManager, BusinessHandler{
	...
	@Override
	public OfferApprovalDAO daoOf(YoubenbenUserContext userContext) {
	...
	protected void throwExceptionWithMessage(String value) throws OfferApprovalManagerException{
 	...
 	protected OfferApproval saveOfferApproval(YoubenbenUserContext userContext, OfferApproval offerApproval, String [] tokensExpr) throws Exception{	
 	...
 	protected OfferApproval saveOfferApprovalDetail(YoubenbenUserContext userContext, OfferApproval offerApproval) throws Exception{	
 	...
 	public OfferApproval loadOfferApproval(YoubenbenUserContext userContext, String offerApprovalId, String [] tokensExpr) throws Exception{				
 	 ...
 	 public OfferApproval searchOfferApproval(YoubenbenUserContext userContext, String offerApprovalId, String textToSearch,String [] tokensExpr) throws Exception{				
 	...
 	protected OfferApproval present(YoubenbenUserContext userContext, OfferApproval offerApproval, Map<String, Object> tokens) throws Exception {
 	...
 	public OfferApproval loadOfferApprovalDetail(YoubenbenUserContext userContext, String offerApprovalId) throws Exception{	
 	...
 	public Object view(YoubenbenUserContext userContext, String offerApprovalId) throws Exception{	
 		OfferApproval offerApproval = loadOfferApproval( userContext, offerApprovalId, viewTokens());
 		return present(userContext,offerApproval, allTokens());
		
 	}
 	protected OfferApproval saveOfferApproval(YoubenbenUserContext userContext, OfferApproval offerApproval, Map<String,Object>tokens) throws Exception{	
 		return offerApprovalDaoOf(userContext).save(offerApproval, tokens);
 	}
 	protected OfferApproval loadOfferApproval(YoubenbenUserContext userContext, String offerApprovalId, Map<String,Object>tokens) throws Exception{	
		checkerOf(userContext).checkIdOfOfferApproval(offerApprovalId);
		checkerOf(userContext).throwExceptionIfHasErrors( OfferApprovalManagerException.class);
 	...
 	protected<T extends BaseEntity> void addActions(YoubenbenUserContext userContext, OfferApproval offerApproval, Map<String, Object> tokens){
	...
	}// end method of protected<T extends BaseEntity> void addActions(YoubenbenUserContext userContext, OfferApproval offerApproval, Map<String, Object> tokens){
	...
	protected void checkParamsForUpdatingOfferApproval(YoubenbenUserContext userContext,String offerApprovalId, int offerApprovalVersion, String property, String newValueExpr,String [] tokensExpr)throws Exception
	{
	...
	public OfferApproval clone(YoubenbenUserContext userContext, String fromOfferApprovalId) throws Exception{
	...
	public OfferApproval internalSaveOfferApproval(YoubenbenUserContext userContext, OfferApproval offerApproval, Map<String,Object> options) throws Exception
	{
	...
	public OfferApproval updateOfferApprovalProperty(YoubenbenUserContext userContext,String offerApprovalId, int offerApprovalVersion, String property, String newValueExpr,String [] tokensExpr) throws Exception
	{
		checkParamsForUpdatingOfferApproval(userContext, offerApprovalId, offerApprovalVersion, property, newValueExpr, tokensExpr);
...
//--------------------------------------------------------------
	...
	public void delete(YoubenbenUserContext userContext, String offerApprovalId, int offerApprovalVersion) throws Exception {
	...
	public OfferApproval forgetByAll(YoubenbenUserContext userContext, String offerApprovalId, int offerApprovalVersion) throws Exception {
		return forgetByAllInternal(userContext, offerApprovalId, offerApprovalVersion);
	}
	protected OfferApproval forgetByAllInternal(YoubenbenUserContext userContext,
			String offerApprovalId, int offerApprovalVersion) throws Exception{
	...
	protected OfferApproval breakWithEmployeeByCompany(YoubenbenUserContext userContext, String offerApprovalId, String companyId,  String [] tokensExpr)
		 throws Exception{
	...
	protected OfferApproval breakWithEmployeeByDepartment(YoubenbenUserContext userContext, String offerApprovalId, String departmentId,  String [] tokensExpr)
		 throws Exception{
	...
	protected OfferApproval breakWithEmployeeByOccupation(YoubenbenUserContext userContext, String offerApprovalId, String occupationId,  String [] tokensExpr)
		 throws Exception{
	...
	protected OfferApproval breakWithEmployeeByResponsibleFor(YoubenbenUserContext userContext, String offerApprovalId, String responsibleForId,  String [] tokensExpr)
		 throws Exception{
	...
	protected OfferApproval breakWithEmployeeByCurrentSalaryGrade(YoubenbenUserContext userContext, String offerApprovalId, String currentSalaryGradeId,  String [] tokensExpr)
		 throws Exception{
	...
	protected OfferApproval breakWithEmployeeByJobApplication(YoubenbenUserContext userContext, String offerApprovalId, String jobApplicationId,  String [] tokensExpr)
		 throws Exception{
	...
	protected OfferApproval breakWithEmployeeByProfessionInterview(YoubenbenUserContext userContext, String offerApprovalId, String professionInterviewId,  String [] tokensExpr)
		 throws Exception{
	...
	protected OfferApproval breakWithEmployeeByHrInterview(YoubenbenUserContext userContext, String offerApprovalId, String hrInterviewId,  String [] tokensExpr)
		 throws Exception{
	...
	protected OfferApproval breakWithEmployeeByOfferAcceptance(YoubenbenUserContext userContext, String offerApprovalId, String offerAcceptanceId,  String [] tokensExpr)
		 throws Exception{
	...
	protected OfferApproval breakWithEmployeeByEmployeeBoarding(YoubenbenUserContext userContext, String offerApprovalId, String employeeBoardingId,  String [] tokensExpr)
		 throws Exception{
	...
	protected OfferApproval breakWithEmployeeByTermination(YoubenbenUserContext userContext, String offerApprovalId, String terminationId,  String [] tokensExpr)
		 throws Exception{
	...
	protected void checkParamsForAddingEmployee(YoubenbenUserContext userContext, String offerApprovalId, String companyId, String title, String departmentId, String familyName, String givenName, String email, String city, String address, String cellPhone, String occupationId, String responsibleForId, String currentSalaryGradeId, String salaryAccount, String jobApplicationId, String professionInterviewId, String hrInterviewId, String offerAcceptanceId, String employeeBoardingId, String terminationId,String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForUpdatingEmployeeProperties(YoubenbenUserContext userContext, String offerApprovalId,String id,String title,String familyName,String givenName,String email,String city,String address,String cellPhone,String salaryAccount,String [] tokensExpr) throws Exception {
	...
	public  OfferApproval updateEmployeeProperties(YoubenbenUserContext userContext, String offerApprovalId, String id,String title,String familyName,String givenName,String email,String city,String address,String cellPhone,String salaryAccount, String [] tokensExpr) throws Exception
	{
	...
	protected void checkParamsForRemovingEmployeeList(YoubenbenUserContext userContext, String offerApprovalId,
	...
	public  OfferApproval removeEmployeeList(YoubenbenUserContext userContext, String offerApprovalId,
			String employeeIds[],String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForRemovingEmployee(YoubenbenUserContext userContext, String offerApprovalId,
	...
	public  OfferApproval removeEmployee(YoubenbenUserContext userContext, String offerApprovalId,
		String employeeId, int employeeVersion,String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForCopyingEmployee(YoubenbenUserContext userContext, String offerApprovalId,
		String employeeId, int employeeVersion,String [] tokensExpr) throws Exception{
	...
	public  OfferApproval copyEmployeeFrom(YoubenbenUserContext userContext, String offerApprovalId,
		String employeeId, int employeeVersion,String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForUpdatingEmployee(YoubenbenUserContext userContext, String offerApprovalId, String employeeId, int employeeVersion, String property, String newValueExpr,String [] tokensExpr) throws Exception{
	...
	public  OfferApproval updateEmployee(YoubenbenUserContext userContext, String offerApprovalId, String employeeId, int employeeVersion, String property, String newValueExpr,String [] tokensExpr)
			throws Exception{
	...
	*/
	...
	// -----------------------------------// list-of-view 处理 \\-----------------------------------
    protected void enhanceForListOfView(YoubenbenUserContext userContext,SmartList<OfferApproval> list) throws Exception {
  ...
  // -----------------------------------\\ list-of-view 处理 //-----------------------------------v
	 ...
	 * @throws Exception
	 */
 	public Object wxappview(YoubenbenUserContext userContext, String offerApprovalId) throws Exception{
	  SerializeScope vscope = YoubenbenViewScope.getInstance().getOfferApprovalDetailScope().clone();
