...
public class EmployeeWorkExperienceManagerImpl extends CustomYoubenbenCheckerManager implements EmployeeWorkExperienceManager, BusinessHandler{
	...
	@Override
	public EmployeeWorkExperienceDAO daoOf(YoubenbenUserContext userContext) {
	...
	protected void throwExceptionWithMessage(String value) throws EmployeeWorkExperienceManagerException{
 	...
 	protected EmployeeWorkExperience saveEmployeeWorkExperience(YoubenbenUserContext userContext, EmployeeWorkExperience employeeWorkExperience, String [] tokensExpr) throws Exception{	
 	...
 	protected EmployeeWorkExperience saveEmployeeWorkExperienceDetail(YoubenbenUserContext userContext, EmployeeWorkExperience employeeWorkExperience) throws Exception{	
 	...
 	public EmployeeWorkExperience loadEmployeeWorkExperience(YoubenbenUserContext userContext, String employeeWorkExperienceId, String [] tokensExpr) throws Exception{				
 	 ...
 	 public EmployeeWorkExperience searchEmployeeWorkExperience(YoubenbenUserContext userContext, String employeeWorkExperienceId, String textToSearch,String [] tokensExpr) throws Exception{				
 	...
 	protected EmployeeWorkExperience present(YoubenbenUserContext userContext, EmployeeWorkExperience employeeWorkExperience, Map<String, Object> tokens) throws Exception {
 	...
 	public EmployeeWorkExperience loadEmployeeWorkExperienceDetail(YoubenbenUserContext userContext, String employeeWorkExperienceId) throws Exception{	
 	...
 	public Object view(YoubenbenUserContext userContext, String employeeWorkExperienceId) throws Exception{	
 		EmployeeWorkExperience employeeWorkExperience = loadEmployeeWorkExperience( userContext, employeeWorkExperienceId, viewTokens());
 		return present(userContext,employeeWorkExperience, allTokens());
		
 	}
 	protected EmployeeWorkExperience saveEmployeeWorkExperience(YoubenbenUserContext userContext, EmployeeWorkExperience employeeWorkExperience, Map<String,Object>tokens) throws Exception{	
 		return employeeWorkExperienceDaoOf(userContext).save(employeeWorkExperience, tokens);
 	}
 	protected EmployeeWorkExperience loadEmployeeWorkExperience(YoubenbenUserContext userContext, String employeeWorkExperienceId, Map<String,Object>tokens) throws Exception{	
		checkerOf(userContext).checkIdOfEmployeeWorkExperience(employeeWorkExperienceId);
		checkerOf(userContext).throwExceptionIfHasErrors( EmployeeWorkExperienceManagerException.class);
 	...
 	protected<T extends BaseEntity> void addActions(YoubenbenUserContext userContext, EmployeeWorkExperience employeeWorkExperience, Map<String, Object> tokens){
	...
	}// end method of protected<T extends BaseEntity> void addActions(YoubenbenUserContext userContext, EmployeeWorkExperience employeeWorkExperience, Map<String, Object> tokens){
	...
	protected void checkParamsForUpdatingEmployeeWorkExperience(YoubenbenUserContext userContext,String employeeWorkExperienceId, int employeeWorkExperienceVersion, String property, String newValueExpr,String [] tokensExpr)throws Exception
	{
	...
	public EmployeeWorkExperience clone(YoubenbenUserContext userContext, String fromEmployeeWorkExperienceId) throws Exception{
	...
	public EmployeeWorkExperience internalSaveEmployeeWorkExperience(YoubenbenUserContext userContext, EmployeeWorkExperience employeeWorkExperience, Map<String,Object> options) throws Exception
	{
	...
	public EmployeeWorkExperience updateEmployeeWorkExperienceProperty(YoubenbenUserContext userContext,String employeeWorkExperienceId, int employeeWorkExperienceVersion, String property, String newValueExpr,String [] tokensExpr) throws Exception
	{
		checkParamsForUpdatingEmployeeWorkExperience(userContext, employeeWorkExperienceId, employeeWorkExperienceVersion, property, newValueExpr, tokensExpr);
	...
	protected void checkParamsForTransferingAnotherEmployee(YoubenbenUserContext userContext, String employeeWorkExperienceId, String anotherEmployeeId) throws Exception
 	{
 ...
 //--------------------------------------------------------------
	...
	public void delete(YoubenbenUserContext userContext, String employeeWorkExperienceId, int employeeWorkExperienceVersion) throws Exception {
	...
	public EmployeeWorkExperience forgetByAll(YoubenbenUserContext userContext, String employeeWorkExperienceId, int employeeWorkExperienceVersion) throws Exception {
		return forgetByAllInternal(userContext, employeeWorkExperienceId, employeeWorkExperienceVersion);
	}
	protected EmployeeWorkExperience forgetByAllInternal(YoubenbenUserContext userContext,
			String employeeWorkExperienceId, int employeeWorkExperienceVersion) throws Exception{
	...
	// -----------------------------------// list-of-view 处理 \\-----------------------------------
    protected void enhanceForListOfView(YoubenbenUserContext userContext,SmartList<EmployeeWorkExperience> list) throws Exception {
  ...
  // -----------------------------------\\ list-of-view 处理 //-----------------------------------v
	 ...
	 * @throws Exception
	 */
 	public Object wxappview(YoubenbenUserContext userContext, String employeeWorkExperienceId) throws Exception{
	  SerializeScope vscope = YoubenbenViewScope.getInstance().getEmployeeWorkExperienceDetailScope().clone();
