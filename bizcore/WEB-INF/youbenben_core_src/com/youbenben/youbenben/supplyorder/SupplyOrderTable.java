...
public class SupplyOrderTable{
	...
	public static final String []ALL_CLOUMNS = {COLUMN_ID,COLUMN_BUYER,COLUMN_SELLER,COLUMN_TITLE,COLUMN_TOTAL_AMOUNT,COLUMN_CONFIRMATION,COLUMN_APPROVAL,COLUMN_PROCESSING,COLUMN_PICKING,COLUMN_SHIPMENT,COLUMN_DELIVERY,COLUMN_LAST_UPDATE_TIME,COLUMN_VERSION};
	public static final String []NORMAL_CLOUMNS = {COLUMN_BUYER,COLUMN_SELLER,COLUMN_TITLE,COLUMN_TOTAL_AMOUNT,COLUMN_CONFIRMATION,COLUMN_APPROVAL,COLUMN_PROCESSING,COLUMN_PICKING,COLUMN_SHIPMENT,COLUMN_DELIVERY,COLUMN_LAST_UPDATE_TIME};
