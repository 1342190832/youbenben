...
import com.youbenben.youbenben.goods.CandidateGoods;
...
public class GoodsMovementManagerImpl extends CustomYoubenbenCheckerManager implements GoodsMovementManager, BusinessHandler{
	...
	@Override
	public GoodsMovementDAO daoOf(YoubenbenUserContext userContext) {
	...
	protected void throwExceptionWithMessage(String value) throws GoodsMovementManagerException{
 	...
 	protected GoodsMovement saveGoodsMovement(YoubenbenUserContext userContext, GoodsMovement goodsMovement, String [] tokensExpr) throws Exception{	
 	...
 	protected GoodsMovement saveGoodsMovementDetail(YoubenbenUserContext userContext, GoodsMovement goodsMovement) throws Exception{	
 	...
 	public GoodsMovement loadGoodsMovement(YoubenbenUserContext userContext, String goodsMovementId, String [] tokensExpr) throws Exception{				
 	 ...
 	 public GoodsMovement searchGoodsMovement(YoubenbenUserContext userContext, String goodsMovementId, String textToSearch,String [] tokensExpr) throws Exception{				
 	...
 	protected GoodsMovement present(YoubenbenUserContext userContext, GoodsMovement goodsMovement, Map<String, Object> tokens) throws Exception {
 	...
 	public GoodsMovement loadGoodsMovementDetail(YoubenbenUserContext userContext, String goodsMovementId) throws Exception{	
 	...
 	public Object view(YoubenbenUserContext userContext, String goodsMovementId) throws Exception{	
 		GoodsMovement goodsMovement = loadGoodsMovement( userContext, goodsMovementId, viewTokens());
 		return present(userContext,goodsMovement, allTokens());
		
 	}
 	protected GoodsMovement saveGoodsMovement(YoubenbenUserContext userContext, GoodsMovement goodsMovement, Map<String,Object>tokens) throws Exception{	
 		return goodsMovementDaoOf(userContext).save(goodsMovement, tokens);
 	}
 	protected GoodsMovement loadGoodsMovement(YoubenbenUserContext userContext, String goodsMovementId, Map<String,Object>tokens) throws Exception{	
		checkerOf(userContext).checkIdOfGoodsMovement(goodsMovementId);
		checkerOf(userContext).throwExceptionIfHasErrors( GoodsMovementManagerException.class);
 	...
 	protected<T extends BaseEntity> void addActions(YoubenbenUserContext userContext, GoodsMovement goodsMovement, Map<String, Object> tokens){
	...
	}// end method of protected<T extends BaseEntity> void addActions(YoubenbenUserContext userContext, GoodsMovement goodsMovement, Map<String, Object> tokens){
	...
	protected void checkParamsForUpdatingGoodsMovement(YoubenbenUserContext userContext,String goodsMovementId, int goodsMovementVersion, String property, String newValueExpr,String [] tokensExpr)throws Exception
	{
	...
	public GoodsMovement clone(YoubenbenUserContext userContext, String fromGoodsMovementId) throws Exception{
	...
	public GoodsMovement internalSaveGoodsMovement(YoubenbenUserContext userContext, GoodsMovement goodsMovement, Map<String,Object> options) throws Exception
	{
	...
	public GoodsMovement updateGoodsMovementProperty(YoubenbenUserContext userContext,String goodsMovementId, int goodsMovementVersion, String property, String newValueExpr,String [] tokensExpr) throws Exception
	{
		checkParamsForUpdatingGoodsMovement(userContext, goodsMovementId, goodsMovementVersion, property, newValueExpr, tokensExpr);
	...
	protected void checkParamsForTransferingAnotherGoods(YoubenbenUserContext userContext, String goodsMovementId, String anotherGoodsId) throws Exception
 	{
	...
	public CandidateGoods requestCandidateGoods(YoubenbenUserContext userContext, String ownerClass, String id, String filterKey, int pageNo) throws Exception {
 ...
 //--------------------------------------------------------------
 	...
 	protected Goods loadGoods(YoubenbenUserContext userContext, String newGoodsId, Map<String,Object> options) throws Exception
 	{
	...
	public void delete(YoubenbenUserContext userContext, String goodsMovementId, int goodsMovementVersion) throws Exception {
	...
	public GoodsMovement forgetByAll(YoubenbenUserContext userContext, String goodsMovementId, int goodsMovementVersion) throws Exception {
		return forgetByAllInternal(userContext, goodsMovementId, goodsMovementVersion);
	}
	protected GoodsMovement forgetByAllInternal(YoubenbenUserContext userContext,
			String goodsMovementId, int goodsMovementVersion) throws Exception{
	...
	// -----------------------------------// list-of-view 处理 \\-----------------------------------
    protected void enhanceForListOfView(YoubenbenUserContext userContext,SmartList<GoodsMovement> list) throws Exception {
    	if (list == null || list.isEmpty()){
    		return;
    	}
		List<Goods> goodsList = YoubenbenBaseUtils.collectReferencedObjectWithType(userContext, list, Goods.class);
  ...
  // -----------------------------------\\ list-of-view 处理 //-----------------------------------v
	 ...
	 * @throws Exception
	 */
 	public Object wxappview(YoubenbenUserContext userContext, String goodsMovementId) throws Exception{
	  SerializeScope vscope = YoubenbenViewScope.getInstance().getGoodsMovementDetailScope().clone();
