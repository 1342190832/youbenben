...
public class RetailStoreCreationManagerImpl extends CustomYoubenbenCheckerManager implements RetailStoreCreationManager, BusinessHandler{
	...
	@Override
	public RetailStoreCreationDAO daoOf(YoubenbenUserContext userContext) {
	...
	protected void throwExceptionWithMessage(String value) throws RetailStoreCreationManagerException{
 	...
 	protected RetailStoreCreation saveRetailStoreCreation(YoubenbenUserContext userContext, RetailStoreCreation retailStoreCreation, String [] tokensExpr) throws Exception{	
 	...
 	protected RetailStoreCreation saveRetailStoreCreationDetail(YoubenbenUserContext userContext, RetailStoreCreation retailStoreCreation) throws Exception{	
 	...
 	public RetailStoreCreation loadRetailStoreCreation(YoubenbenUserContext userContext, String retailStoreCreationId, String [] tokensExpr) throws Exception{				
 	 ...
 	 public RetailStoreCreation searchRetailStoreCreation(YoubenbenUserContext userContext, String retailStoreCreationId, String textToSearch,String [] tokensExpr) throws Exception{				
 	...
 	protected RetailStoreCreation present(YoubenbenUserContext userContext, RetailStoreCreation retailStoreCreation, Map<String, Object> tokens) throws Exception {
 	...
 	public RetailStoreCreation loadRetailStoreCreationDetail(YoubenbenUserContext userContext, String retailStoreCreationId) throws Exception{	
 	...
 	public Object view(YoubenbenUserContext userContext, String retailStoreCreationId) throws Exception{	
 		RetailStoreCreation retailStoreCreation = loadRetailStoreCreation( userContext, retailStoreCreationId, viewTokens());
 		return present(userContext,retailStoreCreation, allTokens());
		
 	}
 	protected RetailStoreCreation saveRetailStoreCreation(YoubenbenUserContext userContext, RetailStoreCreation retailStoreCreation, Map<String,Object>tokens) throws Exception{	
 		return retailStoreCreationDaoOf(userContext).save(retailStoreCreation, tokens);
 	}
 	protected RetailStoreCreation loadRetailStoreCreation(YoubenbenUserContext userContext, String retailStoreCreationId, Map<String,Object>tokens) throws Exception{	
		checkerOf(userContext).checkIdOfRetailStoreCreation(retailStoreCreationId);
		checkerOf(userContext).throwExceptionIfHasErrors( RetailStoreCreationManagerException.class);
 	...
 	protected<T extends BaseEntity> void addActions(YoubenbenUserContext userContext, RetailStoreCreation retailStoreCreation, Map<String, Object> tokens){
	...
	}// end method of protected<T extends BaseEntity> void addActions(YoubenbenUserContext userContext, RetailStoreCreation retailStoreCreation, Map<String, Object> tokens){
	...
	protected void checkParamsForUpdatingRetailStoreCreation(YoubenbenUserContext userContext,String retailStoreCreationId, int retailStoreCreationVersion, String property, String newValueExpr,String [] tokensExpr)throws Exception
	{
	...
	public RetailStoreCreation clone(YoubenbenUserContext userContext, String fromRetailStoreCreationId) throws Exception{
	...
	public RetailStoreCreation internalSaveRetailStoreCreation(YoubenbenUserContext userContext, RetailStoreCreation retailStoreCreation, Map<String,Object> options) throws Exception
	{
	...
	public RetailStoreCreation updateRetailStoreCreationProperty(YoubenbenUserContext userContext,String retailStoreCreationId, int retailStoreCreationVersion, String property, String newValueExpr,String [] tokensExpr) throws Exception
	{
		checkParamsForUpdatingRetailStoreCreation(userContext, retailStoreCreationId, retailStoreCreationVersion, property, newValueExpr, tokensExpr);
...
//--------------------------------------------------------------
	...
	public void delete(YoubenbenUserContext userContext, String retailStoreCreationId, int retailStoreCreationVersion) throws Exception {
	...
	public RetailStoreCreation forgetByAll(YoubenbenUserContext userContext, String retailStoreCreationId, int retailStoreCreationVersion) throws Exception {
		return forgetByAllInternal(userContext, retailStoreCreationId, retailStoreCreationVersion);
	}
	protected RetailStoreCreation forgetByAllInternal(YoubenbenUserContext userContext,
			String retailStoreCreationId, int retailStoreCreationVersion) throws Exception{
	...
	protected RetailStoreCreation breakWithRetailStoreByRetailStoreCountryCenter(YoubenbenUserContext userContext, String retailStoreCreationId, String retailStoreCountryCenterId,  String [] tokensExpr)
		 throws Exception{
	...
	protected RetailStoreCreation breakWithRetailStoreByCityServiceCenter(YoubenbenUserContext userContext, String retailStoreCreationId, String cityServiceCenterId,  String [] tokensExpr)
		 throws Exception{
	...
	protected RetailStoreCreation breakWithRetailStoreByInvestmentInvitation(YoubenbenUserContext userContext, String retailStoreCreationId, String investmentInvitationId,  String [] tokensExpr)
		 throws Exception{
	...
	protected RetailStoreCreation breakWithRetailStoreByFranchising(YoubenbenUserContext userContext, String retailStoreCreationId, String franchisingId,  String [] tokensExpr)
		 throws Exception{
	...
	protected RetailStoreCreation breakWithRetailStoreByDecoration(YoubenbenUserContext userContext, String retailStoreCreationId, String decorationId,  String [] tokensExpr)
		 throws Exception{
	...
	protected RetailStoreCreation breakWithRetailStoreByOpening(YoubenbenUserContext userContext, String retailStoreCreationId, String openingId,  String [] tokensExpr)
		 throws Exception{
	...
	protected RetailStoreCreation breakWithRetailStoreByClosing(YoubenbenUserContext userContext, String retailStoreCreationId, String closingId,  String [] tokensExpr)
		 throws Exception{
	...
	protected void checkParamsForUpdatingRetailStoreProperties(YoubenbenUserContext userContext, String retailStoreCreationId,String id,String name,String telephone,String owner,Date founded,BigDecimal latitude,BigDecimal longitude,String description,String [] tokensExpr) throws Exception {
	...
	public  RetailStoreCreation updateRetailStoreProperties(YoubenbenUserContext userContext, String retailStoreCreationId, String id,String name,String telephone,String owner,Date founded,BigDecimal latitude,BigDecimal longitude,String description, String [] tokensExpr) throws Exception
	{
	...
	protected RetailStore createRetailStore(YoubenbenUserContext userContext, String name, String telephone, String owner, String retailStoreCountryCenterId, String cityServiceCenterId, String investmentInvitationId, String franchisingId, String decorationId, String openingId, String closingId, Date founded, BigDecimal latitude, BigDecimal longitude, String description) throws Exception{
	...
	protected void checkParamsForRemovingRetailStoreList(YoubenbenUserContext userContext, String retailStoreCreationId,
	...
	public  RetailStoreCreation removeRetailStoreList(YoubenbenUserContext userContext, String retailStoreCreationId,
			String retailStoreIds[],String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForRemovingRetailStore(YoubenbenUserContext userContext, String retailStoreCreationId,
	...
	public  RetailStoreCreation removeRetailStore(YoubenbenUserContext userContext, String retailStoreCreationId,
		String retailStoreId, int retailStoreVersion,String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForCopyingRetailStore(YoubenbenUserContext userContext, String retailStoreCreationId,
		String retailStoreId, int retailStoreVersion,String [] tokensExpr) throws Exception{
	...
	public  RetailStoreCreation copyRetailStoreFrom(YoubenbenUserContext userContext, String retailStoreCreationId,
		String retailStoreId, int retailStoreVersion,String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForUpdatingRetailStore(YoubenbenUserContext userContext, String retailStoreCreationId, String retailStoreId, int retailStoreVersion, String property, String newValueExpr,String [] tokensExpr) throws Exception{
	...
	public  RetailStoreCreation updateRetailStore(YoubenbenUserContext userContext, String retailStoreCreationId, String retailStoreId, int retailStoreVersion, String property, String newValueExpr,String [] tokensExpr)
			throws Exception{
	...
	*/
	...
	// -----------------------------------// list-of-view 处理 \\-----------------------------------
    protected void enhanceForListOfView(YoubenbenUserContext userContext,SmartList<RetailStoreCreation> list) throws Exception {
  ...
  // -----------------------------------\\ list-of-view 处理 //-----------------------------------v
	 ...
	 * @throws Exception
	 */
 	public Object wxappview(YoubenbenUserContext userContext, String retailStoreCreationId) throws Exception{
	  SerializeScope vscope = YoubenbenViewScope.getInstance().getRetailStoreCreationDetailScope().clone();
