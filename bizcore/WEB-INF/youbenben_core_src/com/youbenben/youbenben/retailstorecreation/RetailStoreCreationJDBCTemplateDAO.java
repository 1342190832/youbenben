...
public class RetailStoreCreationJDBCTemplateDAO extends YoubenbenBaseDAOImpl implements RetailStoreCreationDAO{
	...
	*/
    ...
    public SmartList<RetailStoreCreation> requestCandidateRetailStoreCreationForRetailStore(YoubenbenUserContext userContext, String ownerClass, String id, String filterKey, int pageNo, int pageSize) throws Exception {
	...
	public SmartList<RetailStore> loadOurRetailStoreList(YoubenbenUserContext userContext, List<RetailStoreCreation> us, Map<String,Object> options) throws Exception{
