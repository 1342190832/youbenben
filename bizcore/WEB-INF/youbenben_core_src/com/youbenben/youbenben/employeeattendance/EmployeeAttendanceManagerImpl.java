...
public class EmployeeAttendanceManagerImpl extends CustomYoubenbenCheckerManager implements EmployeeAttendanceManager, BusinessHandler{
	...
	@Override
	public EmployeeAttendanceDAO daoOf(YoubenbenUserContext userContext) {
	...
	protected void throwExceptionWithMessage(String value) throws EmployeeAttendanceManagerException{
 	...
 	protected EmployeeAttendance saveEmployeeAttendance(YoubenbenUserContext userContext, EmployeeAttendance employeeAttendance, String [] tokensExpr) throws Exception{	
 	...
 	protected EmployeeAttendance saveEmployeeAttendanceDetail(YoubenbenUserContext userContext, EmployeeAttendance employeeAttendance) throws Exception{	
 	...
 	public EmployeeAttendance loadEmployeeAttendance(YoubenbenUserContext userContext, String employeeAttendanceId, String [] tokensExpr) throws Exception{				
 	 ...
 	 public EmployeeAttendance searchEmployeeAttendance(YoubenbenUserContext userContext, String employeeAttendanceId, String textToSearch,String [] tokensExpr) throws Exception{				
 	...
 	protected EmployeeAttendance present(YoubenbenUserContext userContext, EmployeeAttendance employeeAttendance, Map<String, Object> tokens) throws Exception {
 	...
 	public EmployeeAttendance loadEmployeeAttendanceDetail(YoubenbenUserContext userContext, String employeeAttendanceId) throws Exception{	
 	...
 	public Object view(YoubenbenUserContext userContext, String employeeAttendanceId) throws Exception{	
 		EmployeeAttendance employeeAttendance = loadEmployeeAttendance( userContext, employeeAttendanceId, viewTokens());
 		return present(userContext,employeeAttendance, allTokens());
		
 	}
 	protected EmployeeAttendance saveEmployeeAttendance(YoubenbenUserContext userContext, EmployeeAttendance employeeAttendance, Map<String,Object>tokens) throws Exception{	
 		return employeeAttendanceDaoOf(userContext).save(employeeAttendance, tokens);
 	}
 	protected EmployeeAttendance loadEmployeeAttendance(YoubenbenUserContext userContext, String employeeAttendanceId, Map<String,Object>tokens) throws Exception{	
		checkerOf(userContext).checkIdOfEmployeeAttendance(employeeAttendanceId);
		checkerOf(userContext).throwExceptionIfHasErrors( EmployeeAttendanceManagerException.class);
 	...
 	protected<T extends BaseEntity> void addActions(YoubenbenUserContext userContext, EmployeeAttendance employeeAttendance, Map<String, Object> tokens){
	...
	}// end method of protected<T extends BaseEntity> void addActions(YoubenbenUserContext userContext, EmployeeAttendance employeeAttendance, Map<String, Object> tokens){
	...
	protected void checkParamsForUpdatingEmployeeAttendance(YoubenbenUserContext userContext,String employeeAttendanceId, int employeeAttendanceVersion, String property, String newValueExpr,String [] tokensExpr)throws Exception
	{
	...
	public EmployeeAttendance clone(YoubenbenUserContext userContext, String fromEmployeeAttendanceId) throws Exception{
	...
	public EmployeeAttendance internalSaveEmployeeAttendance(YoubenbenUserContext userContext, EmployeeAttendance employeeAttendance, Map<String,Object> options) throws Exception
	{
	...
	public EmployeeAttendance updateEmployeeAttendanceProperty(YoubenbenUserContext userContext,String employeeAttendanceId, int employeeAttendanceVersion, String property, String newValueExpr,String [] tokensExpr) throws Exception
	{
		checkParamsForUpdatingEmployeeAttendance(userContext, employeeAttendanceId, employeeAttendanceVersion, property, newValueExpr, tokensExpr);
	...
	protected void checkParamsForTransferingAnotherEmployee(YoubenbenUserContext userContext, String employeeAttendanceId, String anotherEmployeeId) throws Exception
 	{
 ...
 //--------------------------------------------------------------
	...
	public void delete(YoubenbenUserContext userContext, String employeeAttendanceId, int employeeAttendanceVersion) throws Exception {
	...
	public EmployeeAttendance forgetByAll(YoubenbenUserContext userContext, String employeeAttendanceId, int employeeAttendanceVersion) throws Exception {
		return forgetByAllInternal(userContext, employeeAttendanceId, employeeAttendanceVersion);
	}
	protected EmployeeAttendance forgetByAllInternal(YoubenbenUserContext userContext,
			String employeeAttendanceId, int employeeAttendanceVersion) throws Exception{
	...
	// -----------------------------------// list-of-view 处理 \\-----------------------------------
    protected void enhanceForListOfView(YoubenbenUserContext userContext,SmartList<EmployeeAttendance> list) throws Exception {
  ...
  // -----------------------------------\\ list-of-view 处理 //-----------------------------------v
	 ...
	 * @throws Exception
	 */
 	public Object wxappview(YoubenbenUserContext userContext, String employeeAttendanceId) throws Exception{
	  SerializeScope vscope = YoubenbenViewScope.getInstance().getEmployeeAttendanceDetailScope().clone();
