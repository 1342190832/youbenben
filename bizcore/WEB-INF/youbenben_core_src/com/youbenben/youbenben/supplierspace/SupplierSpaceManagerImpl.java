...
public class SupplierSpaceManagerImpl extends CustomYoubenbenCheckerManager implements SupplierSpaceManager, BusinessHandler{
	...
	@Override
	public SupplierSpaceDAO daoOf(YoubenbenUserContext userContext) {
	...
	protected void throwExceptionWithMessage(String value) throws SupplierSpaceManagerException{
 	...
 	protected SupplierSpace saveSupplierSpace(YoubenbenUserContext userContext, SupplierSpace supplierSpace, String [] tokensExpr) throws Exception{	
 	...
 	protected SupplierSpace saveSupplierSpaceDetail(YoubenbenUserContext userContext, SupplierSpace supplierSpace) throws Exception{	
 	...
 	public SupplierSpace loadSupplierSpace(YoubenbenUserContext userContext, String supplierSpaceId, String [] tokensExpr) throws Exception{				
 	 ...
 	 public SupplierSpace searchSupplierSpace(YoubenbenUserContext userContext, String supplierSpaceId, String textToSearch,String [] tokensExpr) throws Exception{				
 	...
 	protected SupplierSpace present(YoubenbenUserContext userContext, SupplierSpace supplierSpace, Map<String, Object> tokens) throws Exception {
 	...
 	public SupplierSpace loadSupplierSpaceDetail(YoubenbenUserContext userContext, String supplierSpaceId) throws Exception{	
 	...
 	public Object view(YoubenbenUserContext userContext, String supplierSpaceId) throws Exception{	
 		SupplierSpace supplierSpace = loadSupplierSpace( userContext, supplierSpaceId, viewTokens());
 		return present(userContext,supplierSpace, allTokens());
		
 	}
 	protected SupplierSpace saveSupplierSpace(YoubenbenUserContext userContext, SupplierSpace supplierSpace, Map<String,Object>tokens) throws Exception{	
 		return supplierSpaceDaoOf(userContext).save(supplierSpace, tokens);
 	}
 	protected SupplierSpace loadSupplierSpace(YoubenbenUserContext userContext, String supplierSpaceId, Map<String,Object>tokens) throws Exception{	
		checkerOf(userContext).checkIdOfSupplierSpace(supplierSpaceId);
		checkerOf(userContext).throwExceptionIfHasErrors( SupplierSpaceManagerException.class);
 	...
 	protected<T extends BaseEntity> void addActions(YoubenbenUserContext userContext, SupplierSpace supplierSpace, Map<String, Object> tokens){
	...
	}// end method of protected<T extends BaseEntity> void addActions(YoubenbenUserContext userContext, SupplierSpace supplierSpace, Map<String, Object> tokens){
	...
	protected void checkParamsForUpdatingSupplierSpace(YoubenbenUserContext userContext,String supplierSpaceId, int supplierSpaceVersion, String property, String newValueExpr,String [] tokensExpr)throws Exception
	{
	...
	public SupplierSpace clone(YoubenbenUserContext userContext, String fromSupplierSpaceId) throws Exception{
	...
	public SupplierSpace internalSaveSupplierSpace(YoubenbenUserContext userContext, SupplierSpace supplierSpace, Map<String,Object> options) throws Exception
	{
	...
	public SupplierSpace updateSupplierSpaceProperty(YoubenbenUserContext userContext,String supplierSpaceId, int supplierSpaceVersion, String property, String newValueExpr,String [] tokensExpr) throws Exception
	{
		checkParamsForUpdatingSupplierSpace(userContext, supplierSpaceId, supplierSpaceVersion, property, newValueExpr, tokensExpr);
	...
	protected void checkParamsForTransferingAnotherWarehouse(YoubenbenUserContext userContext, String supplierSpaceId, String anotherWarehouseId) throws Exception
 	{
 ...
 //--------------------------------------------------------------
	...
	public void delete(YoubenbenUserContext userContext, String supplierSpaceId, int supplierSpaceVersion) throws Exception {
	...
	public SupplierSpace forgetByAll(YoubenbenUserContext userContext, String supplierSpaceId, int supplierSpaceVersion) throws Exception {
		return forgetByAllInternal(userContext, supplierSpaceId, supplierSpaceVersion);
	}
	protected SupplierSpace forgetByAllInternal(YoubenbenUserContext userContext,
			String supplierSpaceId, int supplierSpaceVersion) throws Exception{
	...
	protected SupplierSpace breakWithGoodsShelfByStorageSpace(YoubenbenUserContext userContext, String supplierSpaceId, String storageSpaceId,  String [] tokensExpr)
		 throws Exception{
	...
	protected SupplierSpace breakWithGoodsShelfByDamageSpace(YoubenbenUserContext userContext, String supplierSpaceId, String damageSpaceId,  String [] tokensExpr)
		 throws Exception{
	...
	protected void checkParamsForAddingGoodsShelf(YoubenbenUserContext userContext, String supplierSpaceId, String location, String storageSpaceId, String damageSpaceId,String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForUpdatingGoodsShelfProperties(YoubenbenUserContext userContext, String supplierSpaceId,String id,String location,String [] tokensExpr) throws Exception {
	...
	public  SupplierSpace updateGoodsShelfProperties(YoubenbenUserContext userContext, String supplierSpaceId, String id,String location, String [] tokensExpr) throws Exception
	{
	...
	protected GoodsShelf createGoodsShelf(YoubenbenUserContext userContext, String location, String storageSpaceId, String damageSpaceId) throws Exception{
	...
	protected void checkParamsForRemovingGoodsShelfList(YoubenbenUserContext userContext, String supplierSpaceId,
	...
	public  SupplierSpace removeGoodsShelfList(YoubenbenUserContext userContext, String supplierSpaceId,
			String goodsShelfIds[],String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForRemovingGoodsShelf(YoubenbenUserContext userContext, String supplierSpaceId,
	...
	public  SupplierSpace removeGoodsShelf(YoubenbenUserContext userContext, String supplierSpaceId,
		String goodsShelfId, int goodsShelfVersion,String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForCopyingGoodsShelf(YoubenbenUserContext userContext, String supplierSpaceId,
		String goodsShelfId, int goodsShelfVersion,String [] tokensExpr) throws Exception{
	...
	public  SupplierSpace copyGoodsShelfFrom(YoubenbenUserContext userContext, String supplierSpaceId,
		String goodsShelfId, int goodsShelfVersion,String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForUpdatingGoodsShelf(YoubenbenUserContext userContext, String supplierSpaceId, String goodsShelfId, int goodsShelfVersion, String property, String newValueExpr,String [] tokensExpr) throws Exception{
	...
	public  SupplierSpace updateGoodsShelf(YoubenbenUserContext userContext, String supplierSpaceId, String goodsShelfId, int goodsShelfVersion, String property, String newValueExpr,String [] tokensExpr)
			throws Exception{
	...
	*/
	...
	// -----------------------------------// list-of-view 处理 \\-----------------------------------
    protected void enhanceForListOfView(YoubenbenUserContext userContext,SmartList<SupplierSpace> list) throws Exception {
  ...
  // -----------------------------------\\ list-of-view 处理 //-----------------------------------v
	 ...
	 * @throws Exception
	 */
 	public Object wxappview(YoubenbenUserContext userContext, String supplierSpaceId) throws Exception{
	  SerializeScope vscope = YoubenbenViewScope.getInstance().getSupplierSpaceDetailScope().clone();
