...
public class SupplierSpaceJDBCTemplateDAO extends YoubenbenBaseDAOImpl implements SupplierSpaceDAO{
	...
	*/
    ...
    public SmartList<SupplierSpace> requestCandidateSupplierSpaceForGoodsShelf(YoubenbenUserContext userContext, String ownerClass, String id, String filterKey, int pageNo, int pageSize) throws Exception {
	...
	public SmartList<GoodsShelf> loadOurGoodsShelfList(YoubenbenUserContext userContext, List<SupplierSpace> us, Map<String,Object> options) throws Exception{
