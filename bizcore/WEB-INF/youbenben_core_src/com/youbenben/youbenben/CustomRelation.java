...
public class CustomRelation extends BaseRelation{
	...
	protected void prepareRelation()
	{
		...
		//replaceGenericRelation("ConsumerOrder"                         , BaseRelation.TRUST_CHAIN_ALL, "confirmation");
		//replaceGenericRelation("ConsumerOrder"                         , BaseRelation.TRUST_CHAIN_ALL, "approval");
		//replaceGenericRelation("ConsumerOrder"                         , BaseRelation.TRUST_CHAIN_ALL, "processing");
		//replaceGenericRelation("ConsumerOrder"                         , BaseRelation.TRUST_CHAIN_ALL, "shipment");
		//replaceGenericRelation("ConsumerOrder"                         , BaseRelation.TRUST_CHAIN_ALL, "delivery");
		...
		//replaceGenericRelation("SupplyOrder"                           , BaseRelation.TRUST_CHAIN_ALL, "confirmation");
		//replaceGenericRelation("SupplyOrder"                           , BaseRelation.TRUST_CHAIN_ALL, "approval");
		//replaceGenericRelation("SupplyOrder"                           , BaseRelation.TRUST_CHAIN_ALL, "processing");
		//replaceGenericRelation("SupplyOrder"                           , BaseRelation.TRUST_CHAIN_ALL, "picking");
		//replaceGenericRelation("SupplyOrder"                           , BaseRelation.TRUST_CHAIN_ALL, "shipment");
		//replaceGenericRelation("SupplyOrder"                           , BaseRelation.TRUST_CHAIN_ALL, "delivery");
		...
		//replaceGenericRelation("RetailStoreOrder"                      , BaseRelation.TRUST_CHAIN_ALL, "confirmation");
		//replaceGenericRelation("RetailStoreOrder"                      , BaseRelation.TRUST_CHAIN_ALL, "approval");
		//replaceGenericRelation("RetailStoreOrder"                      , BaseRelation.TRUST_CHAIN_ALL, "processing");
		//replaceGenericRelation("RetailStoreOrder"                      , BaseRelation.TRUST_CHAIN_ALL, "picking");
		//replaceGenericRelation("RetailStoreOrder"                      , BaseRelation.TRUST_CHAIN_ALL, "shipment");
		//replaceGenericRelation("RetailStoreOrder"                      , BaseRelation.TRUST_CHAIN_ALL, "delivery");
		...
		//replaceGenericRelation("Goods"                                 , BaseRelation.TRUST_CHAIN_ALL, "packaging");
		...
		//replaceGenericRelation("AccountingDocument"                    , BaseRelation.TRUST_CHAIN_ALL, "creation");
		//replaceGenericRelation("AccountingDocument"                    , BaseRelation.TRUST_CHAIN_ALL, "confirmation");
		//replaceGenericRelation("AccountingDocument"                    , BaseRelation.TRUST_CHAIN_ALL, "auditing");
		//replaceGenericRelation("AccountingDocument"                    , BaseRelation.TRUST_CHAIN_ALL, "posting");
		//replaceGenericRelation("OriginalVoucher"                       , BaseRelation.TRUST_CHAIN_ALL, "belongsTo");
		//replaceGenericRelation("OriginalVoucher"                       , BaseRelation.TRUST_CHAIN_ALL, "creation");
		//replaceGenericRelation("OriginalVoucher"                       , BaseRelation.TRUST_CHAIN_ALL, "confirmation");
		//replaceGenericRelation("OriginalVoucher"                       , BaseRelation.TRUST_CHAIN_ALL, "auditing");
		...
		//replaceGenericRelation("Employee"                              , BaseRelation.TRUST_CHAIN_ALL, "jobApplication");
		//replaceGenericRelation("Employee"                              , BaseRelation.TRUST_CHAIN_ALL, "professionInterview");
		//replaceGenericRelation("Employee"                              , BaseRelation.TRUST_CHAIN_ALL, "hrInterview");
		//replaceGenericRelation("Employee"                              , BaseRelation.TRUST_CHAIN_ALL, "offerApproval");
		//replaceGenericRelation("Employee"                              , BaseRelation.TRUST_CHAIN_ALL, "offerAcceptance");
		//replaceGenericRelation("Employee"                              , BaseRelation.TRUST_CHAIN_ALL, "employeeBoarding");
		//replaceGenericRelation("Employee"                              , BaseRelation.TRUST_CHAIN_ALL, "termination");
