...
public class RetailStoreOpeningJDBCTemplateDAO extends YoubenbenBaseDAOImpl implements RetailStoreOpeningDAO{
	...
	*/
    ...
    public SmartList<RetailStoreOpening> requestCandidateRetailStoreOpeningForRetailStore(YoubenbenUserContext userContext, String ownerClass, String id, String filterKey, int pageNo, int pageSize) throws Exception {
	...
	public SmartList<RetailStore> loadOurRetailStoreList(YoubenbenUserContext userContext, List<RetailStoreOpening> us, Map<String,Object> options) throws Exception{
