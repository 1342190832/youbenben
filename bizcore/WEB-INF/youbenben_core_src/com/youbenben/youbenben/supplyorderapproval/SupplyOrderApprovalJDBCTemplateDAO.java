...
public class SupplyOrderApprovalJDBCTemplateDAO extends YoubenbenBaseDAOImpl implements SupplyOrderApprovalDAO{
	...
	*/
	...
	public SmartList<SupplyOrderApproval> loadAll() {
	    return this.loadAll(getSupplyOrderApprovalMapper());
	}
    ...
    public SmartList<SupplyOrderApproval> requestCandidateSupplyOrderApprovalForConsumerOrder(YoubenbenUserContext userContext, String ownerClass, String id, String filterKey, int pageNo, int pageSize) throws Exception {
		...
		return findAllCandidateByFilter(SupplyOrderApprovalTable.COLUMN_WHO, null, filterKey, pageNo, pageSize, getSupplyOrderApprovalMapper());
    }
