...
public class SupplyOrderApprovalGridViewGenerator extends BaseGridViewGenerator{
	...
	protected void throwExceptionIfListNotFount(String listName) {
		String message=String.format("List '%s' is not found for SupplyOrderApproval", listName);
		throw new IllegalArgumentException(message);
	}
	
	protected String [] getHeaderKeys(String listName) {
		
		if(SupplyOrderApproval.CONSUMER_ORDER_LIST.equals(listName)){
			return new String[]{"id","title","consumer","confirmation","approval","processing","shipment","delivery","store","last_update_time","version"};
		}
		if(SupplyOrderApproval.SUPPLY_ORDER_LIST.equals(listName)){
