...
public class LeaveTypeManagerImpl extends CustomYoubenbenCheckerManager implements LeaveTypeManager, BusinessHandler{
	...
	@Override
	public LeaveTypeDAO daoOf(YoubenbenUserContext userContext) {
	...
	protected void throwExceptionWithMessage(String value) throws LeaveTypeManagerException{
 	...
 	protected LeaveType saveLeaveType(YoubenbenUserContext userContext, LeaveType leaveType, String [] tokensExpr) throws Exception{	
 	...
 	protected LeaveType saveLeaveTypeDetail(YoubenbenUserContext userContext, LeaveType leaveType) throws Exception{	
 	...
 	public LeaveType loadLeaveType(YoubenbenUserContext userContext, String leaveTypeId, String [] tokensExpr) throws Exception{				
 	 ...
 	 public LeaveType searchLeaveType(YoubenbenUserContext userContext, String leaveTypeId, String textToSearch,String [] tokensExpr) throws Exception{				
 	...
 	protected LeaveType present(YoubenbenUserContext userContext, LeaveType leaveType, Map<String, Object> tokens) throws Exception {
 	...
 	public LeaveType loadLeaveTypeDetail(YoubenbenUserContext userContext, String leaveTypeId) throws Exception{	
 		LeaveType leaveType = loadLeaveType( userContext, leaveTypeId, allTokens());
 		return present(userContext,leaveType, allTokens());
		
 	}
 	
 	public Object view(YoubenbenUserContext userContext, String leaveTypeId) throws Exception{	
 		LeaveType leaveType = loadLeaveType( userContext, leaveTypeId, viewTokens());
 		return present(userContext,leaveType, allTokens());
		
 	}
 	protected LeaveType saveLeaveType(YoubenbenUserContext userContext, LeaveType leaveType, Map<String,Object>tokens) throws Exception{	
 		return leaveTypeDaoOf(userContext).save(leaveType, tokens);
 	}
 	protected LeaveType loadLeaveType(YoubenbenUserContext userContext, String leaveTypeId, Map<String,Object>tokens) throws Exception{	
		checkerOf(userContext).checkIdOfLeaveType(leaveTypeId);
		checkerOf(userContext).throwExceptionIfHasErrors( LeaveTypeManagerException.class);
 	...
 	protected<T extends BaseEntity> void addActions(YoubenbenUserContext userContext, LeaveType leaveType, Map<String, Object> tokens){
	...
	}// end method of protected<T extends BaseEntity> void addActions(YoubenbenUserContext userContext, LeaveType leaveType, Map<String, Object> tokens){
	...
	protected void checkParamsForUpdatingLeaveType(YoubenbenUserContext userContext,String leaveTypeId, int leaveTypeVersion, String property, String newValueExpr,String [] tokensExpr)throws Exception
	{
	...
	public LeaveType clone(YoubenbenUserContext userContext, String fromLeaveTypeId) throws Exception{
	...
	public LeaveType internalSaveLeaveType(YoubenbenUserContext userContext, LeaveType leaveType, Map<String,Object> options) throws Exception
	{
	...
	public LeaveType updateLeaveTypeProperty(YoubenbenUserContext userContext,String leaveTypeId, int leaveTypeVersion, String property, String newValueExpr,String [] tokensExpr) throws Exception
	{
		checkParamsForUpdatingLeaveType(userContext, leaveTypeId, leaveTypeVersion, property, newValueExpr, tokensExpr);
	...
	protected void checkParamsForTransferingAnotherCompany(YoubenbenUserContext userContext, String leaveTypeId, String anotherCompanyId) throws Exception
 	{
 ...
 //--------------------------------------------------------------
	...
	public void delete(YoubenbenUserContext userContext, String leaveTypeId, int leaveTypeVersion) throws Exception {
	...
	public LeaveType forgetByAll(YoubenbenUserContext userContext, String leaveTypeId, int leaveTypeVersion) throws Exception {
		return forgetByAllInternal(userContext, leaveTypeId, leaveTypeVersion);
	}
	protected LeaveType forgetByAllInternal(YoubenbenUserContext userContext,
			String leaveTypeId, int leaveTypeVersion) throws Exception{
	...
	protected LeaveType breakWithEmployeeLeaveByWho(YoubenbenUserContext userContext, String leaveTypeId, String whoId,  String [] tokensExpr)
		 throws Exception{
	...
	protected void checkParamsForAddingEmployeeLeave(YoubenbenUserContext userContext, String leaveTypeId, String whoId, int leaveDurationHour, String remark,String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForUpdatingEmployeeLeaveProperties(YoubenbenUserContext userContext, String leaveTypeId,String id,int leaveDurationHour,String remark,String [] tokensExpr) throws Exception {
	...
	public  LeaveType updateEmployeeLeaveProperties(YoubenbenUserContext userContext, String leaveTypeId, String id,int leaveDurationHour,String remark, String [] tokensExpr) throws Exception
	{
	...
	protected EmployeeLeave createEmployeeLeave(YoubenbenUserContext userContext, String whoId, int leaveDurationHour, String remark) throws Exception{
	...
	protected void checkParamsForRemovingEmployeeLeaveList(YoubenbenUserContext userContext, String leaveTypeId,
	...
	public  LeaveType removeEmployeeLeaveList(YoubenbenUserContext userContext, String leaveTypeId,
			String employeeLeaveIds[],String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForRemovingEmployeeLeave(YoubenbenUserContext userContext, String leaveTypeId,
	...
	public  LeaveType removeEmployeeLeave(YoubenbenUserContext userContext, String leaveTypeId,
		String employeeLeaveId, int employeeLeaveVersion,String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForCopyingEmployeeLeave(YoubenbenUserContext userContext, String leaveTypeId,
		String employeeLeaveId, int employeeLeaveVersion,String [] tokensExpr) throws Exception{
	...
	public  LeaveType copyEmployeeLeaveFrom(YoubenbenUserContext userContext, String leaveTypeId,
		String employeeLeaveId, int employeeLeaveVersion,String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForUpdatingEmployeeLeave(YoubenbenUserContext userContext, String leaveTypeId, String employeeLeaveId, int employeeLeaveVersion, String property, String newValueExpr,String [] tokensExpr) throws Exception{
	...
	public  LeaveType updateEmployeeLeave(YoubenbenUserContext userContext, String leaveTypeId, String employeeLeaveId, int employeeLeaveVersion, String property, String newValueExpr,String [] tokensExpr)
			throws Exception{
	...
	*/
	...
	// -----------------------------------// list-of-view 处理 \\-----------------------------------
    protected void enhanceForListOfView(YoubenbenUserContext userContext,SmartList<LeaveType> list) throws Exception {
  ...
  // -----------------------------------\\ list-of-view 处理 //-----------------------------------v
	 ...
	 * @throws Exception
	 */
 	public Object wxappview(YoubenbenUserContext userContext, String leaveTypeId) throws Exception{
	  SerializeScope vscope = YoubenbenViewScope.getInstance().getLeaveTypeDetailScope().clone();
