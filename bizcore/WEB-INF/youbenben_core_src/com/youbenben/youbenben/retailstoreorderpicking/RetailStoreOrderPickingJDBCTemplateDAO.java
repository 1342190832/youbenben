...
public class RetailStoreOrderPickingJDBCTemplateDAO extends YoubenbenBaseDAOImpl implements RetailStoreOrderPickingDAO{
	...
	*/
	...
	public SmartList<RetailStoreOrderPicking> loadAll() {
	    return this.loadAll(getRetailStoreOrderPickingMapper());
	}
    ...
    public SmartList<RetailStoreOrderPicking> requestCandidateRetailStoreOrderPickingForRetailStoreOrder(YoubenbenUserContext userContext, String ownerClass, String id, String filterKey, int pageNo, int pageSize) throws Exception {
		...
		return findAllCandidateByFilter(RetailStoreOrderPickingTable.COLUMN_WHO, null, filterKey, pageNo, pageSize, getRetailStoreOrderPickingMapper());
    }
