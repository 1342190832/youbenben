...
public class RetailStoreOrderPickingManagerImpl extends CustomYoubenbenCheckerManager implements RetailStoreOrderPickingManager, BusinessHandler{
	...
	@Override
	public RetailStoreOrderPickingDAO daoOf(YoubenbenUserContext userContext) {
	...
	protected void throwExceptionWithMessage(String value) throws RetailStoreOrderPickingManagerException{
 	...
 	protected RetailStoreOrderPicking saveRetailStoreOrderPicking(YoubenbenUserContext userContext, RetailStoreOrderPicking retailStoreOrderPicking, String [] tokensExpr) throws Exception{	
 	...
 	protected RetailStoreOrderPicking saveRetailStoreOrderPickingDetail(YoubenbenUserContext userContext, RetailStoreOrderPicking retailStoreOrderPicking) throws Exception{	
 	...
 	public RetailStoreOrderPicking loadRetailStoreOrderPicking(YoubenbenUserContext userContext, String retailStoreOrderPickingId, String [] tokensExpr) throws Exception{				
 	 ...
 	 public RetailStoreOrderPicking searchRetailStoreOrderPicking(YoubenbenUserContext userContext, String retailStoreOrderPickingId, String textToSearch,String [] tokensExpr) throws Exception{				
 	...
 	protected RetailStoreOrderPicking present(YoubenbenUserContext userContext, RetailStoreOrderPicking retailStoreOrderPicking, Map<String, Object> tokens) throws Exception {
 	...
 	public RetailStoreOrderPicking loadRetailStoreOrderPickingDetail(YoubenbenUserContext userContext, String retailStoreOrderPickingId) throws Exception{	
 	...
 	public Object view(YoubenbenUserContext userContext, String retailStoreOrderPickingId) throws Exception{	
 	...
 	protected RetailStoreOrderPicking saveRetailStoreOrderPicking(YoubenbenUserContext userContext, RetailStoreOrderPicking retailStoreOrderPicking, Map<String,Object>tokens) throws Exception{	
 		return retailStoreOrderPickingDaoOf(userContext).save(retailStoreOrderPicking, tokens);
 	}
 	protected RetailStoreOrderPicking loadRetailStoreOrderPicking(YoubenbenUserContext userContext, String retailStoreOrderPickingId, Map<String,Object>tokens) throws Exception{	
		checkerOf(userContext).checkIdOfRetailStoreOrderPicking(retailStoreOrderPickingId);
		checkerOf(userContext).throwExceptionIfHasErrors( RetailStoreOrderPickingManagerException.class);
 	...
 	protected<T extends BaseEntity> void addActions(YoubenbenUserContext userContext, RetailStoreOrderPicking retailStoreOrderPicking, Map<String, Object> tokens){
	...
	}// end method of protected<T extends BaseEntity> void addActions(YoubenbenUserContext userContext, RetailStoreOrderPicking retailStoreOrderPicking, Map<String, Object> tokens){
	...
	protected void checkParamsForUpdatingRetailStoreOrderPicking(YoubenbenUserContext userContext,String retailStoreOrderPickingId, int retailStoreOrderPickingVersion, String property, String newValueExpr,String [] tokensExpr)throws Exception
	{
	...
	public RetailStoreOrderPicking clone(YoubenbenUserContext userContext, String fromRetailStoreOrderPickingId) throws Exception{
	...
	public RetailStoreOrderPicking internalSaveRetailStoreOrderPicking(YoubenbenUserContext userContext, RetailStoreOrderPicking retailStoreOrderPicking, Map<String,Object> options) throws Exception
	{
	...
	public RetailStoreOrderPicking updateRetailStoreOrderPickingProperty(YoubenbenUserContext userContext,String retailStoreOrderPickingId, int retailStoreOrderPickingVersion, String property, String newValueExpr,String [] tokensExpr) throws Exception
	{
		checkParamsForUpdatingRetailStoreOrderPicking(userContext, retailStoreOrderPickingId, retailStoreOrderPickingVersion, property, newValueExpr, tokensExpr);
...
//--------------------------------------------------------------
	...
	public void delete(YoubenbenUserContext userContext, String retailStoreOrderPickingId, int retailStoreOrderPickingVersion) throws Exception {
	...
	public RetailStoreOrderPicking forgetByAll(YoubenbenUserContext userContext, String retailStoreOrderPickingId, int retailStoreOrderPickingVersion) throws Exception {
		return forgetByAllInternal(userContext, retailStoreOrderPickingId, retailStoreOrderPickingVersion);
	}
	protected RetailStoreOrderPicking forgetByAllInternal(YoubenbenUserContext userContext,
			String retailStoreOrderPickingId, int retailStoreOrderPickingVersion) throws Exception{
	...
	protected RetailStoreOrderPicking breakWithRetailStoreOrderByBuyer(YoubenbenUserContext userContext, String retailStoreOrderPickingId, String buyerId,  String [] tokensExpr)
		 throws Exception{
	...
	protected RetailStoreOrderPicking breakWithRetailStoreOrderBySeller(YoubenbenUserContext userContext, String retailStoreOrderPickingId, String sellerId,  String [] tokensExpr)
		 throws Exception{
	...
	protected RetailStoreOrderPicking breakWithRetailStoreOrderByConfirmation(YoubenbenUserContext userContext, String retailStoreOrderPickingId, String confirmationId,  String [] tokensExpr)
		 throws Exception{
	...
	protected RetailStoreOrderPicking breakWithRetailStoreOrderByApproval(YoubenbenUserContext userContext, String retailStoreOrderPickingId, String approvalId,  String [] tokensExpr)
		 throws Exception{
	...
	protected RetailStoreOrderPicking breakWithRetailStoreOrderByProcessing(YoubenbenUserContext userContext, String retailStoreOrderPickingId, String processingId,  String [] tokensExpr)
		 throws Exception{
	...
	protected RetailStoreOrderPicking breakWithRetailStoreOrderByShipment(YoubenbenUserContext userContext, String retailStoreOrderPickingId, String shipmentId,  String [] tokensExpr)
		 throws Exception{
	...
	protected RetailStoreOrderPicking breakWithRetailStoreOrderByDelivery(YoubenbenUserContext userContext, String retailStoreOrderPickingId, String deliveryId,  String [] tokensExpr)
		 throws Exception{
	...
	protected void checkParamsForUpdatingRetailStoreOrderProperties(YoubenbenUserContext userContext, String retailStoreOrderPickingId,String id,String title,BigDecimal totalAmount,String [] tokensExpr) throws Exception {
	...
	public  RetailStoreOrderPicking updateRetailStoreOrderProperties(YoubenbenUserContext userContext, String retailStoreOrderPickingId, String id,String title,BigDecimal totalAmount, String [] tokensExpr) throws Exception
	{
	...
	protected RetailStoreOrder createRetailStoreOrder(YoubenbenUserContext userContext, String buyerId, String sellerId, String title, BigDecimal totalAmount, String confirmationId, String approvalId, String processingId, String shipmentId, String deliveryId) throws Exception{
	...
	protected void checkParamsForRemovingRetailStoreOrderList(YoubenbenUserContext userContext, String retailStoreOrderPickingId,
	...
	public  RetailStoreOrderPicking removeRetailStoreOrderList(YoubenbenUserContext userContext, String retailStoreOrderPickingId,
			String retailStoreOrderIds[],String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForRemovingRetailStoreOrder(YoubenbenUserContext userContext, String retailStoreOrderPickingId,
	...
	public  RetailStoreOrderPicking removeRetailStoreOrder(YoubenbenUserContext userContext, String retailStoreOrderPickingId,
		String retailStoreOrderId, int retailStoreOrderVersion,String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForCopyingRetailStoreOrder(YoubenbenUserContext userContext, String retailStoreOrderPickingId,
		String retailStoreOrderId, int retailStoreOrderVersion,String [] tokensExpr) throws Exception{
	...
	public  RetailStoreOrderPicking copyRetailStoreOrderFrom(YoubenbenUserContext userContext, String retailStoreOrderPickingId,
		String retailStoreOrderId, int retailStoreOrderVersion,String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForUpdatingRetailStoreOrder(YoubenbenUserContext userContext, String retailStoreOrderPickingId, String retailStoreOrderId, int retailStoreOrderVersion, String property, String newValueExpr,String [] tokensExpr) throws Exception{
	...
	public  RetailStoreOrderPicking updateRetailStoreOrder(YoubenbenUserContext userContext, String retailStoreOrderPickingId, String retailStoreOrderId, int retailStoreOrderVersion, String property, String newValueExpr,String [] tokensExpr)
			throws Exception{
	...
	*/
	...
	// -----------------------------------// list-of-view 处理 \\-----------------------------------
    protected void enhanceForListOfView(YoubenbenUserContext userContext,SmartList<RetailStoreOrderPicking> list) throws Exception {
  ...
  // -----------------------------------\\ list-of-view 处理 //-----------------------------------v
	 ...
	 * @throws Exception
	 */
 	public Object wxappview(YoubenbenUserContext userContext, String retailStoreOrderPickingId) throws Exception{
	  SerializeScope vscope = YoubenbenViewScope.getInstance().getRetailStoreOrderPickingDetailScope().clone();
