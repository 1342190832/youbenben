...
public class PotentialCustomerContactPersonJDBCTemplateDAO extends YoubenbenBaseDAOImpl implements PotentialCustomerContactPersonDAO{
	...
	*/
    ...
    public SmartList<PotentialCustomerContactPerson> requestCandidatePotentialCustomerContactPersonForPotentialCustomerContact(YoubenbenUserContext userContext, String ownerClass, String id, String filterKey, int pageNo, int pageSize) throws Exception {
	...
	public SmartList<PotentialCustomerContact> loadOurPotentialCustomerContactList(YoubenbenUserContext userContext, List<PotentialCustomerContactPerson> us, Map<String,Object> options) throws Exception{
