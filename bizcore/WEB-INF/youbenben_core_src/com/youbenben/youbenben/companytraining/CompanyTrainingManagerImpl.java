...
import com.youbenben.youbenben.instructor.CandidateInstructor;
import com.youbenben.youbenben.trainingcoursetype.CandidateTrainingCourseType;
...
public class CompanyTrainingManagerImpl extends CustomYoubenbenCheckerManager implements CompanyTrainingManager, BusinessHandler{
	...
	@Override
	public CompanyTrainingDAO daoOf(YoubenbenUserContext userContext) {
	...
	protected void throwExceptionWithMessage(String value) throws CompanyTrainingManagerException{
 	...
 	protected CompanyTraining saveCompanyTraining(YoubenbenUserContext userContext, CompanyTraining companyTraining, String [] tokensExpr) throws Exception{	
 	...
 	protected CompanyTraining saveCompanyTrainingDetail(YoubenbenUserContext userContext, CompanyTraining companyTraining) throws Exception{	
 	...
 	public CompanyTraining loadCompanyTraining(YoubenbenUserContext userContext, String companyTrainingId, String [] tokensExpr) throws Exception{				
 	 ...
 	 public CompanyTraining searchCompanyTraining(YoubenbenUserContext userContext, String companyTrainingId, String textToSearch,String [] tokensExpr) throws Exception{				
 	...
 	protected CompanyTraining present(YoubenbenUserContext userContext, CompanyTraining companyTraining, Map<String, Object> tokens) throws Exception {
 	...
 	public CompanyTraining loadCompanyTrainingDetail(YoubenbenUserContext userContext, String companyTrainingId) throws Exception{	
 	...
 	public Object view(YoubenbenUserContext userContext, String companyTrainingId) throws Exception{	
 		CompanyTraining companyTraining = loadCompanyTraining( userContext, companyTrainingId, viewTokens());
 		return present(userContext,companyTraining, allTokens());
		
 	}
 	protected CompanyTraining saveCompanyTraining(YoubenbenUserContext userContext, CompanyTraining companyTraining, Map<String,Object>tokens) throws Exception{	
 		return companyTrainingDaoOf(userContext).save(companyTraining, tokens);
 	}
 	protected CompanyTraining loadCompanyTraining(YoubenbenUserContext userContext, String companyTrainingId, Map<String,Object>tokens) throws Exception{	
		checkerOf(userContext).checkIdOfCompanyTraining(companyTrainingId);
		checkerOf(userContext).throwExceptionIfHasErrors( CompanyTrainingManagerException.class);
 	...
 	protected<T extends BaseEntity> void addActions(YoubenbenUserContext userContext, CompanyTraining companyTraining, Map<String, Object> tokens){
	...
	}// end method of protected<T extends BaseEntity> void addActions(YoubenbenUserContext userContext, CompanyTraining companyTraining, Map<String, Object> tokens){
	...
	protected void checkParamsForUpdatingCompanyTraining(YoubenbenUserContext userContext,String companyTrainingId, int companyTrainingVersion, String property, String newValueExpr,String [] tokensExpr)throws Exception
	{
	...
	public CompanyTraining clone(YoubenbenUserContext userContext, String fromCompanyTrainingId) throws Exception{
	...
	public CompanyTraining internalSaveCompanyTraining(YoubenbenUserContext userContext, CompanyTraining companyTraining, Map<String,Object> options) throws Exception
	{
	...
	public CompanyTraining updateCompanyTrainingProperty(YoubenbenUserContext userContext,String companyTrainingId, int companyTrainingVersion, String property, String newValueExpr,String [] tokensExpr) throws Exception
	{
		checkParamsForUpdatingCompanyTraining(userContext, companyTrainingId, companyTrainingVersion, property, newValueExpr, tokensExpr);
	...
	protected void checkParamsForTransferingAnotherCompany(YoubenbenUserContext userContext, String companyTrainingId, String anotherCompanyId) throws Exception
 	{
	...
	public CandidateRetailStoreCountryCenter requestCandidateCompany(YoubenbenUserContext userContext, String ownerClass, String id, String filterKey, int pageNo) throws Exception {
 	...
 	protected void checkParamsForTransferingAnotherInstructor(YoubenbenUserContext userContext, String companyTrainingId, String anotherInstructorId) throws Exception
 	{
	...
	public CandidateInstructor requestCandidateInstructor(YoubenbenUserContext userContext, String ownerClass, String id, String filterKey, int pageNo) throws Exception {
 	...
 	protected void checkParamsForTransferingAnotherTrainingCourseType(YoubenbenUserContext userContext, String companyTrainingId, String anotherTrainingCourseTypeId) throws Exception
 	{
	...
	public CandidateTrainingCourseType requestCandidateTrainingCourseType(YoubenbenUserContext userContext, String ownerClass, String id, String filterKey, int pageNo) throws Exception {
 ...
 //--------------------------------------------------------------
 	...
 	protected Instructor loadInstructor(YoubenbenUserContext userContext, String newInstructorId, Map<String,Object> options) throws Exception
 	{
 	...
 	protected TrainingCourseType loadTrainingCourseType(YoubenbenUserContext userContext, String newTrainingCourseTypeId, Map<String,Object> options) throws Exception
 	{
	...
	public void delete(YoubenbenUserContext userContext, String companyTrainingId, int companyTrainingVersion) throws Exception {
	...
	public CompanyTraining forgetByAll(YoubenbenUserContext userContext, String companyTrainingId, int companyTrainingVersion) throws Exception {
		return forgetByAllInternal(userContext, companyTrainingId, companyTrainingVersion);
	}
	protected CompanyTraining forgetByAllInternal(YoubenbenUserContext userContext,
			String companyTrainingId, int companyTrainingVersion) throws Exception{
	...
	protected CompanyTraining breakWithEmployeeCompanyTrainingByEmployee(YoubenbenUserContext userContext, String companyTrainingId, String employeeId,  String [] tokensExpr)
		 throws Exception{
	...
	protected CompanyTraining breakWithEmployeeCompanyTrainingByScoring(YoubenbenUserContext userContext, String companyTrainingId, String scoringId,  String [] tokensExpr)
		 throws Exception{
	...
	protected void checkParamsForAddingEmployeeCompanyTraining(YoubenbenUserContext userContext, String companyTrainingId, String employeeId, String scoringId,String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForUpdatingEmployeeCompanyTrainingProperties(YoubenbenUserContext userContext, String companyTrainingId,String id,String [] tokensExpr) throws Exception {
	...
	public  CompanyTraining updateEmployeeCompanyTrainingProperties(YoubenbenUserContext userContext, String companyTrainingId, String id, String [] tokensExpr) throws Exception
	{
	...
	protected EmployeeCompanyTraining createEmployeeCompanyTraining(YoubenbenUserContext userContext, String employeeId, String scoringId) throws Exception{
	...
	protected void checkParamsForRemovingEmployeeCompanyTrainingList(YoubenbenUserContext userContext, String companyTrainingId,
	...
	public  CompanyTraining removeEmployeeCompanyTrainingList(YoubenbenUserContext userContext, String companyTrainingId,
			String employeeCompanyTrainingIds[],String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForRemovingEmployeeCompanyTraining(YoubenbenUserContext userContext, String companyTrainingId,
	...
	public  CompanyTraining removeEmployeeCompanyTraining(YoubenbenUserContext userContext, String companyTrainingId,
		String employeeCompanyTrainingId, int employeeCompanyTrainingVersion,String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForCopyingEmployeeCompanyTraining(YoubenbenUserContext userContext, String companyTrainingId,
		String employeeCompanyTrainingId, int employeeCompanyTrainingVersion,String [] tokensExpr) throws Exception{
	...
	public  CompanyTraining copyEmployeeCompanyTrainingFrom(YoubenbenUserContext userContext, String companyTrainingId,
		String employeeCompanyTrainingId, int employeeCompanyTrainingVersion,String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForUpdatingEmployeeCompanyTraining(YoubenbenUserContext userContext, String companyTrainingId, String employeeCompanyTrainingId, int employeeCompanyTrainingVersion, String property, String newValueExpr,String [] tokensExpr) throws Exception{
	...
	public  CompanyTraining updateEmployeeCompanyTraining(YoubenbenUserContext userContext, String companyTrainingId, String employeeCompanyTrainingId, int employeeCompanyTrainingVersion, String property, String newValueExpr,String [] tokensExpr)
			throws Exception{
	...
	*/
	...
	// -----------------------------------// list-of-view 处理 \\-----------------------------------
    protected void enhanceForListOfView(YoubenbenUserContext userContext,SmartList<CompanyTraining> list) throws Exception {
		...
		List<Instructor> instructorList = YoubenbenBaseUtils.collectReferencedObjectWithType(userContext, list, Instructor.class);
		userContext.getDAOGroup().enhanceList(instructorList, Instructor.class);
		List<TrainingCourseType> trainingCourseTypeList = YoubenbenBaseUtils.collectReferencedObjectWithType(userContext, list, TrainingCourseType.class);
  ...
  // -----------------------------------\\ list-of-view 处理 //-----------------------------------v
	 ...
	 * @throws Exception
	 */
 	public Object wxappview(YoubenbenUserContext userContext, String companyTrainingId) throws Exception{
	  SerializeScope vscope = YoubenbenViewScope.getInstance().getCompanyTrainingDetailScope().clone();
