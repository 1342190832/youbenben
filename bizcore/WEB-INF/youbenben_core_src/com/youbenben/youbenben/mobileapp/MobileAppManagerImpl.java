...
public class MobileAppManagerImpl extends CustomYoubenbenCheckerManager implements MobileAppManager, BusinessHandler{
	...
	@Override
	public MobileAppDAO daoOf(YoubenbenUserContext userContext) {
	...
	protected void throwExceptionWithMessage(String value) throws MobileAppManagerException{
 	...
 	protected MobileApp saveMobileApp(YoubenbenUserContext userContext, MobileApp mobileApp, String [] tokensExpr) throws Exception{	
 	...
 	protected MobileApp saveMobileAppDetail(YoubenbenUserContext userContext, MobileApp mobileApp) throws Exception{	
 	...
 	public MobileApp loadMobileApp(YoubenbenUserContext userContext, String mobileAppId, String [] tokensExpr) throws Exception{				
 	 ...
 	 public MobileApp searchMobileApp(YoubenbenUserContext userContext, String mobileAppId, String textToSearch,String [] tokensExpr) throws Exception{				
 	...
 	protected MobileApp present(YoubenbenUserContext userContext, MobileApp mobileApp, Map<String, Object> tokens) throws Exception {
 	...
 	public MobileApp loadMobileAppDetail(YoubenbenUserContext userContext, String mobileAppId) throws Exception{	
 		MobileApp mobileApp = loadMobileApp( userContext, mobileAppId, allTokens());
 		return present(userContext,mobileApp, allTokens());
		
 	}
 	
 	public Object view(YoubenbenUserContext userContext, String mobileAppId) throws Exception{	
 		MobileApp mobileApp = loadMobileApp( userContext, mobileAppId, viewTokens());
 		return present(userContext,mobileApp, allTokens());
		
 	}
 	protected MobileApp saveMobileApp(YoubenbenUserContext userContext, MobileApp mobileApp, Map<String,Object>tokens) throws Exception{	
 		return mobileAppDaoOf(userContext).save(mobileApp, tokens);
 	}
 	protected MobileApp loadMobileApp(YoubenbenUserContext userContext, String mobileAppId, Map<String,Object>tokens) throws Exception{	
		checkerOf(userContext).checkIdOfMobileApp(mobileAppId);
		checkerOf(userContext).throwExceptionIfHasErrors( MobileAppManagerException.class);
 	...
 	protected<T extends BaseEntity> void addActions(YoubenbenUserContext userContext, MobileApp mobileApp, Map<String, Object> tokens){
	...
	}// end method of protected<T extends BaseEntity> void addActions(YoubenbenUserContext userContext, MobileApp mobileApp, Map<String, Object> tokens){
	...
	protected void checkParamsForUpdatingMobileApp(YoubenbenUserContext userContext,String mobileAppId, int mobileAppVersion, String property, String newValueExpr,String [] tokensExpr)throws Exception
	{
	...
	public MobileApp clone(YoubenbenUserContext userContext, String fromMobileAppId) throws Exception{
	...
	public MobileApp internalSaveMobileApp(YoubenbenUserContext userContext, MobileApp mobileApp, Map<String,Object> options) throws Exception
	{
	...
	public MobileApp updateMobileAppProperty(YoubenbenUserContext userContext,String mobileAppId, int mobileAppVersion, String property, String newValueExpr,String [] tokensExpr) throws Exception
	{
		checkParamsForUpdatingMobileApp(userContext, mobileAppId, mobileAppVersion, property, newValueExpr, tokensExpr);
...
//--------------------------------------------------------------
	...
	public void delete(YoubenbenUserContext userContext, String mobileAppId, int mobileAppVersion) throws Exception {
	...
	public MobileApp forgetByAll(YoubenbenUserContext userContext, String mobileAppId, int mobileAppVersion) throws Exception {
		return forgetByAllInternal(userContext, mobileAppId, mobileAppVersion);
	}
	protected MobileApp forgetByAllInternal(YoubenbenUserContext userContext,
			String mobileAppId, int mobileAppVersion) throws Exception{
	...
	protected MobileApp breakWithPageByPageType(YoubenbenUserContext userContext, String mobileAppId, String pageTypeId,  String [] tokensExpr)
		 throws Exception{
	...
	protected void checkParamsForAddingPage(YoubenbenUserContext userContext, String mobileAppId, String pageTitle, String linkToUrl, String pageTypeId,String [] tokensExpr) throws Exception{
	...
	public  MobileApp addPage(YoubenbenUserContext userContext, String mobileAppId, String pageTitle, String linkToUrl, String pageTypeId, String [] tokensExpr) throws Exception
	{
		...
		checkParamsForAddingPage(userContext,mobileAppId,pageTitle, linkToUrl, pageTypeId,tokensExpr);

		Page page = createPage(userContext,pageTitle, linkToUrl, pageTypeId);
	...
	protected void checkParamsForUpdatingPageProperties(YoubenbenUserContext userContext, String mobileAppId,String id,String pageTitle,String linkToUrl,String [] tokensExpr) throws Exception {
	...
	public  MobileApp updatePageProperties(YoubenbenUserContext userContext, String mobileAppId, String id,String pageTitle,String linkToUrl, String [] tokensExpr) throws Exception
	{
		checkParamsForUpdatingPageProperties(userContext,mobileAppId,id,pageTitle,linkToUrl,tokensExpr);
	...
	protected Page createPage(YoubenbenUserContext userContext, String pageTitle, String linkToUrl, String pageTypeId) throws Exception{
	...
	protected void checkParamsForRemovingPageList(YoubenbenUserContext userContext, String mobileAppId,
	...
	public  MobileApp removePageList(YoubenbenUserContext userContext, String mobileAppId,
			String pageIds[],String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForRemovingPage(YoubenbenUserContext userContext, String mobileAppId,
	...
	public  MobileApp removePage(YoubenbenUserContext userContext, String mobileAppId,
		String pageId, int pageVersion,String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForCopyingPage(YoubenbenUserContext userContext, String mobileAppId,
		String pageId, int pageVersion,String [] tokensExpr) throws Exception{
	...
	public  MobileApp copyPageFrom(YoubenbenUserContext userContext, String mobileAppId,
		String pageId, int pageVersion,String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForUpdatingPage(YoubenbenUserContext userContext, String mobileAppId, String pageId, int pageVersion, String property, String newValueExpr,String [] tokensExpr) throws Exception{
	...
	public  MobileApp updatePage(YoubenbenUserContext userContext, String mobileAppId, String pageId, int pageVersion, String property, String newValueExpr,String [] tokensExpr)
			throws Exception{
	...
	*/
	...
	protected void checkParamsForAddingPageType(YoubenbenUserContext userContext, String mobileAppId, String name, String code, boolean footerTab,String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForUpdatingPageTypeProperties(YoubenbenUserContext userContext, String mobileAppId,String id,String name,String code,boolean footerTab,String [] tokensExpr) throws Exception {
	...
	public  MobileApp updatePageTypeProperties(YoubenbenUserContext userContext, String mobileAppId, String id,String name,String code,boolean footerTab, String [] tokensExpr) throws Exception
	{
	...
	protected PageType createPageType(YoubenbenUserContext userContext, String name, String code, boolean footerTab) throws Exception{
	...
	protected void checkParamsForRemovingPageTypeList(YoubenbenUserContext userContext, String mobileAppId,
	...
	public  MobileApp removePageTypeList(YoubenbenUserContext userContext, String mobileAppId,
			String pageTypeIds[],String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForRemovingPageType(YoubenbenUserContext userContext, String mobileAppId,
	...
	public  MobileApp removePageType(YoubenbenUserContext userContext, String mobileAppId,
		String pageTypeId, int pageTypeVersion,String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForCopyingPageType(YoubenbenUserContext userContext, String mobileAppId,
		String pageTypeId, int pageTypeVersion,String [] tokensExpr) throws Exception{
	...
	public  MobileApp copyPageTypeFrom(YoubenbenUserContext userContext, String mobileAppId,
		String pageTypeId, int pageTypeVersion,String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForUpdatingPageType(YoubenbenUserContext userContext, String mobileAppId, String pageTypeId, int pageTypeVersion, String property, String newValueExpr,String [] tokensExpr) throws Exception{
	...
	public  MobileApp updatePageType(YoubenbenUserContext userContext, String mobileAppId, String pageTypeId, int pageTypeVersion, String property, String newValueExpr,String [] tokensExpr)
			throws Exception{
	...
	*/
	...
	// -----------------------------------// list-of-view 处理 \\-----------------------------------
    protected void enhanceForListOfView(YoubenbenUserContext userContext,SmartList<MobileApp> list) throws Exception {
  ...
  // -----------------------------------\\ list-of-view 处理 //-----------------------------------v
	 ...
	 * @throws Exception
	 */
 	public Object wxappview(YoubenbenUserContext userContext, String mobileAppId) throws Exception{
	  SerializeScope vscope = YoubenbenViewScope.getInstance().getMobileAppDetailScope().clone();
    ...
    String pageTitle = "手机应用程序"+"详情";
		...
		vscope.field("pageListSection", YoubenbenListOfViewScope.getInstance()
