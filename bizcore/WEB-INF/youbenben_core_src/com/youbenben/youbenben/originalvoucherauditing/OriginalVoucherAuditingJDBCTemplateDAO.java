...
public class OriginalVoucherAuditingJDBCTemplateDAO extends YoubenbenBaseDAOImpl implements OriginalVoucherAuditingDAO{
	...
	*/
    ...
    public SmartList<OriginalVoucherAuditing> requestCandidateOriginalVoucherAuditingForOriginalVoucher(YoubenbenUserContext userContext, String ownerClass, String id, String filterKey, int pageNo, int pageSize) throws Exception {
        // NOTE: by default, ignore owner info, just return all by filter key.
		// You need override this method if you have different candidate-logic
		return findAllCandidateByFilter(OriginalVoucherAuditingTable.COLUMN_WHO, null, filterKey, pageNo, pageSize, getOriginalVoucherAuditingMapper());
    }
	...
	public SmartList<OriginalVoucher> loadOurOriginalVoucherList(YoubenbenUserContext userContext, List<OriginalVoucherAuditing> us, Map<String,Object> options) throws Exception{
	...
	@Override
	public CandidateOriginalVoucherAuditing executeCandidatesQuery(CandidateQuery query, String sql, Object ... parmeters) throws Exception {
