...
import com.youbenben.youbenben.supplierspace.CandidateSupplierSpace;
import com.youbenben.youbenben.damagespace.CandidateDamageSpace;
import com.youbenben.youbenben.storagespace.CandidateStorageSpace;
...
public class GoodsShelfManagerImpl extends CustomYoubenbenCheckerManager implements GoodsShelfManager, BusinessHandler{
	...
	@Override
	public GoodsShelfDAO daoOf(YoubenbenUserContext userContext) {
	...
	protected void throwExceptionWithMessage(String value) throws GoodsShelfManagerException{
 	...
 	protected GoodsShelf saveGoodsShelf(YoubenbenUserContext userContext, GoodsShelf goodsShelf, String [] tokensExpr) throws Exception{	
 	...
 	protected GoodsShelf saveGoodsShelfDetail(YoubenbenUserContext userContext, GoodsShelf goodsShelf) throws Exception{	
 	...
 	public GoodsShelf loadGoodsShelf(YoubenbenUserContext userContext, String goodsShelfId, String [] tokensExpr) throws Exception{				
 	 ...
 	 public GoodsShelf searchGoodsShelf(YoubenbenUserContext userContext, String goodsShelfId, String textToSearch,String [] tokensExpr) throws Exception{				
 	...
 	protected GoodsShelf present(YoubenbenUserContext userContext, GoodsShelf goodsShelf, Map<String, Object> tokens) throws Exception {
 	...
 	public GoodsShelf loadGoodsShelfDetail(YoubenbenUserContext userContext, String goodsShelfId) throws Exception{	
 		GoodsShelf goodsShelf = loadGoodsShelf( userContext, goodsShelfId, allTokens());
 		return present(userContext,goodsShelf, allTokens());
		
 	}
 	
 	public Object view(YoubenbenUserContext userContext, String goodsShelfId) throws Exception{	
 		GoodsShelf goodsShelf = loadGoodsShelf( userContext, goodsShelfId, viewTokens());
 		return present(userContext,goodsShelf, allTokens());
		
 	}
 	protected GoodsShelf saveGoodsShelf(YoubenbenUserContext userContext, GoodsShelf goodsShelf, Map<String,Object>tokens) throws Exception{	
 		return goodsShelfDaoOf(userContext).save(goodsShelf, tokens);
 	}
 	protected GoodsShelf loadGoodsShelf(YoubenbenUserContext userContext, String goodsShelfId, Map<String,Object>tokens) throws Exception{	
		checkerOf(userContext).checkIdOfGoodsShelf(goodsShelfId);
		checkerOf(userContext).throwExceptionIfHasErrors( GoodsShelfManagerException.class);
 	...
 	protected<T extends BaseEntity> void addActions(YoubenbenUserContext userContext, GoodsShelf goodsShelf, Map<String, Object> tokens){
	...
	}// end method of protected<T extends BaseEntity> void addActions(YoubenbenUserContext userContext, GoodsShelf goodsShelf, Map<String, Object> tokens){
	...
	protected void checkParamsForUpdatingGoodsShelf(YoubenbenUserContext userContext,String goodsShelfId, int goodsShelfVersion, String property, String newValueExpr,String [] tokensExpr)throws Exception
	{
	...
	public GoodsShelf clone(YoubenbenUserContext userContext, String fromGoodsShelfId) throws Exception{
	...
	public GoodsShelf internalSaveGoodsShelf(YoubenbenUserContext userContext, GoodsShelf goodsShelf, Map<String,Object> options) throws Exception
	{
	...
	public GoodsShelf updateGoodsShelfProperty(YoubenbenUserContext userContext,String goodsShelfId, int goodsShelfVersion, String property, String newValueExpr,String [] tokensExpr) throws Exception
	{
		checkParamsForUpdatingGoodsShelf(userContext, goodsShelfId, goodsShelfVersion, property, newValueExpr, tokensExpr);
	...
	protected void checkParamsForTransferingAnotherStorageSpace(YoubenbenUserContext userContext, String goodsShelfId, String anotherStorageSpaceId) throws Exception
 	{
	...
	public CandidateStorageSpace requestCandidateStorageSpace(YoubenbenUserContext userContext, String ownerClass, String id, String filterKey, int pageNo) throws Exception {
 	...
 	protected void checkParamsForTransferingAnotherSupplierSpace(YoubenbenUserContext userContext, String goodsShelfId, String anotherSupplierSpaceId) throws Exception
 	{
	...
	public CandidateSupplierSpace requestCandidateSupplierSpace(YoubenbenUserContext userContext, String ownerClass, String id, String filterKey, int pageNo) throws Exception {
 	...
 	protected void checkParamsForTransferingAnotherDamageSpace(YoubenbenUserContext userContext, String goodsShelfId, String anotherDamageSpaceId) throws Exception
 	{
	...
	public CandidateDamageSpace requestCandidateDamageSpace(YoubenbenUserContext userContext, String ownerClass, String id, String filterKey, int pageNo) throws Exception {
 ...
 //--------------------------------------------------------------
 	...
 	protected SupplierSpace loadSupplierSpace(YoubenbenUserContext userContext, String newSupplierSpaceId, Map<String,Object> options) throws Exception
 	{
 	...
 	protected DamageSpace loadDamageSpace(YoubenbenUserContext userContext, String newDamageSpaceId, Map<String,Object> options) throws Exception
 	{
 	...
 	protected StorageSpace loadStorageSpace(YoubenbenUserContext userContext, String newStorageSpaceId, Map<String,Object> options) throws Exception
 	{
	...
	public void delete(YoubenbenUserContext userContext, String goodsShelfId, int goodsShelfVersion) throws Exception {
	...
	public GoodsShelf forgetByAll(YoubenbenUserContext userContext, String goodsShelfId, int goodsShelfVersion) throws Exception {
		return forgetByAllInternal(userContext, goodsShelfId, goodsShelfVersion);
	}
	protected GoodsShelf forgetByAllInternal(YoubenbenUserContext userContext,
			String goodsShelfId, int goodsShelfVersion) throws Exception{
	...
	protected void checkParamsForAddingGoodsShelfStockCount(YoubenbenUserContext userContext, String goodsShelfId, String title, Date countTime, String summary,String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForUpdatingGoodsShelfStockCountProperties(YoubenbenUserContext userContext, String goodsShelfId,String id,String title,Date countTime,String summary,String [] tokensExpr) throws Exception {
	...
	public  GoodsShelf updateGoodsShelfStockCountProperties(YoubenbenUserContext userContext, String goodsShelfId, String id,String title,Date countTime,String summary, String [] tokensExpr) throws Exception
	{
	...
	protected GoodsShelfStockCount createGoodsShelfStockCount(YoubenbenUserContext userContext, String title, Date countTime, String summary) throws Exception{
	...
	protected void checkParamsForRemovingGoodsShelfStockCountList(YoubenbenUserContext userContext, String goodsShelfId,
	...
	public  GoodsShelf removeGoodsShelfStockCountList(YoubenbenUserContext userContext, String goodsShelfId,
			String goodsShelfStockCountIds[],String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForRemovingGoodsShelfStockCount(YoubenbenUserContext userContext, String goodsShelfId,
	...
	public  GoodsShelf removeGoodsShelfStockCount(YoubenbenUserContext userContext, String goodsShelfId,
		String goodsShelfStockCountId, int goodsShelfStockCountVersion,String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForCopyingGoodsShelfStockCount(YoubenbenUserContext userContext, String goodsShelfId,
		String goodsShelfStockCountId, int goodsShelfStockCountVersion,String [] tokensExpr) throws Exception{
	...
	public  GoodsShelf copyGoodsShelfStockCountFrom(YoubenbenUserContext userContext, String goodsShelfId,
		String goodsShelfStockCountId, int goodsShelfStockCountVersion,String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForUpdatingGoodsShelfStockCount(YoubenbenUserContext userContext, String goodsShelfId, String goodsShelfStockCountId, int goodsShelfStockCountVersion, String property, String newValueExpr,String [] tokensExpr) throws Exception{
	...
	public  GoodsShelf updateGoodsShelfStockCount(YoubenbenUserContext userContext, String goodsShelfId, String goodsShelfStockCountId, int goodsShelfStockCountVersion, String property, String newValueExpr,String [] tokensExpr)
			throws Exception{
	...
	*/
	...
	protected void checkParamsForAddingGoodsAllocation(YoubenbenUserContext userContext, String goodsShelfId, String location, BigDecimal latitude, BigDecimal longitude,String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForUpdatingGoodsAllocationProperties(YoubenbenUserContext userContext, String goodsShelfId,String id,String location,BigDecimal latitude,BigDecimal longitude,String [] tokensExpr) throws Exception {
	...
	public  GoodsShelf updateGoodsAllocationProperties(YoubenbenUserContext userContext, String goodsShelfId, String id,String location,BigDecimal latitude,BigDecimal longitude, String [] tokensExpr) throws Exception
	{
	...
	protected GoodsAllocation createGoodsAllocation(YoubenbenUserContext userContext, String location, BigDecimal latitude, BigDecimal longitude) throws Exception{
	...
	protected void checkParamsForRemovingGoodsAllocationList(YoubenbenUserContext userContext, String goodsShelfId,
	...
	public  GoodsShelf removeGoodsAllocationList(YoubenbenUserContext userContext, String goodsShelfId,
			String goodsAllocationIds[],String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForRemovingGoodsAllocation(YoubenbenUserContext userContext, String goodsShelfId,
	...
	public  GoodsShelf removeGoodsAllocation(YoubenbenUserContext userContext, String goodsShelfId,
		String goodsAllocationId, int goodsAllocationVersion,String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForCopyingGoodsAllocation(YoubenbenUserContext userContext, String goodsShelfId,
		String goodsAllocationId, int goodsAllocationVersion,String [] tokensExpr) throws Exception{
	...
	public  GoodsShelf copyGoodsAllocationFrom(YoubenbenUserContext userContext, String goodsShelfId,
		String goodsAllocationId, int goodsAllocationVersion,String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForUpdatingGoodsAllocation(YoubenbenUserContext userContext, String goodsShelfId, String goodsAllocationId, int goodsAllocationVersion, String property, String newValueExpr,String [] tokensExpr) throws Exception{
	...
	public  GoodsShelf updateGoodsAllocation(YoubenbenUserContext userContext, String goodsShelfId, String goodsAllocationId, int goodsAllocationVersion, String property, String newValueExpr,String [] tokensExpr)
			throws Exception{
	...
	*/
	...
	// -----------------------------------// list-of-view 处理 \\-----------------------------------
    protected void enhanceForListOfView(YoubenbenUserContext userContext,SmartList<GoodsShelf> list) throws Exception {
    	if (list == null || list.isEmpty()){
    		return;
    	}
		List<StorageSpace> storageSpaceList = YoubenbenBaseUtils.collectReferencedObjectWithType(userContext, list, StorageSpace.class);
		userContext.getDAOGroup().enhanceList(storageSpaceList, StorageSpace.class);
		List<SupplierSpace> supplierSpaceList = YoubenbenBaseUtils.collectReferencedObjectWithType(userContext, list, SupplierSpace.class);
		userContext.getDAOGroup().enhanceList(supplierSpaceList, SupplierSpace.class);
		List<DamageSpace> damageSpaceList = YoubenbenBaseUtils.collectReferencedObjectWithType(userContext, list, DamageSpace.class);
  ...
  // -----------------------------------\\ list-of-view 处理 //-----------------------------------v
	 ...
	 * @throws Exception
	 */
 	public Object wxappview(YoubenbenUserContext userContext, String goodsShelfId) throws Exception{
	  SerializeScope vscope = YoubenbenViewScope.getInstance().getGoodsShelfDetailScope().clone();
    ...
    String pageTitle = "货架"+"详情";
		...
		vscope.field("goodsShelfStockCountListSection", YoubenbenListOfViewScope.getInstance()
		...
		vscope.field("goodsAllocationListSection", YoubenbenListOfViewScope.getInstance()
