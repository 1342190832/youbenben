...
public class CityEventJDBCTemplateDAO extends YoubenbenBaseDAOImpl implements CityEventDAO{
	...
	*/
	...
	protected CityEvent analyzeEventAttendanceList(CityEvent cityEvent, Map<String,Object> options){
 	...
 	public SmartList<CityEvent> findCityEventByCityServiceCenter(String franchisedOutletCityServiceCenterId,Map<String,Object> options){
  		...
  		SmartList<CityEvent> resultList = queryWith(CityEventTable.COLUMN_CITY_SERVICE_CENTER, franchisedOutletCityServiceCenterId, options, getCityEventMapper());
		// analyzeCityEventByCityServiceCenter(resultList, franchisedOutletCityServiceCenterId, options);
		return resultList;
 	}
 	...
 	public SmartList<CityEvent> findCityEventByCityServiceCenter(String franchisedOutletCityServiceCenterId, int start, int count,Map<String,Object> options){
 		...
 		SmartList<CityEvent> resultList =  queryWithRange(CityEventTable.COLUMN_CITY_SERVICE_CENTER, franchisedOutletCityServiceCenterId, options, getCityEventMapper(), start, count);
 		//analyzeCityEventByCityServiceCenter(resultList, franchisedOutletCityServiceCenterId, options);
 		return resultList;
 	...
 	public void analyzeCityEventByCityServiceCenter(SmartList<CityEvent> resultList, String franchisedOutletCityServiceCenterId, Map<String,Object> options){
		if(resultList==null){
 		...
 		filterKey.put(CityEvent.CITY_SERVICE_CENTER_PROPERTY, franchisedOutletCityServiceCenterId);
 	...
 	public int countCityEventByCityServiceCenter(String franchisedOutletCityServiceCenterId,Map<String,Object> options){
 		...
 		return countWith(CityEventTable.COLUMN_CITY_SERVICE_CENTER, franchisedOutletCityServiceCenterId, options);
 	}
 	@Override
	...
	//======================================================================================
 	...
 	protected CityEvent saveCityServiceCenter(CityEvent cityEvent, Map<String,Object> options){
 		...
 		getFranchisedOutletCityServiceCenterDAO().save(cityEvent.getCityServiceCenter(),options);
 		return cityEvent;
