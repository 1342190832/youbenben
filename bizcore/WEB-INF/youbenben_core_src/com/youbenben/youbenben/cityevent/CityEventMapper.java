...
public class CityEventMapper extends BaseRowMapper<CityEvent>{
	...
	protected void setMobile(CityEvent cityEvent, ResultSet rs, int rowNumber) throws SQLException{
 	...
 	protected void setCityServiceCenter(CityEvent cityEvent, ResultSet rs, int rowNumber) throws SQLException{
 		String franchisedOutletCityServiceCenterId = rs.getString(CityEventTable.COLUMN_CITY_SERVICE_CENTER);
 		...
 		FranchisedOutletCityServiceCenter franchisedOutletCityServiceCenter = cityEvent.getCityServiceCenter();
 		...
 		cityEvent.setCityServiceCenter(createEmptyCityServiceCenter(franchisedOutletCityServiceCenterId));
 	}
