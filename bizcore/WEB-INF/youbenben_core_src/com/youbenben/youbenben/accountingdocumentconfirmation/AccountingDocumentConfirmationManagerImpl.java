...
public class AccountingDocumentConfirmationManagerImpl extends CustomYoubenbenCheckerManager implements AccountingDocumentConfirmationManager, BusinessHandler{
	...
	@Override
	public AccountingDocumentConfirmationDAO daoOf(YoubenbenUserContext userContext) {
	...
	protected void throwExceptionWithMessage(String value) throws AccountingDocumentConfirmationManagerException{
 	...
 	protected AccountingDocumentConfirmation saveAccountingDocumentConfirmation(YoubenbenUserContext userContext, AccountingDocumentConfirmation accountingDocumentConfirmation, String [] tokensExpr) throws Exception{	
 	...
 	protected AccountingDocumentConfirmation saveAccountingDocumentConfirmationDetail(YoubenbenUserContext userContext, AccountingDocumentConfirmation accountingDocumentConfirmation) throws Exception{	
 	...
 	public AccountingDocumentConfirmation loadAccountingDocumentConfirmation(YoubenbenUserContext userContext, String accountingDocumentConfirmationId, String [] tokensExpr) throws Exception{				
 	 ...
 	 public AccountingDocumentConfirmation searchAccountingDocumentConfirmation(YoubenbenUserContext userContext, String accountingDocumentConfirmationId, String textToSearch,String [] tokensExpr) throws Exception{				
 	...
 	protected AccountingDocumentConfirmation present(YoubenbenUserContext userContext, AccountingDocumentConfirmation accountingDocumentConfirmation, Map<String, Object> tokens) throws Exception {
 	...
 	public AccountingDocumentConfirmation loadAccountingDocumentConfirmationDetail(YoubenbenUserContext userContext, String accountingDocumentConfirmationId) throws Exception{	
 	...
 	public Object view(YoubenbenUserContext userContext, String accountingDocumentConfirmationId) throws Exception{	
 	...
 	protected AccountingDocumentConfirmation saveAccountingDocumentConfirmation(YoubenbenUserContext userContext, AccountingDocumentConfirmation accountingDocumentConfirmation, Map<String,Object>tokens) throws Exception{	
 		return accountingDocumentConfirmationDaoOf(userContext).save(accountingDocumentConfirmation, tokens);
 	}
 	protected AccountingDocumentConfirmation loadAccountingDocumentConfirmation(YoubenbenUserContext userContext, String accountingDocumentConfirmationId, Map<String,Object>tokens) throws Exception{	
		checkerOf(userContext).checkIdOfAccountingDocumentConfirmation(accountingDocumentConfirmationId);
		checkerOf(userContext).throwExceptionIfHasErrors( AccountingDocumentConfirmationManagerException.class);
 	...
 	protected<T extends BaseEntity> void addActions(YoubenbenUserContext userContext, AccountingDocumentConfirmation accountingDocumentConfirmation, Map<String, Object> tokens){
	...
	}// end method of protected<T extends BaseEntity> void addActions(YoubenbenUserContext userContext, AccountingDocumentConfirmation accountingDocumentConfirmation, Map<String, Object> tokens){
	...
	protected void checkParamsForUpdatingAccountingDocumentConfirmation(YoubenbenUserContext userContext,String accountingDocumentConfirmationId, int accountingDocumentConfirmationVersion, String property, String newValueExpr,String [] tokensExpr)throws Exception
	{
	...
	public AccountingDocumentConfirmation clone(YoubenbenUserContext userContext, String fromAccountingDocumentConfirmationId) throws Exception{
	...
	public AccountingDocumentConfirmation internalSaveAccountingDocumentConfirmation(YoubenbenUserContext userContext, AccountingDocumentConfirmation accountingDocumentConfirmation, Map<String,Object> options) throws Exception
	{
	...
	public AccountingDocumentConfirmation updateAccountingDocumentConfirmationProperty(YoubenbenUserContext userContext,String accountingDocumentConfirmationId, int accountingDocumentConfirmationVersion, String property, String newValueExpr,String [] tokensExpr) throws Exception
	{
		checkParamsForUpdatingAccountingDocumentConfirmation(userContext, accountingDocumentConfirmationId, accountingDocumentConfirmationVersion, property, newValueExpr, tokensExpr);
...
//--------------------------------------------------------------
	...
	public void delete(YoubenbenUserContext userContext, String accountingDocumentConfirmationId, int accountingDocumentConfirmationVersion) throws Exception {
	...
	public AccountingDocumentConfirmation forgetByAll(YoubenbenUserContext userContext, String accountingDocumentConfirmationId, int accountingDocumentConfirmationVersion) throws Exception {
		return forgetByAllInternal(userContext, accountingDocumentConfirmationId, accountingDocumentConfirmationVersion);
	}
	protected AccountingDocumentConfirmation forgetByAllInternal(YoubenbenUserContext userContext,
			String accountingDocumentConfirmationId, int accountingDocumentConfirmationVersion) throws Exception{
	...
	protected AccountingDocumentConfirmation breakWithAccountingDocumentByAccountingPeriod(YoubenbenUserContext userContext, String accountingDocumentConfirmationId, String accountingPeriodId,  String [] tokensExpr)
		 throws Exception{
	...
	protected AccountingDocumentConfirmation breakWithAccountingDocumentByDocumentType(YoubenbenUserContext userContext, String accountingDocumentConfirmationId, String documentTypeId,  String [] tokensExpr)
		 throws Exception{
	...
	protected AccountingDocumentConfirmation breakWithAccountingDocumentByCreation(YoubenbenUserContext userContext, String accountingDocumentConfirmationId, String creationId,  String [] tokensExpr)
		 throws Exception{
	...
	protected AccountingDocumentConfirmation breakWithAccountingDocumentByAuditing(YoubenbenUserContext userContext, String accountingDocumentConfirmationId, String auditingId,  String [] tokensExpr)
		 throws Exception{
	...
	protected AccountingDocumentConfirmation breakWithAccountingDocumentByPosting(YoubenbenUserContext userContext, String accountingDocumentConfirmationId, String postingId,  String [] tokensExpr)
		 throws Exception{
	...
	protected void checkParamsForUpdatingAccountingDocumentProperties(YoubenbenUserContext userContext, String accountingDocumentConfirmationId,String id,String name,Date accountingDocumentDate,String [] tokensExpr) throws Exception {
	...
	public  AccountingDocumentConfirmation updateAccountingDocumentProperties(YoubenbenUserContext userContext, String accountingDocumentConfirmationId, String id,String name,Date accountingDocumentDate, String [] tokensExpr) throws Exception
	{
	...
	protected AccountingDocument createAccountingDocument(YoubenbenUserContext userContext, String name, Date accountingDocumentDate, String accountingPeriodId, String documentTypeId, String creationId, String auditingId, String postingId) throws Exception{
	...
	protected void checkParamsForRemovingAccountingDocumentList(YoubenbenUserContext userContext, String accountingDocumentConfirmationId,
	...
	public  AccountingDocumentConfirmation removeAccountingDocumentList(YoubenbenUserContext userContext, String accountingDocumentConfirmationId,
			String accountingDocumentIds[],String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForRemovingAccountingDocument(YoubenbenUserContext userContext, String accountingDocumentConfirmationId,
	...
	public  AccountingDocumentConfirmation removeAccountingDocument(YoubenbenUserContext userContext, String accountingDocumentConfirmationId,
		String accountingDocumentId, int accountingDocumentVersion,String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForCopyingAccountingDocument(YoubenbenUserContext userContext, String accountingDocumentConfirmationId,
		String accountingDocumentId, int accountingDocumentVersion,String [] tokensExpr) throws Exception{
	...
	public  AccountingDocumentConfirmation copyAccountingDocumentFrom(YoubenbenUserContext userContext, String accountingDocumentConfirmationId,
		String accountingDocumentId, int accountingDocumentVersion,String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForUpdatingAccountingDocument(YoubenbenUserContext userContext, String accountingDocumentConfirmationId, String accountingDocumentId, int accountingDocumentVersion, String property, String newValueExpr,String [] tokensExpr) throws Exception{
	...
	public  AccountingDocumentConfirmation updateAccountingDocument(YoubenbenUserContext userContext, String accountingDocumentConfirmationId, String accountingDocumentId, int accountingDocumentVersion, String property, String newValueExpr,String [] tokensExpr)
			throws Exception{
	...
	*/
	...
	// -----------------------------------// list-of-view 处理 \\-----------------------------------
    protected void enhanceForListOfView(YoubenbenUserContext userContext,SmartList<AccountingDocumentConfirmation> list) throws Exception {
  ...
  // -----------------------------------\\ list-of-view 处理 //-----------------------------------v
	 ...
	 * @throws Exception
	 */
 	public Object wxappview(YoubenbenUserContext userContext, String accountingDocumentConfirmationId) throws Exception{
	  SerializeScope vscope = YoubenbenViewScope.getInstance().getAccountingDocumentConfirmationDetailScope().clone();
