...
public class AccountingDocumentConfirmationJDBCTemplateDAO extends YoubenbenBaseDAOImpl implements AccountingDocumentConfirmationDAO{
	...
	*/
	...
	public SmartList<AccountingDocumentConfirmation> loadAll() {
	    return this.loadAll(getAccountingDocumentConfirmationMapper());
	}
    ...
    public SmartList<AccountingDocumentConfirmation> requestCandidateAccountingDocumentConfirmationForAccountingDocument(YoubenbenUserContext userContext, String ownerClass, String id, String filterKey, int pageNo, int pageSize) throws Exception {
		...
		return findAllCandidateByFilter(AccountingDocumentConfirmationTable.COLUMN_WHO, null, filterKey, pageNo, pageSize, getAccountingDocumentConfirmationMapper());
    }
