...
public class CandidateContainerManagerImpl extends CustomYoubenbenCheckerManager implements CandidateContainerManager, BusinessHandler{
	...
	@Override
	public CandidateContainerDAO daoOf(YoubenbenUserContext userContext) {
	...
	protected void throwExceptionWithMessage(String value) throws CandidateContainerManagerException{
 	...
 	protected CandidateContainer saveCandidateContainer(YoubenbenUserContext userContext, CandidateContainer candidateContainer, String [] tokensExpr) throws Exception{	
 	...
 	protected CandidateContainer saveCandidateContainerDetail(YoubenbenUserContext userContext, CandidateContainer candidateContainer) throws Exception{	
 	...
 	public CandidateContainer loadCandidateContainer(YoubenbenUserContext userContext, String candidateContainerId, String [] tokensExpr) throws Exception{				
 	 ...
 	 public CandidateContainer searchCandidateContainer(YoubenbenUserContext userContext, String candidateContainerId, String textToSearch,String [] tokensExpr) throws Exception{				
 	...
 	protected CandidateContainer present(YoubenbenUserContext userContext, CandidateContainer candidateContainer, Map<String, Object> tokens) throws Exception {
 	...
 	public CandidateContainer loadCandidateContainerDetail(YoubenbenUserContext userContext, String candidateContainerId) throws Exception{	
 	...
 	public Object view(YoubenbenUserContext userContext, String candidateContainerId) throws Exception{	
 		CandidateContainer candidateContainer = loadCandidateContainer( userContext, candidateContainerId, viewTokens());
 		return present(userContext,candidateContainer, allTokens());
		
 	}
 	protected CandidateContainer saveCandidateContainer(YoubenbenUserContext userContext, CandidateContainer candidateContainer, Map<String,Object>tokens) throws Exception{	
 		return candidateContainerDaoOf(userContext).save(candidateContainer, tokens);
 	}
 	protected CandidateContainer loadCandidateContainer(YoubenbenUserContext userContext, String candidateContainerId, Map<String,Object>tokens) throws Exception{	
		checkerOf(userContext).checkIdOfCandidateContainer(candidateContainerId);
		checkerOf(userContext).throwExceptionIfHasErrors( CandidateContainerManagerException.class);
 	...
 	protected<T extends BaseEntity> void addActions(YoubenbenUserContext userContext, CandidateContainer candidateContainer, Map<String, Object> tokens){
	...
	}// end method of protected<T extends BaseEntity> void addActions(YoubenbenUserContext userContext, CandidateContainer candidateContainer, Map<String, Object> tokens){
	...
	protected void checkParamsForUpdatingCandidateContainer(YoubenbenUserContext userContext,String candidateContainerId, int candidateContainerVersion, String property, String newValueExpr,String [] tokensExpr)throws Exception
	{
	...
	public CandidateContainer clone(YoubenbenUserContext userContext, String fromCandidateContainerId) throws Exception{
	...
	public CandidateContainer internalSaveCandidateContainer(YoubenbenUserContext userContext, CandidateContainer candidateContainer, Map<String,Object> options) throws Exception
	{
	...
	public CandidateContainer updateCandidateContainerProperty(YoubenbenUserContext userContext,String candidateContainerId, int candidateContainerVersion, String property, String newValueExpr,String [] tokensExpr) throws Exception
	{
		checkParamsForUpdatingCandidateContainer(userContext, candidateContainerId, candidateContainerVersion, property, newValueExpr, tokensExpr);
...
//--------------------------------------------------------------
	...
	public void delete(YoubenbenUserContext userContext, String candidateContainerId, int candidateContainerVersion) throws Exception {
	...
	public CandidateContainer forgetByAll(YoubenbenUserContext userContext, String candidateContainerId, int candidateContainerVersion) throws Exception {
		return forgetByAllInternal(userContext, candidateContainerId, candidateContainerVersion);
	}
	protected CandidateContainer forgetByAllInternal(YoubenbenUserContext userContext,
			String candidateContainerId, int candidateContainerVersion) throws Exception{
	...
	protected void checkParamsForAddingCandidateElement(YoubenbenUserContext userContext, String candidateContainerId, String name, String type, String image,String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForUpdatingCandidateElementProperties(YoubenbenUserContext userContext, String candidateContainerId,String id,String name,String type,String image,String [] tokensExpr) throws Exception {
	...
	public  CandidateContainer updateCandidateElementProperties(YoubenbenUserContext userContext, String candidateContainerId, String id,String name,String type,String image, String [] tokensExpr) throws Exception
	{
	...
	protected CandidateElement createCandidateElement(YoubenbenUserContext userContext, String name, String type, String image) throws Exception{
	...
	protected void checkParamsForRemovingCandidateElementList(YoubenbenUserContext userContext, String candidateContainerId,
	...
	public  CandidateContainer removeCandidateElementList(YoubenbenUserContext userContext, String candidateContainerId,
			String candidateElementIds[],String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForRemovingCandidateElement(YoubenbenUserContext userContext, String candidateContainerId,
	...
	public  CandidateContainer removeCandidateElement(YoubenbenUserContext userContext, String candidateContainerId,
		String candidateElementId, int candidateElementVersion,String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForCopyingCandidateElement(YoubenbenUserContext userContext, String candidateContainerId,
		String candidateElementId, int candidateElementVersion,String [] tokensExpr) throws Exception{
	...
	public  CandidateContainer copyCandidateElementFrom(YoubenbenUserContext userContext, String candidateContainerId,
		String candidateElementId, int candidateElementVersion,String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForUpdatingCandidateElement(YoubenbenUserContext userContext, String candidateContainerId, String candidateElementId, int candidateElementVersion, String property, String newValueExpr,String [] tokensExpr) throws Exception{
	...
	public  CandidateContainer updateCandidateElement(YoubenbenUserContext userContext, String candidateContainerId, String candidateElementId, int candidateElementVersion, String property, String newValueExpr,String [] tokensExpr)
			throws Exception{
	...
	*/
	...
	// -----------------------------------// list-of-view 处理 \\-----------------------------------
    protected void enhanceForListOfView(YoubenbenUserContext userContext,SmartList<CandidateContainer> list) throws Exception {
  ...
  // -----------------------------------\\ list-of-view 处理 //-----------------------------------v
	 ...
	 * @throws Exception
	 */
 	public Object wxappview(YoubenbenUserContext userContext, String candidateContainerId) throws Exception{
	  SerializeScope vscope = YoubenbenViewScope.getInstance().getCandidateContainerDetailScope().clone();
    ...
    String pageTitle = "候选人容器"+"详情";
		...
		vscope.field("candidateElementListSection", YoubenbenListOfViewScope.getInstance()
