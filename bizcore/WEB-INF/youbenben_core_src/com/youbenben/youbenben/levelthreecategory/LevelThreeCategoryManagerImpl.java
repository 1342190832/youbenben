...
import com.youbenben.youbenben.leveltwocategory.CandidateLevelTwoCategory;
...
public class LevelThreeCategoryManagerImpl extends CustomYoubenbenCheckerManager implements LevelThreeCategoryManager, BusinessHandler{
	...
	@Override
	public LevelThreeCategoryDAO daoOf(YoubenbenUserContext userContext) {
	...
	protected void throwExceptionWithMessage(String value) throws LevelThreeCategoryManagerException{
 	...
 	protected LevelThreeCategory saveLevelThreeCategory(YoubenbenUserContext userContext, LevelThreeCategory levelThreeCategory, String [] tokensExpr) throws Exception{	
 	...
 	protected LevelThreeCategory saveLevelThreeCategoryDetail(YoubenbenUserContext userContext, LevelThreeCategory levelThreeCategory) throws Exception{	
 	...
 	public LevelThreeCategory loadLevelThreeCategory(YoubenbenUserContext userContext, String levelThreeCategoryId, String [] tokensExpr) throws Exception{				
 	 ...
 	 public LevelThreeCategory searchLevelThreeCategory(YoubenbenUserContext userContext, String levelThreeCategoryId, String textToSearch,String [] tokensExpr) throws Exception{				
 	...
 	protected LevelThreeCategory present(YoubenbenUserContext userContext, LevelThreeCategory levelThreeCategory, Map<String, Object> tokens) throws Exception {
 	...
 	public LevelThreeCategory loadLevelThreeCategoryDetail(YoubenbenUserContext userContext, String levelThreeCategoryId) throws Exception{	
 	...
 	public Object view(YoubenbenUserContext userContext, String levelThreeCategoryId) throws Exception{	
 		LevelThreeCategory levelThreeCategory = loadLevelThreeCategory( userContext, levelThreeCategoryId, viewTokens());
 		return present(userContext,levelThreeCategory, allTokens());
		
 	}
 	protected LevelThreeCategory saveLevelThreeCategory(YoubenbenUserContext userContext, LevelThreeCategory levelThreeCategory, Map<String,Object>tokens) throws Exception{	
 		return levelThreeCategoryDaoOf(userContext).save(levelThreeCategory, tokens);
 	}
 	protected LevelThreeCategory loadLevelThreeCategory(YoubenbenUserContext userContext, String levelThreeCategoryId, Map<String,Object>tokens) throws Exception{	
		checkerOf(userContext).checkIdOfLevelThreeCategory(levelThreeCategoryId);
		checkerOf(userContext).throwExceptionIfHasErrors( LevelThreeCategoryManagerException.class);
 	...
 	protected<T extends BaseEntity> void addActions(YoubenbenUserContext userContext, LevelThreeCategory levelThreeCategory, Map<String, Object> tokens){
	...
	}// end method of protected<T extends BaseEntity> void addActions(YoubenbenUserContext userContext, LevelThreeCategory levelThreeCategory, Map<String, Object> tokens){
	...
	protected void checkParamsForUpdatingLevelThreeCategory(YoubenbenUserContext userContext,String levelThreeCategoryId, int levelThreeCategoryVersion, String property, String newValueExpr,String [] tokensExpr)throws Exception
	{
	...
	public LevelThreeCategory clone(YoubenbenUserContext userContext, String fromLevelThreeCategoryId) throws Exception{
	...
	public LevelThreeCategory internalSaveLevelThreeCategory(YoubenbenUserContext userContext, LevelThreeCategory levelThreeCategory, Map<String,Object> options) throws Exception
	{
	...
	public LevelThreeCategory updateLevelThreeCategoryProperty(YoubenbenUserContext userContext,String levelThreeCategoryId, int levelThreeCategoryVersion, String property, String newValueExpr,String [] tokensExpr) throws Exception
	{
		checkParamsForUpdatingLevelThreeCategory(userContext, levelThreeCategoryId, levelThreeCategoryVersion, property, newValueExpr, tokensExpr);
	...
	protected void checkParamsForTransferingAnotherParentCategory(YoubenbenUserContext userContext, String levelThreeCategoryId, String anotherParentCategoryId) throws Exception
 	{
	...
	public CandidateLevelTwoCategory requestCandidateParentCategory(YoubenbenUserContext userContext, String ownerClass, String id, String filterKey, int pageNo) throws Exception {
 ...
 //--------------------------------------------------------------
 	...
 	protected LevelTwoCategory loadLevelTwoCategory(YoubenbenUserContext userContext, String newParentCategoryId, Map<String,Object> options) throws Exception
 	{
	...
	public void delete(YoubenbenUserContext userContext, String levelThreeCategoryId, int levelThreeCategoryVersion) throws Exception {
	...
	public LevelThreeCategory forgetByAll(YoubenbenUserContext userContext, String levelThreeCategoryId, int levelThreeCategoryVersion) throws Exception {
		return forgetByAllInternal(userContext, levelThreeCategoryId, levelThreeCategoryVersion);
	}
	protected LevelThreeCategory forgetByAllInternal(YoubenbenUserContext userContext,
			String levelThreeCategoryId, int levelThreeCategoryVersion) throws Exception{
	...
	protected void checkParamsForAddingProduct(YoubenbenUserContext userContext, String levelThreeCategoryId, String name, String origin, String remark, String brand, String picture,String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForUpdatingProductProperties(YoubenbenUserContext userContext, String levelThreeCategoryId,String id,String name,String origin,String remark,String brand,String picture,String [] tokensExpr) throws Exception {
	...
	public  LevelThreeCategory updateProductProperties(YoubenbenUserContext userContext, String levelThreeCategoryId, String id,String name,String origin,String remark,String brand,String picture, String [] tokensExpr) throws Exception
	{
	...
	protected Product createProduct(YoubenbenUserContext userContext, String name, String origin, String remark, String brand, String picture) throws Exception{
	...
	protected void checkParamsForRemovingProductList(YoubenbenUserContext userContext, String levelThreeCategoryId,
	...
	public  LevelThreeCategory removeProductList(YoubenbenUserContext userContext, String levelThreeCategoryId,
			String productIds[],String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForRemovingProduct(YoubenbenUserContext userContext, String levelThreeCategoryId,
	...
	public  LevelThreeCategory removeProduct(YoubenbenUserContext userContext, String levelThreeCategoryId,
		String productId, int productVersion,String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForCopyingProduct(YoubenbenUserContext userContext, String levelThreeCategoryId,
		String productId, int productVersion,String [] tokensExpr) throws Exception{
	...
	public  LevelThreeCategory copyProductFrom(YoubenbenUserContext userContext, String levelThreeCategoryId,
		String productId, int productVersion,String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForUpdatingProduct(YoubenbenUserContext userContext, String levelThreeCategoryId, String productId, int productVersion, String property, String newValueExpr,String [] tokensExpr) throws Exception{
	...
	public  LevelThreeCategory updateProduct(YoubenbenUserContext userContext, String levelThreeCategoryId, String productId, int productVersion, String property, String newValueExpr,String [] tokensExpr)
			throws Exception{
	...
	*/
	...
	// -----------------------------------// list-of-view 处理 \\-----------------------------------
    protected void enhanceForListOfView(YoubenbenUserContext userContext,SmartList<LevelThreeCategory> list) throws Exception {
    	if (list == null || list.isEmpty()){
    		return;
    	}
		List<LevelTwoCategory> parentCategoryList = YoubenbenBaseUtils.collectReferencedObjectWithType(userContext, list, LevelTwoCategory.class);
  ...
  // -----------------------------------\\ list-of-view 处理 //-----------------------------------v
	 ...
	 * @throws Exception
	 */
 	public Object wxappview(YoubenbenUserContext userContext, String levelThreeCategoryId) throws Exception{
	  SerializeScope vscope = YoubenbenViewScope.getInstance().getLevelThreeCategoryDetailScope().clone();
    ...
    String pageTitle = "三级分类"+"详情";
		...
		vscope.field("productListSection", YoubenbenListOfViewScope.getInstance()
