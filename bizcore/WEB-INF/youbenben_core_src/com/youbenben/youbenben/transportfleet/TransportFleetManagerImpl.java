...
public class TransportFleetManagerImpl extends CustomYoubenbenCheckerManager implements TransportFleetManager, BusinessHandler{
	...
	@Override
	public TransportFleetDAO daoOf(YoubenbenUserContext userContext) {
	...
	protected void throwExceptionWithMessage(String value) throws TransportFleetManagerException{
 	...
 	protected TransportFleet saveTransportFleet(YoubenbenUserContext userContext, TransportFleet transportFleet, String [] tokensExpr) throws Exception{	
 	...
 	protected TransportFleet saveTransportFleetDetail(YoubenbenUserContext userContext, TransportFleet transportFleet) throws Exception{	
 	...
 	public TransportFleet loadTransportFleet(YoubenbenUserContext userContext, String transportFleetId, String [] tokensExpr) throws Exception{				
 	 ...
 	 public TransportFleet searchTransportFleet(YoubenbenUserContext userContext, String transportFleetId, String textToSearch,String [] tokensExpr) throws Exception{				
 	...
 	protected TransportFleet present(YoubenbenUserContext userContext, TransportFleet transportFleet, Map<String, Object> tokens) throws Exception {
 	...
 	public TransportFleet loadTransportFleetDetail(YoubenbenUserContext userContext, String transportFleetId) throws Exception{	
 	...
 	public Object view(YoubenbenUserContext userContext, String transportFleetId) throws Exception{	
 		TransportFleet transportFleet = loadTransportFleet( userContext, transportFleetId, viewTokens());
 		return present(userContext,transportFleet, allTokens());
		
 	}
 	protected TransportFleet saveTransportFleet(YoubenbenUserContext userContext, TransportFleet transportFleet, Map<String,Object>tokens) throws Exception{	
 		return transportFleetDaoOf(userContext).save(transportFleet, tokens);
 	}
 	protected TransportFleet loadTransportFleet(YoubenbenUserContext userContext, String transportFleetId, Map<String,Object>tokens) throws Exception{	
		checkerOf(userContext).checkIdOfTransportFleet(transportFleetId);
		checkerOf(userContext).throwExceptionIfHasErrors( TransportFleetManagerException.class);
 	...
 	protected<T extends BaseEntity> void addActions(YoubenbenUserContext userContext, TransportFleet transportFleet, Map<String, Object> tokens){
	...
	}// end method of protected<T extends BaseEntity> void addActions(YoubenbenUserContext userContext, TransportFleet transportFleet, Map<String, Object> tokens){
	...
	protected void checkParamsForUpdatingTransportFleet(YoubenbenUserContext userContext,String transportFleetId, int transportFleetVersion, String property, String newValueExpr,String [] tokensExpr)throws Exception
	{
	...
	public TransportFleet clone(YoubenbenUserContext userContext, String fromTransportFleetId) throws Exception{
	...
	public TransportFleet internalSaveTransportFleet(YoubenbenUserContext userContext, TransportFleet transportFleet, Map<String,Object> options) throws Exception
	{
	...
	public TransportFleet updateTransportFleetProperty(YoubenbenUserContext userContext,String transportFleetId, int transportFleetVersion, String property, String newValueExpr,String [] tokensExpr) throws Exception
	{
		checkParamsForUpdatingTransportFleet(userContext, transportFleetId, transportFleetVersion, property, newValueExpr, tokensExpr);
	...
	protected void checkParamsForTransferingAnotherOwner(YoubenbenUserContext userContext, String transportFleetId, String anotherOwnerId) throws Exception
 	{
 ...
 //--------------------------------------------------------------
	...
	public void delete(YoubenbenUserContext userContext, String transportFleetId, int transportFleetVersion) throws Exception {
	...
	public TransportFleet forgetByAll(YoubenbenUserContext userContext, String transportFleetId, int transportFleetVersion) throws Exception {
		return forgetByAllInternal(userContext, transportFleetId, transportFleetVersion);
	}
	protected TransportFleet forgetByAllInternal(YoubenbenUserContext userContext,
			String transportFleetId, int transportFleetVersion) throws Exception{
	...
	protected TransportFleet breakWithTransportTaskByEnd(YoubenbenUserContext userContext, String transportFleetId, String endId,  String [] tokensExpr)
		 throws Exception{
	...
	protected TransportFleet breakWithTransportTaskByDriver(YoubenbenUserContext userContext, String transportFleetId, String driverId,  String [] tokensExpr)
		 throws Exception{
	...
	protected TransportFleet breakWithTransportTaskByTruck(YoubenbenUserContext userContext, String transportFleetId, String truckId,  String [] tokensExpr)
		 throws Exception{
	...
	protected void checkParamsForAddingTransportTruck(YoubenbenUserContext userContext, String transportFleetId, String name, String plateNumber, String contactNumber, String vehicleLicenseNumber, String engineNumber, Date makeDate, String mileage, String bodyColor,String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForUpdatingTransportTruckProperties(YoubenbenUserContext userContext, String transportFleetId,String id,String name,String plateNumber,String contactNumber,String vehicleLicenseNumber,String engineNumber,Date makeDate,String mileage,String bodyColor,String [] tokensExpr) throws Exception {
	...
	public  TransportFleet updateTransportTruckProperties(YoubenbenUserContext userContext, String transportFleetId, String id,String name,String plateNumber,String contactNumber,String vehicleLicenseNumber,String engineNumber,Date makeDate,String mileage,String bodyColor, String [] tokensExpr) throws Exception
	{
	...
	protected TransportTruck createTransportTruck(YoubenbenUserContext userContext, String name, String plateNumber, String contactNumber, String vehicleLicenseNumber, String engineNumber, Date makeDate, String mileage, String bodyColor) throws Exception{
	...
	protected void checkParamsForRemovingTransportTruckList(YoubenbenUserContext userContext, String transportFleetId,
	...
	public  TransportFleet removeTransportTruckList(YoubenbenUserContext userContext, String transportFleetId,
			String transportTruckIds[],String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForRemovingTransportTruck(YoubenbenUserContext userContext, String transportFleetId,
	...
	public  TransportFleet removeTransportTruck(YoubenbenUserContext userContext, String transportFleetId,
		String transportTruckId, int transportTruckVersion,String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForCopyingTransportTruck(YoubenbenUserContext userContext, String transportFleetId,
		String transportTruckId, int transportTruckVersion,String [] tokensExpr) throws Exception{
	...
	public  TransportFleet copyTransportTruckFrom(YoubenbenUserContext userContext, String transportFleetId,
		String transportTruckId, int transportTruckVersion,String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForUpdatingTransportTruck(YoubenbenUserContext userContext, String transportFleetId, String transportTruckId, int transportTruckVersion, String property, String newValueExpr,String [] tokensExpr) throws Exception{
	...
	public  TransportFleet updateTransportTruck(YoubenbenUserContext userContext, String transportFleetId, String transportTruckId, int transportTruckVersion, String property, String newValueExpr,String [] tokensExpr)
			throws Exception{
	...
	*/
	...
	protected void checkParamsForAddingTruckDriver(YoubenbenUserContext userContext, String transportFleetId, String name, String driverLicenseNumber, String contactNumber,String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForUpdatingTruckDriverProperties(YoubenbenUserContext userContext, String transportFleetId,String id,String name,String driverLicenseNumber,String contactNumber,String [] tokensExpr) throws Exception {
	...
	public  TransportFleet updateTruckDriverProperties(YoubenbenUserContext userContext, String transportFleetId, String id,String name,String driverLicenseNumber,String contactNumber, String [] tokensExpr) throws Exception
	{
	...
	protected TruckDriver createTruckDriver(YoubenbenUserContext userContext, String name, String driverLicenseNumber, String contactNumber) throws Exception{
	...
	protected void checkParamsForRemovingTruckDriverList(YoubenbenUserContext userContext, String transportFleetId,
	...
	public  TransportFleet removeTruckDriverList(YoubenbenUserContext userContext, String transportFleetId,
			String truckDriverIds[],String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForRemovingTruckDriver(YoubenbenUserContext userContext, String transportFleetId,
	...
	public  TransportFleet removeTruckDriver(YoubenbenUserContext userContext, String transportFleetId,
		String truckDriverId, int truckDriverVersion,String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForCopyingTruckDriver(YoubenbenUserContext userContext, String transportFleetId,
		String truckDriverId, int truckDriverVersion,String [] tokensExpr) throws Exception{
	...
	public  TransportFleet copyTruckDriverFrom(YoubenbenUserContext userContext, String transportFleetId,
		String truckDriverId, int truckDriverVersion,String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForUpdatingTruckDriver(YoubenbenUserContext userContext, String transportFleetId, String truckDriverId, int truckDriverVersion, String property, String newValueExpr,String [] tokensExpr) throws Exception{
	...
	public  TransportFleet updateTruckDriver(YoubenbenUserContext userContext, String transportFleetId, String truckDriverId, int truckDriverVersion, String property, String newValueExpr,String [] tokensExpr)
			throws Exception{
	...
	*/
	...
	protected void checkParamsForAddingTransportTask(YoubenbenUserContext userContext, String transportFleetId, String name, String start, Date beginTime, String endId, String driverId, String truckId, BigDecimal latitude, BigDecimal longitude,String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForUpdatingTransportTaskProperties(YoubenbenUserContext userContext, String transportFleetId,String id,String name,String start,Date beginTime,BigDecimal latitude,BigDecimal longitude,String [] tokensExpr) throws Exception {
	...
	public  TransportFleet updateTransportTaskProperties(YoubenbenUserContext userContext, String transportFleetId, String id,String name,String start,Date beginTime,BigDecimal latitude,BigDecimal longitude, String [] tokensExpr) throws Exception
	{
	...
	protected TransportTask createTransportTask(YoubenbenUserContext userContext, String name, String start, Date beginTime, String endId, String driverId, String truckId, BigDecimal latitude, BigDecimal longitude) throws Exception{
	...
	protected void checkParamsForRemovingTransportTaskList(YoubenbenUserContext userContext, String transportFleetId,
	...
	public  TransportFleet removeTransportTaskList(YoubenbenUserContext userContext, String transportFleetId,
			String transportTaskIds[],String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForRemovingTransportTask(YoubenbenUserContext userContext, String transportFleetId,
	...
	public  TransportFleet removeTransportTask(YoubenbenUserContext userContext, String transportFleetId,
		String transportTaskId, int transportTaskVersion,String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForCopyingTransportTask(YoubenbenUserContext userContext, String transportFleetId,
		String transportTaskId, int transportTaskVersion,String [] tokensExpr) throws Exception{
	...
	public  TransportFleet copyTransportTaskFrom(YoubenbenUserContext userContext, String transportFleetId,
		String transportTaskId, int transportTaskVersion,String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForUpdatingTransportTask(YoubenbenUserContext userContext, String transportFleetId, String transportTaskId, int transportTaskVersion, String property, String newValueExpr,String [] tokensExpr) throws Exception{
	...
	public  TransportFleet updateTransportTask(YoubenbenUserContext userContext, String transportFleetId, String transportTaskId, int transportTaskVersion, String property, String newValueExpr,String [] tokensExpr)
			throws Exception{
	...
	*/
	...
	// -----------------------------------// list-of-view 处理 \\-----------------------------------
    protected void enhanceForListOfView(YoubenbenUserContext userContext,SmartList<TransportFleet> list) throws Exception {
  ...
  // -----------------------------------\\ list-of-view 处理 //-----------------------------------v
	 ...
	 * @throws Exception
	 */
 	public Object wxappview(YoubenbenUserContext userContext, String transportFleetId) throws Exception{
	  SerializeScope vscope = YoubenbenViewScope.getInstance().getTransportFleetDetailScope().clone();
    ...
    String pageTitle = "运输车队"+"详情";
		...
		vscope.field("transportTruckListSection", YoubenbenListOfViewScope.getInstance()
		...
		vscope.field("truckDriverListSection", YoubenbenListOfViewScope.getInstance()
