...
public class TransportFleetJDBCTemplateDAO extends YoubenbenBaseDAOImpl implements TransportFleetDAO{
	...
	*/
    ...
    public SmartList<TransportFleet> requestCandidateTransportFleetForTransportTruck(YoubenbenUserContext userContext, String ownerClass, String id, String filterKey, int pageNo, int pageSize) throws Exception {
    ...
    public SmartList<TransportFleet> requestCandidateTransportFleetForTruckDriver(YoubenbenUserContext userContext, String ownerClass, String id, String filterKey, int pageNo, int pageSize) throws Exception {
        // NOTE: by default, ignore owner info, just return all by filter key.
		// You need override this method if you have different candidate-logic
		return findAllCandidateByFilter(TransportFleetTable.COLUMN_NAME, TransportFleetTable.COLUMN_OWNER, filterKey, pageNo, pageSize, getTransportFleetMapper());
    }
		
    public SmartList<TransportFleet> requestCandidateTransportFleetForTransportTask(YoubenbenUserContext userContext, String ownerClass, String id, String filterKey, int pageNo, int pageSize) throws Exception {
        // NOTE: by default, ignore owner info, just return all by filter key.
		// You need override this method if you have different candidate-logic
		return findAllCandidateByFilter(TransportFleetTable.COLUMN_NAME, TransportFleetTable.COLUMN_OWNER, filterKey, pageNo, pageSize, getTransportFleetMapper());
    }
	...
	public SmartList<TransportTruck> loadOurTransportTruckList(YoubenbenUserContext userContext, List<TransportFleet> us, Map<String,Object> options) throws Exception{
	...
	public SmartList<TruckDriver> loadOurTruckDriverList(YoubenbenUserContext userContext, List<TransportFleet> us, Map<String,Object> options) throws Exception{
		if (us == null || us.isEmpty()){
			return new SmartList<>();
		}
		Set<String> ids = us.stream().map(it->it.getId()).collect(Collectors.toSet());
	...
	public SmartList<TransportTask> loadOurTransportTaskList(YoubenbenUserContext userContext, List<TransportFleet> us, Map<String,Object> options) throws Exception{
		if (us == null || us.isEmpty()){
			return new SmartList<>();
		}
		Set<String> ids = us.stream().map(it->it.getId()).collect(Collectors.toSet());
