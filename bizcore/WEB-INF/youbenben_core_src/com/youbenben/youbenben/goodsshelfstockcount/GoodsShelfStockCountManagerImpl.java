...
public class GoodsShelfStockCountManagerImpl extends CustomYoubenbenCheckerManager implements GoodsShelfStockCountManager, BusinessHandler{
	...
	@Override
	public GoodsShelfStockCountDAO daoOf(YoubenbenUserContext userContext) {
	...
	protected void throwExceptionWithMessage(String value) throws GoodsShelfStockCountManagerException{
 	...
 	protected GoodsShelfStockCount saveGoodsShelfStockCount(YoubenbenUserContext userContext, GoodsShelfStockCount goodsShelfStockCount, String [] tokensExpr) throws Exception{	
 	...
 	protected GoodsShelfStockCount saveGoodsShelfStockCountDetail(YoubenbenUserContext userContext, GoodsShelfStockCount goodsShelfStockCount) throws Exception{	
 	...
 	public GoodsShelfStockCount loadGoodsShelfStockCount(YoubenbenUserContext userContext, String goodsShelfStockCountId, String [] tokensExpr) throws Exception{				
 	 ...
 	 public GoodsShelfStockCount searchGoodsShelfStockCount(YoubenbenUserContext userContext, String goodsShelfStockCountId, String textToSearch,String [] tokensExpr) throws Exception{				
 	...
 	protected GoodsShelfStockCount present(YoubenbenUserContext userContext, GoodsShelfStockCount goodsShelfStockCount, Map<String, Object> tokens) throws Exception {
 	...
 	public GoodsShelfStockCount loadGoodsShelfStockCountDetail(YoubenbenUserContext userContext, String goodsShelfStockCountId) throws Exception{	
 	...
 	public Object view(YoubenbenUserContext userContext, String goodsShelfStockCountId) throws Exception{	
 		GoodsShelfStockCount goodsShelfStockCount = loadGoodsShelfStockCount( userContext, goodsShelfStockCountId, viewTokens());
 		return present(userContext,goodsShelfStockCount, allTokens());
		
 	}
 	protected GoodsShelfStockCount saveGoodsShelfStockCount(YoubenbenUserContext userContext, GoodsShelfStockCount goodsShelfStockCount, Map<String,Object>tokens) throws Exception{	
 		return goodsShelfStockCountDaoOf(userContext).save(goodsShelfStockCount, tokens);
 	}
 	protected GoodsShelfStockCount loadGoodsShelfStockCount(YoubenbenUserContext userContext, String goodsShelfStockCountId, Map<String,Object>tokens) throws Exception{	
		checkerOf(userContext).checkIdOfGoodsShelfStockCount(goodsShelfStockCountId);
		checkerOf(userContext).throwExceptionIfHasErrors( GoodsShelfStockCountManagerException.class);
 	...
 	protected<T extends BaseEntity> void addActions(YoubenbenUserContext userContext, GoodsShelfStockCount goodsShelfStockCount, Map<String, Object> tokens){
	...
	}// end method of protected<T extends BaseEntity> void addActions(YoubenbenUserContext userContext, GoodsShelfStockCount goodsShelfStockCount, Map<String, Object> tokens){
	...
	protected void checkParamsForUpdatingGoodsShelfStockCount(YoubenbenUserContext userContext,String goodsShelfStockCountId, int goodsShelfStockCountVersion, String property, String newValueExpr,String [] tokensExpr)throws Exception
	{
	...
	public GoodsShelfStockCount clone(YoubenbenUserContext userContext, String fromGoodsShelfStockCountId) throws Exception{
	...
	public GoodsShelfStockCount internalSaveGoodsShelfStockCount(YoubenbenUserContext userContext, GoodsShelfStockCount goodsShelfStockCount, Map<String,Object> options) throws Exception
	{
	...
	public GoodsShelfStockCount updateGoodsShelfStockCountProperty(YoubenbenUserContext userContext,String goodsShelfStockCountId, int goodsShelfStockCountVersion, String property, String newValueExpr,String [] tokensExpr) throws Exception
	{
		checkParamsForUpdatingGoodsShelfStockCount(userContext, goodsShelfStockCountId, goodsShelfStockCountVersion, property, newValueExpr, tokensExpr);
	...
	protected void checkParamsForTransferingAnotherShelf(YoubenbenUserContext userContext, String goodsShelfStockCountId, String anotherShelfId) throws Exception
 	{
	...
	public CandidateGoodsShelf requestCandidateShelf(YoubenbenUserContext userContext, String ownerClass, String id, String filterKey, int pageNo) throws Exception {
 ...
 //--------------------------------------------------------------
 	...
 	protected GoodsShelf loadGoodsShelf(YoubenbenUserContext userContext, String newShelfId, Map<String,Object> options) throws Exception
 	{
	...
	public void delete(YoubenbenUserContext userContext, String goodsShelfStockCountId, int goodsShelfStockCountVersion) throws Exception {
	...
	public GoodsShelfStockCount forgetByAll(YoubenbenUserContext userContext, String goodsShelfStockCountId, int goodsShelfStockCountVersion) throws Exception {
		return forgetByAllInternal(userContext, goodsShelfStockCountId, goodsShelfStockCountVersion);
	}
	protected GoodsShelfStockCount forgetByAllInternal(YoubenbenUserContext userContext,
			String goodsShelfStockCountId, int goodsShelfStockCountVersion) throws Exception{
	...
	protected void checkParamsForAddingStockCountIssueTrack(YoubenbenUserContext userContext, String goodsShelfStockCountId, String title, Date countTime, String summary,String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForUpdatingStockCountIssueTrackProperties(YoubenbenUserContext userContext, String goodsShelfStockCountId,String id,String title,Date countTime,String summary,String [] tokensExpr) throws Exception {
	...
	public  GoodsShelfStockCount updateStockCountIssueTrackProperties(YoubenbenUserContext userContext, String goodsShelfStockCountId, String id,String title,Date countTime,String summary, String [] tokensExpr) throws Exception
	{
	...
	protected StockCountIssueTrack createStockCountIssueTrack(YoubenbenUserContext userContext, String title, Date countTime, String summary) throws Exception{
	...
	protected void checkParamsForRemovingStockCountIssueTrackList(YoubenbenUserContext userContext, String goodsShelfStockCountId,
	...
	public  GoodsShelfStockCount removeStockCountIssueTrackList(YoubenbenUserContext userContext, String goodsShelfStockCountId,
			String stockCountIssueTrackIds[],String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForRemovingStockCountIssueTrack(YoubenbenUserContext userContext, String goodsShelfStockCountId,
	...
	public  GoodsShelfStockCount removeStockCountIssueTrack(YoubenbenUserContext userContext, String goodsShelfStockCountId,
		String stockCountIssueTrackId, int stockCountIssueTrackVersion,String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForCopyingStockCountIssueTrack(YoubenbenUserContext userContext, String goodsShelfStockCountId,
		String stockCountIssueTrackId, int stockCountIssueTrackVersion,String [] tokensExpr) throws Exception{
	...
	public  GoodsShelfStockCount copyStockCountIssueTrackFrom(YoubenbenUserContext userContext, String goodsShelfStockCountId,
		String stockCountIssueTrackId, int stockCountIssueTrackVersion,String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForUpdatingStockCountIssueTrack(YoubenbenUserContext userContext, String goodsShelfStockCountId, String stockCountIssueTrackId, int stockCountIssueTrackVersion, String property, String newValueExpr,String [] tokensExpr) throws Exception{
	...
	public  GoodsShelfStockCount updateStockCountIssueTrack(YoubenbenUserContext userContext, String goodsShelfStockCountId, String stockCountIssueTrackId, int stockCountIssueTrackVersion, String property, String newValueExpr,String [] tokensExpr)
			throws Exception{
	...
	*/
	...
	// -----------------------------------// list-of-view 处理 \\-----------------------------------
    protected void enhanceForListOfView(YoubenbenUserContext userContext,SmartList<GoodsShelfStockCount> list) throws Exception {
    	if (list == null || list.isEmpty()){
    		return;
    	}
		List<GoodsShelf> shelfList = YoubenbenBaseUtils.collectReferencedObjectWithType(userContext, list, GoodsShelf.class);
  ...
  // -----------------------------------\\ list-of-view 处理 //-----------------------------------v
	 ...
	 * @throws Exception
	 */
 	public Object wxappview(YoubenbenUserContext userContext, String goodsShelfStockCountId) throws Exception{
	  SerializeScope vscope = YoubenbenViewScope.getInstance().getGoodsShelfStockCountDetailScope().clone();
    ...
    String pageTitle = "货架库存盘点"+"详情";
		...
		vscope.field("stockCountIssueTrackListSection", YoubenbenListOfViewScope.getInstance()
