...
public class DamageSpaceManagerImpl extends CustomYoubenbenCheckerManager implements DamageSpaceManager, BusinessHandler{
	...
	@Override
	public DamageSpaceDAO daoOf(YoubenbenUserContext userContext) {
	...
	protected void throwExceptionWithMessage(String value) throws DamageSpaceManagerException{
 	...
 	protected DamageSpace saveDamageSpace(YoubenbenUserContext userContext, DamageSpace damageSpace, String [] tokensExpr) throws Exception{	
 	...
 	protected DamageSpace saveDamageSpaceDetail(YoubenbenUserContext userContext, DamageSpace damageSpace) throws Exception{	
 	...
 	public DamageSpace loadDamageSpace(YoubenbenUserContext userContext, String damageSpaceId, String [] tokensExpr) throws Exception{				
 	 ...
 	 public DamageSpace searchDamageSpace(YoubenbenUserContext userContext, String damageSpaceId, String textToSearch,String [] tokensExpr) throws Exception{				
 	...
 	protected DamageSpace present(YoubenbenUserContext userContext, DamageSpace damageSpace, Map<String, Object> tokens) throws Exception {
 	...
 	public DamageSpace loadDamageSpaceDetail(YoubenbenUserContext userContext, String damageSpaceId) throws Exception{	
 	...
 	public Object view(YoubenbenUserContext userContext, String damageSpaceId) throws Exception{	
 		DamageSpace damageSpace = loadDamageSpace( userContext, damageSpaceId, viewTokens());
 		return present(userContext,damageSpace, allTokens());
		
 	}
 	protected DamageSpace saveDamageSpace(YoubenbenUserContext userContext, DamageSpace damageSpace, Map<String,Object>tokens) throws Exception{	
 		return damageSpaceDaoOf(userContext).save(damageSpace, tokens);
 	}
 	protected DamageSpace loadDamageSpace(YoubenbenUserContext userContext, String damageSpaceId, Map<String,Object>tokens) throws Exception{	
		checkerOf(userContext).checkIdOfDamageSpace(damageSpaceId);
		checkerOf(userContext).throwExceptionIfHasErrors( DamageSpaceManagerException.class);
 	...
 	protected<T extends BaseEntity> void addActions(YoubenbenUserContext userContext, DamageSpace damageSpace, Map<String, Object> tokens){
	...
	}// end method of protected<T extends BaseEntity> void addActions(YoubenbenUserContext userContext, DamageSpace damageSpace, Map<String, Object> tokens){
	...
	protected void checkParamsForUpdatingDamageSpace(YoubenbenUserContext userContext,String damageSpaceId, int damageSpaceVersion, String property, String newValueExpr,String [] tokensExpr)throws Exception
	{
	...
	public DamageSpace clone(YoubenbenUserContext userContext, String fromDamageSpaceId) throws Exception{
	...
	public DamageSpace internalSaveDamageSpace(YoubenbenUserContext userContext, DamageSpace damageSpace, Map<String,Object> options) throws Exception
	{
	...
	public DamageSpace updateDamageSpaceProperty(YoubenbenUserContext userContext,String damageSpaceId, int damageSpaceVersion, String property, String newValueExpr,String [] tokensExpr) throws Exception
	{
		checkParamsForUpdatingDamageSpace(userContext, damageSpaceId, damageSpaceVersion, property, newValueExpr, tokensExpr);
	...
	protected void checkParamsForTransferingAnotherWarehouse(YoubenbenUserContext userContext, String damageSpaceId, String anotherWarehouseId) throws Exception
 	{
 ...
 //--------------------------------------------------------------
	...
	public void delete(YoubenbenUserContext userContext, String damageSpaceId, int damageSpaceVersion) throws Exception {
	...
	public DamageSpace forgetByAll(YoubenbenUserContext userContext, String damageSpaceId, int damageSpaceVersion) throws Exception {
		return forgetByAllInternal(userContext, damageSpaceId, damageSpaceVersion);
	}
	protected DamageSpace forgetByAllInternal(YoubenbenUserContext userContext,
			String damageSpaceId, int damageSpaceVersion) throws Exception{
	...
	protected DamageSpace breakWithGoodsShelfByStorageSpace(YoubenbenUserContext userContext, String damageSpaceId, String storageSpaceId,  String [] tokensExpr)
		 throws Exception{
	...
	protected DamageSpace breakWithGoodsShelfBySupplierSpace(YoubenbenUserContext userContext, String damageSpaceId, String supplierSpaceId,  String [] tokensExpr)
		 throws Exception{
	...
	protected void checkParamsForAddingGoodsShelf(YoubenbenUserContext userContext, String damageSpaceId, String location, String storageSpaceId, String supplierSpaceId,String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForUpdatingGoodsShelfProperties(YoubenbenUserContext userContext, String damageSpaceId,String id,String location,String [] tokensExpr) throws Exception {
	...
	public  DamageSpace updateGoodsShelfProperties(YoubenbenUserContext userContext, String damageSpaceId, String id,String location, String [] tokensExpr) throws Exception
	{
	...
	protected GoodsShelf createGoodsShelf(YoubenbenUserContext userContext, String location, String storageSpaceId, String supplierSpaceId) throws Exception{
	...
	protected void checkParamsForRemovingGoodsShelfList(YoubenbenUserContext userContext, String damageSpaceId,
	...
	public  DamageSpace removeGoodsShelfList(YoubenbenUserContext userContext, String damageSpaceId,
			String goodsShelfIds[],String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForRemovingGoodsShelf(YoubenbenUserContext userContext, String damageSpaceId,
	...
	public  DamageSpace removeGoodsShelf(YoubenbenUserContext userContext, String damageSpaceId,
		String goodsShelfId, int goodsShelfVersion,String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForCopyingGoodsShelf(YoubenbenUserContext userContext, String damageSpaceId,
		String goodsShelfId, int goodsShelfVersion,String [] tokensExpr) throws Exception{
	...
	public  DamageSpace copyGoodsShelfFrom(YoubenbenUserContext userContext, String damageSpaceId,
		String goodsShelfId, int goodsShelfVersion,String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForUpdatingGoodsShelf(YoubenbenUserContext userContext, String damageSpaceId, String goodsShelfId, int goodsShelfVersion, String property, String newValueExpr,String [] tokensExpr) throws Exception{
	...
	public  DamageSpace updateGoodsShelf(YoubenbenUserContext userContext, String damageSpaceId, String goodsShelfId, int goodsShelfVersion, String property, String newValueExpr,String [] tokensExpr)
			throws Exception{
	...
	*/
	...
	// -----------------------------------// list-of-view 处理 \\-----------------------------------
    protected void enhanceForListOfView(YoubenbenUserContext userContext,SmartList<DamageSpace> list) throws Exception {
  ...
  // -----------------------------------\\ list-of-view 处理 //-----------------------------------v
	 ...
	 * @throws Exception
	 */
 	public Object wxappview(YoubenbenUserContext userContext, String damageSpaceId) throws Exception{
	  SerializeScope vscope = YoubenbenViewScope.getInstance().getDamageSpaceDetailScope().clone();
