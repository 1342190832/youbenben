...
import com.youbenben.youbenben.goodsshelf.CandidateGoodsShelf;
...
public class GoodsAllocationManagerImpl extends CustomYoubenbenCheckerManager implements GoodsAllocationManager, BusinessHandler{
	...
	@Override
	public GoodsAllocationDAO daoOf(YoubenbenUserContext userContext) {
	...
	protected void throwExceptionWithMessage(String value) throws GoodsAllocationManagerException{
 	...
 	protected GoodsAllocation saveGoodsAllocation(YoubenbenUserContext userContext, GoodsAllocation goodsAllocation, String [] tokensExpr) throws Exception{	
 	...
 	protected GoodsAllocation saveGoodsAllocationDetail(YoubenbenUserContext userContext, GoodsAllocation goodsAllocation) throws Exception{	
 	...
 	public GoodsAllocation loadGoodsAllocation(YoubenbenUserContext userContext, String goodsAllocationId, String [] tokensExpr) throws Exception{				
 	 ...
 	 public GoodsAllocation searchGoodsAllocation(YoubenbenUserContext userContext, String goodsAllocationId, String textToSearch,String [] tokensExpr) throws Exception{				
 	...
 	protected GoodsAllocation present(YoubenbenUserContext userContext, GoodsAllocation goodsAllocation, Map<String, Object> tokens) throws Exception {
 	...
 	public GoodsAllocation loadGoodsAllocationDetail(YoubenbenUserContext userContext, String goodsAllocationId) throws Exception{	
 	...
 	public Object view(YoubenbenUserContext userContext, String goodsAllocationId) throws Exception{	
 		GoodsAllocation goodsAllocation = loadGoodsAllocation( userContext, goodsAllocationId, viewTokens());
 		return present(userContext,goodsAllocation, allTokens());
		
 	}
 	protected GoodsAllocation saveGoodsAllocation(YoubenbenUserContext userContext, GoodsAllocation goodsAllocation, Map<String,Object>tokens) throws Exception{	
 		return goodsAllocationDaoOf(userContext).save(goodsAllocation, tokens);
 	}
 	protected GoodsAllocation loadGoodsAllocation(YoubenbenUserContext userContext, String goodsAllocationId, Map<String,Object>tokens) throws Exception{	
		checkerOf(userContext).checkIdOfGoodsAllocation(goodsAllocationId);
		checkerOf(userContext).throwExceptionIfHasErrors( GoodsAllocationManagerException.class);
 	...
 	protected<T extends BaseEntity> void addActions(YoubenbenUserContext userContext, GoodsAllocation goodsAllocation, Map<String, Object> tokens){
	...
	}// end method of protected<T extends BaseEntity> void addActions(YoubenbenUserContext userContext, GoodsAllocation goodsAllocation, Map<String, Object> tokens){
	...
	protected void checkParamsForUpdatingGoodsAllocation(YoubenbenUserContext userContext,String goodsAllocationId, int goodsAllocationVersion, String property, String newValueExpr,String [] tokensExpr)throws Exception
	{
	...
	public GoodsAllocation clone(YoubenbenUserContext userContext, String fromGoodsAllocationId) throws Exception{
	...
	public GoodsAllocation internalSaveGoodsAllocation(YoubenbenUserContext userContext, GoodsAllocation goodsAllocation, Map<String,Object> options) throws Exception
	{
	...
	public GoodsAllocation updateGoodsAllocationProperty(YoubenbenUserContext userContext,String goodsAllocationId, int goodsAllocationVersion, String property, String newValueExpr,String [] tokensExpr) throws Exception
	{
		checkParamsForUpdatingGoodsAllocation(userContext, goodsAllocationId, goodsAllocationVersion, property, newValueExpr, tokensExpr);
	...
	protected void checkParamsForTransferingAnotherGoodsShelf(YoubenbenUserContext userContext, String goodsAllocationId, String anotherGoodsShelfId) throws Exception
 	{
	...
	public CandidateGoodsShelf requestCandidateGoodsShelf(YoubenbenUserContext userContext, String ownerClass, String id, String filterKey, int pageNo) throws Exception {
 ...
 //--------------------------------------------------------------
 	...
 	protected GoodsShelf loadGoodsShelf(YoubenbenUserContext userContext, String newGoodsShelfId, Map<String,Object> options) throws Exception
 	{
	...
	public void delete(YoubenbenUserContext userContext, String goodsAllocationId, int goodsAllocationVersion) throws Exception {
	...
	public GoodsAllocation forgetByAll(YoubenbenUserContext userContext, String goodsAllocationId, int goodsAllocationVersion) throws Exception {
		return forgetByAllInternal(userContext, goodsAllocationId, goodsAllocationVersion);
	}
	protected GoodsAllocation forgetByAllInternal(YoubenbenUserContext userContext,
			String goodsAllocationId, int goodsAllocationVersion) throws Exception{
	...
	protected GoodsAllocation breakWithGoodsBySku(YoubenbenUserContext userContext, String goodsAllocationId, String skuId,  String [] tokensExpr)
		 throws Exception{
	...
	protected GoodsAllocation breakWithGoodsByReceivingSpace(YoubenbenUserContext userContext, String goodsAllocationId, String receivingSpaceId,  String [] tokensExpr)
		 throws Exception{
	...
	protected GoodsAllocation breakWithGoodsBySmartPallet(YoubenbenUserContext userContext, String goodsAllocationId, String smartPalletId,  String [] tokensExpr)
		 throws Exception{
	...
	protected GoodsAllocation breakWithGoodsByShippingSpace(YoubenbenUserContext userContext, String goodsAllocationId, String shippingSpaceId,  String [] tokensExpr)
		 throws Exception{
	...
	protected GoodsAllocation breakWithGoodsByTransportTask(YoubenbenUserContext userContext, String goodsAllocationId, String transportTaskId,  String [] tokensExpr)
		 throws Exception{
	...
	protected GoodsAllocation breakWithGoodsByRetailStore(YoubenbenUserContext userContext, String goodsAllocationId, String retailStoreId,  String [] tokensExpr)
		 throws Exception{
	...
	protected GoodsAllocation breakWithGoodsByBizOrder(YoubenbenUserContext userContext, String goodsAllocationId, String bizOrderId,  String [] tokensExpr)
		 throws Exception{
	...
	protected GoodsAllocation breakWithGoodsByRetailStoreOrder(YoubenbenUserContext userContext, String goodsAllocationId, String retailStoreOrderId,  String [] tokensExpr)
		 throws Exception{
	...
	protected GoodsAllocation breakWithGoodsByPackaging(YoubenbenUserContext userContext, String goodsAllocationId, String packagingId,  String [] tokensExpr)
		 throws Exception{
	...
	protected void checkParamsForUpdatingGoodsProperties(YoubenbenUserContext userContext, String goodsAllocationId,String id,String name,String rfid,String uom,int maxPackage,Date expireTime,String [] tokensExpr) throws Exception {
	...
	public  GoodsAllocation updateGoodsProperties(YoubenbenUserContext userContext, String goodsAllocationId, String id,String name,String rfid,String uom,int maxPackage,Date expireTime, String [] tokensExpr) throws Exception
	{
	...
	protected Goods createGoods(YoubenbenUserContext userContext, String name, String rfid, String uom, int maxPackage, Date expireTime, String skuId, String receivingSpaceId, String smartPalletId, String shippingSpaceId, String transportTaskId, String retailStoreId, String bizOrderId, String retailStoreOrderId, String packagingId) throws Exception{
	...
	protected void checkParamsForRemovingGoodsList(YoubenbenUserContext userContext, String goodsAllocationId,
	...
	public  GoodsAllocation removeGoodsList(YoubenbenUserContext userContext, String goodsAllocationId,
			String goodsIds[],String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForRemovingGoods(YoubenbenUserContext userContext, String goodsAllocationId,
	...
	public  GoodsAllocation removeGoods(YoubenbenUserContext userContext, String goodsAllocationId,
		String goodsId, int goodsVersion,String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForCopyingGoods(YoubenbenUserContext userContext, String goodsAllocationId,
		String goodsId, int goodsVersion,String [] tokensExpr) throws Exception{
	...
	public  GoodsAllocation copyGoodsFrom(YoubenbenUserContext userContext, String goodsAllocationId,
		String goodsId, int goodsVersion,String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForUpdatingGoods(YoubenbenUserContext userContext, String goodsAllocationId, String goodsId, int goodsVersion, String property, String newValueExpr,String [] tokensExpr) throws Exception{
	...
	public  GoodsAllocation updateGoods(YoubenbenUserContext userContext, String goodsAllocationId, String goodsId, int goodsVersion, String property, String newValueExpr,String [] tokensExpr)
			throws Exception{
	...
	*/
	...
	// -----------------------------------// list-of-view 处理 \\-----------------------------------
    protected void enhanceForListOfView(YoubenbenUserContext userContext,SmartList<GoodsAllocation> list) throws Exception {
    	if (list == null || list.isEmpty()){
    		return;
    	}
		List<GoodsShelf> goodsShelfList = YoubenbenBaseUtils.collectReferencedObjectWithType(userContext, list, GoodsShelf.class);
  ...
  // -----------------------------------\\ list-of-view 处理 //-----------------------------------v
	 ...
	 * @throws Exception
	 */
 	public Object wxappview(YoubenbenUserContext userContext, String goodsAllocationId) throws Exception{
	  SerializeScope vscope = YoubenbenViewScope.getInstance().getGoodsAllocationDetailScope().clone();
