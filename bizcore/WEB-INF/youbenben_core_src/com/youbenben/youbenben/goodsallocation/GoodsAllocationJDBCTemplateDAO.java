...
public class GoodsAllocationJDBCTemplateDAO extends YoubenbenBaseDAOImpl implements GoodsAllocationDAO{
	...
	*/
    ...
    public SmartList<GoodsAllocation> requestCandidateGoodsAllocationForGoods(YoubenbenUserContext userContext, String ownerClass, String id, String filterKey, int pageNo, int pageSize) throws Exception {
	...
	public SmartList<Goods> loadOurGoodsList(YoubenbenUserContext userContext, List<GoodsAllocation> us, Map<String,Object> options) throws Exception{
