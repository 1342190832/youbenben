...
public class MemberRewardPointManagerImpl extends CustomYoubenbenCheckerManager implements MemberRewardPointManager, BusinessHandler{
	...
	@Override
	public MemberRewardPointDAO daoOf(YoubenbenUserContext userContext) {
	...
	protected void throwExceptionWithMessage(String value) throws MemberRewardPointManagerException{
 	...
 	protected MemberRewardPoint saveMemberRewardPoint(YoubenbenUserContext userContext, MemberRewardPoint memberRewardPoint, String [] tokensExpr) throws Exception{	
 	...
 	protected MemberRewardPoint saveMemberRewardPointDetail(YoubenbenUserContext userContext, MemberRewardPoint memberRewardPoint) throws Exception{	
 	...
 	public MemberRewardPoint loadMemberRewardPoint(YoubenbenUserContext userContext, String memberRewardPointId, String [] tokensExpr) throws Exception{				
 	 ...
 	 public MemberRewardPoint searchMemberRewardPoint(YoubenbenUserContext userContext, String memberRewardPointId, String textToSearch,String [] tokensExpr) throws Exception{				
 	...
 	protected MemberRewardPoint present(YoubenbenUserContext userContext, MemberRewardPoint memberRewardPoint, Map<String, Object> tokens) throws Exception {
 	...
 	public MemberRewardPoint loadMemberRewardPointDetail(YoubenbenUserContext userContext, String memberRewardPointId) throws Exception{	
 	...
 	public Object view(YoubenbenUserContext userContext, String memberRewardPointId) throws Exception{	
 		MemberRewardPoint memberRewardPoint = loadMemberRewardPoint( userContext, memberRewardPointId, viewTokens());
 		return present(userContext,memberRewardPoint, allTokens());
		
 	}
 	protected MemberRewardPoint saveMemberRewardPoint(YoubenbenUserContext userContext, MemberRewardPoint memberRewardPoint, Map<String,Object>tokens) throws Exception{	
 		return memberRewardPointDaoOf(userContext).save(memberRewardPoint, tokens);
 	}
 	protected MemberRewardPoint loadMemberRewardPoint(YoubenbenUserContext userContext, String memberRewardPointId, Map<String,Object>tokens) throws Exception{	
		checkerOf(userContext).checkIdOfMemberRewardPoint(memberRewardPointId);
		checkerOf(userContext).throwExceptionIfHasErrors( MemberRewardPointManagerException.class);
 	...
 	protected<T extends BaseEntity> void addActions(YoubenbenUserContext userContext, MemberRewardPoint memberRewardPoint, Map<String, Object> tokens){
	...
	}// end method of protected<T extends BaseEntity> void addActions(YoubenbenUserContext userContext, MemberRewardPoint memberRewardPoint, Map<String, Object> tokens){
	...
	protected void checkParamsForUpdatingMemberRewardPoint(YoubenbenUserContext userContext,String memberRewardPointId, int memberRewardPointVersion, String property, String newValueExpr,String [] tokensExpr)throws Exception
	{
	...
	public MemberRewardPoint clone(YoubenbenUserContext userContext, String fromMemberRewardPointId) throws Exception{
	...
	public MemberRewardPoint internalSaveMemberRewardPoint(YoubenbenUserContext userContext, MemberRewardPoint memberRewardPoint, Map<String,Object> options) throws Exception
	{
	...
	public MemberRewardPoint updateMemberRewardPointProperty(YoubenbenUserContext userContext,String memberRewardPointId, int memberRewardPointVersion, String property, String newValueExpr,String [] tokensExpr) throws Exception
	{
		checkParamsForUpdatingMemberRewardPoint(userContext, memberRewardPointId, memberRewardPointVersion, property, newValueExpr, tokensExpr);
	...
	protected void checkParamsForTransferingAnotherOwner(YoubenbenUserContext userContext, String memberRewardPointId, String anotherOwnerId) throws Exception
 	{
 ...
 //--------------------------------------------------------------
	...
	public void delete(YoubenbenUserContext userContext, String memberRewardPointId, int memberRewardPointVersion) throws Exception {
	...
	public MemberRewardPoint forgetByAll(YoubenbenUserContext userContext, String memberRewardPointId, int memberRewardPointVersion) throws Exception {
		return forgetByAllInternal(userContext, memberRewardPointId, memberRewardPointVersion);
	}
	protected MemberRewardPoint forgetByAllInternal(YoubenbenUserContext userContext,
			String memberRewardPointId, int memberRewardPointVersion) throws Exception{
	...
	// -----------------------------------// list-of-view 处理 \\-----------------------------------
    protected void enhanceForListOfView(YoubenbenUserContext userContext,SmartList<MemberRewardPoint> list) throws Exception {
  ...
  // -----------------------------------\\ list-of-view 处理 //-----------------------------------v
	 ...
	 * @throws Exception
	 */
 	public Object wxappview(YoubenbenUserContext userContext, String memberRewardPointId) throws Exception{
	  SerializeScope vscope = YoubenbenViewScope.getInstance().getMemberRewardPointDetailScope().clone();
