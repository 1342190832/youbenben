...
public class ConsumerOrderProcessingJDBCTemplateDAO extends YoubenbenBaseDAOImpl implements ConsumerOrderProcessingDAO{
	...
	*/
	...
	public SmartList<ConsumerOrderProcessing> loadAll() {
	    return this.loadAll(getConsumerOrderProcessingMapper());
	}
	...
	public CandidateConsumerOrderProcessing executeCandidatesQuery(CandidateQuery query, String sql, Object ... parmeters) throws Exception {
		...
		CandidateConsumerOrderProcessing result = new CandidateConsumerOrderProcessing();
