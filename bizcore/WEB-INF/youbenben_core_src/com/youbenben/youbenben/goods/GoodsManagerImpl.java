...
import com.youbenben.youbenben.sku.CandidateSku;
import com.youbenben.youbenben.smartpallet.CandidateSmartPallet;
import com.youbenben.youbenben.shippingspace.CandidateShippingSpace;
import com.youbenben.youbenben.supplyorder.CandidateSupplyOrder;
import com.youbenben.youbenben.transporttask.CandidateTransportTask;
import com.youbenben.youbenben.receivingspace.CandidateReceivingSpace;
import com.youbenben.youbenben.retailstoreorder.CandidateRetailStoreOrder;
import com.youbenben.youbenben.goodsallocation.CandidateGoodsAllocation;
import com.youbenben.youbenben.retailstore.CandidateRetailStore;
import com.youbenben.youbenben.goodspackaging.CandidateGoodsPackaging;
...
public class GoodsManagerImpl extends CustomYoubenbenCheckerManager implements GoodsManager, BusinessHandler{
	...
	@Override
	public GoodsDAO daoOf(YoubenbenUserContext userContext) {
	...
	protected void throwExceptionWithMessage(String value) throws GoodsManagerException{
 	...
 	protected Goods saveGoods(YoubenbenUserContext userContext, Goods goods, String [] tokensExpr) throws Exception{	
 	...
 	protected Goods saveGoodsDetail(YoubenbenUserContext userContext, Goods goods) throws Exception{	
 	...
 	public Goods loadGoods(YoubenbenUserContext userContext, String goodsId, String [] tokensExpr) throws Exception{				
 	 ...
 	 public Goods searchGoods(YoubenbenUserContext userContext, String goodsId, String textToSearch,String [] tokensExpr) throws Exception{				
 	...
 	protected Goods present(YoubenbenUserContext userContext, Goods goods, Map<String, Object> tokens) throws Exception {
 	...
 	public Goods loadGoodsDetail(YoubenbenUserContext userContext, String goodsId) throws Exception{	
 		Goods goods = loadGoods( userContext, goodsId, allTokens());
 		return present(userContext,goods, allTokens());
		
 	}
 	
 	public Object view(YoubenbenUserContext userContext, String goodsId) throws Exception{	
 		Goods goods = loadGoods( userContext, goodsId, viewTokens());
 		return present(userContext,goods, allTokens());
		
 	}
 	protected Goods saveGoods(YoubenbenUserContext userContext, Goods goods, Map<String,Object>tokens) throws Exception{	
 		return goodsDaoOf(userContext).save(goods, tokens);
 	}
 	protected Goods loadGoods(YoubenbenUserContext userContext, String goodsId, Map<String,Object>tokens) throws Exception{	
		checkerOf(userContext).checkIdOfGoods(goodsId);
		checkerOf(userContext).throwExceptionIfHasErrors( GoodsManagerException.class);
 	...
 	protected<T extends BaseEntity> void addActions(YoubenbenUserContext userContext, Goods goods, Map<String, Object> tokens){
		...
		addAction(userContext, goods, tokens,"goods.transfer_to_packaging","transferToAnotherPackaging","transferToAnotherPackaging/"+goods.getId()+"/","main","primary");
	...
	}// end method of protected<T extends BaseEntity> void addActions(YoubenbenUserContext userContext, Goods goods, Map<String, Object> tokens){
	...
	//public Goods createGoods(YoubenbenUserContext userContext,String name, String rfid, String uom, int maxPackage, Date expireTime, String skuId, String receivingSpaceId, String goodsAllocationId, String smartPalletId, String shippingSpaceId, String transportTaskId, String retailStoreId, String bizOrderId, String retailStoreOrderId, String packagingId) throws Exception
	{
		...
		GoodsPackaging packaging = loadGoodsPackaging(userContext, packagingId,emptyOptions());
	...
	protected void checkParamsForUpdatingGoods(YoubenbenUserContext userContext,String goodsId, int goodsVersion, String property, String newValueExpr,String [] tokensExpr)throws Exception
	{
	...
	public Goods clone(YoubenbenUserContext userContext, String fromGoodsId) throws Exception{
	...
	public Goods internalSaveGoods(YoubenbenUserContext userContext, Goods goods, Map<String,Object> options) throws Exception
	{
	...
	public Goods updateGoodsProperty(YoubenbenUserContext userContext,String goodsId, int goodsVersion, String property, String newValueExpr,String [] tokensExpr) throws Exception
	{
		checkParamsForUpdatingGoods(userContext, goodsId, goodsVersion, property, newValueExpr, tokensExpr);
	...
	protected void checkParamsForTransferingAnotherSku(YoubenbenUserContext userContext, String goodsId, String anotherSkuId) throws Exception
 	{
	...
	public CandidateSku requestCandidateSku(YoubenbenUserContext userContext, String ownerClass, String id, String filterKey, int pageNo) throws Exception {
 	...
 	protected void checkParamsForTransferingAnotherReceivingSpace(YoubenbenUserContext userContext, String goodsId, String anotherReceivingSpaceId) throws Exception
 	{
	...
	public CandidateReceivingSpace requestCandidateReceivingSpace(YoubenbenUserContext userContext, String ownerClass, String id, String filterKey, int pageNo) throws Exception {
 	...
 	protected void checkParamsForTransferingAnotherGoodsAllocation(YoubenbenUserContext userContext, String goodsId, String anotherGoodsAllocationId) throws Exception
 	{
	...
	public CandidateGoodsAllocation requestCandidateGoodsAllocation(YoubenbenUserContext userContext, String ownerClass, String id, String filterKey, int pageNo) throws Exception {
 	...
 	protected void checkParamsForTransferingAnotherSmartPallet(YoubenbenUserContext userContext, String goodsId, String anotherSmartPalletId) throws Exception
 	{
	...
	public CandidateSmartPallet requestCandidateSmartPallet(YoubenbenUserContext userContext, String ownerClass, String id, String filterKey, int pageNo) throws Exception {
 	...
 	protected void checkParamsForTransferingAnotherShippingSpace(YoubenbenUserContext userContext, String goodsId, String anotherShippingSpaceId) throws Exception
 	{
	...
	public CandidateShippingSpace requestCandidateShippingSpace(YoubenbenUserContext userContext, String ownerClass, String id, String filterKey, int pageNo) throws Exception {
 	...
 	protected void checkParamsForTransferingAnotherTransportTask(YoubenbenUserContext userContext, String goodsId, String anotherTransportTaskId) throws Exception
 	{
	...
	public CandidateTransportTask requestCandidateTransportTask(YoubenbenUserContext userContext, String ownerClass, String id, String filterKey, int pageNo) throws Exception {
 	...
 	protected void checkParamsForTransferingAnotherRetailStore(YoubenbenUserContext userContext, String goodsId, String anotherRetailStoreId) throws Exception
 	{
	...
	public CandidateRetailStore requestCandidateRetailStore(YoubenbenUserContext userContext, String ownerClass, String id, String filterKey, int pageNo) throws Exception {
 	...
 	protected void checkParamsForTransferingAnotherBizOrder(YoubenbenUserContext userContext, String goodsId, String anotherBizOrderId) throws Exception
 	{
	...
	public CandidateSupplyOrder requestCandidateBizOrder(YoubenbenUserContext userContext, String ownerClass, String id, String filterKey, int pageNo) throws Exception {
 	...
 	protected void checkParamsForTransferingAnotherRetailStoreOrder(YoubenbenUserContext userContext, String goodsId, String anotherRetailStoreOrderId) throws Exception
 	{
	...
	public CandidateRetailStoreOrder requestCandidateRetailStoreOrder(YoubenbenUserContext userContext, String ownerClass, String id, String filterKey, int pageNo) throws Exception {
 	...
 	protected void checkParamsForTransferingAnotherPackaging(YoubenbenUserContext userContext, String goodsId, String anotherPackagingId) throws Exception
 	{

 		checkerOf(userContext).checkIdOfGoods(goodsId);
 		checkerOf(userContext).checkIdOfGoodsPackaging(anotherPackagingId);//check for optional reference
 		checkerOf(userContext).throwExceptionIfHasErrors(GoodsManagerException.class);
	...
	public CandidateGoodsPackaging requestCandidatePackaging(YoubenbenUserContext userContext, String ownerClass, String id, String filterKey, int pageNo) throws Exception {
		...
		int pageSize = 20;
		//requestCandidateProductForSkuAsOwner
		SmartList<GoodsPackaging> candidateList = goodsPackagingDaoOf(userContext).requestCandidateGoodsPackagingForGoods(userContext,ownerClass, id, filterKey, pageNo, pageSize);
		result.setCandidates(candidateList);
		int totalCount = candidateList.getTotalCount();
		result.setTotalPage(Math.max(1, (totalCount + pageSize -1)/pageSize ));
		return result;
 ...
 //--------------------------------------------------------------
 	...
 	protected ReceivingSpace loadReceivingSpace(YoubenbenUserContext userContext, String newReceivingSpaceId, Map<String,Object> options) throws Exception
 	{
 	...
 	protected GoodsAllocation loadGoodsAllocation(YoubenbenUserContext userContext, String newGoodsAllocationId, Map<String,Object> options) throws Exception
 	{
 	...
 	protected SmartPallet loadSmartPallet(YoubenbenUserContext userContext, String newSmartPalletId, Map<String,Object> options) throws Exception
 	{
 	...
 	protected GoodsPackaging loadGoodsPackaging(YoubenbenUserContext userContext, String newPackagingId, Map<String,Object> options) throws Exception
 	{

 		return goodsPackagingDaoOf(userContext).load(newPackagingId, options);
 	}
 	...
 	protected TransportTask loadTransportTask(YoubenbenUserContext userContext, String newTransportTaskId, Map<String,Object> options) throws Exception
 	{
 	...
 	protected ShippingSpace loadShippingSpace(YoubenbenUserContext userContext, String newShippingSpaceId, Map<String,Object> options) throws Exception
 	{
 	...
 	protected Sku loadSku(YoubenbenUserContext userContext, String newSkuId, Map<String,Object> options) throws Exception
 	{
 	...
 	protected RetailStoreOrder loadRetailStoreOrder(YoubenbenUserContext userContext, String newRetailStoreOrderId, Map<String,Object> options) throws Exception
 	{
 	...
 	protected RetailStore loadRetailStore(YoubenbenUserContext userContext, String newRetailStoreId, Map<String,Object> options) throws Exception
 	{
	...
	public void delete(YoubenbenUserContext userContext, String goodsId, int goodsVersion) throws Exception {
	...
	public Goods forgetByAll(YoubenbenUserContext userContext, String goodsId, int goodsVersion) throws Exception {
		return forgetByAllInternal(userContext, goodsId, goodsVersion);
	}
	protected Goods forgetByAllInternal(YoubenbenUserContext userContext,
			String goodsId, int goodsVersion) throws Exception{
	...
	protected Goods breakWithGoodsMovementByFacilityId(YoubenbenUserContext userContext, String goodsId, String facilityIdId,  String [] tokensExpr)
		 throws Exception{
	...
	protected Goods breakWithGoodsMovementBySessionId(YoubenbenUserContext userContext, String goodsId, String sessionIdId,  String [] tokensExpr)
		 throws Exception{
	...
	protected void checkParamsForAddingGoodsMovement(YoubenbenUserContext userContext, String goodsId, DateTime moveTime, String facility, String facilityId, String fromIp, String userAgent, String sessionId, BigDecimal latitude, BigDecimal longitude,String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForUpdatingGoodsMovementProperties(YoubenbenUserContext userContext, String goodsId,String id,DateTime moveTime,String facility,String facilityId,String fromIp,String userAgent,String sessionId,BigDecimal latitude,BigDecimal longitude,String [] tokensExpr) throws Exception {
	...
	public  Goods updateGoodsMovementProperties(YoubenbenUserContext userContext, String goodsId, String id,DateTime moveTime,String facility,String facilityId,String fromIp,String userAgent,String sessionId,BigDecimal latitude,BigDecimal longitude, String [] tokensExpr) throws Exception
	{
	...
	protected GoodsMovement createGoodsMovement(YoubenbenUserContext userContext, DateTime moveTime, String facility, String facilityId, String fromIp, String userAgent, String sessionId, BigDecimal latitude, BigDecimal longitude) throws Exception{
	...
	protected void checkParamsForRemovingGoodsMovementList(YoubenbenUserContext userContext, String goodsId,
	...
	public  Goods removeGoodsMovementList(YoubenbenUserContext userContext, String goodsId,
			String goodsMovementIds[],String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForRemovingGoodsMovement(YoubenbenUserContext userContext, String goodsId,
	...
	public  Goods removeGoodsMovement(YoubenbenUserContext userContext, String goodsId,
		String goodsMovementId, int goodsMovementVersion,String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForCopyingGoodsMovement(YoubenbenUserContext userContext, String goodsId,
		String goodsMovementId, int goodsMovementVersion,String [] tokensExpr) throws Exception{
	...
	public  Goods copyGoodsMovementFrom(YoubenbenUserContext userContext, String goodsId,
		String goodsMovementId, int goodsMovementVersion,String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForUpdatingGoodsMovement(YoubenbenUserContext userContext, String goodsId, String goodsMovementId, int goodsMovementVersion, String property, String newValueExpr,String [] tokensExpr) throws Exception{
	...
	public  Goods updateGoodsMovement(YoubenbenUserContext userContext, String goodsId, String goodsMovementId, int goodsMovementVersion, String property, String newValueExpr,String [] tokensExpr)
			throws Exception{
	...
	*/
	...
	// -----------------------------------// list-of-view 处理 \\-----------------------------------
    protected void enhanceForListOfView(YoubenbenUserContext userContext,SmartList<Goods> list) throws Exception {
    	if (list == null || list.isEmpty()){
    		return;
    	}
		List<Sku> skuList = YoubenbenBaseUtils.collectReferencedObjectWithType(userContext, list, Sku.class);
		userContext.getDAOGroup().enhanceList(skuList, Sku.class);
		List<ReceivingSpace> receivingSpaceList = YoubenbenBaseUtils.collectReferencedObjectWithType(userContext, list, ReceivingSpace.class);
		userContext.getDAOGroup().enhanceList(receivingSpaceList, ReceivingSpace.class);
		List<GoodsAllocation> goodsAllocationList = YoubenbenBaseUtils.collectReferencedObjectWithType(userContext, list, GoodsAllocation.class);
		userContext.getDAOGroup().enhanceList(goodsAllocationList, GoodsAllocation.class);
		List<SmartPallet> smartPalletList = YoubenbenBaseUtils.collectReferencedObjectWithType(userContext, list, SmartPallet.class);
		userContext.getDAOGroup().enhanceList(smartPalletList, SmartPallet.class);
		List<ShippingSpace> shippingSpaceList = YoubenbenBaseUtils.collectReferencedObjectWithType(userContext, list, ShippingSpace.class);
		userContext.getDAOGroup().enhanceList(shippingSpaceList, ShippingSpace.class);
		List<TransportTask> transportTaskList = YoubenbenBaseUtils.collectReferencedObjectWithType(userContext, list, TransportTask.class);
		userContext.getDAOGroup().enhanceList(transportTaskList, TransportTask.class);
		List<RetailStore> retailStoreList = YoubenbenBaseUtils.collectReferencedObjectWithType(userContext, list, RetailStore.class);
		...
		List<RetailStoreOrder> retailStoreOrderList = YoubenbenBaseUtils.collectReferencedObjectWithType(userContext, list, RetailStoreOrder.class);
		userContext.getDAOGroup().enhanceList(retailStoreOrderList, RetailStoreOrder.class);
		List<GoodsPackaging> packagingList = YoubenbenBaseUtils.collectReferencedObjectWithType(userContext, list, GoodsPackaging.class);
		userContext.getDAOGroup().enhanceList(packagingList, GoodsPackaging.class);
	...
	public Object listByPackaging(YoubenbenUserContext userContext,String packagingId) throws Exception {
		return listPageByPackaging(userContext, packagingId, 0, 20);
	}
	@SuppressWarnings({ "unchecked", "rawtypes" })
	public Object listPageByPackaging(YoubenbenUserContext userContext,String packagingId, int start, int count) throws Exception {
		SmartList<Goods> list = goodsDaoOf(userContext).findGoodsByPackaging(packagingId, start, count, new HashMap<>());
		enhanceForListOfView(userContext, list);
		YoubenbenCommonListOfViewPage page = new YoubenbenCommonListOfViewPage();
		page.setClassOfList(Goods.class);
		page.setContainerObject(GoodsPackaging.withId(packagingId));
		page.setRequestBeanName(this.getBeanName());
		page.setDataList((SmartList)list);
		page.setPageTitle("货物列表");
		page.setRequestName("listByPackaging");
		page.setRequestOffset(start);
		page.setRequestLimit(count);
		page.setDisplayMode("auto");
		page.setLinkToUrl(TextUtil.encodeUrl(String.format("%s/listByPackaging/%s/",  getBeanName(), packagingId)));

		page.assemblerContent(userContext, "listByPackaging");
		return page.doRender(userContext);
	}
  ...
  // -----------------------------------\\ list-of-view 处理 //-----------------------------------v
	 ...
	 * @throws Exception
	 */
 	public Object wxappview(YoubenbenUserContext userContext, String goodsId) throws Exception{
	  SerializeScope vscope = YoubenbenViewScope.getInstance().getGoodsDetailScope().clone();
    ...
    String pageTitle = "货物"+"详情";
		...
		propList.add(
				MapUtil.put("id", "16-packaging")
				    .put("fieldName", "packaging")
				    .put("label", "包装")
				    .put("type", "auto")
				    .put("linkToUrl", "goodsPackagingManager/wxappview/:id/")
				    .put("displayMode", "{\"brief\":\"description\",\"imageUrl\":\"\",\"name\":\"auto\",\"title\":\"package_name\",\"imageList\":\"\"}")
				    .into_map()
		);
		result.put("packaging", merchantObj.getPackaging());
		...
		vscope.field("goodsMovementListSection", YoubenbenListOfViewScope.getInstance()
