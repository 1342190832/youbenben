...
public class Goods extends BaseEntity implements  java.io.Serializable{
	...
	public Object[] toFlatArray(){
		return new Object[]{getId(), getName(), getRfid(), getUom(), getMaxPackage(), getExpireTime(), getSku(), getReceivingSpace(), getGoodsAllocation(), getSmartPallet(), getShippingSpace(), getTransportTask(), getRetailStore(), getBizOrder(), getRetailStoreOrder(), getPackaging(), getVersion()};
	}
