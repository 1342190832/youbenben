...
public class SupplyOrderShippingGroupManagerImpl extends CustomYoubenbenCheckerManager implements SupplyOrderShippingGroupManager, BusinessHandler{
	...
	@Override
	public SupplyOrderShippingGroupDAO daoOf(YoubenbenUserContext userContext) {
	...
	protected void throwExceptionWithMessage(String value) throws SupplyOrderShippingGroupManagerException{
 	...
 	protected SupplyOrderShippingGroup saveSupplyOrderShippingGroup(YoubenbenUserContext userContext, SupplyOrderShippingGroup supplyOrderShippingGroup, String [] tokensExpr) throws Exception{	
 	...
 	protected SupplyOrderShippingGroup saveSupplyOrderShippingGroupDetail(YoubenbenUserContext userContext, SupplyOrderShippingGroup supplyOrderShippingGroup) throws Exception{	
 	...
 	public SupplyOrderShippingGroup loadSupplyOrderShippingGroup(YoubenbenUserContext userContext, String supplyOrderShippingGroupId, String [] tokensExpr) throws Exception{				
 	 ...
 	 public SupplyOrderShippingGroup searchSupplyOrderShippingGroup(YoubenbenUserContext userContext, String supplyOrderShippingGroupId, String textToSearch,String [] tokensExpr) throws Exception{				
 	...
 	protected SupplyOrderShippingGroup present(YoubenbenUserContext userContext, SupplyOrderShippingGroup supplyOrderShippingGroup, Map<String, Object> tokens) throws Exception {
 	...
 	public SupplyOrderShippingGroup loadSupplyOrderShippingGroupDetail(YoubenbenUserContext userContext, String supplyOrderShippingGroupId) throws Exception{	
 	...
 	public Object view(YoubenbenUserContext userContext, String supplyOrderShippingGroupId) throws Exception{	
 	...
 	protected SupplyOrderShippingGroup saveSupplyOrderShippingGroup(YoubenbenUserContext userContext, SupplyOrderShippingGroup supplyOrderShippingGroup, Map<String,Object>tokens) throws Exception{	
 		return supplyOrderShippingGroupDaoOf(userContext).save(supplyOrderShippingGroup, tokens);
 	}
 	protected SupplyOrderShippingGroup loadSupplyOrderShippingGroup(YoubenbenUserContext userContext, String supplyOrderShippingGroupId, Map<String,Object>tokens) throws Exception{	
		checkerOf(userContext).checkIdOfSupplyOrderShippingGroup(supplyOrderShippingGroupId);
		checkerOf(userContext).throwExceptionIfHasErrors( SupplyOrderShippingGroupManagerException.class);
 	...
 	protected<T extends BaseEntity> void addActions(YoubenbenUserContext userContext, SupplyOrderShippingGroup supplyOrderShippingGroup, Map<String, Object> tokens){
	...
	}// end method of protected<T extends BaseEntity> void addActions(YoubenbenUserContext userContext, SupplyOrderShippingGroup supplyOrderShippingGroup, Map<String, Object> tokens){
	...
	protected void checkParamsForUpdatingSupplyOrderShippingGroup(YoubenbenUserContext userContext,String supplyOrderShippingGroupId, int supplyOrderShippingGroupVersion, String property, String newValueExpr,String [] tokensExpr)throws Exception
	{
	...
	public SupplyOrderShippingGroup clone(YoubenbenUserContext userContext, String fromSupplyOrderShippingGroupId) throws Exception{
	...
	public SupplyOrderShippingGroup internalSaveSupplyOrderShippingGroup(YoubenbenUserContext userContext, SupplyOrderShippingGroup supplyOrderShippingGroup, Map<String,Object> options) throws Exception
	{
	...
	public SupplyOrderShippingGroup updateSupplyOrderShippingGroupProperty(YoubenbenUserContext userContext,String supplyOrderShippingGroupId, int supplyOrderShippingGroupVersion, String property, String newValueExpr,String [] tokensExpr) throws Exception
	{
		checkParamsForUpdatingSupplyOrderShippingGroup(userContext, supplyOrderShippingGroupId, supplyOrderShippingGroupVersion, property, newValueExpr, tokensExpr);
	...
	protected void checkParamsForTransferingAnotherBizOrder(YoubenbenUserContext userContext, String supplyOrderShippingGroupId, String anotherBizOrderId) throws Exception
 	{
 ...
 //--------------------------------------------------------------
	...
	public void delete(YoubenbenUserContext userContext, String supplyOrderShippingGroupId, int supplyOrderShippingGroupVersion) throws Exception {
	...
	public SupplyOrderShippingGroup forgetByAll(YoubenbenUserContext userContext, String supplyOrderShippingGroupId, int supplyOrderShippingGroupVersion) throws Exception {
		return forgetByAllInternal(userContext, supplyOrderShippingGroupId, supplyOrderShippingGroupVersion);
	}
	protected SupplyOrderShippingGroup forgetByAllInternal(YoubenbenUserContext userContext,
			String supplyOrderShippingGroupId, int supplyOrderShippingGroupVersion) throws Exception{
	...
	// -----------------------------------// list-of-view 处理 \\-----------------------------------
    protected void enhanceForListOfView(YoubenbenUserContext userContext,SmartList<SupplyOrderShippingGroup> list) throws Exception {
  ...
  // -----------------------------------\\ list-of-view 处理 //-----------------------------------v
	 ...
	 * @throws Exception
	 */
 	public Object wxappview(YoubenbenUserContext userContext, String supplyOrderShippingGroupId) throws Exception{
	  SerializeScope vscope = YoubenbenViewScope.getInstance().getSupplyOrderShippingGroupDetailScope().clone();
