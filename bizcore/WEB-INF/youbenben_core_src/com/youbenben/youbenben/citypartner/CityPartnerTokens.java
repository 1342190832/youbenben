...
public class CityPartnerTokens extends CommonTokens{
	...
	protected static final String TOWNSERVICECENTER = "townServiceCenter";
	public String getTownServiceCenter(){
		return TOWNSERVICECENTER;
	}
	public CityPartnerTokens withTownServiceCenter(){		
		addSimpleOptions(TOWNSERVICECENTER);
		return this;
	}
