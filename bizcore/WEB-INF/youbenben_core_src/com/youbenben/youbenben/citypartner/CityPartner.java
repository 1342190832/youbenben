...
public class CityPartner extends BaseEntity implements  java.io.Serializable{
	...
	public static final String TOWN_SERVICE_CENTER_PROPERTY   = "townServiceCenter" ;
	...
	protected		FranchisedOutletCityServiceCenter	mTownServiceCenter  ;
	...
	public Object propertyOf(String property) {
		...
		if(TOWN_SERVICE_CENTER_PROPERTY.equals(property)){
			return getTownServiceCenter();
		}
		if(DESCRIPTION_PROPERTY.equals(property)){
	...
	public void setTownServiceCenter(FranchisedOutletCityServiceCenter townServiceCenter){
		this.mTownServiceCenter = townServiceCenter;;
	}
	public FranchisedOutletCityServiceCenter getTownServiceCenter(){
		return this.mTownServiceCenter;
	}
	public CityPartner updateTownServiceCenter(FranchisedOutletCityServiceCenter townServiceCenter){
		this.mTownServiceCenter = townServiceCenter;;
		this.changed = true;
		return this;
	}
	public void mergeTownServiceCenter(FranchisedOutletCityServiceCenter townServiceCenter){
		if(townServiceCenter != null) { setTownServiceCenter(townServiceCenter);}
	}
	
	
	public void clearTownServiceCenter(){
		setTownServiceCenter ( null );
		this.changed = true;
	}
	...
	public void collectRefercences(BaseEntity owner, List<BaseEntity> entityList, String internalType){
		...
		addToEntityList(this, entityList, getTownServiceCenter(), internalType);
	...
	public List<KeyValuePair> keyValuePairOf(){
		...
		appendKeyValuePair(result, TOWN_SERVICE_CENTER_PROPERTY, getTownServiceCenter());
	...
	public BaseEntity copyTo(BaseEntity baseDest){
		...
		if(baseDest instanceof CityPartner){
			...
			dest.setTownServiceCenter(getTownServiceCenter());
	...
	public BaseEntity mergeDataTo(BaseEntity baseDest){
		...
		if(baseDest instanceof CityPartner){
			...
			dest.mergeTownServiceCenter(getTownServiceCenter());
	...
	public Object[] toFlatArray(){
		return new Object[]{getId(), getName(), getMobile(), getTownServiceCenter(), getDescription(), getLastUpdateTime(), getVersion()};
	}
	public String toString(){
		...
		if(getTownServiceCenter() != null ){
 			stringBuilder.append("\ttownServiceCenter='FranchisedOutletCityServiceCenter("+getTownServiceCenter().getId()+")';");
 		}
