...
public class CityPartnerManagerImpl extends CustomYoubenbenCheckerManager implements CityPartnerManager, BusinessHandler{
	...
	@Override
	public CityPartnerDAO daoOf(YoubenbenUserContext userContext) {
	...
	protected void throwExceptionWithMessage(String value) throws CityPartnerManagerException{
 	...
 	protected CityPartner saveCityPartner(YoubenbenUserContext userContext, CityPartner cityPartner, String [] tokensExpr) throws Exception{	
 	...
 	protected CityPartner saveCityPartnerDetail(YoubenbenUserContext userContext, CityPartner cityPartner) throws Exception{	
 	...
 	public CityPartner loadCityPartner(YoubenbenUserContext userContext, String cityPartnerId, String [] tokensExpr) throws Exception{				
 	 ...
 	 public CityPartner searchCityPartner(YoubenbenUserContext userContext, String cityPartnerId, String textToSearch,String [] tokensExpr) throws Exception{				
 	...
 	protected CityPartner present(YoubenbenUserContext userContext, CityPartner cityPartner, Map<String, Object> tokens) throws Exception {
 	...
 	public CityPartner loadCityPartnerDetail(YoubenbenUserContext userContext, String cityPartnerId) throws Exception{	
 	...
 	public Object view(YoubenbenUserContext userContext, String cityPartnerId) throws Exception{	
 		CityPartner cityPartner = loadCityPartner( userContext, cityPartnerId, viewTokens());
 		return present(userContext,cityPartner, allTokens());
		
 	}
 	protected CityPartner saveCityPartner(YoubenbenUserContext userContext, CityPartner cityPartner, Map<String,Object>tokens) throws Exception{	
 		return cityPartnerDaoOf(userContext).save(cityPartner, tokens);
 	}
 	protected CityPartner loadCityPartner(YoubenbenUserContext userContext, String cityPartnerId, Map<String,Object>tokens) throws Exception{	
		checkerOf(userContext).checkIdOfCityPartner(cityPartnerId);
		checkerOf(userContext).throwExceptionIfHasErrors( CityPartnerManagerException.class);
 	...
 	protected<T extends BaseEntity> void addActions(YoubenbenUserContext userContext, CityPartner cityPartner, Map<String, Object> tokens){
	...
	}// end method of protected<T extends BaseEntity> void addActions(YoubenbenUserContext userContext, CityPartner cityPartner, Map<String, Object> tokens){
	...
	protected void checkParamsForUpdatingCityPartner(YoubenbenUserContext userContext,String cityPartnerId, int cityPartnerVersion, String property, String newValueExpr,String [] tokensExpr)throws Exception
	{
	...
	public CityPartner clone(YoubenbenUserContext userContext, String fromCityPartnerId) throws Exception{
	...
	public CityPartner internalSaveCityPartner(YoubenbenUserContext userContext, CityPartner cityPartner, Map<String,Object> options) throws Exception
	{
	...
	public CityPartner updateCityPartnerProperty(YoubenbenUserContext userContext,String cityPartnerId, int cityPartnerVersion, String property, String newValueExpr,String [] tokensExpr) throws Exception
	{
		checkParamsForUpdatingCityPartner(userContext, cityPartnerId, cityPartnerVersion, property, newValueExpr, tokensExpr);
	...
	protected void checkParamsForTransferingAnotherTownServiceCenter(YoubenbenUserContext userContext, String cityPartnerId, String anotherTownServiceCenterId) throws Exception
 	{
	...
	public CandidateFranchisedOutletCityServiceCenter requestCandidateTownServiceCenter(YoubenbenUserContext userContext, String ownerClass, String id, String filterKey, int pageNo) throws Exception {
 ...
 //--------------------------------------------------------------
 	...
 	protected FranchisedOutletCityServiceCenter loadFranchisedOutletCityServiceCenter(YoubenbenUserContext userContext, String newTownServiceCenterId, Map<String,Object> options) throws Exception
 	{
	...
	public void delete(YoubenbenUserContext userContext, String cityPartnerId, int cityPartnerVersion) throws Exception {
	...
	public CityPartner forgetByAll(YoubenbenUserContext userContext, String cityPartnerId, int cityPartnerVersion) throws Exception {
		return forgetByAllInternal(userContext, cityPartnerId, cityPartnerVersion);
	}
	protected CityPartner forgetByAllInternal(YoubenbenUserContext userContext,
			String cityPartnerId, int cityPartnerVersion) throws Exception{
	...
	protected CityPartner breakWithPotentialCustomerByCityServiceCenter(YoubenbenUserContext userContext, String cityPartnerId, String cityServiceCenterId,  String [] tokensExpr)
		 throws Exception{
	...
	protected CityPartner breakWithPotentialCustomerContactByPotentialCustomer(YoubenbenUserContext userContext, String cityPartnerId, String potentialCustomerId,  String [] tokensExpr)
		 throws Exception{
	...
	protected CityPartner breakWithPotentialCustomerContactByContactTo(YoubenbenUserContext userContext, String cityPartnerId, String contactToId,  String [] tokensExpr)
		 throws Exception{
	...
	protected void checkParamsForAddingPotentialCustomer(YoubenbenUserContext userContext, String cityPartnerId, String name, String mobile, String cityServiceCenterId, String description,String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForUpdatingPotentialCustomerProperties(YoubenbenUserContext userContext, String cityPartnerId,String id,String name,String mobile,String description,String [] tokensExpr) throws Exception {
	...
	public  CityPartner updatePotentialCustomerProperties(YoubenbenUserContext userContext, String cityPartnerId, String id,String name,String mobile,String description, String [] tokensExpr) throws Exception
	{
	...
	protected PotentialCustomer createPotentialCustomer(YoubenbenUserContext userContext, String name, String mobile, String cityServiceCenterId, String description) throws Exception{
	...
	protected void checkParamsForRemovingPotentialCustomerList(YoubenbenUserContext userContext, String cityPartnerId,
	...
	public  CityPartner removePotentialCustomerList(YoubenbenUserContext userContext, String cityPartnerId,
			String potentialCustomerIds[],String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForRemovingPotentialCustomer(YoubenbenUserContext userContext, String cityPartnerId,
	...
	public  CityPartner removePotentialCustomer(YoubenbenUserContext userContext, String cityPartnerId,
		String potentialCustomerId, int potentialCustomerVersion,String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForCopyingPotentialCustomer(YoubenbenUserContext userContext, String cityPartnerId,
		String potentialCustomerId, int potentialCustomerVersion,String [] tokensExpr) throws Exception{
	...
	public  CityPartner copyPotentialCustomerFrom(YoubenbenUserContext userContext, String cityPartnerId,
		String potentialCustomerId, int potentialCustomerVersion,String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForUpdatingPotentialCustomer(YoubenbenUserContext userContext, String cityPartnerId, String potentialCustomerId, int potentialCustomerVersion, String property, String newValueExpr,String [] tokensExpr) throws Exception{
	...
	public  CityPartner updatePotentialCustomer(YoubenbenUserContext userContext, String cityPartnerId, String potentialCustomerId, int potentialCustomerVersion, String property, String newValueExpr,String [] tokensExpr)
			throws Exception{
	...
	*/
	...
	protected void checkParamsForAddingPotentialCustomerContact(YoubenbenUserContext userContext, String cityPartnerId, String name, Date contactDate, String contactMethod, String potentialCustomerId, String contactToId, String description,String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForUpdatingPotentialCustomerContactProperties(YoubenbenUserContext userContext, String cityPartnerId,String id,String name,Date contactDate,String contactMethod,String description,String [] tokensExpr) throws Exception {
	...
	public  CityPartner updatePotentialCustomerContactProperties(YoubenbenUserContext userContext, String cityPartnerId, String id,String name,Date contactDate,String contactMethod,String description, String [] tokensExpr) throws Exception
	{
	...
	protected PotentialCustomerContact createPotentialCustomerContact(YoubenbenUserContext userContext, String name, Date contactDate, String contactMethod, String potentialCustomerId, String contactToId, String description) throws Exception{
	...
	protected void checkParamsForRemovingPotentialCustomerContactList(YoubenbenUserContext userContext, String cityPartnerId,
	...
	public  CityPartner removePotentialCustomerContactList(YoubenbenUserContext userContext, String cityPartnerId,
			String potentialCustomerContactIds[],String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForRemovingPotentialCustomerContact(YoubenbenUserContext userContext, String cityPartnerId,
	...
	public  CityPartner removePotentialCustomerContact(YoubenbenUserContext userContext, String cityPartnerId,
		String potentialCustomerContactId, int potentialCustomerContactVersion,String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForCopyingPotentialCustomerContact(YoubenbenUserContext userContext, String cityPartnerId,
		String potentialCustomerContactId, int potentialCustomerContactVersion,String [] tokensExpr) throws Exception{
	...
	public  CityPartner copyPotentialCustomerContactFrom(YoubenbenUserContext userContext, String cityPartnerId,
		String potentialCustomerContactId, int potentialCustomerContactVersion,String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForUpdatingPotentialCustomerContact(YoubenbenUserContext userContext, String cityPartnerId, String potentialCustomerContactId, int potentialCustomerContactVersion, String property, String newValueExpr,String [] tokensExpr) throws Exception{
	...
	public  CityPartner updatePotentialCustomerContact(YoubenbenUserContext userContext, String cityPartnerId, String potentialCustomerContactId, int potentialCustomerContactVersion, String property, String newValueExpr,String [] tokensExpr)
			throws Exception{
	...
	*/
	...
	// -----------------------------------// list-of-view 处理 \\-----------------------------------
    protected void enhanceForListOfView(YoubenbenUserContext userContext,SmartList<CityPartner> list) throws Exception {
    	if (list == null || list.isEmpty()){
    		return;
    	}
		List<FranchisedOutletCityServiceCenter> townServiceCenterList = YoubenbenBaseUtils.collectReferencedObjectWithType(userContext, list, FranchisedOutletCityServiceCenter.class);
  ...
  // -----------------------------------\\ list-of-view 处理 //-----------------------------------v
	 ...
	 * @throws Exception
	 */
 	public Object wxappview(YoubenbenUserContext userContext, String cityPartnerId) throws Exception{
	  SerializeScope vscope = YoubenbenViewScope.getInstance().getCityPartnerDetailScope().clone();
