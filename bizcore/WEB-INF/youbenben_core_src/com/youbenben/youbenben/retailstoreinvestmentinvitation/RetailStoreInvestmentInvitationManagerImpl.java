...
public class RetailStoreInvestmentInvitationManagerImpl extends CustomYoubenbenCheckerManager implements RetailStoreInvestmentInvitationManager, BusinessHandler{
	...
	@Override
	public RetailStoreInvestmentInvitationDAO daoOf(YoubenbenUserContext userContext) {
	...
	protected void throwExceptionWithMessage(String value) throws RetailStoreInvestmentInvitationManagerException{
 	...
 	protected RetailStoreInvestmentInvitation saveRetailStoreInvestmentInvitation(YoubenbenUserContext userContext, RetailStoreInvestmentInvitation retailStoreInvestmentInvitation, String [] tokensExpr) throws Exception{	
 	...
 	protected RetailStoreInvestmentInvitation saveRetailStoreInvestmentInvitationDetail(YoubenbenUserContext userContext, RetailStoreInvestmentInvitation retailStoreInvestmentInvitation) throws Exception{	
 	...
 	public RetailStoreInvestmentInvitation loadRetailStoreInvestmentInvitation(YoubenbenUserContext userContext, String retailStoreInvestmentInvitationId, String [] tokensExpr) throws Exception{				
 	 ...
 	 public RetailStoreInvestmentInvitation searchRetailStoreInvestmentInvitation(YoubenbenUserContext userContext, String retailStoreInvestmentInvitationId, String textToSearch,String [] tokensExpr) throws Exception{				
 	...
 	protected RetailStoreInvestmentInvitation present(YoubenbenUserContext userContext, RetailStoreInvestmentInvitation retailStoreInvestmentInvitation, Map<String, Object> tokens) throws Exception {
 	...
 	public RetailStoreInvestmentInvitation loadRetailStoreInvestmentInvitationDetail(YoubenbenUserContext userContext, String retailStoreInvestmentInvitationId) throws Exception{	
 	...
 	public Object view(YoubenbenUserContext userContext, String retailStoreInvestmentInvitationId) throws Exception{	
 	...
 	protected RetailStoreInvestmentInvitation saveRetailStoreInvestmentInvitation(YoubenbenUserContext userContext, RetailStoreInvestmentInvitation retailStoreInvestmentInvitation, Map<String,Object>tokens) throws Exception{	
 		return retailStoreInvestmentInvitationDaoOf(userContext).save(retailStoreInvestmentInvitation, tokens);
 	}
 	protected RetailStoreInvestmentInvitation loadRetailStoreInvestmentInvitation(YoubenbenUserContext userContext, String retailStoreInvestmentInvitationId, Map<String,Object>tokens) throws Exception{	
		checkerOf(userContext).checkIdOfRetailStoreInvestmentInvitation(retailStoreInvestmentInvitationId);
		checkerOf(userContext).throwExceptionIfHasErrors( RetailStoreInvestmentInvitationManagerException.class);
 	...
 	protected<T extends BaseEntity> void addActions(YoubenbenUserContext userContext, RetailStoreInvestmentInvitation retailStoreInvestmentInvitation, Map<String, Object> tokens){
	...
	}// end method of protected<T extends BaseEntity> void addActions(YoubenbenUserContext userContext, RetailStoreInvestmentInvitation retailStoreInvestmentInvitation, Map<String, Object> tokens){
	...
	protected void checkParamsForUpdatingRetailStoreInvestmentInvitation(YoubenbenUserContext userContext,String retailStoreInvestmentInvitationId, int retailStoreInvestmentInvitationVersion, String property, String newValueExpr,String [] tokensExpr)throws Exception
	{
	...
	public RetailStoreInvestmentInvitation clone(YoubenbenUserContext userContext, String fromRetailStoreInvestmentInvitationId) throws Exception{
	...
	public RetailStoreInvestmentInvitation internalSaveRetailStoreInvestmentInvitation(YoubenbenUserContext userContext, RetailStoreInvestmentInvitation retailStoreInvestmentInvitation, Map<String,Object> options) throws Exception
	{
	...
	public RetailStoreInvestmentInvitation updateRetailStoreInvestmentInvitationProperty(YoubenbenUserContext userContext,String retailStoreInvestmentInvitationId, int retailStoreInvestmentInvitationVersion, String property, String newValueExpr,String [] tokensExpr) throws Exception
	{
		checkParamsForUpdatingRetailStoreInvestmentInvitation(userContext, retailStoreInvestmentInvitationId, retailStoreInvestmentInvitationVersion, property, newValueExpr, tokensExpr);
...
//--------------------------------------------------------------
	...
	public void delete(YoubenbenUserContext userContext, String retailStoreInvestmentInvitationId, int retailStoreInvestmentInvitationVersion) throws Exception {
	...
	public RetailStoreInvestmentInvitation forgetByAll(YoubenbenUserContext userContext, String retailStoreInvestmentInvitationId, int retailStoreInvestmentInvitationVersion) throws Exception {
		return forgetByAllInternal(userContext, retailStoreInvestmentInvitationId, retailStoreInvestmentInvitationVersion);
	}
	protected RetailStoreInvestmentInvitation forgetByAllInternal(YoubenbenUserContext userContext,
			String retailStoreInvestmentInvitationId, int retailStoreInvestmentInvitationVersion) throws Exception{
	...
	protected RetailStoreInvestmentInvitation breakWithRetailStoreByRetailStoreCountryCenter(YoubenbenUserContext userContext, String retailStoreInvestmentInvitationId, String retailStoreCountryCenterId,  String [] tokensExpr)
		 throws Exception{
	...
	protected RetailStoreInvestmentInvitation breakWithRetailStoreByCityServiceCenter(YoubenbenUserContext userContext, String retailStoreInvestmentInvitationId, String cityServiceCenterId,  String [] tokensExpr)
		 throws Exception{
	...
	protected RetailStoreInvestmentInvitation breakWithRetailStoreByCreation(YoubenbenUserContext userContext, String retailStoreInvestmentInvitationId, String creationId,  String [] tokensExpr)
		 throws Exception{
	...
	protected RetailStoreInvestmentInvitation breakWithRetailStoreByFranchising(YoubenbenUserContext userContext, String retailStoreInvestmentInvitationId, String franchisingId,  String [] tokensExpr)
		 throws Exception{
	...
	protected RetailStoreInvestmentInvitation breakWithRetailStoreByDecoration(YoubenbenUserContext userContext, String retailStoreInvestmentInvitationId, String decorationId,  String [] tokensExpr)
		 throws Exception{
	...
	protected RetailStoreInvestmentInvitation breakWithRetailStoreByOpening(YoubenbenUserContext userContext, String retailStoreInvestmentInvitationId, String openingId,  String [] tokensExpr)
		 throws Exception{
	...
	protected RetailStoreInvestmentInvitation breakWithRetailStoreByClosing(YoubenbenUserContext userContext, String retailStoreInvestmentInvitationId, String closingId,  String [] tokensExpr)
		 throws Exception{
	...
	protected void checkParamsForUpdatingRetailStoreProperties(YoubenbenUserContext userContext, String retailStoreInvestmentInvitationId,String id,String name,String telephone,String owner,Date founded,BigDecimal latitude,BigDecimal longitude,String description,String [] tokensExpr) throws Exception {
	...
	public  RetailStoreInvestmentInvitation updateRetailStoreProperties(YoubenbenUserContext userContext, String retailStoreInvestmentInvitationId, String id,String name,String telephone,String owner,Date founded,BigDecimal latitude,BigDecimal longitude,String description, String [] tokensExpr) throws Exception
	{
	...
	protected RetailStore createRetailStore(YoubenbenUserContext userContext, String name, String telephone, String owner, String retailStoreCountryCenterId, String cityServiceCenterId, String creationId, String franchisingId, String decorationId, String openingId, String closingId, Date founded, BigDecimal latitude, BigDecimal longitude, String description) throws Exception{
	...
	protected void checkParamsForRemovingRetailStoreList(YoubenbenUserContext userContext, String retailStoreInvestmentInvitationId,
	...
	public  RetailStoreInvestmentInvitation removeRetailStoreList(YoubenbenUserContext userContext, String retailStoreInvestmentInvitationId,
			String retailStoreIds[],String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForRemovingRetailStore(YoubenbenUserContext userContext, String retailStoreInvestmentInvitationId,
	...
	public  RetailStoreInvestmentInvitation removeRetailStore(YoubenbenUserContext userContext, String retailStoreInvestmentInvitationId,
		String retailStoreId, int retailStoreVersion,String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForCopyingRetailStore(YoubenbenUserContext userContext, String retailStoreInvestmentInvitationId,
		String retailStoreId, int retailStoreVersion,String [] tokensExpr) throws Exception{
	...
	public  RetailStoreInvestmentInvitation copyRetailStoreFrom(YoubenbenUserContext userContext, String retailStoreInvestmentInvitationId,
		String retailStoreId, int retailStoreVersion,String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForUpdatingRetailStore(YoubenbenUserContext userContext, String retailStoreInvestmentInvitationId, String retailStoreId, int retailStoreVersion, String property, String newValueExpr,String [] tokensExpr) throws Exception{
	...
	public  RetailStoreInvestmentInvitation updateRetailStore(YoubenbenUserContext userContext, String retailStoreInvestmentInvitationId, String retailStoreId, int retailStoreVersion, String property, String newValueExpr,String [] tokensExpr)
			throws Exception{
	...
	*/
	...
	// -----------------------------------// list-of-view 处理 \\-----------------------------------
    protected void enhanceForListOfView(YoubenbenUserContext userContext,SmartList<RetailStoreInvestmentInvitation> list) throws Exception {
  ...
  // -----------------------------------\\ list-of-view 处理 //-----------------------------------v
	 ...
	 * @throws Exception
	 */
 	public Object wxappview(YoubenbenUserContext userContext, String retailStoreInvestmentInvitationId) throws Exception{
	  SerializeScope vscope = YoubenbenViewScope.getInstance().getRetailStoreInvestmentInvitationDetailScope().clone();
