...
public class RetailStoreInvestmentInvitationJDBCTemplateDAO extends YoubenbenBaseDAOImpl implements RetailStoreInvestmentInvitationDAO{
	...
	*/
    ...
    public SmartList<RetailStoreInvestmentInvitation> requestCandidateRetailStoreInvestmentInvitationForRetailStore(YoubenbenUserContext userContext, String ownerClass, String id, String filterKey, int pageNo, int pageSize) throws Exception {
	...
	public SmartList<RetailStore> loadOurRetailStoreList(YoubenbenUserContext userContext, List<RetailStoreInvestmentInvitation> us, Map<String,Object> options) throws Exception{
