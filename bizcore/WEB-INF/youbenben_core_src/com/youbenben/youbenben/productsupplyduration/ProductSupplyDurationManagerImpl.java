...
import com.youbenben.youbenben.supplierproduct.CandidateSupplierProduct;
...
public class ProductSupplyDurationManagerImpl extends CustomYoubenbenCheckerManager implements ProductSupplyDurationManager, BusinessHandler{
	...
	@Override
	public ProductSupplyDurationDAO daoOf(YoubenbenUserContext userContext) {
	...
	protected void throwExceptionWithMessage(String value) throws ProductSupplyDurationManagerException{
 	...
 	protected ProductSupplyDuration saveProductSupplyDuration(YoubenbenUserContext userContext, ProductSupplyDuration productSupplyDuration, String [] tokensExpr) throws Exception{	
 	...
 	protected ProductSupplyDuration saveProductSupplyDurationDetail(YoubenbenUserContext userContext, ProductSupplyDuration productSupplyDuration) throws Exception{	
 	...
 	public ProductSupplyDuration loadProductSupplyDuration(YoubenbenUserContext userContext, String productSupplyDurationId, String [] tokensExpr) throws Exception{				
 	 ...
 	 public ProductSupplyDuration searchProductSupplyDuration(YoubenbenUserContext userContext, String productSupplyDurationId, String textToSearch,String [] tokensExpr) throws Exception{				
 	...
 	protected ProductSupplyDuration present(YoubenbenUserContext userContext, ProductSupplyDuration productSupplyDuration, Map<String, Object> tokens) throws Exception {
 	...
 	public ProductSupplyDuration loadProductSupplyDurationDetail(YoubenbenUserContext userContext, String productSupplyDurationId) throws Exception{	
 	...
 	public Object view(YoubenbenUserContext userContext, String productSupplyDurationId) throws Exception{	
 		ProductSupplyDuration productSupplyDuration = loadProductSupplyDuration( userContext, productSupplyDurationId, viewTokens());
 		return present(userContext,productSupplyDuration, allTokens());
		
 	}
 	protected ProductSupplyDuration saveProductSupplyDuration(YoubenbenUserContext userContext, ProductSupplyDuration productSupplyDuration, Map<String,Object>tokens) throws Exception{	
 		return productSupplyDurationDaoOf(userContext).save(productSupplyDuration, tokens);
 	}
 	protected ProductSupplyDuration loadProductSupplyDuration(YoubenbenUserContext userContext, String productSupplyDurationId, Map<String,Object>tokens) throws Exception{	
		checkerOf(userContext).checkIdOfProductSupplyDuration(productSupplyDurationId);
		checkerOf(userContext).throwExceptionIfHasErrors( ProductSupplyDurationManagerException.class);
 	...
 	protected<T extends BaseEntity> void addActions(YoubenbenUserContext userContext, ProductSupplyDuration productSupplyDuration, Map<String, Object> tokens){
	...
	}// end method of protected<T extends BaseEntity> void addActions(YoubenbenUserContext userContext, ProductSupplyDuration productSupplyDuration, Map<String, Object> tokens){
	...
	protected void checkParamsForUpdatingProductSupplyDuration(YoubenbenUserContext userContext,String productSupplyDurationId, int productSupplyDurationVersion, String property, String newValueExpr,String [] tokensExpr)throws Exception
	{
	...
	public ProductSupplyDuration clone(YoubenbenUserContext userContext, String fromProductSupplyDurationId) throws Exception{
	...
	public ProductSupplyDuration internalSaveProductSupplyDuration(YoubenbenUserContext userContext, ProductSupplyDuration productSupplyDuration, Map<String,Object> options) throws Exception
	{
	...
	public ProductSupplyDuration updateProductSupplyDurationProperty(YoubenbenUserContext userContext,String productSupplyDurationId, int productSupplyDurationVersion, String property, String newValueExpr,String [] tokensExpr) throws Exception
	{
		checkParamsForUpdatingProductSupplyDuration(userContext, productSupplyDurationId, productSupplyDurationVersion, property, newValueExpr, tokensExpr);
	...
	protected void checkParamsForTransferingAnotherProduct(YoubenbenUserContext userContext, String productSupplyDurationId, String anotherProductId) throws Exception
 	{
	...
	public CandidateSupplierProduct requestCandidateProduct(YoubenbenUserContext userContext, String ownerClass, String id, String filterKey, int pageNo) throws Exception {
 ...
 //--------------------------------------------------------------
 	...
 	protected SupplierProduct loadSupplierProduct(YoubenbenUserContext userContext, String newProductId, Map<String,Object> options) throws Exception
 	{
	...
	public void delete(YoubenbenUserContext userContext, String productSupplyDurationId, int productSupplyDurationVersion) throws Exception {
	...
	public ProductSupplyDuration forgetByAll(YoubenbenUserContext userContext, String productSupplyDurationId, int productSupplyDurationVersion) throws Exception {
		return forgetByAllInternal(userContext, productSupplyDurationId, productSupplyDurationVersion);
	}
	protected ProductSupplyDuration forgetByAllInternal(YoubenbenUserContext userContext,
			String productSupplyDurationId, int productSupplyDurationVersion) throws Exception{
	...
	// -----------------------------------// list-of-view 处理 \\-----------------------------------
    protected void enhanceForListOfView(YoubenbenUserContext userContext,SmartList<ProductSupplyDuration> list) throws Exception {
    	if (list == null || list.isEmpty()){
    		return;
    	}
		List<SupplierProduct> productList = YoubenbenBaseUtils.collectReferencedObjectWithType(userContext, list, SupplierProduct.class);
  ...
  // -----------------------------------\\ list-of-view 处理 //-----------------------------------v
	 ...
	 * @throws Exception
	 */
 	public Object wxappview(YoubenbenUserContext userContext, String productSupplyDurationId) throws Exception{
	  SerializeScope vscope = YoubenbenViewScope.getInstance().getProductSupplyDurationDetailScope().clone();
