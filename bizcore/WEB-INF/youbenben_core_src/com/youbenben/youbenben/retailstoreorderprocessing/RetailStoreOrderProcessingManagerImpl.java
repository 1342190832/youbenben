...
public class RetailStoreOrderProcessingManagerImpl extends CustomYoubenbenCheckerManager implements RetailStoreOrderProcessingManager, BusinessHandler{
	...
	@Override
	public RetailStoreOrderProcessingDAO daoOf(YoubenbenUserContext userContext) {
	...
	protected void throwExceptionWithMessage(String value) throws RetailStoreOrderProcessingManagerException{
 	...
 	protected RetailStoreOrderProcessing saveRetailStoreOrderProcessing(YoubenbenUserContext userContext, RetailStoreOrderProcessing retailStoreOrderProcessing, String [] tokensExpr) throws Exception{	
 	...
 	protected RetailStoreOrderProcessing saveRetailStoreOrderProcessingDetail(YoubenbenUserContext userContext, RetailStoreOrderProcessing retailStoreOrderProcessing) throws Exception{	
 	...
 	public RetailStoreOrderProcessing loadRetailStoreOrderProcessing(YoubenbenUserContext userContext, String retailStoreOrderProcessingId, String [] tokensExpr) throws Exception{				
 	 ...
 	 public RetailStoreOrderProcessing searchRetailStoreOrderProcessing(YoubenbenUserContext userContext, String retailStoreOrderProcessingId, String textToSearch,String [] tokensExpr) throws Exception{				
 	...
 	protected RetailStoreOrderProcessing present(YoubenbenUserContext userContext, RetailStoreOrderProcessing retailStoreOrderProcessing, Map<String, Object> tokens) throws Exception {
 	...
 	public RetailStoreOrderProcessing loadRetailStoreOrderProcessingDetail(YoubenbenUserContext userContext, String retailStoreOrderProcessingId) throws Exception{	
 	...
 	public Object view(YoubenbenUserContext userContext, String retailStoreOrderProcessingId) throws Exception{	
 	...
 	protected RetailStoreOrderProcessing saveRetailStoreOrderProcessing(YoubenbenUserContext userContext, RetailStoreOrderProcessing retailStoreOrderProcessing, Map<String,Object>tokens) throws Exception{	
 		return retailStoreOrderProcessingDaoOf(userContext).save(retailStoreOrderProcessing, tokens);
 	}
 	protected RetailStoreOrderProcessing loadRetailStoreOrderProcessing(YoubenbenUserContext userContext, String retailStoreOrderProcessingId, Map<String,Object>tokens) throws Exception{	
		checkerOf(userContext).checkIdOfRetailStoreOrderProcessing(retailStoreOrderProcessingId);
		checkerOf(userContext).throwExceptionIfHasErrors( RetailStoreOrderProcessingManagerException.class);
 	...
 	protected<T extends BaseEntity> void addActions(YoubenbenUserContext userContext, RetailStoreOrderProcessing retailStoreOrderProcessing, Map<String, Object> tokens){
	...
	}// end method of protected<T extends BaseEntity> void addActions(YoubenbenUserContext userContext, RetailStoreOrderProcessing retailStoreOrderProcessing, Map<String, Object> tokens){
	...
	protected void checkParamsForUpdatingRetailStoreOrderProcessing(YoubenbenUserContext userContext,String retailStoreOrderProcessingId, int retailStoreOrderProcessingVersion, String property, String newValueExpr,String [] tokensExpr)throws Exception
	{
	...
	public RetailStoreOrderProcessing clone(YoubenbenUserContext userContext, String fromRetailStoreOrderProcessingId) throws Exception{
	...
	public RetailStoreOrderProcessing internalSaveRetailStoreOrderProcessing(YoubenbenUserContext userContext, RetailStoreOrderProcessing retailStoreOrderProcessing, Map<String,Object> options) throws Exception
	{
	...
	public RetailStoreOrderProcessing updateRetailStoreOrderProcessingProperty(YoubenbenUserContext userContext,String retailStoreOrderProcessingId, int retailStoreOrderProcessingVersion, String property, String newValueExpr,String [] tokensExpr) throws Exception
	{
		checkParamsForUpdatingRetailStoreOrderProcessing(userContext, retailStoreOrderProcessingId, retailStoreOrderProcessingVersion, property, newValueExpr, tokensExpr);
...
//--------------------------------------------------------------
	...
	public void delete(YoubenbenUserContext userContext, String retailStoreOrderProcessingId, int retailStoreOrderProcessingVersion) throws Exception {
	...
	public RetailStoreOrderProcessing forgetByAll(YoubenbenUserContext userContext, String retailStoreOrderProcessingId, int retailStoreOrderProcessingVersion) throws Exception {
		return forgetByAllInternal(userContext, retailStoreOrderProcessingId, retailStoreOrderProcessingVersion);
	}
	protected RetailStoreOrderProcessing forgetByAllInternal(YoubenbenUserContext userContext,
			String retailStoreOrderProcessingId, int retailStoreOrderProcessingVersion) throws Exception{
	...
	protected RetailStoreOrderProcessing breakWithRetailStoreOrderByBuyer(YoubenbenUserContext userContext, String retailStoreOrderProcessingId, String buyerId,  String [] tokensExpr)
		 throws Exception{
	...
	protected RetailStoreOrderProcessing breakWithRetailStoreOrderBySeller(YoubenbenUserContext userContext, String retailStoreOrderProcessingId, String sellerId,  String [] tokensExpr)
		 throws Exception{
	...
	protected RetailStoreOrderProcessing breakWithRetailStoreOrderByConfirmation(YoubenbenUserContext userContext, String retailStoreOrderProcessingId, String confirmationId,  String [] tokensExpr)
		 throws Exception{
	...
	protected RetailStoreOrderProcessing breakWithRetailStoreOrderByApproval(YoubenbenUserContext userContext, String retailStoreOrderProcessingId, String approvalId,  String [] tokensExpr)
		 throws Exception{
	...
	protected RetailStoreOrderProcessing breakWithRetailStoreOrderByPicking(YoubenbenUserContext userContext, String retailStoreOrderProcessingId, String pickingId,  String [] tokensExpr)
		 throws Exception{
	...
	protected RetailStoreOrderProcessing breakWithRetailStoreOrderByShipment(YoubenbenUserContext userContext, String retailStoreOrderProcessingId, String shipmentId,  String [] tokensExpr)
		 throws Exception{
	...
	protected RetailStoreOrderProcessing breakWithRetailStoreOrderByDelivery(YoubenbenUserContext userContext, String retailStoreOrderProcessingId, String deliveryId,  String [] tokensExpr)
		 throws Exception{
	...
	protected void checkParamsForUpdatingRetailStoreOrderProperties(YoubenbenUserContext userContext, String retailStoreOrderProcessingId,String id,String title,BigDecimal totalAmount,String [] tokensExpr) throws Exception {
	...
	public  RetailStoreOrderProcessing updateRetailStoreOrderProperties(YoubenbenUserContext userContext, String retailStoreOrderProcessingId, String id,String title,BigDecimal totalAmount, String [] tokensExpr) throws Exception
	{
	...
	protected RetailStoreOrder createRetailStoreOrder(YoubenbenUserContext userContext, String buyerId, String sellerId, String title, BigDecimal totalAmount, String confirmationId, String approvalId, String pickingId, String shipmentId, String deliveryId) throws Exception{
	...
	protected void checkParamsForRemovingRetailStoreOrderList(YoubenbenUserContext userContext, String retailStoreOrderProcessingId,
	...
	public  RetailStoreOrderProcessing removeRetailStoreOrderList(YoubenbenUserContext userContext, String retailStoreOrderProcessingId,
			String retailStoreOrderIds[],String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForRemovingRetailStoreOrder(YoubenbenUserContext userContext, String retailStoreOrderProcessingId,
	...
	public  RetailStoreOrderProcessing removeRetailStoreOrder(YoubenbenUserContext userContext, String retailStoreOrderProcessingId,
		String retailStoreOrderId, int retailStoreOrderVersion,String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForCopyingRetailStoreOrder(YoubenbenUserContext userContext, String retailStoreOrderProcessingId,
		String retailStoreOrderId, int retailStoreOrderVersion,String [] tokensExpr) throws Exception{
	...
	public  RetailStoreOrderProcessing copyRetailStoreOrderFrom(YoubenbenUserContext userContext, String retailStoreOrderProcessingId,
		String retailStoreOrderId, int retailStoreOrderVersion,String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForUpdatingRetailStoreOrder(YoubenbenUserContext userContext, String retailStoreOrderProcessingId, String retailStoreOrderId, int retailStoreOrderVersion, String property, String newValueExpr,String [] tokensExpr) throws Exception{
	...
	public  RetailStoreOrderProcessing updateRetailStoreOrder(YoubenbenUserContext userContext, String retailStoreOrderProcessingId, String retailStoreOrderId, int retailStoreOrderVersion, String property, String newValueExpr,String [] tokensExpr)
			throws Exception{
	...
	*/
	...
	// -----------------------------------// list-of-view 处理 \\-----------------------------------
    protected void enhanceForListOfView(YoubenbenUserContext userContext,SmartList<RetailStoreOrderProcessing> list) throws Exception {
  ...
  // -----------------------------------\\ list-of-view 处理 //-----------------------------------v
	 ...
	 * @throws Exception
	 */
 	public Object wxappview(YoubenbenUserContext userContext, String retailStoreOrderProcessingId) throws Exception{
	  SerializeScope vscope = YoubenbenViewScope.getInstance().getRetailStoreOrderProcessingDetailScope().clone();
