...
public class RetailStoreOrderLineItemManagerImpl extends CustomYoubenbenCheckerManager implements RetailStoreOrderLineItemManager, BusinessHandler{
	...
	@Override
	public RetailStoreOrderLineItemDAO daoOf(YoubenbenUserContext userContext) {
	...
	protected void throwExceptionWithMessage(String value) throws RetailStoreOrderLineItemManagerException{
 	...
 	protected RetailStoreOrderLineItem saveRetailStoreOrderLineItem(YoubenbenUserContext userContext, RetailStoreOrderLineItem retailStoreOrderLineItem, String [] tokensExpr) throws Exception{	
 	...
 	protected RetailStoreOrderLineItem saveRetailStoreOrderLineItemDetail(YoubenbenUserContext userContext, RetailStoreOrderLineItem retailStoreOrderLineItem) throws Exception{	
 	...
 	public RetailStoreOrderLineItem loadRetailStoreOrderLineItem(YoubenbenUserContext userContext, String retailStoreOrderLineItemId, String [] tokensExpr) throws Exception{				
 	 ...
 	 public RetailStoreOrderLineItem searchRetailStoreOrderLineItem(YoubenbenUserContext userContext, String retailStoreOrderLineItemId, String textToSearch,String [] tokensExpr) throws Exception{				
 	...
 	protected RetailStoreOrderLineItem present(YoubenbenUserContext userContext, RetailStoreOrderLineItem retailStoreOrderLineItem, Map<String, Object> tokens) throws Exception {
 	...
 	public RetailStoreOrderLineItem loadRetailStoreOrderLineItemDetail(YoubenbenUserContext userContext, String retailStoreOrderLineItemId) throws Exception{	
 	...
 	public Object view(YoubenbenUserContext userContext, String retailStoreOrderLineItemId) throws Exception{	
 	...
 	protected RetailStoreOrderLineItem saveRetailStoreOrderLineItem(YoubenbenUserContext userContext, RetailStoreOrderLineItem retailStoreOrderLineItem, Map<String,Object>tokens) throws Exception{	
 		return retailStoreOrderLineItemDaoOf(userContext).save(retailStoreOrderLineItem, tokens);
 	}
 	protected RetailStoreOrderLineItem loadRetailStoreOrderLineItem(YoubenbenUserContext userContext, String retailStoreOrderLineItemId, Map<String,Object>tokens) throws Exception{	
		checkerOf(userContext).checkIdOfRetailStoreOrderLineItem(retailStoreOrderLineItemId);
		checkerOf(userContext).throwExceptionIfHasErrors( RetailStoreOrderLineItemManagerException.class);
 	...
 	protected<T extends BaseEntity> void addActions(YoubenbenUserContext userContext, RetailStoreOrderLineItem retailStoreOrderLineItem, Map<String, Object> tokens){
	...
	}// end method of protected<T extends BaseEntity> void addActions(YoubenbenUserContext userContext, RetailStoreOrderLineItem retailStoreOrderLineItem, Map<String, Object> tokens){
	...
	protected void checkParamsForUpdatingRetailStoreOrderLineItem(YoubenbenUserContext userContext,String retailStoreOrderLineItemId, int retailStoreOrderLineItemVersion, String property, String newValueExpr,String [] tokensExpr)throws Exception
	{
	...
	public RetailStoreOrderLineItem clone(YoubenbenUserContext userContext, String fromRetailStoreOrderLineItemId) throws Exception{
	...
	public RetailStoreOrderLineItem internalSaveRetailStoreOrderLineItem(YoubenbenUserContext userContext, RetailStoreOrderLineItem retailStoreOrderLineItem, Map<String,Object> options) throws Exception
	{
	...
	public RetailStoreOrderLineItem updateRetailStoreOrderLineItemProperty(YoubenbenUserContext userContext,String retailStoreOrderLineItemId, int retailStoreOrderLineItemVersion, String property, String newValueExpr,String [] tokensExpr) throws Exception
	{
		checkParamsForUpdatingRetailStoreOrderLineItem(userContext, retailStoreOrderLineItemId, retailStoreOrderLineItemVersion, property, newValueExpr, tokensExpr);
	...
	protected void checkParamsForTransferingAnotherBizOrder(YoubenbenUserContext userContext, String retailStoreOrderLineItemId, String anotherBizOrderId) throws Exception
 	{
 ...
 //--------------------------------------------------------------
	...
	public void delete(YoubenbenUserContext userContext, String retailStoreOrderLineItemId, int retailStoreOrderLineItemVersion) throws Exception {
	...
	public RetailStoreOrderLineItem forgetByAll(YoubenbenUserContext userContext, String retailStoreOrderLineItemId, int retailStoreOrderLineItemVersion) throws Exception {
		return forgetByAllInternal(userContext, retailStoreOrderLineItemId, retailStoreOrderLineItemVersion);
	}
	protected RetailStoreOrderLineItem forgetByAllInternal(YoubenbenUserContext userContext,
			String retailStoreOrderLineItemId, int retailStoreOrderLineItemVersion) throws Exception{
	...
	// -----------------------------------// list-of-view 处理 \\-----------------------------------
    protected void enhanceForListOfView(YoubenbenUserContext userContext,SmartList<RetailStoreOrderLineItem> list) throws Exception {
  ...
  // -----------------------------------\\ list-of-view 处理 //-----------------------------------v
	 ...
	 * @throws Exception
	 */
 	public Object wxappview(YoubenbenUserContext userContext, String retailStoreOrderLineItemId) throws Exception{
	  SerializeScope vscope = YoubenbenViewScope.getInstance().getRetailStoreOrderLineItemDetailScope().clone();
