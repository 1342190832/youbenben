...
public class EmployeeEducationManagerImpl extends CustomYoubenbenCheckerManager implements EmployeeEducationManager, BusinessHandler{
	...
	@Override
	public EmployeeEducationDAO daoOf(YoubenbenUserContext userContext) {
	...
	protected void throwExceptionWithMessage(String value) throws EmployeeEducationManagerException{
 	...
 	protected EmployeeEducation saveEmployeeEducation(YoubenbenUserContext userContext, EmployeeEducation employeeEducation, String [] tokensExpr) throws Exception{	
 	...
 	protected EmployeeEducation saveEmployeeEducationDetail(YoubenbenUserContext userContext, EmployeeEducation employeeEducation) throws Exception{	
 	...
 	public EmployeeEducation loadEmployeeEducation(YoubenbenUserContext userContext, String employeeEducationId, String [] tokensExpr) throws Exception{				
 	 ...
 	 public EmployeeEducation searchEmployeeEducation(YoubenbenUserContext userContext, String employeeEducationId, String textToSearch,String [] tokensExpr) throws Exception{				
 	...
 	protected EmployeeEducation present(YoubenbenUserContext userContext, EmployeeEducation employeeEducation, Map<String, Object> tokens) throws Exception {
 	...
 	public EmployeeEducation loadEmployeeEducationDetail(YoubenbenUserContext userContext, String employeeEducationId) throws Exception{	
 	...
 	public Object view(YoubenbenUserContext userContext, String employeeEducationId) throws Exception{	
 		EmployeeEducation employeeEducation = loadEmployeeEducation( userContext, employeeEducationId, viewTokens());
 		return present(userContext,employeeEducation, allTokens());
		
 	}
 	protected EmployeeEducation saveEmployeeEducation(YoubenbenUserContext userContext, EmployeeEducation employeeEducation, Map<String,Object>tokens) throws Exception{	
 		return employeeEducationDaoOf(userContext).save(employeeEducation, tokens);
 	}
 	protected EmployeeEducation loadEmployeeEducation(YoubenbenUserContext userContext, String employeeEducationId, Map<String,Object>tokens) throws Exception{	
		checkerOf(userContext).checkIdOfEmployeeEducation(employeeEducationId);
		checkerOf(userContext).throwExceptionIfHasErrors( EmployeeEducationManagerException.class);
 	...
 	protected<T extends BaseEntity> void addActions(YoubenbenUserContext userContext, EmployeeEducation employeeEducation, Map<String, Object> tokens){
	...
	}// end method of protected<T extends BaseEntity> void addActions(YoubenbenUserContext userContext, EmployeeEducation employeeEducation, Map<String, Object> tokens){
	...
	protected void checkParamsForUpdatingEmployeeEducation(YoubenbenUserContext userContext,String employeeEducationId, int employeeEducationVersion, String property, String newValueExpr,String [] tokensExpr)throws Exception
	{
	...
	public EmployeeEducation clone(YoubenbenUserContext userContext, String fromEmployeeEducationId) throws Exception{
	...
	public EmployeeEducation internalSaveEmployeeEducation(YoubenbenUserContext userContext, EmployeeEducation employeeEducation, Map<String,Object> options) throws Exception
	{
	...
	public EmployeeEducation updateEmployeeEducationProperty(YoubenbenUserContext userContext,String employeeEducationId, int employeeEducationVersion, String property, String newValueExpr,String [] tokensExpr) throws Exception
	{
		checkParamsForUpdatingEmployeeEducation(userContext, employeeEducationId, employeeEducationVersion, property, newValueExpr, tokensExpr);
	...
	protected void checkParamsForTransferingAnotherEmployee(YoubenbenUserContext userContext, String employeeEducationId, String anotherEmployeeId) throws Exception
 	{
 ...
 //--------------------------------------------------------------
	...
	public void delete(YoubenbenUserContext userContext, String employeeEducationId, int employeeEducationVersion) throws Exception {
	...
	public EmployeeEducation forgetByAll(YoubenbenUserContext userContext, String employeeEducationId, int employeeEducationVersion) throws Exception {
		return forgetByAllInternal(userContext, employeeEducationId, employeeEducationVersion);
	}
	protected EmployeeEducation forgetByAllInternal(YoubenbenUserContext userContext,
			String employeeEducationId, int employeeEducationVersion) throws Exception{
	...
	// -----------------------------------// list-of-view 处理 \\-----------------------------------
    protected void enhanceForListOfView(YoubenbenUserContext userContext,SmartList<EmployeeEducation> list) throws Exception {
  ...
  // -----------------------------------\\ list-of-view 处理 //-----------------------------------v
	 ...
	 * @throws Exception
	 */
 	public Object wxappview(YoubenbenUserContext userContext, String employeeEducationId) throws Exception{
	  SerializeScope vscope = YoubenbenViewScope.getInstance().getEmployeeEducationDetailScope().clone();
