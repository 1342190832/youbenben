...
import com.youbenben.youbenben.goodsshelfstockcount.CandidateGoodsShelfStockCount;
...
public class StockCountIssueTrackManagerImpl extends CustomYoubenbenCheckerManager implements StockCountIssueTrackManager, BusinessHandler{
	...
	@Override
	public StockCountIssueTrackDAO daoOf(YoubenbenUserContext userContext) {
	...
	protected void throwExceptionWithMessage(String value) throws StockCountIssueTrackManagerException{
 	...
 	protected StockCountIssueTrack saveStockCountIssueTrack(YoubenbenUserContext userContext, StockCountIssueTrack stockCountIssueTrack, String [] tokensExpr) throws Exception{	
 	...
 	protected StockCountIssueTrack saveStockCountIssueTrackDetail(YoubenbenUserContext userContext, StockCountIssueTrack stockCountIssueTrack) throws Exception{	
 	...
 	public StockCountIssueTrack loadStockCountIssueTrack(YoubenbenUserContext userContext, String stockCountIssueTrackId, String [] tokensExpr) throws Exception{				
 	 ...
 	 public StockCountIssueTrack searchStockCountIssueTrack(YoubenbenUserContext userContext, String stockCountIssueTrackId, String textToSearch,String [] tokensExpr) throws Exception{				
 	...
 	protected StockCountIssueTrack present(YoubenbenUserContext userContext, StockCountIssueTrack stockCountIssueTrack, Map<String, Object> tokens) throws Exception {
 	...
 	public StockCountIssueTrack loadStockCountIssueTrackDetail(YoubenbenUserContext userContext, String stockCountIssueTrackId) throws Exception{	
 	...
 	public Object view(YoubenbenUserContext userContext, String stockCountIssueTrackId) throws Exception{	
 		StockCountIssueTrack stockCountIssueTrack = loadStockCountIssueTrack( userContext, stockCountIssueTrackId, viewTokens());
 		return present(userContext,stockCountIssueTrack, allTokens());
		
 	}
 	protected StockCountIssueTrack saveStockCountIssueTrack(YoubenbenUserContext userContext, StockCountIssueTrack stockCountIssueTrack, Map<String,Object>tokens) throws Exception{	
 		return stockCountIssueTrackDaoOf(userContext).save(stockCountIssueTrack, tokens);
 	}
 	protected StockCountIssueTrack loadStockCountIssueTrack(YoubenbenUserContext userContext, String stockCountIssueTrackId, Map<String,Object>tokens) throws Exception{	
		checkerOf(userContext).checkIdOfStockCountIssueTrack(stockCountIssueTrackId);
		checkerOf(userContext).throwExceptionIfHasErrors( StockCountIssueTrackManagerException.class);
 	...
 	protected<T extends BaseEntity> void addActions(YoubenbenUserContext userContext, StockCountIssueTrack stockCountIssueTrack, Map<String, Object> tokens){
	...
	}// end method of protected<T extends BaseEntity> void addActions(YoubenbenUserContext userContext, StockCountIssueTrack stockCountIssueTrack, Map<String, Object> tokens){
	...
	protected void checkParamsForUpdatingStockCountIssueTrack(YoubenbenUserContext userContext,String stockCountIssueTrackId, int stockCountIssueTrackVersion, String property, String newValueExpr,String [] tokensExpr)throws Exception
	{
	...
	public StockCountIssueTrack clone(YoubenbenUserContext userContext, String fromStockCountIssueTrackId) throws Exception{
	...
	public StockCountIssueTrack internalSaveStockCountIssueTrack(YoubenbenUserContext userContext, StockCountIssueTrack stockCountIssueTrack, Map<String,Object> options) throws Exception
	{
	...
	public StockCountIssueTrack updateStockCountIssueTrackProperty(YoubenbenUserContext userContext,String stockCountIssueTrackId, int stockCountIssueTrackVersion, String property, String newValueExpr,String [] tokensExpr) throws Exception
	{
		checkParamsForUpdatingStockCountIssueTrack(userContext, stockCountIssueTrackId, stockCountIssueTrackVersion, property, newValueExpr, tokensExpr);
	...
	protected void checkParamsForTransferingAnotherStockCount(YoubenbenUserContext userContext, String stockCountIssueTrackId, String anotherStockCountId) throws Exception
 	{
	...
	public CandidateGoodsShelfStockCount requestCandidateStockCount(YoubenbenUserContext userContext, String ownerClass, String id, String filterKey, int pageNo) throws Exception {
 ...
 //--------------------------------------------------------------
 	...
 	protected GoodsShelfStockCount loadGoodsShelfStockCount(YoubenbenUserContext userContext, String newStockCountId, Map<String,Object> options) throws Exception
 	{
	...
	public void delete(YoubenbenUserContext userContext, String stockCountIssueTrackId, int stockCountIssueTrackVersion) throws Exception {
	...
	public StockCountIssueTrack forgetByAll(YoubenbenUserContext userContext, String stockCountIssueTrackId, int stockCountIssueTrackVersion) throws Exception {
		return forgetByAllInternal(userContext, stockCountIssueTrackId, stockCountIssueTrackVersion);
	}
	protected StockCountIssueTrack forgetByAllInternal(YoubenbenUserContext userContext,
			String stockCountIssueTrackId, int stockCountIssueTrackVersion) throws Exception{
	...
	// -----------------------------------// list-of-view 处理 \\-----------------------------------
    protected void enhanceForListOfView(YoubenbenUserContext userContext,SmartList<StockCountIssueTrack> list) throws Exception {
    	if (list == null || list.isEmpty()){
    		return;
    	}
		List<GoodsShelfStockCount> stockCountList = YoubenbenBaseUtils.collectReferencedObjectWithType(userContext, list, GoodsShelfStockCount.class);
  ...
  // -----------------------------------\\ list-of-view 处理 //-----------------------------------v
	 ...
	 * @throws Exception
	 */
 	public Object wxappview(YoubenbenUserContext userContext, String stockCountIssueTrackId) throws Exception{
	  SerializeScope vscope = YoubenbenViewScope.getInstance().getStockCountIssueTrackDetailScope().clone();
