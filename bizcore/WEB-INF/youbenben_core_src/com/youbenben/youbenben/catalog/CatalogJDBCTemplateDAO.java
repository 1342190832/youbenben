...
public class CatalogJDBCTemplateDAO extends YoubenbenBaseDAOImpl implements CatalogDAO{

	protected FranchisedOutletProvinceCenterDAO franchisedOutletProvinceCenterDAO;
	public void setFranchisedOutletProvinceCenterDAO(FranchisedOutletProvinceCenterDAO franchisedOutletProvinceCenterDAO){
 	
 		if(franchisedOutletProvinceCenterDAO == null){
 			throw new IllegalStateException("Do not try to set franchisedOutletProvinceCenterDAO to null.");
 		}
	 	this.franchisedOutletProvinceCenterDAO = franchisedOutletProvinceCenterDAO;
 	}
 	public FranchisedOutletProvinceCenterDAO getFranchisedOutletProvinceCenterDAO(){
 		if(this.franchisedOutletProvinceCenterDAO == null){
 			throw new IllegalStateException("The franchisedOutletProvinceCenterDAO is not configured yet, please config it some where.");
 		}
	...
	*/
	...
	protected Catalog loadInternalCatalog(AccessKey accessKey, Map<String,Object> loadOptions) throws Exception{
 	...
 	protected Catalog extractOwner(Catalog catalog, Map<String,Object> options) throws Exception{
		...
		FranchisedOutletProvinceCenter owner = getFranchisedOutletProvinceCenterDAO().load(ownerId,options);
		if(owner != null){
	...
	protected Catalog analyzeLevelOneCategoryList(Catalog catalog, Map<String,Object> options){
 	...
 	public SmartList<Catalog> findCatalogByOwner(String franchisedOutletProvinceCenterId,Map<String,Object> options){
  		...
  		SmartList<Catalog> resultList = queryWith(CatalogTable.COLUMN_OWNER, franchisedOutletProvinceCenterId, options, getCatalogMapper());
		// analyzeCatalogByOwner(resultList, franchisedOutletProvinceCenterId, options);
		return resultList;
 	}
 	...
 	public SmartList<Catalog> findCatalogByOwner(String franchisedOutletProvinceCenterId, int start, int count,Map<String,Object> options){
 		...
 		SmartList<Catalog> resultList =  queryWithRange(CatalogTable.COLUMN_OWNER, franchisedOutletProvinceCenterId, options, getCatalogMapper(), start, count);
 		//analyzeCatalogByOwner(resultList, franchisedOutletProvinceCenterId, options);
 		return resultList;
 	...
 	public int countCatalogByOwner(String franchisedOutletProvinceCenterId,Map<String,Object> options){
 		...
 		return countWith(CatalogTable.COLUMN_OWNER, franchisedOutletProvinceCenterId, options);
 	}
 	@Override
	...
	//======================================================================================
 	...
 	protected Catalog saveOwner(Catalog catalog, Map<String,Object> options){
 		...
 		getFranchisedOutletProvinceCenterDAO().save(catalog.getOwner(),options);
 		return catalog;
