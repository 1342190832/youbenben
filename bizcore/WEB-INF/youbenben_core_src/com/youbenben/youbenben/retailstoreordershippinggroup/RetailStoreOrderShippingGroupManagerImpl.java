...
public class RetailStoreOrderShippingGroupManagerImpl extends CustomYoubenbenCheckerManager implements RetailStoreOrderShippingGroupManager, BusinessHandler{
	...
	@Override
	public RetailStoreOrderShippingGroupDAO daoOf(YoubenbenUserContext userContext) {
	...
	protected void throwExceptionWithMessage(String value) throws RetailStoreOrderShippingGroupManagerException{
 	...
 	protected RetailStoreOrderShippingGroup saveRetailStoreOrderShippingGroup(YoubenbenUserContext userContext, RetailStoreOrderShippingGroup retailStoreOrderShippingGroup, String [] tokensExpr) throws Exception{	
 	...
 	protected RetailStoreOrderShippingGroup saveRetailStoreOrderShippingGroupDetail(YoubenbenUserContext userContext, RetailStoreOrderShippingGroup retailStoreOrderShippingGroup) throws Exception{	
 	...
 	public RetailStoreOrderShippingGroup loadRetailStoreOrderShippingGroup(YoubenbenUserContext userContext, String retailStoreOrderShippingGroupId, String [] tokensExpr) throws Exception{				
 	 ...
 	 public RetailStoreOrderShippingGroup searchRetailStoreOrderShippingGroup(YoubenbenUserContext userContext, String retailStoreOrderShippingGroupId, String textToSearch,String [] tokensExpr) throws Exception{				
 	...
 	protected RetailStoreOrderShippingGroup present(YoubenbenUserContext userContext, RetailStoreOrderShippingGroup retailStoreOrderShippingGroup, Map<String, Object> tokens) throws Exception {
 	...
 	public RetailStoreOrderShippingGroup loadRetailStoreOrderShippingGroupDetail(YoubenbenUserContext userContext, String retailStoreOrderShippingGroupId) throws Exception{	
 	...
 	public Object view(YoubenbenUserContext userContext, String retailStoreOrderShippingGroupId) throws Exception{	
 	...
 	protected RetailStoreOrderShippingGroup saveRetailStoreOrderShippingGroup(YoubenbenUserContext userContext, RetailStoreOrderShippingGroup retailStoreOrderShippingGroup, Map<String,Object>tokens) throws Exception{	
 		return retailStoreOrderShippingGroupDaoOf(userContext).save(retailStoreOrderShippingGroup, tokens);
 	}
 	protected RetailStoreOrderShippingGroup loadRetailStoreOrderShippingGroup(YoubenbenUserContext userContext, String retailStoreOrderShippingGroupId, Map<String,Object>tokens) throws Exception{	
		checkerOf(userContext).checkIdOfRetailStoreOrderShippingGroup(retailStoreOrderShippingGroupId);
		checkerOf(userContext).throwExceptionIfHasErrors( RetailStoreOrderShippingGroupManagerException.class);
 	...
 	protected<T extends BaseEntity> void addActions(YoubenbenUserContext userContext, RetailStoreOrderShippingGroup retailStoreOrderShippingGroup, Map<String, Object> tokens){
	...
	}// end method of protected<T extends BaseEntity> void addActions(YoubenbenUserContext userContext, RetailStoreOrderShippingGroup retailStoreOrderShippingGroup, Map<String, Object> tokens){
	...
	protected void checkParamsForUpdatingRetailStoreOrderShippingGroup(YoubenbenUserContext userContext,String retailStoreOrderShippingGroupId, int retailStoreOrderShippingGroupVersion, String property, String newValueExpr,String [] tokensExpr)throws Exception
	{
	...
	public RetailStoreOrderShippingGroup clone(YoubenbenUserContext userContext, String fromRetailStoreOrderShippingGroupId) throws Exception{
	...
	public RetailStoreOrderShippingGroup internalSaveRetailStoreOrderShippingGroup(YoubenbenUserContext userContext, RetailStoreOrderShippingGroup retailStoreOrderShippingGroup, Map<String,Object> options) throws Exception
	{
	...
	public RetailStoreOrderShippingGroup updateRetailStoreOrderShippingGroupProperty(YoubenbenUserContext userContext,String retailStoreOrderShippingGroupId, int retailStoreOrderShippingGroupVersion, String property, String newValueExpr,String [] tokensExpr) throws Exception
	{
		checkParamsForUpdatingRetailStoreOrderShippingGroup(userContext, retailStoreOrderShippingGroupId, retailStoreOrderShippingGroupVersion, property, newValueExpr, tokensExpr);
	...
	protected void checkParamsForTransferingAnotherBizOrder(YoubenbenUserContext userContext, String retailStoreOrderShippingGroupId, String anotherBizOrderId) throws Exception
 	{
	...
	public CandidateRetailStoreOrder requestCandidateBizOrder(YoubenbenUserContext userContext, String ownerClass, String id, String filterKey, int pageNo) throws Exception {
 ...
 //--------------------------------------------------------------
 	...
 	protected RetailStoreOrder loadRetailStoreOrder(YoubenbenUserContext userContext, String newBizOrderId, Map<String,Object> options) throws Exception
 	{
	...
	public void delete(YoubenbenUserContext userContext, String retailStoreOrderShippingGroupId, int retailStoreOrderShippingGroupVersion) throws Exception {
	...
	public RetailStoreOrderShippingGroup forgetByAll(YoubenbenUserContext userContext, String retailStoreOrderShippingGroupId, int retailStoreOrderShippingGroupVersion) throws Exception {
		return forgetByAllInternal(userContext, retailStoreOrderShippingGroupId, retailStoreOrderShippingGroupVersion);
	}
	protected RetailStoreOrderShippingGroup forgetByAllInternal(YoubenbenUserContext userContext,
			String retailStoreOrderShippingGroupId, int retailStoreOrderShippingGroupVersion) throws Exception{
	...
	// -----------------------------------// list-of-view 处理 \\-----------------------------------
    protected void enhanceForListOfView(YoubenbenUserContext userContext,SmartList<RetailStoreOrderShippingGroup> list) throws Exception {
    	if (list == null || list.isEmpty()){
    		return;
    	}
		List<RetailStoreOrder> bizOrderList = YoubenbenBaseUtils.collectReferencedObjectWithType(userContext, list, RetailStoreOrder.class);
  ...
  // -----------------------------------\\ list-of-view 处理 //-----------------------------------v
	 ...
	 * @throws Exception
	 */
 	public Object wxappview(YoubenbenUserContext userContext, String retailStoreOrderShippingGroupId) throws Exception{
	  SerializeScope vscope = YoubenbenViewScope.getInstance().getRetailStoreOrderShippingGroupDetailScope().clone();
