...
public class AccountingSubjectManagerImpl extends CustomYoubenbenCheckerManager implements AccountingSubjectManager, BusinessHandler{
	...
	@Override
	public AccountingSubjectDAO daoOf(YoubenbenUserContext userContext) {
	...
	protected void throwExceptionWithMessage(String value) throws AccountingSubjectManagerException{
 	...
 	protected AccountingSubject saveAccountingSubject(YoubenbenUserContext userContext, AccountingSubject accountingSubject, String [] tokensExpr) throws Exception{	
 	...
 	protected AccountingSubject saveAccountingSubjectDetail(YoubenbenUserContext userContext, AccountingSubject accountingSubject) throws Exception{	
 	...
 	public AccountingSubject loadAccountingSubject(YoubenbenUserContext userContext, String accountingSubjectId, String [] tokensExpr) throws Exception{				
 	 ...
 	 public AccountingSubject searchAccountingSubject(YoubenbenUserContext userContext, String accountingSubjectId, String textToSearch,String [] tokensExpr) throws Exception{				
 	...
 	protected AccountingSubject present(YoubenbenUserContext userContext, AccountingSubject accountingSubject, Map<String, Object> tokens) throws Exception {
 	...
 	public AccountingSubject loadAccountingSubjectDetail(YoubenbenUserContext userContext, String accountingSubjectId) throws Exception{	
 	...
 	public Object view(YoubenbenUserContext userContext, String accountingSubjectId) throws Exception{	
 		AccountingSubject accountingSubject = loadAccountingSubject( userContext, accountingSubjectId, viewTokens());
 		return present(userContext,accountingSubject, allTokens());
		
 	}
 	protected AccountingSubject saveAccountingSubject(YoubenbenUserContext userContext, AccountingSubject accountingSubject, Map<String,Object>tokens) throws Exception{	
 		return accountingSubjectDaoOf(userContext).save(accountingSubject, tokens);
 	}
 	protected AccountingSubject loadAccountingSubject(YoubenbenUserContext userContext, String accountingSubjectId, Map<String,Object>tokens) throws Exception{	
		checkerOf(userContext).checkIdOfAccountingSubject(accountingSubjectId);
		checkerOf(userContext).throwExceptionIfHasErrors( AccountingSubjectManagerException.class);
 	...
 	protected<T extends BaseEntity> void addActions(YoubenbenUserContext userContext, AccountingSubject accountingSubject, Map<String, Object> tokens){
	...
	}// end method of protected<T extends BaseEntity> void addActions(YoubenbenUserContext userContext, AccountingSubject accountingSubject, Map<String, Object> tokens){
	...
	protected void checkParamsForUpdatingAccountingSubject(YoubenbenUserContext userContext,String accountingSubjectId, int accountingSubjectVersion, String property, String newValueExpr,String [] tokensExpr)throws Exception
	{
	...
	public AccountingSubject clone(YoubenbenUserContext userContext, String fromAccountingSubjectId) throws Exception{
	...
	public AccountingSubject internalSaveAccountingSubject(YoubenbenUserContext userContext, AccountingSubject accountingSubject, Map<String,Object> options) throws Exception
	{
	...
	public AccountingSubject updateAccountingSubjectProperty(YoubenbenUserContext userContext,String accountingSubjectId, int accountingSubjectVersion, String property, String newValueExpr,String [] tokensExpr) throws Exception
	{
		checkParamsForUpdatingAccountingSubject(userContext, accountingSubjectId, accountingSubjectVersion, property, newValueExpr, tokensExpr);
	...
	protected void checkParamsForTransferingAnotherAccountSet(YoubenbenUserContext userContext, String accountingSubjectId, String anotherAccountSetId) throws Exception
 	{
 ...
 //--------------------------------------------------------------
	...
	public void delete(YoubenbenUserContext userContext, String accountingSubjectId, int accountingSubjectVersion) throws Exception {
	...
	public AccountingSubject forgetByAll(YoubenbenUserContext userContext, String accountingSubjectId, int accountingSubjectVersion) throws Exception {
		return forgetByAllInternal(userContext, accountingSubjectId, accountingSubjectVersion);
	}
	protected AccountingSubject forgetByAllInternal(YoubenbenUserContext userContext,
			String accountingSubjectId, int accountingSubjectVersion) throws Exception{
	...
	protected AccountingSubject breakWithAccountingDocumentLineByBelongsTo(YoubenbenUserContext userContext, String accountingSubjectId, String belongsToId,  String [] tokensExpr)
		 throws Exception{
	...
	protected void checkParamsForAddingAccountingDocumentLine(YoubenbenUserContext userContext, String accountingSubjectId, String name, String code, String direct, BigDecimal amount, String belongsToId,String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForUpdatingAccountingDocumentLineProperties(YoubenbenUserContext userContext, String accountingSubjectId,String id,String name,String code,String direct,BigDecimal amount,String [] tokensExpr) throws Exception {
	...
	public  AccountingSubject updateAccountingDocumentLineProperties(YoubenbenUserContext userContext, String accountingSubjectId, String id,String name,String code,String direct,BigDecimal amount, String [] tokensExpr) throws Exception
	{
	...
	protected AccountingDocumentLine createAccountingDocumentLine(YoubenbenUserContext userContext, String name, String code, String direct, BigDecimal amount, String belongsToId) throws Exception{
	...
	protected void checkParamsForRemovingAccountingDocumentLineList(YoubenbenUserContext userContext, String accountingSubjectId,
	...
	public  AccountingSubject removeAccountingDocumentLineList(YoubenbenUserContext userContext, String accountingSubjectId,
			String accountingDocumentLineIds[],String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForRemovingAccountingDocumentLine(YoubenbenUserContext userContext, String accountingSubjectId,
	...
	public  AccountingSubject removeAccountingDocumentLine(YoubenbenUserContext userContext, String accountingSubjectId,
		String accountingDocumentLineId, int accountingDocumentLineVersion,String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForCopyingAccountingDocumentLine(YoubenbenUserContext userContext, String accountingSubjectId,
		String accountingDocumentLineId, int accountingDocumentLineVersion,String [] tokensExpr) throws Exception{
	...
	public  AccountingSubject copyAccountingDocumentLineFrom(YoubenbenUserContext userContext, String accountingSubjectId,
		String accountingDocumentLineId, int accountingDocumentLineVersion,String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForUpdatingAccountingDocumentLine(YoubenbenUserContext userContext, String accountingSubjectId, String accountingDocumentLineId, int accountingDocumentLineVersion, String property, String newValueExpr,String [] tokensExpr) throws Exception{
	...
	public  AccountingSubject updateAccountingDocumentLine(YoubenbenUserContext userContext, String accountingSubjectId, String accountingDocumentLineId, int accountingDocumentLineVersion, String property, String newValueExpr,String [] tokensExpr)
			throws Exception{
	...
	*/
	...
	// -----------------------------------// list-of-view 处理 \\-----------------------------------
    protected void enhanceForListOfView(YoubenbenUserContext userContext,SmartList<AccountingSubject> list) throws Exception {
  ...
  // -----------------------------------\\ list-of-view 处理 //-----------------------------------v
	 ...
	 * @throws Exception
	 */
 	public Object wxappview(YoubenbenUserContext userContext, String accountingSubjectId) throws Exception{
	  SerializeScope vscope = YoubenbenViewScope.getInstance().getAccountingSubjectDetailScope().clone();
