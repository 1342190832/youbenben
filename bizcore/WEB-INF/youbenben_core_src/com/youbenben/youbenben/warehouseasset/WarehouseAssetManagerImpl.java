...
public class WarehouseAssetManagerImpl extends CustomYoubenbenCheckerManager implements WarehouseAssetManager, BusinessHandler{
	...
	@Override
	public WarehouseAssetDAO daoOf(YoubenbenUserContext userContext) {
	...
	protected void throwExceptionWithMessage(String value) throws WarehouseAssetManagerException{
 	...
 	protected WarehouseAsset saveWarehouseAsset(YoubenbenUserContext userContext, WarehouseAsset warehouseAsset, String [] tokensExpr) throws Exception{	
 	...
 	protected WarehouseAsset saveWarehouseAssetDetail(YoubenbenUserContext userContext, WarehouseAsset warehouseAsset) throws Exception{	
 	...
 	public WarehouseAsset loadWarehouseAsset(YoubenbenUserContext userContext, String warehouseAssetId, String [] tokensExpr) throws Exception{				
 	 ...
 	 public WarehouseAsset searchWarehouseAsset(YoubenbenUserContext userContext, String warehouseAssetId, String textToSearch,String [] tokensExpr) throws Exception{				
 	...
 	protected WarehouseAsset present(YoubenbenUserContext userContext, WarehouseAsset warehouseAsset, Map<String, Object> tokens) throws Exception {
 	...
 	public WarehouseAsset loadWarehouseAssetDetail(YoubenbenUserContext userContext, String warehouseAssetId) throws Exception{	
 	...
 	public Object view(YoubenbenUserContext userContext, String warehouseAssetId) throws Exception{	
 		WarehouseAsset warehouseAsset = loadWarehouseAsset( userContext, warehouseAssetId, viewTokens());
 		return present(userContext,warehouseAsset, allTokens());
		
 	}
 	protected WarehouseAsset saveWarehouseAsset(YoubenbenUserContext userContext, WarehouseAsset warehouseAsset, Map<String,Object>tokens) throws Exception{	
 		return warehouseAssetDaoOf(userContext).save(warehouseAsset, tokens);
 	}
 	protected WarehouseAsset loadWarehouseAsset(YoubenbenUserContext userContext, String warehouseAssetId, Map<String,Object>tokens) throws Exception{	
		checkerOf(userContext).checkIdOfWarehouseAsset(warehouseAssetId);
		checkerOf(userContext).throwExceptionIfHasErrors( WarehouseAssetManagerException.class);
 	...
 	protected<T extends BaseEntity> void addActions(YoubenbenUserContext userContext, WarehouseAsset warehouseAsset, Map<String, Object> tokens){
	...
	}// end method of protected<T extends BaseEntity> void addActions(YoubenbenUserContext userContext, WarehouseAsset warehouseAsset, Map<String, Object> tokens){
	...
	protected void checkParamsForUpdatingWarehouseAsset(YoubenbenUserContext userContext,String warehouseAssetId, int warehouseAssetVersion, String property, String newValueExpr,String [] tokensExpr)throws Exception
	{
	...
	public WarehouseAsset clone(YoubenbenUserContext userContext, String fromWarehouseAssetId) throws Exception{
	...
	public WarehouseAsset internalSaveWarehouseAsset(YoubenbenUserContext userContext, WarehouseAsset warehouseAsset, Map<String,Object> options) throws Exception
	{
	...
	public WarehouseAsset updateWarehouseAssetProperty(YoubenbenUserContext userContext,String warehouseAssetId, int warehouseAssetVersion, String property, String newValueExpr,String [] tokensExpr) throws Exception
	{
		checkParamsForUpdatingWarehouseAsset(userContext, warehouseAssetId, warehouseAssetVersion, property, newValueExpr, tokensExpr);
	...
	protected void checkParamsForTransferingAnotherOwner(YoubenbenUserContext userContext, String warehouseAssetId, String anotherOwnerId) throws Exception
 	{
	...
	public CandidateWarehouse requestCandidateOwner(YoubenbenUserContext userContext, String ownerClass, String id, String filterKey, int pageNo) throws Exception {
 ...
 //--------------------------------------------------------------
 	...
 	protected Warehouse loadWarehouse(YoubenbenUserContext userContext, String newOwnerId, Map<String,Object> options) throws Exception
 	{
	...
	public void delete(YoubenbenUserContext userContext, String warehouseAssetId, int warehouseAssetVersion) throws Exception {
	...
	public WarehouseAsset forgetByAll(YoubenbenUserContext userContext, String warehouseAssetId, int warehouseAssetVersion) throws Exception {
		return forgetByAllInternal(userContext, warehouseAssetId, warehouseAssetVersion);
	}
	protected WarehouseAsset forgetByAllInternal(YoubenbenUserContext userContext,
			String warehouseAssetId, int warehouseAssetVersion) throws Exception{
	...
	// -----------------------------------// list-of-view 处理 \\-----------------------------------
    protected void enhanceForListOfView(YoubenbenUserContext userContext,SmartList<WarehouseAsset> list) throws Exception {
    	if (list == null || list.isEmpty()){
    		return;
    	}
		List<Warehouse> ownerList = YoubenbenBaseUtils.collectReferencedObjectWithType(userContext, list, Warehouse.class);
  ...
  // -----------------------------------\\ list-of-view 处理 //-----------------------------------v
	 ...
	 * @throws Exception
	 */
 	public Object wxappview(YoubenbenUserContext userContext, String warehouseAssetId) throws Exception{
	  SerializeScope vscope = YoubenbenViewScope.getInstance().getWarehouseAssetDetailScope().clone();
