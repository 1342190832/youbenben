...
public class YoubenbenCandidatesUtil extends BaseCandidatesUtil{
	...
	protected BaseCandidateEntity<? extends BaseEntity> executeQuery(YoubenbenUserContext userContext, CandidateQuery query, String sql,
		...
		case "franchised_outlet_province_center":
			currentDAO = (YoubenbenBaseDAOImpl)userContext.getDAOGroup().getFranchisedOutletProvinceCenterDAO();
		...
		case "franchised_outlet_city_center":
			currentDAO = (YoubenbenBaseDAOImpl)userContext.getDAOGroup().getFranchisedOutletCityCenterDAO();
		...
		case "city_center_department":
			currentDAO = (YoubenbenBaseDAOImpl)userContext.getDAOGroup().getCityCenterDepartmentDAO();
		...
		case "franchised_outlet_city_service_center":
			currentDAO = (YoubenbenBaseDAOImpl)userContext.getDAOGroup().getFranchisedOutletCityServiceCenterDAO();
