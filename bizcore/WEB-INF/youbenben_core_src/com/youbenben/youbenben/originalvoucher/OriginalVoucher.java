...
public class OriginalVoucher extends BaseEntity implements  java.io.Serializable{
	...
	public Object[] toFlatArray(){
		return new Object[]{getId(), getTitle(), getMadeBy(), getReceivedBy(), getVoucherType(), getVoucherImage(), getBelongsTo(), getCreation(), getConfirmation(), getAuditing(), getVersion()};
	}
