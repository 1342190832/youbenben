...
public class OriginalVoucherTable{
	...
	public static final String []ALL_CLOUMNS = {COLUMN_ID,COLUMN_TITLE,COLUMN_MADE_BY,COLUMN_RECEIVED_BY,COLUMN_VOUCHER_TYPE,COLUMN_VOUCHER_IMAGE,COLUMN_BELONGS_TO,COLUMN_CREATION,COLUMN_CONFIRMATION,COLUMN_AUDITING,COLUMN_VERSION};
	public static final String []NORMAL_CLOUMNS = {COLUMN_TITLE,COLUMN_MADE_BY,COLUMN_RECEIVED_BY,COLUMN_VOUCHER_TYPE,COLUMN_VOUCHER_IMAGE,COLUMN_BELONGS_TO,COLUMN_CREATION,COLUMN_CONFIRMATION,COLUMN_AUDITING};
