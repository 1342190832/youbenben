...
public class LoginHistoryManagerImpl extends CustomYoubenbenCheckerManager implements LoginHistoryManager, BusinessHandler{
	...
	@Override
	public LoginHistoryDAO daoOf(YoubenbenUserContext userContext) {
	...
	protected void throwExceptionWithMessage(String value) throws LoginHistoryManagerException{
 	...
 	protected LoginHistory saveLoginHistory(YoubenbenUserContext userContext, LoginHistory loginHistory, String [] tokensExpr) throws Exception{	
 	...
 	protected LoginHistory saveLoginHistoryDetail(YoubenbenUserContext userContext, LoginHistory loginHistory) throws Exception{	
 	...
 	public LoginHistory loadLoginHistory(YoubenbenUserContext userContext, String loginHistoryId, String [] tokensExpr) throws Exception{				
 	 ...
 	 public LoginHistory searchLoginHistory(YoubenbenUserContext userContext, String loginHistoryId, String textToSearch,String [] tokensExpr) throws Exception{				
 	...
 	protected LoginHistory present(YoubenbenUserContext userContext, LoginHistory loginHistory, Map<String, Object> tokens) throws Exception {
 	...
 	public LoginHistory loadLoginHistoryDetail(YoubenbenUserContext userContext, String loginHistoryId) throws Exception{	
 	...
 	public Object view(YoubenbenUserContext userContext, String loginHistoryId) throws Exception{	
 		LoginHistory loginHistory = loadLoginHistory( userContext, loginHistoryId, viewTokens());
 		return present(userContext,loginHistory, allTokens());
		
 	}
 	protected LoginHistory saveLoginHistory(YoubenbenUserContext userContext, LoginHistory loginHistory, Map<String,Object>tokens) throws Exception{	
 		return loginHistoryDaoOf(userContext).save(loginHistory, tokens);
 	}
 	protected LoginHistory loadLoginHistory(YoubenbenUserContext userContext, String loginHistoryId, Map<String,Object>tokens) throws Exception{	
		checkerOf(userContext).checkIdOfLoginHistory(loginHistoryId);
		checkerOf(userContext).throwExceptionIfHasErrors( LoginHistoryManagerException.class);
 	...
 	protected<T extends BaseEntity> void addActions(YoubenbenUserContext userContext, LoginHistory loginHistory, Map<String, Object> tokens){
	...
	}// end method of protected<T extends BaseEntity> void addActions(YoubenbenUserContext userContext, LoginHistory loginHistory, Map<String, Object> tokens){
	...
	protected void checkParamsForUpdatingLoginHistory(YoubenbenUserContext userContext,String loginHistoryId, int loginHistoryVersion, String property, String newValueExpr,String [] tokensExpr)throws Exception
	{
	...
	public LoginHistory clone(YoubenbenUserContext userContext, String fromLoginHistoryId) throws Exception{
	...
	public LoginHistory internalSaveLoginHistory(YoubenbenUserContext userContext, LoginHistory loginHistory, Map<String,Object> options) throws Exception
	{
	...
	public LoginHistory updateLoginHistoryProperty(YoubenbenUserContext userContext,String loginHistoryId, int loginHistoryVersion, String property, String newValueExpr,String [] tokensExpr) throws Exception
	{
		checkParamsForUpdatingLoginHistory(userContext, loginHistoryId, loginHistoryVersion, property, newValueExpr, tokensExpr);
	...
	protected void checkParamsForTransferingAnotherSecUser(YoubenbenUserContext userContext, String loginHistoryId, String anotherSecUserId) throws Exception
 	{
	...
	protected void checkParamsForTransferingAnotherSecUserWithLogin(YoubenbenUserContext userContext, String loginHistoryId, String anotherLogin) throws Exception
 	{
 	...
 	public LoginHistory transferToAnotherSecUserWithLogin(YoubenbenUserContext userContext, String loginHistoryId, String anotherLogin) throws Exception
 	{
	...
	protected void checkParamsForTransferingAnotherSecUserWithEmail(YoubenbenUserContext userContext, String loginHistoryId, String anotherEmail) throws Exception
 	{
 	...
 	public LoginHistory transferToAnotherSecUserWithEmail(YoubenbenUserContext userContext, String loginHistoryId, String anotherEmail) throws Exception
 	{
	...
	protected void checkParamsForTransferingAnotherSecUserWithMobile(YoubenbenUserContext userContext, String loginHistoryId, String anotherMobile) throws Exception
 	{
 	...
 	public LoginHistory transferToAnotherSecUserWithMobile(YoubenbenUserContext userContext, String loginHistoryId, String anotherMobile) throws Exception
 	{
 ...
 //--------------------------------------------------------------
	...
	public void delete(YoubenbenUserContext userContext, String loginHistoryId, int loginHistoryVersion) throws Exception {
	...
	public LoginHistory forgetByAll(YoubenbenUserContext userContext, String loginHistoryId, int loginHistoryVersion) throws Exception {
		return forgetByAllInternal(userContext, loginHistoryId, loginHistoryVersion);
	}
	protected LoginHistory forgetByAllInternal(YoubenbenUserContext userContext,
			String loginHistoryId, int loginHistoryVersion) throws Exception{
	...
	// -----------------------------------// list-of-view 处理 \\-----------------------------------
    protected void enhanceForListOfView(YoubenbenUserContext userContext,SmartList<LoginHistory> list) throws Exception {
  ...
  // -----------------------------------\\ list-of-view 处理 //-----------------------------------v
	 ...
	 * @throws Exception
	 */
 	public Object wxappview(YoubenbenUserContext userContext, String loginHistoryId) throws Exception{
	  SerializeScope vscope = YoubenbenViewScope.getInstance().getLoginHistoryDetailScope().clone();
