...
import com.xingyou.xingyou.LoginForm;
import com.xingyou.xingyou.BaseEntity;
import com.xingyou.xingyou.CommonError;
import com.xingyou.xingyou.DAOGroup;
import com.xingyou.xingyou.ManagerGroup;

import com.xingyou.xingyou.UserContextImpl;
import com.xingyou.xingyou.userapp.UserApp;
import com.xingyou.xingyou.XingyouUserContext;
import com.xingyou.xingyou.userapp.*;
import com.xingyou.xingyou.listaccess.*;
import com.xingyou.xingyou.XingyouObjectChecker;
import com.xingyou.xingyou.loginhistory.LoginHistory;
import com.xingyou.xingyou.Message;
import com.xingyou.xingyou.CustomXingyouUserContextImpl;
...
public class CustomSecUserManagerImpl extends SecUserManagerImpl implements
   ...
   public void setBlockChainAdvancer(BlockChainAdvancer pBlockChainAdvancer){
    ...
    public String confirmSession(XingyouUserContext userContext){
    ...
    public Object resetPassword(XingyouUserContext userContext, String mobile, int verifycationCode, String newPassword) {
    ...
    public Object resetPasswordWithoutLogin(XingyouUserContext userContext, String loginType, String loginKey, int verifycationCode, String newPassword) {
        SecUser user;
        try {
    ...
    public Object selectApp(XingyouUserContext userContext,
    ...
    public SecUser manage(XingyouUserContext userContext) throws Exception{
        SecUser user = cachedUser(userContext);
    ...
    protected SecUser cachedUser(XingyouUserContext userContext)
    {
        return (SecUser)userContext.getCachedObject(this.getUserKey(userContext), SecUser.class);
    }

    public SecUser getCachedSecUser(XingyouUserContext userContext) {
    ...
    protected Object gotoApp(XingyouUserContext userContext, UserApp app) throws Exception {
    ...
    public String getVerificationCode(XingyouUserContext userContext,String mobile){
    ...
    protected void sendVerificationCode(XingyouUserContext userContext, String mobile,String code) throws Exception{
    ...
    protected int getRandomVerificationCode(XingyouUserContext userContex, int length){
    ...
    protected String getBeanName(XingyouUserContext userContext, UserApp app){
    ...
    protected String getTargetObjectId(XingyouUserContext userContext, UserApp app){

        return  app.getObjectId();

    }
    protected String getServiceType(XingyouUserContext userContext, UserApp app){

        return app.getObjectType();
    }
    protected String getMethodName(XingyouUserContext userContext, UserApp app){
    ...
    public Object home(XingyouUserContext userContext) {
    ...
    public Object loginWithEmail(XingyouUserContext userContext, String email,
            Password password) {

        return loginInternal(userContext,"email",email, password);

    }
    public Object login(XingyouUserContext userContext, String email,
            Password password) {
    ...
    public Object loginWithLogin(XingyouUserContext userContext, String email,
            Password password) {

        return loginInternal(userContext,"login",email, password);

    }
    public Object loginWithMobile(XingyouUserContext userContext, String email,
            Password password) {
        return loginInternal(userContext,"mobile",email, password);

    }
    protected SecUser loadUserWith(XingyouUserContext userContext, String type, String userId) throws Exception{
    ...
    protected Object loginInternal(XingyouUserContext userContext, String type, String userId,
            Password password) {
     ...
     */
    protected Object loginTheSecUserInternal(XingyouUserContext userContext, SecUser user, String loginComments) throws Exception {
		...
		iamService.onLoginSecUserInternalSuccess((XingyouUserContextImpl) userContext, user);
    ...
    public Object showlogin(XingyouUserContext userContext) {
    ...
    protected LoginForm showSessionExpired(XingyouUserContext userContext) {
    ...
    public BaseUserContext loadUserConext(HttpServletRequest request)
        ...
        XingyouUserContextImpl uc = createNewConext(path);
        init(uc, request);
        return uc;
    }
    ...
    protected XingyouObjectChecker checker;
    public XingyouObjectChecker getChecker(){
        return checker;
    }

    public void setChecker(XingyouObjectChecker checker){
    ...
    protected void init(UserContextImpl userContext, HttpServletRequest request) {
        ...
        userContext.setChecker((XingyouObjectChecker)beanFactory.getBean(getCheckerBeanName()));
    ...
    protected XingyouUserContextImpl createNewConext(String path) {

        return new CustomXingyouUserContextImpl();
    ...
    public Object checkOtherLogin(XingyouUserContext userContext) throws Exception {
	...
	protected void checkUserHasManagementAccess(XingyouUserContext userContext, String objectType, String objectId)
	...
	public UserApp updateAppPermission(XingyouUserContext userContext, String secUserId, String userAppId, int version,
	...
	public UserApp updateListAccess(XingyouUserContext userContext, String secUserId, String userAppId, String displayName,
	...
	public UserApp loadUserAppWithUser(XingyouUserContext userContext, String secUserId, String objectType,
    ...
    public Object changeCurUserPassword(XingyouUserContext userContext, String currentPassword, String newPassword)
			throws Exception {
	...
	public String testIfHasManagementAccess(XingyouUserContext userContext,String objectType,String objectId) {
		try {
			this.checkUserHasManagementAccess(userContext, objectType, objectId);
			return "OK";
		}catch(Exception e){
    ...
    public Map<String, Object> testoss(XingyouUserContext userContext) throws SecUserManagerException {
