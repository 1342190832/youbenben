...
public class XingyouBizUserContextImpl extends XingyouUserContextImpl{
	...
	protected BaseXingyouFormProcessor inputFormData;
	protected BaseXingyouFormProcessor outputFormData;
	...
	public String getPostMd5Key(XingyouBizUserContextImpl ctx) {
	...
	public BaseXingyouFormProcessor getInputFormData() {
		return inputFormData;
	}
	public void setInputFormData(BaseXingyouFormProcessor inputFormData) {
		this.inputFormData = inputFormData;
	}
	public BaseXingyouFormProcessor getOutputFormData() {
		return outputFormData;
	}
	public void setOutputFormData(BaseXingyouFormProcessor outputFormData) {
