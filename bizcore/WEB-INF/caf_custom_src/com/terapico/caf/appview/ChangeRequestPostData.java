...
public class ChangeRequestPostData {
	...
	public void addFieldValue(String groupName, CRFieldSpec fieldSpec, String recordId, Object fieldValue) {
		...
		Map<String, Object> fdData = groupData.stream().filter(fd->{
			if (recordId == null) {
	...
	public void addVerifyErrorMessage(String fieldName, String label, String message) {
		ensureVerifyMessage().add(MapUtil.put("fieldName", fieldName)
				.put("label", label)
				.put("message", message)
				.into_map());
	}
